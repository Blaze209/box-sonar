...
public abstract class ForwardingFileSystem extends FileSystem {
    ...
    public List<Path> list(Path dir) throws IOException {
        ...
        List<Path> list = this.delegate.list(onPathParameter(dir, BoxNoteConstants.BOX_NOTE_STYLE_TYPE_LIST, KeyManagementAlgorithmIdentifiers.DIRECT));
        ArrayList arrayList = new ArrayList();
        Iterator<T> it = list.iterator();
        while (it.hasNext()) {
            arrayList.add(onPathResult((Path) it.next(), BoxNoteConstants.BOX_NOTE_STYLE_TYPE_LIST));
        }
