    ...
    private final Request createTunnel(int readTimeout, int writeTimeout, Request tunnelRequest, HttpUrl url) throws IOException {
        ...
        while (true) {
            ...
            if (iCode == 407) {
                ...
                if (StringsKt.equals(HeaderElements.CLOSE, Response.header$default(responseBuild, "Connection", null, 2, null), true)) {
