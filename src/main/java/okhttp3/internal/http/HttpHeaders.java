        ...
        while (true) {
            ...
            while (true) {
                ...
                if (!zSkipCommasAndWhitespace && (zSkipCommasAndWhitespace2 || buffer.exhausted())) {
                    Map mapSingletonMap = Collections.singletonMap(null, token3 + StringsKt.repeat(SimpleComparison.EQUAL_TO_OPERATION, iSkipAll));
                    ...
                    while (true) {
                        if (token3 != null) {
                            ...
                            if (startsWith(buffer, CtapException.ERR_INVALID_CREDENTIAL)) {
