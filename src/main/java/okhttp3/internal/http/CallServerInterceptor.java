...
public final class CallServerInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (StringsKt.equals(HeaderElements.CLOSE, responseBuild.request().header("Connection"), true) || StringsKt.equals(HeaderElements.CLOSE, Response.header$default(responseBuild, "Connection", null, 2, null), true)) {
            exchange.noNewExchangesOnConnection();
        }
