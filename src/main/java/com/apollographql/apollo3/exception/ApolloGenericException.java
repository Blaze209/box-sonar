...
public final class ApolloGenericException extends ApolloException {
    ...
    public ApolloGenericException(String str, Throwable th) {
        super(str, th);
    }

    public /* synthetic */ ApolloGenericException(String str, Throwable th, int i, DefaultConstructorMarker defaultConstructorMarker) {
