...
@DebugMetadata(c = "com.apollographql.apollo3.cache.normalized.FetchPolicyInterceptors$CacheFirstInterceptor$1$intercept$1$cacheResponse$1", f = "FetchPolicyInterceptors.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
final class FetchPolicyInterceptors$CacheFirstInterceptor$1$intercept$1$cacheResponse$1<D> extends SuspendLambda implements Function3<FlowCollector<? super ApolloResponse<D>>, Throwable, Continuation<? super Unit>, Object> {
    final /* synthetic */ Ref.ObjectRef<ApolloException> $cacheException;
    /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FetchPolicyInterceptors$CacheFirstInterceptor$1$intercept$1$cacheResponse$1(Ref.ObjectRef<ApolloException> objectRef, Continuation<? super FetchPolicyInterceptors$CacheFirstInterceptor$1$intercept$1$cacheResponse$1> continuation) {
