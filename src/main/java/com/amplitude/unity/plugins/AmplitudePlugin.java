...
public class AmplitudePlugin {
    ...
    public static void setTrackingOptions(String str, String str2) {
        JSONObject jSONObjectToJSONObject = ToJSONObject(str2);
        TrackingOptions trackingOptions = new TrackingOptions();
        if (jSONObjectToJSONObject.optBoolean("disableADID", false)) {
            trackingOptions.disableAdid();
        }
        if (jSONObjectToJSONObject.optBoolean("disableAppSetId", false)) {
            trackingOptions.disableAppSetId();
        }
        if (jSONObjectToJSONObject.optBoolean("disableCarrier", false)) {
            trackingOptions.disableCarrier();
        }
        if (jSONObjectToJSONObject.optBoolean("disableCity", false)) {
            trackingOptions.disableCity();
        }
        if (jSONObjectToJSONObject.optBoolean("disableCountry", false)) {
            trackingOptions.disableCountry();
        }
        if (jSONObjectToJSONObject.optBoolean("disableDeviceBrand", false)) {
            trackingOptions.disableDeviceBrand();
        }
        if (jSONObjectToJSONObject.optBoolean("disableDeviceManufacturer", false)) {
            trackingOptions.disableDeviceManufacturer();
        }
        if (jSONObjectToJSONObject.optBoolean("disableDeviceModel", false)) {
            trackingOptions.disableDeviceModel();
        }
        if (jSONObjectToJSONObject.optBoolean("disableDMA", false)) {
            trackingOptions.disableDma();
        }
        if (jSONObjectToJSONObject.optBoolean("disableIPAddress", false)) {
            trackingOptions.disableIpAddress();
        }
        if (jSONObjectToJSONObject.optBoolean("disableLanguage", false)) {
            trackingOptions.disableLanguage();
        }
        if (jSONObjectToJSONObject.optBoolean("disableLatLng", false)) {
            trackingOptions.disableLatLng();
        }
        if (jSONObjectToJSONObject.optBoolean("disableOSName", false)) {
            trackingOptions.disableOsName();
        }
        if (jSONObjectToJSONObject.optBoolean("disableOSVersion", false)) {
            trackingOptions.disableOsVersion();
        }
        if (jSONObjectToJSONObject.optBoolean("disableApiLevel", false)) {
            trackingOptions.disableApiLevel();
        }
        if (jSONObjectToJSONObject.optBoolean("disablePlatform", false)) {
            trackingOptions.disablePlatform();
        }
        if (jSONObjectToJSONObject.optBoolean("disableRegion", false)) {
            trackingOptions.disableRegion();
        }
        if (jSONObjectToJSONObject.optBoolean("disableVersionName", false)) {
    ...
    public static void setOnceUserPropertyList(String str, String str2, String str3) {
        JSONObject jSONObjectToJSONObject = ToJSONObject(str3);
        if (jSONObjectToJSONObject == null) {
            return;
        }
        Amplitude.getInstance(str).identify(new Identify().setOnce(str2, jSONObjectToJSONObject.optJSONArray(BoxNoteConstants.BOX_NOTE_STYLE_TYPE_LIST)));
    }
    ...
    public static void setUserPropertyList(String str, String str2, String str3) {
        ...
        Amplitude.getInstance(str).identify(new Identify().set(str2, jSONObjectToJSONObject.optJSONArray(BoxNoteConstants.BOX_NOTE_STYLE_TYPE_LIST)));
    }
    ...
    public static void appendUserPropertyList(String str, String str2, String str3) {
        ...
        Amplitude.getInstance(str).identify(new Identify().append(str2, jSONObjectToJSONObject.optJSONArray(BoxNoteConstants.BOX_NOTE_STYLE_TYPE_LIST)));
    }
    ...
    public static void prependUserPropertyList(String str, String str2, String str3) {
        ...
        Amplitude.getInstance(str).identify(new Identify().prepend(str2, jSONObjectToJSONObject.optJSONArray(BoxNoteConstants.BOX_NOTE_STYLE_TYPE_LIST)));
    }
    ...
    public static void preInsertUserPropertyList(String str, String str2, String str3) {
        ...
        Amplitude.getInstance(str).identify(new Identify().preInsert(str2, jSONObjectToJSONObject.optJSONArray(BoxNoteConstants.BOX_NOTE_STYLE_TYPE_LIST)));
    }
    ...
    public static void postInsertUserPropertyList(String str, String str2, String str3) {
        ...
        Amplitude.getInstance(str).identify(new Identify().postInsert(str2, jSONObjectToJSONObject.optJSONArray(BoxNoteConstants.BOX_NOTE_STYLE_TYPE_LIST)));
    }
    ...
    public static void removeUserPropertyList(String str, String str2, String str3) {
        ...
        Amplitude.getInstance(str).identify(new Identify().remove(str2, jSONObjectToJSONObject.optJSONArray(BoxNoteConstants.BOX_NOTE_STYLE_TYPE_LIST)));
    }
