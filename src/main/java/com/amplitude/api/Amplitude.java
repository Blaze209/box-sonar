...
public class Amplitude {
    ...
    public static synchronized AmplitudeClient getInstance(String str) {
        ...
        amplitudeClient = map.get(strNormalizeInstanceName);
        if (amplitudeClient == null) {
            amplitudeClient = new AmplitudeClient(strNormalizeInstanceName);
            map.put(strNormalizeInstanceName, amplitudeClient);
        }
