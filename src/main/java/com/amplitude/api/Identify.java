...
public class Identify {
    ...
    public Identify unset(String str) {
        addToUserProperties("$unset", str, CacheKeyValueDelegate.CACHE_VALUE_SEPARATOR);
        return this;
    }
    ...
    public Identify clearAll() {
        ...
        try {
            this.userPropertiesOperations.put("$clearAll", CacheKeyValueDelegate.CACHE_VALUE_SEPARATOR);
            return this;
