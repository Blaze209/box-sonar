...
public final class MD5 extends MessageDigest implements Cloneable {
    ...
    public void engineUpdate(byte[] bArr, int i, int i2) {
        if (i >= 0 && i2 >= 0 && i + i2 <= bArr.length) {
            ...
            while (i2 >= 512) {
                ...
                engineUpdate(bArr, i + BoxRequestsFile.DownloadThumbnail.SIZE_320);
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:28:0x00c2 -> B:29:0x00c3). Please report as a decompilation issue!!! */
    ...
    private final void engineUpdate(byte[] bArr, int i) {
        ...
        int i3 = this.hC;
        int i4 = this.hD;
        int i5 = (bArr[i] & 255) | ((bArr[i + 1] & 255) << 8) | ((bArr[i + 2] & 255) << 16) | (bArr[i + 3] << Ascii.CAN);
        int i6 = this.hA;
        int i7 = (((((i3 ^ i4) & i2) ^ i4) + i5) - 680876936) + i6;
        int i8 = ((i7 >>> 25) | (i7 << 7)) + i2;
        int i9 = (bArr[i + 4] & 255) | ((bArr[i + 5] & 255) << 8) | ((bArr[i + 6] & 255) << 16) | (bArr[i + 7] << Ascii.CAN);
        int i10 = (((((i2 ^ i3) & i8) ^ i3) + i9) - 389564586) + i4;
        int i11 = ((i10 >>> 20) | (i10 << 12)) + i8;
        int i12 = ((bArr[i + 10] & 255) << 16) | (bArr[i + 8] & 255) | ((bArr[i + 9] & 255) << 8) | (bArr[i + 11] << Ascii.CAN);
        int i13 = (((i8 ^ i2) & i11) ^ i2) + i12 + 606105819 + i3;
        int i14 = ((i13 >>> 15) | (i13 << 17)) + i11;
        int i15 = (bArr[i + 12] & 255) | ((bArr[i + 13] & 255) << 8) | ((bArr[i + 14] & 255) << 16) | (bArr[i + 15] << Ascii.CAN);
        int i16 = (((((i11 ^ i8) & i14) ^ i8) + i15) - 1044525330) + i2;
        int i17 = ((i16 >>> 10) | (i16 << 22)) + i14;
        int i18 = ((bArr[i + 17] & 255) << 8) | (bArr[i + 16] & 255) | ((bArr[i + 18] & 255) << 16) | (bArr[i + 19] << Ascii.CAN);
        int i19 = (((((i14 ^ i11) & i17) ^ i11) + i18) - 176418897) + i8;
        int i20 = ((i19 << 7) | (i19 >>> 25)) + i17;
        int i21 = (bArr[i + 20] & 255) | ((bArr[i + 21] & 255) << 8) | ((bArr[i + 22] & 255) << 16) | (bArr[i + 23] << Ascii.CAN);
        int i22 = (((i17 ^ i14) & i20) ^ i14) + i21 + 1200080426 + i11;
        int i23 = ((i22 << 12) | (i22 >>> 20)) + i20;
        int i24 = ((bArr[i + 25] & 255) << 8) | (bArr[i + 24] & 255) | ((bArr[i + 26] & 255) << 16) | (bArr[i + 27] << Ascii.CAN);
        int i25 = (((((i20 ^ i17) & i23) ^ i17) + i24) - 1473231341) + i14;
        int i26 = ((i25 << 17) | (i25 >>> 15)) + i23;
        int i27 = (bArr[i + 28] & 255) | ((bArr[i + 29] & 255) << 8) | ((bArr[i + 30] & 255) << 16) | (bArr[i + 31] << Ascii.CAN);
        int i28 = (((((i23 ^ i20) & i26) ^ i20) + i27) - 45705983) + i17;
        int i29 = ((i28 << 22) | (i28 >>> 10)) + i26;
        int i30 = ((bArr[i + 33] & 255) << 8) | (bArr[i + 32] & 255) | ((bArr[i + 34] & 255) << 16) | (bArr[i + 35] << Ascii.CAN);
        int i31 = (((i26 ^ i23) & i29) ^ i23) + i30 + 1770035416 + i20;
        int i32 = ((i31 << 7) | (i31 >>> 25)) + i29;
        int i33 = (bArr[i + 36] & 255) | ((bArr[i + 37] & 255) << 8) | ((bArr[i + 38] & 255) << 16) | (bArr[i + 39] << Ascii.CAN);
        int i34 = (((((i29 ^ i26) & i32) ^ i26) + i33) - 1958414417) + i23;
        int i35 = ((i34 << 12) | (i34 >>> 20)) + i32;
        int i36 = ((bArr[i + 41] & 255) << 8) | (bArr[i + 40] & 255) | ((bArr[i + 42] & 255) << 16) | (bArr[i + 43] << Ascii.CAN);
        int i37 = (((((i32 ^ i29) & i35) ^ i29) + i36) - 42063) + i26;
        int i38 = ((i37 << 17) | (i37 >>> 15)) + i35;
        int i39 = ((bArr[i + 45] & 255) << 8) | (bArr[i + 44] & 255) | ((bArr[i + 46] & 255) << 16) | (bArr[i + 47] << Ascii.CAN);
        int i40 = (((((i35 ^ i32) & i38) ^ i32) + i39) - 1990404162) + i29;
        int i41 = ((i40 << 22) | (i40 >>> 10)) + i38;
        int i42 = (bArr[i + 48] & 255) | ((bArr[i + 49] & 255) << 8) | ((bArr[i + 50] & 255) << 16) | (bArr[i + 51] << Ascii.CAN);
        int i43 = (((i38 ^ i35) & i41) ^ i35) + i42 + 1804603682 + i32;
        int i44 = ((i43 << 7) | (i43 >>> 25)) + i41;
        int i45 = ((bArr[i + 53] & 255) << 8) | (bArr[i + 52] & 255) | ((bArr[i + 54] & 255) << 16) | (bArr[i + 55] << Ascii.CAN);
        int i46 = (((((i41 ^ i38) & i44) ^ i38) + i45) - 40341101) + i35;
        int i47 = ((i46 << 12) | (i46 >>> 20)) + i44;
        int i48 = (bArr[i + 56] & 255) | ((bArr[i + 57] & 255) << 8) | ((bArr[i + 58] & 255) << 16) | (bArr[i + 59] << Ascii.CAN);
        int i49 = (((((i44 ^ i41) & i47) ^ i41) + i48) - 1502002290) + i38;
        int i50 = ((i49 << 17) | (i49 >>> 15)) + i47;
        int i51 = ((bArr[i + 61] & 255) << 8) | (bArr[i + 60] & 255) | ((bArr[i + 62] & 255) << 16) | (bArr[i + 63] << Ascii.CAN);
