...
public class NotificationTarget extends CustomTarget<Bitmap> {
    ...
    private void update() {
        MAMNotificationManagement.notify((NotificationManager) Preconditions.checkNotNull((NotificationManager) this.context.getSystemService("notification")), this.notificationTag, this.notificationId, this.notification);
    }
