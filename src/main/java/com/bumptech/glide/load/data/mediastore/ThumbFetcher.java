...
public class ThumbFetcher implements DataFetcher<InputStream> {
    ...
    static class VideoThumbnailQuery implements ThumbnailQuery {
        ...
        public Cursor query(Uri uri) {
            return MAMContentResolverManagement.query(this.contentResolver, MediaStore.Video.Thumbnails.EXTERNAL_CONTENT_URI, PATH_PROJECTION, PATH_SELECTION, new String[]{uri.getLastPathSegment()}, null);
        }
    }
    ...
    static class ImageThumbnailQuery implements ThumbnailQuery {
        ...
        @Override // com.bumptech.glide.load.data.mediastore.ThumbnailQuery
        public Cursor query(Uri uri) {
            return MAMContentResolverManagement.query(this.contentResolver, MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI, PATH_PROJECTION, PATH_SELECTION, new String[]{uri.getLastPathSegment()}, null);
        }
    }
}
