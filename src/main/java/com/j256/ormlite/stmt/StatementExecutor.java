...
public class StatementExecutor<T, ID> implements GenericRowMapper<String[]> {
    ...
    public SelectIterator<T, ID> buildIterator(BaseDaoImpl<T, ID> baseDaoImpl, ConnectionSource connectionSource, PreparedStmt<T> preparedStmt, ObjectCache objectCache, int i) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                try {
                    return new SelectIterator<>(this.tableInfo.getDataClass(), baseDaoImpl, preparedStmt, connectionSource2, readOnlyConnection, compiledStatementCompile, preparedStmt.getStatement(), objectCache);
                } catch (Throwable th2) {
                    th = th2;
                    th = th;
    ...
    public GenericRawResults<String[]> queryRaw(ConnectionSource connectionSource, String str, String[] strArr, ObjectCache objectCache) throws Throwable {
        ...
        CompiledStatement compiledStatement = null;
        try {
            CompiledStatement compiledStatementCompileStatement = readOnlyConnection.compileStatement(str, StatementBuilder.StatementType.SELECT, noFieldTypes);
            try {
                assignStatementArguments(compiledStatementCompileStatement, strArr);
                connectionSource2 = connectionSource;
                try {
                    return new RawResultsImpl(connectionSource2, readOnlyConnection, str, String[].class, compiledStatementCompileStatement, this, objectCache);
                } catch (Throwable th2) {
                    th = th2;
                    th = th;
                    compiledStatement = compiledStatementCompileStatement;
    ...
    public <UO> GenericRawResults<UO> queryRaw(ConnectionSource connectionSource, String str, RawRowMapper<UO> rawRowMapper, String[] strArr, ObjectCache objectCache) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                connectionSource2 = connectionSource;
                try {
                    return new RawResultsImpl(connectionSource2, readOnlyConnection, str, String[].class, compiledStatementCompileStatement, new UserObjectRowMapper(rawRowMapper, this), objectCache);
                } catch (Throwable th2) {
                    th = th2;
                    th = th;
                    compiledStatement = compiledStatementCompileStatement;
    ...
    public GenericRawResults<Object[]> queryRaw(ConnectionSource connectionSource, String str, DataType[] dataTypeArr, String[] strArr, ObjectCache objectCache) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                connectionSource2 = connectionSource;
                try {
                    return new RawResultsImpl(connectionSource2, readOnlyConnection, str, Object[].class, compiledStatementCompileStatement, new ObjectArrayRowMapper(dataTypeArr), objectCache);
                } catch (Throwable th2) {
                    th = th2;
                    th = th;
                    compiledStatement = compiledStatementCompileStatement;
