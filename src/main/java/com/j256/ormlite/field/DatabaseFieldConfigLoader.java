...
public class DatabaseFieldConfigLoader {
    ...
    public static void writeConfig(BufferedWriter bufferedWriter, DatabaseFieldConfig databaseFieldConfig, String str) throws IOException {
        ...
        if (databaseFieldConfig.isId()) {
            bufferedWriter.append("id").append('=').append(TelemetryEventStrings.Value.TRUE);
            bufferedWriter.newLine();
        }
        if (databaseFieldConfig.isGeneratedId()) {
            bufferedWriter.append(FIELD_NAME_GENERATED_ID).append('=').append(TelemetryEventStrings.Value.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isForeign()) {
            bufferedWriter.append(FIELD_NAME_FOREIGN).append('=').append(TelemetryEventStrings.Value.TRUE);
            bufferedWriter.newLine();
        }
        if (databaseFieldConfig.isUseGetSet()) {
            bufferedWriter.append(FIELD_NAME_USE_GET_SET).append('=').append(TelemetryEventStrings.Value.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isThrowIfNull()) {
            bufferedWriter.append(FIELD_NAME_THROW_IF_NULL).append('=').append(TelemetryEventStrings.Value.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isUnique()) {
            bufferedWriter.append(FIELD_NAME_UNIQUE).append('=').append(TelemetryEventStrings.Value.TRUE);
            bufferedWriter.newLine();
        }
        if (databaseFieldConfig.isUniqueCombo()) {
            bufferedWriter.append(FIELD_NAME_UNIQUE_COMBO).append('=').append(TelemetryEventStrings.Value.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isForeignAutoRefresh()) {
            bufferedWriter.append(FIELD_NAME_FOREIGN_AUTO_REFRESH).append('=').append(TelemetryEventStrings.Value.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isAllowGeneratedIdInsert()) {
            bufferedWriter.append(FIELD_NAME_ALLOW_GENERATED_ID_INSERT).append('=').append(TelemetryEventStrings.Value.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isForeignAutoCreate()) {
            bufferedWriter.append(FIELD_NAME_FOREIGN_AUTO_CREATE).append('=').append(TelemetryEventStrings.Value.TRUE);
            bufferedWriter.newLine();
        }
        if (databaseFieldConfig.isVersion()) {
            bufferedWriter.append("version").append('=').append(TelemetryEventStrings.Value.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isForeignCollection()) {
            bufferedWriter.append(FIELD_NAME_FOREIGN_COLLECTION).append('=').append(TelemetryEventStrings.Value.TRUE);
            bufferedWriter.newLine();
        }
        if (databaseFieldConfig.isForeignCollectionEager()) {
            bufferedWriter.append(FIELD_NAME_FOREIGN_COLLECTION_EAGER).append('=').append(TelemetryEventStrings.Value.TRUE);
            bufferedWriter.newLine();
        }
