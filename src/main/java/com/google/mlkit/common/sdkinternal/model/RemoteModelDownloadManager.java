...
public class RemoteModelDownloadManager {
    ...
    RemoteModelDownloadManager(MlKitContext mlKitContext, RemoteModel remoteModel, ModelFileHelper modelFileHelper, RemoteModelFileManager remoteModelFileManager, ModelInfoRetrieverInterop modelInfoRetrieverInterop, zzsh zzshVar) {
        ...
        DownloadManager downloadManager = (DownloadManager) mlKitContext.getApplicationContext().getSystemService(BoxAmplitudeAnalytics.JobEventPropertyBuilder.JOB_TYPE_DOWNLOAD_JOB);
    ...
    private final synchronized Long zzn(DownloadManager.Request request, ModelInfo modelInfo) {
        ...
        long jEnqueue = MAMDownloadManagement.enqueue(downloadManager, request);
    ...
    /* JADX WARN: Code duplicated, block: B:18:0x0044 A[Catch: all -> 0x007e, TRY_ENTER, TRY_LEAVE, TryCatch #2 {, blocks: (B:3:0x0001, B:7:0x000e, B:18:0x0044, B:33:0x006e, B:40:0x007b, B:39:0x0078, B:36:0x0073, B:9:0x0027, B:11:0x002d, B:20:0x0048, B:22:0x004f, B:24:0x0056, B:26:0x005c, B:28:0x0064), top: B:50:0x0001, inners: #0, #1 }] */
    /* JADX WARN: Code duplicated, block: B:20:0x0048 A[Catch: all -> 0x003d, TRY_ENTER, TryCatch #1 {all -> 0x003d, blocks: (B:9:0x0027, B:11:0x002d, B:20:0x0048, B:22:0x004f, B:24:0x0056, B:26:0x005c, B:28:0x0064), top: B:48:0x0027, outer: #2 }] */
    ...
    public final MlKitException zzl(Long l) {
        ...
        if (cursorQuery != null && cursorQuery.moveToFirst()) {
            int i2 = cursorQuery.getInt(cursorQuery.getColumnIndex(BoxNoteConstants.BOX_NOTE_BRIDGE_KEY_REASON));
            if (i2 == 1006) {
    ...
    public int getFailureReason(Long l) {
        ...
        if (cursorQuery == null || !cursorQuery.moveToFirst() || (columnIndex = cursorQuery.getColumnIndex(BoxNoteConstants.BOX_NOTE_BRIDGE_KEY_REASON)) == -1) {
            return 0;
        }
