...
public final class DateTime implements Serializable {
    ...
    private static Rfc3339ParseResult parseRfc3339WithNanoSeconds(String str) throws NumberFormatException {
        ...
        if (z) {
            ...
            i4 = matcher.group(8) != null ? Integer.parseInt(com.google.common.base.Strings.padEnd(matcher.group(8).substring(1), 9, '0')) : 0;
            i = i8;
        } else {
            i = 0;
            i2 = 0;
        ...
        if (!z || !z2) {
            ...
            int i9 = (Integer.parseInt(matcher.group(11)) * 60) + Integer.parseInt(matcher.group(12));
            if (matcher.group(10).charAt(0) == '-') {
                i9 = -i9;
            }
            timeInMillis -= ((long) i9) * 60000;
