...
public class FileDataStoreFactory extends AbstractDataStoreFactory {
    ...
    private static final boolean IS_WINDOWS = StandardSystemProperty.OS_NAME.value().toLowerCase(Locale.ENGLISH).startsWith(ResourceAttributes.OsTypeValues.WINDOWS);
