...
public class FirebaseInstanceId {
    ...
    class zza {
        ...
        private final Boolean zzc() {
            ...
            try {
                ...
                if (packageManager == null || (applicationInfo = MAMPackageManagement.getApplicationInfo(packageManager, applicationContext.getPackageName(), 128)) == null || applicationInfo.metaData == null || !applicationInfo.metaData.containsKey("firebase_messaging_auto_init_enabled")) {
                    return null;
                }
        ...
        private final boolean zzd() {
            try {
                ...
                ResolveInfo resolveInfoResolveService = MAMPackageManagement.resolveService(applicationContext.getPackageManager(), intent, 0);
    ...
    final synchronized void zza(long j) throws Throwable {
        try {
            try {
