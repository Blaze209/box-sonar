...
public final class zzaq {
    ...
    public final synchronized int zza() {
        ...
        if (MAMPackageManagement.checkPermission(packageManager, "com.google.android.c2dm.permission.SEND", "com.google.android.gms") == -1) {
        ...
        List<ResolveInfo> listQueryBroadcastReceivers = MAMPackageManagement.queryBroadcastReceivers(packageManager, intent2, 0);
    ...
    private final PackageInfo zza(String str) {
        try {
            return MAMPackageManagement.getPackageInfo(this.zza.getPackageManager(), str, 0);
