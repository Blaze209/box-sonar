...
public final class zzo {
    ...
    static boolean zza() {
        ...
        try {
            ...
            try {
                ...
                if (packageManager != null && (applicationInfo = MAMPackageManagement.getApplicationInfo(packageManager, applicationContext.getPackageName(), 128)) != null && applicationInfo.metaData != null && applicationInfo.metaData.containsKey("delivery_metrics_exported_to_big_query_enabled")) {
    ...
    static int zzm(Intent intent) {
        ...
        return SemanticAttributes.MessagingRocketmqMessageTypeValues.NORMAL.equals(stringExtra) ? 2 : 0;
    }
