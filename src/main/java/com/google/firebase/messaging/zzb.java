...
public final class zzb {
    ...
    static zza zza(Context context, zzn zznVar) {
        ...
        if (TextUtils.isEmpty(strZzb2)) {
            ...
            defaultUri = ("default".equals(strZzb2) || resources.getIdentifier(strZzb2, "raw", packageName) == 0) ? RingtoneManager.getDefaultUri(2) : Uri.parse(new StringBuilder(String.valueOf(packageName).length() + 24 + String.valueOf(strZzb2).length()).append("android.resource://").append(packageName).append("/raw/").append(strZzb2).toString());
        }
        if (defaultUri != null) {
        ...
        if (TextUtils.isEmpty(strZza)) {
            ...
            if (uriZza != null) {
                ...
                Intent launchIntentForPackage = MAMPackageManagement.getLaunchIntentForPackage(packageManager, packageName);
        ...
        if (intent == null) {
            ...
            activity = MAMPendingIntent.getActivity(context, zza.incrementAndGet(), intent, 1073741824);
    ...
    private static int zza(PackageManager packageManager, Resources resources, String str, String str2, Bundle bundle) {
        ...
        if (i == 0 || !zza(resources, i)) {
            try {
                i = MAMPackageManagement.getApplicationInfo(packageManager, str, 0).icon;
    ...
    private static String zzb(Context context, String str, Bundle bundle) {
        try {
            if (MAMPackageManagement.getApplicationInfo(context.getPackageManager(), context.getPackageName(), 0).targetSdkVersion < 26) {
                return null;
            }
    ...
    private static PendingIntent zza(Context context, Intent intent) {
        return MAMPendingIntent.getBroadcast(context, zza.incrementAndGet(), new Intent("com.google.firebase.MESSAGING_EVENT").setComponent(new ComponentName(context, "com.google.firebase.iid.FirebaseInstanceIdReceiver")).putExtra("wrapped_intent", intent), 1073741824);
    }
}
