...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public RemoteMessage build() {
            ...
            this.zza.remove(TypedValues.TransitionType.S_FROM);
    ...
    public final String getFrom() {
        return this.zza.getString(TypedValues.TransitionType.S_FROM);
    }
    ...
    private static int zza(String str) {
        ...
        return SemanticAttributes.MessagingRocketmqMessageTypeValues.NORMAL.equals(str) ? 2 : 0;
    }
