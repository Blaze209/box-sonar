...
class CrashlyticsController {
    ...
    /* synthetic */ void m13779xe0c67ca9(String str) {
    ...
    static List<NativeSessionFile> getNativeSessionFiles(NativeSessionFileProvider nativeSessionFileProvider, String str, FileStore fileStore, byte[] bArr) {
        ...
        ArrayList arrayList = new ArrayList();
        arrayList.add(new BytesBackedNativeSessionFile("logs_file", FileTree.LOGS_DIR, bArr));
        ...
        arrayList.add(new FileBackedNativeSessionFile("device_meta_file", SemanticAttributes.EventDomainValues.DEVICE, nativeSessionFileProvider.getDeviceFile()));
