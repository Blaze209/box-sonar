...
public class IdManager implements InstallIdProvider {
    ...
    public String getModelName() {
        return String.format(Locale.US, CommandParameters.APPLICATION_IDENTIFIER_FORMAT, removeForwardSlashesIn(Build.MANUFACTURER), removeForwardSlashesIn(Build.MODEL));
    }
