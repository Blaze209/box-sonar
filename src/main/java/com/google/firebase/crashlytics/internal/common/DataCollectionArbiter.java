...
public class DataCollectionArbiter {
    ...
    private static Boolean readCrashlyticsDataCollectionEnabledFromManifest(Context context) {
        ...
        try {
            ...
            if (packageManager == null || (applicationInfo = MAMPackageManagement.getApplicationInfo(packageManager, context.getPackageName(), 128)) == null || applicationInfo.metaData == null || !applicationInfo.metaData.containsKey(FIREBASE_CRASHLYTICS_COLLECTION_ENABLED)) {
                return null;
            }
