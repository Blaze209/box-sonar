...
public final class SessionLifecycleService extends MAMService {
    ...
    public static final class MessageHandler extends Handler {
        ...
        private final boolean isSessionRestart(long foregroundTimeMs) {
            return foregroundTimeMs - this.lastMsgTimeMs > Duration.m16167getInWholeMillisecondsimpl(SessionsSettings.INSTANCE.getInstance().m13829getSessionRestartTimeoutUwyO8pc());
        }
    }
