...
public final class SessionEvents {
    ...
    public final ApplicationInfo getApplicationInfo(FirebaseApp firebaseApp) throws PackageManager.NameNotFoundException {
        ...
        PackageInfo packageInfo = MAMPackageManagement.getPackageInfo(applicationContext.getPackageManager(), packageName, 0);
        ...
        return new ApplicationInfo(applicationId, MODEL, BuildConfig.VERSION_NAME, RELEASE, logEnvironment, new AndroidApplicationInfo(packageName, str2, strValueOf, MANUFACTURER, currentProcessDetails, processDetailsProvider2.getAppProcessDetails(applicationContext3)));
    }
