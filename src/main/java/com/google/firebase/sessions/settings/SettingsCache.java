...
public final class SettingsCache {
    ...
    static final class C18021<T> extends ContinuationImpl {
        int label;
    ...
    public final <T> Object updateConfigValue(Preferences.Key<T> key, T t, Continuation<? super Unit> continuation) {
        C18021 c18021;
        if (continuation instanceof C18021) {
            c18021 = (C18021) continuation;
            if ((c18021.label & Integer.MIN_VALUE) != 0) {
                c18021.label -= Integer.MIN_VALUE;
            } else {
                c18021 = new C18021(continuation);
            }
        } else {
            c18021 = new C18021(continuation);
        }
        Object obj = c18021.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c18021.label;
        try {
            if (i == 0) {
                ...
                c18021.label = 1;
                if (PreferencesKt.edit(dataStore, anonymousClass2, c18021) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
