...
public final class SessionsSettings {
    ...
    public final long m13829getSessionRestartTimeoutUwyO8pc() {
        Duration durationMo13827getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo13827getSessionRestartTimeoutFghU774();
        if (durationMo13827getSessionRestartTimeoutFghU774 != null) {
            long rawValue = durationMo13827getSessionRestartTimeoutFghU774.getRawValue();
            if (m13828isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration durationMo13827getSessionRestartTimeoutFghU775 = this.remoteSettings.mo13827getSessionRestartTimeoutFghU774();
        if (durationMo13827getSessionRestartTimeoutFghU775 != null) {
            long rawValue2 = durationMo13827getSessionRestartTimeoutFghU775.getRawValue();
            if (m13828isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m13828isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m16183isPositiveimpl(sessionRestartTimeout) && Duration.m16178isFiniteimpl(sessionRestartTimeout);
    }
