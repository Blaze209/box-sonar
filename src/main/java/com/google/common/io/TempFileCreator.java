...
abstract class TempFileCreator {
    ...
    static final class JavaNioCreator extends TempFileCreator {
        ...
        private static String getUsername() {
            ...
            try {
                ...
                return (String) Objects.requireNonNull(cls3.getMethod("orElse", Object.class).invoke(cls2.getMethod("user", new Class[0]).invoke(cls.getMethod(BoxRepresentation.FIELD_INFO, new Class[0]).invoke(method.invoke(null, new Object[0]), new Object[0]), new Object[0]), str));
    ...
    private static final class JavaIoCreator extends TempFileCreator {
        ...
        File createTempDir() {
            ...
            String str = System.currentTimeMillis() + CacheKeyValueDelegate.CACHE_VALUE_SEPARATOR;
