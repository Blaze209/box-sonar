...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static class Segment<K, V> extends ReentrantLock {
            ...
            try {
                try {
                    try {
                        ...
                        segment = this;
                        k = key;
                        V vLockedGetOrLoad = segment.lockedGetOrLoad(k, hash, loader);
                        segment.postReadCleanup();
        ...
        ListenableFuture<V> loadAsync(final K key, final int hash, final LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> loader) {
            ...
            listenableFutureLoadFuture.addListener(new Runnable() { // from class: com.google.common.cache.LocalCache$Segment$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m13732lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(key, hash, loadingValueReference, listenableFutureLoadFuture);
                }
        ...
        /* synthetic */ void m13732lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(Object obj, int i, LoadingValueReference loadingValueReference, ListenableFuture listenableFuture) {
            try {
            ...
            try {
                ...
                while (next != null) {
                    ...
                    if (next.getHash() != hash || key2 == null || !this.map.keyEquivalence.equivalent(key, key2)) {
                        ...
                        this.modCount++;
                        segment = this;
                        ReferenceEntry<K, V> referenceEntryRemoveValueFromChain = segment.removeValueFromChain(referenceEntry, next, key2, hash, v, valueReference, removalCause2);
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
            ...
            try {
                ...
                return Futures.transform(listenableFutureReload, new Function() { // from class: com.google.common.cache.LocalCache$LoadingValueReference$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return this.f$0.m13731x59597480(obj);
                    }
                }, MoreExecutors.directExecutor());
            } catch (Throwable th) {
        ...
        /* synthetic */ Object m13731x59597480(Object obj) {
            set(obj);
            return obj;
        }
