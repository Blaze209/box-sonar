...
public final class MediaType {
    ...
    public static final MediaType HTML_UTF_8 = createConstantUtf8("text", TextRecognitionConverter.Tags.HTML);
    ...
    public static final MediaType TEXT_JAVASCRIPT_UTF_8 = createConstantUtf8("text", JavascriptRunner.JAVA_SCRIPT_TYPE);
    ...
    public static final MediaType GIF = createConstant("image", SupportedFileExtensions.GIF_EXTENSION);
    ...
    public static final MediaType PNG = createConstant("image", BoxRepresentation.TYPE_PNG);
    ...
    public static final MediaType MP4_AUDIO = createConstant("audio", BoxRepresentation.TYPE_MP4);
    ...
    public static final MediaType MP4_VIDEO = createConstant("video", BoxRepresentation.TYPE_MP4);
    ...
    public static final MediaType JAVASCRIPT_UTF_8 = createConstantUtf8("application", JavascriptRunner.JAVA_SCRIPT_TYPE);
    ...
    public static final MediaType FONT_COLLECTION = createConstant(FONT_TYPE, BoxCollection.TYPE);
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.on("; ").withKeyValueSeparator(SimpleComparison.EQUAL_TO_OPERATION);
