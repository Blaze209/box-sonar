...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    public String toString() {
        ...
        sb.append(CommentBarInputBoxKt.MENTION_SYMBOL).append(Integer.toHexString(System.identityHashCode(this))).append("[status=");
        if (isCancelled()) {
            sb.append("CANCELLED");
        } else if (isDone()) {
            addDoneString(sb);
    ...
    private void appendResultObject(StringBuilder builder, @CheckForNull Object o) {
        if (o == null) {
            ...
            builder.append(o.getClass().getName()).append(CommentEntityDomainMapper.MENTIONS_SYMBOL).append(Integer.toHexString(System.identityHashCode(o)));
        }
    }
