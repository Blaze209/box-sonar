...
final class zzr {
    ...
    static /* bridge */ /* synthetic */ Bundle zzb(zzr zzrVar, String str) {
        ...
        try {
            numValueOf = Integer.valueOf(MAMPackageManagement.getPackageInfo(zzrVar.zze.getPackageManager(), zzrVar.zze.getPackageName(), 0).versionCode);
    ...
    public static Bundle zzi() {
        ...
        bundle2.putInt("playcore_version_code", ((Integer) mapZza.get(ResourceAttributes.TelemetrySdkLanguageValues.JAVA)).intValue());
