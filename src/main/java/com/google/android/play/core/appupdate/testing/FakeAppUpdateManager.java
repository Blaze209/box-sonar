    ...
    public Task<AppUpdateInfo> getAppUpdateInfo() {
        ...
        if (zzb() == 2) {
            if (this.zzc.contains(0)) {
                broadcast = MAMPendingIntent.getBroadcast(this.zzb, 0, new Intent(), zza());
                broadcast3 = MAMPendingIntent.getBroadcast(this.zzb, 0, new Intent(), zza());
            } else {
                broadcast = null;
                broadcast3 = null;
            }
            if (this.zzc.contains(1)) {
                PendingIntent broadcast4 = MAMPendingIntent.getBroadcast(this.zzb, 0, new Intent(), zza());
                broadcast2 = MAMPendingIntent.getBroadcast(this.zzb, 0, new Intent(), zza());
