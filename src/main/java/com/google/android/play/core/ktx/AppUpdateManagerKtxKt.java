...
public final class AppUpdateManagerKtxKt {
    ...
    static final class C17981 extends SuspendLambda implements Function2<ProducerScope<? super AppUpdateResult>, Continuation<? super Unit>, Object> {
        final /* synthetic */ AppUpdateManager $this_requestUpdateFlow;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C17981(AppUpdateManager appUpdateManager, Continuation<? super C17981> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C17981 c17981 = new C17981(this.$this_requestUpdateFlow, continuation);
            c17981.L$0 = obj;
            return c17981;
        }
        ...
        public final Object invoke(ProducerScope<? super AppUpdateResult> producerScope, Continuation<? super Unit> continuation) {
            return ((C17981) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Object requestAppUpdateInfo(AppUpdateManager appUpdateManager, Continuation<? super AppUpdateInfo> continuation) {
        ...
        Intrinsics.checkNotNullExpressionValue(objRunTask$default, "runTask(appUpdateInfo)");
    ...
    public static final <T> Object runTask(Task<T> task, final Function0<Unit> function0, Continuation<? super T> continuation) {
        ...
        if (task.isComplete()) {
            if (task.isSuccessful()) {
                cancellableContinuationImpl2.resumeWith(Result.m14780constructorimpl(task.getResult()));
            } else {
                Exception exception = task.getException();
                Intrinsics.checkNotNull(exception);
                cancellableContinuationImpl2.resumeWith(Result.m14780constructorimpl(ResultKt.createFailure(exception)));
            }
        } else {
            task.addOnSuccessListener(new OnSuccessListener() { // from class: com.google.android.play.core.ktx.AppUpdateManagerKtxKt$runTask$3$2
                ...
                public final void onSuccess(T t) {
                    cancellableContinuationImpl2.resumeWith(Result.m14780constructorimpl(t));
                }
            });
            task.addOnFailureListener(new OnFailureListener() { // from class: com.google.android.play.core.ktx.AppUpdateManagerKtxKt$runTask$3$3
                ...
                public final void onFailure(Exception exception2) {
                    ...
                    cancellableContinuationImpl2.resumeWith(Result.m14780constructorimpl(ResultKt.createFailure(exception2)));
                }
            });
        }
    ...
    public static final Flow<AppUpdateResult> requestUpdateFlow(AppUpdateManager appUpdateManager) throws InstallException {
        ...
        return FlowKt.conflate(FlowKt.callbackFlow(new C17981(appUpdateManager, null)));
    }
    ...
    public static final <E> boolean tryOffer(SendChannel<? super E> sendChannel, E e) {
        ...
        return ChannelResult.m16344isSuccessimpl(sendChannel.mo11206trySendJP2dKIU(e));
    }
}
