...
public class AlarmManagerScheduler implements WorkScheduler {
    ...
    boolean isJobServiceOn(Intent intent) {
        return MAMPendingIntent.getBroadcast(this.context, 0, intent, 603979776) != null;
    }
    ...
    public void schedule(TransportContext transportContext, int i, boolean z) {
        ...
        this.alarmManager.set(3, this.clock.getTime() + scheduleDelay, MAMPendingIntent.getBroadcast(this.context, 0, intent, 67108864));
    }
}
