...
public final class zzfz {
    ...
    protected final void zza(String str) {
        ...
        zzgc zzgcVar = new zzgc(this, str);
        this.zza.zzq().zzd();
        ...
        if (listQueryIntentServices != null && !listQueryIntentServices.isEmpty()) {
            ...
            if (resolveInfo.serviceInfo != null) {
                ...
                if (resolveInfo.serviceInfo.name != null && "com.android.vending".equals(str2) && zzb()) {
                    try {
                        this.zza.zzr().zzx().zza("Install Referrer Service is", ConnectionTracker.getInstance().bindService(this.zza.zzn(), new Intent(intent), zzgcVar, 1) ? "available" : "not available");
                        return;
                    } catch (Exception e) {
    ...
    final Bundle zza(String str, com.google.android.gms.internal.measurement.zzd zzdVar) {
        ...
        bundle.putString(Analytics.Data.PACKAGE_NAME, str);
        try {
