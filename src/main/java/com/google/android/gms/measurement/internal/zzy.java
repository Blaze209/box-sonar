...
public final class zzy implements Parcelable.Creator<zzv> {
    ...
    public final /* synthetic */ zzv createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iValidateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(header)) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    zzkzVar = (zzkz) SafeParcelReader.createParcelable(parcel, header, zzkz.CREATOR);
                    break;
                case 5:
        ...
        return new zzv(strCreateString, strCreateString2, zzkzVar, j, z, strCreateString3, zzanVar, j2, zzanVar2, j3, zzanVar3);
    }
}
