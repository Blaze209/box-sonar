...
public class GooglePlayServicesUtilLight {
    ...
    public static int getApkVersion(Context context) {
        try {
            return MAMPackageManagement.getPackageInfo(context.getPackageManager(), "com.google.android.gms", 0).versionCode;
    ...
    public static Resources getRemoteResource(Context context) {
        try {
            return MAMPackageManagement.getResourcesForApplication(context.getPackageManager(), "com.google.android.gms");
        } catch (PackageManager.NameNotFoundException unused) {
            return null;
        }
    }
    ...
    public static boolean isRestrictedUserProfile(Context context) {
        ...
        return applicationRestrictions != null && TelemetryEventStrings.Value.TRUE.equals(applicationRestrictions.getString("restricted_profile"));
    }
    ...
    static boolean zza(Context context, String str) {
        ...
        try {
            ApplicationInfo applicationInfo = MAMPackageManagement.getApplicationInfo(context.getPackageManager(), str, 8192);
            if (zEquals) {
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        ...
        if (z) {
            try {
                packageInfo = MAMPackageManagement.getPackageInfo(packageManager, "com.android.vending", 8256);
            } catch (PackageManager.NameNotFoundException unused2) {
        ...
        try {
            PackageInfo packageInfo2 = MAMPackageManagement.getPackageInfo(packageManager, "com.google.android.gms", 64);
            GoogleSignatureVerifier.getInstance(context);
                ...
                if (!z) {
                    ...
                    if (com.google.android.gms.common.util.zza.zza(packageInfo2.versionCode) >= com.google.android.gms.common.util.zza.zza(i)) {
                        ...
                        if (applicationInfo == null) {
                            applicationInfo = MAMPackageManagement.getApplicationInfo(packageManager, "com.google.android.gms", 0);
                        }
