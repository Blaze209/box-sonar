...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    final Dialog zaa(Context context, int i, zag zagVar, DialogInterface.OnCancelListener onCancelListener, DialogInterface.OnClickListener onClickListener) {
        ...
        MAMAlertDialogBuilder mAMAlertDialogBuilder2 = null;
        if (i == 0) {
            return null;
        }
        ...
        if ("Theme.Dialog.Alert".equals(context.getResources().getResourceEntryName(typedValue.resourceId))) {
            mAMAlertDialogBuilder = new MAMAlertDialogBuilder(context, 5);
        }
        if (mAMAlertDialogBuilder2 == null) {
            mAMAlertDialogBuilder2 = mAMAlertDialogBuilder;
            mAMAlertDialogBuilder2 = new MAMAlertDialogBuilder(context);
        }
        mAMAlertDialogBuilder2 = mAMAlertDialogBuilder;
        mAMAlertDialogBuilder2.setMessage(com.google.android.gms.common.internal.zac.zac(context, i));
        if (onCancelListener != null) {
            mAMAlertDialogBuilder2.setOnCancelListener(onCancelListener);
        }
        ...
        if (strZab != null) {
            ...
            mAMAlertDialogBuilder2.setPositiveButton(strZab, onClickListener2);
        }
        String strZaf = com.google.android.gms.common.internal.zac.zaf(context, i);
        if (strZaf != null) {
            mAMAlertDialogBuilder2.setTitle(strZaf);
        }
        Log.w("GoogleApiAvailability", String.format("Creating dialog for Google Play services availability issue. ConnectionResult=%s", Integer.valueOf(i)), new IllegalArgumentException());
        return mAMAlertDialogBuilder2.create();
    }
    ...
    public final Dialog zab(Activity activity, DialogInterface.OnCancelListener onCancelListener) {
        ...
        mAMAlertDialogBuilder.setMessage(com.google.android.gms.common.internal.zac.zac(activity, 18));
        mAMAlertDialogBuilder.setPositiveButton("", (DialogInterface.OnClickListener) null);
        AlertDialog alertDialogCreate = mAMAlertDialogBuilder.create();
    ...
    final void zae(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        MAMNotificationManagement.notify(notificationManager, i2, notificationBuild);
    }
    ...
    public final boolean zah(Context context, ConnectionResult connectionResult, int i) {
        ...
        zae(context, connectionResult.getErrorCode(), null, MAMPendingIntent.getActivity(context, 0, GoogleApiActivity.zaa(context, errorResolutionPendingIntent, i, true), zap.zaa | C.BUFFER_FLAG_FIRST_SAMPLE));
        return true;
    }
