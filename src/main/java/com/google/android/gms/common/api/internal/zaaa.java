...
final class zaaa implements zaca {
    ...
    private final PendingIntent zaz() {
        ...
        return MAMPendingIntent.getActivity(this.zaa, System.identityHashCode(this.zab), client.getSignInIntent(), com.google.android.gms.internal.base.zap.zaa | C.BUFFER_FLAG_FIRST_SAMPLE);
    }
