...
public class GoogleApiActivity extends MAMActivity implements DialogInterface.OnCancelListener {
    protected int zaa = 0;
    ...
    private final void zab() {
        ...
        Integer num = (Integer) extras.get(AuthenticationConstants.OAuth2.ERROR_CODE);
