...
public class GoogleSignatureVerifier {
    ...
    private final zzx zzc(@Nullable String str, boolean z, boolean z2) {
        ...
        if (zzn.zzg()) {
            ...
            try {
                PackageInfo packageInfo = MAMPackageManagement.getPackageInfo(this.zzc.getPackageManager(), str, 64);
    ...
    public boolean isUidGoogleSigned(int i) {
        zzx zzxVarZzc;
        String[] packagesForUid = MAMPackageManagement.getPackagesForUid(this.zzc.getPackageManager(), i);
