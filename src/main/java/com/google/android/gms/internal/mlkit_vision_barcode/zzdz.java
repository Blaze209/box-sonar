...
public abstract class zzdz<V> extends zzex implements zzet<V> {
    ...
    final class zzi extends zza {
        ...
        static {
            ...
            try {
                ...
                zzf = unsafe.objectFieldOffset(zzj.class.getDeclaredField(ES6Iterator.NEXT_METHOD));
                zza = unsafe;
        ...
        while (true) {
            ...
            while (zzdVar3 != null) {
                ...
                if (runnable2 instanceof zzf) {
                    ...
                    zzw(runnable2, (Executor) Objects.requireNonNull(zzdVar3.zzc));
                }
                zzdVar3 = zzdVar5;
            }
            return;
    ...
    public final boolean cancel(boolean z) {
        ...
        boolean z2 = false;
        while (true) {
            if (zzc.zzf(this, obj, objRequireNonNull)) {
                zzv(this, z);
                if (obj instanceof zzf) {
