...
final class zzfy {
    ...
    private static void zzd(zzfw zzfwVar, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (((Method) map2.get("set".concat(String.valueOf(strSubstring)))) != null && (!strSubstring.endsWith("Bytes") || !map.containsKey(PasskeyWebListener.GET_UNIQUE_KEY.concat(String.valueOf(strSubstring.substring(0, strSubstring.length() - 5)))))) {
                String strConcat3 = String.valueOf(strSubstring.substring(0, 1).toLowerCase()).concat(String.valueOf(strSubstring.substring(1)));
                Method method4 = (Method) map.get(PasskeyWebListener.GET_UNIQUE_KEY.concat(String.valueOf(strSubstring)));
