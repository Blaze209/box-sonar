            ...
            case 5:
                ...
                if (strongBinder2 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface2 instanceof zzn) {
                        zzpVar14 = (zzn) iInterfaceQueryLocalInterface2;
                    } else {
                        zzpVar14 = new zzp(strongBinder2);
                    }
                }
                getUserProperties(string3, string4, zZza, zzpVar14);
                break;
            case 6:
                ...
                if (strongBinder3 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface3 instanceof zzn) {
                        zzpVar13 = (zzn) iInterfaceQueryLocalInterface3;
                    } else {
                        zzpVar13 = new zzp(strongBinder3);
                    }
                }
                getMaxUserProperties(string5, zzpVar13);
                break;
            case 7:
            ...
            case 10:
                ...
                if (strongBinder4 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface4 instanceof zzn) {
                        zzpVar12 = (zzn) iInterfaceQueryLocalInterface4;
                    } else {
                        zzpVar12 = new zzp(strongBinder4);
                    }
                }
                getConditionalUserProperties(string6, string7, zzpVar12);
                break;
            case 11:
            ...
            case 16:
                ...
                if (strongBinder5 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface5 instanceof zzn) {
                        zzpVar11 = (zzn) iInterfaceQueryLocalInterface5;
                    } else {
                        zzpVar11 = new zzp(strongBinder5);
                    }
                }
                getCurrentScreenName(zzpVar11);
                break;
            case 17:
                ...
                if (strongBinder6 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface6 instanceof zzn) {
                        zzpVar10 = (zzn) iInterfaceQueryLocalInterface6;
                    } else {
                        zzpVar10 = new zzp(strongBinder6);
                    }
                }
                getCurrentScreenClass(zzpVar10);
                break;
            case 18:
            ...
            case 19:
                ...
                if (strongBinder8 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface8 instanceof zzn) {
                        zzpVar9 = (zzn) iInterfaceQueryLocalInterface8;
                    } else {
                        zzpVar9 = new zzp(strongBinder8);
                    }
                }
                getCachedAppInstanceId(zzpVar9);
                break;
            case 20:
                ...
                if (strongBinder9 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface9 instanceof zzn) {
                        zzpVar8 = (zzn) iInterfaceQueryLocalInterface9;
                    } else {
                        zzpVar8 = new zzp(strongBinder9);
                    }
                }
            ...
            case 21:
                ...
                if (strongBinder10 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface10 instanceof zzn) {
                        zzpVar7 = (zzn) iInterfaceQueryLocalInterface10;
                    } else {
                        zzpVar7 = new zzp(strongBinder10);
                    }
                }
                getGmpAppId(zzpVar7);
                break;
            case 22:
                ...
                if (strongBinder11 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface11 instanceof zzn) {
                        zzpVar6 = (zzn) iInterfaceQueryLocalInterface11;
                    } else {
                        zzpVar6 = new zzp(strongBinder11);
                    }
                }
                generateEventId(zzpVar6);
                break;
            case 23:
            ...
            case 31:
                ...
                if (strongBinder12 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface12 instanceof zzn) {
                        zzpVar5 = (zzn) iInterfaceQueryLocalInterface12;
                    } else {
                        zzpVar5 = new zzp(strongBinder12);
                    }
                }
                onActivitySaveInstanceState(iObjectWrapperAsInterface, zzpVar5, parcel.readLong());
                break;
            case 32:
                ...
                if (strongBinder13 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface13 instanceof zzn) {
                        zzpVar4 = (zzn) iInterfaceQueryLocalInterface13;
                    } else {
                        zzpVar4 = new zzp(strongBinder13);
                    }
                }
                performAction(bundle2, zzpVar4, parcel.readLong());
                break;
            case 33:
            ...
            case 38:
                ...
                if (strongBinder17 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface17 instanceof zzn) {
                        zzpVar3 = (zzn) iInterfaceQueryLocalInterface17;
                    } else {
                        zzpVar3 = new zzp(strongBinder17);
                    }
                }
                getTestFlag(zzpVar3, parcel.readInt());
                break;
            case 39:
            ...
            case 40:
                ...
                if (strongBinder18 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface18 instanceof zzn) {
                        zzpVar2 = (zzn) iInterfaceQueryLocalInterface18;
                    } else {
                        zzpVar2 = new zzp(strongBinder18);
                    }
                }
                isDataCollectionEnabled(zzpVar2);
                break;
            default:
                return false;
        }
