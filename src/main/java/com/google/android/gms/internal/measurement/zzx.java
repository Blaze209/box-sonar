...
public class zzx {
    ...
    private List<Pair<com.google.android.gms.measurement.internal.zzhn, zzb>> zzf;
    private int zzg;
    private boolean zzp;
    private String zzq;
    private zzm zzr;
    ...
    public final void zza(Exception exc, boolean z, boolean z2) {
        ...
        if (z2) {
            zzxVar = this;
            exc2 = exc;
            zzxVar.zza(5, "Error with data collection. Data lost.", exc2, (Object) null, (Object) null);
        } else {
            zzxVar = this;
            exc2 = exc;
        }
        Log.w(zzxVar.zzc, "Error with data collection. Data lost.", exc2);
    }
    ...
    public static boolean zzb(Context context) {
        ...
        synchronized (zzx.class) {
            if (!zzj) {
                try {
                    try {
                        String str = (String) Class.forName("android.os.SystemProperties").getMethod(PasskeyWebListener.GET_UNIQUE_KEY, String.class, String.class).invoke(null, "measurement.dynamite.enabled", "");
