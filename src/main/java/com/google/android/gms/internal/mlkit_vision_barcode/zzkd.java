...
final class zzkd implements ObjectEncoder {
    ...
    static {
        FieldDescriptor.Builder builder = FieldDescriptor.builder(DiagnosisParams.DIAGNOSIS_MODE);
        ...
        FieldDescriptor.Builder builder3 = FieldDescriptor.builder(BoxItem.FIELD_CLASSIFICATION);
