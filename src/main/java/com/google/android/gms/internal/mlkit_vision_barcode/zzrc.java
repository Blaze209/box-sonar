...
public enum zzrc implements zzfc {
    ...
    ON_DEVICE_IMAGE_LABEL_DETECT(Token.SETELEM_OP),
    ON_DEVICE_IMAGE_LABEL_CREATE(Token.LOCAL_BLOCK),
    ON_DEVICE_IMAGE_LABEL_CLOSE(Token.SET_REF_OP),
    ON_DEVICE_IMAGE_LABEL_LOAD(Token.DOTDOT),
    ON_DEVICE_SMART_REPLY_DETECT(Token.TO_DOUBLE),
    ON_DEVICE_SMART_REPLY_CREATE(Token.GET),
    ON_DEVICE_SMART_REPLY_CLOSE(Token.SET),
    ON_DEVICE_SMART_REPLY_BLACKLIST_UPDATE(Token.LET),
    ON_DEVICE_SMART_REPLY_LOAD(Token.CONST),
    ...
    CLOUD_WEB_SEARCH_CREATE(Token.LABEL),
    CLOUD_WEB_SEARCH_DETECT(Token.TARGET),
    CLOUD_WEB_SEARCH_CLOSE(Token.LOOP),
    ...
    AGGREGATED_CUSTOM_IMAGE_LABEL_DETECTION(BoxCommonConstants.REQUEST_OPTIONS),
    AGGREGATED_ON_DEVICE_EXPLICIT_CONTENT_DETECTION(BoxCommonConstants.REQUEST_DELETE),
    AGGREGATED_ON_DEVICE_FACE_MESH_DETECTION(BoxCommonConstants.REQUEST_RENAME),
    ...
    AGGREGATED_ON_DEVICE_SHADOW_REMOVAL_PROCESS(BoxCommonConstants.REQUEST_INVITE_COLLABORATORS),
    ...
    ACCELERATION_ALLOWLIST_GET(HttpStatus.SC_REQUEST_HEADER_FIELDS_TOO_LARGE),
    ...
    TOXICITY_DETECTION_CREATE_EVENT(HttpStatus.SC_UNAVAILABLE_FOR_LEGAL_REASONS),
