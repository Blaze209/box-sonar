...
public final class zzjf implements zzjg {
    ...
    static {
        ...
        zzh = zzcrVar.zza("measurement.store.max_stored_events_per_app", SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US);
        ...
        zzt = zzcrVar.zza("measurement.upload.backoff_period", MAMWERetryScheduler.DEFAULT_UNLICENSED_RETRY_INTERVAL_MS);
        ...
        zzab = zzcrVar.zza("measurement.upload.max_events_per_day", SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US);
        ...
        zzah = zzcrVar.zza("measurement.upload.retry_time", Constants.SESSION_TIMEOUT_MILLIS);
