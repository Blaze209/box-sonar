...
class TimePickerClockPresenter implements ClockHandView.OnRotateListener, TimePickerView.OnSelectionChange, TimePickerView.OnPeriodChangeListener, ClockHandView.OnActionUpListener, TimePickerPresenter {
    ...
    private static final String[] HOUR_CLOCK_VALUES = {GrpcStatusUtil.GRPC_STATUS_UNIMPLEMENTED, "1", "2", ExifInterface.GPS_MEASUREMENT_3D, GrpcStatusUtil.GRPC_STATUS_DEADLINE_EXCEEDED, "5", "6", "7", GrpcStatusUtil.GRPC_STATUS_RESOURCE_EXHAUSTED, "9", GrpcStatusUtil.GRPC_STATUS_ABORTED, GrpcStatusUtil.GRPC_STATUS_OUT_OF_RANGE};
    private static final String[] HOUR_CLOCK_24_VALUES = {"00", "1", "2", ExifInterface.GPS_MEASUREMENT_3D, GrpcStatusUtil.GRPC_STATUS_DEADLINE_EXCEEDED, "5", "6", "7", GrpcStatusUtil.GRPC_STATUS_RESOURCE_EXHAUSTED, "9", GrpcStatusUtil.GRPC_STATUS_ABORTED, GrpcStatusUtil.GRPC_STATUS_OUT_OF_RANGE, GrpcStatusUtil.GRPC_STATUS_UNIMPLEMENTED, "13", GrpcStatusUtil.GRPC_STATUS_UNAVAILABLE, GrpcStatusUtil.GRPC_STATUS_DATA_LOSS, "16", "17", "18", "19", "20", PublicApiId.PCA_ACQUIRE_TOKEN_SILENT_WITH_PARAMETERS, PublicApiId.PCA_ACQUIRE_TOKEN_SILENT_ASYNC_WITH_PARAMETERS, PublicApiId.SINGLE_ACCOUNT_PCA_ACQUIRE_TOKEN_SILENT_WITH_PARAMETERS};
    private static final String[] MINUTE_CLOCK_VALUES = {"00", "5", GrpcStatusUtil.GRPC_STATUS_ABORTED, GrpcStatusUtil.GRPC_STATUS_DATA_LOSS, "20", PublicApiId.SINGLE_ACCOUNT_PCA_ACQUIRE_TOKEN_SILENT_WITH_SCOPES_AUTHORITY, PublicApiId.MULTIPLE_ACCOUNT_PCA_ACQUIRE_TOKEN_SILENT_WITH_PARAMETERS, "35", "40", "45", "50", "55"};
