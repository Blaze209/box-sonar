...
abstract class ChaCha20Base implements IndCpaCipher {
    ...
    private static final int[] SIGMA = toIntArray(new byte[]{101, 120, 112, 97, 110, 100, 32, CtapException.ERR_PIN_AUTH_INVALID, CtapException.ERR_PIN_BLOCKED, CtapException.ERR_KEEPALIVE_CANCEL, 98, 121, 116, 101, 32, 107});
