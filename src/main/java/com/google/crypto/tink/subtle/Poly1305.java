...
class Poly1305 {
    ...
    static byte[] computeMac(final byte[] key, byte[] data) {
        ...
        while (i3 < data.length) {
            ...
            long jLoad211 = j9 + load26(bArr, 0, 0);
            long jLoad212 = j5 + load26(bArr, i, i2);
            long jLoad213 = j6 + load26(bArr, 6, 4);
            long jLoad214 = j7 + load26(bArr, 9, 6);
            long j10 = jLoad27;
            long jLoad215 = j8 + (load26(bArr, 12, 8) | ((long) (bArr[16] << Ascii.CAN)));
            long j11 = (jLoad211 * jLoad26) + (jLoad212 * j4) + (jLoad213 * j3) + (jLoad214 * j2) + (jLoad215 * j);
            long j12 = (jLoad211 * j10) + (jLoad212 * jLoad26) + (jLoad213 * j4) + (jLoad214 * j3) + (jLoad215 * j2);
            long j13 = (jLoad211 * jLoad28) + (jLoad212 * j10) + (jLoad213 * jLoad26) + (jLoad214 * j4) + (jLoad215 * j3);
            long j14 = (jLoad211 * jLoad29) + (jLoad212 * jLoad28) + (jLoad213 * j10) + (jLoad214 * jLoad26) + (jLoad215 * j4);
            long j15 = (jLoad211 * jLoad210) + (jLoad212 * jLoad29) + (jLoad213 * jLoad28) + (jLoad214 * j10) + (jLoad215 * jLoad26);
            long j16 = j12 + (j11 >> 26);
            long j17 = j13 + (j16 >> 26);
            j6 = j17 & 67108863;
            long j18 = j14 + (j17 >> 26);
        ...
        long jLoad33 = j49 + load32(key, 20) + (jLoad32 >> 32);
        long j53 = jLoad33 & 4294967295L;
        long jLoad34 = j50 + load32(key, 24) + (jLoad33 >> 32);
        long j54 = jLoad34 & 4294967295L;
        long jLoad35 = (j51 + load32(key, 28) + (jLoad34 >> 32)) & 4294967295L;
