...
final class MessageLiteToString {
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (((Method) map2.get("set" + strSubstring)) != null && (!strSubstring.endsWith(BYTES_SUFFIX) || !map.containsKey(PasskeyWebListener.GET_UNIQUE_KEY + strSubstring.substring(0, strSubstring.length() - BYTES_SUFFIX.length())))) {
                String str4 = strSubstring.substring(0, 1).toLowerCase() + strSubstring.substring(1);
                Method method4 = (Method) map.get(PasskeyWebListener.GET_UNIQUE_KEY + strSubstring);
