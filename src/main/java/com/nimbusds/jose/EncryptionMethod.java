...
public final class EncryptionMethod extends Algorithm {
    ...
    public static final EncryptionMethod A128CBC_HS256 = new EncryptionMethod(ContentEncryptionAlgorithmIdentifiers.AES_128_CBC_HMAC_SHA_256, Requirement.REQUIRED, 256);
    public static final EncryptionMethod A192CBC_HS384 = new EncryptionMethod(ContentEncryptionAlgorithmIdentifiers.AES_192_CBC_HMAC_SHA_384, Requirement.OPTIONAL, 384);
    public static final EncryptionMethod A256CBC_HS512 = new EncryptionMethod(ContentEncryptionAlgorithmIdentifiers.AES_256_CBC_HMAC_SHA_512, Requirement.REQUIRED, 512);
    ...
    public static final EncryptionMethod A128GCM = new EncryptionMethod(ContentEncryptionAlgorithmIdentifiers.AES_128_GCM, Requirement.RECOMMENDED, 128);
    public static final EncryptionMethod A192GCM = new EncryptionMethod(ContentEncryptionAlgorithmIdentifiers.AES_192_GCM, Requirement.OPTIONAL, 192);
    public static final EncryptionMethod A256GCM = new EncryptionMethod(ContentEncryptionAlgorithmIdentifiers.AES_256_GCM, Requirement.RECOMMENDED, 256);
