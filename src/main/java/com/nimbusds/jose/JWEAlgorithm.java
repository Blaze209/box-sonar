...
public final class JWEAlgorithm extends Algorithm {
    ...
    @Deprecated
    public static final JWEAlgorithm RSA1_5 = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.RSA1_5, Requirement.REQUIRED);

    @Deprecated
    public static final JWEAlgorithm RSA_OAEP = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.RSA_OAEP, Requirement.OPTIONAL);
    public static final JWEAlgorithm RSA_OAEP_256 = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.RSA_OAEP_256, Requirement.OPTIONAL);
    ...
    public static final JWEAlgorithm A128KW = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.A128KW, Requirement.RECOMMENDED);
    public static final JWEAlgorithm A192KW = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.A192KW, Requirement.OPTIONAL);
    public static final JWEAlgorithm A256KW = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.A256KW, Requirement.RECOMMENDED);
    public static final JWEAlgorithm DIR = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.DIRECT, Requirement.RECOMMENDED);
    public static final JWEAlgorithm ECDH_ES = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.ECDH_ES, Requirement.RECOMMENDED);
    public static final JWEAlgorithm ECDH_ES_A128KW = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.ECDH_ES_A128KW, Requirement.RECOMMENDED);
    public static final JWEAlgorithm ECDH_ES_A192KW = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.ECDH_ES_A192KW, Requirement.OPTIONAL);
    public static final JWEAlgorithm ECDH_ES_A256KW = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.ECDH_ES_A256KW, Requirement.RECOMMENDED);
    ...
    public static final JWEAlgorithm A128GCMKW = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.A128GCMKW, Requirement.OPTIONAL);
    public static final JWEAlgorithm A192GCMKW = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.A192GCMKW, Requirement.OPTIONAL);
    public static final JWEAlgorithm A256GCMKW = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.A256GCMKW, Requirement.OPTIONAL);
    public static final JWEAlgorithm PBES2_HS256_A128KW = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.PBES2_HS256_A128KW, Requirement.OPTIONAL);
    public static final JWEAlgorithm PBES2_HS384_A192KW = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.PBES2_HS384_A192KW, Requirement.OPTIONAL);
    public static final JWEAlgorithm PBES2_HS512_A256KW = new JWEAlgorithm(KeyManagementAlgorithmIdentifiers.PBES2_HS512_A256KW, Requirement.OPTIONAL);
