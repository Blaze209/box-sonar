...
public class JWSObjectJSON extends JOSEObjectJSON {
    ...
    public static final class Signature {
        ...
        public Map<String, Object> toJSONObject() {
            ...
            if (unprotectedHeader != null && !unprotectedHeader.getIncludedParams().isEmpty()) {
                mapNewJSONObject.put(BoxAnalyticsParams.CTA_LOCATION_HEADER, this.unprotectedHeader.toJSONObject());
            }
            mapNewJSONObject.put(FidoConstants.WEBAUTHN_RESPONSE_SIGNATURE_JSON_KEY, this.signature.toString());
    ...
    public static JWSObjectJSON parse(Map<String, Object> map) throws ParseException {
        ...
        Base64URL base64URL2 = JSONObjectUtils.getBase64URL(map, FidoConstants.WEBAUTHN_RESPONSE_SIGNATURE_JSON_KEY);
        boolean z = base64URL2 != null;
        LinkedList linkedList = new LinkedList();
        if (z) {
            JWSHeader jWSHeader = parseJWSHeader(map);
            UnprotectedHeader unprotectedHeader = UnprotectedHeader.parse(JSONObjectUtils.getJSONObject(map, BoxAnalyticsParams.CTA_LOCATION_HEADER));
            ...
            for (Map<String, Object> map2 : jSONObjectArray) {
                ...
                UnprotectedHeader unprotectedHeader2 = UnprotectedHeader.parse(JSONObjectUtils.getJSONObject(map2, BoxAnalyticsParams.CTA_LOCATION_HEADER));
                try {
                    HeaderValidation.ensureDisjoint(jWSHeader2, unprotectedHeader2);
                    Base64URL base64URL3 = JSONObjectUtils.getBase64URL(map2, FidoConstants.WEBAUTHN_RESPONSE_SIGNATURE_JSON_KEY);
                    if (base64URL3 == null) {
