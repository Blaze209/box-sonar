...
final class Base64Codec {
    ...
    static int decodeDigit(byte b) {
        ...
        return tpSelect(iTpGT3, b + 4, 0) | tpSelect(iTpGT, b + ByteSourceJsonBootstrapper.UTF8_BOM_3, 0) | tpSelect(iTpGT2, b - 71, 0) | tpSelect(iTpEq, 62, 0) | tpSelect(iTpEq2, 63, 0) | tpSelect(iTpGT | iTpGT2 | iTpGT3 | iTpEq | iTpEq2, 0, -1);
    }
