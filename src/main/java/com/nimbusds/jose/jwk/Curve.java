...
public final class Curve implements Serializable {
    ...
    public static final Curve P_256 = new Curve(EllipticCurves.P_256, "secp256r1", "1.2.840.10045.3.1.7");
    ...
    public static final Curve P_384 = new Curve(EllipticCurves.P_384, "secp384r1", "1.3.132.0.34");
    public static final Curve P_521 = new Curve(EllipticCurves.P_521, "secp521r1", "1.3.132.0.35");
