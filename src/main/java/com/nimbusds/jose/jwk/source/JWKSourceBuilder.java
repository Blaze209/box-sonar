...
public class JWKSourceBuilder<C extends SecurityContext> {
    ...
    /* JADX WARN: Code duplicated, block: B:70:0x00eb  */
    /* JADX WARN: Code duplicated, block: B:72:0x00f3 A[RETURN] */
    public JWKSource<C> build() {
        ...
        if (this.refreshAhead) {
            ...
            if (this.failover != null) {
                return new JWKSourceWithFailover(jWKSetBasedJWKSource, this.failover);
            }
