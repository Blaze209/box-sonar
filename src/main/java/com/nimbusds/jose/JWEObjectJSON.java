...
public class JWEObjectJSON extends JOSEObjectJSON {
    ...
    public static final class Recipient {
        ...
        public static Recipient parse(Map<String, Object> map) throws ParseException {
            return new Recipient(UnprotectedHeader.parse(JSONObjectUtils.getJSONObject(map, BoxAnalyticsParams.CTA_LOCATION_HEADER)), JSONObjectUtils.getBase64URL(map, "encrypted_key"));
        }
    }
