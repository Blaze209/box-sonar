...
public class BoxConstants {
    ...
    public static final String BASE_UPLOAD_URI_FEDRAMP_COMPLIANT = "https://upload.box-gov.com/api/2.0";
    ...
    public static final String BASE_URI_FEDRAMP_COMPLIANT = "https://api.box-gov.com/2.0";
    ...
    public static final String OAUTH_BASE_URI_FEDRAMP_COMPLIANT = "https://api.box-gov.com";
