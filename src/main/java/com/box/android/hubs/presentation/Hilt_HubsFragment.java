...
public abstract class Hilt_HubsFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((HubsFragment_GeneratedInjector) generatedComponent()).injectHubsFragment((HubsFragment) UnsafeCasts.unsafeCast(this));
    }
