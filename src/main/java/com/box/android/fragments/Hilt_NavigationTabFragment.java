...
abstract class Hilt_NavigationTabFragment extends TabLayoutFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((NavigationTabFragment_GeneratedInjector) generatedComponent()).injectNavigationTabFragment((NavigationTabFragment) UnsafeCasts.unsafeCast(this));
    }
