...
abstract class Hilt_PushRegistrationDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_PushRegistrationDialogFragment() {
        this.disableGetContextFix = false;
        this.componentManagerLock = new Object();
        this.injected = false;
    }

    Hilt_PushRegistrationDialogFragment(int i) {
        super(i);
        this.disableGetContextFix = false;
        this.componentManagerLock = new Object();
        this.injected = false;
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((PushRegistrationDialogFragment_GeneratedInjector) generatedComponent()).injectPushRegistrationDialogFragment((PushRegistrationDialogFragment) UnsafeCasts.unsafeCast(this));
    }
