...
abstract class Hilt_NotificationsTasksTabFragment extends TabLayoutFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_NotificationsTasksTabFragment() {
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((NotificationsTasksTabFragment_GeneratedInjector) generatedComponent()).injectNotificationsTasksTabFragment((NotificationsTasksTabFragment) UnsafeCasts.unsafeCast(this));
    }
