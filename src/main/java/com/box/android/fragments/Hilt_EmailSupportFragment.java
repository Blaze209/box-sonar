...
abstract class Hilt_EmailSupportFragment extends DialogFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_EmailSupportFragment() {
        this.disableGetContextFix = false;
        this.componentManagerLock = new Object();
        this.injected = false;
    }

    Hilt_EmailSupportFragment(int i) {
        super(i);
        this.disableGetContextFix = false;
        this.componentManagerLock = new Object();
        this.injected = false;
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((EmailSupportFragment_GeneratedInjector) generatedComponent()).injectEmailSupportFragment((EmailSupportFragment) UnsafeCasts.unsafeCast(this));
    }
