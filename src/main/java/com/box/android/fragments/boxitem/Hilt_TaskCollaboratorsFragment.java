...
abstract class Hilt_TaskCollaboratorsFragment extends BaseListingFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_TaskCollaboratorsFragment() {
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((TaskCollaboratorsFragment_GeneratedInjector) generatedComponent()).injectTaskCollaboratorsFragment((TaskCollaboratorsFragment) UnsafeCasts.unsafeCast(this));
    }
