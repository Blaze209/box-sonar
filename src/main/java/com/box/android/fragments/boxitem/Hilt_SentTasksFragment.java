...
abstract class Hilt_SentTasksFragment extends TasksFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((SentTasksFragment_GeneratedInjector) generatedComponent()).injectSentTasksFragment((SentTasksFragment) UnsafeCasts.unsafeCast(this));
    }
