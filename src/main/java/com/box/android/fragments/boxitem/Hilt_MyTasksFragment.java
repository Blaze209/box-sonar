...
abstract class Hilt_MyTasksFragment extends TasksFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((MyTasksFragment_GeneratedInjector) generatedComponent()).injectMyTasksFragment((MyTasksFragment) UnsafeCasts.unsafeCast(this));
    }
