...
abstract class Hilt_PushNotificationsFragment extends BaseListingFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_PushNotificationsFragment() {
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((PushNotificationsFragment_GeneratedInjector) generatedComponent()).injectPushNotificationsFragment((PushNotificationsFragment) UnsafeCasts.unsafeCast(this));
    }
