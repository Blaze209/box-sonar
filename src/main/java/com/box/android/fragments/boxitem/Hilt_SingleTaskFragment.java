...
abstract class Hilt_SingleTaskFragment extends TasksFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((SingleTaskFragment_GeneratedInjector) generatedComponent()).injectSingleTaskFragment((SingleTaskFragment) UnsafeCasts.unsafeCast(this));
    }
