...
import com.box.android.base.presentation.fragments.MultiSelectDialogFragment;
...
public abstract class Hilt_CollectionsMultiSelectDialogFragment<T> extends MultiSelectDialogFragment<T> implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((CollectionsMultiSelectDialogFragment_GeneratedInjector) generatedComponent()).injectCollectionsMultiSelectDialogFragment((CollectionsMultiSelectDialogFragment) UnsafeCasts.unsafeCast(this));
    }
