...
public abstract class Hilt_FavoritesCollectionItemsFragment<T, VB extends ViewBinding> extends BaseListingAbstractFragment<T, VB> implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((FavoritesCollectionItemsFragment_GeneratedInjector) generatedComponent()).injectFavoritesCollectionItemsFragment((FavoritesCollectionItemsFragment) UnsafeCasts.unsafeCast(this));
    }
