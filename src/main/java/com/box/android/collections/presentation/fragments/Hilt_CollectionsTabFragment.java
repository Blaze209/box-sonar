...
public abstract class Hilt_CollectionsTabFragment extends TabLayoutFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((CollectionsTabFragment_GeneratedInjector) generatedComponent()).injectCollectionsTabFragment((CollectionsTabFragment) UnsafeCasts.unsafeCast(this));
    }
