...
public abstract class Hilt_CollectionItemsFragment<T, VB extends ViewBinding> extends BaseListingAbstractFragment<T, VB> implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((CollectionItemsFragment_GeneratedInjector) generatedComponent()).injectCollectionItemsFragment((CollectionItemsFragment) UnsafeCasts.unsafeCast(this));
    }
