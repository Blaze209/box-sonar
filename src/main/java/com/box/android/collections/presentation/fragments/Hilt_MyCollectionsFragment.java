...
public abstract class Hilt_MyCollectionsFragment<T, VB extends ViewBinding> extends BaseListingAbstractFragment<T, VB> implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((MyCollectionsFragment_GeneratedInjector) generatedComponent()).injectMyCollectionsFragment((MyCollectionsFragment) UnsafeCasts.unsafeCast(this));
    }
