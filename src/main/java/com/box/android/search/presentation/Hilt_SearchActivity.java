...
public abstract class Hilt_SearchActivity extends BoxFragmentActivity {
    ...
    private void _initHiltInternal() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: com.box.android.search.presentation.Hilt_SearchActivity.1
