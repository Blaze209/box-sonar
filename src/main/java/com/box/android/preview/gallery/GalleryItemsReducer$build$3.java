...
final /* synthetic */ class GalleryItemsReducer$build$3 extends FunctionReferenceImpl implements Function2<String, ItemThumbnailReducer.Action, GalleryItemsReducer.Action.ItemThumbnailAction> {
    public static final GalleryItemsReducer$build$3 INSTANCE = new GalleryItemsReducer$build$3();

    GalleryItemsReducer$build$3() {
