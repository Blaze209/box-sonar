...
public final class AnnotationToolbarNonDrawBinding implements ViewBinding {
    ...
    public static AnnotationToolbarNonDrawBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static AnnotationToolbarNonDrawBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.annotation_toolbar_non_draw, viewGroup, false);
        if (z) {
    ...
    public static AnnotationToolbarNonDrawBinding bind(View view) {
                            ...
                            if (eraserToolView != null) {
                                ...
                                if (markerToolView != null) {
                                    ...
                                    if (pencilToolView != null && (viewFindChildViewById = ViewBindings.findChildViewById(view, (i = R.id.visible_toolbar))) != null) {
                                        return new AnnotationToolbarNonDrawBinding(constraintLayout, constraintLayout, markupButton, markupButton2, markupButton3, appCompatImageButton, group, eraserToolView, markerToolView, pencilToolView, viewFindChildViewById);
                                    }
                                }
                            }
                        }
