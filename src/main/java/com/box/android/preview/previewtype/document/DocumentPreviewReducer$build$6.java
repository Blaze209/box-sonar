...
final /* synthetic */ class DocumentPreviewReducer$build$6 extends FunctionReferenceImpl implements Function1<CreateAnnotationReducer.Action, DocumentPreviewReducer.Action.CreateAnnotation> {
    public static final DocumentPreviewReducer$build$6 INSTANCE = new DocumentPreviewReducer$build$6();

    DocumentPreviewReducer$build$6() {
