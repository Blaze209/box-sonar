...
/* JADX INFO: compiled from: ImagePdfFragmentBuilder.kt */
/* JADX INFO: loaded from: classes12.dex */
@Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0007\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0018\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016J\u0006\u0010\f\u001a\u00020\rJ\u0016\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\rR\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0013"}, d2 = {"Lcom/box/android/preview/previewtype/image/ImagePdfFragmentBuilder;", "Lcom/box/android/preview/integration/nutrient/NutrientPdfFragmentBuilder;", "configuration", "Lcom/pspdfkit/configuration/activity/PdfActivityConfiguration;", "<init>", "(Lcom/pspdfkit/configuration/activity/PdfActivityConfiguration;)V", "build", "Lcom/box/android/preview/integration/nutrient/PdfUIFragmentWrapper;", "context", "Landroid/content/Context;", "uri", "Landroid/net/Uri;", "describeContents", "", "writeToParcel", "", "dest", "Landroid/os/Parcel;", "flags", "preview_generalProdRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class ImagePdfFragmentBuilder implements NutrientPdfFragmentBuilder {
    public static final int $stable = PdfActivityConfiguration.$stable;
    public static final Parcelable.Creator<ImagePdfFragmentBuilder> CREATOR = new Creator();
    private final PdfActivityConfiguration configuration;

    /* JADX INFO: compiled from: ImagePdfFragmentBuilder.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    public static final class Creator implements Parcelable.Creator<ImagePdfFragmentBuilder> {
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final ImagePdfFragmentBuilder createFromParcel(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            return new ImagePdfFragmentBuilder((PdfActivityConfiguration) parcel.readParcelable(ImagePdfFragmentBuilder.class.getClassLoader()));
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final ImagePdfFragmentBuilder[] newArray(int i) {
            return new ImagePdfFragmentBuilder[i];
        }
    }
    ...
    public ImagePdfFragmentBuilder(PdfActivityConfiguration configuration) {
    ...
    public PdfUIFragmentWrapper build(Context context, Uri uri) {
        ...
        PdfUiFragment pdfUiFragmentBuild = PdfUiFragmentBuilder.fromImageUri(context, uri).fragmentClass(PdfUIFragmentWrapper.class).configuration(this.configuration).build();
