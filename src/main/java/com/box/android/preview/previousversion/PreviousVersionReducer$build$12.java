...
final /* synthetic */ class PreviousVersionReducer$build$12 extends FunctionReferenceImpl implements Function1<VideoPreviewReducer.Action, PreviousVersionReducer.Action.Video> {
    public static final PreviousVersionReducer$build$12 INSTANCE = new PreviousVersionReducer$build$12();

    PreviousVersionReducer$build$12() {
