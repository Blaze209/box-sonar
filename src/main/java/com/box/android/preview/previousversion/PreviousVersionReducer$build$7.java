...
final /* synthetic */ class PreviousVersionReducer$build$7 extends FunctionReferenceImpl implements Function1<ImagePreviewReducer.State, ItemState.Image> {
    public static final PreviousVersionReducer$build$7 INSTANCE = new PreviousVersionReducer$build$7();

    PreviousVersionReducer$build$7() {
