...
abstract class Hilt_PushNotificationSheetFragment extends BottomSheetMenuFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_PushNotificationSheetFragment() {
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((PushNotificationSheetFragment_GeneratedInjector) generatedComponent()).injectPushNotificationSheetFragment((PushNotificationSheetFragment) UnsafeCasts.unsafeCast(this));
    }
