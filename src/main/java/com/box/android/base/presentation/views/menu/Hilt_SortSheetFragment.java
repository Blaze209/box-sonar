...
abstract class Hilt_SortSheetFragment extends BottomSheetMenuFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((SortSheetFragment_GeneratedInjector) generatedComponent()).injectSortSheetFragment((SortSheetFragment) UnsafeCasts.unsafeCast(this));
    }
