...
abstract class Hilt_BookmarkSheetFragment extends BottomSheetMenuFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((BookmarkSheetFragment_GeneratedInjector) generatedComponent()).injectBookmarkSheetFragment((BookmarkSheetFragment) UnsafeCasts.unsafeCast(this));
    }
