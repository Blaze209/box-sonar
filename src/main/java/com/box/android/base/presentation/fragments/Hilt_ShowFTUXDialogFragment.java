...
abstract class Hilt_ShowFTUXDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_ShowFTUXDialogFragment() {
        this.disableGetContextFix = false;
        this.componentManagerLock = new Object();
        this.injected = false;
    }

    Hilt_ShowFTUXDialogFragment(int i) {
        super(i);
        this.disableGetContextFix = false;
        this.componentManagerLock = new Object();
        this.injected = false;
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((ShowFTUXDialogFragment_GeneratedInjector) generatedComponent()).injectShowFTUXDialogFragment((ShowFTUXDialogFragment) UnsafeCasts.unsafeCast(this));
    }
