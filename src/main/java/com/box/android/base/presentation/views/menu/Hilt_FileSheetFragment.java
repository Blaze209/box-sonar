...
abstract class Hilt_FileSheetFragment extends BottomSheetMenuFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((FileSheetFragment_GeneratedInjector) generatedComponent()).injectFileSheetFragment((FileSheetFragment) UnsafeCasts.unsafeCast(this));
    }
