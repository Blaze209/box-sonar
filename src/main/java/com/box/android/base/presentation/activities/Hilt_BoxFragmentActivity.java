...
public abstract class Hilt_BoxFragmentActivity extends BoxSpinnerDialogFragmentActivity implements GeneratedComponentManagerHolder {
    private volatile ActivityComponentManager componentManager;
    private final Object componentManagerLock = new Object();
    private boolean injected = false;
    private SavedStateHandleHolder savedStateHandleHolder;

    Hilt_BoxFragmentActivity() {
        _initHiltInternal();
    }

    private void _initHiltInternal() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: com.box.android.base.presentation.activities.Hilt_BoxFragmentActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(Context context) {
                Hilt_BoxFragmentActivity.this.inject();
            }
        });
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((BoxFragmentActivity_GeneratedInjector) generatedComponent()).injectBoxFragmentActivity((BoxFragmentActivity) UnsafeCasts.unsafeCast(this));
    }
