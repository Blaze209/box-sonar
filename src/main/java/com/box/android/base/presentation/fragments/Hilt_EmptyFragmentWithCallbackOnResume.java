...
abstract class Hilt_EmptyFragmentWithCallbackOnResume extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_EmptyFragmentWithCallbackOnResume() {
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((EmptyFragmentWithCallbackOnResume_GeneratedInjector) generatedComponent()).injectEmptyFragmentWithCallbackOnResume((EmptyFragmentWithCallbackOnResume) UnsafeCasts.unsafeCast(this));
    }
