...
abstract class Hilt_FolderSheetFragment extends BottomSheetMenuFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((FolderSheetFragment_GeneratedInjector) generatedComponent()).injectFolderSheetFragment((FolderSheetFragment) UnsafeCasts.unsafeCast(this));
    }
