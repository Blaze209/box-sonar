...
abstract class Hilt_NotificationsFilterFragment extends BottomSheetMenuFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_NotificationsFilterFragment() {
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((NotificationsFilterFragment_GeneratedInjector) generatedComponent()).injectNotificationsFilterFragment((NotificationsFilterFragment) UnsafeCasts.unsafeCast(this));
    }
