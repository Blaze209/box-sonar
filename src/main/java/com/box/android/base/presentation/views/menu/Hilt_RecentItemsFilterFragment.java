...
abstract class Hilt_RecentItemsFilterFragment extends BottomSheetMenuFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_RecentItemsFilterFragment() {
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((RecentItemsFilterFragment_GeneratedInjector) generatedComponent()).injectRecentItemsFilterFragment((RecentItemsFilterFragment) UnsafeCasts.unsafeCast(this));
    }
