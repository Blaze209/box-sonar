...
public abstract class Hilt_LibraryFragment extends BottomSheetMenuFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((LibraryFragment_GeneratedInjector) generatedComponent()).injectLibraryFragment((LibraryFragment) UnsafeCasts.unsafeCast(this));
    }
