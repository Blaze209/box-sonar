...
public abstract class Hilt_FeatureFlipsToggleFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_FeatureFlipsToggleFragment() {
        this.disableGetContextFix = false;
        this.componentManagerLock = new Object();
        this.injected = false;
    }

    Hilt_FeatureFlipsToggleFragment(int i) {
        super(i);
        this.disableGetContextFix = false;
        this.componentManagerLock = new Object();
        this.injected = false;
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((FeatureFlipsToggleFragment_GeneratedInjector) generatedComponent()).injectFeatureFlipsToggleFragment((FeatureFlipsToggleFragment) UnsafeCasts.unsafeCast(this));
    }
