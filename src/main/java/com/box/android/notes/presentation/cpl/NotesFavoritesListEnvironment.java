...
public final class NotesFavoritesListEnvironment implements IItemsListViewEnvironment {
    ...
    private final NotesFavoritesViewInteractor itemsViewUseCase;
    ...
    public NotesFavoritesViewInteractor getItemsViewUseCase() {
