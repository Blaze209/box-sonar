...
public final class NotesRecentsListEnvironment implements IItemsListViewEnvironment {
    ...
    private final NotesRecentsViewInteractor itemsViewUseCase;
    ...
    public NotesRecentsViewInteractor getItemsViewUseCase() {
