...
public final class JobWorker extends CoroutineWorker {
    ...
    static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return JobWorker.this.doWork(this);
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public JobWorker(JobService jobService, IUserContextManager userContextManager, BoxApiPrivate boxApiPrivate, Context appContext, WorkerParameters workerParameters) {
    ...
    public Object doWork(Continuation<? super ListenableWorker.Result> continuation) {
        ...
        if (i == 0) {
            ...
            String string = getInputData().getString(JOB_ID_PARAM);
            if (string != null) {
                JobId jobId = new JobId(string);
                ...
                anonymousClass2.L$0 = SpillingKt.nullOutSpilledVariable(jobId);
                anonymousClass2.label = 1;
                if (jobHelper.executeJob(jobId, applicationContext, jobService, iUserContextManager, boxApiPrivate, boxAuthentication, anonymousClass2) == coroutine_suspended) {
