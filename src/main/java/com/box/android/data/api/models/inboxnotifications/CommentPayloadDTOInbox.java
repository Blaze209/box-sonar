...
public final /* data */ class CommentPayloadDTOInbox extends InboxNotificationPayloadDTO {
    ...
    public static /* synthetic */ CommentPayloadDTOInbox copy$default(CommentPayloadDTOInbox commentPayloadDTOInbox, String str, InboxNotificationCommentDTO inboxNotificationCommentDTO, InboxNotificationTargetItemDTO inboxNotificationTargetItemDTO, InboxNotificationUserDTO inboxNotificationUserDTO, int i, Object obj) {
        if ((i & 1) != 0) {
            str = commentPayloadDTOInbox.type;
        }
        if ((i & 2) != 0) {
            inboxNotificationCommentDTO = commentPayloadDTOInbox.comment;
        }
        if ((i & 4) != 0) {
            inboxNotificationTargetItemDTO = commentPayloadDTOInbox.target;
        }
        if ((i & 8) != 0) {
            inboxNotificationUserDTO = commentPayloadDTOInbox.sentBy;
        }
        return commentPayloadDTOInbox.copy(str, inboxNotificationCommentDTO, inboxNotificationTargetItemDTO, inboxNotificationUserDTO);
    }
    ...
    public final CommentPayloadDTOInbox copy(@Json(name = "type") String type, @Json(name = "comment") InboxNotificationCommentDTO comment, @Json(name = "target") InboxNotificationTargetItemDTO target, @Json(name = "sent_by") InboxNotificationUserDTO sentBy) {
        Intrinsics.checkNotNullParameter(type, "type");
        Intrinsics.checkNotNullParameter(comment, "comment");
        Intrinsics.checkNotNullParameter(target, "target");
        return new CommentPayloadDTOInbox(type, comment, target, sentBy);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CommentPayloadDTOInbox)) {
            return false;
        }
        CommentPayloadDTOInbox commentPayloadDTOInbox = (CommentPayloadDTOInbox) other;
        return Intrinsics.areEqual(this.type, commentPayloadDTOInbox.type) && Intrinsics.areEqual(this.comment, commentPayloadDTOInbox.comment) && Intrinsics.areEqual(this.target, commentPayloadDTOInbox.target) && Intrinsics.areEqual(this.sentBy, commentPayloadDTOInbox.sentBy);
    }
    ...
    public String toString() {
        return "CommentPayloadDTOInbox(type=" + this.type + ", comment=" + this.comment + ", target=" + this.target + ", sentBy=" + this.sentBy + ")";
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CommentPayloadDTOInbox(@Json(name = "type") String type, @Json(name = "comment") InboxNotificationCommentDTO comment, @Json(name = "target") InboxNotificationTargetItemDTO target, @Json(name = "sent_by") InboxNotificationUserDTO inboxNotificationUserDTO) {
        super(null);
        Intrinsics.checkNotNullParameter(type, "type");
        Intrinsics.checkNotNullParameter(comment, "comment");
        Intrinsics.checkNotNullParameter(target, "target");
