...
import com.box.android.data.mappers.GQLGetItemQueryToIItemDTOMapper;
...
public final class GQLGetItemResponseInterceptor extends GQLBaseInterceptor {
    ...
    @Inject
    public GQLGetItemResponseInterceptor(ItemRemoteDataSource itemRemoteDataSource, GQLRequestParser requestParser, Moshi moshi) {
        super(moshi);
    ...
    public Response intercept(Interceptor.Chain chain) throws InterruptedException, IOException {
        ...
        ItemType itemTypeValueOfWithTransform = ItemType.INSTANCE.valueOfWithTransform(itemType, new Function1() { // from class: com.box.android.data.datasource.items.interceptors.GQLGetItemResponseInterceptor$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return GQLGetItemResponseInterceptor.intercept$lambda$0((String) obj);
            }
        });
        ...
        return getResponse(200, request, (Error) objectRef2.element, new GetItemQuery.Data((GetItemQuery.Item) objectRef.element));
    }
    ...
    /* JADX INFO: renamed from: com.box.android.data.datasource.items.interceptors.GQLGetItemResponseInterceptor$intercept$1, reason: invalid class name */
    /* JADX INFO: compiled from: GQLGetItemResponseInterceptor.kt */
    ...
    @DebugMetadata(c = "com.box.android.data.datasource.items.interceptors.GQLGetItemResponseInterceptor$intercept$1", f = "GQLGetItemResponseInterceptor.kt", i = {}, l = {42}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends IItemDTO, ? extends RemoteError>>, Object> {
        ...
        final /* synthetic */ Ref.ObjectRef<GetItemQuery.Item> $queryItem;
        final /* synthetic */ Ref.ObjectRef<Error> $responseError;
        final /* synthetic */ ItemType $safeItemType;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(String str, ItemType itemType, Ref.ObjectRef<GetItemQuery.Item> objectRef, Ref.ObjectRef<Error> objectRef2, Continuation<? super AnonymousClass1> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return GQLGetItemResponseInterceptor.this.new AnonymousClass1(this.$itemId, this.$safeItemType, this.$queryItem, this.$responseError, continuation);
        }
        ...
        /* JADX WARN: Type inference failed for: r6v4, types: [T, com.apollographql.apollo3.api.Error] */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                obj = GQLGetItemResponseInterceptor.this.itemRemoteDataSource.getItem(new ItemId.Remote(this.$itemId, this.$safeItemType), this);
            ...
            Ref.ObjectRef<GetItemQuery.Item> objectRef = this.$queryItem;
            boolean z = result instanceof Result.Success;
            if (z) {
                objectRef.element = GraphQLMapper.toGraphQL$default(GQLGetItemQueryToIItemDTOMapper.INSTANCE, (IItemDTO) ((Result.Success) result).getValue(), null, 2, null);
            } else if (!(result instanceof Result.Error)) {
                throw new NoWhenBranchMatchedException();
            }
            Ref.ObjectRef<Error> objectRef2 = this.$responseError;
            GQLGetItemResponseInterceptor gQLGetItemResponseInterceptor = GQLGetItemResponseInterceptor.this;
            if (z) {
                return result;
            }
            if (result instanceof Result.Error) {
                objectRef2.element = gQLGetItemResponseInterceptor.getError((RemoteError) ((Result.Error) result).getValue());
                return result;
            }
            throw new NoWhenBranchMatchedException();
        }
