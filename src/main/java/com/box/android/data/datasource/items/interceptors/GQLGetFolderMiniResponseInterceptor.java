...
import com.box.android.data.mappers.GQLGetFolderMiniQueryToFolderDTOMapper;
...
public final class GQLGetFolderMiniResponseInterceptor extends GQLBaseInterceptor {
    ...
    @Inject
    public GQLGetFolderMiniResponseInterceptor(ItemRemoteDataSource itemRemoteDataSource, GQLRequestParser requestParser, Moshi moshi) {
        super(moshi);
    ...
    public Response intercept(Interceptor.Chain chain) throws InterruptedException, IOException {
        ...
        if (id == null) {
            throw new IOException("No ID provided for Get Folder Mini request!");
        }
        Ref.ObjectRef objectRef = new Ref.ObjectRef();
        Ref.ObjectRef objectRef2 = new Ref.ObjectRef();
        BuildersKt__BuildersKt.runBlocking$default(null, new AnonymousClass1(id, objectRef, objectRef2, null), 1, null);
        return getResponse(200, request, (Error) objectRef2.element, new GetFolderMiniQuery.Data((GetFolderMiniQuery.Folder) objectRef.element));
    }

    /* JADX INFO: renamed from: com.box.android.data.datasource.items.interceptors.GQLGetFolderMiniResponseInterceptor$intercept$1, reason: invalid class name */
    /* JADX INFO: compiled from: GQLGetFolderMiniResponseInterceptor.kt */
    ...
    @DebugMetadata(c = "com.box.android.data.datasource.items.interceptors.GQLGetFolderMiniResponseInterceptor$intercept$1", f = "GQLGetFolderMiniResponseInterceptor.kt", i = {}, l = {38}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends IItemDTO, ? extends RemoteError>>, Object> {
        ...
        final /* synthetic */ Ref.ObjectRef<GetFolderMiniQuery.Folder> $queryFolder;
        final /* synthetic */ Ref.ObjectRef<Error> $responseError;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(String str, Ref.ObjectRef<GetFolderMiniQuery.Folder> objectRef, Ref.ObjectRef<Error> objectRef2, Continuation<? super AnonymousClass1> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return GQLGetFolderMiniResponseInterceptor.this.new AnonymousClass1(this.$id, this.$queryFolder, this.$responseError, continuation);
        }
        ...
        /* JADX WARN: Type inference failed for: r9v5, types: [T, com.apollographql.apollo3.api.Error] */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Object invokeSuspend(Object obj) throws IOException {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                obj = ItemRemoteDataSource.getFolderMini$default(GQLGetFolderMiniResponseInterceptor.this.itemRemoteDataSource, new ItemId.Remote(this.$id, ItemType.FOLDER), false, this, 2, null);
            ...
            Ref.ObjectRef<GetFolderMiniQuery.Folder> objectRef = this.$queryFolder;
            boolean z = result instanceof Result.Success;
            if (z) {
                IItemDTO iItemDTO = (IItemDTO) ((Result.Success) result).getValue();
                if (iItemDTO instanceof FolderDTO) {
                    objectRef.element = GraphQLMapper.toGraphQL$default(GQLGetFolderMiniQueryToFolderDTOMapper.INSTANCE, iItemDTO, null, 2, null);
                } else {
                    throw new IOException("Unexpected return type for Get Folder Mini Interceptor: " + iItemDTO);
                }
            } else if (!(result instanceof Result.Error)) {
                throw new NoWhenBranchMatchedException();
            }
            Ref.ObjectRef<Error> objectRef2 = this.$responseError;
            GQLGetFolderMiniResponseInterceptor gQLGetFolderMiniResponseInterceptor = GQLGetFolderMiniResponseInterceptor.this;
            if (z) {
                return result;
            }
            ...
            if (remoteError instanceof ItemsRemoteError) {
                objectRef2.element = gQLGetFolderMiniResponseInterceptor.getError(remoteError);
                return result;
            }
