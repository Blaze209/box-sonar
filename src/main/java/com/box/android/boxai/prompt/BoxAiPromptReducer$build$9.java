...
final /* synthetic */ class BoxAiPromptReducer$build$9 extends FunctionReferenceImpl implements Function1<PermissionReducer.Action, BoxAiPromptReducer.Action.AudioPermissionsAction> {
    public static final BoxAiPromptReducer$build$9 INSTANCE = new BoxAiPromptReducer$build$9();

    BoxAiPromptReducer$build$9() {
