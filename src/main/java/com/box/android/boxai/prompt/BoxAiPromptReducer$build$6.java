...
final /* synthetic */ class BoxAiPromptReducer$build$6 extends FunctionReferenceImpl implements Function1<VoiceInputReducer.Action, BoxAiPromptReducer.Action.VoiceInputAction> {
    public static final BoxAiPromptReducer$build$6 INSTANCE = new BoxAiPromptReducer$build$6();

    BoxAiPromptReducer$build$6() {
