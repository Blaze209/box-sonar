...
final /* synthetic */ class NavigationViewModel$offlinedStore$2 extends FunctionReferenceImpl implements Function1<OfflinedReducer.Action, NavigationReducer.Action.NavigationOfflinedAction> {
    public static final NavigationViewModel$offlinedStore$2 INSTANCE = new NavigationViewModel$offlinedStore$2();

    NavigationViewModel$offlinedStore$2() {
