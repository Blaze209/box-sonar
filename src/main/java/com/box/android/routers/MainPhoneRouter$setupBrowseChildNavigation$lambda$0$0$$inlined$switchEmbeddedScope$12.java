...
@DebugMetadata(c = "com.box.android.routers.MainPhoneRouter$setupBrowseChildNavigation$lambda$0$0$$inlined$switchEmbeddedScope$12", f = "MainPhoneRouter.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class MainPhoneRouter$setupBrowseChildNavigation$lambda$0$0$$inlined$switchEmbeddedScope$12 extends SuspendLambda implements Function2<BrowseReducer.Route.FeatureBanner, Continuation<? super Unit>, Object> {
    ...
    public MainPhoneRouter$setupBrowseChildNavigation$lambda$0$0$$inlined$switchEmbeddedScope$12(Store store, KClass kClass, Function1 function1, Continuation continuation, MainPhoneRouter mainPhoneRouter, Store store2) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MainPhoneRouter$setupBrowseChildNavigation$lambda$0$0$$inlined$switchEmbeddedScope$12(this.$this_switchEmbeddedScope, this.$switchCase, this.$fromLocalAction, continuation, this.this$0, this.$store$inlined);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(BrowseReducer.Route.FeatureBanner featureBanner, Continuation<? super Unit> continuation) {
        return ((MainPhoneRouter$setupBrowseChildNavigation$lambda$0$0$$inlined$switchEmbeddedScope$12) create(featureBanner, continuation)).invokeSuspend(Unit.INSTANCE);
    }
