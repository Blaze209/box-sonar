...
final /* synthetic */ class NavigationRouter$initOfflinedNavigation$2$1 extends FunctionReferenceImpl implements Function1<OfflinedReducer.Action, OfflinedReducer.Action> {
    public static final NavigationRouter$initOfflinedNavigation$2$1 INSTANCE = new NavigationRouter$initOfflinedNavigation$2$1();

    NavigationRouter$initOfflinedNavigation$2$1() {
