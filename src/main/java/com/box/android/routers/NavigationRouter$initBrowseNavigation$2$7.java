...
final /* synthetic */ class NavigationRouter$initBrowseNavigation$2$7 extends FunctionReferenceImpl implements Function1<BrowseReducer.Action, BrowseReducer.Action> {
    public static final NavigationRouter$initBrowseNavigation$2$7 INSTANCE = new NavigationRouter$initBrowseNavigation$2$7();

    NavigationRouter$initBrowseNavigation$2$7() {
