...
final /* synthetic */ class NavigationRouter$initBrowseNavigation$2$5 extends FunctionReferenceImpl implements Function1<BrowseReducer.Action, BrowseReducer.Action> {
    public static final NavigationRouter$initBrowseNavigation$2$5 INSTANCE = new NavigationRouter$initBrowseNavigation$2$5();

    NavigationRouter$initBrowseNavigation$2$5() {
