...
@DebugMetadata(c = "com.box.android.routers.NavigationRouter$initBrowseNavigation$lambda$0$$inlined$switchEmbeddedScope$6", f = "NavigationRouter.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {}, v = 1)
public final class NavigationRouter$initBrowseNavigation$lambda$0$$inlined$switchEmbeddedScope$6 extends SuspendLambda implements Function2<BrowseReducer.Route.File, Continuation<? super Unit>, Object> {
    ...
    public NavigationRouter$initBrowseNavigation$lambda$0$$inlined$switchEmbeddedScope$6(Store store, KClass kClass, Function1 function1, Continuation continuation, NavigationRouter navigationRouter, Store store2) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new NavigationRouter$initBrowseNavigation$lambda$0$$inlined$switchEmbeddedScope$6(this.$this_switchEmbeddedScope, this.$switchCase, this.$fromLocalAction, continuation, this.this$0, this.$store$inlined);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(BrowseReducer.Route.File file, Continuation<? super Unit> continuation) {
        return ((NavigationRouter$initBrowseNavigation$lambda$0$$inlined$switchEmbeddedScope$6) create(file, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        Store storeScope = this.$this_switchEmbeddedScope.scope(KClassesJvm.getJvmName(this.$switchCase), new Function1<BrowseReducer.Route, Wrapped<FileModel>>() { // from class: com.box.android.routers.NavigationRouter$initBrowseNavigation$lambda$0$$inlined$switchEmbeddedScope$6.1
        ...
        iItemActionHandler.setOnItemClosedListener(new Function0<Unit>() { // from class: com.box.android.routers.NavigationRouter$initBrowseNavigation$2$4$1
