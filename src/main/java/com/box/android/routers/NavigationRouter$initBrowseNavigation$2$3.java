...
final /* synthetic */ class NavigationRouter$initBrowseNavigation$2$3 extends FunctionReferenceImpl implements Function1<BrowseReducer.Action, BrowseReducer.Action> {
    public static final NavigationRouter$initBrowseNavigation$2$3 INSTANCE = new NavigationRouter$initBrowseNavigation$2$3();

    NavigationRouter$initBrowseNavigation$2$3() {
