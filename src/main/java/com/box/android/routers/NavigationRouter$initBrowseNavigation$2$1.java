...
final /* synthetic */ class NavigationRouter$initBrowseNavigation$2$1 extends FunctionReferenceImpl implements Function1<BrowseReducer.Action, BrowseReducer.Action.ChildBrowseAction> {
    public static final NavigationRouter$initBrowseNavigation$2$1 INSTANCE = new NavigationRouter$initBrowseNavigation$2$1();

    NavigationRouter$initBrowseNavigation$2$1() {
