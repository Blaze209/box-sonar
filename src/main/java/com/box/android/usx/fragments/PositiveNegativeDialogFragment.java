...
public class PositiveNegativeDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        return new MaterialAlertDialogBuilder(getActivity()).setTitle(i).setMessage(getArguments().getInt(ARGUMENT_MESSAGE_ID)).setPositiveButton(getText(getArguments().getInt(ARGUMENT_POSITIVE_ID)), new DialogInterface.OnClickListener() { // from class: com.box.android.usx.fragments.PositiveNegativeDialogFragment.2
        ...
        }).setNegativeButton(getText(getArguments().getInt(ARGUMENT_NEGATIVE_ID)), new DialogInterface.OnClickListener() { // from class: com.box.android.usx.fragments.PositiveNegativeDialogFragment.1
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i2) {
                PositiveNegativeDialogFragment.this.mButtonClicked = true;
                if (PositiveNegativeDialogFragment.this.mButtonClickedListener != null) {
