...
public final class SettingsNotificationsFragmentV2Binding implements ViewBinding {
    ...
    public static SettingsNotificationsFragmentV2Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static SettingsNotificationsFragmentV2Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.settings_notifications_fragment_v2, viewGroup, false);
        if (z) {
    ...
    public static SettingsNotificationsFragmentV2Binding bind(View view) {
                                                        ...
                                                        if (imageView != null) {
                                                            ...
                                                            if (linearLayout != null) {
                                                                ...
                                                                if (switchCompat != null) {
                                                                    return new SettingsNotificationsFragmentV2Binding((LinearLayout) view, appCompatCheckBox, relativeLayout, textView, appCompatCheckBox2, relativeLayout2, textView2, appCompatCheckBox3, relativeLayout3, textView3, appCompatCheckBox4, relativeLayout4, textView4, imageView, linearLayout, switchCompat);
                                                                }
                                                            }
                                                        }
                                                    }
