...
public abstract class Hilt_AudioRecordingHostFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((AudioRecordingHostFragment_GeneratedInjector) generatedComponent()).injectAudioRecordingHostFragment((AudioRecordingHostFragment) UnsafeCasts.unsafeCast(this));
    }
