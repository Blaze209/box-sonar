...
public abstract class Hilt_AudioRecordingIntegratedFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((AudioRecordingIntegratedFragment_GeneratedInjector) generatedComponent()).injectAudioRecordingIntegratedFragment((AudioRecordingIntegratedFragment) UnsafeCasts.unsafeCast(this));
    }
