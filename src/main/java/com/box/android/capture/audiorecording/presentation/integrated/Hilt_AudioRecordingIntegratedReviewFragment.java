...
import com.box.android.base.presentation.fragments.BoxFragment;
...
public abstract class Hilt_AudioRecordingIntegratedReviewFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((AudioRecordingIntegratedReviewFragment_GeneratedInjector) generatedComponent()).injectAudioRecordingIntegratedReviewFragment((AudioRecordingIntegratedReviewFragment) UnsafeCasts.unsafeCast(this));
    }
