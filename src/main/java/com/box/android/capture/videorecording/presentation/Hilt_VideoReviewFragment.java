...
public abstract class Hilt_VideoReviewFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((VideoReviewFragment_GeneratedInjector) generatedComponent()).injectVideoReviewFragment((VideoReviewFragment) UnsafeCasts.unsafeCast(this));
    }
