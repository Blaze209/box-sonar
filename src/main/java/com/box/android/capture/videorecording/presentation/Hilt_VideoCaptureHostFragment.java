...
public abstract class Hilt_VideoCaptureHostFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((VideoCaptureHostFragment_GeneratedInjector) generatedComponent()).injectVideoCaptureHostFragment((VideoCaptureHostFragment) UnsafeCasts.unsafeCast(this));
    }
