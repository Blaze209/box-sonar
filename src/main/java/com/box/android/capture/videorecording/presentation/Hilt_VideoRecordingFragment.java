...
public abstract class Hilt_VideoRecordingFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((VideoRecordingFragment_GeneratedInjector) generatedComponent()).injectVideoRecordingFragment((VideoRecordingFragment) UnsafeCasts.unsafeCast(this));
    }
