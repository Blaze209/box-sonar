...
public abstract class Hilt_CaptureHistoryFragment<T, VB extends ViewBinding> extends BaseListingAbstractFragment<T, VB> implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((CaptureHistoryFragment_GeneratedInjector) generatedComponent()).injectCaptureHistoryFragment((CaptureHistoryFragment) UnsafeCasts.unsafeCast(this));
    }
