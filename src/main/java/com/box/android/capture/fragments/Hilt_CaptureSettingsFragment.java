...
public abstract class Hilt_CaptureSettingsFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_CaptureSettingsFragment() {
        this.disableGetContextFix = false;
        this.componentManagerLock = new Object();
        this.injected = false;
    }

    Hilt_CaptureSettingsFragment(int i) {
        super(i);
        this.disableGetContextFix = false;
        this.componentManagerLock = new Object();
        this.injected = false;
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((CaptureSettingsFragment_GeneratedInjector) generatedComponent()).injectCaptureSettingsFragment((CaptureSettingsFragment) UnsafeCasts.unsafeCast(this));
    }
