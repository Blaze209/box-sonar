...
public abstract class Hilt_PhotoReviewFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((PhotoReviewFragment_GeneratedInjector) generatedComponent()).injectPhotoReviewFragment((PhotoReviewFragment) UnsafeCasts.unsafeCast(this));
    }
