...
public abstract class Hilt_CameraPreviewFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((CameraPreviewFragment_GeneratedInjector) generatedComponent()).injectCameraPreviewFragment((CameraPreviewFragment) UnsafeCasts.unsafeCast(this));
    }
