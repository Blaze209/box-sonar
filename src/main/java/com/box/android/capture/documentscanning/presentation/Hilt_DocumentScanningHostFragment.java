...
public abstract class Hilt_DocumentScanningHostFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((DocumentScanningHostFragment_GeneratedInjector) generatedComponent()).injectDocumentScanningHostFragment((DocumentScanningHostFragment) UnsafeCasts.unsafeCast(this));
    }
