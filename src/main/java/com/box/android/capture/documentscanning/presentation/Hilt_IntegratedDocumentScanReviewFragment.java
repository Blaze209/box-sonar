...
public abstract class Hilt_IntegratedDocumentScanReviewFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((IntegratedDocumentScanReviewFragment_GeneratedInjector) generatedComponent()).injectIntegratedDocumentScanReviewFragment((IntegratedDocumentScanReviewFragment) UnsafeCasts.unsafeCast(this));
    }
