...
public abstract class Hilt_IntegratedDocumentScanFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((IntegratedDocumentScanFragment_GeneratedInjector) generatedComponent()).injectIntegratedDocumentScanFragment((IntegratedDocumentScanFragment) UnsafeCasts.unsafeCast(this));
    }
