...
public abstract class Hilt_IntegratedDocumentScanEditFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((IntegratedDocumentScanEditFragment_GeneratedInjector) generatedComponent()).injectIntegratedDocumentScanEditFragment((IntegratedDocumentScanEditFragment) UnsafeCasts.unsafeCast(this));
    }
