...
public abstract class Hilt_CaptureErrorFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((CaptureErrorFragment_GeneratedInjector) generatedComponent()).injectCaptureErrorFragment((CaptureErrorFragment) UnsafeCasts.unsafeCast(this));
    }
