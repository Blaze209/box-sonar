...
public abstract class Hilt_ImageCaptureHostFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((ImageCaptureHostFragment_GeneratedInjector) generatedComponent()).injectImageCaptureHostFragment((ImageCaptureHostFragment) UnsafeCasts.unsafeCast(this));
    }
