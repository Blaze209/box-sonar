...
public class LinkedBlockingDeque<E> extends AbstractQueue<E> implements BlockingQueue<E>, Serializable {
    ...
    private class Itr extends LinkedBlockingDeque<E>.AbstractItr {
        ...
        @Override // com.box.android.utilities.LinkedBlockingDeque.AbstractItr
        Node<E> firstNode() {
