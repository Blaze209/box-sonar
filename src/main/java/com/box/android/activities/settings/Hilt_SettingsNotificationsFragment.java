...
abstract class Hilt_SettingsNotificationsFragment extends BoxFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_SettingsNotificationsFragment() {
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((SettingsNotificationsFragment_GeneratedInjector) generatedComponent()).injectSettingsNotificationsFragment((SettingsNotificationsFragment) UnsafeCasts.unsafeCast(this));
    }
