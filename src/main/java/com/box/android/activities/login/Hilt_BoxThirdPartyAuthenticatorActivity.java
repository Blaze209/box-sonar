...
abstract class Hilt_BoxThirdPartyAuthenticatorActivity extends BoxSpinnerDialogFragmentActivity implements GeneratedComponentManagerHolder {
    private volatile ActivityComponentManager componentManager;
    private final Object componentManagerLock = new Object();
    private boolean injected = false;
    private SavedStateHandleHolder savedStateHandleHolder;

    Hilt_BoxThirdPartyAuthenticatorActivity() {
        _initHiltInternal();
    }

    private void _initHiltInternal() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: com.box.android.activities.login.Hilt_BoxThirdPartyAuthenticatorActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(Context context) {
                Hilt_BoxThirdPartyAuthenticatorActivity.this.inject();
            }
        });
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((BoxThirdPartyAuthenticatorActivity_GeneratedInjector) generatedComponent()).injectBoxThirdPartyAuthenticatorActivity((BoxThirdPartyAuthenticatorActivity) UnsafeCasts.unsafeCast(this));
    }
