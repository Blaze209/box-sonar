...
abstract class Hilt_CustomOAuthActivity extends BoxSpinnerDialogFragmentActivity implements GeneratedComponentManagerHolder {
    private volatile ActivityComponentManager componentManager;
    private final Object componentManagerLock = new Object();
    private boolean injected = false;
    private SavedStateHandleHolder savedStateHandleHolder;

    Hilt_CustomOAuthActivity() {
        _initHiltInternal();
    }

    private void _initHiltInternal() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: com.box.android.activities.login.Hilt_CustomOAuthActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(Context context) {
                Hilt_CustomOAuthActivity.this.inject();
            }
        });
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((CustomOAuthActivity_GeneratedInjector) generatedComponent()).injectCustomOAuthActivity((CustomOAuthActivity) UnsafeCasts.unsafeCast(this));
    }
