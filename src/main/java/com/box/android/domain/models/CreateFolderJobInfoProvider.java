...
public final class CreateFolderJobInfoProvider implements IJobDisplayInfoProvider {
    ...
    static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return CreateFolderJobInfoProvider.this.getItemModel(this);
        }
    }

    /* JADX INFO: renamed from: com.box.android.domain.models.CreateFolderJobInfoProvider$getName$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: JobInfoProviders.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    @DebugMetadata(c = "com.box.android.domain.models.CreateFolderJobInfoProvider", f = "JobInfoProviders.kt", i = {}, l = {113}, m = "getName", n = {}, s = {}, v = 1)
    static final class C16071 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        ...
        public final Object invokeSuspend(Object obj) {
            this.result = obj;
            this.label |= Integer.MIN_VALUE;
            return CreateFolderJobInfoProvider.this.getName(this);
        }
    }

    /* JADX INFO: renamed from: com.box.android.domain.models.CreateFolderJobInfoProvider$getServerId$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: JobInfoProviders.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    @DebugMetadata(c = "com.box.android.domain.models.CreateFolderJobInfoProvider", f = "JobInfoProviders.kt", i = {}, l = {123}, m = "getServerId", n = {}, s = {}, v = 1)
    static final class C16081 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.result = obj;
            this.label |= Integer.MIN_VALUE;
            return CreateFolderJobInfoProvider.this.getServerId(this);
        }
    }

    public CreateFolderJobInfoProvider(ItemId itemId, ILocalItemService localItemService, IdMappingService idMappingService) {
    ...
    public Object getName(Continuation<? super String> continuation) {
        ...
        Object itemModel = c16071.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c16071.label;
        if (i == 0) {
            ResultKt.throwOnFailure(itemModel);
            c16071.label = 1;
            itemModel = getItemModel(c16071);
    ...
    public int getIconResId() {
        return CommonBoxUtil.getDrawableResIdByName("add_folder_white");
    }
    ...
    public Object getServerId(Continuation<? super String> continuation) {
        ...
        if (i == 0) {
            ...
            ItemId itemId = this.itemId;
            c16081.label = 1;
            remoteId = idMappingService.getRemoteId(itemId, c16081);
    ...
    public Integer errorStringRes(DomainError error) {
        ...
        if (error instanceof FileUploadDomainError.SourceOrDestNotFound) {
            ...
            str = ((error instanceof CreateFolderDomainError.ItemNameTooLong) || (error instanceof CreateFolderDomainError.InvalidName)) ? "folder_create_error_invalid_name" : null;
        }
        if (str != null) {
