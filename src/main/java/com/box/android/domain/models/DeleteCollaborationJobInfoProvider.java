...
public final class DeleteCollaborationJobInfoProvider implements IJobDisplayInfoProvider {
    ...
    static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return DeleteCollaborationJobInfoProvider.this.getItemModel(this);
        }
    }

    /* JADX INFO: renamed from: com.box.android.domain.models.DeleteCollaborationJobInfoProvider$getName$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: JobInfoProviders.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    @DebugMetadata(c = "com.box.android.domain.models.DeleteCollaborationJobInfoProvider", f = "JobInfoProviders.kt", i = {}, l = {47}, m = "getName", n = {}, s = {}, v = 1)
    static final class C16091 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.result = obj;
            this.label |= Integer.MIN_VALUE;
            return DeleteCollaborationJobInfoProvider.this.getName(this);
        }
    }

    /* JADX INFO: renamed from: com.box.android.domain.models.DeleteCollaborationJobInfoProvider$getServerId$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: JobInfoProviders.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    @DebugMetadata(c = "com.box.android.domain.models.DeleteCollaborationJobInfoProvider", f = "JobInfoProviders.kt", i = {}, l = {55}, m = "getServerId", n = {}, s = {}, v = 1)
    static final class C16101 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        ...
        public final Object invokeSuspend(Object obj) {
            this.result = obj;
            this.label |= Integer.MIN_VALUE;
            return DeleteCollaborationJobInfoProvider.this.getServerId(this);
        }
    }

    public DeleteCollaborationJobInfoProvider(ItemId itemId, ILocalItemService localItemService, IdMappingService idMappingService) {
    ...
    public Object getName(Continuation<? super String> continuation) {
        ...
        if (continuation instanceof C16091) {
            ...
            if ((c16091.label & Integer.MIN_VALUE) != 0) {
                c16091.label -= Integer.MIN_VALUE;
            } else {
        ...
        Object itemModel = c16091.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c16091.label;
        if (i == 0) {
            ResultKt.throwOnFailure(itemModel);
            c16091.label = 1;
            itemModel = getItemModel(c16091);
    ...
    public int getIconResId() {
        return CommonBoxUtil.getDrawableResIdByName("ic_end_collaboration");
    }

    @Override // com.box.android.domain.models.IJobDisplayInfoProvider
    public String getJobType() {
        return JobType.DELETE_COLLABORATION;
    }
    ...
    public Object getServerId(Continuation<? super String> continuation) {
        C16101 c16101;
        if (continuation instanceof C16101) {
            c16101 = (C16101) continuation;
            if ((c16101.label & Integer.MIN_VALUE) != 0) {
                c16101.label -= Integer.MIN_VALUE;
            } else {
                c16101 = new C16101(continuation);
            }
        } else {
            c16101 = new C16101(continuation);
        }
        Object remoteId = c16101.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c16101.label;
        if (i == 0) {
            ...
            c16101.label = 1;
            remoteId = idMappingService.getRemoteId(itemId, c16101);
    ...
    public Integer errorStringRes(DomainError error) {
        ...
        if (error instanceof FileUploadDomainError.AccessDeniedError) {
            str = "upload_job_permissions_error";
        } else {
            str = error instanceof FileUploadDomainError.SourceOrDestNotFound ? "The_source_or_destination_does_not_exist" : null;
        }
        if (str != null) {
