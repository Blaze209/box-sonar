...
public final class CopyItemJobInfoProvider implements IJobDisplayInfoProvider {
    ...
    static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return CopyItemJobInfoProvider.this.getItemModel(this);
        }
    }

    /* JADX INFO: renamed from: com.box.android.domain.models.CopyItemJobInfoProvider$getName$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: JobInfoProviders.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    @DebugMetadata(c = "com.box.android.domain.models.CopyItemJobInfoProvider", f = "JobInfoProviders.kt", i = {}, l = {95}, m = "getName", n = {}, s = {}, v = 1)
    static final class C16051 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        ...
        public final Object invokeSuspend(Object obj) {
            this.result = obj;
            this.label |= Integer.MIN_VALUE;
            return CopyItemJobInfoProvider.this.getName(this);
        }
    }

    /* JADX INFO: renamed from: com.box.android.domain.models.CopyItemJobInfoProvider$getServerId$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: JobInfoProviders.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    @DebugMetadata(c = "com.box.android.domain.models.CopyItemJobInfoProvider", f = "JobInfoProviders.kt", i = {}, l = {103}, m = "getServerId", n = {}, s = {}, v = 1)
    static final class C16061 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        ...
        public final Object invokeSuspend(Object obj) {
            this.result = obj;
            this.label |= Integer.MIN_VALUE;
            return CopyItemJobInfoProvider.this.getServerId(this);
        }
    }

    public CopyItemJobInfoProvider(ItemId itemId, ILocalItemService localItemService, IdMappingService idMappingService) {
    ...
    public Object getName(Continuation<? super String> continuation) {
        ...
        Object itemModel = c16051.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c16051.label;
        if (i == 0) {
            ResultKt.throwOnFailure(itemModel);
            c16051.label = 1;
            itemModel = getItemModel(c16051);
    ...
    public Object getServerId(Continuation<? super String> continuation) {
        ...
        if (i == 0) {
            ...
            c16061.label = 1;
            remoteId = idMappingService.getRemoteId(itemId, c16061);
