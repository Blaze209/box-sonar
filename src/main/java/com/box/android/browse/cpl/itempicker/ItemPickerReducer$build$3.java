...
final /* synthetic */ class ItemPickerReducer$build$3 extends FunctionReferenceImpl implements Function2<Integer, ItemsListReducer.Action, ItemPickerReducer.Action.ItemsList> {
    public static final ItemPickerReducer$build$3 INSTANCE = new ItemPickerReducer$build$3();

    ItemPickerReducer$build$3() {
