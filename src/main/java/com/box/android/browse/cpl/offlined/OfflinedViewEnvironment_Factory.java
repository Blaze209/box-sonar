...
public final class OfflinedViewEnvironment_Factory implements Factory<OfflinedViewEnvironment> {
    ...
    private final Provider<OfflinedViewInteractor> itemsViewUseCaseProvider;
    ...
    public OfflinedViewEnvironment get() {
    ...
    public static OfflinedViewEnvironment_Factory create(Provider<OfflinedViewInteractor> provider, Provider<ItemThumbnailEnvironment> provider2, Provider<Gen204PerformanceLogger> provider3, Provider<BoxFeatureBannerUtils> provider4, Provider<IUserContextManager> provider5, Provider<MultiselectEnvironment> provider6, Provider<BrowseAnalytics> provider7, Provider<ISessionManager> provider8, Provider<MetricsUseCase> provider9, Provider<ApdexService> provider10, Provider<AppStartApdexTracker> provider11, Provider<ItemModelStateMapper> provider12, Provider<BoxModelOfflineManagerWrapper> provider13, Provider<CoroutineDispatcher> provider14, Provider<LocalSortPreferences> provider15) {
        return new OfflinedViewEnvironment_Factory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11, provider12, provider13, provider14, provider15);
    }

    public static OfflinedViewEnvironment newInstance(OfflinedViewInteractor offlinedViewInteractor, ItemThumbnailEnvironment itemThumbnailEnvironment, Gen204PerformanceLogger gen204PerformanceLogger, BoxFeatureBannerUtils boxFeatureBannerUtils, IUserContextManager iUserContextManager, MultiselectEnvironment multiselectEnvironment, BrowseAnalytics browseAnalytics, ISessionManager iSessionManager, MetricsUseCase metricsUseCase, ApdexService apdexService, AppStartApdexTracker appStartApdexTracker, ItemModelStateMapper itemModelStateMapper, BoxModelOfflineManagerWrapper boxModelOfflineManagerWrapper, CoroutineDispatcher coroutineDispatcher, LocalSortPreferences localSortPreferences) {
