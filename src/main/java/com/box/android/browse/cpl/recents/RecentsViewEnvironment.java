...
public final class RecentsViewEnvironment implements IItemsListViewEnvironment {
    ...
    private final RecentsViewInteractor itemsViewUseCase;
    ...
    public RecentsViewInteractor getItemsViewUseCase() {
