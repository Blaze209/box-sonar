...
public final class ActionableOfflinedViewEnvironment_Factory implements Factory<ActionableOfflinedViewEnvironment> {
    ...
    private final Provider<OfflinedViewEnvironment> itemListViewEnvironmentProvider;
    private final Provider<OfflineFilesEnvironment> offlineFilesEnvironmentProvider;

    private ActionableOfflinedViewEnvironment_Factory(Provider<OfflinedViewEnvironment> provider, Provider<BrowseAnalytics> provider2, Provider<BoxAccountManagerHelper> provider3, Provider<FileActionsManager> provider4, Provider<OfflineFilesEnvironment> provider5, Provider<DownloadEnvironment> provider6, Provider<BoxAiEnvironment> provider7) {
    ...
    public ActionableOfflinedViewEnvironment get() {
    ...
    public static ActionableOfflinedViewEnvironment_Factory create(Provider<OfflinedViewEnvironment> provider, Provider<BrowseAnalytics> provider2, Provider<BoxAccountManagerHelper> provider3, Provider<FileActionsManager> provider4, Provider<OfflineFilesEnvironment> provider5, Provider<DownloadEnvironment> provider6, Provider<BoxAiEnvironment> provider7) {
        return new ActionableOfflinedViewEnvironment_Factory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }

    public static ActionableOfflinedViewEnvironment newInstance(OfflinedViewEnvironment offlinedViewEnvironment, BrowseAnalytics browseAnalytics, BoxAccountManagerHelper boxAccountManagerHelper, FileActionsManager fileActionsManager, OfflineFilesEnvironment offlineFilesEnvironment, DownloadEnvironment downloadEnvironment, BoxAiEnvironment boxAiEnvironment) {
        return new ActionableOfflinedViewEnvironment(offlinedViewEnvironment, browseAnalytics, boxAccountManagerHelper, fileActionsManager, offlineFilesEnvironment, downloadEnvironment, boxAiEnvironment);
    }
}
