...
abstract class Hilt_NewFileMenuFragment extends BottomSheetMenuFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((NewFileMenuFragment_GeneratedInjector) generatedComponent()).injectNewFileMenuFragment((NewFileMenuFragment) UnsafeCasts.unsafeCast(this));
    }
