...
public final class FolderViewEnvironment implements IItemsListViewEnvironment {
    ...
    private final FolderViewInteractor itemsViewUseCase;
    ...
    public FolderViewInteractor getItemsViewUseCase() {
