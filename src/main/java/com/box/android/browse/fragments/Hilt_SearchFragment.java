...
abstract class Hilt_SearchFragment extends BoxSearchFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((SearchFragment_GeneratedInjector) generatedComponent()).injectSearchFragment((SearchFragment) UnsafeCasts.unsafeCast(this));
    }
