...
import com.box.android.base.presentation.fragments.DialogSpinnerFragment;
...
abstract class Hilt_AutoContentUploadFragment extends DialogSpinnerFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_AutoContentUploadFragment() {
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((AutoContentUploadFragment_GeneratedInjector) generatedComponent()).injectAutoContentUploadFragment((AutoContentUploadFragment) UnsafeCasts.unsafeCast(this));
    }
