...
final /* synthetic */ class JobsReducer$build$3 extends FunctionReferenceImpl implements Function2<String, JobItemReducer.Action, JobsReducer.Action.JobItemAction> {
    public static final JobsReducer$build$3 INSTANCE = new JobsReducer$build$3();
