...
public class MAMExtractEditText extends ExtractEditText implements HookedTextView {
    ...
    public MAMExtractEditText(Context context) {
        super(context);
    ...
    public MAMExtractEditText(Context context, AttributeSet attributeSet) {
    ...
    public MAMExtractEditText(Context context, AttributeSet attributeSet, int i) {
    ...
    public MAMExtractEditText(Context context, AttributeSet attributeSet, int i, int i2) {
