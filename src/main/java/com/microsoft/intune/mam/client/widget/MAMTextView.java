...
public class MAMTextView extends TextView implements HookedTextView {
    ...
    public MAMTextView(Context context) {
        super(context);
    ...
    public MAMTextView(Context context, AttributeSet attributeSet) {
    ...
    public MAMTextView(Context context, AttributeSet attributeSet, int i) {
    ...
    public MAMTextView(Context context, AttributeSet attributeSet, int i, int i2) {
