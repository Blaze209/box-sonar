...
public class OfflineMAMUIHelperBehavior implements MAMUIHelperBehavior {
    private static final MAMLogger LOGGER = MAMLoggerProvider.getLogger(OfflineMAMUIHelperBehavior.class);
