...
public class MAMAutoCompleteTextView extends AutoCompleteTextView implements HookedTextView {
    ...
    public MAMAutoCompleteTextView(Context context) {
    ...
    public MAMAutoCompleteTextView(Context context, AttributeSet attributeSet) {
    ...
    public MAMAutoCompleteTextView(Context context, AttributeSet attributeSet, int i) {
    ...
    public MAMAutoCompleteTextView(Context context, AttributeSet attributeSet, int i, int i2) {
