...
public class MAMSurfaceView extends SurfaceView implements HookedSurfaceView {
    ...
    public MAMSurfaceView(Context context) {
        super(context);
    ...
    public MAMSurfaceView(Context context, AttributeSet attributeSet) {
    ...
    public MAMSurfaceView(Context context, AttributeSet attributeSet, int i) {
    ...
    public MAMSurfaceView(Context context, AttributeSet attributeSet, int i, int i2) {
