...
public class MAMCheckedTextView extends CheckedTextView implements HookedTextView {
    ...
    public MAMCheckedTextView(Context context, AttributeSet attributeSet, int i) {
    ...
    public MAMCheckedTextView(Context context, AttributeSet attributeSet, int i, int i2) {
