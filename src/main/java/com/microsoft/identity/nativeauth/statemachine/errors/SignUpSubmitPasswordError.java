...
public final class SignUpSubmitPasswordError extends Error implements SignUpSubmitPasswordResult, BrowserRequiredError {
    ...
    public /* synthetic */ SignUpSubmitPasswordError(String str, String str2, String str3, String str4, List list, String str5, Exception exc, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean isComplete() {
        return SignUpSubmitPasswordResult.DefaultImpls.isComplete(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isError() {
        return SignUpSubmitPasswordResult.DefaultImpls.isError(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isSuccess() {
        return SignUpSubmitPasswordResult.DefaultImpls.isSuccess(this);
    }
    ...
    public SignUpSubmitPasswordError(String str, String str2, String str3, String correlationId, List<Integer> list, String str4, Exception exc) {
