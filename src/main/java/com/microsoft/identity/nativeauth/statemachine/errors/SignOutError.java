...
public final class SignOutError extends Error implements SignOutResult {
    ...
    public /* synthetic */ SignOutError(String str, String str2, String str3, String str4, List list, Exception exc, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean isComplete() {
        return SignOutResult.DefaultImpls.isComplete(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isError() {
        return SignOutResult.DefaultImpls.isError(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isSuccess() {
        return SignOutResult.DefaultImpls.isSuccess(this);
    }
    ...
    public SignOutError(String str, String str2, String str3, String correlationId, List<Integer> list, Exception exc) {
