...
public class SignInContinuationError extends Error implements BrowserRequiredError, SignInResult {
    ...
    public /* synthetic */ SignInContinuationError(String str, String str2, String str3, String str4, List list, Exception exc, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public SignInContinuationError(String str, String str2, String str3, String correlationId, List<Integer> list, Exception exc) {
