...
public final class MFASubmitChallengeError extends Error implements BrowserRequiredError, MFASubmitChallengeResult {
    ...
    public /* synthetic */ MFASubmitChallengeError(String str, String str2, String str3, String str4, List list, String str5, Exception exc, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean isComplete() {
        return MFASubmitChallengeResult.DefaultImpls.isComplete(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isError() {
        return MFASubmitChallengeResult.DefaultImpls.isError(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isSuccess() {
        return MFASubmitChallengeResult.DefaultImpls.isSuccess(this);
    }
    ...
    public MFASubmitChallengeError(String str, String str2, String str3, String correlationId, List<Integer> list, String str4, Exception exc) {
