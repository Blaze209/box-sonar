...
public class SignInError extends Error implements SignInResult, BrowserRequiredError {
    ...
    public /* synthetic */ SignInError(String str, String str2, String str3, String str4, List list, Exception exc, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean isComplete() {
        return SignInResult.DefaultImpls.isComplete(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isError() {
        return SignInResult.DefaultImpls.isError(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isSuccess() {
        return SignInResult.DefaultImpls.isSuccess(this);
    }
    ...
    public SignInError(String str, String str2, String str3, String correlationId, List<Integer> list, Exception exc) {
    ...
    public final boolean isInvalidCredentials() {
        return Intrinsics.areEqual(getErrorType(), SignInErrorTypes.INVALID_CREDENTIALS);
    }
