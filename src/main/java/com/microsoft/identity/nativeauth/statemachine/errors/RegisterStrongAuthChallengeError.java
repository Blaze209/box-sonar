...
public final class RegisterStrongAuthChallengeError extends Error implements BrowserRequiredError, RegisterStrongAuthChallengeResult {
    ...
    public /* synthetic */ RegisterStrongAuthChallengeError(String str, String str2, String str3, String str4, List list, Exception exc, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean isComplete() {
        return RegisterStrongAuthChallengeResult.DefaultImpls.isComplete(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isError() {
        return RegisterStrongAuthChallengeResult.DefaultImpls.isError(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isSuccess() {
        return RegisterStrongAuthChallengeResult.DefaultImpls.isSuccess(this);
    }
    ...
    public RegisterStrongAuthChallengeError(String str, String str2, String str3, String correlationId, List<Integer> list, Exception exc) {
    ...
    public final boolean isInvalidInput() {
        return Intrinsics.areEqual(getErrorType(), ErrorTypes.INVALID_INPUT);
    }

    public final boolean isVerificationContactBlocked() {
        return Intrinsics.areEqual(getErrorType(), ErrorTypes.VERIFICATION_CONTACT_BLOCKED);
    }
}
