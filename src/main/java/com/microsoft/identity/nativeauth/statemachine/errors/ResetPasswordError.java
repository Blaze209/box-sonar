...
public final class ResetPasswordError extends Error implements ResetPasswordResult, ResetPasswordStartResult, BrowserRequiredError {
    ...
    public /* synthetic */ ResetPasswordError(String str, String str2, String str3, String str4, List list, Exception exc, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean isComplete() {
        return ResetPasswordResult.DefaultImpls.isComplete(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isError() {
        return ResetPasswordResult.DefaultImpls.isError(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isSuccess() {
        return ResetPasswordResult.DefaultImpls.isSuccess(this);
    }
    ...
    public ResetPasswordError(String str, String str2, String str3, String correlationId, List<Integer> list, Exception exc) {
    ...
    public final boolean isUserNotFound() {
        return Intrinsics.areEqual(getErrorType(), ErrorTypes.USER_NOT_FOUND);
    }
