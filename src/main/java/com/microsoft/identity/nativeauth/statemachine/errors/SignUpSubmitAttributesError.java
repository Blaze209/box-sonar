...
public final class SignUpSubmitAttributesError extends Error implements SignUpSubmitAttributesResult, BrowserRequiredError {
    ...
    public /* synthetic */ SignUpSubmitAttributesError(String str, String str2, String str3, String str4, List list, Exception exc, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean isComplete() {
        return SignUpSubmitAttributesResult.DefaultImpls.isComplete(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isError() {
        return SignUpSubmitAttributesResult.DefaultImpls.isError(this);
    }

    @Override // com.microsoft.identity.nativeauth.statemachine.results.Result
    public boolean isSuccess() {
        return SignUpSubmitAttributesResult.DefaultImpls.isSuccess(this);
    }
    ...
    public SignUpSubmitAttributesError(String str, String str2, String str3, String correlationId, List<Integer> list, Exception exc) {
