...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\bf\u0018\u00002\u00020\u0001:\u0001\u0002¨\u0006\u0003"}, d2 = {"Lcom/microsoft/identity/nativeauth/statemachine/results/ResetPasswordStartResult;", "Lcom/microsoft/identity/nativeauth/statemachine/results/Result;", "CodeRequired", "msal_distRelease"}, k = 1, mv = {1, 8, 0}, xi = 48)
public interface ResetPasswordStartResult extends Result {
    ...
    public static final class CodeRequired extends Result.SuccessResult implements ResetPasswordStartResult {
        ...
        public CodeRequired(ResetPasswordCodeRequiredState nextState, int i, String sentTo, String channel) {
            super(nextState);
