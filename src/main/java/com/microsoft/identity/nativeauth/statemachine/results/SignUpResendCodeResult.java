...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\bf\u0018\u00002\u00020\u0001:\u0001\u0002¨\u0006\u0003"}, d2 = {"Lcom/microsoft/identity/nativeauth/statemachine/results/SignUpResendCodeResult;", "Lcom/microsoft/identity/nativeauth/statemachine/results/Result;", "Success", "msal_distRelease"}, k = 1, mv = {1, 8, 0}, xi = 48)
public interface SignUpResendCodeResult extends Result {

    /* JADX INFO: compiled from: SignUpResult.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    public static final class DefaultImpls {
        public static boolean isComplete(SignUpResendCodeResult signUpResendCodeResult) {
            return Result.DefaultImpls.isComplete(signUpResendCodeResult);
        }

        public static boolean isError(SignUpResendCodeResult signUpResendCodeResult) {
            return Result.DefaultImpls.isError(signUpResendCodeResult);
        }

        public static boolean isSuccess(SignUpResendCodeResult signUpResendCodeResult) {
            return Result.DefaultImpls.isSuccess(signUpResendCodeResult);
        }
    }

    /* JADX INFO: compiled from: SignUpResult.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\n\u0018\u00002\u00020\u00012\u00020\u0002B%\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006\u0012\u0006\u0010\u0007\u001a\u00020\b\u0012\u0006\u0010\t\u001a\u00020\b¢\u0006\u0002\u0010\nR\u0011\u0010\t\u001a\u00020\b¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000eR\u0014\u0010\u0003\u001a\u00020\u0004X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\u0010R\u0011\u0010\u0007\u001a\u00020\b¢\u0006\b\n\u0000\u001a\u0004\b\u0011\u0010\f¨\u0006\u0012"}, d2 = {"Lcom/microsoft/identity/nativeauth/statemachine/results/SignUpResendCodeResult$Success;", "Lcom/microsoft/identity/nativeauth/statemachine/results/SignUpResendCodeResult;", "Lcom/microsoft/identity/nativeauth/statemachine/results/Result$SuccessResult;", "nextState", "Lcom/microsoft/identity/nativeauth/statemachine/states/SignUpCodeRequiredState;", "codeLength", "", "sentTo", "", "channel", "(Lcom/microsoft/identity/nativeauth/statemachine/states/SignUpCodeRequiredState;ILjava/lang/String;Ljava/lang/String;)V", "getChannel", "()Ljava/lang/String;", "getCodeLength", "()I", "getNextState", "()Lcom/microsoft/identity/nativeauth/statemachine/states/SignUpCodeRequiredState;", "getSentTo", "msal_distRelease"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class Success extends Result.SuccessResult implements SignUpResendCodeResult {
        ...
        public Success(SignUpCodeRequiredState nextState, int i, String sentTo, String channel) {
            super(nextState);
