...
public interface SignInSubmitPasswordCommandResult extends INativeAuthCommandResult {
    ...
    public static final class DefaultImpls {
        public static boolean containsPii(SignInSubmitPasswordCommandResult signInSubmitPasswordCommandResult) {
            return INativeAuthCommandResult.DefaultImpls.containsPii(signInSubmitPasswordCommandResult);
        }
    }
}
