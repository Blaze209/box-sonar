...
public interface SignInWithContinuationTokenCommandResult extends INativeAuthCommandResult {

    /* JADX INFO: compiled from: SignInCommandResult.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    public static final class DefaultImpls {
        public static boolean containsPii(SignInWithContinuationTokenCommandResult signInWithContinuationTokenCommandResult) {
            return INativeAuthCommandResult.DefaultImpls.containsPii(signInWithContinuationTokenCommandResult);
        }
    }
}
