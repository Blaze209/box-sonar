...
public interface JITChallengeAuthMethodCommandResult extends INativeAuthCommandResult {

    /* JADX INFO: compiled from: JITCommandResult.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    public static final class DefaultImpls {
        public static boolean containsPii(JITChallengeAuthMethodCommandResult jITChallengeAuthMethodCommandResult) {
            return INativeAuthCommandResult.DefaultImpls.containsPii(jITChallengeAuthMethodCommandResult);
        }
    }
}
