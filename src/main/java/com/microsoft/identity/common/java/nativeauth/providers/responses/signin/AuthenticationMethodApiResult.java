...
public final /* data */ class AuthenticationMethodApiResult implements ILoggable {
    ...
    public static /* synthetic */ AuthenticationMethodApiResult copy$default(AuthenticationMethodApiResult authenticationMethodApiResult, String str, String str2, String str3, String str4, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public final AuthenticationMethodApiResult copy(String id, String challengeType, String loginHint, String challengeChannel) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AuthenticationMethodApiResult)) {
            return false;
        }
        AuthenticationMethodApiResult authenticationMethodApiResult = (AuthenticationMethodApiResult) other;
        return Intrinsics.areEqual(this.id, authenticationMethodApiResult.id) && Intrinsics.areEqual(this.challengeType, authenticationMethodApiResult.challengeType) && Intrinsics.areEqual(this.loginHint, authenticationMethodApiResult.loginHint) && Intrinsics.areEqual(this.challengeChannel, authenticationMethodApiResult.challengeChannel);
    }
    ...
    public AuthenticationMethodApiResult(String id, String challengeType, String str, String challengeChannel) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(challengeType, "challengeType");
        Intrinsics.checkNotNullParameter(challengeChannel, "challengeChannel");
        this.id = id;
