...
public class ActiveDirectoryFederationServices2016 extends IdentityProvider<ActiveDirectoryFederationServices2016OAuth2Strategy, OAuth2Configuration> {
    ...
    public ActiveDirectoryFederationServices2016OAuth2Strategy createOAuth2Strategy(OAuth2Configuration oAuth2Configuration, IPlatformComponents iPlatformComponents) {
        return new ActiveDirectoryFederationServices2016OAuth2Strategy(oAuth2Configuration, OAuth2StrategyParameters.builder().platformComponents(iPlatformComponents).build());
    }
}
