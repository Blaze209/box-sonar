...
public class BrowserAuthorizationFragment extends AuthorizationFragment {
    ...
    public static Intent createCustomTabResponseIntent(Context context, String str) {
        String str2 = TAG + ":createCustomTabResponseIntent";
        if (sCallingActivityClass == null) {
            Logger.warn(str2, "Calling activity class is NULL. Unable to create intent for response.");
            return null;
        }
    ...
    /* JADX INFO: renamed from: com.microsoft.identity.common.internal.providers.oauth2.BrowserAuthorizationFragment$1, reason: invalid class name */
