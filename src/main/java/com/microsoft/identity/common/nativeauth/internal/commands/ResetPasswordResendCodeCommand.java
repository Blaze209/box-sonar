...
public final class ResetPasswordResendCodeCommand extends BaseNativeAuthCommand<ResetPasswordResendCodeCommandResult> {
    ...
    public ResetPasswordResendCodeCommand(ResetPasswordResendCodeCommandParameters parameters, NativeAuthMsalController controller, String publicApiId) {
    ...
    public ResetPasswordResendCodeCommandResult execute() throws Exception {
        LogSession.Companion companion = LogSession.INSTANCE;
        String TAG2 = TAG;
        Intrinsics.checkNotNullExpressionValue(TAG2, "TAG");
        companion.logMethodCall(TAG2, this.parameters.getCorrelationId(), TAG2 + ".execute");
        ResetPasswordResendCodeCommandResult resetPasswordResendCodeCommandResultResetPasswordResendCode = this.controller.resetPasswordResendCode(this.parameters);
        Logger.infoWithObject(TAG2, this.parameters.getCorrelationId(), "Returning result: ", resetPasswordResendCodeCommandResultResetPasswordResendCode);
        return resetPasswordResendCodeCommandResultResetPasswordResendCode;
    }
}
