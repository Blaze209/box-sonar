...
public final class SignUpSubmitUserAttributesCommand extends BaseNativeAuthCommand<SignUpSubmitUserAttributesCommandResult> {
    private static final String TAG = "SignUpSubmitUserAttributesCommand";
    private final NativeAuthMsalController controller;
    private final SignUpSubmitUserAttributesCommandParameters parameters;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SignUpSubmitUserAttributesCommand(SignUpSubmitUserAttributesCommandParameters parameters, NativeAuthMsalController controller, String publicApiId) {
    ...
    public SignUpSubmitUserAttributesCommandResult execute() throws Exception {
        LogSession.Companion companion = LogSession.INSTANCE;
        String TAG2 = TAG;
        Intrinsics.checkNotNullExpressionValue(TAG2, "TAG");
        companion.logMethodCall(TAG2, this.parameters.getCorrelationId(), TAG2 + ".execute");
        SignUpSubmitUserAttributesCommandResult signUpSubmitUserAttributesCommandResultSignUpSubmitUserAttributes = this.controller.signUpSubmitUserAttributes(this.parameters);
        Logger.infoWithObject(TAG2, "Returning result: ", signUpSubmitUserAttributesCommandResultSignUpSubmitUserAttributes);
        return signUpSubmitUserAttributesCommandResultSignUpSubmitUserAttributes;
    }
}
