...
public final class SignUpStartCommand extends BaseNativeAuthCommand<SignUpStartCommandResult> {
    ...
    public SignUpStartCommandResult execute() throws Exception {
        LogSession.Companion companion = LogSession.INSTANCE;
        String TAG2 = TAG;
        Intrinsics.checkNotNullExpressionValue(TAG2, "TAG");
        companion.logMethodCall(TAG2, this.parameters.getCorrelationId(), TAG2 + ".execute");
        SignUpStartCommandResult signUpStartCommandResultSignUpStart = this.controller.signUpStart(this.parameters);
        Logger.infoWithObject(TAG2, this.parameters.getCorrelationId(), "Returning result: ", signUpStartCommandResultSignUpStart);
        return signUpStartCommandResultSignUpStart;
    }
}
