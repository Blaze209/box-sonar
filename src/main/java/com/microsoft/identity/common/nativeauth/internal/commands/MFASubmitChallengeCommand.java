...
/* JADX INFO: compiled from: MFASubmitChallengeCommand.kt */
...
public final class MFASubmitChallengeCommand extends BaseNativeAuthCommand<MFASubmitChallengeCommandResult> {
    private static final String TAG = "MFASubmitChallengeCommand";
    private final NativeAuthMsalController controller;
    private final MFASubmitChallengeCommandParameters parameters;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MFASubmitChallengeCommand(MFASubmitChallengeCommandParameters parameters, NativeAuthMsalController controller, String publicApiId) {
    ...
    public MFASubmitChallengeCommandResult execute() throws Exception {
        LogSession.Companion companion = LogSession.INSTANCE;
        String TAG2 = TAG;
        Intrinsics.checkNotNullExpressionValue(TAG2, "TAG");
        companion.logMethodCall(TAG2, this.parameters.getCorrelationId(), TAG2 + ".execute");
        MFASubmitChallengeCommandResult mFASubmitChallengeCommandResultSignInSubmitChallenge = this.controller.signInSubmitChallenge(this.parameters);
        Logger.infoWithObject(TAG2, this.parameters.getCorrelationId(), "Returning result: ", mFASubmitChallengeCommandResultSignInSubmitChallenge);
        return mFASubmitChallengeCommandResultSignInSubmitChallenge;
    }
}
