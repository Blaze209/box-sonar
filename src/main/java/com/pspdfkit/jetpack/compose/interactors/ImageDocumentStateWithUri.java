...
public final class ImageDocumentStateWithUri extends DocumentState {
    ...
    public ImageDocumentStateWithUri(Context context, Uri uri, PdfActivityConfiguration pdfActivityConfiguration, MutableState<Fragment.SavedState> mutableState) {
