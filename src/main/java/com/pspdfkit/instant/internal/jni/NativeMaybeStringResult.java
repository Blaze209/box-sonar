...
public abstract class NativeMaybeStringResult {

    public static final class CppProxy extends NativeMaybeStringResult {
        ...
        private native String native_value(long j);
        ...
        @Override // com.pspdfkit.instant.internal.jni.NativeMaybeStringResult
