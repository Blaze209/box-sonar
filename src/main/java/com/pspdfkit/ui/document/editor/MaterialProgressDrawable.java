    ...
    public static class Ring {
        ...
        private void drawTriangle(Canvas canvas, float f, float f2, Rect rect) {
            if (this.mShowArrow) {
                ...
                float fCos = (float) ((Math.cos(0.0d) * this.mRingCenterRadius) + ((double) rect.exactCenterX()));
                float fSin = (float) ((Math.sin(0.0d) * this.mRingCenterRadius) + ((double) rect.exactCenterY()));
    ...
    private void setupAnimators() {
        ...
        Animation animation = new Animation() { // from class: com.pspdfkit.ui.document.editor.MaterialProgressDrawable.2
            ...
            public void applyTransformation(float f, Transformation transformation) {
                ...
                ring.setStartTrim(((ring.getStartingEndTrim() - ring.getStartingStartTrim()) * f) + ring.getStartingStartTrim());
        ...
        animation.setAnimationListener(new Animation.AnimationListener() { // from class: com.pspdfkit.ui.document.editor.MaterialProgressDrawable.3
            ...
            public void onAnimationEnd(Animation animation2) {
                ...
                materialProgressDrawable.mParent.startAnimation(materialProgressDrawable.mAnimation);
            }
        ...
        Animation animation2 = new Animation() { // from class: com.pspdfkit.ui.document.editor.MaterialProgressDrawable.4
            ...
            public void applyTransformation(float f, Transformation transformation) {
                ...
                ring.setEndTrim((MaterialProgressDrawable.START_CURVE_INTERPOLATOR.getInterpolation(f) * (0.8f - radians)) + startingEndTrim);
                ring.setStartTrim((MaterialProgressDrawable.END_CURVE_INTERPOLATOR.getInterpolation(f) * 0.8f) + startingStartTrim);
                ring.setRotation((0.25f * f) + startingRotation);
                MaterialProgressDrawable materialProgressDrawable = MaterialProgressDrawable.this;
                materialProgressDrawable.setRotation(((materialProgressDrawable.mRotationCount / 5.0f) * 720.0f) + (f * 144.0f));
            }
        };
