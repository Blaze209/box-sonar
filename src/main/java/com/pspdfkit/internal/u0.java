...
public final /* synthetic */ class u0 {
    ...
    static {
        ...
        try {
            iArr[AnnotationType.WIDGET.ordinal()] = 17;
        } catch (NoSuchFieldError unused17) {
        }
        try {
            iArr[AnnotationType.CARET.ordinal()] = 18;
        } catch (NoSuchFieldError unused18) {
        }
        try {
            iArr[AnnotationType.RICHMEDIA.ordinal()] = 19;
        } catch (NoSuchFieldError unused19) {
        }
        try {
            iArr[AnnotationType.SCREEN.ordinal()] = 20;
        } catch (NoSuchFieldError unused20) {
        }
        try {
            iArr[AnnotationType.FILE.ordinal()] = 21;
        ...
        try {
            iArr[AnnotationType.UNDEFINED.ordinal()] = 26;
        } catch (NoSuchFieldError unused26) {
        }
        try {
            iArr[AnnotationType.NONE.ordinal()] = 27;
