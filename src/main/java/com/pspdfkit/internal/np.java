...
public final class np extends h1<MeasurementDistanceAnnotationConfiguration.Builder> implements MeasurementDistanceAnnotationConfiguration.Builder {
    ...
    public final MeasurementDistanceAnnotationConfiguration build() {
        j1 j1Var = this.a;
        i1<Float> i1Var = i1.m;
        j1Var.getClass();
