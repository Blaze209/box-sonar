...
public class NonBlockingJsonParser extends NonBlockingJsonParserBase implements ByteArrayFeeder {
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    case 17:
                        return _finishKeywordToken(TelemetryEventStrings.Value.TRUE, this._pending32, JsonToken.VALUE_TRUE);
                    case 18:
    ...
    protected final JsonToken _finishTokenWithEOF() throws IOException {
        ...
        if (i != 50) {
            switch (i) {
                ...
                case 17:
                    return _finishKeywordTokenWithEOF(TelemetryEventStrings.Value.TRUE, this._pending32, JsonToken.VALUE_TRUE);
                case 18:
    ...
    protected JsonToken _startTrueToken() throws IOException {
        ...
        this._minorState = 17;
        return _finishKeywordToken(TelemetryEventStrings.Value.TRUE, 1, JsonToken.VALUE_TRUE);
    }
    ...
    protected JsonToken _finishNumberLeadingNegZeroes() throws IOException {
        while (this._inputPtr < this._inputEnd) {
            ...
            if (i2 < 48) {
                ...
                if (i2 != 48) {
                    char[] cArrEmptyAndGetCurrentSegment2 = this._textBuffer.emptyAndGetCurrentSegment();
                    cArrEmptyAndGetCurrentSegment2[0] = Soundex.SILENT_MARKER;
                ...
                if (i2 == 101 || i2 == 69) {
                    char[] cArrEmptyAndGetCurrentSegment3 = this._textBuffer.emptyAndGetCurrentSegment();
                    cArrEmptyAndGetCurrentSegment3[0] = Soundex.SILENT_MARKER;
