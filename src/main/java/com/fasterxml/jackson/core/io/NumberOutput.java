...
public final class NumberOutput {
    ...
    static {
        ...
        sSmallIntStrs = new String[]{"0", "1", "2", ExifInterface.GPS_MEASUREMENT_3D, GrpcStatusUtil.GRPC_STATUS_DEADLINE_EXCEEDED, "5", "6", "7", GrpcStatusUtil.GRPC_STATUS_RESOURCE_EXHAUSTED, "9", GrpcStatusUtil.GRPC_STATUS_ABORTED};
        sSmallIntStrs2 = new String[]{"-1", BoxCommonConstants.RECENTS_ROOT_FOLDER_ID, "-3", "-4", "-5", "-6", "-7", "-8", "-9", "-10"};
    }
    ...
    public static int outputInt(int i, byte[] bArr, int i2) {
        ...
        if (i < 0) {
            ...
            bArr[i2] = CtapException.ERR_KEEPALIVE_CANCEL;
            i = -i;
            i2++;
        }
        if (i < MILLION) {
        ...
        if (i >= i6) {
            ...
            if (i7 >= i6) {
                i7 -= i6;
                i3 = i2 + 1;
                bArr[i2] = CtapException.ERR_PIN_BLOCKED;
            } else {
                i3 = i2 + 1;
                bArr[i2] = CtapException.ERR_PIN_INVALID;
            }
    ...
    public static int outputLong(long j, byte[] bArr, int i) {
        ...
        if (j < 0) {
            ...
            bArr[i] = CtapException.ERR_KEEPALIVE_CANCEL;
            j = -j;
            i++;
        } else if (j <= MAX_INT_AS_LONG) {
            return outputInt((int) j, bArr, i);
