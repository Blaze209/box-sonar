...
final class TransactionWrapper<R> implements TransactionWithoutReturn, TransactionWithReturn<R> {
    ...
    public Void rollback(R returnValue) throws RollbackException {
        this.transaction.checkThreadConfinement$runtime();
    ...
    public void mo14349transaction(Function1<? super TransactionWithoutReturn, Unit> body) {
        Intrinsics.checkNotNullParameter(body, "body");
        Transacter transacter = this.transaction.getTransacter();
