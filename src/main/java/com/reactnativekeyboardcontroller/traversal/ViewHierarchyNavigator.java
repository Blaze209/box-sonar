...
public final class ViewHierarchyNavigator {
    ...
    public final void setFocusTo(String direction, View view) {
        ...
        final EditText editTextFindNextEditText = Intrinsics.areEqual(direction, ES6Iterator.NEXT_METHOD) ? findNextEditText(view) : findPreviousEditText(view);
