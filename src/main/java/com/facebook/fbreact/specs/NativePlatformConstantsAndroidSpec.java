...
public abstract class NativePlatformConstantsAndroidSpec extends ReactContextBaseJavaModule implements TurboModule {
    ...
    public final Map<String, Object> getConstants() {
        ...
        if (ReactBuildConfig.DEBUG || ReactBuildConfig.IS_INTERNAL_BUILD) {
            HashSet hashSet = new HashSet(Arrays.asList("Brand", "Fingerprint", "Manufacturer", ExifInterface.TAG_MODEL, DebugTraceUtil.EVENT_RELEASE, "Serial", "Version", "isTesting", "reactNativeVersion", "uiMode"));
