...
public class DefaultDiskStorage implements DiskStorage {
    ...
    public DiskStorage.Inserter insert(String str, Object obj) throws IOException {
        ...
        if (!subdirectory.exists()) {
            mkdirs(subdirectory, SemanticAttributes.FaasDocumentOperationValues.INSERT);
        }
        try {
            return new InserterImpl(str, fileInfo.createTempFile(subdirectory));
        } catch (IOException e) {
            this.mCacheErrorLogger.logError(CacheErrorLogger.CacheErrorCategory.WRITE_CREATE_TEMPFILE, TAG, SemanticAttributes.FaasDocumentOperationValues.INSERT, e);
            throw e;
        }
    }
    ...
    private String typeOfBytes(byte[] bArr) {
        if (bArr.length >= 2) {
            ...
            if (b == 71 && bArr[1] == 73) {
                return SupportedFileExtensions.GIF_EXTENSION;
            }
            return "undefined";
        }
        return "undefined";
    ...
    class InserterImpl implements DiskStorage.Inserter {
        ...
        public BinaryResource commit(Object obj, long j) throws IOException {
            ...
            try {
                ...
                DefaultDiskStorage.this.mCacheErrorLogger.logError(cacheErrorCategory, DefaultDiskStorage.TAG, BoxUploadSessionEndpoints.FIELD_COMMIT, e);
                throw e;
            }
        }
