...
public class NumberFormat {
    ...
    private void setNumberFormatUnitOptions(Map<String, Object> map) throws JSRangeErrorException {
        ...
        Object objGetOption2 = OptionHelpers.GetOption(map, "currencyDisplay", OptionHelpers.OptionType.STRING, new String[]{NativeSymbol.TYPE_NAME, "narrowSymbol", "code", "name"}, NativeSymbol.TYPE_NAME);
