...
public final class WebpUtil {
    ...
    private final String getHeader(byte[] header) {
        ...
        for (byte b : header) {
            sb.append((char) (UShort.m15061constructorimpl(b) & UShort.MAX_VALUE));
        }
