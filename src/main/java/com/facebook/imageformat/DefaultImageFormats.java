...
public final class DefaultImageFormats {
    ...
    static {
        ...
        JPEG = imageFormat;
        ImageFormat imageFormat2 = new ImageFormat("PNG", BoxRepresentation.TYPE_PNG);
        PNG = imageFormat2;
        ImageFormat imageFormat3 = new ImageFormat("GIF", SupportedFileExtensions.GIF_EXTENSION);
        GIF = imageFormat3;
