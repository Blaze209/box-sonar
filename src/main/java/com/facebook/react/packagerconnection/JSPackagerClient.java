...
public final class JSPackagerClient implements ReconnectingWebSocket.MessageCallback {
    ...
    public JSPackagerClient(String clientId, PackagerConnectionSettings settings, Map<String, ? extends RequestHandler> requestHandlers, ReconnectingWebSocket.ConnectionCallback connectionCallback) {
        ...
        String string = new Uri.Builder().scheme("ws").encodedAuthority(settings.getDebugServerHost()).appendPath("message").appendQueryParameter(SemanticAttributes.EventDomainValues.DEVICE, AndroidInfoHelpers.getFriendlyDeviceName()).appendQueryParameter("app", settings.getPackageName()).appendQueryParameter("clientid", clientId).build().toString();
    ...
    public void onMessage(String text) {
        ...
        try {
            ...
            Object objOpt2 = jSONObject.opt(SerializedNames.PARAMS);
            if (iOptInt != 2) {
    ...
    /* JADX INFO: compiled from: JSPackagerClient.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0003\b\u0082\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0010\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0003H\u0016J\u0010\u0010\t\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\u0003H\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Lcom/facebook/react/packagerconnection/JSPackagerClient$ResponderImpl;", "Lcom/facebook/react/packagerconnection/Responder;", "id", "", "<init>", "(Lcom/facebook/react/packagerconnection/JSPackagerClient;Ljava/lang/Object;)V", "respond", "", ReactNativeFeatureActivity.RESULT_EXTRA_KEY, "error", "ReactAndroid_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    private final class ResponderImpl implements Responder {
        ...
        public void respond(Object result) {
            ...
            try {
                ...
                jSONObject.put(ReactNativeFeatureActivity.RESULT_EXTRA_KEY, result);
