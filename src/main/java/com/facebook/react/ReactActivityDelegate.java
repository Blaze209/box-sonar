...
public class ReactActivityDelegate {
    ...
    public /* synthetic */ void lambda$onCreate$0() {
        ...
        if (ReactNativeNewArchitectureFeatureFlags.enableBridgelessArchitecture()) {
            ...
            reactActivityDelegate = this;
            reactActivityDelegate.mReactDelegate = new ReactDelegate(getPlainActivity(), getReactNativeHost(), mainComponentName, bundleComposeLaunchOptions, getFabricEnabled()) { // from class: com.facebook.react.ReactActivityDelegate.1
        ...
        if (mainComponentName != null) {
            reactActivityDelegate.loadApp(mainComponentName);
        }
    }
