...
public final class ColorPropConverter {
    ...
    private final Integer getColorInteger(Object value, Context context) {
        ...
        if (value instanceof ReadableMap) {
            ...
            if (readableMap.hasKey("space")) {
                float f = 255;
                return Integer.valueOf(Color.argb((int) (((float) readableMap.getDouble(CmcdData.OBJECT_TYPE_AUDIO_ONLY)) * f), (int) (((float) readableMap.getDouble("r")) * f), (int) (((float) readableMap.getDouble("g")) * f), (int) (((float) readableMap.getDouble("b")) * f)));
            }
    ...
    public static final Integer resolveResourcePath(Context context, String resourcePath) {
        ...
        if (str != null && str.length() != 0) {
            boolean zStartsWith$default = StringsKt.startsWith$default(resourcePath, "@", false, 2, (Object) null);
            boolean zStartsWith$default2 = StringsKt.startsWith$default(resourcePath, "?", false, 2, (Object) null);
    ...
    private final int resolveResource(Context context, String resourcePath) {
        ...
        List listSplit$default2 = StringsKt.split$default((CharSequence) resourcePath, new String[]{"/"}, false, 0, 6, (Object) null);
