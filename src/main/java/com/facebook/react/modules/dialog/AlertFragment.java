...
public final class AlertFragment extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public static final class Companion {
        ...
        private final View getAccessibleTitle(Context activityContext, String titleText) {
            ...
            TextView textView = (TextView) objAssertNotNull;
        ...
        private final Dialog createAppDialog(Context activityContext, Bundle arguments, DialogInterface.OnClickListener fragment) {
            MAMAlertDialogBuilder mAMAlertDialogBuilder = new MAMAlertDialogBuilder(activityContext);
            if (arguments.containsKey("title")) {
                String str = (String) Assertions.assertNotNull(arguments.getString("title"));
                Intrinsics.checkNotNull(str);
                mAMAlertDialogBuilder.setCustomTitle(getAccessibleTitle(activityContext, str));
            }
            if (arguments.containsKey(AlertFragment.ARG_BUTTON_POSITIVE)) {
                mAMAlertDialogBuilder.setPositiveButton(arguments.getString(AlertFragment.ARG_BUTTON_POSITIVE), fragment);
            }
            if (arguments.containsKey(AlertFragment.ARG_BUTTON_NEGATIVE)) {
                mAMAlertDialogBuilder.setNegativeButton(arguments.getString(AlertFragment.ARG_BUTTON_NEGATIVE), fragment);
            }
            if (arguments.containsKey(AlertFragment.ARG_BUTTON_NEUTRAL)) {
                mAMAlertDialogBuilder.setNeutralButton(arguments.getString(AlertFragment.ARG_BUTTON_NEUTRAL), fragment);
            }
            if (arguments.containsKey("message")) {
                mAMAlertDialogBuilder.setMessage(arguments.getString("message"));
            }
            if (arguments.containsKey(AlertFragment.ARG_ITEMS)) {
                mAMAlertDialogBuilder.setItems(arguments.getCharSequenceArray(AlertFragment.ARG_ITEMS), fragment);
            }
            android.app.AlertDialog alertDialogCreate = mAMAlertDialogBuilder.create();
            Intrinsics.checkNotNullExpressionValue(alertDialogCreate, "create(...)");
            return alertDialogCreate;
        }
    }
