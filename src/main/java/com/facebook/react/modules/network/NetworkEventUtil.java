...
public final class NetworkEventUtil {
    ...
    @JvmStatic
    public static final void onResponseReceived(ReactApplicationContext reactContext, int requestId, String devToolsRequestId, String requestUrl, Response response) {
        Intrinsics.checkNotNullParameter(devToolsRequestId, "devToolsRequestId");
    ...
    private final Map<String, String> okHttpHeadersToMap(Headers headers) {
        ...
        int iM16512deprecated_size = headers.m16512deprecated_size();
        for (int i = 0; i < iM16512deprecated_size; i++) {
