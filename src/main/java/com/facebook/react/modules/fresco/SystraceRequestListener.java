...
public final class SystraceRequestListener extends BaseRequestListener {
    ...
    public void onProducerStart(String requestId, String producerName) {
        ...
        if (Systrace.isTracing(0L)) {
            Pair<Integer, String> pairCreate = Pair.create(Integer.valueOf(this.currentId), "FRESCO_PRODUCER_" + StringsKt.replace$default(producerName, AbstractJsonLexerKt.COLON, SessionDataKt.UNDERSCORE, false, 4, (Object) null));
    ...
    public void onProducerEvent(String requestId, String producerName, String eventName) {
        ...
        if (Systrace.isTracing(0L)) {
            Systrace.traceInstant(0L, "FRESCO_PRODUCER_EVENT_" + StringsKt.replace$default(requestId, AbstractJsonLexerKt.COLON, SessionDataKt.UNDERSCORE, false, 4, (Object) null) + "_" + StringsKt.replace$default(producerName, AbstractJsonLexerKt.COLON, SessionDataKt.UNDERSCORE, false, 4, (Object) null) + "_" + StringsKt.replace$default(eventName, AbstractJsonLexerKt.COLON, SessionDataKt.UNDERSCORE, false, 4, (Object) null), Systrace.EventScope.THREAD);
        }
    }
    ...
    public void onRequestStart(ImageRequest request, Object callerContext, String requestId, boolean isPrefetch) {
        ...
        if (Systrace.isTracing(0L)) {
            ...
            sb.append(StringsKt.replace$default(string, AbstractJsonLexerKt.COLON, SessionDataKt.UNDERSCORE, false, 4, (Object) null));
