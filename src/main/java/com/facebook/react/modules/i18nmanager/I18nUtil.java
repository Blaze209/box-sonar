...
public final class I18nUtil {
    ...
    private final boolean isRTLForced(Context context) {
        return isPrefSet(context, KEY_FOR_PREFS_FORCERTL, false) || StringsKt.equals(System.getProperty("FORCE_RTL_FOR_TESTING", "false"), TelemetryEventStrings.Value.TRUE, true);
    }
