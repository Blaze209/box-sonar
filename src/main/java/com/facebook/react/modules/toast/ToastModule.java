...
public final class ToastModule extends NativeToastAndroidSpec {
    ...
    protected Map<String, Object> getTypedExportedConstants() {
        return MapsKt.mutableMapOf(TuplesKt.to(DURATION_SHORT_KEY, 0), TuplesKt.to(DURATION_LONG_KEY, 1), TuplesKt.to("TOP", 49), TuplesKt.to("BOTTOM", 81), TuplesKt.to("CENTER", 17));
    }
