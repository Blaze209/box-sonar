...
public final class AndroidInfoModule extends NativePlatformConstantsAndroidSpec {
    ...
    protected Map<String, Object> getTypedExportedConstants() {
        ...
        linkedHashMap.put(DebugTraceUtil.EVENT_RELEASE, Build.VERSION.RELEASE);
        ...
        linkedHashMap.put("isTesting", Boolean.valueOf(Intrinsics.areEqual(TelemetryEventStrings.Value.TRUE, System.getProperty(IS_TESTING))));
        String property = System.getProperty(IS_DISABLE_ANIMATIONS);
        if (property != null) {
            linkedHashMap.put("isDisableAnimations", Boolean.valueOf(Intrinsics.areEqual(TelemetryEventStrings.Value.TRUE, property)));
        }
    ...
    public String getAndroidID() {
        String string = Settings.Secure.getString(getReactApplicationContext().getContentResolver(), DeviceIdStorage.ANDROID_ID_SHARED_PREFS_KEY);
