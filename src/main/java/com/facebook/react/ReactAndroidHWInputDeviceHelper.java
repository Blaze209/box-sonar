...
public final class ReactAndroidHWInputDeviceHelper {
    ...
    private static final Map<Integer, String> KEY_EVENTS_ACTIONS = MapsKt.mapOf(TuplesKt.to(23, "select"), TuplesKt.to(66, "select"), TuplesKt.to(62, "select"), TuplesKt.to(85, "playPause"), TuplesKt.to(89, "rewind"), TuplesKt.to(90, "fastForward"), TuplesKt.to(86, "stop"), TuplesKt.to(87, ES6Iterator.NEXT_METHOD), TuplesKt.to(88, "previous"), TuplesKt.to(19, DiagnosisParams.UPLOAD_AT_COMPLETION), TuplesKt.to(22, "right"), TuplesKt.to(20, "down"), TuplesKt.to(21, "left"), TuplesKt.to(Integer.valueOf(Token.ARROW), BoxRepresentation.FIELD_INFO), TuplesKt.to(82, "menu"), TuplesKt.to(Integer.valueOf(Token.YIELD_STAR), "channelUp"), TuplesKt.to(Integer.valueOf(Token.LAST_TOKEN), "channelDown"));
