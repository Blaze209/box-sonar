...
public final class FrescoBasedReactTextInlineImageShadowNode extends ReactTextInlineImageShadowNode {
    ...
    public static final class Companion {
        ...
        public final Uri getResourceDrawableUri(Context context, String name) {
            ...
            return new Uri.Builder().scheme(UriUtil.LOCAL_RESOURCE_SCHEME).path(String.valueOf(context.getResources().getIdentifier(StringsKt.replace$default(lowerCase, CacheKeyValueDelegate.CACHE_VALUE_SEPARATOR, "_", false, 4, (Object) null), "drawable", context.getPackageName()))).build();
        }
    }
