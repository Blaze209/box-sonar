...
public final class ReactTextViewManager extends ReactTextAnchorViewManager<ReactTextShadowNode> implements IViewManagerWithChildren, ReactTextViewManagerCallback {
    ...
    private final Object getReactTextUpdate(ReactTextView view, ReactStylesDiffMap props, MapBuffer state) {
        ...
        return new ReactTextUpdate(orCreateSpannableForText, -1, false, TextLayoutManager.getTextGravity(mapBuffer, orCreateSpannableForText), TextAttributeProps.INSTANCE.getTextBreakStrategy(mapBuffer2.getString(2)), TextAttributeProps.INSTANCE.getJustificationMode(props, view.getJustificationMode()));
    }
