...
public final class ReactTypefaceUtils {
    ...
    public static final int parseFontWeight(String fontWeightString) {
        ...
        switch (fontWeightString.hashCode()) {
            case -1039745817:
                return !fontWeightString.equals(SemanticAttributes.MessagingRocketmqMessageTypeValues.NORMAL) ? -1 : 400;
            case 48625:
                return !fontWeightString.equals(PerfConstants.ScenarioConstants.SCENARIO_NON_BROKERED_ACQUIRE_TOKEN_SILENTLY) ? -1 : 100;
            case 49586:
                return !fontWeightString.equals(PerfConstants.ScenarioConstants.SCENARIO_BROKERED_ACQUIRE_TOKEN_SILENTLY) ? -1 : 200;
            case 50547:
                return !fontWeightString.equals(PerfConstants.ScenarioConstants.SCENARIO_GENERATE_AT_POP_ASYMMETRIC_KEYPAIR) ? -1 : 300;
            case 51508:
            ...
            case 55352:
                if (fontWeightString.equals("800")) {
                    return HubAssetRemoteDataSource.HUB_BANNER_SCALED_SIZE;
                }
                return -1;
            case 56313:
    ...
    public static final int parseFontStyle(String fontStyleString) {
        ...
        return Intrinsics.areEqual(fontStyleString, SemanticAttributes.MessagingRocketmqMessageTypeValues.NORMAL) ? 0 : -1;
    }
