...
public class ReactViewGroup extends MAMViewGroup implements ReactInterceptingViewGroup, ReactClippingViewGroup, ReactPointerEventsView, ReactHitSlopView, ReactZIndexedViewGroup, ReactOverflowViewWithInset {
    ...
    public final void updateSubviewClipStatus(View subview) {
        ...
        if (rect.intersects(subview.getLeft(), subview.getTop(), subview.getRight(), subview.getBottom()) != (!isViewClipped(subview, null))) {
            ...
            for (int i3 = 0; i3 < i; i3++) {
                ...
                if (view == subview) {
                    updateSubviewClipStatus$default(this, rect, i3, i2, null, 8, null);
                    break;
                } else {
                    if (isViewClipped(view, Integer.valueOf(i3))) {
                        i2++;
                    }
                }
            }
    ...
    /* JADX WARN: Code duplicated, block: B:17:0x0069 A[PHI: r4
      0x0069: PHI (r4v1 android.graphics.BlendMode) = (r4v0 android.graphics.BlendMode), (r4v0 android.graphics.BlendMode), (r4v3 android.graphics.BlendMode) binds: [B:9:0x0026, B:11:0x002f, B:15:0x003e] A[DONT_GENERATE, DONT_INLINE]] */
    @Override // android.view.ViewGroup
