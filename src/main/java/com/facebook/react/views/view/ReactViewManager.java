    ...
    public void setHitSlop(ReactViewGroup view, Dynamic hitSlop) {
        ...
        if (i == 1) {
            ...
            if (readableMapAsMap == null) {
                ...
                view.setHitSlopRect(new Rect(px(readableMapAsMap, "left"), px(readableMapAsMap, ViewProps.TOP), px(readableMapAsMap, "right"), px(readableMapAsMap, ViewProps.BOTTOM)));
                return;
            }
        }
        if (i == 2) {
