...
public class ReactEditText extends AppCompatEditText {
    ...
    public InputConnection onMAMCreateInputConnection(EditorInfo outAttrs) {
        ...
        ReactEditTextInputConnectionWrapper reactEditTextInputConnectionWrapperOnMAMCreateInputConnection = super.onMAMCreateInputConnection(outAttrs);
        if (reactEditTextInputConnectionWrapperOnMAMCreateInputConnection != null && this.onKeyPress) {
            EventDispatcher eventDispatcher = this.eventDispatcher;
            if (eventDispatcher != null) {
                reactEditTextInputConnectionWrapperOnMAMCreateInputConnection = new ReactEditTextInputConnectionWrapper(reactEditTextInputConnectionWrapperOnMAMCreateInputConnection, reactContext, this, eventDispatcher);
            } else {
                throw new IllegalStateException("Required value was null.".toString());
            }
        }
        ...
        return reactEditTextInputConnectionWrapperOnMAMCreateInputConnection;
    }
        ...
        if (str != null) {
            switch (str.hashCode()) {
                ...
                case 3304:
                    ...
                    break;
                case 3089282:
                    str.equals(ES6Iterator.DONE_PROPERTY);
                    break;
                case 3377907:
