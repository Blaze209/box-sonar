...
public final class MultiPostprocessor implements Postprocessor {
    ...
    public CloseableReference<Bitmap> process(Bitmap sourceBitmap, PlatformBitmapFactory bitmapFactory) {
        ...
        try {
            CloseableReference<Bitmap> closeableReferenceMo13208clone = null;
            for (Postprocessor postprocessor : this.postprocessors) {
                if (closeableReferenceMo13208clone == null || (bitmap = closeableReferenceMo13208clone.get()) == null) {
                    bitmap = sourceBitmap;
                }
                closeableReferenceProcess = postprocessor.process(bitmap, bitmapFactory);
                CloseableReference.closeSafely(closeableReferenceMo13208clone);
                closeableReferenceMo13208clone = closeableReferenceProcess.mo13208clone();
            }
            ...
            CloseableReference<Bitmap> closeableReferenceMo13208clone2 = closeableReferenceProcess.mo13208clone();
            Intrinsics.checkNotNullExpressionValue(closeableReferenceMo13208clone2, "clone(...)");
            CloseableReference.closeSafely(closeableReferenceProcess);
            return closeableReferenceMo13208clone2;
        } catch (Throwable th) {
    ...
    /* JADX INFO: compiled from: MultiPostprocessor.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0018\u0010\u0004\u001a\u0004\u0018\u00010\u00052\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u0007H\u0007¨\u0006\b"}, d2 = {"Lcom/facebook/react/views/image/MultiPostprocessor$Companion;", "", "<init>", "()V", TypedValues.TransitionType.S_FROM, "Lcom/facebook/imagepipeline/request/Postprocessor;", "postprocessors", "", "ReactAndroid_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
