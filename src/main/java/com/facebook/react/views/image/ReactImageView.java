...
public final class ReactImageView extends GenericDraweeView {
    ...
    public final void setSource(ReadableArray sources) {
        ...
        if (sources == null || sources.size() == 0) {
            ...
            if (sources.size() == 1) {
                ...
                ImageCacheControl imageCacheControlComputeCacheControl = computeCacheControl(map.getString(SemanticAttributes.DbSystemValues.CACHE));
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (map2 != null) {
                        ImageCacheControl imageCacheControlComputeCacheControl2 = computeCacheControl(map2.getString(SemanticAttributes.DbSystemValues.CACHE));
    ...
    */
    ...
    /* JADX INFO: compiled from: ReactImageView.kt */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u001e\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u00052\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\tH\u0016¨\u0006\n"}, d2 = {"Lcom/facebook/react/views/image/ReactImageView$TilePostprocessor;", "Lcom/facebook/imagepipeline/request/BasePostprocessor;", "<init>", "(Lcom/facebook/react/views/image/ReactImageView;)V", SemanticAttributes.MessagingOperationValues.PROCESS, "Lcom/facebook/common/references/CloseableReference;", "Landroid/graphics/Bitmap;", "source", "bitmapFactory", "Lcom/facebook/imagepipeline/bitmaps/PlatformBitmapFactory;", "ReactAndroid_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    private final class TilePostprocessor extends BasePostprocessor {
        ...
        public CloseableReference<Bitmap> process(Bitmap source, PlatformBitmapFactory bitmapFactory) {
            ...
            try {
                ...
                CloseableReference<Bitmap> closeableReferenceMo13208clone = closeableReferenceCreateBitmap.mo13208clone();
                Intrinsics.checkNotNullExpressionValue(closeableReferenceMo13208clone, "clone(...)");
                return closeableReferenceMo13208clone;
            } finally {
