...
public final class PropsAnimatedNode extends AnimatedNode {
    ...
    public final View getConnectedView() {
        ...
        try {
            ...
            UIManager uIManager = this.connectedViewUIManager;
            objM14780constructorimpl = Result.m14780constructorimpl(uIManager != null ? uIManager.resolveView(this.connectedViewTag) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM14780constructorimpl = Result.m14780constructorimpl(ResultKt.createFailure(th));
        }
        return (View) (Result.m14786isFailureimpl(objM14780constructorimpl) ? null : objM14780constructorimpl);
    }
