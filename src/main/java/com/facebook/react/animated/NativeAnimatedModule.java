...
public final class NativeAnimatedModule extends NativeAnimatedModuleSpec implements LifecycleEventListener, UIManagerListener {
    ...
    /* JADX INFO: compiled from: NativeAnimatedModule.kt */
    @Metadata(d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0000\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0014\u0010\f\u001a\u00020\r2\n\u0010\u000e\u001a\u00060\u0006R\u00020\u0007H\u0007J\u001a\u0010\u000f\u001a\u00020\r2\u0006\u0010\u0010\u001a\u00020\u00112\b\u0010\u0012\u001a\u0004\u0018\u00010\u0013H\u0007J\u001c\u0010\u0014\u001a\u000e\u0012\b\u0012\u00060\u0006R\u00020\u0007\u0018\u00010\u00152\u0006\u0010\u0010\u001a\u00020\u0011H\u0007R\u0018\u0010\u0004\u001a\f\u0012\b\u0012\u00060\u0006R\u00020\u00070\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001a\b\u0018\u00010\u0006R\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u0011\u0010\t\u001a\u00020\n8G¢\u0006\u0006\u001a\u0004\b\t\u0010\u000b¨\u0006\u0016"}, d2 = {"Lcom/facebook/react/animated/NativeAnimatedModule$ConcurrentOperationQueue;", "", "<init>", "(Lcom/facebook/react/animated/NativeAnimatedModule;)V", SemanticAttributes.MessagingDestinationKindValues.QUEUE, "Ljava/util/Queue;", "Lcom/facebook/react/animated/NativeAnimatedModule$UIThreadOperation;", "Lcom/facebook/react/animated/NativeAnimatedModule;", "peekedOperation", "isEmpty", "", "()Z", "add", "", SerializedNames.OPERATION, "executeBatch", "maxBatchNumber", "", "nodesManager", "Lcom/facebook/react/animated/NativeAnimatedNodesManager;", "drainQueueIntoList", "", "ReactAndroid_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public void queueAndExecuteBatchedOperations(ReadableArray opsAndArgs) {
        ...
        startOperationBatch();
        addUnbatchedOperation(new C17501(size, opsAndArgs));
    ...
    public static final class C17501 extends UIThreadOperation {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C17501(int i, ReadableArray readableArray) {
            super();
            this.$opBufferSize = i;
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[BatchExecutionOpCodes.INSTANCE.fromId(this.$opsAndArgs.getInt(i)).ordinal()]) {
                    ...
                    case 4:
                        ...
                        animatedNodesManager.startListeningToAnimatedNodeValue(i7, new AnimatedNodeValueListener() { // from class: com.facebook.react.animated.NativeAnimatedModule$queueAndExecuteBatchedOperations$1$$ExternalSyntheticLambda0
                            @Override // com.facebook.react.animated.AnimatedNodeValueListener
                            public final void onValueUpdate(double d, double d2) {
                                NativeAnimatedModule.C17501.execute$lambda$1(nativeAnimatedModule, i7, d, d2);
                            }
                        });
                        break;
                    case 5:
