...
public class SurfaceMountingManager {
    ...
    public static void logViewHierarchy(ViewGroup viewGroup, boolean z) {
        ...
        FLog.e(TAG, "  <ViewGroup tag=" + id + " class=" + viewGroup.getClass().toString() + SimpleComparison.GREATER_THAN_OPERATION);
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            FLog.e(TAG, "     <View idx=" + i + " tag=" + viewGroup.getChildAt(i).getId() + " class=" + viewGroup.getChildAt(i).getClass().toString() + SimpleComparison.GREATER_THAN_OPERATION);
        }
        String str = TAG;
        FLog.e(str, "  </ViewGroup tag=" + id + SimpleComparison.GREATER_THAN_OPERATION);
        if (z) {
            FLog.e(str, "Displaying Ancestors:");
            for (ViewParent parent = viewGroup.getParent(); parent != null; parent = parent.getParent()) {
                ViewGroup viewGroup2 = parent instanceof ViewGroup ? (ViewGroup) parent : null;
                FLog.e(TAG, "<ViewParent tag=" + (viewGroup2 == null ? -1 : viewGroup2.getId()) + " class=" + parent.getClass().toString() + SimpleComparison.GREATER_THAN_OPERATION);
            }
        }
    }
