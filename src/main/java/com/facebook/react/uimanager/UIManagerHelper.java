...
public final class UIManagerHelper {
    ...
    public static final float[] getDefaultTextInputPadding(Context context) {
        ...
        MAMEditText mAMEditText2 = mAMEditText;
        return new float[]{PixelUtil.toDIPFromPixel(ViewCompat.getPaddingStart(mAMEditText2)), PixelUtil.toDIPFromPixel(ViewCompat.getPaddingEnd(mAMEditText2)), PixelUtil.toDIPFromPixel(mAMEditText.getPaddingTop()), PixelUtil.toDIPFromPixel(mAMEditText.getPaddingBottom())};
    }
}
