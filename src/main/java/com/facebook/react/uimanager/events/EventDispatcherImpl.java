...
public final class EventDispatcherImpl implements EventDispatcher, LifecycleEventListener {
    ...
    public void dispatchEvent(Event<?> event) {
        ...
        synchronized (this.eventsStagingLock) {
            ...
            Systrace.startAsyncFlow(0L, event.getName(), event.getUniqueID());
            ...
            synchronized (this.eventsToDispatchLock) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (!event2.canCoalesce()) {
                        ...
                        long eventCookie = getEventCookie(event2.getViewTag(), event2.getName(), event2.getCoalescingKey());
                ...
                synchronized (obj) {
                    if (eventDispatcherImpl.eventsToDispatchSize > 0) {
                        ...
                        for (int i2 = 0; i2 < i; i2++) {
                            ...
                            if (event != null) {
                                Systrace.endAsyncFlow(0L, event.getName(), event.getUniqueID());
    ...
    /* JADX INFO: compiled from: EventDispatcherImpl.kt */
    @Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\n\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J \u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\fH\u0002R\u001a\u0010\u0004\u001a\u000e\u0012\n\u0012\b\u0012\u0002\b\u0003\u0018\u00010\u00060\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000e"}, d2 = {"Lcom/facebook/react/uimanager/events/EventDispatcherImpl$Companion;", "", "<init>", "()V", "EVENT_COMPARATOR", "Ljava/util/Comparator;", "Lcom/facebook/react/uimanager/events/Event;", "getEventCookie", "", "viewTag", "", SerializableEvent.EVENT_TYPE_FIELD, "", "coalescingKey", "ReactAndroid_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
        ...
        public final long getEventCookie(int viewTag, short eventTypeId, short coalescingKey) {
            return ((long) viewTag) | ((((long) eventTypeId) & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 32) | ((((long) coalescingKey) & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 48);
        }
