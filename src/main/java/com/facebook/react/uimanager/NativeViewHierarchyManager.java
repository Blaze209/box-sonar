            ...
            try {
                if (this.DEBUG_MODE) {
                    try {
                        ...
                        th = th2;
                        nativeViewHierarchyManager = this;
                    }
                }
                UiThreadUtil.assertOnUiThread();
                ...
                if (iArr2 != null) {
                    ...
                    while (i4 < iArr2.length) {
                        ...
                        if (this.mLayoutAnimationEnabled && this.mLayoutAnimator.shouldAnimateLayout(view)) {
                            ...
                            nativeViewHierarchyManager2 = this;
                            i2 = i;
                            ...
                            nativeViewHierarchyManager2 = this;
                            i2 = i;
                            nativeViewHierarchyManager2.dropView(view);
                        }
                        i4++;
                        this = nativeViewHierarchyManager2;
                        i = i2;
                    }
                }
                NativeViewHierarchyManager nativeViewHierarchyManager3 = this;
                int i6 = i;
                if (viewAtIndexArr != null) {
                    for (ViewAtIndex viewAtIndex : viewAtIndexArr) {
                        View view2 = nativeViewHierarchyManager3.mTagsToViews.get(viewAtIndex.mTag);
                        if (view2 == null) {
                ...
                if (pendingDeletionsForTag.isEmpty()) {
                    nativeViewHierarchyManager3.mPendingDeletionsForTag.remove(Integer.valueOf(i6));
                }
                return;
            } catch (Throwable th3) {
                th = th3;
