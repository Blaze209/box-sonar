...
@Metadata(d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0007\n\u0002\b\u0006\b\u0000\u0018\u0000 \"2\u00020\u0001:\u0001\"B\u001d\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¢\u0006\u0004\b\u0007\u0010\bJ\u0006\u0010\u0012\u001a\u00020\u0006J\u0006\u0010\u0013\u001a\u00020\u0006J\u000e\u0010\u0014\u001a\u00020\u00062\u0006\u0010\u0015\u001a\u00020\u0016J\u000e\u0010\u0017\u001a\u00020\u00062\u0006\u0010\u0018\u001a\u00020\u0019J\b\u0010\u001a\u001a\u00020\nH\u0002J\u0018\u0010\u001b\u001a\u00020\n2\u0006\u0010\u001c\u001a\u00020\u001d2\u0006\u0010\u001e\u001a\u00020\u001dH\u0002J\b\u0010\u001f\u001a\u00020\u0010H\u0002J\u0010\u0010 \u001a\u00020\u001d2\u0006\u0010!\u001a\u00020\u001dH\u0002R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\fX\u0082.¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\fX\u0082.¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\fX\u0082.¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0010X\u0082.¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\fX\u0082.¢\u0006\u0002\n\u0000¨\u0006#"}, d2 = {"Lcom/facebook/react/devsupport/perfmonitor/PerfMonitorOverlayView;", "", "context", "Landroid/content/Context;", "onButtonPress", "Lkotlin/Function0;", "", "<init>", "(Landroid/content/Context;Lkotlin/jvm/functions/Function0;)V", DialogNavigator.NAME, "Landroid/app/Dialog;", "statusIndicator", "Landroid/widget/TextView;", "statusLabel", "tooltipLabel", "issuesContainer", "Landroid/widget/LinearLayout;", "issueCountLabel", "show", "hide", "updateRecordingState", "state", "Lcom/facebook/react/devsupport/interfaces/TracingState;", "updatePerfIssueCount", "count", "", "createToolbarDialog", "createAnchoredDialog", "offsetX", "", "offsetY", "createInnerLayout", "dpToPx", "dp", "Companion", "ReactAndroid_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class PerfMonitorOverlayView {
    ...
    private final Dialog createToolbarDialog() {
        ...
        mAMTextView.setWidth((int) dpToPx(12.0f));
        mAMTextView.setHeight((int) dpToPx(12.0f));
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setShape(1);
        gradientDrawable.setColor(SupportMenu.CATEGORY_MASK);
        mAMTextView.setBackground(gradientDrawable);
        this.statusIndicator = mAMTextView;
        ...
        mAMTextView2.setTextSize(f);
        mAMTextView2.setTextColor(-1);
        Typeface typeface = TYPEFACE_BOLD;
        mAMTextView2.setTypeface(typeface);
        this.statusLabel = mAMTextView2;
        MAMTextView mAMTextView3 = new MAMTextView(this.context);
        mAMTextView3.setTextSize(TEXT_SIZE_ACCESSORY);
        mAMTextView3.setTextColor(-1);
        mAMTextView3.setTypeface(typeface);
        this.tooltipLabel = mAMTextView3;
        ...
        TextView textView2 = this.tooltipLabel;
        if (textView2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("tooltipLabel");
            textView2 = null;
        }
        ...
        MAMTextView mAMTextView4 = new MAMTextView(this.context);
        mAMTextView4.setTextSize(f);
        mAMTextView4.setTextColor(-1);
        mAMTextView4.setTypeface(typeface);
        Drawable drawable = mAMTextView4.getContext().getDrawable(R.drawable.ic_dialog_alert);
        if (drawable != null) {
            drawable.setBounds(0, 1, (int) dpToPx(f), ((int) dpToPx(f)) + 1);
        } else {
            drawable = null;
        }
        mAMTextView4.setCompoundDrawables(drawable, null, null, null);
        mAMTextView4.setCompoundDrawablePadding((int) dpToPx(6.0f));
        this.issueCountLabel = mAMTextView4;
        LinearLayout linearLayout3 = this.issuesContainer;
        if (linearLayout3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("issuesContainer");
            linearLayout3 = null;
        }
        TextView textView3 = this.issueCountLabel;
        if (textView3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("issueCountLabel");
            textView3 = null;
        }
        ...
        linearLayoutCreateInnerLayout.addView(textView4);
