    ...
    public final void showInternal(String message, Double color, Double backgroundColor) {
        ...
        if (popupWindow == null || !popupWindow.isShowing()) {
            ...
            try {
                ...
                MAMPopupWindow mAMPopupWindow = new MAMPopupWindow(textView, -1, -2);
                mAMPopupWindow.showAtLocation(currentActivity.getWindow().getDecorView(), 0, 0, i);
                this.devLoadingView = textView;
                this.devLoadingPopup = mAMPopupWindow;
