...
public final class ChangeBundleLocationDialog {
    ...
    public final void show(Context context, DeveloperSettings devSettings, final ChangeBundleLocationDialogListener onClickListener) {
        ...
        mAMTextView.setText(context.getString(R.string.catalyst_change_bundle_location_input_label));
        ...
        mAMEditText.setHint(context.getString(R.string.catalyst_change_bundle_location_input_hint));
        mAMEditText.setBackgroundResource(android.R.drawable.edit_text);
        mAMEditText.setHintTextColor(-3355444);
        mAMEditText.setTextColor(-16777216);
        mAMEditText.setText(debugServerHost);
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.react.devsupport.ChangeBundleLocationDialog$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                ChangeBundleLocationDialog.show$lambda$0(mAMEditText, debugServerHost2, view);
            }
        });
        ...
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.react.devsupport.ChangeBundleLocationDialog$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChangeBundleLocationDialog.show$lambda$1(mAMEditText, devServerNetworkIpAndPort$ReactAndroid_release, view);
            }
        });
        ...
        mAMTextView2.setText(context.getString(R.string.catalyst_change_bundle_location_instructions, AndroidInfoHelpers.getAdbReverseTcpCommand(context)));
        ...
        final AlertDialog alertDialogCreate = new MAMAlertDialogBuilder(context).setTitle(context.getString(R.string.catalyst_change_bundle_location)).setView(linearLayout).create();
        button3.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.react.devsupport.ChangeBundleLocationDialog$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChangeBundleLocationDialog.show$lambda$2(onClickListener, mAMEditText, alertDialogCreate, view);
            }
        });
