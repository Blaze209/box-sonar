    ...
    private String buildString() {
        ...
        if (str2 != null) {
            ...
            if (this.encodedAuthority != null) {
                ...
                if (str3 != null) {
                    sb.append(str3).append(CommentEntityDomainMapper.MENTIONS_SYMBOL);
                } else {
                    String str4 = this.userInfo;
                    if (str4 != null) {
                        sb.append(encodeUserInfo(str4)).append(CommentEntityDomainMapper.MENTIONS_SYMBOL);
                    }
                }
            ...
            if (this.encodedQuery != null) {
                ...
                sb.append(MsalUtils.QUERY_STRING_SYMBOL).append(encodeUrlForm(this.queryParams));
            } else if (this.query != null) {
                sb.append(MsalUtils.QUERY_STRING_SYMBOL).append(encodeUric(this.query));
            }
        }
