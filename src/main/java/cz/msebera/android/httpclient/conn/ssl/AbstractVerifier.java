...
public abstract class AbstractVerifier implements X509HostnameVerifier {
    ...
    static {
        String[] strArr = {"ac", Constants.COLLATION_EXTENSION_KEY_SHORT, "com", "ed", "edu", ResourceAttributes.TelemetrySdkLanguageValues.GO, "gouv", "gov", BoxRepresentation.FIELD_INFO, "lg", "ne", "net", "or", "org"};
