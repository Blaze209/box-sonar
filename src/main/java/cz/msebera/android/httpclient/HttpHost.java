...
public final class HttpHost implements Cloneable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HttpHost) {
            ...
            if (this.lcHostname.equals(httpHost.lcHostname) && this.port == httpHost.port && this.schemeName.equals(httpHost.schemeName) && ((inetAddress = this.address) != null ? inetAddress.equals(httpHost.address) : httpHost.address == null)) {
                return true;
            }
        }
        return false;
