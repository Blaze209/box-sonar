    ...
    protected final CloseableHttpResponse doExecute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) throws IOException {
        ...
        try {
            if (connectionBackoffStrategy != null && backoffManager != null) {
                HttpRoute httpRouteDetermineRoute = routePlanner.determineRoute(httpHost != null ? httpHost : (HttpHost) determineParams(httpRequest).getParameter("http.default-host"), httpRequest, defaultedHttpContext);
                try {
