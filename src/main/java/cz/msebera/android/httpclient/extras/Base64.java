    ...
    static class Encoder extends Coder {
        ...
        public boolean process(byte[] bArr, int i, int i2, boolean z) {
            ...
            while (true) {
                ...
                c = c;
                int i12 = ((bArr[i3 + 1] & 255) << 8) | ((bArr[i3] & 255) << 16) | (bArr[i3 + 2] & 255);
                bArr3[i5] = bArr2[(i12 >> 18) & 63];
                bArr3[i5 + 1] = bArr2[(i12 >> 12) & 63];
                bArr3[i5 + 2] = bArr2[(i12 >> 6) & 63];
                bArr3[i5 + 3] = bArr2[i12 & 63];
                int i13 = i5 + 4;
                i8--;
                if (i8 == 0) {
                    if (this.do_cr) {
            ...
            if (z) {
                ...
                if (i3 - i14 == i9 - 1) {
                    ...
                    int i15 = (b3 & 255) << 4;
                    this.tailLen = i14 - i11;
                    bArr3[i5] = bArr2[(i15 >> 6) & 63];
                    int i16 = i5 + 2;
                    ...
                    this.tailLen = i14 - i11;
                    bArr3[i5] = bArr2[(i18 >> 12) & 63];
                    bArr3[i5 + 1] = bArr2[(i18 >> 6) & 63];
                    int i19 = i5 + 3;
                    bArr3[i5 + 2] = bArr2[i18 & 63];
                    if (this.do_padding) {
                        bArr3[i19] = 61;
                        i19 = i5 + 4;
                    }
