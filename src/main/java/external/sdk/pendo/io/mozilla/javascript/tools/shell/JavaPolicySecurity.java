...
public class JavaPolicySecurity extends SecurityProxy {
    ...
    private static class ContextPermissions extends PermissionCollection {
        ...
        public String toString() {
            return getClass().getName() + CommentBarInputBoxKt.MENTION_SYMBOL + Integer.toHexString(System.identityHashCode(this)) + " (context=" + this._context + ", static_permitions=" + this._statisPermissions + ')';
        }
    }
