...
public final class EdgeToEdgePackageKt {
    ...
    private static final /* synthetic */ <T> T invokeWindowUtilKtMethod(String str, Pair<? extends Class<?>, ? extends Object>... pairArr) {
        ...
        try {
            ...
            objM14780constructorimpl = Result.m14780constructorimpl(objInvoke);
        } catch (Throwable th) {
        ...
        if (thM14783exceptionOrNullimpl != null) {
            Log.e("EdgeToEdgePackage", "Failed to invoke '" + str + "' on com.facebook.react.views.view.WindowUtilKt", thM14783exceptionOrNullimpl);
        }
        if (Result.m14786isFailureimpl(objM14780constructorimpl)) {
            return null;
        }
        return (T) objM14780constructorimpl;
    }
}
