        ...
        return CollectionsKt.listOf(new ReactActivityLifecycleListener() { // from class: expo.modules.kotlin.edgeToEdge.EdgeToEdgePackage.createReactActivityLifecycleListeners.1
            ...
            public void onCreate(Activity activity, Bundle savedInstanceState) {
                ...
                try {
                    ...
                    objM14780constructorimpl = Result.m14780constructorimpl((Boolean) objInvoke);
                } catch (Throwable th) {
                ...
                if (thM14783exceptionOrNullimpl != null) {
                    Log.e("EdgeToEdgePackage", "Failed to invoke 'isEdgeToEdgeFeatureFlagOn' on com.facebook.react.views.view.WindowUtilKt", thM14783exceptionOrNullimpl);
                }
                if (Result.m14786isFailureimpl(objM14780constructorimpl)) {
                    objM14780constructorimpl = null;
                }
                Boolean bool = (Boolean) objM14780constructorimpl;
                if (bool != null ? bool.booleanValue() : true) {
                    ...
                    try {
                        ...
                        objM14780constructorimpl2 = Result.m14780constructorimpl((Unit) obj);
                    } catch (Throwable th2) {
                        Result.Companion companion4 = Result.INSTANCE;
                        objM14780constructorimpl2 = Result.m14780constructorimpl(ResultKt.createFailure(th2));
                    }
                    Throwable thM14783exceptionOrNullimpl2 = Result.m14783exceptionOrNullimpl(objM14780constructorimpl2);
                    if (thM14783exceptionOrNullimpl2 != null) {
                        Log.e("EdgeToEdgePackage", "Failed to invoke 'enableEdgeToEdge' on com.facebook.react.views.view.WindowUtilKt", thM14783exceptionOrNullimpl2);
                    }
                    Result.m14786isFailureimpl(objM14780constructorimpl2);
                    if (activity != null) {
