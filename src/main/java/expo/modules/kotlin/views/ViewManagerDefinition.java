...
public final class ViewManagerDefinition {
    ...
    public /* synthetic */ ViewManagerDefinition(Function2 function2, Class cls, Map map, String str, Function1 function1, CallbacksDefinition callbacksDefinition, ViewGroupDefinition viewGroupDefinition, Function1 function3, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(function2, cls, (i & 4) != 0 ? MapsKt.emptyMap() : map, (i & 8) != 0 ? cls.getName() : str, (i & 16) != 0 ? null : function1, (i & 32) != 0 ? null : callbacksDefinition, (i & 64) != 0 ? null : viewGroupDefinition, (i & 128) != 0 ? null : function3, (i & 256) != 0 ? CollectionsKt.emptyList() : list);
    }
