...
public class ObjectDefinitionBuilder {
    ...
    public final /* synthetic */ <T> PropertyComponentBuilder Property(String name, Function0<? extends T> body) {
        ...
        propertyComponentBuilder.setGetter(new SyncFunctionComponent(PasskeyWebListener.GET_UNIQUE_KEY, anyTypeArr, returnType, new PropertyComponentBuilder$get$1$1(body)));
