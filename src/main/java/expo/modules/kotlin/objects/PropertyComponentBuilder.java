...
public class PropertyComponentBuilder {
    ...
    public final /* synthetic */ <R> PropertyComponentBuilder get(Function0<? extends R> body) {
        ...
        setGetter(new SyncFunctionComponent(PasskeyWebListener.GET_UNIQUE_KEY, anyTypeArr, returnType, new PropertyComponentBuilder$get$1$1(body)));
        return this;
    }
