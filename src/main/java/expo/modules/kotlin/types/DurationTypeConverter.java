...
public final class DurationTypeConverter extends DynamicAwareTypeConverters<Duration> {
    ...
    public /* bridge */ /* synthetic */ Duration convertFromAny(Object obj, AppContext appContext, boolean z) {
        return Duration.m16154boximpl(m14594convertFromAnyZBGTal8(obj, appContext, z));
    }

    @Override // expo.modules.kotlin.types.DynamicAwareTypeConverters
    public /* bridge */ /* synthetic */ Duration convertFromDynamic(Dynamic dynamic, AppContext appContext, boolean z) {
        return Duration.m16154boximpl(m14595convertFromDynamicZBGTal8(dynamic, appContext, z));
    }

    /* JADX INFO: renamed from: convertFromDynamic-ZBGTal8, reason: not valid java name */
    public long m14595convertFromDynamicZBGTal8(Dynamic value, AppContext context, boolean forceConversion) {
    ...
    public long m14594convertFromAnyZBGTal8(Object value, AppContext context, boolean forceConversion) {
        Intrinsics.checkNotNullParameter(value, "value");
