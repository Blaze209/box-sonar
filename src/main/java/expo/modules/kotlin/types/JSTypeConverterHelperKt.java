...
public final class JSTypeConverterHelperKt {
    public static final Map<String, Object> toJSValueExperimental(Record record) {
        ...
        for (KProperty1 kProperty1 : memberProperties) {
            ...
            if (field != null) {
                ...
                linkedHashMap.put(name, JSTypeConverterProvider.convertToJSValue$default(JSTypeConverterProvider.INSTANCE, kProperty1.get(record), null, true, 2, null));
            }
    ...
    public static final Map<String, Object> toJSValueExperimental(FormattedRecord<?> formattedRecord) {
        ...
        for (KProperty1<Record, ?> kProperty1 : memberProperties) {
            ...
            if (field != null) {
                ...
                Object value = kProperty1.get(formattedRecord.getRecord$expo_modules_core_release());
    ...
    public static final WritableMap toJSValue(Record record, JSTypeConverterProvider.ContainerProvider containerProvider) {
        ...
        for (KProperty1 kProperty1 : memberProperties) {
            ...
            if (field != null) {
                ...
                KCallablesJvm.setAccessible(kProperty1, true);
                putGeneric(writableMapCreateMap, name, JSTypeConverterProvider.INSTANCE.legacyConvertToJSValue(kProperty1.get(record), containerProvider));
            }
            arrayList.add(Unit.INSTANCE);
        }
    ...
    public static final <T> WritableArray toJSValue(T[] tArr, JSTypeConverterProvider.ContainerProvider containerProvider) {
        ...
        WritableArray writableArrayCreateArray = containerProvider.createArray();
        for (T t : tArr) {
            putGeneric(writableArrayCreateArray, JSTypeConverterProvider.INSTANCE.legacyConvertToJSValue(t, containerProvider));
        }
        return writableArrayCreateArray;
    }
    ...
    public static final WritableArray toJSValue(Pair<?, ?> pair, JSTypeConverterProvider.ContainerProvider containerProvider) {
        ...
        Intrinsics.checkNotNullParameter(containerProvider, "containerProvider");
        WritableArray writableArrayCreateArray = containerProvider.createArray();
        Object objLegacyConvertToJSValue = JSTypeConverterProvider.INSTANCE.legacyConvertToJSValue(pair.getFirst(), containerProvider);
        Object objLegacyConvertToJSValue2 = JSTypeConverterProvider.INSTANCE.legacyConvertToJSValue(pair.getSecond(), containerProvider);
