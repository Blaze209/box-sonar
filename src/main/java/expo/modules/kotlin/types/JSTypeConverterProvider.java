...
public final class JSTypeConverterProvider {
    ...
    public final Object legacyConvertToJSValue(Object value, ContainerProvider containerProvider) {
        ...
        if (value instanceof FormattedRecord) {
            return new IllegalStateException("FormattedRecord should be converted using the experimental converter.");
        }
        ...
        if (value instanceof Duration) {
            return Double.valueOf(Duration.m16192toDoubleimpl(((Duration) value).getRawValue(), DurationUnit.SECONDS));
        }
