...
public final class JavaFile extends File implements UnifiedFileInterface {
    ...
    public Long getCreationTime() throws IOException {
        ...
        return Long.valueOf(Duration.m16167getInWholeMillisecondsimpl(DurationKt.toDuration(attributes.creationTime().toMillis(), DurationUnit.MILLISECONDS)));
    }
