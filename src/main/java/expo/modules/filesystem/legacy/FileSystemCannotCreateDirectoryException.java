...
public final class FileSystemCannotCreateDirectoryException extends CodedException {
    public FileSystemCannotCreateDirectoryException(Uri uri) {
        String string;
        super((uri == null || (string = new StringBuilder("Directory '").append(uri).append("' could not be created or already exists").toString()) == null) ? MicrosoftAuthorizationErrorResponse.UNKNOWN_ERROR : string, null, 2, null);
    }
}
