...
public final class PersistentOrderedMapKeysIterator<K, V> implements Iterator<K>, KMappedMarker {
    ...
    public PersistentOrderedMapKeysIterator(PersistentOrderedMap<K, V> map) {
        ...
        this.internal = new PersistentOrderedMapLinksIterator<>(map.getFirstKey(), map.getHashMap$kotlinx_collections_immutable());
    }
