...
public final class PersistentOrderedMapBuilderEntriesIterator<K, V> implements Iterator<Map.Entry<K, V>>, KMutableIterator {
    ...
    public Map.Entry<K, V> next() {
        return new MutableMapEntry(this.internal.getBuilder$kotlinx_collections_immutable().getHashMapBuilder$kotlinx_collections_immutable(), this.internal.getLastIteratedKey(), this.internal.next());
    }
