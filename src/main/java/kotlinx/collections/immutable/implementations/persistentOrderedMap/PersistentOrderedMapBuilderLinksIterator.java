...
public class PersistentOrderedMapBuilderLinksIterator<K, V> implements Iterator<LinkedValue<V>>, KMutableIterator {
    ...
    /* JADX INFO: renamed from: getLastIteratedKey$kotlinx_collections_immutable, reason: from getter */
