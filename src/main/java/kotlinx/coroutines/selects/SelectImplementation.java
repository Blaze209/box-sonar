...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    static final class C20251 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SelectImplementation<R> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C20251(SelectImplementation<R> selectImplementation, Continuation<? super C20251> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        C20251 c20251;
        if (continuation instanceof C20251) {
            c20251 = (C20251) continuation;
            if ((c20251.label & Integer.MIN_VALUE) != 0) {
                c20251.label -= Integer.MIN_VALUE;
            } else {
                c20251 = new C20251(this, continuation);
            }
        } else {
            c20251 = new C20251(this, continuation);
        }
        Object obj2 = c20251.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c20251.label;
        try {
            if (i != 0) {
            ...
            c20251.label = 1;
            Object objInvokeBlock = clauseData.invokeBlock(objProcessResult, c20251);
            return objInvokeBlock == coroutine_suspended ? coroutine_suspended : objInvokeBlock;
        } catch (Throwable th) {
            if (DebugKt.getRECOVER_STACK_TRACES() && (c20251 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c20251);
            }
            throw th;
        }
    }
