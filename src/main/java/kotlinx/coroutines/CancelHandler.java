...
public interface CancelHandler extends NotCompleted {
    ...
    public static final class UserSupplied implements CancelHandler {
        ...
        public String toString() {
            return "CancelHandler.UserSupplied[" + DebugStringsKt.getClassSimpleName(this.handler) + CommentBarInputBoxKt.MENTION_SYMBOL + DebugStringsKt.getHexAddress(this) + AbstractJsonLexerKt.END_LIST;
        }
    }
}
