...
public abstract class CoroutineDispatcher extends AbstractCoroutineContextElement implements ContinuationInterceptor {
    ...
    public abstract void mo16386dispatch(CoroutineContext context, Runnable block);
    ...
    public String toString() {
        return DebugStringsKt.getClassSimpleName(this) + CommentBarInputBoxKt.MENTION_SYMBOL + DebugStringsKt.getHexAddress(this);
    }
}
