...
public class JobSupport implements Job, ChildJob, ParentJob {
    ...
    public String toString() {
        return toDebugString() + CommentBarInputBoxKt.MENTION_SYMBOL + DebugStringsKt.getHexAddress(this);
    }
