...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM14780constructorimpl = Result.m14780constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        try {
            ...
            objM14780constructorimpl2 = Result.m14780constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM14780constructorimpl2 = Result.m14780constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m14783exceptionOrNullimpl(objM14780constructorimpl2) == null) {
            obj = objM14780constructorimpl2;
        }
