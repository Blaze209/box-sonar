...
public final class FastServiceLoaderKt {
    ...
    static {
        ...
        try {
            ...
            objM14780constructorimpl = Result.m14780constructorimpl(Class.forName("android.os.Build"));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM14780constructorimpl = Result.m14780constructorimpl(ResultKt.createFailure(th));
        }
        ANDROID_DETECTED = Result.m14787isSuccessimpl(objM14780constructorimpl);
    }
