    ...
    public final int addLast(E element) {
        ...
        while (true) {
            ...
            if (!this.singleConsumer && this.getArray().get(i2 & i3) != null) {
                ...
                long jUpdateTail = companion.updateTail(j, i5);
                LockFreeTaskQueueCore<E> lockFreeTaskQueueCore = this;
