...
public interface ReceiveChannel<E> {
    ...
    Object mo11204receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo11205tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo11205tryReceivePtdJZtk = receiveChannel.mo11205tryReceivePtdJZtk();
            if (ChannelResult.m16344isSuccessimpl(objMo11205tryReceivePtdJZtk)) {
                return (E) ChannelResult.m16340getOrThrowimpl(objMo11205tryReceivePtdJZtk);
            }
            Throwable thM16338exceptionOrNullimpl = ChannelResult.m16338exceptionOrNullimpl(objMo11205tryReceivePtdJZtk);
            if (thM16338exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM16338exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            Object objMo11204receiveCatchingJP2dKIU;
            ...
            if (i == 0) {
                ...
                objMo11204receiveCatchingJP2dKIU = receiveChannel.mo11204receiveCatchingJP2dKIU(anonymousClass1);
                if (objMo11204receiveCatchingJP2dKIU == coroutine_suspended) {
                ...
                ResultKt.throwOnFailure(obj);
                objMo11204receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
            }
            return ChannelResult.m16339getOrNullimpl(objMo11204receiveCatchingJP2dKIU);
        }
