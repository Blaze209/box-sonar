...
public interface SendChannel<E> {
    ...
    void mo16402invokeOnClose(Function1<? super Throwable, Unit> handler);
    ...
    Object mo11206trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object objMo11206trySendJP2dKIU = sendChannel.mo11206trySendJP2dKIU(e);
            if (ChannelResult.m16344isSuccessimpl(objMo11206trySendJP2dKIU)) {
                return true;
            }
            Throwable thM16338exceptionOrNullimpl = ChannelResult.m16338exceptionOrNullimpl(objMo11206trySendJP2dKIU);
