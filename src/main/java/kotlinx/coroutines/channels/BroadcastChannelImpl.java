...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.mo11206trySendJP2dKIU(getValue());
                }
    ...
    /* JADX WARN: Code duplicated, block: B:27:0x0080 A[RETURN] */
    ...
    public Object mo11206trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                Object objMo11206trySendJP2dKIU = super.mo11206trySendJP2dKIU(element);
                reentrantLock.unlock();
                return objMo11206trySendJP2dKIU;
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            if (!(list instanceof Collection) || !list.isEmpty()) {
                ...
                while (it.hasNext()) {
                    if (((BufferedChannel) it.next()).shouldSendSuspend$kotlinx_coroutines_core()) {
                        Object objM16348failurePtdJZtk = ChannelResult.INSTANCE.m16348failurePtdJZtk();
                        reentrantLock.unlock();
                        return objM16348failurePtdJZtk;
                    }
                }
            }
            if (this.capacity == -1) {
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo11206trySendJP2dKIU(element);
            }
            Object objM16349successJP2dKIU = ChannelResult.INSTANCE.m16349successJP2dKIU(Unit.INSTANCE);
            reentrantLock.unlock();
            return objM16349successJP2dKIU;
        } catch (Throwable th) {
            reentrantLock.unlock();
            throw th;
        }
    ...
    public String toString() {
        return (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT ? "CONFLATED_ELEMENT=" + this.lastConflatedElement + "; " : "") + "BROADCAST=<" + super.toString() + ">; SUBSCRIBERS=" + CollectionsKt.joinToString$default(this.subscribers, AuthenticationConstants.Broker.CHALLENGE_REQUEST_CERT_AUTH_DELIMETER, SimpleComparison.LESS_THAN_OPERATION, SimpleComparison.GREATER_THAN_OPERATION, 0, null, null, 56, null);
    }
}
