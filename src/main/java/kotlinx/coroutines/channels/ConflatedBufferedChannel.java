...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM16353trySendImplMj0NB7M = conflatedBufferedChannel.m16353trySendImplMj0NB7M(e, true);
        if (objM16353trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m16338exceptionOrNullimpl(objM16353trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM16353trySendImplMj0NB7M = conflatedBufferedChannel.m16353trySendImplMj0NB7M(e, true);
        if (!(objM16353trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo11206trySendJP2dKIU(E element) {
        return m16353trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m16353trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m16352trySendDropLatestMj0NB7M(element, isSendOp) : m16328trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m16352trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo11206trySendJP2dKIU = super.mo11206trySendJP2dKIU(element);
        if (ChannelResult.m16344isSuccessimpl(objMo11206trySendJP2dKIU) || ChannelResult.m16342isClosedimpl(objMo11206trySendJP2dKIU)) {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo11206trySendJP2dKIU = mo11206trySendJP2dKIU(element);
        if (!(objMo11206trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo11206trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m16338exceptionOrNullimpl(objMo11206trySendJP2dKIU);
