...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo11204receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m16326receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        cancellableContinuation.resumeWith(Result.m14780constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    public Object mo11206trySendJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment.id != j2) {
                ...
                if (channelSegmentFindSegmentSend == null) {
                    if (zIsClosedForSend0) {
                        return ChannelResult.INSTANCE.m16347closedJP2dKIU(this.getSendException());
                    }
                }
            } else {
            ...
            E e = element;
            int iUpdateCellSend = this.updateCellSend(channelSegmentFindSegmentSend, i, e, j, obj, zIsClosedForSend0);
            ...
            if (iUpdateCellSend == 2) {
                if (zIsClosedForSend0) {
                    channelSegment.onSlotCleaned();
                    return ChannelResult.INSTANCE.m16347closedJP2dKIU(bufferedChannel.getSendException());
                }
    ...
    protected final Object m16328trySendDropOldestJP2dKIU(E element) {
        ChannelSegment channelSegmentFindSegmentSend;
        ...
        while (true) {
            ...
            if (iUpdateCellSend == 2) {
                ...
                bufferedChannel.dropFirstElementUntilTheSpecifiedCellIsInTheBuffer((channelSegment.id * ((long) BufferedChannelKt.SEGMENT_SIZE)) + ((long) i));
                return ChannelResult.INSTANCE.m16349successJP2dKIU(Unit.INSTANCE);
            }
            if (iUpdateCellSend == 3) {
                throw new IllegalStateException("unexpected".toString());
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM16334boximpl = ChannelResult.m16334boximpl(ChannelResult.INSTANCE.m16349successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM16334boximpl, (Function3) (function1 != null ? bindCancellationFunResult(function1) : null));
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m14780constructorimpl(ResultKt.createFailure(getReceiveException())));
    }

    /* JADX WARN: Code duplicated, block: B:7:0x0014  */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: receiveCatching-JP2dKIU$suspendImpl, reason: not valid java name */
    static /* synthetic */ <E> Object m16326receiveCatchingJP2dKIU$suspendImpl(BufferedChannel<E> bufferedChannel, Continuation<? super ChannelResult<? extends E>> continuation) {
            ...
            if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                if (objUpdateCellReceive != BufferedChannelKt.FAILED) {
                    if (objUpdateCellReceive == BufferedChannelKt.SUSPEND_NO_WAITER) {
                        ...
                        Object objM16327receiveCatchingOnNoWaiterSuspendGKJJFZk = bufferedChannel2.m16327receiveCatchingOnNoWaiterSuspendGKJJFZk(channelSegment, i2, andIncrement, bufferedChannel$receiveCatching$2);
                        return objM16327receiveCatchingOnNoWaiterSuspendGKJJFZk == coroutine_suspended ? coroutine_suspended : objM16327receiveCatchingOnNoWaiterSuspendGKJJFZk;
                    }
                    channelSegment.cleanPrev();
                    return ChannelResult.INSTANCE.m16349successJP2dKIU(objUpdateCellReceive);
                }
                if (andIncrement < bufferedChannel2.getSendersCounter$kotlinx_coroutines_core()) {
                    channelSegment.cleanPrev();
                }
        ...
        return ChannelResult.INSTANCE.m16347closedJP2dKIU(bufferedChannel.getCloseCause());
    }
    ...
    public final Object m16327receiveCatchingOnNoWaiterSuspendGKJJFZk(ChannelSegment<E> channelSegment, int i, long j, Continuation<? super ChannelResult<? extends E>> continuation) {
        BufferedChannel$receiveCatchingOnNoWaiterSuspend$1 bufferedChannel$receiveCatchingOnNoWaiterSuspend$1;
        ChannelResult channelResultM16334boximpl;
        Function3 function3;
        ChannelSegment channelSegment2;
            ...
            try {
                ...
                if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                    if (objUpdateCellReceive == BufferedChannelKt.FAILED) {
                        ...
                        while (true) {
                            ...
                            if (objUpdateCellReceive2 != BufferedChannelKt.SUSPEND) {
                                if (objUpdateCellReceive2 == BufferedChannelKt.FAILED) {
                                    ...
                                    channelSegment2.cleanPrev();
                                    channelResultM16334boximpl = ChannelResult.m16334boximpl(ChannelResult.INSTANCE.m16349successJP2dKIU(objUpdateCellReceive2));
                                    Function1<E, Unit> function1 = this.onUndeliveredElement;
                        ...
                        channelSegment.cleanPrev();
                        channelResultM16334boximpl = ChannelResult.m16334boximpl(ChannelResult.INSTANCE.m16349successJP2dKIU(objUpdateCellReceive));
                        Function1<E, Unit> function2 = this.onUndeliveredElement;
                        function3 = (Function3) (function2 != null ? bindCancellationFunResult(function2) : null);
                    }
                    orCreateCancellableContinuation.resume(channelResultM16334boximpl, (Function3<? super Throwable, ? super ChannelResult, ? super CoroutineContext, Unit>) function3);
                    break;
                }
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m14780constructorimpl(ChannelResult.m16334boximpl(ChannelResult.INSTANCE.m16347closedJP2dKIU(getCloseCause()))));
    }
    ...
    public Object mo11205tryReceivePtdJZtk() {
        ...
        if (isClosedForReceive0(j2)) {
            return ChannelResult.INSTANCE.m16347closedJP2dKIU(getCloseCause());
        }
        if (j < (j2 & 1152921504606846975L)) {
            ...
            while (!this.isClosedForReceive()) {
                ...
                Object objUpdateCellReceive = this.updateCellReceive(channelSegmentFindSegmentReceive, i, andIncrement, obj);
            ...
            return ChannelResult.INSTANCE.m16347closedJP2dKIU(this.getCloseCause());
        }
        return ChannelResult.INSTANCE.m16348failurePtdJZtk();
    }
    ...
    protected final void dropFirstElementUntilTheSpecifiedCellIsInTheBuffer(long globalCellIndex) {
        ...
        while (true) {
            ...
            if (receivers$volatile$FU.compareAndSet(bufferedChannel, j, 1 + j)) {
                ...
                int i = (int) (j % ((long) BufferedChannelKt.SEGMENT_SIZE));
                if (channelSegment2.id != j2) {
                    ChannelSegment<E> channelSegmentFindSegmentReceive = this.findSegmentReceive(j2, channelSegment2);
                    if (channelSegmentFindSegmentReceive != null) {
                        channelSegment = channelSegmentFindSegmentReceive;
                    }
                } else {
                ...
                Object objUpdateCellReceive = this.updateCellReceive(channelSegment, i, j, null);
                if (objUpdateCellReceive != BufferedChannelKt.FAILED) {
                    channelSegment.cleanPrev();
                    Function1<E, Unit> function1 = this.onUndeliveredElement;
                ...
                } else if (j < this.getSendersCounter$kotlinx_coroutines_core()) {
                    channelSegment.cleanPrev();
                }
                channelSegment2 = channelSegment;
            }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m16334boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m16347closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m16349successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m14780constructorimpl(false));
                return;
            }
            ...
            cancellableContinuationImpl2.resumeWith(Result.m14780constructorimpl(ResultKt.createFailure(closeCause)));
        }
    ...
    private final void removeUnprocessedElements(ChannelSegment<E> lastSegment) {
        ...
        Object objM16377constructorimpl$default = InlineList.m16377constructorimpl$default(null, 1, null);
        loop0: do {
                    ...
                    if (state$kotlinx_coroutines_core != BufferedChannelKt.BUFFERED) {
                        if (state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER || state$kotlinx_coroutines_core == null) {
                            ...
                            if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                ...
                                objM16377constructorimpl$default = InlineList.m16382plusFjFbRPM(objM16377constructorimpl$default, waiter);
        ...
        if (objM16377constructorimpl$default != null) {
            if (!(objM16377constructorimpl$default instanceof ArrayList)) {
                resumeSenderOnCancelledChannel((Waiter) objM16377constructorimpl$default);
            } else {
                Intrinsics.checkNotNull(objM16377constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>");
                ArrayList arrayList = (ArrayList) objM16377constructorimpl$default;
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
            ...
            for (int i = BufferedChannelKt.SEGMENT_SIZE - 1; -1 < i; i--) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core == null || state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER) {
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM16377constructorimpl$default = InlineList.m16382plusFjFbRPM(objM16377constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM16377constructorimpl$default = InlineList.m16382plusFjFbRPM(objM16377constructorimpl$default, state$kotlinx_coroutines_core);
                            lastSegment.onCancelledRequest(i, true);
                            break;
                        }
                    }
        ...
        if (objM16377constructorimpl$default != null) {
            if (!(objM16377constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) objM16377constructorimpl$default);
                return;
            }
            Intrinsics.checkNotNull(objM16377constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>");
            ArrayList arrayList = (ArrayList) objM16377constructorimpl$default;
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            ...
            Result.Companion companion = Result.INSTANCE;
            cont.resumeWith(Result.m14780constructorimpl(false));
            return;
        }
        if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m14780constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
            ...
            cancellableContinuationImpl.resumeWith(Result.m14780constructorimpl(ChannelResult.m16334boximpl(ChannelResult.INSTANCE.m16347closedJP2dKIU(getCloseCause()))));
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m16394isClosedimpl(objFindSegmentInternal)) {
                Segment segmentM16392getSegmentimpl = SegmentOrClosed.m16392getSegmentimpl(objFindSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id >= segmentM16392getSegmentimpl.id) {
                        break loop0;
                    }
                    if (!segmentM16392getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    }
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, segment, segmentM16392getSegmentimpl)) {
                    ...
                    if (segmentM16392getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        segmentM16392getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m16392getSegmentimpl(objFindSegmentInternal);
    ...
    /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function3<Throwable, ChannelResult<? extends E>, CoroutineContext, Unit> {
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Throwable th, Object obj, CoroutineContext coroutineContext) {
            m16329invoke5_sEAP8(th, ((ChannelResult) obj).getHolder(), coroutineContext);
            return Unit.INSTANCE;
        }

        /* JADX INFO: renamed from: invoke-5_sEAP8, reason: not valid java name */
        public final void m16329invoke5_sEAP8(Throwable th, Object obj, CoroutineContext coroutineContext) {
            ((BufferedChannel) this.receiver).m16325onCancellationChannelResultImplDoNotCall5_sEAP8(th, obj, coroutineContext);
        }
    }
    ...
    public final void m16325onCancellationChannelResultImplDoNotCall5_sEAP8(Throwable cause, Object element, CoroutineContext context) {
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        Intrinsics.checkNotNull(function1);
        Object objM16339getOrNullimpl = ChannelResult.m16339getOrNullimpl(element);
        Intrinsics.checkNotNull(objM16339getOrNullimpl);
        OnUndeliveredElementKt.callUndeliveredElement(function1, objM16339getOrNullimpl, context);
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            cancellableContinuationImpl3.resumeWith(Result.m14780constructorimpl(ResultKt.createFailure(undeliveredElementExceptionRecoverFromStackFrame)));
        } else {
            ...
            cancellableContinuationImpl4.resumeWith(Result.m14780constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    /* JADX WARN: Code duplicated, block: B:67:0x0134 A[RETURN] */
    ...
    public final Object sendOnNoWaiterSuspend(ChannelSegment<E> channelSegment, int i, E e, long j, Continuation<? super Unit> continuation) {
        ...
        try {
            ...
            cancellableContinuationImpl.resumeWith(objM14780constructorimpl);
            result = orCreateCancellableContinuation.getResult();
            if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                DebugProbesKt.probeCoroutineSuspended(continuation);
            }
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuationImpl2.resumeWith(Result.m14780constructorimpl(Boxing.boxBoolean(false)));
                    break;
                }
            } else {
                channelSegment = channelSegment2;
            ...
            Result.Companion companion3 = Result.INSTANCE;
            cancellableContinuationImpl2.resumeWith(Result.m14780constructorimpl(Boxing.boxBoolean(true)));
            break;
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
