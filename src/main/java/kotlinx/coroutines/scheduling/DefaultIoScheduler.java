...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    public void execute(Runnable command) {
        mo16386dispatch(EmptyCoroutineContext.INSTANCE, command);
    }
    ...
    public void mo16386dispatch(CoroutineContext context, Runnable block) {
        default.mo16386dispatch(context, block);
    }
