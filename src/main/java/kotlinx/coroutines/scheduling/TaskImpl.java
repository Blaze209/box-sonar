...
final class TaskImpl extends Task {
    ...
    public String toString() {
        return "Task[" + DebugStringsKt.getClassSimpleName(this.block) + CommentBarInputBoxKt.MENTION_SYMBOL + DebugStringsKt.getHexAddress(this.block) + ", " + this.submissionTime + ", " + TasksKt.taskContextString(this.taskContext) + AbstractJsonLexerKt.END_LIST;
    }
}
