...
public abstract class ChannelFlowOperator<S, T> extends ChannelFlow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.internal.ChannelFlowOperator$collectWithContextUndispatched$2", f = "ChannelFlow.kt", i = {}, l = {Token.XMLATTR}, m = "invokeSuspend", n = {}, s = {})
