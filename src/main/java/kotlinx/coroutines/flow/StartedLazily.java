...
final class StartedLazily implements SharingStarted {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.StartedLazily$command$1", f = "SharingStarted.kt", i = {}, l = {Token.TO_DOUBLE}, m = "invokeSuspend", n = {}, s = {})
    static final class AnonymousClass1 extends SuspendLambda implements Function2<FlowCollector<? super SharingCommand>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (this.$subscriptionCount.collect(new C03321(booleanRef, flowCollector), this) == coroutine_suspended) {
        ...
        static final class C03321<T> implements FlowCollector {
            final /* synthetic */ FlowCollector<SharingCommand> $$this$flow;
            final /* synthetic */ Ref.BooleanRef $started;

            /* JADX WARN: Multi-variable type inference failed */
            C03321(Ref.BooleanRef booleanRef, FlowCollector<? super SharingCommand> flowCollector) {
