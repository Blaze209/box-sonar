...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m16361debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m16310toDelayMillisLRDsOJo(j));
    }
    ...
    public static final long debounce$lambda$2$FlowKt__DelayKt(Function1 function1, Object obj) {
        return DelayKt.m16310toDelayMillisLRDsOJo(((Duration) function1.invoke(obj)).getRawValue());
    }
    ...
    public static final <T> Flow<T> m16362sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m16310toDelayMillisLRDsOJo(j));
    }

    /* JADX INFO: renamed from: timeout-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m16363timeoutHG0u8IE(Flow<? extends T> flow, long j) {
        return m16364timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, j);
    }

    /* JADX INFO: renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt, reason: not valid java name */
    private static final <T> Flow<T> m16364timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long j) {
