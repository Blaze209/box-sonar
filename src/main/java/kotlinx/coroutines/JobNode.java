...
public abstract class JobNode extends LockFreeLinkedListNode implements DisposableHandle, Incomplete {
    ...
    public String toString() {
        return DebugStringsKt.getClassSimpleName(this) + CommentBarInputBoxKt.MENTION_SYMBOL + DebugStringsKt.getHexAddress(this) + "[job@" + DebugStringsKt.getHexAddress(getJob()) + AbstractJsonLexerKt.END_LIST;
    }
}
