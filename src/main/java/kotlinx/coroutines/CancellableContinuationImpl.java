            ...
            if (obj instanceof NotCompleted) {
                ...
                if (obj instanceof CancelledContinuation) {
                    ...
                    if (cancelledContinuation.makeResumed()) {
                        if (function4 != null) {
                            cancellableContinuationImpl2.callOnCancellation(function4, cancelledContinuation.cause, r2);
                            return;
                        }
                        return;
                    }
