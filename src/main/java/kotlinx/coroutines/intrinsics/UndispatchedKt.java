        ...
        try {
            ...
            try {
                ...
                if (objWrapWithContinuationImpl != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    continuationProbeCoroutineCreated.resumeWith(Result.m14780constructorimpl(objWrapWithContinuationImpl));
                }
            } catch (Throwable th) {
                ThreadContextKt.restoreThreadContext(coroutineContext, objUpdateThreadContext);
                throw th;
            ...
            continuationProbeCoroutineCreated.resumeWith(Result.m14780constructorimpl(ResultKt.createFailure(th)));
        }
    }
}
