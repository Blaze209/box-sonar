...
public final class PolymorphicModuleBuilder<Base> {
    ...
    public final void m16463default(Function1<? super String, ? extends DeserializationStrategy<? extends Base>> defaultSerializerProvider) {
