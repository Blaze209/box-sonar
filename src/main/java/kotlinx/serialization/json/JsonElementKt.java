...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m16458JsonPrimitive7apg3OU(byte b) {
        return m16459JsonPrimitiveVKZWuLQ(ULong.m14954constructorimpl(((long) b) & 255));
    }

    /* JADX INFO: renamed from: JsonPrimitive-xj2QHRw, reason: not valid java name */
    public static final JsonPrimitive m16461JsonPrimitivexj2QHRw(short s) {
        return m16459JsonPrimitiveVKZWuLQ(ULong.m14954constructorimpl(((long) s) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    /* JADX INFO: renamed from: JsonPrimitive-WZ4Q5Ns, reason: not valid java name */
    public static final JsonPrimitive m16460JsonPrimitiveWZ4Q5Ns(int i) {
        return m16459JsonPrimitiveVKZWuLQ(ULong.m14954constructorimpl(((long) i) & 4294967295L));
    }

    /* JADX INFO: renamed from: JsonPrimitive-VKZWuLQ, reason: not valid java name */
    public static final JsonPrimitive m16459JsonPrimitiveVKZWuLQ(long j) {
