...
public final class ULongSerializer implements KSerializer<ULong> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return ULong.m14948boximpl(m16447deserializeI7RO_PI(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m16448serialize2TYgG_w(encoder, ((ULong) obj).getData());
    }
    ...
    public void m16448serialize2TYgG_w(Encoder encoder, long value) {
    ...
    public long m16447deserializeI7RO_PI(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return ULong.m14954constructorimpl(decoder.decodeInline(getDescriptor()).decodeLong());
    }
}
