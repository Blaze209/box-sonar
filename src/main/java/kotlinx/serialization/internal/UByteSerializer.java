...
public final class UByteSerializer implements KSerializer<UByte> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UByte.m14792boximpl(m16431deserializeWa3L5BU(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m16432serializeEK6454(encoder, ((UByte) obj).getData());
    }
    ...
    public void m16432serializeEK6454(Encoder encoder, byte value) {
    ...
    public byte m16431deserializeWa3L5BU(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UByte.m14798constructorimpl(decoder.decodeInline(getDescriptor()).decodeByte());
    }
}
