...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m16421computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        Object objM14779boximpl = concurrentHashMap.get(arrayList2);
        if (objM14779boximpl == null) {
            try {
                Result.Companion companion = Result.INSTANCE;
                objM14780constructorimpl = Result.m14780constructorimpl(producer.invoke());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM14780constructorimpl = Result.m14780constructorimpl(ResultKt.createFailure(th));
            }
            objM14779boximpl = Result.m14779boximpl(objM14780constructorimpl);
            Object objPutIfAbsent = concurrentHashMap.putIfAbsent(arrayList2, objM14779boximpl);
            if (objPutIfAbsent != null) {
                objM14779boximpl = objPutIfAbsent;
            }
        }
        Intrinsics.checkNotNullExpressionValue(objM14779boximpl, "getOrPut(...)");
        return ((Result) objM14779boximpl).getValue();
    }
}
