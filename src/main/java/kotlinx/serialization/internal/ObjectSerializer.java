...
public final class ObjectSerializer<T> implements KSerializer<T> {
    ...
    public ObjectSerializer(final String serialName, T objectInstance) {
        ...
        this.descriptor = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0() { // from class: kotlinx.serialization.internal.ObjectSerializer$$ExternalSyntheticLambda1
            ...
            public final Object invoke() {
                return ObjectSerializer.descriptor_delegate$lambda$0(serialName, this);
            }
        });
    }
    ...
    public static final SerialDescriptor descriptor_delegate$lambda$0(String str, final ObjectSerializer objectSerializer) {
        return SerialDescriptorsKt.buildSerialDescriptor(str, StructureKind.OBJECT.INSTANCE, new SerialDescriptor[0], new Function1() { // from class: kotlinx.serialization.internal.ObjectSerializer$$ExternalSyntheticLambda0
