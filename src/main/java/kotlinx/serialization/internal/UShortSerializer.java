...
public final class UShortSerializer implements KSerializer<UShort> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UShort.m15055boximpl(m16455deserializeBwKQO78(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m16456serializei8woANY(encoder, ((UShort) obj).getData());
    }
    ...
    public void m16456serializei8woANY(Encoder encoder, short value) {
    ...
    public short m16455deserializeBwKQO78(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UShort.m15061constructorimpl(decoder.decodeInline(getDescriptor()).decodeShort());
    }
}
