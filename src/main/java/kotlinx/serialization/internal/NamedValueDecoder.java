...
public abstract class NamedValueDecoder extends TaggedDecoder<String> {
    ...
    protected final String renderTagStack() {
        return getTagStack$kotlinx_serialization_core().isEmpty() ? MetadataReservedKeys.PREFIX : CollectionsKt.joinToString$default(getTagStack$kotlinx_serialization_core(), ".", "$.", null, 0, null, null, 60, null);
    }
}
