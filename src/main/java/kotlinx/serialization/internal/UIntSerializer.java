...
public final class UIntSerializer implements KSerializer<UInt> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UInt.m14869boximpl(m16439deserializeOGnWXxg(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m16440serializeQn1smSk(encoder, ((UInt) obj).getData());
    }
    ...
    public void m16440serializeQn1smSk(Encoder encoder, int value) {
    ...
    public int m16439deserializeOGnWXxg(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UInt.m14875constructorimpl(decoder.decodeInline(getDescriptor()).decodeInt());
    }
}
