...
public enum b implements sdk.pendo.io.i0.a {
    icon_mic(45056),
    icon_mute(45057),
    ...
    @Override // sdk.pendo.io.i0.a
    public String b() {
        return name().replace(SessionDataKt.UNDERSCORE, Soundex.SILENT_MARKER);
    }

    public static synchronized b a(Character ch) {
        if (LOOKUP_TABLE.isEmpty()) {
            for (b bVar : EnumSet.allOf(b.class)) {
                LOOKUP_TABLE.put(Character.valueOf(bVar.mCharacter), bVar);
            }
        }
        return LOOKUP_TABLE.get(ch);
    }
}
