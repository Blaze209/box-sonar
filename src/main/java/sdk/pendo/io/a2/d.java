...
public class d {
    ...
    static {
        ...
        c = strArr2;
        d = a(strArr2);
        String[][] strArr3 = {new String[]{"\"", "&quot;"}, new String[]{MsalUtils.QUERY_STRING_DELIMITER, "&amp;"}, new String[]{SimpleComparison.LESS_THAN_OPERATION, "&lt;"}, new String[]{SimpleComparison.GREATER_THAN_OPERATION, "&gt;"}};
        e = strArr3;
        f = a(strArr3);
