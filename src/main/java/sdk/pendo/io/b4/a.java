...
public abstract class a<T, R> implements sdk.pendo.io.t3.a<T>, sdk.pendo.io.t3.d<R> {
    protected final sdk.pendo.io.t3.a<? super R> a;
    protected sdk.pendo.io.j3.c b;
    protected sdk.pendo.io.t3.d<T> c;
    protected boolean d;
    protected int e;

    public a(sdk.pendo.io.t3.a<? super R> aVar) {
        this.a = aVar;
    }
    ...
    public final void a(sdk.pendo.io.j3.c cVar) {
        if (sdk.pendo.io.c4.c.a(this.b, cVar)) {
            ...
            if (b()) {
                this.a.a((sdk.pendo.io.j3.c) this);
                a();
            }
        }
    }
