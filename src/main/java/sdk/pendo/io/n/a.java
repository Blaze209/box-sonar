...
public class a extends FilterInputStream {
    ...
    private int d;
    private int e;
    private final sdk.pendo.io.i.a f;

    /* JADX INFO: renamed from: sdk.pendo.io.n.a$a, reason: collision with other inner class name */
    static class C0423a extends IOException {
        C0423a(String str) {
            super(str);
        }
    }

    public a(InputStream inputStream, sdk.pendo.io.i.a aVar) {
        ...
        if (i != -1) {
            ...
            if (i2 < i3) {
                if (i == 0 && i3 > bArr.length && this.b == bArr.length) {
                    ...
                    byte[] bArr2 = (byte[]) this.f.get(i3, byte[].class);
    ...
    public synchronized void reset() {
        ...
        int i = this.d;
        if (-1 == i) {
            throw new C0423a("Mark has been invalidated, pos: " + this.e + " markLimit: " + this.c);
        }
        this.e = i;
    }
    ...
    a(InputStream inputStream, sdk.pendo.io.i.a aVar, int i) {
        super(inputStream);
        this.d = -1;
        this.f = aVar;
        this.a = (byte[]) aVar.get(i, byte[].class);
    }
