...
public final class V1Span {
    ...
    public int hashCode() {
        ...
        long j3 = this.id;
        int i3 = (iHashCode ^ ((int) (((long) iHashCode) ^ (j3 ^ (j3 >>> 32))))) * 1000003;
        long j4 = this.parentId;
        int i4 = (i3 ^ ((int) (((long) i3) ^ (j4 ^ (j4 >>> 32))))) * 1000003;
        long j5 = this.timestamp;
        int i5 = (i4 ^ ((int) (((long) i4) ^ (j5 ^ (j5 >>> 32))))) * 1000003;
        long j6 = this.duration;
        int iHashCode2 = (((((i5 ^ ((int) (((j6 >>> 32) ^ j6) ^ ((long) i5)))) * 1000003) ^ this.annotations.hashCode()) * 1000003) ^ this.binaryAnnotations.hashCode()) * 1000003;
