...
public abstract class Call<V> implements Cloneable {
    ...
    static class Constant<V> extends Base<V> {
        ...
        public boolean equals(Object obj) {
            ...
            V v = this.v;
            if (v == null) {
                return constant.v == null;
            }
            return v.equals(constant.v);
        }
    ...
    static final class ErrorHandling<V> extends Base<V> {
        ...
        <T extends Throwable> V handleError(T t) throws Throwable {
            Object obj = SENTINEL;
            final AtomicReference atomicReference = new AtomicReference(obj);
            this.errorHandler.onErrorReturn(t, new Callback<V>() { // from class: zipkin2.Call.ErrorHandling.1
                @Override // zipkin2.Callback
                public void onError(Throwable th) {
                }
