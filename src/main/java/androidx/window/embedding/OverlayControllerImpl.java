...
public class OverlayControllerImpl {
    ...
    public OverlayControllerImpl(ActivityEmbeddingComponent embeddingExtension, EmbeddingAdapter adapter) {
        ...
        embeddingExtension.registerActivityStackCallback(new CredentialManager$$ExternalSyntheticLambda0(), new OverlayControllerActivityStackConsumer(new Function1() { // from class: androidx.window.embedding.OverlayControllerImpl$$ExternalSyntheticLambda1
