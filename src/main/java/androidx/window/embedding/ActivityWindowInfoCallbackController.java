    ...
    public final void addCallback(Activity activity, Consumer<EmbeddedActivityWindowInfo> callback) {
        ...
        try {
            if (this.callbacks.isEmpty()) {
                this.embeddingExtension.setEmbeddedActivityWindowInfoCallback(new CredentialManager$$ExternalSyntheticLambda0(), this.extensionsCallback);
            }
