...
public final class SplitInfo {
    ...
    public SplitInfo(ActivityStack primaryActivityStack, ActivityStack secondaryActivityStack, SplitAttributes splitAttributes, androidx.window.extensions.embedding.SplitInfo.Token token) {
