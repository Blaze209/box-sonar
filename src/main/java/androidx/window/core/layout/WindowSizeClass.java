...
public final class WindowSizeClass {
    ...
    static {
        ...
        List<Integer> listPlus = CollectionsKt.plus((Collection) listListOf, (Iterable) CollectionsKt.listOf((Object[]) new Integer[]{Integer.valueOf(WIDTH_DP_LARGE_LOWER_BOUND), 1600}));
