...
public final class ReflectionUtils {
    ...
    public final boolean validateImplementation$window_release(final Class<?> implementation, Class<?> requirements) {
        ...
        for (final Method method : methods) {
            if (!validateReflection$window_release(implementation.getName() + ColorSerializer.PREFIX + method.getName() + " is not valid", new Function0() { // from class: androidx.window.reflection.ReflectionUtils$$ExternalSyntheticLambda0
