...
public class AppCompatEditText extends MAMEditText implements TintableBackgroundView, OnReceiveContentViewBehavior, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public InputConnection onMAMCreateInputConnection(EditorInfo editorInfo) {
        ...
        this.mTextHelper.populateSurroundingTextIfNeeded(this, inputConnectionOnMAMCreateInputConnection, editorInfo);
        InputConnection inputConnectionOnCreateInputConnection = AppCompatHintHelper.onCreateInputConnection(inputConnectionOnMAMCreateInputConnection, editorInfo, this);
