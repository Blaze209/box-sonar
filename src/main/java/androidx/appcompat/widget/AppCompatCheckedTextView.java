...
public class AppCompatCheckedTextView extends MAMCheckedTextView implements TintableCheckedTextView, TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public InputConnection onMAMCreateInputConnection(EditorInfo editorInfo) {
        return AppCompatHintHelper.onCreateInputConnection(super.onMAMCreateInputConnection(editorInfo), editorInfo, this);
    }
