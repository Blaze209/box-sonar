...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getDrawable(Uri uri) {
        try {
            ...
            InputStream inputStreamOpenInputStream = MAMContentResolverManagement.openInputStream(this.mProviderContext.getContentResolver(), uri);
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            Drawable drawable = MAMPackageManagement.getDrawable(packageManager, componentName.getPackageName(), iconResource, activityInfo.applicationInfo);
            if (drawable != null) {
                return drawable;
            }
    ...
    Drawable getDrawableFromResourceUri(Uri uri) throws FileNotFoundException {
        ...
        try {
            Resources resourcesForApplication = MAMPackageManagement.getResourcesForApplication(this.mProviderContext.getPackageManager(), authority);
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i) {
        ...
        if (i > 0) {
            builderFragment.appendQueryParameter(BoxIterator.FIELD_LIMIT, String.valueOf(i));
        }
        return MAMContentResolverManagement.query(this.mProviderContext.getContentResolver(), builderFragment.build(), null, suggestSelection, strArr2, null);
    }
}
