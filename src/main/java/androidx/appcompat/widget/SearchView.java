...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private boolean hasVoiceSearch() {
        ...
        if (searchableInfo != null && searchableInfo.getVoiceSearchEnabled()) {
            ...
            if (intent != null && MAMPackageManagement.resolveActivity(getContext().getPackageManager(), intent, 65536) != null) {
                return true;
            }
        }
        return false;
    ...
    private Intent createVoiceAppSearchIntent(Intent intent, SearchableInfo searchableInfo) {
        ...
        PendingIntent activity = MAMPendingIntent.getActivity(getContext(), 0, intent2, 1107296256);
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public InputConnection onMAMCreateInputConnection(EditorInfo editorInfo) {
            ...
            return inputConnectionOnMAMCreateInputConnection;
        }
