...
public abstract class AppCompatDelegate {
    ...
    static void syncLocalesToFramework(Context context) {
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (MAMPackageManagement.getComponentEnabledSetting(context.getPackageManager(), componentName) != 1) {
                ...
                MAMPackageManagement.setComponentEnabledSetting(context.getPackageManager(), componentName, 1, 1);
            }
        }
    }
