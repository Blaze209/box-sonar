...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(Context context) {
        ...
        if (context2 instanceof androidx.appcompat.view.ContextThemeWrapper) {
            try {
                ((androidx.appcompat.view.ContextThemeWrapper) context2).applyOverrideConfiguration(appCompatDelegateImpl.createOverrideAppConfiguration(context2, iMapNightMode, localeListCompatCalculateApplicationLocales, null, false));
                return context2;
        ...
        if (actionModeOnWindowStartingSupportActionMode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    MAMPopupWindow mAMPopupWindow = new MAMPopupWindow(contextThemeWrapper, (AttributeSet) null, androidx.appcompat.R.attr.actionModePopupWindowStyle);
                    this.mActionModePopup = mAMPopupWindow;
                    PopupWindowCompat.setWindowLayoutType(mAMPopupWindow, 2);
    ...
    private int getActivityHandlesConfigChangesFlags(Context context) {
        if (!this.mActivityHandlesConfigFlagsChecked && (this.mHost instanceof Activity)) {
            ...
            try {
                ActivityInfo activityInfo = MAMPackageManagement.getActivityInfo(packageManager, new ComponentName(context, this.mHost.getClass()), 269221888);
    ...
    abstract class AutoNightModeManager {
        ...
        void setup() {
            ...
            if (this.mReceiver == null) {
                this.mReceiver = new MAMBroadcastReceiver() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.AutoNightModeManager.1
