...
public class ListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        MAMTextView mAMTextView = new MAMTextView(contextRequireContext);
        mAMTextView.setId(INTERNAL_EMPTY_ID);
        mAMTextView.setGravity(17);
        frameLayout2.addView(mAMTextView, new FrameLayout.LayoutParams(-1, -1));
