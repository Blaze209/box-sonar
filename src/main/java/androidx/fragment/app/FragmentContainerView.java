    ...
    public FragmentContainerView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            ...
            if (classAttribute != null) {
                str = TextRecognitionConverter.Attributes.CLASS;
            } else {
