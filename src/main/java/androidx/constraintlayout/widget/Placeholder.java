...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            ...
            paint.setARGB(255, BoxCommonConstants.REQUEST_OPTIONS, BoxCommonConstants.REQUEST_OPTIONS, BoxCommonConstants.REQUEST_OPTIONS);
            ...
            paint.getTextBounds(MsalUtils.QUERY_STRING_SYMBOL, 0, MsalUtils.QUERY_STRING_SYMBOL.length(), rect);
            canvas.drawText(MsalUtils.QUERY_STRING_SYMBOL, ((iWidth / 2.0f) - (rect.width() / 2.0f)) - rect.left, ((iHeight / 2.0f) + (rect.height() / 2.0f)) - rect.bottom, paint);
        }
    }
