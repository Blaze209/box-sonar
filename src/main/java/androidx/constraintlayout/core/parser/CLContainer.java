...
public class CLContainer extends CLElement {
    ...
    public CLContainer mo10168clone() {
        CLContainer cLContainer = (CLContainer) super.mo10168clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement cLElementMo10168clone = it.next().mo10168clone();
            cLElementMo10168clone.setContainer(cLContainer);
            arrayList.add(cLElementMo10168clone);
        }
