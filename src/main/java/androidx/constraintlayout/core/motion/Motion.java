    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i2 < i) {
            ...
            if (easing != null) {
                ...
                float f7 = f6 - f4;
                d = (((float) easing.get((fMin - f4) / f7)) * f7) + f4;
            }
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        while (true) {
            ...
            for (int i8 = 0; i8 < i5; i8++) {
                if (motionPathsArr[i8].mCustomAttributes.containsKey(str8) && (customVariable = motionPathsArr[i8].mCustomAttributes.get(str8)) != null) {
        ...
        for (int i14 = 0; i14 < i5; i14++) {
            ...
            dArr2[i14] = motionPathsArr[i14].mTime;
        }
        int i15 = 0;
        while (true) {
            ...
            if (iArr3[i15] < MotionPaths.sNames.length) {
                String str9 = MotionPaths.sNames[this.mInterpolateVariables[i15]] + " [";
            ...
            for (int i19 = 0; i19 < i5; i19++) {
                if (motionPathsArr[i19].hasCustomData(str10)) {
                    if (dArr4 == null) {
                        dArr3 = new double[i5];
                        int[] iArr4 = new int[2];
                        iArr4[i3] = motionPathsArr[i19].getCustomDataCount(str10);
                        iArr4[0] = i5;
                        dArr4 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, iArr4);
                    }
                    dArr3[i18] = motionPathsArr[i19].mTime;
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            for (int i20 = 0; i20 < i5; i20++) {
                ...
                dArr5[i20] = motionPathsArr[i20].mTime;
                dArr6[i20][0] = motionPathsArr[i20].mX;
                dArr6[i20][i3] = motionPathsArr[i20].mY;
            }
            ...
            if (this.mTransformPivotTarget != -1) {
                ...
                if (motionWidget3 != null) {
                    ...
                    if (motionWidget2.getRight() - motionWidget2.getLeft() > 0 && motionWidget2.getBottom() - motionWidget2.getTop() > 0) {
                        float left2 = left - motionWidget2.getLeft();
                        float top2 = top - motionWidget2.getTop();
                        motionWidget2.setPivotX(left2);
