...
public final class Rotate90DegreesCcwKt {
    ...
    public static final ImageVector getRotate90DegreesCcw(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Rotate90DegreesCcw", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
