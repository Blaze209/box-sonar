...
public final class PersonAddAlt1Kt {
    ...
    public static final ImageVector getPersonAddAlt1(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PersonAddAlt1", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
