...
public final class SwitchAccessShortcutAddKt {
    ...
    public static final ImageVector getSwitchAccessShortcutAdd(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SwitchAccessShortcutAdd", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
