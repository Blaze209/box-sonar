...
public final class SignalWifiConnectedNoInternet4Kt {
    ...
    public static final ImageVector getSignalWifiConnectedNoInternet4(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SignalWifiConnectedNoInternet4", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
