...
public final class OnDeviceTrainingKt {
    ...
    public static final ImageVector getOnDeviceTraining(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.OnDeviceTraining", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
