...
public final class PersonRemoveAlt1Kt {
    ...
    public static final ImageVector getPersonRemoveAlt1(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PersonRemoveAlt1", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
