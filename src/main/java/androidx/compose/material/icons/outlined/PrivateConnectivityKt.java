...
public final class PrivateConnectivityKt {
    ...
    public static final ImageVector getPrivateConnectivity(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PrivateConnectivity", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
