...
public final class SignalCellularConnectedNoInternet0BarKt {
    ...
    public static final ImageVector getSignalCellularConnectedNoInternet0Bar(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SignalCellularConnectedNoInternet0Bar", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
