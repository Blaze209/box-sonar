...
public final class ScreenshotMonitorKt {
    ...
    public static final ImageVector getScreenshotMonitor(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ScreenshotMonitor", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
