...
public final class LocalConvenienceStoreKt {
    ...
    public static final ImageVector getLocalConvenienceStore(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.LocalConvenienceStore", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
