...
public final class CallMissedOutgoingKt {
    ...
    public static final ImageVector getCallMissedOutgoing(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.CallMissedOutgoing", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
