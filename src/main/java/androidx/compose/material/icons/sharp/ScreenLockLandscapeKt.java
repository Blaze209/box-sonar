...
public final class ScreenLockLandscapeKt {
    ...
    public static final ImageVector getScreenLockLandscape(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ScreenLockLandscape", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
