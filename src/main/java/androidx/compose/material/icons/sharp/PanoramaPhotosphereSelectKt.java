...
public final class PanoramaPhotosphereSelectKt {
    ...
    public static final ImageVector getPanoramaPhotosphereSelect(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.PanoramaPhotosphereSelect", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
