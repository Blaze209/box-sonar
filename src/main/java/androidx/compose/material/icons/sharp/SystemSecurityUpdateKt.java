...
public final class SystemSecurityUpdateKt {
    ...
    public static final ImageVector getSystemSecurityUpdate(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.SystemSecurityUpdate", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
