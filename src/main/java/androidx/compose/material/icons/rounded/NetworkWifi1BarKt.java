...
public final class NetworkWifi1BarKt {
    ...
    public static final ImageVector getNetworkWifi1Bar(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.NetworkWifi1Bar", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
