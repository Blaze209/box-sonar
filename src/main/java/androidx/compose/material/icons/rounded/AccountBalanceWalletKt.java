...
public final class AccountBalanceWalletKt {
    ...
    public static final ImageVector getAccountBalanceWallet(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AccountBalanceWallet", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
