...
public final class SignalCellularConnectedNoInternet4BarKt {
    ...
    public static final ImageVector getSignalCellularConnectedNoInternet4Bar(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SignalCellularConnectedNoInternet4Bar", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
