...
public final class SignalWifi0BarKt {
    ...
    public static final ImageVector getSignalWifi0Bar(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SignalWifi0Bar", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
