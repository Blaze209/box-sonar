...
public final class EmojiFoodBeverageKt {
    ...
    public static final ImageVector getEmojiFoodBeverage(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.EmojiFoodBeverage", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
