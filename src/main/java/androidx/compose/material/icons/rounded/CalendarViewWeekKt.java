...
public final class CalendarViewWeekKt {
    ...
    public static final ImageVector getCalendarViewWeek(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.CalendarViewWeek", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
