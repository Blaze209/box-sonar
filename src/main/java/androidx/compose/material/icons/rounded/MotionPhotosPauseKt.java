...
public final class MotionPhotosPauseKt {
    ...
    public static final ImageVector getMotionPhotosPause(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.MotionPhotosPause", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
