...
public final class SwitchAccessShortcutKt {
    ...
    public static final ImageVector getSwitchAccessShortcut(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SwitchAccessShortcut", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
