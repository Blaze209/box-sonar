...
public final class AutoAwesomeMosaicKt {
    ...
    public static final ImageVector getAutoAwesomeMosaic(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AutoAwesomeMosaic", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilder3.horizontalLineToRelative(-4.0f);
        pathBuilder3.close();
        ImageVector.Builder.m7552addPathoIyEayM$default(builder, pathBuilder3.getNodes(), defaultFillType3, "", solidColor3, 0.3f, null, 0.3f, 1.0f, iM7190getButtKaPHkGw3, iM7200getBevelLxFBmk10, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilder6.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m7552addPathoIyEayM$default(builder, pathBuilder6.getNodes(), defaultFillType6, "", solidColor6, 1.0f, null, 1.0f, 1.0f, iM7190getButtKaPHkGw6, iM7200getBevelLxFBmk13, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
