...
public final class AccountTreeKt {
    ...
    public static final ImageVector getAccountTree(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AccountTree", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilder4.lineToRelative(0.0f, -4.0f);
        pathBuilder4.lineToRelative(3.0f, 0.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m7552addPathoIyEayM$default(builder, pathBuilder4.getNodes(), defaultFillType4, "", solidColor4, 0.3f, null, 0.3f, 1.0f, iM7190getButtKaPHkGw4, iM7200getBevelLxFBmk11, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
