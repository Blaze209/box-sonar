...
public final class AirlineSeatLegroomReducedKt {
    ...
    public static final ImageVector getAirlineSeatLegroomReduced(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AirlineSeatLegroomReduced", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
