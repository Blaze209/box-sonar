...
public final class TheaterComedyKt {
    ...
    public static final ImageVector getTheaterComedy(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.TheaterComedy", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilder7.close();
        ImageVector.Builder.m7552addPathoIyEayM$default(builder, pathBuilder7.getNodes(), defaultFillType7, "", solidColor7, 0.3f, null, 0.3f, 1.0f, iM7190getButtKaPHkGw7, iM7200getBevelLxFBmk14, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
