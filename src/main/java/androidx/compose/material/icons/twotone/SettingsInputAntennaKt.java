...
public final class SettingsInputAntennaKt {
    ...
    public static final ImageVector getSettingsInputAntenna(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SettingsInputAntenna", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
