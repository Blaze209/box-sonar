...
public final class AddPhotoAlternateKt {
    ...
    public static final ImageVector getAddPhotoAlternate(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AddPhotoAlternate", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
