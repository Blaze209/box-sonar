...
public final class SwitchAccessShortcutAddKt {
    ...
    public static final ImageVector getSwitchAccessShortcutAdd(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SwitchAccessShortcutAdd", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
