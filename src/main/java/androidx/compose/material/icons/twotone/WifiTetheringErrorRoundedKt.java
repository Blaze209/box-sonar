...
public final class WifiTetheringErrorRoundedKt {
    ...
    public static final ImageVector getWifiTetheringErrorRounded(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.WifiTetheringErrorRounded", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
