...
public final class SettingsInputHdmiKt {
    ...
    public static final ImageVector getSettingsInputHdmi(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SettingsInputHdmi", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
