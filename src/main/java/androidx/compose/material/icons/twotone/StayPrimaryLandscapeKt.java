...
public final class StayPrimaryLandscapeKt {
    ...
    public static final ImageVector getStayPrimaryLandscape(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.StayPrimaryLandscape", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
