...
public final class InsertDriveFileKt {
    ...
    public static final ImageVector getInsertDriveFile(Icons.AutoMirrored.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Sharp.InsertDriveFile", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
