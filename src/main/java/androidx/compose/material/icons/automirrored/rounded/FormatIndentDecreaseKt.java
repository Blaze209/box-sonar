...
public final class FormatIndentDecreaseKt {
    ...
    public static final ImageVector getFormatIndentDecrease(Icons.AutoMirrored.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.FormatIndentDecrease", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
