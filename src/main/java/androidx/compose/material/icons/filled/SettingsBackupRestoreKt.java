...
public final class SettingsBackupRestoreKt {
    ...
    public static final ImageVector getSettingsBackupRestore(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SettingsBackupRestore", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
