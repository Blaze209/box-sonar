...
public final class UnfoldLessDoubleKt {
    ...
    public static final ImageVector getUnfoldLessDouble(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.UnfoldLessDouble", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
