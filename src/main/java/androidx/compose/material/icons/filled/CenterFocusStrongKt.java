...
public final class CenterFocusStrongKt {
    ...
    public static final ImageVector getCenterFocusStrong(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.CenterFocusStrong", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
