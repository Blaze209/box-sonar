...
public final class FormatAlignJustifyKt {
    ...
    public static final ImageVector getFormatAlignJustify(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.FormatAlignJustify", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
