...
public final class PhotoCameraFrontKt {
    ...
    public static final ImageVector getPhotoCameraFront(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.PhotoCameraFront", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
