...
public final class WifiTetheringErrorRoundedKt {
    ...
    public static final ImageVector getWifiTetheringErrorRounded(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.WifiTetheringErrorRounded", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
