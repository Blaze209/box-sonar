...
public final class FormatAlignCenterKt {
    ...
    public static final ImageVector getFormatAlignCenter(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.FormatAlignCenter", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
