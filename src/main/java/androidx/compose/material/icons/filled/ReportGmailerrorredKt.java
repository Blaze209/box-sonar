...
public final class ReportGmailerrorredKt {
    ...
    public static final ImageVector getReportGmailerrorred(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.ReportGmailerrorred", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
