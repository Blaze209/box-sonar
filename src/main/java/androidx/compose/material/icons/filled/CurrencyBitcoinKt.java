...
public final class CurrencyBitcoinKt {
    ...
    public static final ImageVector getCurrencyBitcoin(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.CurrencyBitcoin", Dp.m9687constructorimpl(24.0f), Dp.m9687constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
