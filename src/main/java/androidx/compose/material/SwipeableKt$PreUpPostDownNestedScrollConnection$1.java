...
public final class SwipeableKt$PreUpPostDownNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public Object mo1298onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        ...
        if (i == 0) {
            ...
            float f = toFloat(Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(Velocity.m9925getXimpl(j))) << 32) | (((long) Float.floatToRawIntBits(Velocity.m9926getYimpl(j))) & 4294967295L)));
    ...
    public Object mo945onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            SwipeableState<T> swipeableState = this.$this_PreUpPostDownNestedScrollConnection;
            float f = toFloat(Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(Velocity.m9925getXimpl(j2))) << 32) | (((long) Float.floatToRawIntBits(Velocity.m9926getYimpl(j2))) & 4294967295L)));
