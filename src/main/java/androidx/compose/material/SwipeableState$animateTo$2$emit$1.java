...
final class SwipeableState$animateTo$2$emit$1 extends ContinuationImpl {
    ...
    final /* synthetic */ SwipeableState.C07062<T> this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    SwipeableState$animateTo$2$emit$1(SwipeableState.C07062<? super T> c07062, Continuation<? super SwipeableState$animateTo$2$emit$1> continuation) {
        super(continuation);
        this.this$0 = c07062;
    }
