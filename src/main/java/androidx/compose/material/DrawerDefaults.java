...
public final class DrawerDefaults {
    ...
    private static final float Elevation = Dp.m9687constructorimpl(16);
    ...
    public final long getBackgroundColor(Composer composer, int i) {
        ...
        long jM2346getSurface0d7_KjU = MaterialTheme.INSTANCE.getColors(composer, 6).m2346getSurface0d7_KjU();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return jM2346getSurface0d7_KjU;
    }

    /* JADX INFO: renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m2386getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final long getScrimColor(Composer composer, int i) {
        ...
        long jM6813copywmQWz5c$default = Color.m6813copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m2341getOnSurface0d7_KjU(), 0.32f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
