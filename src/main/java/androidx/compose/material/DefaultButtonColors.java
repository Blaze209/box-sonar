...
final class DefaultButtonColors implements ButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.backgroundColor, defaultButtonColors.backgroundColor) && Color.m6815equalsimpl0(this.contentColor, defaultButtonColors.contentColor) && Color.m6815equalsimpl0(this.disabledBackgroundColor, defaultButtonColors.disabledBackgroundColor) && Color.m6815equalsimpl0(this.disabledContentColor, defaultButtonColors.disabledContentColor);
    }

    public int hashCode() {
        return (((((Color.m6821hashCodeimpl(this.backgroundColor) * 31) + Color.m6821hashCodeimpl(this.contentColor)) * 31) + Color.m6821hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m6821hashCodeimpl(this.disabledContentColor);
    }
}
