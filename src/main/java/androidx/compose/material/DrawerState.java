...
public final class DrawerState {
    ...
    public DrawerState(DrawerValue drawerValue, Function1<? super DrawerValue, Boolean> function1) {
        this.anchoredDraggableState = new AnchoredDraggableState<>(drawerValue, new Function1() { // from class: androidx.compose.material.DrawerState$$ExternalSyntheticLambda1
            ...
            public final Object invoke(Object obj) {
                return Float.valueOf(DrawerState.anchoredDraggableState$lambda$0(this.f$0, ((Float) obj).floatValue()));
            }
        }, new Function0() { // from class: androidx.compose.material.DrawerState$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Float.valueOf(DrawerState.anchoredDraggableState$lambda$1(this.f$0));
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final float anchoredDraggableState$lambda$0(DrawerState drawerState, float f) {
        return drawerState.requireDensity().mo754toPx0680j_4(DrawerKt.DrawerPositionalThreshold);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final float anchoredDraggableState$lambda$1(DrawerState drawerState) {
        return drawerState.requireDensity().mo754toPx0680j_4(DrawerKt.DrawerVelocityThreshold);
    }
