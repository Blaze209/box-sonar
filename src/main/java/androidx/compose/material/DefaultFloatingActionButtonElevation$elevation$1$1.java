...
@DebugMetadata(c = "androidx.compose.material.DefaultFloatingActionButtonElevation$elevation$1$1", f = "FloatingActionButton.kt", i = {}, l = {272}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class DefaultFloatingActionButtonElevation$elevation$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$animatable.m2429updateElevationlDy3nrA(this.this$0.defaultElevation, this.this$0.pressedElevation, this.this$0.hoveredElevation, this.this$0.focusedElevation, this) == coroutine_suspended) {
