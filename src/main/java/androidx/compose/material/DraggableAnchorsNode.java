...
final class DraggableAnchorsNode<T> extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo372measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo0.getWidth(), placeableMo8265measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.material.DraggableAnchorsNode$$ExternalSyntheticLambda0
    ...
    public static final Unit measure_3p2s80s$lambda$0(MeasureScope measureScope, DraggableAnchorsNode draggableAnchorsNode, Placeable placeable, Placeable.PlacementScope placementScope) {
        ...
        float f = draggableAnchorsNode.orientation == Orientation.Horizontal ? fRequireOffset : 0.0f;
        if (draggableAnchorsNode.orientation != Orientation.Vertical) {
            fRequireOffset = 0.0f;
        }
        Placeable.PlacementScope.place$default(placementScope, placeable, MathKt.roundToInt(f), MathKt.roundToInt(fRequireOffset), 0.0f, 4, null);
