...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo2698defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long jM2712defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m2712defaultRippleColor5vOe2sY(Color.INSTANCE.m6840getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return jM2712defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha rippleAlphaM2711defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m2711defaultRippleAlphaDxMtmZc(Color.INSTANCE.m6840getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return rippleAlphaM2711defaultRippleAlphaDxMtmZc;
    }
}
