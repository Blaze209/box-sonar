...
final class StateLayer {
    ...
    public final void handleInteraction$material_ripple(Interaction interaction, CoroutineScope scope) {
        ...
        if (interaction2 == null) {
            ...
            if (interaction2 instanceof HoverInteraction.Enter) {
                ...
                draggedAlpha = interaction2 instanceof DragInteraction.Start ? rippleAlphaInvoke.getDraggedAlpha() : 0.0f;
            }
    ...
    public final void m2714drawStateLayermxwnekA(DrawScope drawScope, float f, long j) {
        float fFloatValue = this.animatedAlpha.getValue().floatValue();
        if (fFloatValue > 0.0f) {
            long jM6813copywmQWz5c$default = Color.m6813copywmQWz5c$default(j, fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                DrawScope.m7376drawCircleVaOC9Bg$default(drawScope, jM6813copywmQWz5c$default, f, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
