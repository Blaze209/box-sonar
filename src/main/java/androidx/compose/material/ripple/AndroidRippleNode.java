...
public final class AndroidRippleNode extends RippleNode implements RippleHostKey {
    ...
    public void mo2695addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius) {
        ...
        rippleHostView.m2703addRippleKOepWvA(interaction, getBounded(), size, MathKt.roundToInt(targetRadius), m2709getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha(), new Function0() { // from class: androidx.compose.material.ripple.AndroidRippleNode$$ExternalSyntheticLambda0
    ...
    public void drawRipples(DrawScope drawScope) {
        ...
        RippleHostView rippleHostView = this.rippleHostView;
        if (rippleHostView != null) {
            rippleHostView.m2704setRipplePropertiesbiQXAtU(getRippleSize(), MathKt.roundToInt(getTargetRadius()), m2709getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha());
