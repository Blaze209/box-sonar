...
public final class Ripple_androidKt {
    ...
    public static final DelegatableNode m2713createPlatformRippleNodeTDGSqEk(InteractionSource interactionSource, boolean z, float f, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
