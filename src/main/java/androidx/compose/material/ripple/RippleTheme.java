...
public interface RippleTheme {
    ...
    long mo2698defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m2712defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            return (lightTheme || ((double) ColorKt.m6866luminance8_81llA(contentColor)) >= 0.5d) ? contentColor : Color.INSTANCE.m6851getWhite0d7_KjU();
        }
        ...
        public final RippleAlpha m2711defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            if (lightTheme) {
                return ((double) ColorKt.m6866luminance8_81llA(contentColor)) > 0.5d ? RippleThemeKt.LightThemeHighContrastRippleAlpha : RippleThemeKt.LightThemeLowContrastRippleAlpha;
            }
