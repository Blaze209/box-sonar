...
public abstract class RippleNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, DrawModifierNode, LayoutAwareModifierNode {
    ...
    public abstract void mo2695addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius);
    ...
    public final long m2709getRippleColor0d7_KjU() {
        return this.color.mo2379invoke0d7_KjU();
    }
    ...
    public void mo743onRemeasuredozmzZPI(long size) {
        ...
        this.rippleSize = IntSizeKt.m9870toSizeozmzZPI(size);
        if (Float.isNaN(this.radius)) {
            fMo754toPx0680j_4 = RippleAnimationKt.m2700getRippleEndRadiuscSwnlzA(densityRequireDensity, this.bounded, this.rippleSize);
        } else {
            fMo754toPx0680j_4 = densityRequireDensity.mo754toPx0680j_4(this.radius);
        }
        this.targetRadius = fMo754toPx0680j_4;
    ...
    public final void handlePressInteraction(PressInteraction pressInteraction) {
        if (pressInteraction instanceof PressInteraction.Press) {
            mo2695addRipple12SF9DM((PressInteraction.Press) pressInteraction, this.rippleSize, this.targetRadius);
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (stateLayer != null) {
            stateLayer.m2714drawStateLayermxwnekA(contentDrawScope, this.targetRadius, m2709getRippleColor0d7_KjU());
        }
