...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m2716setColorDxMtmZc(long color, float alpha) {
        long jM2715calculateRippleColor5vOe2sY = m2715calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m6815equalsimpl0(color2.m6824unboximpl(), jM2715calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m6804boximpl(jM2715calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m6868toArgb8_81llA(jM2715calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m2715calculateRippleColor5vOe2sY(long color, float alpha) {
        return Color.m6813copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
