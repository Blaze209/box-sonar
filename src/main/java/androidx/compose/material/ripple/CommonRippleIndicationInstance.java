...
final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        float fM2700getRippleEndRadiuscSwnlzA;
        if (Float.isNaN(this.radius)) {
            fM2700getRippleEndRadiuscSwnlzA = RippleAnimationKt.m2700getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo7395getSizeNHjbRc());
        } else {
            fM2700getRippleEndRadiuscSwnlzA = contentDrawScope.mo754toPx0680j_4(this.radius);
        }
        this.targetRadius = fM2700getRippleEndRadiuscSwnlzA;
        long jM6824unboximpl = this.color.getValue().m6824unboximpl();
        contentDrawScope.drawContent();
        ContentDrawScope contentDrawScope2 = contentDrawScope;
        m2706drawStateLayerH2RKhps(contentDrawScope2, this.radius, jM6824unboximpl);
        m2697drawRipples4WTKRHQ(contentDrawScope2, jM6824unboximpl);
    }
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        RippleAnimation rippleAnimation = new RippleAnimation(this.bounded ? Offset.m6558boximpl(interaction.getPressPosition()) : null, this.targetRadius, this.bounded, null);
    ...
    @DebugMetadata(c = "androidx.compose.material.ripple.CommonRippleIndicationInstance$addRipple$2", f = "CommonRipple.kt", i = {}, l = {Token.SETELEM_OP}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    ...
    private final void m2697drawRipples4WTKRHQ(DrawScope drawScope, long j) {
        long j2;
        Iterator<Map.Entry<PressInteraction.Press, RippleAnimation>> it = this.ripples.entrySet().iterator();
        while (it.hasNext()) {
            ...
            if (pressedAlpha == 0.0f) {
                ...
                j2 = j;
                value.m2699draw4WTKRHQ(drawScope, Color.m6813copywmQWz5c$default(j2, pressedAlpha, 0.0f, 0.0f, 0.0f, 14, null));
            }
            j = j2;
        }
    }
