...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m9687constructorimpl(10);
    ...
    public static final float m2701getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m6638getWidthimpl(j), Size.m6635getHeightimpl(j)) * 0.3f;
    }

    /* JADX INFO: renamed from: getRippleEndRadius-cSwnlzA, reason: not valid java name */
    public static final float m2700getRippleEndRadiuscSwnlzA(Density density, boolean z, long j) {
        float fM6567getDistanceimpl = Offset.m6567getDistanceimpl(OffsetKt.Offset(Size.m6638getWidthimpl(j), Size.m6635getHeightimpl(j))) / 2.0f;
        return z ? fM6567getDistanceimpl + density.mo754toPx0680j_4(BoundedRippleExtraRadius) : fM6567getDistanceimpl;
    }
}
