...
public final class RippleKt {
    ...
    public static final DelegatableNode m2707createRippleModifierNodeTDGSqEk(InteractionSource interactionSource, boolean z, float f, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
        return Ripple_androidKt.m2713createPlatformRippleNodeTDGSqEk(interactionSource, z, f, colorProducer, function0);
    }
    ...
    public static final Indication m2708rememberRipple9IZ8Weo(boolean z, float f, long j, Composer composer, int i, int i2) {
        ...
        State stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m6804boximpl(j), composer, (i >> 6) & 14);
