...
final class SharedElement$momentumAnimationOffset$1$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (Animatable.animateTo$default(this.this$0.momentumAnimation, Offset.m6558boximpl(Offset.INSTANCE.m6585getZeroF1C5BW0()), this.$spring, null, null, this, 12, null) == coroutine_suspended) {
