...
public final class AnimationModifierKt {
    ...
    public static final boolean m376isValidozmzZPI(long j) {
        return !IntSize.m9856equalsimpl0(j, InvalidSize);
    }

    static {
        long j = Integer.MIN_VALUE;
        InvalidSize = IntSize.m9853constructorimpl((j & 4294967295L) | (j << 32));
    }
}
