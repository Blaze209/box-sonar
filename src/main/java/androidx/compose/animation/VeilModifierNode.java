    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        State<Color> stateAnimate = this.veilAnimation.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<Color>>() { // from class: androidx.compose.animation.VeilModifierNode$draw$veilColor$1
            ...
            public /* bridge */ /* synthetic */ Color invoke(EnterExitState enterExitState) {
                return Color.m6804boximpl(m463invokevNxB06k(enterExitState));
            }

            /* JADX INFO: renamed from: invoke-vNxB06k, reason: not valid java name */
            public final long m463invokevNxB06k(EnterExitState enterExitState) {
                int i = WhenMappings.$EnumSwitchMapping$0[enterExitState.ordinal()];
                if (i == 1) {
                    Veil veil = this.this$0.getEnter().getData().getVeil();
                    if (veil != null) {
                        return veil.m462getTargetColor0d7_KjU();
                    }
                    Veil veil2 = this.this$0.getExit().getData().getVeil();
                    return veil2 != null ? veil2.m461getInitialColor0d7_KjU() : Color.INSTANCE.m6849getTransparent0d7_KjU();
                }
                if (i == 2) {
                    Veil veil3 = this.this$0.getEnter().getData().getVeil();
                    return veil3 != null ? veil3.m461getInitialColor0d7_KjU() : Color.INSTANCE.m6849getTransparent0d7_KjU();
                }
                if (i != 3) {
                    throw new NoWhenBranchMatchedException();
                }
                Veil veil4 = this.this$0.getExit().getData().getVeil();
                return veil4 != null ? veil4.m462getTargetColor0d7_KjU() : Color.INSTANCE.m6849getTransparent0d7_KjU();
            }
        });
        if (Color.m6816getAlphaimpl(stateAnimate.getValue().m6824unboximpl()) == 0.0f) {
            return;
        }
        ...
        if (veil != null && veil.getMatchParentSize()) {
            ...
            if (parentLayoutCoordinates == null) {
                ...
                jM6647getZeroNHjbRc = Size.m6629constructorimpl((((long) Float.floatToRawIntBits((int) (jMo8273getSizeYbymL2g & 4294967295L))) & 4294967295L) | (Float.floatToRawIntBits((int) (jMo8273getSizeYbymL2g >> 32)) << 32));
            }
            DrawScope.m7389drawRectnJ9OG0$default(contentDrawScope, stateAnimate.getValue().m6824unboximpl(), Offset.m6561constructorimpl((-9223372034707292160L) ^ LayoutCoordinatesKt.positionInParent(layoutCoordinatesRequireLayoutCoordinates)), jM6647getZeroNHjbRc, 0.0f, null, null, 0, 120, null);
            return;
        }
        DrawScope.m7389drawRectnJ9OG0$default(contentDrawScope, stateAnimate.getValue().m6824unboximpl(), 0L, 0L, 0.0f, null, null, 0, 126, null);
    }
}
