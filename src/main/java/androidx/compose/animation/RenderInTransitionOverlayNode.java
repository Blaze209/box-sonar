...
public final class RenderInTransitionOverlayNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, ModifierLocalModifierNode {
    ...
    private long positionInOverlay = Offset.INSTANCE.m6585getZeroF1C5BW0();
    ...
    public final void m418setPositionInOverlayk4lQ0M(long j) {
        if (Offset.m6566equalsimpl0(j, this.positionInOverlay)) {
            return;
        }
        Function0<Unit> invalidateOverlay = this.sharedScope.getInvalidateOverlay();
        if (invalidateOverlay != null) {
    ...
    public MeasureResult mo372measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo0.getWidth(), placeableMo8265measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.RenderInTransitionOverlayNode$measure$1$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                if (!measureScope.isLookingAhead()) {
                    if (!this.getRenderInOverlay().invoke().booleanValue()) {
                        ...
                        renderInTransitionOverlayNode.m418setPositionInOverlayk4lQ0M(renderInTransitionOverlayNode.getSharedScope().getRoot$animation().mo8274localPositionOfR5De75A(DelegatableNodeKt.requireLayoutCoordinates(renderInTransitionOverlayNode), Offset.INSTANCE.m6585getZeroF1C5BW0()));
                    }
                }
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        DrawScope.m7393recordJVtK1S4$default(contentDrawScope2, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.RenderInTransitionOverlayNode.draw.1
            {
                super(1);
            }
