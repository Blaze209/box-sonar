    ...
    public MeasureResult mo344measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        while (true) {
            ...
            if (childData != null && childData.isTarget()) {
                ...
                placeableArr[i2] = placeableMo8265measureBRTryo0;
                jM9863getZeroYbymL2g = jM9853constructorimpl;
            }
            i2++;
        }
        ...
        for (int i3 = 0; i3 < size3; i3++) {
            ...
            if (placeableArr[i3] == null) {
                placeableArr[i3] = measurable2.mo8265measureBRTryo0(j);
            }
        }
        if (measureScope.isLookingAhead()) {
            width = (int) (jM9863getZeroYbymL2g >> 32);
        } else {
            if (size != 0) {
        ...
        if (measureScope.isLookingAhead()) {
            height = (int) (jM9863getZeroYbymL2g & 4294967295L);
        } else {
            if (size != 0) {
        ...
        if (!measureScope.isLookingAhead()) {
            this.rootScope.m369setMeasuredSizeozmzZPI$animation(IntSize.m9853constructorimpl((((long) width) << 32) | (((long) height) & 4294967295L)));
        }
        return MeasureScope.layout$default(measureScope, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                for (Placeable placeable5 : placeableArr2) {
                    if (placeable5 != null) {
                        long jMo6288alignKFBX0sM = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo6288alignKFBX0sM(IntSize.m9853constructorimpl((((long) placeable5.getWidth()) << 32) | (((long) placeable5.getHeight()) & 4294967295L)), IntSize.m9853constructorimpl((((long) i5) << 32) | (((long) i6) & 4294967295L)), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default(placementScope, placeable5, IntOffset.m9815getXimpl(jMo6288alignKFBX0sM), IntOffset.m9816getYimpl(jMo6288alignKFBX0sM), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);
