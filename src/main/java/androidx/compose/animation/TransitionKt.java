...
public final class TransitionKt {
    public static final <S> State<Color> animateColor(final Transition<S> transition, Function3<? super Transition.Segment<S>, ? super Composer, ? super Integer, ? extends FiniteAnimationSpec<Color>> function3, String str, Function3<? super S, ? super Composer, ? super Integer, Color> function4, Composer composer, int i, int i2) {
        ...
        ColorSpace colorSpaceM6818getColorSpaceimpl = Color.m6818getColorSpaceimpl(function4.invoke(transition.getTargetState(), composer, Integer.valueOf((i >> 6) & 112)).m6824unboximpl());
        ComposerKt.sourceInformationMarkerStart(composer, -1791411589, "CC(remember):Transition.kt#9igjgp");
        boolean zChanged = composer.changed(colorSpaceM6818getColorSpaceimpl);
        ...
        int i5 = (i4 >> 9) & 112;
        Color colorInvoke = function4.invoke(currentState, composer, Integer.valueOf(i5));
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        Color colorInvoke2 = function4.invoke((Object) ((State) objRememberedValue2).getValue(), composer, Integer.valueOf(i5));
    ...
    public static final State<Color> m455animateColorDTcfvLk(InfiniteTransition infiniteTransition, long j, long j2, InfiniteRepeatableSpec<Color> infiniteRepeatableSpec, String str, Composer composer, int i, int i2) {
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = (TwoWayConverter) ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m6818getColorSpaceimpl(j2));
            composer.updateRememberedValue(objRememberedValue);
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        int i3 = i << 3;
        State<Color> stateAnimateValue = InfiniteTransitionKt.animateValue(infiniteTransition, Color.m6804boximpl(j), Color.m6804boximpl(j2), (TwoWayConverter) objRememberedValue, infiniteRepeatableSpec, str2, composer, InfiniteTransition.$stable | (i & 14) | (i & 112) | (i & 896) | (InfiniteRepeatableSpec.$stable << 12) | (57344 & i3) | (i3 & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public static final /* synthetic */ State m456animateColorRIQooxk(InfiniteTransition infiniteTransition, long j, long j2, InfiniteRepeatableSpec infiniteRepeatableSpec, Composer composer, int i) {
        ...
        State<Color> stateM455animateColorDTcfvLk = m455animateColorDTcfvLk(infiniteTransition, j, j2, infiniteRepeatableSpec, "ColorAnimation", composer, InfiniteTransition.$stable | 24576 | (i & 14) | (i & 112) | (i & 896) | (InfiniteRepeatableSpec.$stable << 9) | (i & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
