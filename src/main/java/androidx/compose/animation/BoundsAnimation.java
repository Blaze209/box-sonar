...
public final class BoundsAnimation {
    ...
    public final Rect getValue() {
        ...
        long jM6579unboximpl = this.momentumOffset.invoke().m6579unboximpl();
        return !Offset.m6566equalsimpl0(jM6579unboximpl, Offset.INSTANCE.m6585getZeroF1C5BW0()) ? value.m6606translatek4lQ0M(jM6579unboximpl) : value;
    }
