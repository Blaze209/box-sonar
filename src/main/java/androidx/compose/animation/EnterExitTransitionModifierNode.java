...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m409setLookaheadConstraintsBRTryo0(long j) {
    ...
    public final long m410sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        if (i != 1) {
            if (i == 2) {
                ...
                if (changeSize != null && (size = changeSize.getSize()) != null) {
                    return size.invoke(IntSize.m9850boximpl(fullSize)).m9862unboximpl();
                }
            } else {
                if (i != 3) {
                ...
                if (changeSize2 != null && (size2 = changeSize2.getSize()) != null) {
                    return size2.invoke(IntSize.m9850boximpl(fullSize)).m9862unboximpl();
                }
            }
        }
        return fullSize;
    ...
    public final long m412targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
            if (i == 1) {
                return IntOffset.INSTANCE.m9826getZeronOccac();
            }
            if (i == 2) {
                return IntOffset.INSTANCE.m9826getZeronOccac();
            }
            ...
            if (changeSize != null) {
                long jM9862unboximpl = changeSize.getSize().invoke(IntSize.m9850boximpl(fullSize)).m9862unboximpl();
                Alignment alignment = getAlignment();
                Intrinsics.checkNotNull(alignment);
                long jMo6288alignKFBX0sM = alignment.mo6288alignKFBX0sM(fullSize, jM9862unboximpl, LayoutDirection.Ltr);
                Alignment alignment2 = this.currentAlignment;
                Intrinsics.checkNotNull(alignment2);
                return IntOffset.m9818minusqkQi6aY(jMo6288alignKFBX0sM, alignment2.mo6288alignKFBX0sM(fullSize, jM9862unboximpl, LayoutDirection.Ltr));
            }
            return IntOffset.INSTANCE.m9826getZeronOccac();
        }
        return IntOffset.INSTANCE.m9826getZeronOccac();
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            long jM9853constructorimpl = IntSize.m9853constructorimpl((((long) placeableMo8265measureBRTryo0.getWidth()) << 32) | (((long) placeableMo8265measureBRTryo0.getHeight()) & 4294967295L));
            this.lookaheadSize = jM9853constructorimpl;
            m409setLookaheadConstraintsBRTryo0(j);
            return MeasureScope.layout$default(measureScope, (int) (jM9853constructorimpl >> 32), (int) (jM9853constructorimpl & 4294967295L), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                {
                    super(1);
                }
        ...
        if (this.isEnabled.invoke().booleanValue()) {
            ...
            final Placeable placeableMo8265measureBRTryo1 = measurable.mo8265measureBRTryo0(j);
            long jM9853constructorimpl2 = IntSize.m9853constructorimpl((((long) placeableMo8265measureBRTryo1.getWidth()) << 32) | (((long) placeableMo8265measureBRTryo1.getHeight()) & 4294967295L));
            final long j2 = AnimationModifierKt.m376isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jM9853constructorimpl2;
            ...
            State<IntSize> stateAnimate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                    return IntSize.m9850boximpl(m413invokeYEO4UFw(enterExitState));
                }

                /* JADX INFO: renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m413invokeYEO4UFw(EnterExitState enterExitState) {
                    return this.this$0.m410sizeByStateUzc_VyU(enterExitState, j2);
                }
            }) : null;
            if (stateAnimate3 != null) {
                jM9853constructorimpl2 = stateAnimate3.getValue().m9862unboximpl();
            }
            long jM9654constrain4WqzIAM = ConstraintsKt.m9654constrain4WqzIAM(j, jM9853constructorimpl2);
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
            long jM9826getZeronOccac = (deferredAnimation2 == null || (stateAnimate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
                @Override // kotlin.jvm.functions.Function1
                public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                    return EnterExitTransitionKt.DefaultOffsetAnimationSpec;
                }
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m9806boximpl(m414invokeBjo55l4(enterExitState));
                }

                /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m414invokeBjo55l4(EnterExitState enterExitState) {
                    return this.this$0.m412targetOffsetByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m9826getZeronOccac() : stateAnimate2.getValue().m9824unboximpl();
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
            long jM9826getZeronOccac2 = (deferredAnimation3 == null || (stateAnimate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m9806boximpl(m415invokeBjo55l4(enterExitState));
                }

                /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m415invokeBjo55l4(EnterExitState enterExitState) {
                    return this.this$0.m411slideTargetValueByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m9826getZeronOccac() : stateAnimate.getValue().m9824unboximpl();
            Alignment alignment2 = this.currentAlignment;
            final long jM9819plusqkQi6aY = IntOffset.m9819plusqkQi6aY(alignment2 != null ? alignment2.mo6288alignKFBX0sM(j2, jM9654constrain4WqzIAM, LayoutDirection.Ltr) : IntOffset.INSTANCE.m9826getZeronOccac(), jM9826getZeronOccac2);
            final long j3 = jM9826getZeronOccac;
            return MeasureScope.layout$default(measureScope, (int) (jM9654constrain4WqzIAM >> 32), (int) (jM9654constrain4WqzIAM & 4294967295L), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    placementScope.placeWithLayer(placeableMo8265measureBRTryo1, IntOffset.m9815getXimpl(j3) + IntOffset.m9815getXimpl(jM9819plusqkQi6aY), IntOffset.m9816getYimpl(j3) + IntOffset.m9816getYimpl(jM9819plusqkQi6aY), 0.0f, function1Init);
                }
            }, 4, null);
        }
        final Placeable placeableMo8265measureBRTryo2 = measurable.mo8265measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo2.getWidth(), placeableMo8265measureBRTryo2.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$3$1
            {
                super(1);
            }
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo8265measureBRTryo2, 0, 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public final long m411slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Function1<IntSize, IntOffset> slideOffset;
        Function1<IntSize, IntOffset> slideOffset2;
        Slide slide = this.enter.getData().getSlide();
        long jM9826getZeronOccac = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m9826getZeronOccac() : slideOffset2.invoke(IntSize.m9850boximpl(fullSize)).m9824unboximpl();
        Slide slide2 = this.exit.getData().getSlide();
        long jM9826getZeronOccac2 = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m9826getZeronOccac() : slideOffset.invoke(IntSize.m9850boximpl(fullSize)).m9824unboximpl();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i == 1) {
            return IntOffset.INSTANCE.m9826getZeronOccac();
        }
