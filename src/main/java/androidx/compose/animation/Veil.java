...
public final /* data */ class Veil {
    ...
    public static /* synthetic */ Veil m457copyRFnl5yQ$default(Veil veil, long j, long j2, FiniteAnimationSpec finiteAnimationSpec, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            j = veil.initialColor;
        }
        long j3 = j;
        ...
        return veil.m460copyRFnl5yQ(j3, j4, finiteAnimationSpec2, z);
    }
    ...
    public final Veil m460copyRFnl5yQ(long initialColor, long targetColor, FiniteAnimationSpec<Color> animationSpec, boolean matchParentSize) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.initialColor, veil.initialColor) && Color.m6815equalsimpl0(this.targetColor, veil.targetColor) && Intrinsics.areEqual(this.animationSpec, veil.animationSpec) && this.matchParentSize == veil.matchParentSize;
    }

    public int hashCode() {
        return (((((Color.m6821hashCodeimpl(this.initialColor) * 31) + Color.m6821hashCodeimpl(this.targetColor)) * 31) + this.animationSpec.hashCode()) * 31) + Boolean.hashCode(this.matchParentSize);
    }

    public String toString() {
        return "Veil(initialColor=" + ((Object) Color.m6822toStringimpl(this.initialColor)) + ", targetColor=" + ((Object) Color.m6822toStringimpl(this.targetColor)) + ", animationSpec=" + this.animationSpec + ", matchParentSize=" + this.matchParentSize + ')';
    }
    ...
    public final long m461getInitialColor0d7_KjU() {
        return this.initialColor;
    }

    /* JADX INFO: renamed from: getTargetColor-0d7_KjU, reason: not valid java name */
    public final long m462getTargetColor0d7_KjU() {
        return this.targetColor;
    }
