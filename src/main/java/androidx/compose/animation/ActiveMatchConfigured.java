...
public final class ActiveMatchConfigured extends MatchIsOrHasBeenConfigured {
    ...
    public SharedTransitionStateMachine.State mo339configureActiveMatch38uP1EE(SharedElement sharedElement, BoundsProvider targetBoundsProvider, long lookaheadSize, long topLeft, long structuralOffset) {
        SharedTransitionStateMachineKt.m434updateTargetDataBGTQxF0(getTargetData(), lookaheadSize, topLeft, structuralOffset, !Intrinsics.areEqual(getTargetBoundsProvider(), targetBoundsProvider));
    ...
    public SharedTransitionStateMachine.State onVisibleContentRemovedDuringTransition() {
        Rect rectCalculateAlternativeTargetBounds = getTargetBoundsProvider().calculateAlternativeTargetBounds(RectKt.m6609Recttz77jQw(Offset.m6574plusMKHz9U(getTargetData().m447getCurrentMfrOffsetF1C5BW0(), getTargetData().m450getTargetStructuralOffsetF1C5BW0()), getTargetData().m449getSizeNHjbRc()));
        if (rectCalculateAlternativeTargetBounds == null) {
            return NoMatchFound.INSTANCE;
        }
        TargetData targetData = new TargetData(rectCalculateAlternativeTargetBounds.m6602getSizeNHjbRc(), getTargetData().m448getInitialMfrOffsetF1C5BW0(), Offset.m6573minusMKHz9U(rectCalculateAlternativeTargetBounds.m6604getTopLeftF1C5BW0(), getTargetData().m447getCurrentMfrOffsetF1C5BW0()), null);
        targetData.m451setCurrentMfrOffsetk4lQ0M(getTargetData().m447getCurrentMfrOffsetF1C5BW0());
