...
public final class BoundsTransformDeferredAnimation {
    ...
    private long targetSize = Size.INSTANCE.m6646getUnspecifiedNHjbRc();
    private long targetOffset = Offset.INSTANCE.m6584getUnspecifiedF1C5BW0();
    private long currentPosition = Offset.INSTANCE.m6584getUnspecifiedF1C5BW0();
    ...
    private long additionalOffset = Offset.INSTANCE.m6585getZeroF1C5BW0();

    /* JADX INFO: renamed from: updateTargetSize-uvyYCjk, reason: not valid java name */
    public final void m383updateTargetSizeuvyYCjk(long size) {
        if (this.targetSize != InlineClassHelperKt.UnspecifiedPackedFloats && !IntSize.m9856equalsimpl0(IntSizeKt.m9866roundToIntSizeuvyYCjk(size), IntSizeKt.m9866roundToIntSizeuvyYCjk(this.targetSize))) {
            this.isPending = true;
        }
    ...
    private final void m379updateTargetOffsetk4lQ0M(long offset) {
        if ((this.targetOffset & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats && !IntOffset.m9814equalsimpl0(IntOffsetKt.m9832roundk4lQ0M(offset), IntOffsetKt.m9832roundk4lQ0M(this.targetOffset))) {
            this.isPending = true;
        }
    ...
    public final void m381setCurrentSizeuvyYCjk(long j) {
        this.currentSize = j;
    }
    ...
    public final Rect getCurrentBounds() {
        ...
        return RectKt.m6609Recttz77jQw(j2, j);
    }

    /* JADX INFO: renamed from: updateCurrentBounds-tz77jQw, reason: not valid java name */
    public final void m382updateCurrentBoundstz77jQw(long position, long size) {
    ...
    public final void updateTargetOffsetAndAnimate(LookaheadScope lookaheadScope, Placeable.PlacementScope placementScope, CoroutineScope coroutineScope, boolean directManipulationParentsDirty, boolean includeMotionFrameOfReference, BoundsTransform boundsTransform) {
        ...
        if (coordinates != null) {
            ...
            if (!includeMotionFrameOfReference && directManipulationParentsDirty) {
                ...
                while (!Intrinsics.areEqual(lookaheadScope.toLookaheadCoordinates(parentCoordinates), lookaheadScopeCoordinates)) {
                    if (parentCoordinates.getIntroducesMotionFrameOfReference()) {
                        if (arrayList.size() == i) {
                            ...
                            jM6585getZeroF1C5BW0 = Offset.m6574plusMKHz9U(jM6585getZeroF1C5BW0, LayoutCoordinatesKt.positionInParent(parentCoordinates));
                        } else if (!Intrinsics.areEqual(arrayList.get(i), parentCoordinates)) {
                            long jM6573minusMKHz9U = Offset.m6573minusMKHz9U(jM6585getZeroF1C5BW0, LayoutCoordinatesKt.positionInParent(arrayList.get(i)));
                            arrayList.set(i, parentCoordinates);
                            jM6585getZeroF1C5BW0 = Offset.m6574plusMKHz9U(jM6573minusMKHz9U, LayoutCoordinatesKt.positionInParent(parentCoordinates));
                        }
                        i++;
                    }
                ...
                if (i <= size) {
                    while (true) {
                        jM6585getZeroF1C5BW0 = Offset.m6573minusMKHz9U(jM6585getZeroF1C5BW0, LayoutCoordinatesKt.positionInParent(arrayList.get(size)));
            ...
            this.additionalOffset = Offset.m6574plusMKHz9U(this.additionalOffset, jM6585getZeroF1C5BW0);
            m379updateTargetOffsetk4lQ0M(Offset.m6574plusMKHz9U(LookaheadScope.m8295localLookaheadPositionOfauaQtc$default(lookaheadScope, lookaheadScopeCoordinates, coordinates, 0L, includeMotionFrameOfReference, 2, null), this.additionalOffset));
            setAnimatedValue(animate(coroutineScope, boundsTransform).m6606translatek4lQ0M(Offset.m6561constructorimpl(this.additionalOffset ^ (-9223372034707292160L))));
        }
    }
    ...
    private final Rect animate(CoroutineScope coroutineScope, BoundsTransform boundsTransform) {
        ...
        if ((9223372034707292159L & j) != InlineClassHelperKt.UnspecifiedPackedFloats) {
            ...
            if (j2 != InlineClassHelperKt.UnspecifiedPackedFloats) {
                Rect rectM6609Recttz77jQw = RectKt.m6609Recttz77jQw(j, j2);
                Animatable<Rect, AnimationVector4D> animatable = this.animatable;
                if (animatable == null) {
                    animatable = new Animatable<>(rectM6609Recttz77jQw, VectorConvertersKt.getVectorConverter(Rect.INSTANCE), null, null, 12, null);
                }
                this.animatable = animatable;
                if (this.isPending) {
                    this.isPending = false;
                    BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, CoroutineStart.UNDISPATCHED, new AnonymousClass1(animatable, rectM6609Recttz77jQw, boundsTransform, this, null), 1, null);
                }
            }
        }
