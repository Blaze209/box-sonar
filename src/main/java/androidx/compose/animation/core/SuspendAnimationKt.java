    ...
    public static final <T, V extends AnimationVector> Object animate(final AnimationState<T, V> animationState, Animation<T, V> animation, long j, final Function1<? super AnimationScope<T, V>, Unit> function1, Continuation<? super Unit> continuation) {
        ...
        if (i == 0) {
            ...
            if (j == Long.MIN_VALUE) {
                try {
                    ...
                    try {
                        Function1 function4 = new Function1() { // from class: androidx.compose.animation.core.SuspendAnimationKt$$ExternalSyntheticLambda0
                            @Override // kotlin.jvm.functions.Function1
                            public final Object invoke(Object obj2) {
                ...
                try {
                    ...
                    doAnimationFrameWithScale(r12, j, getDurationScale(anonymousClass5.getContext()), animation2, animationState, function1);
        ...
        do {
            ...
            if (((AnimationScope) t).isRunning()) {
                ...
                try {
                    function3 = new Function1() { // from class: androidx.compose.animation.core.SuspendAnimationKt$$ExternalSyntheticLambda2
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj2) {
                            return SuspendAnimationKt.animate$lambda$6(objectRef3, durationScale2, animation3, animationState4, function5, ((Long) obj2).longValue());
                        }
                    };
