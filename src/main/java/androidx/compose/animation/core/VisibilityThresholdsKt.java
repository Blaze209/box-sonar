...
public final class VisibilityThresholdsKt {
    ...
    public static final long getVisibilityThreshold(DpOffset.Companion companion) {
        ...
        return DpOffset.m9743constructorimpl((((long) Float.floatToRawIntBits(visibilityThreshold)) << 32) | (((long) Float.floatToRawIntBits(visibilityThreshold2)) & 4294967295L));
    }
    ...
    public static final long getVisibilityThreshold(IntOffset.Companion companion) {
        long j = 1;
        return IntOffset.m9809constructorimpl((j & 4294967295L) | (j << 32));
    }

    public static final long getVisibilityThreshold(Offset.Companion companion) {
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(1.0f)) << 32) | (((long) Float.floatToRawIntBits(1.0f)) & 4294967295L));
    }

    public static final float getVisibilityThreshold(Dp.Companion companion) {
        return Dp.m9687constructorimpl(0.4f);
    }

    public static final long getVisibilityThreshold(Size.Companion companion) {
        return Size.m6629constructorimpl((((long) Float.floatToRawIntBits(1.0f)) << 32) | (((long) Float.floatToRawIntBits(1.0f)) & 4294967295L));
    }

    public static final long getVisibilityThreshold(IntSize.Companion companion) {
        long j = 1;
        return IntSize.m9853constructorimpl((j & 4294967295L) | (j << 32));
    }
}
