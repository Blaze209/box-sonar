...
public final class ArcMode {
    ...
    private static final int ArcAbove = m480constructorimpl(5);
    private static final int ArcBelow = m480constructorimpl(4);
    private static final int ArcLinear = m480constructorimpl(0);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ArcMode m479boximpl(int i) {
    ...
    public static int m483hashCodeimpl(int i) {
    ...
    public boolean equals(Object other) {
        return m481equalsimpl(this.value, other);
    }
