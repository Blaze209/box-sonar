...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> extends KeyframesSpecBaseConfig<T, KeyframeEntity<T>> {
        ...
        public final KeyframeEntity<T> m496usingngzHuyU(KeyframeEntity<T> keyframeEntity, int i) {
            keyframeEntity.m495setArcModeRur9ykg$animation_core(i);
            return keyframeEntity;
        }
    }
    ...
    public <V extends AnimationVector> VectorizedKeyframesSpec<V> vectorize(TwoWayConverter<T, V> converter) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i4 < i3) {
                        if ((255 & j) < 128) {
                            ...
                            mutableIntObjectMap.set(i6, new VectorizedKeyframeSpecElementInfo(converter.getConvertToVector().invoke(keyframeEntity.getValue$animation_core()), keyframeEntity.getEasing(), keyframeEntity.getArcMode(), null));
                        }
                        j >>= i2;
                        i4++;
                        i2 = i2;
        ...
        mutableIntList.sort();
        return new VectorizedKeyframesSpec<>(mutableIntList, mutableIntObjectMap, this.config.getDurationMillis(), this.config.getDelayMillis(), EasingKt.getLinearEasing(), ArcMode.INSTANCE.m488getArcLinear9TMq4(), null);
    }
    ...
    public static final class KeyframeEntity<T> extends KeyframeBaseEntity<T> {
        ...
        public /* synthetic */ KeyframeEntity(Object obj, Easing easing, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this(obj, (i2 & 2) != 0 ? EasingKt.getLinearEasing() : easing, (i2 & 4) != 0 ? ArcMode.INSTANCE.m488getArcLinear9TMq4() : i, null);
        }
        ...
        public final void m495setArcModeRur9ykg$animation_core(int i) {
            this.arcMode = i;
        }
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(keyframeEntity.getValue$animation_core(), getValue$animation_core()) && Intrinsics.areEqual(keyframeEntity.getEasing(), getEasing()) && ArcMode.m482equalsimpl0(keyframeEntity.arcMode, this.arcMode);
        }

        public int hashCode() {
            T value$animation_core = getValue$animation_core();
            return ((((value$animation_core != null ? value$animation_core.hashCode() : 0) * 31) + ArcMode.m483hashCodeimpl(this.arcMode)) * 31) + getEasing().hashCode();
        }
    }
}
