...
public final class VectorizedKeyframesSpec<V extends AnimationVector> implements VectorizedDurationBasedAnimationSpec<V> {
    ...
    public VectorizedKeyframesSpec(Map<Integer, ? extends Pair<? extends V, ? extends Easing>> map, int i, int i2) {
        ...
        for (Map.Entry<Integer, ? extends Pair<? extends V, ? extends Easing>> entry : map.entrySet()) {
            ...
            mutableIntObjectMap.set(iIntValue, new VectorizedKeyframeSpecElementInfo(value.getFirst(), value.getSecond(), ArcMode.INSTANCE.m488getArcLinear9TMq4(), null));
        }
        this(mutableIntList2, mutableIntObjectMap, i, i2, EasingKt.getLinearEasing(), ArcMode.INSTANCE.m488getArcLinear9TMq4(), null);
    }
    ...
    private final void init(V initialValue, V targetValue, V initialVelocity) {
        ...
        if (this.valueVector == null) {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                ...
                int iM549getArcMode9TMq4 = vectorizedKeyframeSpecElementInfo != null ? vectorizedKeyframeSpecElementInfo.m549getArcMode9TMq4() : this.initialArcMode;
                if (!ArcMode.m482equalsimpl0(iM549getArcMode9TMq4, ArcMode.INSTANCE.m488getArcLinear9TMq4())) {
                    z = true;
                }
                iArr[i4] = iM549getArcMode9TMq4;
            }
            this.modes = iArr;
        }
        if (z) {
    ...
    private final float getEasedTimeFromIndex(int index, int timeMillis, boolean asFraction) {
        ...
        if (index >= this.timestamps._size - 1) {
            ...
            if (timeMillis != i) {
                ...
                return asFraction ? fTransform : ((f2 * fTransform) + i) / 1000;
            }
            f = i;
        }
        return f / 1000;
