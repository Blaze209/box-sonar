...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    private final MutableState measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m9850boximpl(IntSize.INSTANCE.m9863getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo347slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        if (m366isLeftgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
                ...
                public final Integer invoke(int i) {
                    long j = i;
                    return initialOffset.invoke(Integer.valueOf(((int) (this.m365getCurrentSizeYbymL2g() >> 32)) - IntOffset.m9815getXimpl(this.m364calculateOffsetemnUabE(IntSize.m9853constructorimpl((j & 4294967295L) | (j << 32)), this.m365getCurrentSizeYbymL2g()))));
                }
            });
        }
        if (m367isRightgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
                ...
                public final Integer invoke(int i) {
                    long j = i;
                    return initialOffset.invoke(Integer.valueOf((-IntOffset.m9815getXimpl(this.m364calculateOffsetemnUabE(IntSize.m9853constructorimpl((j & 4294967295L) | (j << 32)), this.m365getCurrentSizeYbymL2g()))) - i));
                }
            });
        }
        if (AnimatedContentTransitionScope.SlideDirection.m352equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m361getUpDKzdypw())) {
            return EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
                ...
                public final Integer invoke(int i) {
                    long j = i;
                    return initialOffset.invoke(Integer.valueOf(((int) (this.m365getCurrentSizeYbymL2g() & 4294967295L)) - IntOffset.m9816getYimpl(this.m364calculateOffsetemnUabE(IntSize.m9853constructorimpl((4294967295L & j) | (j << 32)), this.m365getCurrentSizeYbymL2g()))));
                }
            });
        }
        if (AnimatedContentTransitionScope.SlideDirection.m352equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m356getDownDKzdypw())) {
            return EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
                ...
                public final Integer invoke(int i) {
                    long j = i;
                    return initialOffset.invoke(Integer.valueOf((-IntOffset.m9816getYimpl(this.m364calculateOffsetemnUabE(IntSize.m9853constructorimpl((j & 4294967295L) | (j << 32)), this.m365getCurrentSizeYbymL2g()))) - i));
                }
            });
        }
    ...
    private final boolean m366isLeftgWo6LJ4(int i) {
        if (AnimatedContentTransitionScope.SlideDirection.m352equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m358getLeftDKzdypw())) {
            return true;
        }
        if (AnimatedContentTransitionScope.SlideDirection.m352equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m360getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) {
            return true;
        }
        return AnimatedContentTransitionScope.SlideDirection.m352equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m357getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl;
    }

    /* JADX INFO: renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m367isRightgWo6LJ4(int i) {
        if (AnimatedContentTransitionScope.SlideDirection.m352equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m359getRightDKzdypw())) {
            return true;
        }
        if (AnimatedContentTransitionScope.SlideDirection.m352equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m360getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) {
            return true;
        }
        return AnimatedContentTransitionScope.SlideDirection.m352equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m357getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: calculateOffset-emnUabE, reason: not valid java name */
    public final long m364calculateOffsetemnUabE(long fullSize, long currentSize) {
        return getContentAlignment().mo6288alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* JADX INFO: renamed from: slideOutOfContainer-mOhB8PU */
    public ExitTransition mo348slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        if (m366isLeftgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
                ...
                public final Integer invoke(int i) {
                    ...
                    long j = i;
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m9815getXimpl(this.this$0.m364calculateOffsetemnUabE(IntSize.m9853constructorimpl((j & 4294967295L) | (j << 32)), state != null ? ((IntSize) state.getValue()).m9862unboximpl() : IntSize.INSTANCE.m9863getZeroYbymL2g()))) - i));
                }
            });
        }
        if (m367isRightgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
                ...
                public final Integer invoke(int i) {
                    State state = (State) this.this$0.getTargetSizeMap$animation().get(this.this$0.getTransition$animation().getTargetState());
                    long jM9862unboximpl = state != null ? ((IntSize) state.getValue()).m9862unboximpl() : IntSize.INSTANCE.m9863getZeroYbymL2g();
                    long j = i;
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m9815getXimpl(this.this$0.m364calculateOffsetemnUabE(IntSize.m9853constructorimpl((j & 4294967295L) | (j << 32)), jM9862unboximpl))) + ((int) (jM9862unboximpl >> 32))));
                }
            });
        }
        if (AnimatedContentTransitionScope.SlideDirection.m352equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m361getUpDKzdypw())) {
            return EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$3
                ...
                public final Integer invoke(int i) {
                    State state = (State) this.this$0.getTargetSizeMap$animation().get(this.this$0.getTransition$animation().getTargetState());
                    long j = i;
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m9816getYimpl(this.this$0.m364calculateOffsetemnUabE(IntSize.m9853constructorimpl((j & 4294967295L) | (j << 32)), state != null ? ((IntSize) state.getValue()).m9862unboximpl() : IntSize.INSTANCE.m9863getZeroYbymL2g()))) - i));
                }
            });
        }
        if (AnimatedContentTransitionScope.SlideDirection.m352equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m356getDownDKzdypw())) {
            return EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$4
                ...
                public final Integer invoke(int i) {
                    ...
                    long jM9862unboximpl = state != null ? ((IntSize) state.getValue()).m9862unboximpl() : IntSize.INSTANCE.m9863getZeroYbymL2g();
                    long j = i;
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m9816getYimpl(this.this$0.m364calculateOffsetemnUabE(IntSize.m9853constructorimpl((j & 4294967295L) | (j << 32)), jM9862unboximpl))) + ((int) (jM9862unboximpl & 4294967295L))));
                }
            });
        }
    ...
    public final long m368getMeasuredSizeYbymL2g$animation() {
        return ((IntSize) this.measuredSize.getValue()).m9862unboximpl();
    }

    /* JADX INFO: renamed from: setMeasuredSize-ozmzZPI$animation, reason: not valid java name */
    public final void m369setMeasuredSizeozmzZPI$animation(long j) {
        this.measuredSize.setValue(IntSize.m9850boximpl(j));
    }
    ...
    public final long m365getCurrentSizeYbymL2g() {
        State<IntSize> state = this.animatedSize;
        return state != null ? state.getValue().m9862unboximpl() : m368getMeasuredSizeYbymL2g$animation();
    }
    ...
    static final class SizeModifierNode<S> extends LayoutModifierNodeWithPassThroughIntrinsics {
        ...
        public final long m371lastContinuousSizeOrDefaultmzRDjE0(long j) {
            return IntSize.m9856equalsimpl0(this.lastSize, AnimatedContentKt.UnspecifiedSize) ? j : this.lastSize;
        }
        ...
        public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            final long jM9862unboximpl;
            final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(j);
            if (measureScope.isLookingAhead()) {
                jM9862unboximpl = IntSize.m9853constructorimpl((((long) placeableMo8265measureBRTryo0.getWidth()) << 32) | (((long) placeableMo8265measureBRTryo0.getHeight()) & 4294967295L));
            } else if (this.sizeAnimation == null) {
                jM9862unboximpl = IntSize.m9853constructorimpl((((long) placeableMo8265measureBRTryo0.getWidth()) << 32) | (((long) placeableMo8265measureBRTryo0.getHeight()) & 4294967295L));
                this.lastSize = IntSize.m9853constructorimpl((((long) placeableMo8265measureBRTryo0.getWidth()) << 32) | (((long) placeableMo8265measureBRTryo0.getHeight()) & 4294967295L));
            } else {
                final long jM9853constructorimpl = IntSize.m9853constructorimpl((((long) placeableMo8265measureBRTryo0.getWidth()) << 32) | (((long) placeableMo8265measureBRTryo0.getHeight()) & 4294967295L));
                Transition<S>.DeferredAnimation<IntSize, AnimationVector2D> deferredAnimation = this.sizeAnimation;
                ...
                State<IntSize> stateAnimate = deferredAnimation.animate(new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifierNode$measure$size$1
                    ...
                    public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> segment) {
                        long jM9862unboximpl2;
                        FiniteAnimationSpec<IntSize> finiteAnimationSpecMo446createAnimationSpecTemP2vQ;
                        if (Intrinsics.areEqual(segment.getInitialState(), this.this$0.getScope().getInitialState())) {
                            jM9862unboximpl2 = this.this$0.m371lastContinuousSizeOrDefaultmzRDjE0(jM9853constructorimpl);
                        } else {
                            State<IntSize> state = this.this$0.getScope().getTargetSizeMap$animation().get(segment.getInitialState());
                            jM9862unboximpl2 = state != null ? state.getValue().m9862unboximpl() : IntSize.INSTANCE.m9863getZeroYbymL2g();
                        }
                        State<IntSize> state2 = this.this$0.getScope().getTargetSizeMap$animation().get(segment.getTargetState());
                        long jM9862unboximpl3 = state2 != null ? state2.getValue().m9862unboximpl() : IntSize.INSTANCE.m9863getZeroYbymL2g();
                        SizeTransform value = this.this$0.getSizeTransform().getValue();
                        return (value == null || (finiteAnimationSpecMo446createAnimationSpecTemP2vQ = value.mo446createAnimationSpecTemP2vQ(jM9862unboximpl2, jM9862unboximpl3)) == null) ? AnimationSpecKt.spring$default(0.0f, 400.0f, null, 5, null) : finiteAnimationSpecMo446createAnimationSpecTemP2vQ;
                    }
                    ...
                    public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                        return IntSize.m9850boximpl(m373invokeYEO4UFw(obj));
                    }

                    /* JADX INFO: renamed from: invoke-YEO4UFw, reason: not valid java name */
                    public final long m373invokeYEO4UFw(S s) {
                        if (Intrinsics.areEqual(s, this.this$0.getScope().getInitialState())) {
                            return this.this$0.m371lastContinuousSizeOrDefaultmzRDjE0(jM9853constructorimpl);
                        }
                        State<IntSize> state = this.this$0.getScope().getTargetSizeMap$animation().get(s);
                        return state != null ? state.getValue().m9862unboximpl() : IntSize.INSTANCE.m9863getZeroYbymL2g();
                    }
                });
                this.scope.setAnimatedSize$animation(stateAnimate);
                jM9862unboximpl = stateAnimate.getValue().m9862unboximpl();
                this.lastSize = stateAnimate.getValue().m9862unboximpl();
            }
            return MeasureScope.layout$default(measureScope, (int) (jM9862unboximpl >> 32), (int) (jM9862unboximpl & 4294967295L), null, new Function1<Placeable.PlacementScope, Unit>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifierNode$measure$1
                final /* synthetic */ AnimatedContentTransitionScopeImpl.SizeModifierNode<S> this$0;
                ...
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    Placeable.PlacementScope.m8331place70tqf50$default(placementScope, placeableMo8265measureBRTryo0, this.this$0.getScope().getContentAlignment().mo6288alignKFBX0sM(IntSize.m9853constructorimpl((((long) placeableMo8265measureBRTryo0.getWidth()) << 32) | (((long) placeableMo8265measureBRTryo0.getHeight()) & 4294967295L)), jM9862unboximpl, LayoutDirection.Ltr), 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
