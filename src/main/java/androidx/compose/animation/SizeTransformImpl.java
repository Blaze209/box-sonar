...
final class SizeTransformImpl implements SizeTransform {
    ...
    public FiniteAnimationSpec<IntSize> mo446createAnimationSpecTemP2vQ(long initialSize, long targetSize) {
        return this.sizeAnimationSpec.invoke(IntSize.m9850boximpl(initialSize), IntSize.m9850boximpl(targetSize));
    }
}
