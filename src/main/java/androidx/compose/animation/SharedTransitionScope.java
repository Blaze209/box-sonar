...
public interface SharedTransitionScope extends LookaheadScope {
    ...
    public interface SharedContentConfig {
        ...
        default Rect m427alternativeTargetBoundsInTransitionScopeAfterRemovalcSwnlzA(SharedContentState sharedContentState, Rect rect, long j) {
            return null;
        }
    ...
    public interface PlaceholderSize {
        ...
        long mo426calculateSizeJyjRU_E(long contentSize, long animatedSize);
        ...
        public static final class Companion {
            ...
            private static final PlaceholderSize AnimatedSize = new PlaceholderSize() { // from class: androidx.compose.animation.SharedTransitionScope$PlaceholderSize$Companion$AnimatedSize$1
                ...
                public final long mo426calculateSizeJyjRU_E(long j, long j2) {
                    return j2;
                }
            };
    ...
    default Modifier skipToLookaheadPosition(Modifier modifier, final Function0<Boolean> function0) {
        return LookaheadScopeKt.approachLayout(modifier, new Function1<IntSize, Boolean>() { // from class: androidx.compose.animation.SharedTransitionScope.skipToLookaheadPosition.2
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(IntSize intSize) {
                return m429invokeozmzZPI(intSize.m9862unboximpl());
            }

            /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
            public final Boolean m429invokeozmzZPI(long j) {
                return false;
            }
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(ApproachMeasureScope approachMeasureScope, Measurable measurable, Constraints constraints) {
                return m430invoke3p2s80s(approachMeasureScope, measurable, constraints.getValue());
            }

            /* JADX INFO: renamed from: invoke-3p2s80s, reason: not valid java name */
            public final MeasureResult m430invoke3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j) {
                ...
                return MeasureScope.layout$default(approachMeasureScope, placeableMo8265measureBRTryo0.getWidth(), placeableMo8265measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedTransitionScope$skipToLookaheadPosition$4$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(Placeable.PlacementScope placementScope) {
                        if (function1.invoke().booleanValue()) {
                            ...
                            if (coordinates != null) {
                                ...
                                Placeable.PlacementScope.m8331place70tqf50$default(placementScope, placeableMo8265measureBRTryo0, IntOffsetKt.m9832roundk4lQ0M(Offset.m6573minusMKHz9U(coordinates.mo8274localPositionOfR5De75A(sharedTransitionScope2.getLookaheadScopeCoordinates(placementScope), Offset.m6573minusMKHz9U(LookaheadScope.m8295localLookaheadPositionOfauaQtc$default(sharedTransitionScope2, sharedTransitionScope2.getLookaheadScopeCoordinates(placementScope), coordinates, 0L, false, 6, null), LayoutCoordinates.m8272localPositionOfS_NoaFU$default(sharedTransitionScope2.getLookaheadScopeCoordinates(placementScope), coordinates, 0L, false, 6, null))), LayoutCoordinates.m8272localPositionOfS_NoaFU$default(coordinates, sharedTransitionScope2.getLookaheadScopeCoordinates(placementScope), 0L, false, 6, null))), 0.0f, 2, null);
                                return;
                            }
    ...
    public static final class SharedContentState {
        ...
        public final void m428prepareTransitionWithInitialVelocityTH1AsA0(long initialVelocity) {
            SharedElementEntry nonNullInternalState = getNonNullInternalState();
            if (getConfig$animation().isEnabled(this)) {
                nonNullInternalState.getSharedElement().m423updateExitVelocityTH1AsA0$animation(initialVelocity);
            }
        }
