...
final class SizeAnimationModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    public static final /* data */ class AnimData {
        ...
        public static /* synthetic */ AnimData m441copyO0kMr_c$default(AnimData animData, Animatable animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m443copyO0kMr_c(animatable, j);
        }
        ...
        public final AnimData m443copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long startSize) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m9856equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m9859hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m9861toStringimpl(this.startSize)) + ')';
        }
        ...
        public final long m444getStartSizeYbymL2g() {
            return this.startSize;
        }

        /* JADX INFO: renamed from: setStartSize-ozmzZPI, reason: not valid java name */
        public final void m445setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }
    }
    ...
    public MeasureResult mo372measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        Placeable placeableMo8265measureBRTryo0;
        long jM9654constrain4WqzIAM;
        if (measureScope.isLookingAhead()) {
            m438setLookaheadConstraintsBRTryo0(j);
            placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(j);
        } else {
            placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(m439targetConstraintsZezNO4M(j));
        }
        final Placeable placeable = placeableMo8265measureBRTryo0;
        final long jM9853constructorimpl = IntSize.m9853constructorimpl((((long) placeable.getWidth()) << 32) | (((long) placeable.getHeight()) & 4294967295L));
        if (measureScope.isLookingAhead()) {
            this.lookaheadSize = jM9853constructorimpl;
            jM9654constrain4WqzIAM = jM9853constructorimpl;
        } else {
            jM9654constrain4WqzIAM = ConstraintsKt.m9654constrain4WqzIAM(j, m440animateTomzRDjE0(AnimationModifierKt.m376isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jM9853constructorimpl));
        }
        final int i = (int) (jM9654constrain4WqzIAM >> 32);
        final int i2 = (int) (jM9654constrain4WqzIAM & 4294967295L);
        return MeasureScope.layout$default(measureScope, i, i2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifierNode$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m8331place70tqf50$default(placementScope, placeable, this.this$0.getAlignment().mo6288alignKFBX0sM(jM9853constructorimpl, IntSize.m9853constructorimpl((((long) i) << 32) | (((long) i2) & 4294967295L)), measureScope.getLayoutDirection()), 0.0f, 2, null);
            }
        }, 4, null);
    }

    /* JADX INFO: renamed from: animateTo-mzRDjE0, reason: not valid java name */
    public final long m440animateTomzRDjE0(long targetSize) {
        AnimData animData = getAnimData();
        if (animData != null) {
            boolean z = (IntSize.m9856equalsimpl0(targetSize, animData.getAnim().getValue().m9862unboximpl()) || animData.getAnim().isRunning()) ? false : true;
            if (!IntSize.m9856equalsimpl0(targetSize, animData.getAnim().getTargetValue().m9862unboximpl()) || z) {
                animData.m445setStartSizeozmzZPI(animData.getAnim().getValue().m9862unboximpl());
            ...
            long j = 1;
            animData = new AnimData(new Animatable(IntSize.m9850boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m9850boximpl(IntSize.m9853constructorimpl((j & 4294967295L) | (j << 32))), null, 8, null), targetSize, null);
        }
        setAnimData(animData);
        return animData.getAnim().getValue().m9862unboximpl();
    }
}
