...
public final class SharedElementEntry implements LayerRenderer, RememberObserver {
    ...
    public final Rect calculateTargetBounds(Rect previousTargetBoundsBeforeLosingTarget) {
        return getUserState().getConfig$animation().m427alternativeTargetBoundsInTransitionScopeAfterRemovalcSwnlzA(getUserState(), previousTargetBoundsBeforeLosingTarget, IntSizeKt.m9870toSizeozmzZPI(getSharedElement().getScope().getLookaheadRoot$animation().mo8273getSizeYbymL2g()));
    }
    ...
    public void drawInOverlay(DrawScope drawScope) {
        ...
        long jM6604getTopLeftF1C5BW0 = currentBounds.m6604getTopLeftF1C5BW0();
        float fIntBitsToFloat = Float.intBitsToFloat((int) (jM6604getTopLeftF1C5BW0 >> 32));
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (jM6604getTopLeftF1C5BW0 & 4294967295L));
