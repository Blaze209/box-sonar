...
public final class SlotWriter {
    ...
    public final boolean hasObjectKey(int index) {
        return (this.groups[(groupIndexToAddress(index) * 5) + 1] & C.BUFFER_FLAG_LAST_SAMPLE) != 0;
    }
    ...
    public final boolean removeGroup() {
        ...
        if (mutableIntList != null) {
            while (PrioritySet.m6022isNotEmptyimpl(mutableIntList) && PrioritySet.m6023peekimpl(mutableIntList) >= i) {
                PrioritySet.m6024takeMaximpl(mutableIntList);
            }
        }
    ...
    /* JADX INFO: compiled from: SlotTable.kt */
    @Metadata(d1 = {"\u0000\u001f\n\u0000\n\u0002\u0010(\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001J\t\u0010\t\u001a\u00020\nH\u0096\u0002J\u000b\u0010\u000b\u001a\u0004\u0018\u00010\u0002H\u0096\u0002R\u001a\u0010\u0003\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0005\u0010\u0006\"\u0004\b\u0007\u0010\b¨\u0006\f"}, d2 = {"androidx/compose/runtime/SlotWriter$groupSlots$1", "", "", "current", "", "getCurrent", "()I", "setCurrent", "(I)V", "hasNext", "", ES6Iterator.NEXT_METHOD, "runtime"}, k = 1, mv = {2, 0, 0}, xi = 48)
    ...
    private final void recalculateMarks() {
        MutableIntList mutableIntList = this.pendingRecalculateMarks;
        if (mutableIntList != null) {
            while (PrioritySet.m6022isNotEmptyimpl(mutableIntList)) {
                m6038updateContainsMarkNowXpTMRCE(PrioritySet.m6024takeMaximpl(mutableIntList), mutableIntList);
            }
        }
    }
    ...
    public final void updateContainsMark(int group) {
        if (group >= 0) {
            MutableIntList mutableIntListM6017constructorimpl$default = this.pendingRecalculateMarks;
            if (mutableIntListM6017constructorimpl$default == null) {
                mutableIntListM6017constructorimpl$default = PrioritySet.m6017constructorimpl$default(null, 1, null);
                this.pendingRecalculateMarks = mutableIntListM6017constructorimpl$default;
            }
            PrioritySet.m6014addimpl(mutableIntListM6017constructorimpl$default, group);
        }
    }

    /* JADX INFO: renamed from: updateContainsMarkNow-XpTMRCE, reason: not valid java name */
    private final void m6038updateContainsMarkNowXpTMRCE(int group, MutableIntList set) {
        int iGroupIndexToAddress = groupIndexToAddress(group);
        ...
        if (((iArr[(iGroupIndexToAddress * 5) + 1] & 67108864) != 0) != zChildContainsAnyMarks) {
            ...
            int iParent = parent(group);
            if (iParent >= 0) {
                PrioritySet.m6014addimpl(set, iParent);
            }
        }
    }
