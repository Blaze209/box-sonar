...
public final class ComposeStackTraceMode {
    ...
    private static final int GroupKeys = m6278constructorimpl(1);
    private static final int SourceInformation = m6278constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ComposeStackTraceMode m6277boximpl(int i) {
        return new ComposeStackTraceMode(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m6278constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m6279equalsimpl(int i, Object obj) {
    ...
    public static String m6282toStringimpl(int i) {
        return "ComposeStackTraceMode(value=" + i + ')';
    }

    public boolean equals(Object other) {
        return m6279equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m6281hashCodeimpl(this.value);
    }

    public String toString() {
        return m6282toStringimpl(this.value);
    }
