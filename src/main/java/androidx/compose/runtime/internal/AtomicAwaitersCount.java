...
final class AtomicAwaitersCount {
    ...
    public static final /* synthetic */ AtomicAwaitersCount m6183boximpl(AtomicInt atomicInt) {
        return new AtomicAwaitersCount(atomicInt);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static AtomicInt m6185constructorimpl(AtomicInt atomicInt) {
        return atomicInt;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m6187equalsimpl(AtomicInt atomicInt, Object obj) {
        return (obj instanceof AtomicAwaitersCount) && Intrinsics.areEqual(atomicInt, ((AtomicAwaitersCount) obj).getValue());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6188equalsimpl0(AtomicInt atomicInt, AtomicInt atomicInt2) {
        return Intrinsics.areEqual(atomicInt, atomicInt2);
    }

    /* JADX INFO: renamed from: getCount-impl, reason: not valid java name */
    private static final int m6189getCountimpl(AtomicInt atomicInt, int i) {
        return 134217727 & i;
    }

    /* JADX INFO: renamed from: getVersion-impl, reason: not valid java name */
    private static final int m6190getVersionimpl(AtomicInt atomicInt, int i) {
        return (i >>> 27) & 15;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m6192hashCodeimpl(AtomicInt atomicInt) {
        return atomicInt.hashCode();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: pack-impl, reason: not valid java name */
    public static final int m6195packimpl(AtomicInt atomicInt, int i, int i2) {
        return ((i & 15) << 27) | (134217727 & i2);
    }

    public boolean equals(Object other) {
        return m6187equalsimpl(this.value, other);
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static AtomicInt m6184constructorimpl() {
        return m6185constructorimpl(new AtomicInt(0));
    }

    /* JADX INFO: renamed from: hasAwaiters-impl, reason: not valid java name */
    public static final boolean m6191hasAwaitersimpl(AtomicInt atomicInt) {
        return (atomicInt.get() & 134217727) > 0;
    }

    /* JADX INFO: renamed from: update-impl, reason: not valid java name */
    private static final int m6197updateimpl(AtomicInt atomicInt, Function1<? super Integer, Integer> function1) {
        int i;
        int iIntValue;
        do {
            i = atomicInt.get();
    ...
    public String toString() {
        return m6196toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m6196toStringimpl(AtomicInt atomicInt) {
        int i = atomicInt.get();
    ...
    public static final void m6194incrementVersionAndResetCountimpl(AtomicInt atomicInt) {
        int i;
        do {
            i = atomicInt.get();
        } while (!atomicInt.compareAndSet(i, m6195packimpl(atomicInt, ((i >>> 27) & 15) + 1, 0)));
    }

    /* JADX INFO: renamed from: incrementCountAndGetVersion-impl, reason: not valid java name */
    public static final int m6193incrementCountAndGetVersionimpl(AtomicInt atomicInt, Function0<Unit> function0) {
        int i;
        int i2;
        do {
            i = atomicInt.get();
    ...
    public static final void m6186decrementCountimpl(AtomicInt atomicInt, int i) {
        int i2;
        do {
            i2 = atomicInt.get();
