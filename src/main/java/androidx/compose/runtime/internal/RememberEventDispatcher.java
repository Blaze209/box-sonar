...
public final class RememberEventDispatcher implements RememberManager {
    ...
    public void startResumingScope(RecomposeScopeImpl scope) {
        ...
        if (pausedCompositionRemembers != null) {
            ArrayList<MutableVector<RememberObserverHolder>> arrayListM6045constructorimpl$default = this.nestedRemembersLists;
            if (arrayListM6045constructorimpl$default == null) {
                arrayListM6045constructorimpl$default = Stack.m6045constructorimpl$default(null, 1, null);
                this.nestedRemembersLists = arrayListM6045constructorimpl$default;
            }
            Stack.m6055pushimpl(arrayListM6045constructorimpl$default, this.currentRememberingList);
    ...
    public void endResumingScope(RecomposeScopeImpl scope) {
        ...
        if (arrayList != null && (mutableVector = (MutableVector) Stack.m6054popimpl(arrayList)) != null) {
            this.currentRememberingList = mutableVector;
        }
