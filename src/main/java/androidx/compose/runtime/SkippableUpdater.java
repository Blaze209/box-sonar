...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m6030boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m6031constructorimpl(Composer composer) {
        return composer;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m6032equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).getComposer());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6033equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m6034hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m6035toStringimpl(Composer composer) {
        return "SkippableUpdater(composer=" + composer + ')';
    }

    public boolean equals(Object other) {
        return m6032equalsimpl(this.composer, other);
    }

    public int hashCode() {
        return m6034hashCodeimpl(this.composer);
    }

    public String toString() {
        return m6035toStringimpl(this.composer);
    }
    ...
    public static final void m6036updateimpl(Composer composer, Function1<? super Updater<T>, Unit> function1) {
        composer.startReplaceableGroup(509942095);
        function1.invoke(Updater.m6061boximpl(Updater.m6062constructorimpl(composer)));
