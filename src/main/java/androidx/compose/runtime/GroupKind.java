...
final class GroupKind {
    ...
    private static final int Group = m5994constructorimpl(0);
    private static final int Node = m5994constructorimpl(1);
    private static final int ReusableNode = m5994constructorimpl(2);
    private final int value;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ GroupKind m5993boximpl(int i) {
    ...
    public static boolean m5995equalsimpl(int i, Object obj) {
        return (obj instanceof GroupKind) && i == ((GroupKind) obj).m6001unboximpl();
    }
    ...
    public boolean equals(Object other) {
        return m5995equalsimpl(this.value, other);
    }
    ...
    public static final boolean m5998isNodeimpl(int i) {
        return i != INSTANCE.m6002getGroupULZAiWs();
    }

    /* JADX INFO: renamed from: isReusable-impl, reason: not valid java name */
    public static final boolean m5999isReusableimpl(int i) {
        return i != INSTANCE.m6003getNodeULZAiWs();
    }
