...
public final class ReaderKind {
    ...
    public static final /* synthetic */ ReaderKind m6257boximpl(int i) {
        return new ReaderKind(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m6258constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m6260equalsimpl(int i, Object obj) {
        return (obj instanceof ReaderKind) && i == ((ReaderKind) obj).m6266unboximpl();
    }
    ...
    public static final boolean m6263isReadInh_f27i8(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public boolean equals(Object other) {
        return m6260equalsimpl(this.mask, other);
    }

    public int hashCode() {
        return m6262hashCodeimpl(this.mask);
    }
    ...
    public static /* synthetic */ int m6259constructorimpl$default(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i2 & 1) != 0) {
            i = 0;
        }
        return m6258constructorimpl(i);
    }
    ...
    public static final int m6265withReadIn3QSx2Dw(int i, int i2) {
        return m6258constructorimpl(i | i2);
    }
    ...
    public static final class Companion {
        ...
        public final int m6267getComposition6f8NoZ8() {
            return ReaderKind.m6258constructorimpl(1);
        }

        /* JADX INFO: renamed from: getSnapshotStateObserver-6f8NoZ8, reason: not valid java name */
        public final int m6269getSnapshotStateObserver6f8NoZ8() {
            return ReaderKind.m6258constructorimpl(2);
        }

        /* JADX INFO: renamed from: getSnapshotFlow-6f8NoZ8, reason: not valid java name */
        public final int m6268getSnapshotFlow6f8NoZ8() {
            return ReaderKind.m6258constructorimpl(4);
        }
    }
}
