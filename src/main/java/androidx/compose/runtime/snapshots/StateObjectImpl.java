...
public abstract class StateObjectImpl implements StateObject {
    ...
    public final void m6275recordReadInh_f27i8$runtime(int reader) {
        int iM6258constructorimpl;
        do {
            iM6258constructorimpl = ReaderKind.m6258constructorimpl(this.readerKind.get());
            if ((iM6258constructorimpl & reader) != 0) {
                return;
            }
        } while (!this.readerKind.compareAndSet(iM6258constructorimpl, ReaderKind.m6258constructorimpl(iM6258constructorimpl | reader)));
    }

    /* JADX INFO: renamed from: isReadIn-h_f27i8$runtime, reason: not valid java name */
    public final boolean m6274isReadInh_f27i8$runtime(int reader) {
        return (ReaderKind.m6258constructorimpl(this.readerKind.get()) & reader) != 0;
    }
}
