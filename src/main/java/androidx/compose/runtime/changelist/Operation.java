...
public abstract class Operation {
    ...
    public String mo6075objectParamName31yXWZQ(int parameter) {
    ...
    public static final class ObjectParameter<T> {
        ...
        public static final /* synthetic */ ObjectParameter m6100boximpl(int i) {
            return new ObjectParameter(i);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static <T> int m6101constructorimpl(int i) {
            return i;
        }

        /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
        public static boolean m6102equalsimpl(int i, Object obj) {
            return (obj instanceof ObjectParameter) && i == ((ObjectParameter) obj).m6106unboximpl();
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m6103equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m6104hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
        public static String m6105toStringimpl(int i) {
            return "ObjectParameter(offset=" + i + ')';
        }

        public boolean equals(Object other) {
            return m6102equalsimpl(this.offset, other);
        }

        public int hashCode() {
            return m6104hashCodeimpl(this.offset);
        }

        public String toString() {
            return m6105toStringimpl(this.offset);
        }
    ...
    public static final class Downs extends Operation {
        ...
        public final int m6088getNodesHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            for (Object obj : (Object[]) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0))) {
                applier.down(obj);
            }
        }
        ...
        public String mo6075objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(0)) ? "nodes" : super.mo6075objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class SideEffect extends Operation {
        ...
        public final int m6113getEffectHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }
        ...
        /* JADX INFO: renamed from: objectParamName-31yXWZQ */
        public String mo6075objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(0)) ? GuideTransition.GUIDE_TRANSITION_EFFECT_FIELD : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.sideEffect((Function0) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0)));
        }
    }
    ...
    public static final class Remember extends Operation {
        ...
        public final int m6111getValueHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }
        ...
        /* JADX INFO: renamed from: objectParamName-31yXWZQ */
        public String mo6075objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(0)) ? "value" : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.remembering((RememberObserverHolder) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0)));
        }
    }
    ...
    public static final class RememberPausingScope extends Operation {
        ...
        public final int m6112getScopeHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }
        ...
        /* JADX INFO: renamed from: objectParamName-31yXWZQ */
        public String mo6075objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(0)) ? "scope" : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.rememberPausingScope((RecomposeScopeImpl) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0)));
        }
    }
    ...
    public static final class StartResumingScope extends Operation {
        ...
        /* JADX INFO: renamed from: getScope-HpuvwBQ, reason: not valid java name */
        public final int m6114getScopeHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.startResumingScope((RecomposeScopeImpl) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0)));
        }
    }
    ...
    public static final class EndResumingScope extends Operation {
        ...
        /* JADX INFO: renamed from: getScope-HpuvwBQ, reason: not valid java name */
        public final int m6091getScopeHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.endResumingScope((RecomposeScopeImpl) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0)));
        }
    }
    ...
    public static final class AppendValue extends Operation {
        ...
        public final int m6076getAnchorHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }

        /* JADX INFO: renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m6077getValueHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* JADX INFO: renamed from: objectParamName-31yXWZQ */
        public String mo6075objectParamName31yXWZQ(int parameter) {
            if (ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(0))) {
                return "anchor";
            }
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(1)) ? "value" : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            Anchor anchor = (Anchor) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0));
            Object objMo6122getObject31yXWZQ = operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(1));
            if (objMo6122getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering((RememberObserverHolder) objMo6122getObject31yXWZQ);
            }
            slotWriter.appendSlot(anchor, objMo6122getObject31yXWZQ);
        }
    }
    ...
    public static final class UpdateValue extends Operation {
        ...
        /* JADX INFO: renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m6121getValueHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            Object objMo6122getObject31yXWZQ = operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0));
            int i = operationArgContainer.getInt(0);
            if (objMo6122getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering((RememberObserverHolder) objMo6122getObject31yXWZQ);
            }
            Object obj = slotWriter.set(slotWriter.getCurrentGroup(), i, objMo6122getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
                rememberManager.forgetting((RememberObserverHolder) obj);
            } else if (obj instanceof RecomposeScopeImpl) {
                ((RecomposeScopeImpl) obj).release();
    ...
    public static final class UpdateAnchoredValue extends Operation {
        ...
        /* JADX INFO: renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m6117getValueHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }

        /* JADX INFO: renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m6116getAnchorHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(1);
        }
        ...
        public String mo6075objectParamName31yXWZQ(int parameter) {
            ...
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(1)) ? "anchor" : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            Object objMo6122getObject31yXWZQ = operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(1));
            int i = operationArgContainer.getInt(0);
            if (objMo6122getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering((RememberObserverHolder) objMo6122getObject31yXWZQ);
            }
            Object obj = slotWriter.set(slotWriter.anchorIndex(anchor), i, objMo6122getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
                rememberManager.forgetting((RememberObserverHolder) obj);
            } else if (obj instanceof RecomposeScopeImpl) {
                ((RecomposeScopeImpl) obj).release();
    ...
    public static final class UpdateAuxData extends Operation {
        ...
        public final int m6118getDataHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }
        ...
        /* JADX INFO: renamed from: objectParamName-31yXWZQ */
        public String mo6075objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(0)) ? "data" : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            slotWriter.updateAux(operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0)));
        }
    }
    ...
    public static final class EnsureGroupStarted extends Operation {
        ...
        /* JADX INFO: renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m6092getAnchorHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }
        ...
        /* JADX INFO: renamed from: objectParamName-31yXWZQ */
        public String mo6075objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(0)) ? "anchor" : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            slotWriter.ensureStarted((Anchor) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0)));
        }
    }
    ...
    public static final class EndCompositionScope extends Operation {
        ...
        public final int m6089getActionHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }

        /* JADX INFO: renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m6090getCompositionHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(1);
        }
        ...
        public String mo6075objectParamName31yXWZQ(int parameter) {
            ...
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(1)) ? "composition" : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            ((Function1) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0))).invoke((Composition) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(1)));
        }
    }
    ...
    public static final class UpdateNode extends Operation {
        ...
        /* JADX INFO: renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m6120getValueHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }

        /* JADX INFO: renamed from: getBlock-HpuvwBQ, reason: not valid java name */
        public final int m6119getBlockHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(1);
        }
        ...
        public String mo6075objectParamName31yXWZQ(int parameter) {
            ...
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(1)) ? "block" : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            applier.apply((Function2) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(1)), operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0)));
        }
    }
    ...
    public static final class InsertSlots extends Operation {
        ...
        /* JADX INFO: renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m6095getAnchorHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }

        /* JADX INFO: renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m6096getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(1);
        }
        ...
        public String mo6075objectParamName31yXWZQ(int parameter) {
            ...
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(1)) ? TypedValues.TransitionType.S_FROM : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            SlotTable slotTable = (SlotTable) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0));
    ...
    public static final class InsertSlotsWithFixups extends Operation {
        ...
        /* JADX INFO: renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m6097getAnchorHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }

        /* JADX INFO: renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m6099getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(1);
        }

        /* JADX INFO: renamed from: getFixups-HpuvwBQ, reason: not valid java name */
        public final int m6098getFixupsHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(2);
        }
        ...
        public String mo6075objectParamName31yXWZQ(int parameter) {
            ...
            if (ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(1))) {
                return TypedValues.TransitionType.S_FROM;
            }
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(2)) ? "fixups" : super.mo6075objectParamName31yXWZQ(parameter);
        }
        ...
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            ...
            SlotTable slotTable = (SlotTable) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0));
            FixupList fixupList = (FixupList) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(2));
    ...
    public static final class InsertNodeFixup extends Operation {
        ...
        public final int m6093getFactoryHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }

        /* JADX INFO: renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m6094getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(1);
        }
        ...
        public String mo6075objectParamName31yXWZQ(int parameter) {
            ...
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(1)) ? "groupAnchor" : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected Anchor getGroupAnchor(OperationArgContainer operationArgContainer, SlotWriter slotWriter) {
            return (Anchor) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(1));
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            Object objInvoke = ((Function0) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0))).invoke();
            Anchor anchor = (Anchor) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(1));
            int i = operationArgContainer.getInt(0);
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
    ...
    public static final class PostInsertNodeFixup extends Operation {
        ...
        /* JADX INFO: renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m6107getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }
        ...
        /* JADX INFO: renamed from: objectParamName-31yXWZQ */
        public String mo6075objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(0)) ? "groupAnchor" : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected Anchor getGroupAnchor(OperationArgContainer operationArgContainer, SlotWriter slotWriter) {
            return (Anchor) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0));
        }
    ...
    public static final class DetermineMovableContentNodeIndex extends Operation {
        ...
        public final int m6087getEffectiveNodeIndexOutHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }

        /* JADX INFO: renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m6086getAnchorHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(1);
        }
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            IntRef intRef = (IntRef) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(1));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
    ...
    public static final class CopyNodesToNewAnchorLocation extends Operation {
        ...
        public final int m6080getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }

        /* JADX INFO: renamed from: getNodes-HpuvwBQ, reason: not valid java name */
        public final int m6081getNodesHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(1);
        }
        ...
        public String mo6075objectParamName31yXWZQ(int parameter) {
            ...
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(1)) ? "nodes" : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            int element = ((IntRef) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0))).getElement();
            List list = (List) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(1));
            int size = list.size();
    ...
    public static final class CopySlotTableToAnchorLocation extends Operation {
        ...
        public final int m6084getResolvedStateHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }

        /* JADX INFO: renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m6083getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(1);
        }

        /* JADX INFO: renamed from: getFrom-HpuvwBQ, reason: not valid java name */
        public final int m6082getFromHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(2);
        }

        /* JADX INFO: renamed from: getTo-HpuvwBQ, reason: not valid java name */
        public final int m6085getToHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(3);
        }
        ...
        public String mo6075objectParamName31yXWZQ(int parameter) {
            ...
            if (ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(2))) {
                return TypedValues.TransitionType.S_FROM;
            }
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(3)) ? TypedValues.TransitionType.S_TO : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            MovableContentStateReference movableContentStateReference = (MovableContentStateReference) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(2));
            MovableContentStateReference movableContentStateReference2 = (MovableContentStateReference) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(3));
            CompositionContext compositionContext = (CompositionContext) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(1));
            MovableContentState movableContentStateMovableContentStateResolve$runtime = (MovableContentState) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0));
    ...
    public static final class ReleaseMovableGroupAtCurrent extends Operation {
        ...
        /* JADX INFO: renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m6108getCompositionHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }

        /* JADX INFO: renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m6109getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(1);
        }

        /* JADX INFO: renamed from: getReference-HpuvwBQ, reason: not valid java name */
        public final int m6110getReferenceHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(2);
        }
        ...
        public String mo6075objectParamName31yXWZQ(int parameter) {
            ...
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(2)) ? TypedValues.Custom.S_REFERENCE : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            ControlledComposition controlledComposition = (ControlledComposition) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0));
            MovableContentStateReference movableContentStateReference = (MovableContentStateReference) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(2));
            ((CompositionContext) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(1))).movableContentStateReleased$runtime(movableContentStateReference, ComposerKt.extractMovableContentAtCurrent(controlledComposition, movableContentStateReference, slotWriter, null), applier);
        }
    }
    ...
    public static final class ApplyChangeList extends Operation {
        ...
        public final int m6078getChangesHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(0);
        }

        /* JADX INFO: renamed from: getEffectiveNodeIndex-HpuvwBQ, reason: not valid java name */
        public final int m6079getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m6101constructorimpl(1);
        }
        ...
        public String mo6075objectParamName31yXWZQ(int parameter) {
            if (ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(0))) {
                return BoxRequestEvent.STREAM_TYPE_CHANGES;
            }
            return ObjectParameter.m6103equalsimpl0(parameter, ObjectParameter.m6101constructorimpl(1)) ? "effectiveNodeIndex" : super.mo6075objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            IntRef intRef = (IntRef) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(1));
            int element = intRef != null ? intRef.getElement() : 0;
            ChangeList changeList = (ChangeList) operationArgContainer.mo6122getObject31yXWZQ(ObjectParameter.m6101constructorimpl(0));
            if (element > 0) {
    ...
    public static final class TestOperation extends Operation {
        ...
        public TestOperation(int i, int i2, Function3<? super Applier<?>, ? super SlotWriter, ? super RememberManager, Unit> function3) {
            ...
            for (int i4 = 0; i4 < i2; i4++) {
                arrayList2.add(ObjectParameter.m6100boximpl(ObjectParameter.m6101constructorimpl(i4)));
            }
