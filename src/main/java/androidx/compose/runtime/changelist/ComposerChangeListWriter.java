...
public final class ComposerChangeListWriter {
    ...
    private final ArrayList<Object> pendingDownNodes = Stack.m6045constructorimpl$default(null, 1, null);
    ...
    public final void moveUp() {
        realizeNodeMovementOperations();
        if (Stack.m6051isNotEmptyimpl(this.pendingDownNodes)) {
            Stack.m6054popimpl(this.pendingDownNodes);
            return;
        }
    ...
    public final void moveDown(Object node) {
        realizeNodeMovementOperations();
        Stack.m6055pushimpl(this.pendingDownNodes, node);
    }
    ...
    private final void pushPendingUpsAndDowns() {
        ...
        if (Stack.m6051isNotEmptyimpl(this.pendingDownNodes)) {
            this.changeList.pushDowns(Stack.m6056toArrayimpl(this.pendingDownNodes));
            Stack.m6043clearimpl(this.pendingDownNodes);
        }
    }
