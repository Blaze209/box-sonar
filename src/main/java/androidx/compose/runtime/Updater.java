...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m6061boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m6062constructorimpl(Composer composer) {
        return composer;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m6063equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6064equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m6065hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m6071toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object other) {
        return m6063equalsimpl(this.composer, other);
    }

    public int hashCode() {
        return m6065hashCodeimpl(this.composer);
    }

    public String toString() {
        return m6071toStringimpl(this.composer);
    }
    ...
    public static final /* synthetic */ void m6069setimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* JADX INFO: renamed from: set-impl, reason: not valid java name */
    public static final <V> void m6070setimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> function2) {
    ...
    public static final /* synthetic */ void m6072updateimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* JADX INFO: renamed from: update-impl, reason: not valid java name */
    public static final <V> void m6073updateimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> function2) {
        boolean inserting = composer.getInserting();
    ...
    public static final void m6067initimpl(Composer composer, final Function1<? super T, Unit> function1) {
    ...
    /* JADX INFO: renamed from: init-impl, reason: not valid java name */
    public static final <V> void m6066initimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> function2) {
        if (composer.getInserting()) {
            composer.apply(v, function2);
        }
    }
    ...
    public static final void m6068reconcileimpl(Composer composer, final Function1<? super T, Unit> function1) {
