...
public final class LiveRegionMode {
    ...
    private static final int Polite = m8817constructorimpl(0);
    private static final int Assertive = m8817constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ LiveRegionMode m8816boximpl(int i) {
        return new LiveRegionMode(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m8817constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m8818equalsimpl(int i, Object obj) {
        return (obj instanceof LiveRegionMode) && i == ((LiveRegionMode) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m8819equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m8820hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object other) {
        return m8818equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m8820hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m8821toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m8821toStringimpl(int i) {
        if (m8819equalsimpl0(i, Polite)) {
            return "Polite";
        }
        return m8819equalsimpl0(i, Assertive) ? "Assertive" : "Unknown";
    }
}
