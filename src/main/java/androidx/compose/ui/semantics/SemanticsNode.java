...
public final class SemanticsNode {
    ...
    public final long m8845getSizeYbymL2g() {
        NodeCoordinator nodeCoordinatorFindCoordinatorToGetBounds$ui = findCoordinatorToGetBounds$ui();
        return nodeCoordinatorFindCoordinatorToGetBounds$ui != null ? nodeCoordinatorFindCoordinatorToGetBounds$ui.mo8273getSizeYbymL2g() : IntSize.INSTANCE.m9863getZeroYbymL2g();
    }
    ...
    public final long m8842getPositionInRootF1C5BW0() {
        NodeCoordinator nodeCoordinatorFindCoordinatorToGetBounds$ui = findCoordinatorToGetBounds$ui();
        if (nodeCoordinatorFindCoordinatorToGetBounds$ui != null) {
            if (!nodeCoordinatorFindCoordinatorToGetBounds$ui.isAttached()) {
                nodeCoordinatorFindCoordinatorToGetBounds$ui = null;
    ...
    public final long m8843getPositionInWindowF1C5BW0() {
        NodeCoordinator nodeCoordinatorFindCoordinatorToGetBounds$ui = findCoordinatorToGetBounds$ui();
        if (nodeCoordinatorFindCoordinatorToGetBounds$ui != null) {
            if (!nodeCoordinatorFindCoordinatorToGetBounds$ui.isAttached()) {
                nodeCoordinatorFindCoordinatorToGetBounds$ui = null;
    ...
    public final long m8844getPositionOnScreenF1C5BW0() {
        NodeCoordinator nodeCoordinatorFindCoordinatorToGetBounds$ui = findCoordinatorToGetBounds$ui();
        if (nodeCoordinatorFindCoordinatorToGetBounds$ui != null) {
            if (!nodeCoordinatorFindCoordinatorToGetBounds$ui.isAttached()) {
                nodeCoordinatorFindCoordinatorToGetBounds$ui = null;
    ...
    private final Rect boundsInImportantForBoundsAncestor(LayoutCoordinates nodeCoordinates) {
            ...
            if (head != null) {
                if ((head.getKindSet() & iM8585constructorimpl) != 0) {
                    ...
                    while (Pop != 0) {
                        ...
                        } else if ((Pop.getKindSet() & iM8585constructorimpl) != 0 && (Pop instanceof DelegatingNode)) {
        ...
        NodeCoordinator nodeCoordinatorM8436requireCoordinator64DMado = semanticsModifierNode != null ? DelegatableNodeKt.m8436requireCoordinator64DMado(semanticsModifierNode, NodeKind.m8585constructorimpl(8)) : null;
        if (nodeCoordinatorM8436requireCoordinator64DMado == null) {
            return parent.boundsInImportantForBoundsAncestor(nodeCoordinates);
        }
        return LayoutCoordinates.localBoundingBoxOf$default(nodeCoordinatorM8436requireCoordinator64DMado, nodeCoordinates, false, 2, null);
    }
    ...
    private final void fillOneLayerOfSemanticsWrappers(LayoutNode layoutNode, List<SemanticsNode> list, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layoutNode2.isAttached() && (z || !layoutNode2.getIsDeactivated())) {
                if (layoutNode2.getNodes().m8546hasH91voCI$ui(NodeKind.m8585constructorimpl(8))) {
    ...
    public final SemanticsNode getParent() {
        ...
        if (parent$ui == null) {
            parent$ui = this.layoutNode.getParent$ui();
            while (parent$ui != null) {
                if (!parent$ui.getNodes().m8546hasH91voCI$ui(NodeKind.m8585constructorimpl(8))) {
                    parent$ui = parent$ui.getParent$ui();
                }
            }
            parent$ui = null;
    ...
    public final NodeCoordinator findCoordinatorToGetBounds$ui() {
        NodeCoordinator nodeCoordinatorM8436requireCoordinator64DMado;
        if (!this.isFake) {
            SemanticsModifierNode semanticsModifierNodeFindSemanticsModifierNodeToGetBounds = findSemanticsModifierNodeToGetBounds();
            return (semanticsModifierNodeFindSemanticsModifierNodeToGetBounds == null || (nodeCoordinatorM8436requireCoordinator64DMado = DelegatableNodeKt.m8436requireCoordinator64DMado(semanticsModifierNodeFindSemanticsModifierNodeToGetBounds, NodeKind.m8585constructorimpl(8))) == null) ? this.layoutNode.getInnerCoordinator$ui() : nodeCoordinatorM8436requireCoordinator64DMado;
        }
        SemanticsNode parent = getParent();
        if (parent != null) {
    ...
    private final void emitFakeNodes(List<SemanticsNode> unmergedChildren) {
        ...
        if (role != null && this.unmergedConfig.getIsMergingSemanticsOfDescendants() && !unmergedChildren.isEmpty()) {
            unmergedChildren.add(m8841fakeSemanticsNodeypyhhiA(role, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$1
                {
                    super(1);
                }
        ...
        if (this.unmergedConfig.contains(SemanticsProperties.INSTANCE.getContentDescription()) && !unmergedChildren.isEmpty() && this.unmergedConfig.getIsMergingSemanticsOfDescendants()) {
            ...
            if (str != null) {
                unmergedChildren.add(0, m8841fakeSemanticsNodeypyhhiA(null, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$2
    ...
    private final SemanticsNode m8841fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> properties) {
