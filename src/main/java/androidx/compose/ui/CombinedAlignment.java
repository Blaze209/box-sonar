...
final class CombinedAlignment implements Alignment {
    ...
    public long mo6288alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        return IntOffset.m9809constructorimpl((((long) this.horizontal.align((int) (size >> 32), (int) (space >> 32), layoutDirection)) << 32) | (((long) this.vertical.align((int) (size & 4294967295L), (int) (space & 4294967295L))) & 4294967295L));
    }
}
