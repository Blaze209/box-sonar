    ...
    private final Function1<FocusEnterExitScope, Unit> onExit = new Function1<FocusEnterExitScope, Unit>() { // from class: androidx.compose.ui.viewinterop.FocusGroupPropertiesNode$onExit$1
        ...
        public final void invoke2(FocusEnterExitScope focusEnterExitScope) {
            ...
            if (embeddedView instanceof ViewGroup) {
                ...
                Integer numM6456toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m6456toAndroidFocusDirection3ESFkO8(focusEnterExitScope.getRequestedFocusDirection());
                int iIntValue = numM6456toAndroidFocusDirection3ESFkO8 != null ? numM6456toAndroidFocusDirection3ESFkO8.intValue() : 130;
    ...
    public void onGlobalFocusChanged(View oldFocus, View newFocus) {
        ...
        if (z) {
            ...
            if (getFocusTargetOfEmbeddedViewWrapper().getFocusState().isFocused()) {
                focusOwner.mo6460clearFocusI7lrPNg(false, true, false, FocusDirection.INSTANCE.m6450getExitdhqQ8s());
                return;
            }
            return;
        }
