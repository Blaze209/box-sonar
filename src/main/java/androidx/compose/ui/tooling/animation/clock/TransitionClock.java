...
public final class TransitionClock<T> implements ComposeAnimationClock<TransitionBasedAnimation<T>, TargetState<T>> {
    ...
    private TargetState<T> state = new TargetState<>(getAnimation().m9600getAnimationObject().getCurrentState(), getAnimation().m9600getAnimationObject().getTargetState());
    ...
    public List<ComposeAnimatedProperty> getAnimatedProperties() {
        List<Transition<?>.TransitionAnimationState<?, ?>> listAllAnimations = Utils_androidKt.allAnimations(getAnimation().m9600getAnimationObject());
    ...
    public long getMaxDurationPerIteration() {
        return Utils_androidKt.nanosToMillis(getAnimation().m9600getAnimationObject().getTotalDurationNanos());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        ...
        getAnimation().m9600getAnimationObject().seek(getState().getInitial(), getState().getTarget(), animationTimeNanos);
    }
}
