...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    private final Set<AnimatedVisibilityState> states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m9617boximpl(AnimatedVisibilityState.INSTANCE.m9624getEnterjXw82LU()), AnimatedVisibilityState.m9617boximpl(AnimatedVisibilityState.INSTANCE.m9625getExitjXw82LU())});
    ...
    public Transition<Boolean> m9601getAnimationObject() {
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m9601getAnimationObject().getTransitions(), 0);
