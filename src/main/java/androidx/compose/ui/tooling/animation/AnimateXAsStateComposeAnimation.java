...
public final class AnimateXAsStateComposeAnimation<T, V extends AnimationVector> implements ComposeAnimation {
    ...
    private AnimateXAsStateComposeAnimation(ToolingState<T> toolingState, AnimationSpec<T> animationSpec, Animatable<T, V> animatable) {
        ...
        T value = m9599getAnimationObject().getValue();
        ...
        this.label = m9599getAnimationObject().getLabel();
    }
    ...
    public Animatable<T, V> m9599getAnimationObject() {
    ...
    static {
        ...
        for (ComposeAnimationType composeAnimationType : ComposeAnimationType.values()) {
            if (Intrinsics.areEqual(composeAnimationType.name(), "ANIMATE_X_AS_STATE")) {
                z = true;
                break;
            }
        }
