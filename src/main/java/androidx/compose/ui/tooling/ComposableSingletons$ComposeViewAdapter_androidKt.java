...
public final class ComposableSingletons$ComposeViewAdapter_androidKt {
    ...
    public final Function2<Composer, Integer, Unit> m9588getLambda$1163195098$ui_tooling() {
    ...
    public static final Unit lambda__1163195098$lambda$0(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C:ComposeViewAdapter.android.kt#hevd2p");
        if (composer.shouldExecute((i & 3) != 2, i & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1163195098, i, -1, "androidx.compose.ui.tooling.ComposableSingletons$ComposeViewAdapter_androidKt.lambda$-1163195098.<anonymous> (ComposeViewAdapter.android.kt:81)");
            }
            if (ComposerKt.isTraceInProgress()) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit lambda_2086912010$lambda$0(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C:ComposeViewAdapter.android.kt#hevd2p");
        if (composer.shouldExecute((i & 3) != 2, i & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(2086912010, i, -1, "androidx.compose.ui.tooling.ComposableSingletons$ComposeViewAdapter_androidKt.lambda$2086912010.<anonymous> (ComposeViewAdapter.android.kt:162)");
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
