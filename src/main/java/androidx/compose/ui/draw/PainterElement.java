...
final /* data */ class PainterElement extends ModifierNodeElement<PainterNode> {
    ...
    public void update(PainterNode node) {
        ...
        boolean z2 = sizeToIntrinsics != z || (z && !Size.m6634equalsimpl0(node.getPainter().getIntrinsicSize(), this.painter.getIntrinsicSize()));
