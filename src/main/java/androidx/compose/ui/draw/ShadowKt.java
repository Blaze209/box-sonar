...
public final class ShadowKt {
    ...
    public static /* synthetic */ Modifier m6414shadowziNgDLE$default(Modifier modifier, float f, Shape shape, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
        ...
        return m6413shadowziNgDLE(modifier, f, shape, z);
    }
    ...
    public static final /* synthetic */ Modifier m6413shadowziNgDLE(Modifier modifier, float f, Shape shape, boolean z) {
        return m6411shadows4CzXII(modifier, f, shape, z, GraphicsLayerScopeKt.getDefaultShadowColor(), GraphicsLayerScopeKt.getDefaultShadowColor());
    }

    /* JADX INFO: renamed from: shadow-s4CzXII$default, reason: not valid java name */
    public static /* synthetic */ Modifier m6412shadows4CzXII$default(Modifier modifier, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        boolean z2;
        ...
        return m6411shadows4CzXII(modifier, f, rectangleShape, z2, (i & 8) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j, (i & 16) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j2);
    }
    ...
    public static final void resetShadow(ShadowScope shadowScope) {
        ...
        shadowScope.mo6333setOffsetk4lQ0M(Offset.INSTANCE.m6585getZeroF1C5BW0());
        shadowScope.mo6332setColor8_81llA(Color.INSTANCE.m6840getBlack0d7_KjU());
        shadowScope.setBrush(null);
        shadowScope.setAlpha(1.0f);
        shadowScope.mo6331setBlendModes9anfk8(BlendMode.INSTANCE.m6754getSrcOver0nO6VwU());
    }

    /* JADX INFO: renamed from: shadow-s4CzXII, reason: not valid java name */
    public static final Modifier m6411shadows4CzXII(Modifier modifier, float f, Shape shape, boolean z, long j, long j2) {
        return (Dp.m9686compareTo0680j_4(f, Dp.m9687constructorimpl((float) 0)) > 0 || z) ? modifier.then(new ShadowGraphicsLayerElement(f, shape, z, j, j2, null)) : modifier;
    }
}
