...
public final class CacheDrawScope implements Density {
    ...
    public final long m6349getSizeNHjbRc() {
        return this.cacheParams.mo6347getSizeNHjbRc();
    }
    ...
    public static /* synthetic */ void m6348recordTdoYBX4$default(CacheDrawScope cacheDrawScope, GraphicsLayer graphicsLayer, Density density, LayoutDirection layoutDirection, long j, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        if ((i & 4) != 0) {
            j = IntSizeKt.m9869toIntSizeuvyYCjk(cacheDrawScope.m6349getSizeNHjbRc());
        }
        cacheDrawScope.m6350recordTdoYBX4(graphicsLayer, density2, layoutDirection2, j, function1);
    }

    /* JADX INFO: renamed from: record-TdoYBX4, reason: not valid java name */
    public final void m6350recordTdoYBX4(GraphicsLayer graphicsLayer, final Density density, final LayoutDirection layoutDirection, long j, final Function1<? super ContentDrawScope, Unit> function1) {
        ...
        contentDrawScope.mo7396recordJVtK1S4(graphicsLayer, j, new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.draw.CacheDrawScope$record$1$1
