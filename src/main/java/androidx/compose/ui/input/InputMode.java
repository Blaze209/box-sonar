...
public final class InputMode {
    ...
    private static final int Touch = m7625constructorimpl(1);
    private static final int Keyboard = m7625constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InputMode m7624boximpl(int i) {
        return new InputMode(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m7625constructorimpl(int i) {
        return i;
    }
    ...
    public static String m7629toStringimpl(int i) {
        if (m7627equalsimpl0(i, Touch)) {
            return "Touch";
        }
        return m7627equalsimpl0(i, Keyboard) ? "Keyboard" : "Error";
    }
    ...
    public static final class Companion {
        ...
        public final int m7632getTouchaOaMEAU() {
            return InputMode.Touch;
        }

        /* JADX INFO: renamed from: getKeyboard-aOaMEAU, reason: not valid java name */
        public final int m7631getKeyboardaOaMEAU() {
