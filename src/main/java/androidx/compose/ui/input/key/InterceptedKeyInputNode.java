...
final class InterceptedKeyInputNode extends Modifier.Node implements SoftKeyboardInterceptionModifierNode {
    ...
    public boolean mo7664onInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event) {
    ...
    public boolean mo7665onPreInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event) {
