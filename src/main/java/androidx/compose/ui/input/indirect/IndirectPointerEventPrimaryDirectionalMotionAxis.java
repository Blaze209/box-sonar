...
public final class IndirectPointerEventPrimaryDirectionalMotionAxis {
    ...
    private static final int None = m7641constructorimpl(0);
    private static final int X = m7641constructorimpl(1);
    private static final int Y = m7641constructorimpl(2);
    private final int value;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ IndirectPointerEventPrimaryDirectionalMotionAxis m7640boximpl(int i) {
        return new IndirectPointerEventPrimaryDirectionalMotionAxis(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m7641constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m7642equalsimpl(int i, Object obj) {
    ...
    public static final boolean m7643equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m7644hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m7645toStringimpl(int i) {
        return "IndirectPointerEventPrimaryDirectionalMotionAxis(value=" + i + ')';
    }

    public boolean equals(Object other) {
        return m7642equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m7644hashCodeimpl(this.value);
    }

    public String toString() {
        return m7645toStringimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m7647getNonenZO2Niw() {
