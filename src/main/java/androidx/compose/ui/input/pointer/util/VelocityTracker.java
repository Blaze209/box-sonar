...
public final class VelocityTracker {
    ...
    public final void m8238addPositionUv8p0NA(long timeMillis, long position) {
        this.platformVelocityTracker.mo8229addPositionUv8p0NA(timeMillis, position);
    }

    /* JADX INFO: renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m8239calculateVelocity9UxMQ8M() {
        return m8240calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* JADX INFO: renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m8240calculateVelocityAH228Gc(long maximumVelocity) {
        return this.platformVelocityTracker.mo8230calculateVelocityAH228Gc(maximumVelocity);
    }
