...
public final class StylusHoverIconModifierNode extends HoverIconModifierNode {
    ...
    public boolean mo8048isRelevantPointerTypeuerMTgs(int pointerType) {
        return PointerType.m8205equalsimpl0(pointerType, PointerType.INSTANCE.m8211getStylusT8wyACA()) || PointerType.m8205equalsimpl0(pointerType, PointerType.INSTANCE.m8209getEraserT8wyACA());
    }
