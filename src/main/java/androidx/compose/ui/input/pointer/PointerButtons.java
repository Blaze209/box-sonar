...
public final class PointerButtons {
    ...
    public static final /* synthetic */ PointerButtons m8066boximpl(int i) {
    ...
    public boolean equals(Object other) {
        return m8068equalsimpl(this.packedValue, other);
    }

    public int hashCode() {
        return m8070hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m8071toStringimpl(this.packedValue);
    }
