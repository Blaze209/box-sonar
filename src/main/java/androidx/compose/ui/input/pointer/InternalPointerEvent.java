...
public final class InternalPointerEvent {
    ...
    public final boolean m8049activeHoverEvent0FcD4WY(long pointerId) {
        ...
        while (true) {
            ...
            if (PointerId.m8116equalsimpl0(pointerInputEventData.m8148getIdJ3iCeTQ(), pointerId)) {
                break;
            }
            i++;
        }
