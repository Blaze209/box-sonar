...
public final class PointerInputEventProcessor {
    ...
    public static /* synthetic */ int m8154processBIzXfog$default(PointerInputEventProcessor pointerInputEventProcessor, PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        return pointerInputEventProcessor.m8155processBIzXfog(pointerInputEvent, positionCalculator, z);
    }

    /* JADX INFO: renamed from: process-BIzXfog, reason: not valid java name */
    public final int m8155processBIzXfog(PointerInputEvent pointerEvent, PositionCalculator positionCalculator, boolean isInBounds) {
        int i;
        boolean z;
        boolean z2;
        ...
        try {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (z || PointerEventKt.changedToDownIgnoreConsumed(pointerInputChangeValueAt2)) {
                    LayoutNode.m8487hitTest6fMxITs$ui$default(this.root, pointerInputChangeValueAt2.getPosition(), this.hitResult, pointerInputChangeValueAt2.getType(), false, 8, null);
                    if (!this.hitResult.isEmpty()) {
                        this.hitPathTracker.m8047addHitPathQJqDSyo(pointerInputChangeValueAt2.getId(), this.hitResult, PointerEventKt.changedToDownIgnoreConsumed(pointerInputChangeValueAt2));
