...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    public void mo8157onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        boolean z;
        boolean z2;
        boolean z3;
    ...
    private final void dispatchToView(PointerEvent pointerEvent, boolean shouldConsume) {
        ...
        if (layoutCoordinates$ui != null) {
            long jMo8276localToRootMKHz9U = layoutCoordinates$ui.mo8276localToRootMKHz9U(Offset.INSTANCE.m6585getZeroF1C5BW0());
            final PointerInteropFilter pointerInteropFilter = this.this$0;
            PointerInteropUtils_androidKt.m8193toMotionEventScoped4ec7I(pointerEvent, jMo8276localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
    ...
    private final void stopDispatching(PointerEvent pointerEvent) {
        if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
            ...
            if (layoutCoordinates$ui != null) {
                long jMo8276localToRootMKHz9U = layoutCoordinates$ui.mo8276localToRootMKHz9U(Offset.INSTANCE.m6585getZeroF1C5BW0());
                final PointerInteropFilter pointerInteropFilter = this.this$0;
                PointerInteropUtils_androidKt.m8192toCancelMotionEventScoped4ec7I(pointerEvent, jMo8276localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$stopDispatching$1
                    {
                        super(1);
                    }
