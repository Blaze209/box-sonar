...
public final class VelocityTrackerKt {
    ...
    public static final void addPointerInputChange(VelocityTracker velocityTracker, PointerInputChange pointerInputChange) {
        m8241addPointerInputChange0AR0LA0(velocityTracker, pointerInputChange, Offset.INSTANCE.m6585getZeroF1C5BW0());
    }

    /* JADX INFO: renamed from: addPointerInputChange-0AR0LA0, reason: not valid java name */
    public static final void m8241addPointerInputChange0AR0LA0(VelocityTracker velocityTracker, PointerInputChange pointerInputChange, long j) {
        velocityTracker.getPlatformVelocityTracker().mo8228addPointerInputChangeUv8p0NA(pointerInputChange, j);
    }
