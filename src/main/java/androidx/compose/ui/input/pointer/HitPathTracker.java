...
public final class HitPathTracker {
    ...
    public static /* synthetic */ void m8046addHitPathQJqDSyo$default(HitPathTracker hitPathTracker, long j, List list, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = false;
        }
        hitPathTracker.m8047addHitPathQJqDSyo(j, list, z);
    }

    /* JADX WARN: Code duplicated, block: B:49:0x00fb A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:50:0x00fd A[LOOP:2: B:40:0x00c4->B:50:0x00fd, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:59:0x0100 A[EDGE_INSN: B:59:0x0100->B:51:0x0100 BREAK  A[LOOP:2: B:40:0x00c4->B:50:0x00fd], SYNTHETIC] */
    /* JADX INFO: renamed from: addHitPath-QJqDSyo, reason: not valid java name */
    public final void m8047addHitPathQJqDSyo(long pointerId, List<? extends Modifier.Node> pointerInputNodes, boolean prunePointerIdsAndChangesNotInNodesList) {
        Node node;
