...
public abstract class HoverIconModifierNode extends Modifier.Node implements TraversableNode, PointerInputModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public abstract boolean mo8048isRelevantPointerTypeuerMTgs(int pointerType);
    ...
    public void mo556onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            ...
            for (int i = 0; i < size; i++) {
                if (mo8048isRelevantPointerTypeuerMTgs(changes.get(i).getType())) {
                    if (PointerEventType.m8083equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m8087getEnter7fucELk())) {
                        onEnter();
                        return;
                    } else {
                        if (PointerEventType.m8083equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m8088getExit7fucELk())) {
                            onExit();
                            return;
                        }
                        return;
    ...
    public long mo1811getTouchBoundsExpansionRZrCHBk() {
        DpTouchBoundsExpansion dpTouchBoundsExpansion = this.dpTouchBoundsExpansion;
        return dpTouchBoundsExpansion != null ? dpTouchBoundsExpansion.m8474roundToTouchBoundsExpansionTW6G1oQ(DelegatableNodeKt.requireDensity(this)) : TouchBoundsExpansion.INSTANCE.m8686getNoneRZrCHBk();
    }
