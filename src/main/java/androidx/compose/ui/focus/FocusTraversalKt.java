...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m6493customFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6449getEnterdhqQ8s()) || FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6450getExitdhqQ8s())) {
    ...
    public static final Boolean m6494focusSearch0X8WOeE(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int iM6454getRightdhqQ8s;
        if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6452getNextdhqQ8s()) || FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6453getPreviousdhqQ8s())) {
            return Boolean.valueOf(OneDimensionalFocusSearchKt.m6508oneDimensionalFocusSearchOMvw8(focusTargetNode, i, function1));
        }
        if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6451getLeftdhqQ8s()) || FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6454getRightdhqQ8s()) || FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6455getUpdhqQ8s()) || FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6448getDowndhqQ8s())) {
            return TwoDimensionalFocusSearchKt.m6519twoDimensionalFocusSearchsMXa3k8(focusTargetNode, i, rect, function1);
        }
        if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6449getEnterdhqQ8s())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                iM6454getRightdhqQ8s = FocusDirection.INSTANCE.m6454getRightdhqQ8s();
            } else {
                if (i2 != 2) {
                    throw new NoWhenBranchMatchedException();
                }
                iM6454getRightdhqQ8s = FocusDirection.INSTANCE.m6451getLeftdhqQ8s();
            }
            FocusTargetNode focusTargetNodeFindActiveFocusNode = findActiveFocusNode(focusTargetNode);
            if (focusTargetNodeFindActiveFocusNode != null) {
                return TwoDimensionalFocusSearchKt.m6519twoDimensionalFocusSearchsMXa3k8(focusTargetNodeFindActiveFocusNode, iM6454getRightdhqQ8s, rect, function1);
            }
            return null;
        }
        if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6450getExitdhqQ8s())) {
        ...
        throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m6446toStringimpl(i))).toString());
    }
