...
public final class BeyondBoundsLayoutKt {
    ...
    public static final <T> T m6439searchBeyondBoundsOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> function1) {
        Modifier.Node nodePop;
        BeyondBoundsLayout beyondBoundsLayoutParent;
        int iM8254getBeforehoxUOeE;
        NodeChain nodes;
        ...
        if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6455getUpdhqQ8s())) {
            iM8254getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m8252getAbovehoxUOeE();
        } else if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6448getDowndhqQ8s())) {
            iM8254getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m8255getBelowhoxUOeE();
        } else if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6451getLeftdhqQ8s())) {
            iM8254getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m8256getLefthoxUOeE();
        } else if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6454getRightdhqQ8s())) {
            iM8254getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m8257getRighthoxUOeE();
        } else if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6452getNextdhqQ8s())) {
            iM8254getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m8253getAfterhoxUOeE();
        } else {
            if (!FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6453getPreviousdhqQ8s())) {
                throw new IllegalStateException("Unsupported direction for beyond bounds layout".toString());
            }
            iM8254getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m8254getBeforehoxUOeE();
        }
        return (T) beyondBoundsLayoutParent.mo1398layouto7g1Pn8(iM8254getBeforehoxUOeE, function1);
    }
}
