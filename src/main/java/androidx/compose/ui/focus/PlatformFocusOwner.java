...
public interface PlatformFocusOwner {
    ...
    boolean mo6510moveFocusInChildren3ESFkO8(int focusDirection);

    /* JADX INFO: renamed from: requestOwnerFocus-7o62pno, reason: not valid java name */
    boolean mo6511requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect);
}
