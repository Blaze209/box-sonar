...
public final class OneDimensionalFocusSearchKt {
    ...
    public static final boolean m6508oneDimensionalFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6453getPreviousdhqQ8s())) {
    ...
    private static final boolean forwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i == 1) {
            ...
            if (activeChild != null) {
                return forwardFocusSearch(activeChild, function1) || m6507generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m6452getNextdhqQ8s(), function1);
            }
    ...
    private static final boolean backwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i2 == 1) {
            return backwardFocusSearch(activeChild, function1) || m6507generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m6453getPreviousdhqQ8s(), function1) || (activeChild.fetchFocusProperties$ui().getCanFocus() && function1.invoke(activeChild).booleanValue());
        }
        if (i2 == 2 || i2 == 3) {
            return m6507generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m6453getPreviousdhqQ8s(), function1);
        }
        if (i2 != 4) {
            throw new NoWhenBranchMatchedException();
        }
    ...
    private static final boolean m6507generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final FocusTargetNode focusTargetNode2, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m6509searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1)) {
            return true;
        }
        ...
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m6439searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.OneDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                if (activeFocusTargetNode == DelegatableNodeKt.requireOwner(focusTargetNode).getFocusOwner().getActiveFocusTargetNode()) {
                    Boolean boolValueOf = Boolean.valueOf(OneDimensionalFocusSearchKt.m6509searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1));
    ...
    public static final boolean m6509searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6452getNextdhqQ8s()) || !focusTargetNode.fetchFocusProperties$ui().getCanFocus() || isRoot(focusTargetNode)) {
            return false;
        }
        return function1.invoke(focusTargetNode).booleanValue();
    }
