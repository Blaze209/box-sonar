...
public final class FocusRequesterModifierNodeKt {
        ...
        while (node != null) {
            if (node instanceof FocusTargetNode) {
                ...
                if (ComposeUiFlags.isRequestFocusOnNonFocusableFocusTargetEnabled) {
                    return FocusTargetModifierNode.m6476requestFocus3ESFkO8$default(focusTargetNode, 0, 1, null);
                }
                return focusTargetNode.fetchFocusProperties$ui().getCanFocus() ? FocusTargetModifierNode.m6476requestFocus3ESFkO8$default(focusTargetNode, 0, 1, null) : TwoDimensionalFocusSearchKt.m6515findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, FocusDirection.INSTANCE.m6449getEnterdhqQ8s(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusRequesterModifierNodeKt$requestFocus$1$1
                    @Override // kotlin.jvm.functions.Function1
                    public final Boolean invoke(FocusTargetNode focusTargetNode2) {
                        return Boolean.valueOf(FocusTargetModifierNode.m6476requestFocus3ESFkO8$default(focusTargetNode2, 0, 1, null));
                    }
                });
            }
            if ((node.getKindSet() & iM8585constructorimpl) != 0 && (node instanceof DelegatingNode)) {
                int i = 0;
                    ...
                    if ((nodePop.getKindSet() & iM8585constructorimpl) != 0) {
                        ...
                        while (nodePop != null) {
                            if (nodePop instanceof FocusTargetNode) {
                                ...
                                if (ComposeUiFlags.isRequestFocusOnNonFocusableFocusTargetEnabled) {
                                    return FocusTargetModifierNode.m6476requestFocus3ESFkO8$default(focusTargetNode2, 0, 1, null);
                                }
                                return focusTargetNode2.fetchFocusProperties$ui().getCanFocus() ? FocusTargetModifierNode.m6476requestFocus3ESFkO8$default(focusTargetNode2, 0, 1, null) : TwoDimensionalFocusSearchKt.m6515findChildCorrespondingToFocusEnterOMvw8(focusTargetNode2, FocusDirection.INSTANCE.m6449getEnterdhqQ8s(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusRequesterModifierNodeKt$requestFocus$1$1
                                    @Override // kotlin.jvm.functions.Function1
                                    public final Boolean invoke(FocusTargetNode focusTargetNode3) {
                                        return Boolean.valueOf(FocusTargetModifierNode.m6476requestFocus3ESFkO8$default(focusTargetNode3, 0, 1, null));
                                    }
                                });
                            }
                            if ((nodePop.getKindSet() & iM8585constructorimpl) != 0 && (nodePop instanceof DelegatingNode)) {
                                ...
                                for (Modifier.Node delegate2 = ((DelegatingNode) nodePop).getDelegate(); delegate2 != null; delegate2 = delegate2.getChild()) {
                                    if ((delegate2.getKindSet() & iM8585constructorimpl) != 0) {
                                        i2++;
                                        if (i2 == 1) {
                                            nodePop = delegate2;
                                        } else {
    ...
    public static final boolean captureFocus(FocusRequesterModifierNode focusRequesterModifierNode) {
        ...
        while (node != null) {
            ...
            } else if ((node.getKindSet() & iM8585constructorimpl) != 0 && (node instanceof DelegatingNode)) {
                int i = 0;
                for (Modifier.Node delegate = ((DelegatingNode) node).getDelegate(); delegate != null; delegate = delegate.getChild()) {
                    if ((delegate.getKindSet() & iM8585constructorimpl) != 0) {
                        i++;
