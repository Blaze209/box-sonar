...
public final class Focusability {
    ...
    private static final int Always = m6497constructorimpl(1);
    private static final int SystemDefined = m6497constructorimpl(0);
    private static final int Never = m6497constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Focusability m6495boximpl(int i) {
        return new Focusability(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m6497constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m6498equalsimpl(int i, Object obj) {
        return (obj instanceof Focusability) && i == ((Focusability) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6499equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m6500hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object other) {
        return m6498equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m6500hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m6501toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m6501toStringimpl(int i) {
        if (m6499equalsimpl0(i, Always)) {
            return "Always";
        }
        if (m6499equalsimpl0(i, SystemDefined)) {
            return "SystemDefined";
        }
        if (m6499equalsimpl0(i, Never)) {
            return "Never";
        }
    ...
    public static final boolean m6496canFocusimpl$ui(int i, CompositionLocalConsumerModifierNode compositionLocalConsumerModifierNode) {
        if (m6499equalsimpl0(i, Always)) {
            return true;
        }
        if (m6499equalsimpl0(i, SystemDefined)) {
            return !InputMode.m7627equalsimpl0(((InputModeManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(compositionLocalConsumerModifierNode, CompositionLocalsKt.getLocalInputModeManager())).mo7633getInputModeaOaMEAU(), InputMode.INSTANCE.m7632getTouchaOaMEAU());
        }
        if (m6499equalsimpl0(i, Never)) {
            return false;
        }
