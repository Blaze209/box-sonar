...
public final class FocusTargetNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, LayoutAwareModifierNode, FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public /* synthetic */ FocusTargetNode(int i, boolean z, Function2 function2, Function1 function1, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? Focusability.INSTANCE.m6503getAlwaysLCbbffg() : i, (i2 & 2) != 0 ? false : z, (i2 & 4) != 0 ? null : function2, (i2 & 8) != 0 ? null : function1, null);
    }
    ...
    public /* synthetic */ boolean requestFocus() {
        return mo6478requestFocus3ESFkO8(FocusDirection.INSTANCE.m6449getEnterdhqQ8s());
    }

    @Override // androidx.compose.ui.focus.FocusTargetModifierNode
    /* JADX INFO: renamed from: requestFocus-3ESFkO8 */
    public boolean mo6478requestFocus3ESFkO8(final int focusDirection) {
        boolean zM6515findChildCorrespondingToFocusEnterOMvw8;
        Trace.beginSection("FocusTransactions:requestFocus");
        try {
            if (ComposeUiFlags.isRequestFocusOnNonFocusableFocusTargetEnabled) {
                if (fetchFocusProperties$ui().getCanFocus()) {
                    zM6515findChildCorrespondingToFocusEnterOMvw8 = m6483assignFocus3ESFkO8(focusDirection);
                } else {
                    zM6515findChildCorrespondingToFocusEnterOMvw8 = TwoDimensionalFocusSearchKt.m6515findChildCorrespondingToFocusEnterOMvw8(this, focusDirection, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusTargetNode$requestFocus$1$1
                        ...
                        public final Boolean invoke(FocusTargetNode focusTargetNode) {
                            return Boolean.valueOf(focusTargetNode.m6483assignFocus3ESFkO8(focusDirection));
                        }
                    });
                }
            } else {
                zM6515findChildCorrespondingToFocusEnterOMvw8 = fetchFocusProperties$ui().getCanFocus() && m6483assignFocus3ESFkO8(focusDirection);
            }
            return zM6515findChildCorrespondingToFocusEnterOMvw8;
        } finally {
            Trace.endSection();
        }
    }
    ...
    public final boolean m6483assignFocus3ESFkO8(int focusDirection) {
        int i = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m6490performCustomRequestFocusMxy_nc0(this, focusDirection).ordinal()];
        if (i == 1) {
    ...
    public void mo6479setFocusabilityjosRg5g(int i) {
        if (Focusability.m6499equalsimpl0(this.focusability, i)) {
            return;
        }
        this.focusability = i;
        if (getIsAttached()) {
            FocusTargetNode focusTargetNode = this;
            if (this != DelegatableNodeKt.requireOwner(focusTargetNode).getFocusOwner().getActiveFocusTargetNode() || Focusability.m6496canFocusimpl$ui(this.focusability, this)) {
                return;
            }
    ...
    public void onReset() {
        if (getFocusState().isFocused()) {
            DelegatableNodeKt.requireOwner(this).getFocusOwner().mo6460clearFocusI7lrPNg(true, true, true, FocusDirection.INSTANCE.m6450getExitdhqQ8s());
        }
    }
    ...
    public void onDetach() {
        ...
        if (i == 1 || i == 2) {
            ...
            focusOwner.mo6460clearFocusI7lrPNg(true, true, false, FocusDirection.INSTANCE.m6450getExitdhqQ8s());
            if (this.isInteropViewHost) {
                focusOwner.mo6465requestOwnerFocus7o62pno(null, null);
            }
            ...
            if (focusTargetNodeFindActiveFocusNode != null && focusTargetNodeFindActiveFocusNode.isInteropViewHost) {
                focusOwner2.mo6465requestOwnerFocus7o62pno(null, null);
    ...
    public final FocusProperties fetchFocusProperties$ui() {
        ...
        focusPropertiesImpl.setCanFocus(Focusability.m6496canFocusimpl$ui(getFocusability(), this));
        FocusTargetNode focusTargetNode = this;
        int iM8585constructorimpl = NodeKind.m8585constructorimpl(2048);
        int iM8585constructorimpl2 = NodeKind.m8585constructorimpl(1024);
        Modifier.Node node = focusTargetNode.getNode();
        int i = iM8585constructorimpl | iM8585constructorimpl2;
        if (!focusTargetNode.getNode().getIsAttached()) {
            InlineClassHelperKt.throwIllegalStateException("visitAncestors called on an unattached node");
        }
            ...
            if ((layoutNodeRequireLayoutNode.getNodes().getHead().getAggregateChildKindSet() & i) != 0) {
                while (node2 != null) {
                    if ((node2.getKindSet() & i) != 0) {
                        if (node2 != node && (node2.getKindSet() & iM8585constructorimpl2) != 0) {
                            break loop0;
                        }
                        if ((node2.getKindSet() & iM8585constructorimpl) != 0) {
    ...
    public final Rect fetchFocusRect$ui(LayoutCoordinates relativeCoordinates) {
        ...
        if (focusRect != FocusProperties.INSTANCE.getUnsetFocusRect()) {
            return relativeCoordinates == null ? focusRect : focusRect.m6606translatek4lQ0M(LayoutCoordinates.m8272localPositionOfS_NoaFU$default(relativeCoordinates, DelegatableNodeKt.requireLayoutCoordinates(this), 0L, false, 6, null));
        }
        return (relativeCoordinates == null || (rectLocalBoundingBoxOf = relativeCoordinates.localBoundingBoxOf(DelegatableNodeKt.requireLayoutCoordinates(this), false)) == null) ? RectKt.m6609Recttz77jQw(Offset.INSTANCE.m6585getZeroF1C5BW0(), IntSizeKt.m9870toSizeozmzZPI(DelegatableNodeKt.requireLayoutCoordinates(this).mo8273getSizeYbymL2g())) : rectLocalBoundingBoxOf;
    }

    /* JADX INFO: renamed from: fetchCustomEnterOrExit-ULY8qGw, reason: not valid java name */
    private final void m6484fetchCustomEnterOrExitULY8qGw(int focusDirection, Function1<? super FocusRequester, Unit> block, Function2<? super FocusProperties, ? super FocusEnterExitScope, Unit> enterOrExit) {
    ...
    public final void m6485fetchCustomEnteraToIllA$ui(int focusDirection, Function1<? super FocusRequester, Unit> block) {
    ...
    public final void m6486fetchCustomExitaToIllA$ui(int focusDirection, Function1<? super FocusRequester, Unit> block) {
    ...
    public final void dispatchFocusCallbacks$ui(FocusState previousState, FocusState newState) {
        ...
        int iM8585constructorimpl = NodeKind.m8585constructorimpl(4096);
        int iM8585constructorimpl2 = NodeKind.m8585constructorimpl(1024);
        Modifier.Node node = focusTargetNode.getNode();
        int i = iM8585constructorimpl | iM8585constructorimpl2;
        if (!focusTargetNode.getNode().getIsAttached()) {
