...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m6519twoDimensionalFocusSearchsMXa3k8(FocusTargetNode focusTargetNode, int i, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int i2 = WhenMappings.$EnumSwitchMapping$0[focusTargetNode.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m6515findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, i, function1));
            }
            if (i2 != 4) {
            ...
            return Boolean.valueOf(m6518searchChildren4C6V_qg(focusTargetNode, rect, i, function1));
        }
        ...
        if (i3 == 1) {
            Boolean boolM6519twoDimensionalFocusSearchsMXa3k8 = m6519twoDimensionalFocusSearchsMXa3k8(activeChild, i, rect, function1);
            if (!Intrinsics.areEqual((Object) boolM6519twoDimensionalFocusSearchsMXa3k8, (Object) false)) {
                return boolM6519twoDimensionalFocusSearchsMXa3k8;
            }
            if (rect == null) {
                rect = FocusTraversalKt.focusRect(activeNode(activeChild));
            }
            return Boolean.valueOf(m6516generateAndSearchChildren4C6V_qg(focusTargetNode, rect, i, function1));
        }
        if (i3 == 2 || i3 == 3) {
            if (rect == null) {
    ...
    private static final boolean m6516generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final Rect rect, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m6518searchChildren4C6V_qg(focusTargetNode, rect, i, function1)) {
            return true;
        }
        ...
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m6439searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                if (activeFocusTargetNode == DelegatableNodeKt.requireOwner(focusTargetNode).getFocusOwner().getActiveFocusTargetNode()) {
                    Boolean boolValueOf = Boolean.valueOf(TwoDimensionalFocusSearchKt.m6518searchChildren4C6V_qg(focusTargetNode, rect, i, function1));
    ...
    private static final FocusTargetNode m6514findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect rect, int i) {
        Rect rectTranslate;
        ...
        } else if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6454getRightdhqQ8s())) {
            rectTranslate = rect.translate(-((rect.getRight() - rect.getLeft()) + 1), 0.0f);
        } else if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6455getUpdhqQ8s())) {
            rectTranslate = rect.translate(0.0f, (rect.getBottom() - rect.getTop()) + 1);
        } else if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6448getDowndhqQ8s())) {
            rectTranslate = rect.translate(0.0f, -((rect.getBottom() - rect.getTop()) + 1));
        } else {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                ...
                if (m6517isBetterCandidateI7lrPNg(rectFocusRect, rectTranslate, rect, i)) {
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float bottom;
        float top2;
        if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6451getLeftdhqQ8s()) || FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6454getRightdhqQ8s())) {
            ...
            top2 = rect.getTop();
        } else if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6455getUpdhqQ8s()) || FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6448getDowndhqQ8s())) {
    ...
    public static final boolean m6517isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (!isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return false;
        }
        if (isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) && !m6513beamBeatsI7lrPNg(rect3, rect, rect2, i)) {
            return !m6513beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2);
        }
        return true;
    }
    ...
    private static final boolean beamBeats_I7lrPNg$inSourceBeam(Rect rect, int i, Rect rect2) {
        ...
        if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6455getUpdhqQ8s()) || FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6448getDowndhqQ8s())) {
    ...
    public static final boolean m6515findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6449getEnterdhqQ8s())) {
            i = FocusDirection.INSTANCE.m6454getRightdhqQ8s();
        }
        if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6454getRightdhqQ8s()) || FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6448getDowndhqQ8s())) {
            rectBottomRight = topLeft(FocusTraversalKt.focusRect(focusTargetNode));
        } else if (FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6451getLeftdhqQ8s()) || FocusDirection.m6444equalsimpl0(i, FocusDirection.INSTANCE.m6455getUpdhqQ8s())) {
            rectBottomRight = bottomRight(FocusTraversalKt.focusRect(focusTargetNode));
        } else {
            throw new IllegalStateException(InvalidFocusDirection.toString());
        }
        FocusTargetNode focusTargetNodeM6514findBestCandidate4WY_MpI = m6514findBestCandidate4WY_MpI(mutableVector, rectBottomRight, i);
        if (focusTargetNodeM6514findBestCandidate4WY_MpI != null) {
            return function1.invoke(focusTargetNodeM6514findBestCandidate4WY_MpI).booleanValue();
        }
        return false;
    }
    ...
    public static final boolean m6518searchChildren4C6V_qg(FocusTargetNode focusTargetNode, Rect rect, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        FocusTargetNode focusTargetNodeM6514findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        ...
        while (mutableVector.getSize() != 0 && (focusTargetNodeM6514findBestCandidate4WY_MpI = m6514findBestCandidate4WY_MpI(mutableVector, rect, i)) != null) {
            if (focusTargetNodeM6514findBestCandidate4WY_MpI.fetchFocusProperties$ui().getCanFocus()) {
                return function1.invoke(focusTargetNodeM6514findBestCandidate4WY_MpI).booleanValue();
            }
            if (m6516generateAndSearchChildren4C6V_qg(focusTargetNodeM6514findBestCandidate4WY_MpI, rect, i, function1)) {
                return true;
            }
            mutableVector.remove(focusTargetNodeM6514findBestCandidate4WY_MpI);
        }
        return false;
    }
