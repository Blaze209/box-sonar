...
public final class FocusRequester {
    ...
    public final /* synthetic */ void requestFocus() {
        m6475requestFocus3ESFkO8(FocusDirection.INSTANCE.m6449getEnterdhqQ8s());
    }

    /* JADX INFO: renamed from: requestFocus-3ESFkO8$default, reason: not valid java name */
    public static /* synthetic */ boolean m6474requestFocus3ESFkO8$default(FocusRequester focusRequester, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = FocusDirection.INSTANCE.m6449getEnterdhqQ8s();
        }
        return focusRequester.m6475requestFocus3ESFkO8(i);
    }

    /* JADX INFO: renamed from: requestFocus-3ESFkO8, reason: not valid java name */
    public final boolean m6475requestFocus3ESFkO8(final int focusDirection) {
                        ...
                        if ((nodePop.getKindSet() & iM8585constructorimpl) != 0) {
                            ...
                            while (nodePop != null) {
                                if (nodePop instanceof FocusTargetNode) {
                                    if (((FocusTargetNode) nodePop).mo6478requestFocus3ESFkO8(focusDirection)) {
                                        z = true;
                                        break;
                                    }
                            ...
                            while (nodePop != null) {
                                if (nodePop instanceof FocusTargetNode) {
                                    ...
                                    if (focusTargetNode.fetchFocusProperties$ui().getCanFocus()) {
                                        zM6515findChildCorrespondingToFocusEnterOMvw8 = onFound.invoke(focusTargetNode).booleanValue();
                                    } else {
                                        zM6515findChildCorrespondingToFocusEnterOMvw8 = TwoDimensionalFocusSearchKt.m6515findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, FocusDirection.INSTANCE.m6449getEnterdhqQ8s(), onFound);
                                    }
                                    if (zM6515findChildCorrespondingToFocusEnterOMvw8) {
                                        z = true;
                                        break;
                                    }
                                } else if ((nodePop.getKindSet() & iM8585constructorimpl) != 0 && (nodePop instanceof DelegatingNode)) {
