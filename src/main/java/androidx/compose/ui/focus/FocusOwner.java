...
public interface FocusOwner extends FocusManager {
    ...
    boolean mo6460clearFocusI7lrPNg(boolean force, boolean refreshFocusEvents, boolean clearOwnerFocus, int focusDirection);
    ...
    boolean mo6461dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent);

    /* JADX INFO: renamed from: dispatchKeyEvent-YhN2O0w, reason: not valid java name */
    boolean mo6462dispatchKeyEventYhN2O0w(KeyEvent keyEvent, Function0<Boolean> onFocusedItem);
    ...
    Boolean mo6463focusSearchULY8qGw(int focusDirection, Rect focusedRect, Function1<? super FocusTargetNode, Boolean> onFound);
    ...
    boolean mo6464moveFocusaToIllA(int focusDirection, boolean wrapAroundForOneDimensionalFocus);

    void releaseFocus();

    /* JADX INFO: renamed from: requestOwnerFocus-7o62pno, reason: not valid java name */
    boolean mo6465requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect);

    /* JADX INFO: renamed from: resetFocus-3ESFkO8, reason: not valid java name */
    boolean mo6466resetFocus3ESFkO8(int focusDirection);
    ...
    boolean mo6467takeFocusaToIllA(int focusDirection, Rect previouslyFocusedRect);

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: dispatchKeyEvent-YhN2O0w$default, reason: not valid java name */
    static /* synthetic */ boolean m6459dispatchKeyEventYhN2O0w$default(FocusOwner focusOwner, KeyEvent keyEvent, Function0 function0, int i, Object obj) {
        if (obj != null) {
        ...
        return focusOwner.mo6462dispatchKeyEventYhN2O0w(keyEvent, function0);
    }
