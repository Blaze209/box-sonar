...
final class AndroidContentDataType implements ContentDataType {
    ...
    public static final /* synthetic */ AndroidContentDataType m6311boximpl(int i) {
    ...
    public static boolean m6313equalsimpl(int i, Object obj) {
        return (obj instanceof AndroidContentDataType) && i == ((AndroidContentDataType) obj).m6317unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m6313equalsimpl(this.androidAutofillType, obj);
    }

    public int hashCode() {
        return m6315hashCodeimpl(this.androidAutofillType);
    }

    public String toString() {
        return m6316toStringimpl(this.androidAutofillType);
    }
