...
public final class LookaheadAlignmentLines extends AlignmentLines {
    ...
    protected long mo8419calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j) {
        LookaheadDelegate lookaheadDelegate = nodeCoordinator.getLookaheadDelegate();
        Intrinsics.checkNotNull(lookaheadDelegate);
        long position = lookaheadDelegate.getPosition();
        float fM9815getXimpl = IntOffset.m9815getXimpl(position);
        return Offset.m6574plusMKHz9U(Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(IntOffset.m9816getYimpl(position))) & 4294967295L) | (Float.floatToRawIntBits(fM9815getXimpl) << 32)), j);
    }
}
