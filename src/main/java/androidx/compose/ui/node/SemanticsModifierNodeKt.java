...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m8436requireCoordinator64DMado(node, NodeKind.m8585constructorimpl(8)));
        }
        return DelegatableNodeKt.m8436requireCoordinator64DMado(node, NodeKind.m8585constructorimpl(8)).touchBoundsInRoot();
    }
}
