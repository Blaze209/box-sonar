...
public abstract class AlignmentLines {
    ...
    protected abstract long mo8419calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        long jM6561constructorimpl = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(f)) << 32) | (((long) Float.floatToRawIntBits(f)) & 4294967295L));
        while (true) {
            jM6561constructorimpl = mo8419calculatePositionInParentR5De75A(initialCoordinator, jM6561constructorimpl);
            ...
            if (getAlignmentLinesMap(initialCoordinator).containsKey(alignmentLine)) {
                ...
                jM6561constructorimpl = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(positionFor)) << 32) | (((long) Float.floatToRawIntBits(positionFor)) & 4294967295L));
            }
        }
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            fIntBitsToFloat = Float.intBitsToFloat((int) (jM6561constructorimpl & 4294967295L));
        } else {
            fIntBitsToFloat = Float.intBitsToFloat((int) (jM6561constructorimpl >> 32));
        }
