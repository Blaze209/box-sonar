...
public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
    ...
    private long lastPosition = IntOffset.INSTANCE.m9826getZeronOccac();
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.MeasurePassDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            this.this$0.getOuterCoordinator().mo8265measureBRTryo0(this.this$0.performMeasureConstraints);
        }
    };
    ...
    private long placeOuterCoordinatorPosition = IntOffset.INSTANCE.m9826getZeronOccac();
    private final Function0<Unit> placeOuterCoordinatorBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.MeasurePassDelegate$placeOuterCoordinatorBlock$1
        ...
        public final void invoke2() {
            ...
            if (graphicsLayer != null) {
                placementScope2.m8346placeWithLayeraW9wM(measurePassDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, graphicsLayer, measurePassDelegate.placeOuterCoordinatorZIndex);
            } else if (function1 == null) {
                placementScope2.m8337place70tqf50(measurePassDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex);
            } else {
                placementScope2.m8345placeWithLayeraW9wM(measurePassDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex, function1);
            }
        }
    };
    ...
    public final Constraints m8538getLastConstraintsDWUhwKw() {
        if (this.measuredOnce) {
            return Constraints.m9627boximpl(getMeasurementConstraints());
        }
        return null;
    }
    ...
    public final void m8540performMeasureBRTryo0$ui(long constraints) {
    ...
    public Placeable mo8265measureBRTryo0(long constraints) throws Throwable {
        ...
        if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(getLayoutNode())) {
            ...
            lookaheadPassDelegate.mo8265measureBRTryo0(constraints);
        }
        trackMeasurementByParent(getLayoutNode());
        m8541remeasureBRTryo0(constraints);
        return this;
    }

    /* JADX INFO: renamed from: remeasure-BRTryo0, reason: not valid java name */
    public final boolean m8541remeasureBRTryo0(long constraints) throws Throwable {
        LayoutNode layoutNode = getLayoutNode();
        try {
            ...
            if (!getLayoutNode().getMeasurePending$ui() && Constraints.m9633equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            long jMo8273getSizeYbymL2g = getOuterCoordinator().mo8273getSizeYbymL2g();
            ...
            if (IntSize.m9856equalsimpl0(getOuterCoordinator().mo8273getSizeYbymL2g(), jMo8273getSizeYbymL2g) && getOuterCoordinator().getWidth() == getWidth() && getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
            m8329setMeasuredSizeozmzZPI(IntSize.m9853constructorimpl((((long) getOuterCoordinator().getHeight()) & 4294967295L) | (((long) getOuterCoordinator().getWidth()) << 32)));
            return z;
        } catch (Throwable th) {
    ...
    public void mo8266placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) throws Throwable {
        m8537placeSelfMLgxB_4(position, zIndex, layerBlock, null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* JADX INFO: renamed from: placeAt-f8xVGno */
    public void mo8328placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) throws Throwable {
        m8537placeSelfMLgxB_4(position, zIndex, null, layer);
    }
    ...
    private final void m8537placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) throws Throwable {
        Placeable.PlacementScope placementScope;
        LayoutNode layoutNode = getLayoutNode();
        boolean z = true;
        try {
            this.isPlacedByParent = true;
            if (!IntOffset.m9814equalsimpl0(position, this.lastPosition) || this.needsCoordinatesUpdate) {
            ...
            if (lookaheadPassDelegate2 != null && lookaheadPassDelegate2.getNeedsToBePlacedInApproach()) {
                ...
                Placeable.PlacementScope.place$default(placementScope2, lookaheadPassDelegate3, IntOffset.m9815getXimpl(position), IntOffset.m9816getYimpl(position), 0.0f, 4, null);
            }
            ...
            m8536placeOuterCoordinatorMLgxB_4(position, zIndex, layerBlock, layer);
    ...
    private final void m8536placeOuterCoordinatorMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
        if (getLayoutNode().getIsDeactivated()) {
        ...
        if (!this.layoutPending && this.isPlaced) {
            getOuterCoordinator().m8575placeSelfApparentToRealOffsetMLgxB_4(position, zIndex, layerBlock, layer);
            onNodePlaced$ui();
        } else {
    ...
    public final void replace() {
        ...
        try {
            ...
            try {
                measurePassDelegate.m8536placeOuterCoordinatorMLgxB_4(this.lastPosition, this.lastZIndex, this.lastLayerBlock, this.lastExplicitLayer);
    ...
    private final void onBeforeLayoutChildren() {
        ...
        for (int i = 0; i < size; i++) {
            LayoutNode layoutNode = layoutNodeArr[i];
            if (layoutNode.getMeasurePending$ui() && layoutNode.getMeasuredByParent$ui() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m8490remeasure_Sx5XlM$ui$default(layoutNode, null, 1, null)) {
                LayoutNode.requestRemeasure$ui$default(getLayoutNode(), false, false, false, 7, null);
            }
        }
    }
