...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ Object m8478removeFirst() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public /* bridge */ /* synthetic */ Object m8479removeLast() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final boolean hasHit() {
        long jM8477findBestHitDistancefn2tFes = m8477findBestHitDistancefn2tFes();
        return DistanceAndFlags.m8458getDistanceimpl(jM8477findBestHitDistancefn2tFes) < 0.0f && DistanceAndFlags.m8461isInLayerimpl(jM8477findBestHitDistancefn2tFes) && !DistanceAndFlags.m8460isInExpandedBoundsimpl(jM8477findBestHitDistancefn2tFes);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float distanceFromEdge, boolean isInLayer) {
        ...
        return DistanceAndFlags.m8454compareTo9YPOF3E(m8477findBestHitDistancefn2tFes(), HitTestResultKt.DistanceAndFlags$default(distanceFromEdge, isInLayer, false, 4, null)) > 0;
    }

    /* JADX INFO: renamed from: findBestHitDistance-fn2tFes, reason: not valid java name */
    private final long m8477findBestHitDistancefn2tFes() {
        ...
        if (i <= lastIndex) {
            while (true) {
                long jM8455constructorimpl = DistanceAndFlags.m8455constructorimpl(this.distanceFromEdgeAndFlags.get(i));
                if (DistanceAndFlags.m8454compareTo9YPOF3E(jM8455constructorimpl, jDistanceAndFlags$default) < 0) {
                    jDistanceAndFlags$default = jM8455constructorimpl;
                }
                if ((DistanceAndFlags.m8458getDistanceimpl(jDistanceAndFlags$default) < 0.0f && DistanceAndFlags.m8461isInLayerimpl(jDistanceAndFlags$default)) || i == lastIndex) {
                    break;
                }
                i++;
            }
    ...
    public final void hitExpandedTouchBounds(Modifier.Node node, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        if (!DistanceAndFlags.m8460isInExpandedBoundsimpl(jM8477findBestHitDistancefn2tFes)) {
            if (DistanceAndFlags.m8458getDistanceimpl(jM8477findBestHitDistancefn2tFes) > 0.0f) {
        ...
        childHitTest.invoke();
        this.hitDepth = i4;
        if (DistanceAndFlags.m8458getDistanceimpl(m8477findBestHitDistancefn2tFes()) < 0.0f) {
    ...
    public final void speculativeHit(Modifier.Node node, float distanceFromEdge, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        if (this.hitDepth == CollectionsKt.getLastIndex(hitTestResult)) {
            ...
            childHitTest.invoke();
            this.hitDepth = i2;
            if (this.hitDepth + 1 == CollectionsKt.getLastIndex(hitTestResult) || DistanceAndFlags.m8460isInExpandedBoundsimpl(m8477findBestHitDistancefn2tFes())) {
        ...
        childHitTest.invoke();
        this.hitDepth = i4;
        long jM8477findBestHitDistancefn2tFes2 = m8477findBestHitDistancefn2tFes();
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(hitTestResult) && DistanceAndFlags.m8454compareTo9YPOF3E(jM8477findBestHitDistancefn2tFes, jM8477findBestHitDistancefn2tFes2) > 0) {
            int i5 = i3 + 1;
            if (DistanceAndFlags.m8460isInExpandedBoundsimpl(jM8477findBestHitDistancefn2tFes2)) {
                i = this.hitDepth + 2;
            } else {
                i = this.hitDepth + 1;
            }
    ...
    private final class SubList implements List<Modifier.Node>, KMappedMarker {
        ...
        /* JADX INFO: renamed from: removeFirst, reason: collision with other method in class */
        public /* bridge */ /* synthetic */ Object m8480removeFirst() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
        ...
        /* JADX INFO: renamed from: removeLast, reason: collision with other method in class */
        public /* bridge */ /* synthetic */ Object m8481removeLast() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
