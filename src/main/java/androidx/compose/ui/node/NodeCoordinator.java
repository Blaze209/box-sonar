...
public abstract class NodeCoordinator extends LookaheadCapablePlaceable implements Measurable, LayoutCoordinates, OwnerScope {
    ...
    private static final float[] tmpMatrix = Matrix.m7060constructorimpl$default(null, 1, null);
    private static final HitTestSource PointerInputSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$PointerInputSource$1
        ...
        public void mo8580childHitTestqzLsGqo(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
            layoutNode.m8494hitTest6fMxITs$ui(pointerPosition, hitTestResult, pointerType, isInLayer);
        }

        @Override // androidx.compose.ui.node.NodeCoordinator.HitTestSource
        /* JADX INFO: renamed from: entityType-OLwlOKw, reason: not valid java name */
        public int mo8581entityTypeOLwlOKw() {
        ...
        public boolean interceptOutOfBoundsChildEvents(androidx.compose.ui.Modifier.Node r9) {
            /*
                r8 = this;
                r8 = 16
                int r0 = androidx.compose.ui.node.NodeKind.m8585constructorimpl(r8)
                r1 = 0
                r2 = r1
            L8:
                r3 = 0
    ...
    private static final HitTestSource SemanticsSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$SemanticsSource$1
        ...
        public void mo8580childHitTestqzLsGqo(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
            layoutNode.m8495hitTestSemantics6fMxITs$ui(pointerPosition, hitTestResult, pointerType, isInLayer);
        }
    ...
    private long position = IntOffset.INSTANCE.m9826getZeronOccac();
    ...
    public interface HitTestSource {
        /* JADX INFO: renamed from: childHitTest-qzLsGqo */
        void mo8580childHitTestqzLsGqo(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer);

        /* JADX INFO: renamed from: entityType-OLwlOKw */
        int mo8581entityTypeOLwlOKw();
    ...
    public final /* synthetic */ <T> void m8578visitNodesaLcG6gQ(int type, Function1<? super T, Unit> block) {
        boolean zM8594getIncludeSelfInTraversalH91voCI = NodeKindKt.m8594getIncludeSelfInTraversalH91voCI(type);
        Modifier.Node tail = getTail();
        if (!zM8594getIncludeSelfInTraversalH91voCI && (tail = tail.getParent()) == null) {
            return;
        }
        for (Modifier.Node nodeHeadNode = headNode(zM8594getIncludeSelfInTraversalH91voCI); nodeHeadNode != null && (nodeHeadNode.getAggregateChildKindSet() & type) != 0; nodeHeadNode = nodeHeadNode.getChild()) {
    ...
    private final boolean m8555hasNodeH91voCI(int type) {
        Modifier.Node nodeHeadNode = headNode(NodeKindKt.m8594getIncludeSelfInTraversalH91voCI(type));
        return nodeHeadNode != null && DelegatableNodeKt.m8434has64DMado(nodeHeadNode, type);
    }

    /* JADX INFO: renamed from: head-H91voCI, reason: not valid java name */
    public final Modifier.Node m8571headH91voCI(int type) {
        boolean zM8594getIncludeSelfInTraversalH91voCI = NodeKindKt.m8594getIncludeSelfInTraversalH91voCI(type);
        Modifier.Node tail = getTail();
        if (!zM8594getIncludeSelfInTraversalH91voCI && (tail = tail.getParent()) == null) {
            return null;
    ...
    public final long mo8273getSizeYbymL2g() {
    ...
    public void replace$ui() {
        ...
        if (graphicsLayer != null) {
            mo8328placeAtf8xVGno(getPosition(), this.zIndex, graphicsLayer);
        } else {
            mo8266placeAtf8xVGno(getPosition(), this.zIndex, this.layerBlock);
        }
    }
    ...
    protected void onMeasureResultChanged(int width, int height) {
        ...
        if (ownedLayer != null) {
            ownedLayer.mo8647resizeozmzZPI(IntSize.m9853constructorimpl((((long) width) << 32) | (((long) height) & 4294967295L)));
        } else if (getLayoutNode().isPlaced() && (nodeCoordinator = this.wrappedBy) != null) {
            nodeCoordinator.invalidateLayer();
        }
        m8329setMeasuredSizeozmzZPI(IntSize.m9853constructorimpl((((long) height) & 4294967295L) | (((long) width) << 32)));
        if (this.layerBlock != null) {
            updateLayerParameters(false);
        }
        int iM8585constructorimpl = NodeKind.m8585constructorimpl(4);
        boolean zM8594getIncludeSelfInTraversalH91voCI = NodeKindKt.m8594getIncludeSelfInTraversalH91voCI(iM8585constructorimpl);
        Modifier.Node tail = getTail();
        if (zM8594getIncludeSelfInTraversalH91voCI || (tail = tail.getParent()) != null) {
            for (Modifier.Node nodeHeadNode = headNode(zM8594getIncludeSelfInTraversalH91voCI); nodeHeadNode != null && (nodeHeadNode.getAggregateChildKindSet() & iM8585constructorimpl) != 0; nodeHeadNode = nodeHeadNode.getChild()) {
    ...
    protected void m8576setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public Object getParentData() {
        if (!getLayoutNode().getNodes().m8546hasH91voCI$ui(NodeKind.m8585constructorimpl(64))) {
            return null;
        }
        getTail();
        ...
        for (Modifier.Node tail = getLayoutNode().getNodes().getTail(); tail != null; tail = tail.getParent()) {
            if ((NodeKind.m8585constructorimpl(64) & tail.getKindSet()) != 0) {
                int iM8585constructorimpl = NodeKind.m8585constructorimpl(64);
                MutableVector mutableVector = null;
    ...
    public final long m8569getLastMeasurementConstraintsmsEJaDk$ui() {
    ...
    protected final Placeable m8574performingMeasureK40F9xA(long constraints, Function0<? extends Placeable> block) {
    ...
    protected void mo8266placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        if (this.forcePlaceWithLookaheadOffset) {
            ...
            m8561placeSelfMLgxB_4(lookaheadDelegate.getPosition(), zIndex, layerBlock, null);
            return;
        }
        m8561placeSelfMLgxB_4(position, zIndex, layerBlock, null);
    }
    ...
    protected void mo8328placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        if (this.forcePlaceWithLookaheadOffset) {
            LookaheadDelegate lookaheadDelegate = getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            m8561placeSelfMLgxB_4(lookaheadDelegate.getPosition(), zIndex, null, layer);
            return;
        }
        m8561placeSelfMLgxB_4(position, zIndex, null, layer);
    }

    /* JADX INFO: renamed from: placeSelf-MLgxB_4, reason: not valid java name */
    private final void m8561placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer explicitLayer) {
        if (explicitLayer != null) {
            ...
            if (this.layer == null) {
                ...
                ownedLayerCreateLayer.mo8647resizeozmzZPI(getMeasuredSize());
                ownedLayerCreateLayer.mo8646movegyyYBs(position);
        ...
        if (!IntOffset.m9814equalsimpl0(getPosition(), position)) {
            LayoutNodeKt.requireOwner(getLayoutNode()).voteFrameRate(FrameRateCategory.INSTANCE.m6297getHighNSsRyOo());
            m8576setPositiongyyYBs(position);
            getLayoutNode().getLayoutDelegate().getMeasurePassDelegate().notifyChildrenUsingCoordinatesWhilePlacing();
            OwnedLayer ownedLayer = this.layer;
            if (ownedLayer != null) {
                ownedLayer.mo8646movegyyYBs(position);
            } else {
                NodeCoordinator nodeCoordinator = this.wrappedBy;
                if (nodeCoordinator != null) {
                    nodeCoordinator.invalidateLayer();
    ...
    public final void m8575placeSelfApparentToRealOffsetMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
        m8561placeSelfMLgxB_4(IntOffset.m9819plusqkQi6aY(position, getApparentToRealOffset()), zIndex, layerBlock, layer);
    }
    ...
    public final void draw(Canvas canvas, GraphicsLayer graphicsLayer) {
        ...
        float fM9815getXimpl = IntOffset.m9815getXimpl(getPosition());
        float fM9816getYimpl = IntOffset.m9816getYimpl(getPosition());
    ...
    public final void updateLayerBlock(Function1<? super GraphicsLayerScope, Unit> layerBlock, boolean forceUpdateLayerParameters) {
        ...
        if (layoutNode.isAttached() && layerBlock != null) {
            ...
            ownedLayerCreateLayer$default.mo8647resizeozmzZPI(getMeasuredSize());
            ownedLayerCreateLayer$default.mo8646movegyyYBs(getPosition());
        ...
        OwnedLayer ownedLayer = this.layer;
        if (ownedLayer != null) {
            if (!MatrixKt.m7085isIdentity58bKbWc(ownedLayer.mo8642getUnderlyingMatrixsQKQjiQ())) {
    ...
    private final void updateLayerParameters(boolean invokeOnLayoutChange) {
        ...
        if (ownedLayer != null) {
            ...
            if (function1 != null) {
                ...
                reusableGraphicsLayerScope.m7144setSizeuvyYCjk(IntSizeKt.m9870toSizeozmzZPI(mo8273getSizeYbymL2g()));
    ...
    public final long m8570getMinimumTouchTargetSizeNHjbRc() {
        return this.layerDensity.mo755toSizeXkaWNTQ(getLayoutNode().getViewConfiguration().mo8501getMinimumTouchTargetSizeMYxV2XQ());
    }

    /* JADX INFO: renamed from: hitTest-qzLsGqo, reason: not valid java name */
    public final void m8572hitTestqzLsGqo(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
        boolean z;
        Modifier.Node nodeM8571headH91voCI = m8571headH91voCI(hitTestSource.mo8581entityTypeOLwlOKw());
        boolean z2 = false;
        if (!m8579withinLayerBoundsk4lQ0M(pointerPosition)) {
            if (PointerType.m8205equalsimpl0(pointerType, PointerType.INSTANCE.m8212getTouchT8wyACA())) {
                float fM8567distanceInMinimumTouchTargettz77jQw = m8567distanceInMinimumTouchTargettz77jQw(pointerPosition, m8570getMinimumTouchTargetSizeNHjbRc());
                if ((Float.floatToRawIntBits(fM8567distanceInMinimumTouchTargettz77jQw) & Integer.MAX_VALUE) >= 2139095040 || !hitTestResult.isHitInMinimumTouchTargetBetter(fM8567distanceInMinimumTouchTargettz77jQw, false)) {
                    return;
                }
                m8557hitNearFh5PU_I(nodeM8571headH91voCI, hitTestSource, pointerPosition, hitTestResult, pointerType, false, fM8567distanceInMinimumTouchTargettz77jQw);
                return;
            }
            return;
        }
        if (nodeM8571headH91voCI == null) {
            mo8482hitTestChildqzLsGqo(hitTestSource, pointerPosition, hitTestResult, pointerType, isInLayer);
            return;
        }
        if (m8573isPointerInBoundsk4lQ0M(pointerPosition)) {
            m8556hit5ShdDok(nodeM8571headH91voCI, hitTestSource, pointerPosition, hitTestResult, pointerType, isInLayer);
            return;
        }
        float fM8567distanceInMinimumTouchTargettz77jQw2 = !PointerType.m8205equalsimpl0(pointerType, PointerType.INSTANCE.m8212getTouchT8wyACA()) ? Float.POSITIVE_INFINITY : m8567distanceInMinimumTouchTargettz77jQw(pointerPosition, m8570getMinimumTouchTargetSizeNHjbRc());
        if ((Float.floatToRawIntBits(fM8567distanceInMinimumTouchTargettz77jQw2) & Integer.MAX_VALUE) < 2139095040) {
            z = isInLayer;
            if (hitTestResult.isHitInMinimumTouchTargetBetter(fM8567distanceInMinimumTouchTargettz77jQw2, z)) {
                z2 = true;
            }
        } else {
            z = isInLayer;
        }
        m8560outOfBoundsHit8NAm7pk(nodeM8571headH91voCI, hitTestSource, pointerPosition, hitTestResult, pointerType, z, fM8567distanceInMinimumTouchTargettz77jQw2, z2);
    }

    /* JADX INFO: renamed from: hit-5ShdDok, reason: not valid java name */
    private final void m8556hit5ShdDok(Modifier.Node node, HitTestSource hitTestSource, long j, HitTestResult hitTestResult, int i, boolean z) {
        if (node != null) {
            ...
            m8556hit5ShdDok(NodeCoordinatorKt.m8583nextUntilhw7D004(node, hitTestSource.mo8581entityTypeOLwlOKw(), NodeKind.m8585constructorimpl(2)), hitTestSource, j, hitTestResult, i, z);
            hitTestResult.hitDepth = i2;
            return;
        }
        mo8482hitTestChildqzLsGqo(hitTestSource, j, hitTestResult, i, z);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: outOfBoundsHit-8NAm7pk, reason: not valid java name */
    public final void m8560outOfBoundsHit8NAm7pk(final Modifier.Node node, final HitTestSource hitTestSource, final long j, final HitTestResult hitTestResult, final int i, final boolean z, final float f, final boolean z2) {
        if (node == null) {
            mo8482hitTestChildqzLsGqo(hitTestSource, j, hitTestResult, i, z);
            return;
        }
        if (m8558isInExpandedTouchBoundsThDn1k(node, j, i)) {
            hitTestResult.hitExpandedTouchBounds(node, z, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$outOfBoundsHit$1
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m8560outOfBoundsHit8NAm7pk(NodeCoordinatorKt.m8583nextUntilhw7D004(node, hitTestSource.mo8581entityTypeOLwlOKw(), NodeKind.m8585constructorimpl(2)), hitTestSource, j, hitTestResult, i, z, f, z2);
                }
            });
        } else if (z2) {
            m8557hitNearFh5PU_I(node, hitTestSource, j, hitTestResult, i, z, f);
        } else {
            m8562speculativeHitFh5PU_I(node, hitTestSource, j, hitTestResult, i, z, f);
        }
    }

    /* JADX INFO: renamed from: hitNear-Fh5PU_I, reason: not valid java name */
    private final void m8557hitNearFh5PU_I(Modifier.Node node, HitTestSource hitTestSource, long j, HitTestResult hitTestResult, int i, boolean z, float f) {
        if (node != null) {
            int i2 = hitTestResult.hitDepth;
            hitTestResult.removeNodesInRange(hitTestResult.hitDepth + 1, hitTestResult.size());
            hitTestResult.hitDepth++;
            ...
            m8560outOfBoundsHit8NAm7pk(NodeCoordinatorKt.m8583nextUntilhw7D004(node, hitTestSource.mo8581entityTypeOLwlOKw(), NodeKind.m8585constructorimpl(2)), hitTestSource, j, hitTestResult, i, z, f, true);
            hitTestResult.hitDepth = i2;
            return;
        }
        mo8482hitTestChildqzLsGqo(hitTestSource, j, hitTestResult, i, z);
    ...
    private final void m8562speculativeHitFh5PU_I(final Modifier.Node node, final HitTestSource hitTestSource, final long j, final HitTestResult hitTestResult, final int i, final boolean z, final float f) {
        if (node == null) {
            mo8482hitTestChildqzLsGqo(hitTestSource, j, hitTestResult, i, z);
            ...
            hitTestResult.speculativeHit(node, f, z, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$speculativeHit$1
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m8560outOfBoundsHit8NAm7pk(NodeCoordinatorKt.m8583nextUntilhw7D004(node, hitTestSource.mo8581entityTypeOLwlOKw(), NodeKind.m8585constructorimpl(2)), hitTestSource, j, hitTestResult, i, z, f, false);
                }
            });
        } else {
            m8560outOfBoundsHit8NAm7pk(NodeCoordinatorKt.m8583nextUntilhw7D004(node, hitTestSource.mo8581entityTypeOLwlOKw(), NodeKind.m8585constructorimpl(2)), hitTestSource, j, hitTestResult, i, z, f, false);
        }
    }
    ...
    private final boolean m8558isInExpandedTouchBoundsThDn1k(androidx.compose.ui.Modifier.Node r9, long r10, int r12) {
        /*
            Method dump skipped, instruction units count: 209
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.NodeCoordinator.m8558isInExpandedTouchBoundsThDn1k(androidx.compose.ui.Modifier$Node, long, int):boolean");
    }

    /* JADX INFO: renamed from: hitTestChild-qzLsGqo */
    public void mo8482hitTestChildqzLsGqo(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
        NodeCoordinator nodeCoordinator = this.wrapped;
        if (nodeCoordinator != null) {
            nodeCoordinator.m8572hitTestqzLsGqo(hitTestSource, m8554fromParentPosition8S9VItk$default(nodeCoordinator, pointerPosition, false, 2, null), hitTestResult, pointerType, isInLayer);
        }
    }
    ...
    public final Rect touchBoundsInRoot() {
        ...
        long jM8566calculateMinimumTouchTargetPaddingE7KxVPU = m8566calculateMinimumTouchTargetPaddingE7KxVPU(m8570getMinimumTouchTargetSizeNHjbRc());
        int i = (int) (jM8566calculateMinimumTouchTargetPaddingE7KxVPU >> 32);
        rectCache.setLeft(-Float.intBitsToFloat(i));
        int i2 = (int) (jM8566calculateMinimumTouchTargetPaddingE7KxVPU & 4294967295L);
    ...
    public long mo8279screenToLocalMKHz9U(long relativeToScreen) {
        if (!isAttached()) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        return mo8274localPositionOfR5De75A(LayoutCoordinatesKt.findRootCoordinates(this), LayoutNodeKt.requireOwner(getLayoutNode()).mo8215screenToLocalMKHz9U(relativeToScreen));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: localToScreen-MK-Hz9U */
    public long mo8277localToScreenMKHz9U(long relativeToLocal) {
        if (!isAttached()) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        return LayoutNodeKt.requireOwner(getLayoutNode()).mo8214localToScreenMKHz9U(mo8276localToRootMKHz9U(relativeToLocal));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: windowToLocal-MK-Hz9U */
    public long mo8282windowToLocalMKHz9U(long relativeToWindow) {
        if (!isAttached()) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        LayoutCoordinates layoutCoordinatesFindRootCoordinates = LayoutCoordinatesKt.findRootCoordinates(this);
        return mo8274localPositionOfR5De75A(layoutCoordinatesFindRootCoordinates, Offset.m6573minusMKHz9U(LayoutNodeKt.requireOwner(getLayoutNode()).mo8649calculateLocalPositionMKHz9U(relativeToWindow), LayoutCoordinatesKt.positionInRoot(layoutCoordinatesFindRootCoordinates)));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: localToWindow-MK-Hz9U */
    public long mo8278localToWindowMKHz9U(long relativeToLocal) {
        return LayoutNodeKt.requireOwner(getLayoutNode()).mo8650calculatePositionInWindowMKHz9U(mo8276localToRootMKHz9U(relativeToLocal));
    }
    ...
    public long mo8274localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource) {
        return mo8275localPositionOfS_NoaFU(sourceCoordinates, relativeToSource, true);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: localPositionOf-S_NoaFU */
    public long mo8275localPositionOfS_NoaFU(LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
        if (sourceCoordinates instanceof LookaheadLayoutCoordinates) {
            ...
            return Offset.m6561constructorimpl(lookaheadLayoutCoordinates.mo8275localPositionOfS_NoaFU(this, Offset.m6561constructorimpl(relativeToSource ^ (-9223372034707292160L)), includeMotionFrameOfReference) ^ (-9223372034707292160L));
        }
        ...
        while (coordinator != nodeCoordinatorFindCommonAncestor$ui) {
            relativeToSource = coordinator.m8577toParentPosition8S9VItk(relativeToSource, includeMotionFrameOfReference);
            coordinator = coordinator.wrappedBy;
            Intrinsics.checkNotNull(coordinator);
        }
        return m8553ancestorToLocalS_NoaFU(nodeCoordinatorFindCommonAncestor$ui, relativeToSource, includeMotionFrameOfReference);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: transformFrom-EL8BTi8 */
    public void mo8280transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        NodeCoordinator coordinator = toCoordinator(sourceCoordinates);
        coordinator.onCoordinatesUsed$ui();
        NodeCoordinator nodeCoordinatorFindCommonAncestor$ui = findCommonAncestor$ui(coordinator);
        Matrix.m7069resetimpl(matrix);
        coordinator.m8565transformToAncestorEL8BTi8(nodeCoordinatorFindCommonAncestor$ui, matrix);
        m8564transformFromAncestorEL8BTi8(nodeCoordinatorFindCommonAncestor$ui, matrix);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: transformToScreen-58bKbWc */
    public void mo8281transformToScreen58bKbWc(float[] matrix) {
        ...
        m8565transformToAncestorEL8BTi8(coordinator, matrix);
        if (ownerRequireOwner instanceof MatrixPositionCalculator) {
            ((MatrixPositionCalculator) ownerRequireOwner).mo8050localToScreen58bKbWc(matrix);
            return;
        }
        ...
        if ((9223372034707292159L & jPositionOnScreen) != androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            Matrix.m7081translateimpl(matrix, Float.intBitsToFloat((int) (jPositionOnScreen >> 32)), Float.intBitsToFloat((int) (jPositionOnScreen & 4294967295L)), 0.0f);
        }
    }

    /* JADX INFO: renamed from: transformToAncestor-EL8BTi8, reason: not valid java name */
    private final void m8565transformToAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        while (!Intrinsics.areEqual(this, ancestor)) {
            OwnedLayer ownedLayer = this.layer;
            if (ownedLayer != null) {
                ownedLayer.mo8648transform58bKbWc(matrix);
            }
            long position = this.getPosition();
            if (!IntOffset.m9814equalsimpl0(position, IntOffset.INSTANCE.m9826getZeronOccac())) {
                float[] fArr = tmpMatrix;
                Matrix.m7069resetimpl(fArr);
                Matrix.m7082translateimpl$default(fArr, IntOffset.m9815getXimpl(position), IntOffset.m9816getYimpl(position), 0.0f, 4, null);
                Matrix.m7079timesAssign58bKbWc(matrix, fArr);
            }
            this = this.wrappedBy;
            Intrinsics.checkNotNull(this);
        }
    ...
    private final void m8564transformFromAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        if (Intrinsics.areEqual(ancestor, this)) {
            return;
        }
        NodeCoordinator nodeCoordinator = this.wrappedBy;
        Intrinsics.checkNotNull(nodeCoordinator);
        nodeCoordinator.m8564transformFromAncestorEL8BTi8(ancestor, matrix);
        if (!IntOffset.m9814equalsimpl0(getPosition(), IntOffset.INSTANCE.m9826getZeronOccac())) {
            float[] fArr = tmpMatrix;
            Matrix.m7069resetimpl(fArr);
            Matrix.m7082translateimpl$default(fArr, -IntOffset.m9815getXimpl(getPosition()), -IntOffset.m9816getYimpl(getPosition()), 0.0f, 4, null);
            Matrix.m7079timesAssign58bKbWc(matrix, fArr);
        }
        OwnedLayer ownedLayer = this.layer;
        if (ownedLayer != null) {
            ownedLayer.mo8643inverseTransform58bKbWc(matrix);
        }
    }
    ...
    public Rect localBoundingBoxOf(LayoutCoordinates sourceCoordinates, boolean clipBounds) {
        ...
        rectCache.setRight((int) (sourceCoordinates.mo8273getSizeYbymL2g() >> 32));
        rectCache.setBottom((int) (sourceCoordinates.mo8273getSizeYbymL2g() & 4294967295L));
    ...
    private final long m8553ancestorToLocalS_NoaFU(NodeCoordinator ancestor, long offset, boolean includeMotionFrameOfReference) {
        if (ancestor == this) {
            return offset;
        }
        NodeCoordinator nodeCoordinator = this.wrappedBy;
        if (nodeCoordinator == null || Intrinsics.areEqual(ancestor, nodeCoordinator)) {
            return m8568fromParentPosition8S9VItk(offset, includeMotionFrameOfReference);
        }
        return m8568fromParentPosition8S9VItk(nodeCoordinator.m8553ancestorToLocalS_NoaFU(ancestor, offset, includeMotionFrameOfReference), includeMotionFrameOfReference);
    }
    ...
    public long mo8276localToRootMKHz9U(long relativeToLocal) {
        if (!isAttached()) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        onCoordinatesUsed$ui();
        long jM8563toParentPosition8S9VItk$default = relativeToLocal;
        for (NodeCoordinator nodeCoordinator = this; nodeCoordinator != null; nodeCoordinator = nodeCoordinator.wrappedBy) {
            if (ComposeUiFlags.isRectManagerOffsetUsageFromLayoutCoordinatesEnabled) {
                ...
                if (nodeCoordinator == layoutNode.getOuterCoordinator$ui() && !layoutNode.getHasPositionalLayerTransformationsInOffsetFromRoot()) {
                    long jM8854getOffsetFromRectListForBjo55l4 = LayoutNodeKt.requireOwner(layoutNode).getRectManager().m8854getOffsetFromRectListForBjo55l4(layoutNode);
                    if (!IntOffset.m9814equalsimpl0(jM8854getOffsetFromRectListForBjo55l4, IntOffset.INSTANCE.m9825getMaxnOccac())) {
                        return IntOffsetKt.m9830plusNvtHpc(jM8563toParentPosition8S9VItk$default, jM8854getOffsetFromRectListForBjo55l4);
                    }
                }
            }
            jM8563toParentPosition8S9VItk$default = m8563toParentPosition8S9VItk$default(nodeCoordinator, jM8563toParentPosition8S9VItk$default, false, 2, null);
        }
        return jM8563toParentPosition8S9VItk$default;
    }
    ...
    public static /* synthetic */ long m8563toParentPosition8S9VItk$default(NodeCoordinator nodeCoordinator, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return nodeCoordinator.m8577toParentPosition8S9VItk(j, z);
    }

    /* JADX INFO: renamed from: toParentPosition-8S9VItk, reason: not valid java name */
    public long m8577toParentPosition8S9VItk(long position, boolean includeMotionFrameOfReference) {
        OwnedLayer ownedLayer = this.layer;
        if (ownedLayer != null) {
            position = ownedLayer.mo8645mapOffset8S9VItk(position, false);
        }
        return (includeMotionFrameOfReference || !getIsPlacedUnderMotionFrameOfReference()) ? IntOffsetKt.m9830plusNvtHpc(position, getPosition()) : position;
    }

    /* JADX INFO: renamed from: fromParentPosition-8S9VItk$default, reason: not valid java name */
    public static /* synthetic */ long m8554fromParentPosition8S9VItk$default(NodeCoordinator nodeCoordinator, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return nodeCoordinator.m8568fromParentPosition8S9VItk(j, z);
    }

    /* JADX INFO: renamed from: fromParentPosition-8S9VItk, reason: not valid java name */
    public long m8568fromParentPosition8S9VItk(long position, boolean includeMotionFrameOfReference) {
        if (includeMotionFrameOfReference || !getIsPlacedUnderMotionFrameOfReference()) {
            position = IntOffsetKt.m9828minusNvtHpc(position, getPosition());
        }
        OwnedLayer ownedLayer = this.layer;
        return ownedLayer != null ? ownedLayer.mo8645mapOffset8S9VItk(position, true) : position;
    }
    ...
    public final void rectInParent$ui(MutableRect bounds, boolean clipBounds, boolean clipToMinimumTouchTargetSize) {
        ...
        if (ownedLayer != null) {
            if (this.isClipping) {
                if (clipToMinimumTouchTargetSize) {
                    long jM8570getMinimumTouchTargetSizeNHjbRc = m8570getMinimumTouchTargetSizeNHjbRc();
                    float fIntBitsToFloat = Float.intBitsToFloat((int) (jM8570getMinimumTouchTargetSizeNHjbRc >> 32)) / 2.0f;
                    float fIntBitsToFloat2 = Float.intBitsToFloat((int) (jM8570getMinimumTouchTargetSizeNHjbRc & 4294967295L)) / 2.0f;
                    bounds.intersect(-fIntBitsToFloat, -fIntBitsToFloat2, ((int) (mo8273getSizeYbymL2g() >> 32)) + fIntBitsToFloat, ((int) (4294967295L & mo8273getSizeYbymL2g())) + fIntBitsToFloat2);
                } else if (clipBounds) {
                    bounds.intersect(0.0f, 0.0f, (int) (mo8273getSizeYbymL2g() >> 32), (int) (4294967295L & mo8273getSizeYbymL2g()));
                }
                if (bounds.isEmpty()) {
                    return;
                }
        ...
        float fM9815getXimpl = IntOffset.m9815getXimpl(getPosition());
        bounds.setLeft(bounds.getLeft() + fM9815getXimpl);
        bounds.setRight(bounds.getRight() + fM9815getXimpl);
        float fM9816getYimpl = IntOffset.m9816getYimpl(getPosition());
        bounds.setTop(bounds.getTop() + fM9816getYimpl);
        bounds.setBottom(bounds.getBottom() + fM9816getYimpl);
    }
    ...
    private final void fromParentRect(MutableRect bounds, boolean clipBounds) {
        ...
        if (ownedLayer != null) {
            ...
            if (this.isClipping && clipBounds) {
                bounds.intersect(0.0f, 0.0f, (int) (mo8273getSizeYbymL2g() >> 32), (int) (mo8273getSizeYbymL2g() & 4294967295L));
                bounds.isEmpty();
            }
        }
    }
    ...
    protected final boolean m8579withinLayerBoundsk4lQ0M(long pointerPosition) {
        ...
        OwnedLayer ownedLayer = this.layer;
        return ownedLayer == null || !this.isClipping || ownedLayer.mo8644isInLayerk4lQ0M(pointerPosition);
    }
    ...
    public final NodeCoordinator findCommonAncestor$ui(NodeCoordinator other) {
        ...
        if (layoutNode == layoutNode2) {
            ...
            for (Modifier.Node parent = tail2.getNode().getParent(); parent != null; parent = parent.getParent()) {
                if ((parent.getKindSet() & iM8585constructorimpl) != 0 && parent == tail) {
                    return other;
                }
            }
            return this;
    ...
    protected final float m8567distanceInMinimumTouchTargettz77jQw(long pointerPosition, long minimumTouchTargetSize) {
        ...
        long jM8566calculateMinimumTouchTargetPaddingE7KxVPU = m8566calculateMinimumTouchTargetPaddingE7KxVPU(minimumTouchTargetSize);
        float fIntBitsToFloat = Float.intBitsToFloat((int) (jM8566calculateMinimumTouchTargetPaddingE7KxVPU >> 32));
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (jM8566calculateMinimumTouchTargetPaddingE7KxVPU & 4294967295L));
        long jM8559offsetFromEdgeMKHz9U = m8559offsetFromEdgeMKHz9U(pointerPosition);
        if ((fIntBitsToFloat > 0.0f || fIntBitsToFloat2 > 0.0f) && Float.intBitsToFloat((int) (jM8559offsetFromEdgeMKHz9U >> 32)) <= fIntBitsToFloat && Float.intBitsToFloat((int) (jM8559offsetFromEdgeMKHz9U & 4294967295L)) <= fIntBitsToFloat2) {
            return Offset.m6568getDistanceSquaredimpl(jM8559offsetFromEdgeMKHz9U);
        }
        return Float.POSITIVE_INFINITY;
    }
    ...
    public final void onMeasured() {
        ...
        if (m8555hasNodeH91voCI(NodeKind.m8585constructorimpl(128))) {
            Snapshot.Companion companion = Snapshot.INSTANCE;
            Snapshot currentThreadSnapshot = companion.getCurrentThreadSnapshot();
            Function1<Object, Unit> readObserver = currentThreadSnapshot != null ? currentThreadSnapshot.getReadObserver() : null;
            Snapshot snapshotMakeCurrentNonObservable = companion.makeCurrentNonObservable(currentThreadSnapshot);
            try {
                int iM8585constructorimpl = NodeKind.m8585constructorimpl(128);
                boolean zM8594getIncludeSelfInTraversalH91voCI = NodeKindKt.m8594getIncludeSelfInTraversalH91voCI(iM8585constructorimpl);
                if (!zM8594getIncludeSelfInTraversalH91voCI) {
                    ...
                    if ((nodeHeadNode.getKindSet() & iM8585constructorimpl) != 0) {
                        ...
                        while (nodePop != 0) {
                            if (nodePop instanceof LayoutAwareModifierNode) {
                                ((LayoutAwareModifierNode) nodePop).mo743onRemeasuredozmzZPI(getMeasuredSize());
                            } else if ((nodePop.getKindSet() & iM8585constructorimpl) != 0 && (nodePop instanceof DelegatingNode)) {
                                Modifier.Node delegate$ui = ((DelegatingNode) nodePop).getDelegate();
                                int i = 0;
                                nodePop = nodePop;
    ...
    public final void onUnplaced() {
        if (m8555hasNodeH91voCI(NodeKind.m8585constructorimpl(1048576))) {
            int iM8585constructorimpl = NodeKind.m8585constructorimpl(1048576);
            boolean zM8594getIncludeSelfInTraversalH91voCI = NodeKindKt.m8594getIncludeSelfInTraversalH91voCI(iM8585constructorimpl);
            Modifier.Node tail = getTail();
            if (!zM8594getIncludeSelfInTraversalH91voCI && (tail = tail.getParent()) == null) {
                return;
    ...
    public final void drawContainedDrawModifiers(Canvas canvas, GraphicsLayer graphicsLayer) {
        Modifier.Node nodeM8571headH91voCI = m8571headH91voCI(NodeKind.m8585constructorimpl(4));
        if (nodeM8571headH91voCI == null) {
            performDraw(canvas, graphicsLayer);
        } else {
            getLayoutNode().getMDrawScope$ui().m8507draweZhPAX0$ui(canvas, IntSizeKt.m9870toSizeozmzZPI(mo8273getSizeYbymL2g()), this, nodeM8571headH91voCI, graphicsLayer);
        }
    }
    ...
    protected final boolean m8573isPointerInBoundsk4lQ0M(long pointerPosition) {
    ...
    public final boolean shouldSharePointerInputWithSiblings() {
        /*
            r10 = this;
            r0 = 16
            int r1 = androidx.compose.ui.node.NodeKind.m8585constructorimpl(r0)
            boolean r1 = androidx.compose.ui.node.NodeKindKt.m8594getIncludeSelfInTraversalH91voCI(r1)
        ...
        L12:
            ...
            int r2 = androidx.compose.ui.node.NodeKind.m8585constructorimpl(r0)
    ...
    private final long m8559offsetFromEdgeMKHz9U(long pointerPosition) {
        float fIntBitsToFloat = Float.intBitsToFloat((int) (pointerPosition >> 32));
        float fMax = Math.max(0.0f, fIntBitsToFloat < 0.0f ? -fIntBitsToFloat : fIntBitsToFloat - getMeasuredWidth());
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (pointerPosition & 4294967295L));
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(fMax)) << 32) | (((long) Float.floatToRawIntBits(Math.max(0.0f, fIntBitsToFloat2 < 0.0f ? -fIntBitsToFloat2 : fIntBitsToFloat2 - getMeasuredHeight()))) & 4294967295L));
    }

    /* JADX INFO: renamed from: calculateMinimumTouchTargetPadding-E7KxVPU, reason: not valid java name */
    protected final long m8566calculateMinimumTouchTargetPaddingE7KxVPU(long minimumTouchTargetSize) {
        ...
        return Size.m6629constructorimpl((((long) Float.floatToRawIntBits(Math.max(0.0f, fIntBitsToFloat / 2.0f))) << 32) | (((long) Float.floatToRawIntBits(Math.max(0.0f, fIntBitsToFloat2 / 2.0f))) & 4294967295L));
    }
}
