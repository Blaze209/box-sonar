...
@Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\t\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0087@\u0018\u0000  2\u00020\u0001:\u0001 B\u0011\b\u0000\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0017\u0010\u0014\u001a\u00020\u00072\u0006\u0010\u0015\u001a\u00020\u0016H\u0000¢\u0006\u0004\b\u0017\u0010\u0018J\u0017\u0010\u0019\u001a\u00020\u00072\u0006\u0010\u0015\u001a\u00020\u0016H\u0000¢\u0006\u0004\b\u001a\u0010\u0018J\u0013\u0010\u001b\u001a\u00020\u00112\b\u0010\u001c\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u001d\u001a\u00020\u0007HÖ\u0001J\t\u0010\u001e\u001a\u00020\u001fHÖ\u0001R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\u0006\u001a\u00020\u00078F¢\u0006\u0006\u001a\u0004\b\b\u0010\tR\u0011\u0010\n\u001a\u00020\u00078F¢\u0006\u0006\u001a\u0004\b\u000b\u0010\tR\u0011\u0010\f\u001a\u00020\u00078F¢\u0006\u0006\u001a\u0004\b\r\u0010\tR\u0011\u0010\u000e\u001a\u00020\u00078F¢\u0006\u0006\u001a\u0004\b\u000f\u0010\tR\u0011\u0010\u0010\u001a\u00020\u00118F¢\u0006\u0006\u001a\u0004\b\u0012\u0010\u0013\u0088\u0001\u0002\u0092\u0001\u00020\u0003¨\u0006!"}, d2 = {"Landroidx/compose/ui/node/TouchBoundsExpansion;", "", "packedValue", "", "constructor-impl", "(J)J", "start", "", "getStart-impl", "(J)I", ViewProps.TOP, "getTop-impl", "end", "getEnd-impl", ViewProps.BOTTOM, "getBottom-impl", "isLayoutDirectionAware", "", "isLayoutDirectionAware-impl", "(J)Z", "computeLeft", ViewProps.LAYOUT_DIRECTION, "Landroidx/compose/ui/unit/LayoutDirection;", "computeLeft-impl$ui", "(JLandroidx/compose/ui/unit/LayoutDirection;)I", "computeRight", "computeRight-impl$ui", "equals", "other", "hashCode", "toString", "", "Companion", "ui"}, k = 1, mv = {2, 0, 0}, xi = 48)
@JvmInline
public final class TouchBoundsExpansion {
    ...
    public static final /* synthetic */ TouchBoundsExpansion m8670boximpl(long j) {
        return new TouchBoundsExpansion(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m8673constructorimpl(long j) {
        return j;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m8674equalsimpl(long j, Object obj) {
        return (obj instanceof TouchBoundsExpansion) && j == ((TouchBoundsExpansion) obj).getPackedValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m8675equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m8680hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    /* JADX INFO: renamed from: isLayoutDirectionAware-impl, reason: not valid java name */
    public static final boolean m8681isLayoutDirectionAwareimpl(long j) {
    ...
    public boolean equals(Object other) {
        return m8674equalsimpl(this.packedValue, other);
    }

    public int hashCode() {
        return m8680hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m8682toStringimpl(this.packedValue);
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ long m8684Absolutevsh68fg$default(Companion companion, int i, int i2, int i3, int i4, int i5, Object obj) {
            if ((i5 & 1) != 0) {
                i = 0;
            }
            if ((i5 & 2) != 0) {
            ...
            return companion.m8685Absolutevsh68fg(i, i2, i3, i4);
        }

        /* JADX INFO: renamed from: Absolute-vsh68fg, reason: not valid java name */
        public final long m8685Absolutevsh68fg(int left, int top, int right, int bottom) {
            ...
            return TouchBoundsExpansion.m8673constructorimpl(pack$ui(left, top, right, bottom, false));
        }

        /* JADX INFO: renamed from: getNone-RZrCHBk, reason: not valid java name */
        public final long m8686getNoneRZrCHBk() {
    ...
    public static final int m8678getStartimpl(long j) {
        return INSTANCE.unpack(j, 0);
    }

    /* JADX INFO: renamed from: getTop-impl, reason: not valid java name */
    public static final int m8679getTopimpl(long j) {
        return INSTANCE.unpack(j, 1);
    }

    /* JADX INFO: renamed from: getEnd-impl, reason: not valid java name */
    public static final int m8677getEndimpl(long j) {
        return INSTANCE.unpack(j, 2);
    }

    /* JADX INFO: renamed from: getBottom-impl, reason: not valid java name */
    public static final int m8676getBottomimpl(long j) {
        return INSTANCE.unpack(j, 3);
    }

    /* JADX INFO: renamed from: computeLeft-impl$ui, reason: not valid java name */
    public static final int m8671computeLeftimpl$ui(long j, LayoutDirection layoutDirection) {
        if (!m8681isLayoutDirectionAwareimpl(j) || layoutDirection == LayoutDirection.Ltr) {
            return m8678getStartimpl(j);
        }
        return m8677getEndimpl(j);
    }

    /* JADX INFO: renamed from: computeRight-impl$ui, reason: not valid java name */
    public static final int m8672computeRightimpl$ui(long j, LayoutDirection layoutDirection) {
        if (!m8681isLayoutDirectionAwareimpl(j) || layoutDirection == LayoutDirection.Ltr) {
            return m8677getEndimpl(j);
        }
        return m8678getStartimpl(j);
