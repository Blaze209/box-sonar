...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo8265measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateImpl.m8330setMeasurementConstraintsBRTryo0(constraints);
            ...
            lookaheadDelegateImpl.set_measureResult(getLayoutNode().getMeasurePolicy().mo344measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui(), constraints));
    ...
    public Placeable mo8265measureBRTryo0(long constraints) {
        if (getForceMeasureWithLookaheadConstraints()) {
            ...
            constraints = lookaheadDelegate.m8521getConstraintsmsEJaDk$ui();
        }
        ...
        setMeasureResult$ui(getLayoutNode().getMeasurePolicy().mo344measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui(), constraints));
        onMeasured();
        return this;
    }
    ...
    public void mo8482hitTestChildqzLsGqo(NodeCoordinator.HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
        ...
        if (hitTestSource.shouldHitTestChildren(getLayoutNode())) {
            if (m8579withinLayerBoundsk4lQ0M(pointerPosition)) {
                z = true;
            } else if (PointerType.m8205equalsimpl0(pointerType, PointerType.INSTANCE.m8212getTouchT8wyACA()) && (Float.floatToRawIntBits(m8567distanceInMinimumTouchTargettz77jQw(pointerPosition, m8570getMinimumTouchTargetSizeNHjbRc())) & Integer.MAX_VALUE) < 2139095040) {
                isInLayer = false;
                z = true;
            }
        }
        if (z) {
            ...
            while (size >= 0) {
                ...
                if (layoutNode.isPlaced()) {
                    ...
                    hitTestSource2.mo8580childHitTestqzLsGqo(layoutNode, pointerPosition, hitTestResult, pointerType, isInLayer);
    ...
    static {
        ...
        Paint.mo6690setColor8_81llA(Color.INSTANCE.m6848getRed0d7_KjU());
