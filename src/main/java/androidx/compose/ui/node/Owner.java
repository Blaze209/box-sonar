...
public interface Owner extends PositionCalculator {
    ...
    long mo8649calculateLocalPositionMKHz9U(long positionInWindow);

    /* JADX INFO: renamed from: calculatePositionInWindow-MK-Hz9U, reason: not valid java name */
    long mo8650calculatePositionInWindowMKHz9U(long localPosition);
    ...
    default void mo8651dispatchOnScrollChangedk4lQ0M(long delta) {
    }
    ...
    void mo8652measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints);
