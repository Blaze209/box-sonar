...
public final class LayoutNodeLayoutDelegate {
    ...
    public final Constraints m8509getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m8538getLastConstraintsDWUhwKw();
    }

    /* JADX INFO: renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m8510getLastLookaheadConstraintsDWUhwKw() {
    ...
    public final void m8511performLookaheadMeasureBRTryo0$ui(long constraints) {
        LookaheadPassDelegate lookaheadPassDelegate = this.lookaheadPassDelegate;
        if (lookaheadPassDelegate != null) {
            lookaheadPassDelegate.m8529performMeasureBRTryo0$ui(constraints);
        }
    }
