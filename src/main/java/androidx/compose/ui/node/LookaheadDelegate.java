...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m8526setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final long m8522getSizeYbymL2g$ui() {
    ...
    public final long m8521getConstraintsmsEJaDk$ui() {
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m8329setMeasuredSizeozmzZPI(IntSize.m9853constructorimpl((((long) measureResult.getHeight()) & 4294967295L) | (((long) measureResult.getWidth()) << 32)));
        } else {
            m8329setMeasuredSizeozmzZPI(IntSize.INSTANCE.m9863getZeroYbymL2g());
        }
    ...
    public void replace$ui() {
        mo8266placeAtf8xVGno(getPosition(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* JADX INFO: renamed from: placeAt-f8xVGno */
    public final void mo8266placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m8520placeSelfgyyYBs(position);
    ...
    private final void m8520placeSelfgyyYBs(long position) {
        if (!IntOffset.m9814equalsimpl0(getPosition(), position)) {
            m8526setPositiongyyYBs(position);
    ...
    public final void m8524placeSelfApparentToRealOffsetgyyYBs$ui(long position) {
        m8520placeSelfgyyYBs(IntOffset.m9819plusqkQi6aY(position, getApparentToRealOffset()));
    }
    ...
    public final Placeable m8523performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m8525positionIniSbpLlY$ui(LookaheadDelegate ancestor, boolean excludingAgnosticOffset) {
        ...
        while (!Intrinsics.areEqual(this, ancestor)) {
            if (!this.getIsPlacedUnderMotionFrameOfReference() || !excludingAgnosticOffset) {
                jM9826getZeronOccac = IntOffset.m9819plusqkQi6aY(jM9826getZeronOccac, this.getPosition());
            }
            NodeCoordinator wrappedBy = this.coordinator.getWrappedBy();
