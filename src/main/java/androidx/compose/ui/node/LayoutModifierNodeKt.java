...
public final class LayoutModifierNodeKt {
    ...
    public static final void invalidateLayer(LayoutModifierNode layoutModifierNode) {
        DelegatableNodeKt.m8436requireCoordinator64DMado(layoutModifierNode, NodeKind.m8585constructorimpl(2)).invalidateLayer();
    }
    ...
    public static final void updateLayerBlock(LayoutModifierNode layoutModifierNode, Function1<? super GraphicsLayerScope, Unit> function1) {
        ...
        if (layoutModifierNode.getNode().getIsAttached() && (wrapped = DelegatableNodeKt.m8436requireCoordinator64DMado(layoutModifierNode, NodeKind.m8585constructorimpl(2)).getWrapped()) != null) {
