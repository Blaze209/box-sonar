...
public abstract class LookaheadCapablePlaceable extends Placeable implements MeasureScopeWithLayoutNode, MotionReferencePlacementDelegate {
    ...
    public final int get(AlignmentLine alignmentLine) {
        ...
        if (alignmentLine instanceof VerticalAlignmentLine) {
            iM9816getYimpl = IntOffset.m9815getXimpl(getApparentToRealOffset());
        } else {
            iM9816getYimpl = IntOffset.m9816getYimpl(getApparentToRealOffset());
        }
        return iCalculateAlignmentLine + iM9816getYimpl;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:90:0x00a2 A[SYNTHETIC] */
    ...
    /* JADX WARN: Code duplicated, block: B:66:0x011f A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:67:0x0121 A[LOOP:2: B:57:0x00f4->B:67:0x0121, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:80:0x0124 A[EDGE_INSN: B:80:0x0124->B:68:0x0124 BREAK  A[LOOP:2: B:57:0x00f4->B:67:0x0121], SYNTHETIC] */
    public final void captureRulersIfNeeded$ui(MeasureResult result) {
        ...
        if (result != null) {
            ...
            if (rulers != null) {
                ...
                long jM9825getMaxnOccac = IntOffset.INSTANCE.m9825getMaxnOccac();
                ...
                if (!z && getRulerScope().getCoordinatesAccessed()) {
                    ...
                    jM9825getMaxnOccac = IntOffsetKt.m9832roundk4lQ0M(LayoutCoordinatesKt.positionOnScreen(coordinates));
                    jM9863getZeroYbymL2g = coordinates.mo8273getSizeYbymL2g();
                    z = (IntOffset.m9814equalsimpl0(jM9825getMaxnOccac, getRulerScope().getPositionOnScreen()) && IntSize.m9856equalsimpl0(jM9863getZeroYbymL2g, getRulerScope().getSize())) ? false : true;
                }
                long j = jM9825getMaxnOccac;
                long j2 = jM9863getZeroYbymL2g;
                if (z) {
                    ...
                    m8512captureRulersOSxE8f4(placeableResult, j, j2);
    ...
    static /* synthetic */ void m8513captureRulersOSxE8f4$default(LookaheadCapablePlaceable lookaheadCapablePlaceable, PlaceableResult placeableResult, long j, long j2, int i, Object obj) {
        if (obj != null) {
        ...
        if ((i & 2) != 0) {
            j = IntOffset.INSTANCE.m9825getMaxnOccac();
        }
        long j3 = j;
        if ((i & 4) != 0) {
            j2 = IntSize.INSTANCE.m9863getZeroYbymL2g();
        }
        lookaheadCapablePlaceable.m8512captureRulersOSxE8f4(placeableResult, j3, j2);
    }

    /* JADX INFO: renamed from: captureRulers-OSxE8f4, reason: not valid java name */
    private final void m8512captureRulersOSxE8f4(final PlaceableResult placeableResult, final long positionOnScreen, final long size) {
        ...
        if (owner != null && (snapshotObserver = owner.getSnapshotObserver()) != null) {
            snapshotObserver.observer.observeReads(placeableResult, onCommitAffectingRuler, new Function0<Unit>() { // from class: androidx.compose.ui.node.LookaheadCapablePlaceable$captureRulers$1
                ...
                public final void invoke2() {
                    ...
                    this.this$0.getRulerScope().m8517setPositionOnScreengyyYBs(positionOnScreen);
                    this.this$0.getRulerScope().m8518setSizeozmzZPI(size);
    ...
    /* JADX WARN: Code duplicated, block: B:21:0x0058 A[LOOP:0: B:11:0x0021->B:21:0x0058, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:27:0x005b A[EDGE_INSN: B:27:0x005b->B:22:0x005b BREAK  A[LOOP:0: B:11:0x0021->B:21:0x0058], SYNTHETIC] */
    public final void captureRulersIfNeeded(PlaceableResult placeableResult) {
        ...
        MutableScatterMap<Ruler, MutableScatterSet<WeakReference<LayoutNode>>> mutableScatterMap = this.rulerReaders;
        if (rulers != null) {
            m8513captureRulersOSxE8f4$default(this, placeableResult, 0L, 0L, 6, null);
    ...
    final class ResettableRulerScope implements RulerScope {
        ...
        private long positionOnScreen = IntOffset.INSTANCE.m9825getMaxnOccac();
        private long size = IntSize.INSTANCE.m9863getZeroYbymL2g();
        ...
        public final void m8517setPositionOnScreengyyYBs(long j) {
        ...
        public final void m8518setSizeozmzZPI(long j) {
            this.size = j;
        }
        ...
        public LayoutCoordinates getCoordinates() {
            ...
            if (IntOffset.m9814equalsimpl0(this.positionOnScreen, IntOffset.INSTANCE.m9825getMaxnOccac())) {
                this.positionOnScreen = IntOffsetKt.m9832roundk4lQ0M(LayoutCoordinatesKt.positionOnScreen(coordinates));
                this.size = coordinates.mo8273getSizeYbymL2g();
            }
