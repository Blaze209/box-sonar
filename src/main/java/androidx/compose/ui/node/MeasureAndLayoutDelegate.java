...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m8534updateRootConstraintsBRTryo0(long constraints) {
        ...
        this.rootConstraints = Constraints.m9627boximpl(constraints);
    ...
    private final boolean m8531doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM8489lookaheadRemeasure_Sx5XlM$ui$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            zM8489lookaheadRemeasure_Sx5XlM$ui$default = layoutNode.m8496lookaheadRemeasure_Sx5XlM$ui(constraints);
        } else {
            zM8489lookaheadRemeasure_Sx5XlM$ui$default = LayoutNode.m8489lookaheadRemeasure_Sx5XlM$ui$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui = layoutNode.getParent$ui();
        if (zM8489lookaheadRemeasure_Sx5XlM$ui$default && parent$ui != null) {
            if (parent$ui.getLookaheadRoot() == null) {
                LayoutNode.requestRemeasure$ui$default(parent$ui, false, false, false, 3, null);
                return zM8489lookaheadRemeasure_Sx5XlM$ui$default;
            }
    ...
    private final boolean m8532doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM8490remeasure_Sx5XlM$ui$default;
        if (constraints != null) {
            zM8490remeasure_Sx5XlM$ui$default = layoutNode.m8497remeasure_Sx5XlM$ui(constraints);
        } else {
            zM8490remeasure_Sx5XlM$ui$default = LayoutNode.m8490remeasure_Sx5XlM$ui$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui = layoutNode.getParent$ui();
        if (zM8490remeasure_Sx5XlM$ui$default && parent$ui != null) {
            if (layoutNode.getMeasuredByParent$ui() == LayoutNode.UsageByParent.InMeasureBlock) {
                LayoutNode.requestRemeasure$ui$default(parent$ui, false, false, false, 3, null);
                return zM8490remeasure_Sx5XlM$ui$default;
            }
    ...
    public final void m8533measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                if ((m8531doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m9627boximpl(constraints)) || layoutNode.getLookaheadLayoutPending$ui()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
                    layoutNode.lookaheadReplace$ui();
                }
                ensureSubtreeLookaheadReplaced(layoutNode);
                m8532doRemeasuresdFAvZA(layoutNode, Constraints.m9627boximpl(constraints));
    ...
    public final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead, boolean relayoutNeeded) {
        ...
        boolean zM8531doLookaheadRemeasuresdFAvZA;
        LayoutNode parent$ui;
        if (layoutNode.getIsDeactivated()) {
            return false;
        }
        ...
        if (affectsLookahead) {
            zM8531doLookaheadRemeasuresdFAvZA = layoutNode.getLookaheadMeasurePending$ui() ? m8531doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            if (relayoutNeeded && ((zM8531doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true))) {
                layoutNode.lookaheadReplace$ui();
            }
        } else {
            boolean zM8532doRemeasuresdFAvZA = layoutNode.getMeasurePending$ui() ? m8532doRemeasuresdFAvZA(layoutNode, constraints) : false;
            ...
            zM8531doLookaheadRemeasuresdFAvZA = zM8532doRemeasuresdFAvZA;
        }
        drainPostponedMeasureRequests();
        return zM8531doLookaheadRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m8531doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m8532doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
