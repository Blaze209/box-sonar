...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void unInitializeModifier() {
        ...
        if ((NodeKind.m8585constructorimpl(32) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((backwardsCompatNode.getKindSet() & NodeKind.m8585constructorimpl(8)) != 0) {
    ...
    private final void initializeModifier(boolean duringAttach) {
        ...
        if ((NodeKind.m8585constructorimpl(4) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((NodeKind.m8585constructorimpl(2) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((NodeKind.m8585constructorimpl(128) & backwardsCompatNode.getKindSet()) != 0 && (element instanceof OnRemeasuredModifier) && BackwardsCompatNodeKt.isChainUpdate(this)) {
            DelegatableNodeKt.requireLayoutNode(this).invalidateMeasurements$ui();
        }
        if ((NodeKind.m8585constructorimpl(4194304) & backwardsCompatNode.getKindSet()) != 0 && (element instanceof OnPlacedModifier)) {
                ...
                DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode.initializeModifier.3
                    ...
                    public void onLayoutComplete() {
                        if (BackwardsCompatNode.this.lastOnPlacedCoordinates == null) {
                            ...
                            backwardsCompatNode2.onPlaced(DelegatableNodeKt.m8436requireCoordinator64DMado(backwardsCompatNode2, NodeKind.m8585constructorimpl(4194304)));
                        }
                    }
                });
            }
        }
        if ((NodeKind.m8585constructorimpl(256) & backwardsCompatNode.getKindSet()) != 0 && (element instanceof OnGloballyPositionedModifier) && BackwardsCompatNodeKt.isChainUpdate(this)) {
            DelegatableNodeKt.requireLayoutNode(this).invalidateMeasurements$ui();
        }
        if (element instanceof FocusRequesterModifier) {
            ((FocusRequesterModifier) element).getFocusRequester().getFocusRequesterNodes$ui().add(this);
        }
        if ((NodeKind.m8585constructorimpl(16) & backwardsCompatNode.getKindSet()) != 0 && (element instanceof PointerInputModifier)) {
            ((PointerInputModifier) element).getPointerInputFilter().setLayoutCoordinates$ui(getCoordinator());
        }
        if ((NodeKind.m8585constructorimpl(8) & backwardsCompatNode.getKindSet()) != 0) {
            DelegatableNodeKt.requireOwner(this).onSemanticsChange();
        }
    }
    ...
    public long mo6347getSizeNHjbRc() {
        return IntSizeKt.m9870toSizeozmzZPI(DelegatableNodeKt.m8436requireCoordinator64DMado(this, NodeKind.m8585constructorimpl(128)).mo8273getSizeYbymL2g());
    }
    ...
    public <T> T getCurrent(ModifierLocal<T> modifierLocal) {
        ...
        BackwardsCompatNode backwardsCompatNode = this;
        int iM8585constructorimpl = NodeKind.m8585constructorimpl(32);
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return ((LayoutModifier) element).mo1661measure3p2s80s(measureScope, measurable, j);
    }
    ...
    public void mo556onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        ((PointerInputModifier) element).getPointerInputFilter().mo8157onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public void mo743onRemeasuredozmzZPI(long size) {
        ...
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).m8321onRemeasuredozmzZPI(size);
        }
    }
