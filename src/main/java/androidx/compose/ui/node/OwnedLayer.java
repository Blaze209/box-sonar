...
public interface OwnedLayer {
    ...
    float[] mo8642getUnderlyingMatrixsQKQjiQ();

    void invalidate();

    /* JADX INFO: renamed from: inverseTransform-58bKbWc, reason: not valid java name */
    void mo8643inverseTransform58bKbWc(float[] matrix);
    ...
    void mo8648transform58bKbWc(float[] matrix);
