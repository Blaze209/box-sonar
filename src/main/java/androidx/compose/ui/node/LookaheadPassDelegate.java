...
public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LookaheadPassDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            ...
            lookaheadDelegate.mo8265measureBRTryo0(this.this$0.performMeasureConstraints);
        }
    };
    private final Function0<Unit> layoutModifierBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LookaheadPassDelegate$layoutModifierBlock$1
        ...
        public final void invoke2() {
            ...
            Placeable.PlacementScope.m8331place70tqf50$default(placementScope, lookaheadDelegate2, lookaheadPassDelegate.lastPosition, 0.0f, 2, null);
        }
    };
    ...
    public Placeable mo8265measureBRTryo0(long constraints) throws Throwable {
        ...
        m8530remeasureBRTryo0(constraints);
        return this;
    }
    ...
    public final void m8529performMeasureBRTryo0$ui(long constraints) {
    ...
    public final boolean m8530remeasureBRTryo0(long constraints) throws Throwable {
        ...
        try {
            ...
            if (!getLayoutNode().getLookaheadMeasurePending$ui()) {
                ...
                if (constraints2 == null ? false : Constraints.m9633equalsimpl0(constraints2.getValue(), constraints)) {
            ...
            this.lookaheadConstraints = Constraints.m9627boximpl(constraints);
            ...
            if (this.measuredOnce) {
                jM9853constructorimpl = getMeasuredSize();
            } else {
                long j = Integer.MIN_VALUE;
                jM9853constructorimpl = IntSize.m9853constructorimpl((j & 4294967295L) | (j << 32));
            }
            ...
            this.layoutNodeLayoutDelegate.m8511performLookaheadMeasureBRTryo0$ui(constraints);
            m8329setMeasuredSizeozmzZPI(IntSize.m9853constructorimpl((((long) lookaheadDelegate.getHeight()) & 4294967295L) | (((long) lookaheadDelegate.getWidth()) << 32)));
            return (((int) (jM9853constructorimpl >> 32)) == lookaheadDelegate.getWidth() && ((int) (jM9853constructorimpl & 4294967295L)) == lookaheadDelegate.getHeight()) ? false : true;
        } catch (Throwable th) {
    ...
    public void mo8266placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) throws Throwable {
        m8527placeSelfMLgxB_4(position, zIndex, layerBlock, null);
    }
    ...
    public void mo8328placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) throws Throwable {
        m8527placeSelfMLgxB_4(position, zIndex, null, layer);
    }
    ...
    private final void m8527placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) throws Throwable {
        LayoutNode layoutNode = getLayoutNode();
        try {
            LayoutNode parent$ui = getLayoutNode().getParent$ui();
            ...
            if (!IntOffset.m9814equalsimpl0(position, this.lastPosition)) {
            ...
            if (!getLayoutPending() && isPlaced$ui()) {
                LookaheadDelegate lookaheadDelegate = getOuterCoordinator().getLookaheadDelegate();
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.m8524placeSelfApparentToRealOffsetgyyYBs$ui(position);
                onNodePlaced$ui();
            } else {
    ...
    private final void onBeforeLayoutChildren() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui() && layoutNode.getMeasuredByParentInLookahead$ui() == LayoutNode.UsageByParent.InMeasureBlock) {
                ...
                Intrinsics.checkNotNull(lookaheadPassDelegate);
                Constraints constraintsM8510getLastLookaheadConstraintsDWUhwKw = layoutNode.getLayoutDelegate().m8510getLastLookaheadConstraintsDWUhwKw();
                Intrinsics.checkNotNull(constraintsM8510getLastLookaheadConstraintsDWUhwKw);
                if (lookaheadPassDelegate.m8530remeasureBRTryo0(constraintsM8510getLastLookaheadConstraintsDWUhwKw.getValue())) {
                    LayoutNode.requestLookaheadRemeasure$ui$default(getLayoutNode(), false, false, false, 7, null);
                }
            }
        }
    ...
    public final void replace() {
        ...
        try {
            ...
            try {
                lookaheadPassDelegate.m8527placeSelfMLgxB_4(this.lastPosition, 0.0f, this.lastLayerBlock, this.lastExplicitLayer);
