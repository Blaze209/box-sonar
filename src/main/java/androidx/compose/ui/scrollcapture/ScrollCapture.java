...
public final class ScrollCapture implements ComposeScrollCaptureCallback.ScrollCaptureSessionListener {
    ...
    public final void onScrollCaptureSearch(View view, SemanticsOwner semanticsOwner, CoroutineContext coroutineContext, Consumer<ScrollCaptureTarget> targets) {
        ...
        long jM9844getTopLeftnOccac = scrollCaptureCandidate.getViewportBoundsInWindow().m9844getTopLeftnOccac();
        ScrollCaptureTarget scrollCaptureTarget = new ScrollCaptureTarget(view, RectHelper_androidKt.toAndroidRect(IntRectKt.roundToIntRect(rectBoundsInRoot)), new Point(IntOffset.m9815getXimpl(jM9844getTopLeftnOccac), IntOffset.m9816getYimpl(jM9844getTopLeftnOccac)), composeScrollCaptureCallback);
