...
public interface BeyondBoundsLayout {
    ...
    <T> T mo1398layouto7g1Pn8(int direction, Function1<? super BeyondBoundsScope, ? extends T> block);
    ...
    public static final class LayoutDirection {
        ...
        private static final int Before = m8246constructorimpl(1);
        private static final int After = m8246constructorimpl(2);
        private static final int Left = m8246constructorimpl(3);
        private static final int Right = m8246constructorimpl(4);
        private static final int Above = m8246constructorimpl(5);
        private static final int Below = m8246constructorimpl(6);

        /* JADX INFO: renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ LayoutDirection m8245boximpl(int i) {
            return new LayoutDirection(i);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static int m8246constructorimpl(int i) {
            return i;
        }

        /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
        public static boolean m8247equalsimpl(int i, Object obj) {
            return (obj instanceof LayoutDirection) && i == ((LayoutDirection) obj).getValue();
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m8248equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m8249hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        public boolean equals(Object other) {
            return m8247equalsimpl(this.value, other);
        }

        public int hashCode() {
            return m8249hashCodeimpl(this.value);
        }
        ...
        public String toString() {
            return m8250toStringimpl(this.value);
        }

        /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
        public static String m8250toStringimpl(int i) {
            if (m8248equalsimpl0(i, Before)) {
                return "Before";
            }
            if (m8248equalsimpl0(i, After)) {
                return "After";
            }
            if (m8248equalsimpl0(i, Left)) {
                return "Left";
            }
            if (m8248equalsimpl0(i, Right)) {
                return "Right";
            }
            if (m8248equalsimpl0(i, Above)) {
                return "Above";
            }
            return m8248equalsimpl0(i, Below) ? "Below" : "invalid LayoutDirection";
        }
    }
}
