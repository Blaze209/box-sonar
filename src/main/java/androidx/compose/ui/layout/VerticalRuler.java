...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Float.intBitsToFloat((int) (targetCoordinates.mo8274localPositionOfR5De75A(sourceCoordinates, Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(((int) (sourceCoordinates.mo8273getSizeYbymL2g() & 4294967295L)) / 2.0f)) & 4294967295L) | (Float.floatToRawIntBits(coordinate) << 32))) >> 32));
    }
