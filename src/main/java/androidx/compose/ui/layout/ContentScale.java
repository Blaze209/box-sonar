...
public interface ContentScale {
    ...
    long mo8258computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo8258computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM8262computeFillMaxDimensioniLBOSCw = ContentScaleKt.m8262computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactor.m8375constructorimpl((((long) Float.floatToRawIntBits(fM8262computeFillMaxDimensioniLBOSCw)) << 32) | (((long) Float.floatToRawIntBits(fM8262computeFillMaxDimensioniLBOSCw)) & 4294967295L));
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo8258computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM8263computeFillMinDimensioniLBOSCw = ContentScaleKt.m8263computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactor.m8375constructorimpl((((long) Float.floatToRawIntBits(fM8263computeFillMinDimensioniLBOSCw)) << 32) | (((long) Float.floatToRawIntBits(fM8263computeFillMinDimensioniLBOSCw)) & 4294967295L));
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            public long mo8258computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                return ScaleFactor.m8375constructorimpl((((long) Float.floatToRawIntBits(fIntBitsToFloat)) << 32) | (((long) Float.floatToRawIntBits(fIntBitsToFloat)) & 4294967295L));
            }
        };
        ...
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            public long mo8258computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                return ScaleFactor.m8375constructorimpl((((long) Float.floatToRawIntBits(1.0f)) << 32) | (((long) Float.floatToRawIntBits(1.0f)) & 4294967295L));
            }
        };
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            public long mo8258computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                return ScaleFactor.m8375constructorimpl((((long) Float.floatToRawIntBits(fIntBitsToFloat)) << 32) | (((long) Float.floatToRawIntBits(fIntBitsToFloat2)) & 4294967295L));
            }
        };
