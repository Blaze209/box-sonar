...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo8265measureBRTryo0(long constraints) {
        ...
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(iMinIntrinsicWidth, Constraints.m9635getHasBoundedHeightimpl(constraints) ? Constraints.m9639getMaxHeightimpl(constraints) : 32767);
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m9636getHasBoundedWidthimpl(constraints) ? Constraints.m9640getMaxWidthimpl(constraints) : 32767, iMinIntrinsicHeight);
    }
