...
public interface ApproachLayoutModifierNode extends LayoutModifierNode {
    ...
    MeasureResult mo377approachMeasure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j);

    /* JADX INFO: renamed from: isMeasurementApproachInProgress-ozmzZPI */
    boolean mo378isMeasurementApproachInProgressozmzZPI(long lookaheadSize);
    ...
    default MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo0.getWidth(), placeableMo8265measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.ApproachLayoutModifierNode$measure$1$1
            {
                super(1);
            }
    ...
    default int minApproachIntrinsicWidth(ApproachIntrinsicMeasureScope approachIntrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        ...
        if (lookaheadDelegate.getHasMeasureResult()) {
            return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui(new NodeMeasuringIntrinsics.ApproachMeasureBlock() { // from class: androidx.compose.ui.layout.ApproachLayoutModifierNode.minApproachIntrinsicWidth.1
                ...
                /* JADX INFO: renamed from: measure-3p2s80s */
                public final MeasureResult mo8244measure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j) {
                    return ApproachLayoutModifierNode.this.mo377approachMeasure3p2s80s(approachMeasureScope, measurable, j);
                }
