...
public final class SubcomposeLayoutKt {
    ...
    public static final void SubcomposeLayout(final Modifier modifier, Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer composer, final int i, final int i2) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i3 & 19) != 18, i3 & 1)) {
            ...
            function3 = function2;
            SubcomposeLayout((SubcomposeLayoutState) objRememberedValue, modifier2, function3, composerStartRestartGroup, (i3 << 3) & 1008, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void SubcomposeLayout(final SubcomposeLayoutState subcomposeLayoutState, Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer composer, final int i, final int i2) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i3 & Token.DOTQUERY) != 146, i3 & 1)) {
            ...
            Updater.m6070setimpl(composerM6062constructorimpl, subcomposeLayoutState, subcomposeLayoutState.getSetRoot$ui());
            Updater.m6070setimpl(composerM6062constructorimpl, compositionContextRememberCompositionContext, subcomposeLayoutState.getSetCompositionContext$ui());
            Updater.m6070setimpl(composerM6062constructorimpl, function2, subcomposeLayoutState.getSetMeasurePolicy$ui());
