...
final class SLOperation {
    ...
    private static final int CancelPausedPrecomposition = m8348constructorimpl(0);
    private static final int ReuseForceSyncDeactivation = m8348constructorimpl(1);
    private static final int ReuseScheduleOutOfFrameDeactivation = m8348constructorimpl(2);
    private static final int ReuseSyncDeactivation = m8348constructorimpl(3);
    private static final int ReuseDeactivationViaHost = m8348constructorimpl(4);
    private static final int TookFromPrecomposeMap = m8348constructorimpl(5);
    private static final int Subcompose = m8348constructorimpl(6);
    private static final int SubcomposeNew = m8348constructorimpl(7);
    private static final int SubcomposePausable = m8348constructorimpl(8);
    private static final int SubcomposeForceReuse = m8348constructorimpl(9);
    private static final int DeactivateOutOfFrame = m8348constructorimpl(10);
    private static final int DeactivateOutOfFrameCancelled = m8348constructorimpl(11);
    private static final int SlotToReusedFromOnDeactivate = m8348constructorimpl(12);
    private static final int SlotToReusedFromOnReuse = m8348constructorimpl(13);
    private static final int Reused = m8348constructorimpl(14);
    private static final int ResumePaused = m8348constructorimpl(15);
    private static final int PausePaused = m8348constructorimpl(16);
    private static final int ApplyPaused = m8348constructorimpl(17);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ SLOperation m8347boximpl(int i) {
        return new SLOperation(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m8348constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m8349equalsimpl(int i, Object obj) {
        return (obj instanceof SLOperation) && i == ((SLOperation) obj).m8353unboximpl();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m8350equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public static String m8352toStringimpl(int i) {
    ...
    public final /* synthetic */ int m8353unboximpl() {
        return this.value;
    }
    ...
    public static final class Companion {
        ...
        public final int m8355getCancelPausedPrecompositionNjRlDlw() {
        ...
        public final int m8361getReuseForceSyncDeactivationNjRlDlw() {
        ...
        public final int m8362getReuseScheduleOutOfFrameDeactivationNjRlDlw() {
        ...
        public final int m8363getReuseSyncDeactivationNjRlDlw() {
        ...
        public final int m8360getReuseDeactivationViaHostNjRlDlw() {
        ...
        public final int m8357getDeactivateOutOfFrameCancelledNjRlDlw() {
        ...
        public final int m8365getSlotToReusedFromOnDeactivateNjRlDlw() {
