...
public final class OnSizeChangedNode extends Modifier.Node implements LayoutAwareModifierNode {
    ...
    public OnSizeChangedNode(Function1<? super IntSize, Unit> function1) {
        ...
        this.previousSize = IntSize.m9853constructorimpl((j & 4294967295L) | (j << 32));
    }
    ...
    public void mo743onRemeasuredozmzZPI(long size) {
        if (IntSize.m9856equalsimpl0(this.previousSize, size)) {
            return;
        }
        this.onSizeChanged.invoke(IntSize.m9850boximpl(size));
