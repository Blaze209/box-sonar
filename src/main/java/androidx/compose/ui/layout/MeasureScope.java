...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m8309roundToPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo747roundToPxR2X_6o(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m8310roundToPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo748roundToPx0680j_4(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m8311toDpGaN1DYA(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo749toDpGaN1DYA(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m8312toDpu2uoSUM(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo750toDpu2uoSUM(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m8313toDpu2uoSUM(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo751toDpu2uoSUM(i);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m8314toDpSizekrfVVM(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo752toDpSizekrfVVM(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m8315toPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo753toPxR2X_6o(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m8316toPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo754toPx0680j_4(f);
        }
        ...
        public static long m8317toSizeXkaWNTQ(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo755toSizeXkaWNTQ(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m8318toSp0xMU5do(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo756toSp0xMU5do(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m8319toSpkPz2Gy4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo757toSpkPz2Gy4(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m8320toSpkPz2Gy4(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo758toSpkPz2Gy4(i);
        }
