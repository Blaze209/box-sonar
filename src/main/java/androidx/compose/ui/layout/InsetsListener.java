...
public final class InsetsListener extends WindowInsetsAnimationCompat.Callback implements Runnable, OnApplyWindowInsetsListener, View.OnAttachStateChangeListener {
    ...
    public WindowInsetsAnimationCompat.BoundsCompat onStart(WindowInsetsAnimationCompat animation, WindowInsetsAnimationCompat.BoundsCompat bounds) {
        ...
        if (animation.getDurationMillis() > 0 && windowInsetsCompat != null) {
            ...
            if (windowInsetsRulers != null) {
                ...
                long jM8399constructorimpl = ValueInsets.m8399constructorimpl(((long) insets.bottom) | (((long) insets.left) << 48) | (((long) insets.top) << 32) | (((long) insets.right) << 16));
                long current = windowWindowInsetsAnimationValues2.getCurrent();
                if (!ValueInsets.m8401equalsimpl0(jM8399constructorimpl, current)) {
                    windowWindowInsetsAnimationValues2.m8416setSourceValueInsetsYnlvx88(current);
                    windowWindowInsetsAnimationValues2.m8417setTargetValueInsetsYnlvx88(jM8399constructorimpl);
    ...
    private final void stopAnimationForRuler(WindowWindowInsetsAnimationValues insetsValue) {
        ...
        insetsValue.m8416setSourceValueInsetsYnlvx88(ValueInsets_androidKt.getUnsetValueInsets());
        insetsValue.m8417setTargetValueInsetsYnlvx88(ValueInsets_androidKt.getUnsetValueInsets());
    }
    ...
    private final void updateInsets(WindowInsetsCompat insets) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i4 < i3) {
                        if ((j & 255) < 128) {
                            ...
                            long jM8399constructorimpl2 = ValueInsets.m8399constructorimpl((((long) insets2.left) << 48) | (((long) insets2.top) << 32) | (((long) insets2.right) << c4) | ((long) insets2.bottom));
                            WindowWindowInsetsAnimationValues windowWindowInsetsAnimationValues = this.insetsValues.get(windowInsetsRulers);
                            Intrinsics.checkNotNull(windowWindowInsetsAnimationValues);
                            WindowWindowInsetsAnimationValues windowWindowInsetsAnimationValues2 = windowWindowInsetsAnimationValues;
                            if (!ValueInsets.m8401equalsimpl0(jM8399constructorimpl2, windowWindowInsetsAnimationValues2.getCurrent())) {
                                windowWindowInsetsAnimationValues2.m8414setCurrentYnlvx88(jM8399constructorimpl2);
                                z2 = true;
                                if (!ValueInsets.m8401equalsimpl0(jM8399constructorimpl2, ValueInsets_androidKt.getZeroValueInsets())) {
                                    z3 = true;
                                }
                            }
                            if (i6 != WindowInsetsCompat.Type.ime()) {
                                ...
                                objArr2 = objArr3;
                                long jM8399constructorimpl3 = ValueInsets.m8399constructorimpl((((long) insetsIgnoringVisibility.top) << 32) | (((long) insetsIgnoringVisibility.left) << 48) | (((long) insetsIgnoringVisibility.right) << c4) | ((long) insetsIgnoringVisibility.bottom));
                                if (!ValueInsets.m8401equalsimpl0(windowWindowInsetsAnimationValues2.getMaximum(), jM8399constructorimpl3)) {
                                    windowWindowInsetsAnimationValues2.m8415setMaximumYnlvx88(jM8399constructorimpl3);
                                    z2 = true;
                                    if (!ValueInsets.m8401equalsimpl0(jM8399constructorimpl3, ValueInsets_androidKt.getZeroValueInsets())) {
                                        z3 = true;
                                    }
                                }
                            } else {
                            ...
                            windowWindowInsetsAnimationValues2.setVisible(insets.isVisible(i6));
                        } else {
                            c4 = c5;
                            objArr2 = objArr3;
                        }
        ...
        if (displayCutout == null) {
            jM8399constructorimpl = ValueInsets_androidKt.getZeroValueInsets();
        } else {
            Insets waterfallInsets = displayCutout.getWaterfallInsets();
            jM8399constructorimpl = ValueInsets.m8399constructorimpl((((long) waterfallInsets.left) << c2) | (((long) waterfallInsets.top) << c) | (((long) waterfallInsets.right) << c3) | ((long) waterfallInsets.bottom));
        }
        ...
        windowWindowInsetsAnimationValues4.setVisible(!ValueInsets.m8401equalsimpl0(jM8399constructorimpl, ValueInsets_androidKt.getZeroValueInsets()));
        if (!ValueInsets.m8401equalsimpl0(windowWindowInsetsAnimationValues4.getCurrent(), jM8399constructorimpl)) {
            windowWindowInsetsAnimationValues4.m8414setCurrentYnlvx88(jM8399constructorimpl);
            windowWindowInsetsAnimationValues4.m8415setMaximumYnlvx88(jM8399constructorimpl);
            z2 = z;
            if (!ValueInsets.m8401equalsimpl0(jM8399constructorimpl, ValueInsets_androidKt.getZeroValueInsets())) {
                z3 = z2;
            }
        }
        if (displayCutout == null) {
            ...
            for (int i9 = 0; i9 < size2; i9++) {
                ...
                MutableState<Rect> mutableState = this.displayCutouts.get(i9);
