...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m9834getSizeYbymL2g$annotations() {
    }
    ...
    public final long m9842getSizeYbymL2g() {
        return IntSize.m9853constructorimpl((((long) getWidth()) << 32) | (((long) getHeight()) & 4294967295L));
    }
    ...
    public final IntRect m9846translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m9815getXimpl(offset), this.top + IntOffset.m9816getYimpl(offset), this.right + IntOffset.m9815getXimpl(offset), this.bottom + IntOffset.m9816getYimpl(offset));
    }
    ...
    public final long m9844getTopLeftnOccac() {
        return IntOffset.m9809constructorimpl((((long) this.left) << 32) | (((long) this.top) & 4294967295L));
    }

    /* JADX INFO: renamed from: getTopCenter-nOcc-ac, reason: not valid java name */
    public final long m9843getTopCenternOccac() {
        return IntOffset.m9809constructorimpl((((long) (this.left + (getWidth() / 2))) << 32) | (((long) this.top) & 4294967295L));
    }

    /* JADX INFO: renamed from: getTopRight-nOcc-ac, reason: not valid java name */
    public final long m9845getTopRightnOccac() {
        return IntOffset.m9809constructorimpl((((long) this.right) << 32) | (((long) this.top) & 4294967295L));
    }

    /* JADX INFO: renamed from: getCenterLeft-nOcc-ac, reason: not valid java name */
    public final long m9840getCenterLeftnOccac() {
        return IntOffset.m9809constructorimpl((((long) (this.top + (getHeight() / 2))) & 4294967295L) | (((long) this.left) << 32));
    }

    /* JADX INFO: renamed from: getCenter-nOcc-ac, reason: not valid java name */
    public final long m9839getCenternOccac() {
        return IntOffset.m9809constructorimpl((((long) (this.top + (getHeight() / 2))) & 4294967295L) | (((long) (this.left + (getWidth() / 2))) << 32));
    }

    /* JADX INFO: renamed from: getCenterRight-nOcc-ac, reason: not valid java name */
    public final long m9841getCenterRightnOccac() {
        return IntOffset.m9809constructorimpl((((long) (this.top + (getHeight() / 2))) & 4294967295L) | (((long) this.right) << 32));
    }

    /* JADX INFO: renamed from: getBottomLeft-nOcc-ac, reason: not valid java name */
    public final long m9837getBottomLeftnOccac() {
        return IntOffset.m9809constructorimpl((((long) this.left) << 32) | (((long) this.bottom) & 4294967295L));
    }

    /* JADX INFO: renamed from: getBottomCenter-nOcc-ac, reason: not valid java name */
    public final long m9836getBottomCenternOccac() {
        return IntOffset.m9809constructorimpl((((long) (this.left + (getWidth() / 2))) << 32) | (((long) this.bottom) & 4294967295L));
    }

    /* JADX INFO: renamed from: getBottomRight-nOcc-ac, reason: not valid java name */
    public final long m9838getBottomRightnOccac() {
        return IntOffset.m9809constructorimpl((((long) this.right) << 32) | (((long) this.bottom) & 4294967295L));
    }

    /* JADX INFO: renamed from: contains--gyyYBs, reason: not valid java name */
    public final boolean m9835containsgyyYBs(long offset) {
        return IntOffset.m9815getXimpl(offset) >= this.left && IntOffset.m9815getXimpl(offset) < this.right && IntOffset.m9816getYimpl(offset) >= this.top && IntOffset.m9816getYimpl(offset) < this.bottom;
    }
