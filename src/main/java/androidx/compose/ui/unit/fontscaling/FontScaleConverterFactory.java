...
public final class FontScaleConverterFactory {
    ...
    private final void put(float scaleKey, FontScaleConverter fontScaleConverter) {
        synchronized (LookupTablesWriteLock) {
            ...
            SparseArrayCompat<FontScaleConverter> sparseArrayCompatM337clone = sLookupTables.m337clone();
            fontScaleConverterFactory.putInto(sparseArrayCompatM337clone, scaleKey, fontScaleConverter);
            sLookupTables = sparseArrayCompatM337clone;
            Unit unit = Unit.INSTANCE;
        }
    }
