...
public interface FontScaling {
    ...
    public static final class DefaultImpls {
        ...
        public static long m9799toSp0xMU5do(FontScaling fontScaling, float f) {
            return FontScaling.super.mo756toSp0xMU5do(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m9798toDpGaN1DYA(FontScaling fontScaling, long j) {
            return FontScaling.super.mo749toDpGaN1DYA(j);
        }
    }

    /* JADX INFO: renamed from: toSp-0xMU5do */
    default long mo756toSp0xMU5do(float f) {
    ...
    default float mo749toDpGaN1DYA(long j) {
        if (!TextUnitType.m9909equalsimpl0(TextUnit.m9880getTypeUIouoOA(j), TextUnitType.INSTANCE.m9914getSpUIouoOA())) {
            InlineClassHelperKt.throwIllegalStateException("Only Sp can convert to Px");
        }
        if (!FontScaleConverterFactory.INSTANCE.isNonLinearFontScalingActive(getFontScale())) {
            return Dp.m9687constructorimpl(TextUnit.m9881getValueimpl(j) * getFontScale());
        }
        FontScaleConverter fontScaleConverterForScale = FontScaleConverterFactory.INSTANCE.forScale(getFontScale());
        return fontScaleConverterForScale == null ? Dp.m9687constructorimpl(TextUnit.m9881getValueimpl(j) * getFontScale()) : Dp.m9687constructorimpl(fontScaleConverterForScale.convertSpToDp(TextUnit.m9881getValueimpl(j)));
    }
}
