...
public final class TextUnitType {
    ...
    private static final long Unspecified = m9907constructorimpl(0);
    private static final long Sp = m9907constructorimpl(4294967296L);
    private static final long Em = m9907constructorimpl(8589934592L);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextUnitType m9906boximpl(long j) {
        return new TextUnitType(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m9907constructorimpl(long j) {
        return j;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m9908equalsimpl(long j, Object obj) {
        return (obj instanceof TextUnitType) && j == ((TextUnitType) obj).getType();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m9909equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m9910hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    public boolean equals(Object other) {
        return m9908equalsimpl(this.type, other);
    }

    public int hashCode() {
        return m9910hashCodeimpl(this.type);
    }
    ...
    public String toString() {
        return m9911toStringimpl(this.type);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m9911toStringimpl(long j) {
        if (m9909equalsimpl0(j, Unspecified)) {
            return "Unspecified";
        }
        if (m9909equalsimpl0(j, Sp)) {
            return "Sp";
        }
        return m9909equalsimpl0(j, Em) ? "Em" : "Invalid";
    }
