...
final /* data */ class DensityWithConverter implements Density {
    ...
    public float mo749toDpGaN1DYA(long j) {
        ...
        return Dp.m9687constructorimpl(this.converter.convertSpToDp(TextUnit.m9881getValueimpl(j)));
    }
}
