...
public final class RelativeLayoutBounds {
    ...
    public final long m8861getPositionInRootnOccac() {
        return IntOffset.m9809constructorimpl(this.topLeft);
    }

    /* JADX INFO: renamed from: getPositionInWindow-nOcc-ac, reason: not valid java name */
    public final long m8863getPositionInWindownOccac() {
        int iM9815getXimpl = IntOffset.m9815getXimpl(this.screenOffset) - IntOffset.m9815getXimpl(this.windowOffset);
        int iM9816getYimpl = IntOffset.m9816getYimpl(this.screenOffset) - IntOffset.m9816getYimpl(this.windowOffset);
        long j = this.topLeft;
        return IntOffset.m9809constructorimpl((((long) (((int) (j >> 32)) + iM9815getXimpl)) << 32) | (((long) (((int) j) + iM9816getYimpl)) & 4294967295L));
    }

    /* JADX INFO: renamed from: getPositionInScreen-nOcc-ac, reason: not valid java name */
    public final long m8862getPositionInScreennOccac() {
        int iM9815getXimpl = IntOffset.m9815getXimpl(this.screenOffset);
        int iM9816getYimpl = IntOffset.m9816getYimpl(this.screenOffset);
        long j = this.topLeft;
        return IntOffset.m9809constructorimpl((((long) (((int) (j >> 32)) + iM9815getXimpl)) << 32) | (((long) (((int) j) + iM9816getYimpl)) & 4294967295L));
    }
    ...
    public final IntRect getBoundsInWindow() {
        ...
        if (fArr != null) {
            return IntRectKt.roundToIntRect(Matrix.m7067mapimpl(fArr, new Rect(i, i2, i3, i4)));
        }
        int iM9815getXimpl = IntOffset.m9815getXimpl(this.screenOffset) - IntOffset.m9815getXimpl(this.windowOffset);
        int iM9816getYimpl = IntOffset.m9816getYimpl(this.screenOffset) - IntOffset.m9816getYimpl(this.windowOffset);
        return new IntRect(i + iM9815getXimpl, i2 + iM9816getYimpl, i3 + iM9815getXimpl, i4 + iM9816getYimpl);
    }
    ...
    public final IntRect getBoundsInScreen() {
        if (this.viewToWindowMatrix != null) {
            ...
            return new IntRect(boundsInWindow.getLeft() + IntOffset.m9815getXimpl(j), boundsInWindow.getTop() + IntOffset.m9816getYimpl(j), boundsInWindow.getRight() + IntOffset.m9815getXimpl(j), boundsInWindow.getBottom() + IntOffset.m9816getYimpl(j));
        }
        ...
        int iM9815getXimpl = IntOffset.m9815getXimpl(this.screenOffset);
        int iM9816getYimpl = IntOffset.m9816getYimpl(this.screenOffset);
        return new IntRect(i + iM9815getXimpl, ((int) j2) + iM9816getYimpl, i2 + iM9815getXimpl, i3 + iM9816getYimpl);
    }
    ...
    public final float m8860fractionVisibleInWindowWithInsetsE1MhUcY(long topLeftInset, long bottomRightInset) {
        long j = this.windowSize;
        int iM9815getXimpl = IntOffset.m9815getXimpl(this.windowOffset);
        int iM9816getYimpl = IntOffset.m9816getYimpl(this.windowOffset);
        return fractionVisibleInRect(IntOffset.m9815getXimpl(topLeftInset) + iM9815getXimpl, IntOffset.m9816getYimpl(topLeftInset) + iM9816getYimpl, (iM9815getXimpl + ((int) (j >> 32))) - IntOffset.m9815getXimpl(bottomRightInset), (iM9816getYimpl + ((int) j)) - IntOffset.m9816getYimpl(bottomRightInset));
    }

    /* JADX WARN: Code duplicated, block: B:30:0x0051  */
    public boolean equals(Object other) {
        boolean zM7062equalsimpl0;
        if (this == other) {
            return true;
        }
        ...
        if (this.topLeft != relativeLayoutBounds.topLeft || this.bottomRight != relativeLayoutBounds.bottomRight || this.windowSize != relativeLayoutBounds.windowSize || !IntOffset.m9814equalsimpl0(this.windowOffset, relativeLayoutBounds.windowOffset) || !IntOffset.m9814equalsimpl0(this.screenOffset, relativeLayoutBounds.screenOffset)) {
            return false;
        }
        float[] fArr = this.viewToWindowMatrix;
        ...
        if (fArr == null) {
            if (fArr2 == null) {
                zM7062equalsimpl0 = true;
            } else {
                zM7062equalsimpl0 = false;
            }
        } else if (fArr2 == null) {
            zM7062equalsimpl0 = false;
        } else {
            zM7062equalsimpl0 = Matrix.m7062equalsimpl0(fArr, fArr2);
        }
        return zM7062equalsimpl0 && Intrinsics.areEqual(this.node, relativeLayoutBounds.node);
    }

    public int hashCode() {
        int iHashCode = ((((((((Long.hashCode(this.topLeft) * 31) + Long.hashCode(this.bottomRight)) * 31) + Long.hashCode(this.windowSize)) * 31) + IntOffset.m9817hashCodeimpl(this.windowOffset)) * 31) + IntOffset.m9817hashCodeimpl(this.screenOffset)) * 31;
        float[] fArr = this.viewToWindowMatrix;
        return ((iHashCode + (fArr != null ? Matrix.m7064hashCodeimpl(fArr) : 0)) * 31) + this.node.hashCode();
    }
}
