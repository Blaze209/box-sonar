...
public final class RectManagerKt {
    ...
    public static final boolean m8859isSetgyyYBs(long j) {
        return !IntOffset.m9814equalsimpl0(j, IntOffset.INSTANCE.m9825getMaxnOccac());
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: analyzeComponents-58bKbWc, reason: not valid java name */
    public static final int m8858analyzeComponents58bKbWc(float[] fArr) {
        int i = 0;
        if (fArr.length < 16) {
            return 0;
        }
