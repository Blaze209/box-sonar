...
public final class DerivedSize {
    ...
    private static final DerivedSize Zero = new DerivedSize(IntSize.INSTANCE.m9863getZeroYbymL2g(), DpSize.INSTANCE.m9795getZeroMYxV2XQ(), null);
    ...
    public static final class Companion {
        ...
        public final DerivedSize m8745fromPxSizeviCIZxY(long pxSize, Density density) {
            return new DerivedSize(pxSize, density.mo752toDpSizekrfVVM(IntSizeKt.m9870toSizeozmzZPI(pxSize)), null);
        }

        /* JADX INFO: renamed from: fromDpSize-itqla9I, reason: not valid java name */
        public final DerivedSize m8744fromDpSizeitqla9I(long dpSize, Density density) {
            return new DerivedSize(IntSizeKt.m9869toIntSizeuvyYCjk(density.mo755toSizeXkaWNTQ(dpSize)), dpSize, null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return IntSize.m9856equalsimpl0(this.pxSize, derivedSize.pxSize) && DpSize.m9782equalsimpl0(this.dpSize, derivedSize.dpSize);
    }

    public int hashCode() {
        return (IntSize.m9859hashCodeimpl(this.pxSize) * 31) + DpSize.m9787hashCodeimpl(this.dpSize);
    }
}
