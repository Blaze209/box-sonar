...
public final class AndroidPlatformTextInputSession implements PlatformTextInputSessionScope, CoroutineScope {
    ...
    private final AtomicReference<SessionMutex.Session<InputMethodSession>> methodSessionMutex = SessionMutex.m6302constructorimpl();
    ...
    public final boolean isReadyForConnection() {
        InputMethodSession inputMethodSession = (InputMethodSession) SessionMutex.m6306getCurrentSessionimpl(this.methodSessionMutex);
    ...
    public Object startInputMethod(final PlatformTextInputMethodRequest platformTextInputMethodRequest, Continuation<?> continuation) {
        ...
        if (i == 0) {
            ...
            if (SessionMutex.m6309withSessionCancellingPreviousimpl(atomicReference, function1, anonymousClass3, anonymousClass1) == coroutine_suspended) {
