...
public final class IndirectPointerNavigationGestureDetector {
    ...
    private int primaryDirectionalMotionAxis = IndirectPointerEventPrimaryDirectionalMotionAxis.INSTANCE.m7647getNonenZO2Niw();
    ...
    public IndirectPointerNavigationGestureDetector(Context context, Function1<? super FocusDirection, Unit> function1) {
        ...
        this.gestureDetector = new GestureDetector(context, new GestureDetector.OnGestureListener() { // from class: androidx.compose.ui.platform.IndirectPointerNavigationGestureDetector$gestureDetector$1
            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
                ...
                if (IndirectPointerEventPrimaryDirectionalMotionAxis.m7643equalsimpl0(this.this$0.getPrimaryDirectionalMotionAxis(), IndirectPointerEventPrimaryDirectionalMotionAxis.INSTANCE.m7648getXnZO2Niw())) {
                    if (Math.abs(velocityX) > Math.abs(velocityY)) {
                        this.this$0.onMoveFocus.invoke(FocusDirection.m6441boximpl(velocityX > 0.0f ? FocusDirection.INSTANCE.m6452getNextdhqQ8s() : FocusDirection.INSTANCE.m6453getPreviousdhqQ8s()));
                    }
                } else if (IndirectPointerEventPrimaryDirectionalMotionAxis.m7643equalsimpl0(this.this$0.getPrimaryDirectionalMotionAxis(), IndirectPointerEventPrimaryDirectionalMotionAxis.INSTANCE.m7649getYnZO2Niw()) && Math.abs(velocityY) > Math.abs(velocityX)) {
                    this.this$0.onMoveFocus.invoke(FocusDirection.m6441boximpl(velocityY > 0.0f ? FocusDirection.INSTANCE.m6452getNextdhqQ8s() : FocusDirection.INSTANCE.m6453getPreviousdhqQ8s()));
                }
                return true;
            }
        });
    ...
    public final void m8769setPrimaryDirectionalMotionAxisWQKaTuc(int i) {
    ...
    public final void cancelCurrentEventStream() {
        this.primaryDirectionalMotionAxis = IndirectPointerEventPrimaryDirectionalMotionAxis.INSTANCE.m7647getNonenZO2Niw();
