...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView androidComposeView, DrawChildContainer drawChildContainer, Function2<? super Canvas, ? super GraphicsLayer, Unit> function2, Function0<Unit> function0) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m7229getCenterSzJe1aQ();
    ...
    public float[] mo8642getUnderlyingMatrixsQKQjiQ() {
        return this.matrixCache.m8773calculateMatrixGrdbGEg(this);
    }
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        int iMo7009getCompositingStrategyNrFUSI;
        Function0<Unit> function0;
        int mutatedFields$ui = scope.getMutatedFields() | this.mutatedFields;
        if ((mutatedFields$ui & 4096) != 0) {
            long jMo7012getTransformOriginSzJe1aQ = scope.getTransformOrigin();
            this.mTransformOrigin = jMo7012getTransformOriginSzJe1aQ;
            setPivotX(TransformOrigin.m7224getPivotFractionXimpl(jMo7012getTransformOriginSzJe1aQ) * getWidth());
            setPivotY(TransformOrigin.m7225getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        }
        ...
        boolean zM8803updateS_szKao = this.outlineResolver.m8803updateS_szKao(scope.getOutline(), scope.getAlpha(), z3, scope.getShadowElevation(), scope.getSize());
        if (this.outlineResolver.getCacheIsDirty()) {
            updateOutlineResolver();
        }
        boolean z4 = getManualClipPath() != null;
        if (z2 != z4 || (z4 && zM8803updateS_szKao)) {
            invalidate();
        }
        ...
        if ((mutatedFields$ui & 64) != 0) {
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this, ColorKt.m6868toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields$ui & 128) != 0) {
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this, ColorKt.m6868toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if ((mutatedFields$ui & 32768) != 0 || z5) {
            if (z5) {
                iMo7009getCompositingStrategyNrFUSI = CompositingStrategy.INSTANCE.m6907getOffscreenNrFUSI();
            } else {
                iMo7009getCompositingStrategyNrFUSI = scope.getCompositingStrategy();
            }
            android.graphics.Paint paintAsFrameworkPaint = null;
            if (CompositingStrategy.m6901equalsimpl0(iMo7009getCompositingStrategyNrFUSI, CompositingStrategy.INSTANCE.m6907getOffscreenNrFUSI())) {
                if (z5) {
                    Paint paintObtainLayerPaint = obtainLayerPaint();
                    paintObtainLayerPaint.setColorFilter(scope.getColorFilter());
                    paintObtainLayerPaint.mo6689setBlendModes9anfk8(scope.getBlendMode());
                    paintAsFrameworkPaint = paintObtainLayerPaint.getInternalPaint();
                }
                setLayerType(2, paintAsFrameworkPaint);
            } else {
                if (CompositingStrategy.m6901equalsimpl0(iMo7009getCompositingStrategyNrFUSI, CompositingStrategy.INSTANCE.m6906getModulateAlphaNrFUSI())) {
                    setLayerType(0, null);
                } else {
                    setLayerType(0, null);
                }
    ...
    public void mo8647resizeozmzZPI(long size) {
        ...
        setPivotX(TransformOrigin.m7224getPivotFractionXimpl(this.mTransformOrigin) * i);
        setPivotY(TransformOrigin.m7225getPivotFractionYimpl(this.mTransformOrigin) * i2);
        updateOutlineResolver();
    ...
    public void mo8646movegyyYBs(long position) {
        int iM9815getXimpl = IntOffset.m9815getXimpl(position);
        if (iM9815getXimpl != getLeft()) {
            offsetLeftAndRight(iM9815getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int iM9816getYimpl = IntOffset.m9816getYimpl(position);
        if (iM9816getYimpl != getTop()) {
            offsetTopAndBottom(iM9816getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public long mo8645mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            return this.matrixCache.m8775mapInverseR5De75A(this, point);
        }
        return this.matrixCache.m8774mapR5De75A(this, point);
    }
    ...
    public void mo8648transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m7079timesAssign58bKbWc(matrix, this.matrixCache.m8773calculateMatrixGrdbGEg(this));
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* JADX INFO: renamed from: inverseTransform-58bKbWc */
    public void mo8643inverseTransform58bKbWc(float[] matrix) {
        float[] fArrM8772calculateInverseMatrixbWbORWo = this.matrixCache.m8772calculateInverseMatrixbWbORWo(this);
        if (fArrM8772calculateInverseMatrixbWbORWo != null) {
            androidx.compose.ui.graphics.Matrix.m7079timesAssign58bKbWc(matrix, fArrM8772calculateInverseMatrixbWbORWo);
        }
    }
    ...
    public boolean mo8644isInLayerk4lQ0M(long position) {
        ...
        if (getClipToOutline()) {
            return this.outlineResolver.m8802isInOutlinek4lQ0M(position);
        }
        return true;
    }
}
