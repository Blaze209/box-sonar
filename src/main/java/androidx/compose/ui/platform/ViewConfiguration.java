...
public interface ViewConfiguration {
    ...
    public static final class DefaultImpls {
        ...
        public static long m8812getMinimumTouchTargetSizeMYxV2XQ(ViewConfiguration viewConfiguration) {
            return ViewConfiguration.super.mo8501getMinimumTouchTargetSizeMYxV2XQ();
        }
    ...
    default long mo8501getMinimumTouchTargetSizeMYxV2XQ() {
        float f = 48;
        return DpKt.m9709DpSizeYgX7TsA(Dp.m9687constructorimpl(f), Dp.m9687constructorimpl(f));
    }
}
