...
public final class WindowInfoImpl implements WindowInfo {
    ...
    private static final MutableState<PointerKeyboardModifiers> GlobalKeyboardModifiers = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(PointerKeyboardModifiers.m8195boximpl(PointerEvent_androidKt.EmptyPointerKeyboardModifiers()), null, 2, null);
    private final MutableState<IntSize> _containerSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m9850boximpl(IntSize.INSTANCE.m9863getZeroYbymL2g()), null, 2, null);
    private final MutableState<DpSize> _containerDpSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DpSize.m9773boximpl(DpSize.INSTANCE.m9795getZeroMYxV2XQ()), null, 2, null);
    ...
    public int mo8778getKeyboardModifiersk7X9c1A() {
    ...
    public void m8815setKeyboardModifiers5xRPYO0(int i) {
        GlobalKeyboardModifiers.setValue(PointerKeyboardModifiers.m8195boximpl(i));
    }

    @Override // androidx.compose.ui.platform.WindowInfo
    /* JADX INFO: renamed from: getContainerSize-YbymL2g */
    public long mo8777getContainerSizeYbymL2g() {
        return this._containerSize.getValue().m9862unboximpl();
    }

    /* JADX INFO: renamed from: setContainerSize-ozmzZPI, reason: not valid java name */
    public void m8814setContainerSizeozmzZPI(long j) {
        this._containerSize.setValue(IntSize.m9850boximpl(j));
    }

    @Override // androidx.compose.ui.platform.WindowInfo
    /* JADX INFO: renamed from: getContainerDpSize-MYxV2XQ */
    public long mo8776getContainerDpSizeMYxV2XQ() {
    ...
    public void m8813setContainerDpSizeEaSLcWc(long j) {
        this._containerDpSize.setValue(DpSize.m9773boximpl(j));
    }
