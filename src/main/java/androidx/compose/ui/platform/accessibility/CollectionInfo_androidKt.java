    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() <= 1) {
            ...
            while (i < lastIndex) {
                ...
                arrayList.add(Offset.m6558boximpl(Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(Math.abs(Float.intBitsToFloat((int) (semanticsNode4.getBoundsInRoot().m6599getCenterF1C5BW0() >> 32)) - Float.intBitsToFloat((int) (semanticsNode3.getBoundsInRoot().m6599getCenterF1C5BW0() >> 32))))) << 32) | (((long) Float.floatToRawIntBits(Math.abs(Float.intBitsToFloat((int) (semanticsNode4.getBoundsInRoot().m6599getCenterF1C5BW0() & 4294967295L)) - Float.intBitsToFloat((int) (semanticsNode3.getBoundsInRoot().m6599getCenterF1C5BW0() & 4294967295L))))) & 4294967295L))));
                semanticsNode = semanticsNode2;
            }
            listEmptyList = arrayList;
        }
        if (listEmptyList.size() == 1) {
            jM6579unboximpl = ((Offset) CollectionsKt.first(listEmptyList)).m6579unboximpl();
        } else {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    objFirst = Offset.m6558boximpl(Offset.m6574plusMKHz9U(((Offset) objFirst).m6579unboximpl(), ((Offset) listEmptyList.get(i2)).m6579unboximpl()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
            ...
            jM6579unboximpl = ((Offset) objFirst).m6579unboximpl();
        }
        return Float.intBitsToFloat((int) (4294967295L & jM6579unboximpl)) < Float.intBitsToFloat((int) (jM6579unboximpl >> 32));
    }
