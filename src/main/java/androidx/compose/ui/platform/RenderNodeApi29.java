...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.INSTANCE.m6905getAutoNrFUSI();
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m8805applyCompositingStrategyQu9p0E8(this.renderNode, CompositingStrategy.INSTANCE.m6907getOffscreenNrFUSI());
        } else {
            m8805applyCompositingStrategyQu9p0E8(this.renderNode, this.internalCompositingStrategy);
        }
    }
    ...
    private final void m8805applyCompositingStrategyQu9p0E8(RenderNode renderNode, int i) {
        ...
        } else if (CompositingStrategy.m6901equalsimpl0(i, CompositingStrategy.INSTANCE.m6906getModulateAlphaNrFUSI())) {
