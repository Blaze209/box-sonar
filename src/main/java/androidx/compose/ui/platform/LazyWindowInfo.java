...
public final class LazyWindowInfo implements WindowInfo {
    ...
    public void m8779setKeyboardModifiers5xRPYO0(int i) {
        WindowInfoImpl.INSTANCE.getGlobalKeyboardModifiers$ui().setValue(PointerKeyboardModifiers.m8195boximpl(i));
    }
