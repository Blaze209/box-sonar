...
public final class AndroidComposeView extends MAMViewGroup implements Owner, PlatformFocusOwner, ViewRootForTest, MatrixPositionCalculator, DefaultLifecycleObserver, OutOfFrameExecutor, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, ViewTreeObserver.OnTouchModeChangeListener, FocusListener {
    ...
    static final class C07701 extends ContinuationImpl {
        int label;
    ...
    public static /* synthetic */ void m8698getPrimaryDirectionalMotionAxisOverridedqNNBbU$ui$annotations() {
    }
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        ...
        super(context);
        this.lastDownPointerPosition = Offset.INSTANCE.m6584getUnspecifiedF1C5BW0();
        int i = 1;
        ...
        this.globalPosition = IntOffset.m9809constructorimpl((j & 4294967295L) | (j << 32));
        this.tmpPositionArray = new int[]{0, 0};
        this.tmpMatrix = Matrix.m7060constructorimpl$default(null, 1, null);
        this.viewToWindowMatrix = Matrix.m7060constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m7060constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.INSTANCE.m6583getInfiniteF1C5BW0();
        ...
        this.textInputSessionMutex = SessionMutex.m6302constructorimpl();
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m7632getTouchaOaMEAU() : InputMode.INSTANCE.m7631getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m8709invokeiuPiT84(inputMode.getValue());
            }

            /* JADX INFO: renamed from: invoke-iuPiT84, reason: not valid java name */
            public final Boolean m8709invokeiuPiT84(int i2) {
                boolean zRequestFocusFromTouch;
                if (InputMode.m7627equalsimpl0(i2, InputMode.INSTANCE.m7632getTouchaOaMEAU())) {
                    zRequestFocusFromTouch = this.this$0.isInTouchMode();
                } else if (InputMode.m7627equalsimpl0(i2, InputMode.INSTANCE.m7631getKeyboardaOaMEAU())) {
        ...
        this.indirectPointerNavigationGestureDetector = new IndirectPointerNavigationGestureDetector(context, new Function1<FocusDirection, Unit>() { // from class: androidx.compose.ui.platform.AndroidComposeView$indirectPointerNavigationGestureDetector$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(FocusDirection focusDirection) {
                m8711invoke3ESFkO8(focusDirection.getValue());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-3ESFkO8, reason: not valid java name */
            public final void m8711invoke3ESFkO8(int i2) {
                this.this$0.getFocusOwner().mo6464moveFocusaToIllA(i2, false);
            }
        });
    ...
    public final void m8707setPrimaryDirectionalMotionAxisOverrider2epLt8$ui(IndirectPointerEventPrimaryDirectionalMotionAxis indirectPointerEventPrimaryDirectionalMotionAxis) {
    ...
    private final boolean m8701moveFocusInChildrenCurrent3ESFkO8(int focusDirection) {
        View viewFindNextFocusFromRect;
        if (FocusDirection.m6444equalsimpl0(focusDirection, FocusDirection.INSTANCE.m6449getEnterdhqQ8s()) || FocusDirection.m6444equalsimpl0(focusDirection, FocusDirection.INSTANCE.m6450getExitdhqQ8s())) {
            return false;
        }
        Integer numM6456toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m6456toAndroidFocusDirection3ESFkO8(focusDirection);
        if (numM6456toAndroidFocusDirection3ESFkO8 != null) {
            int iIntValue = numM6456toAndroidFocusDirection3ESFkO8.intValue();
    ...
    private final boolean m8702moveFocusInChildrenViewFocusFix3ESFkO8(int focusDirection) {
        AndroidViewsHandler androidViewsHandler;
        if (FocusDirection.m6444equalsimpl0(focusDirection, FocusDirection.INSTANCE.m6449getEnterdhqQ8s()) || FocusDirection.m6444equalsimpl0(focusDirection, FocusDirection.INSTANCE.m6450getExitdhqQ8s()) || !hasFocus() || (androidViewsHandler = this._androidViewsHandler) == null) {
            return false;
        }
        Integer numM6456toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m6456toAndroidFocusDirection3ESFkO8(focusDirection);
        if (numM6456toAndroidFocusDirection3ESFkO8 != null) {
            ...
            if (!FocusOwnerImplKt.m6471is1dFocusSearch3ESFkO8(focusDirection) || !androidViewsHandler.hasFocus()) {
                Rect embeddedViewFocusRect = getEmbeddedViewFocusRect();
    ...
    private final boolean m8700moveFocusInChildrenBypassUnfocusableComposeView3ESFkO8(int focusDirection) {
        if (FocusDirection.m6444equalsimpl0(focusDirection, FocusDirection.INSTANCE.m6449getEnterdhqQ8s()) || FocusDirection.m6444equalsimpl0(focusDirection, FocusDirection.INSTANCE.m6450getExitdhqQ8s())) {
            return false;
        }
        Integer numM6456toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m6456toAndroidFocusDirection3ESFkO8(focusDirection);
        if (numM6456toAndroidFocusDirection3ESFkO8 != null) {
            int iIntValue = numM6456toAndroidFocusDirection3ESFkO8.intValue();
            View viewM8697findNextViewInEmbeddedView3ESFkO8 = m8697findNextViewInEmbeddedView3ESFkO8(focusDirection);
            if (viewM8697findNextViewInEmbeddedView3ESFkO8 != null) {
                return FocusInteropUtils_androidKt.requestInteropFocus(viewM8697findNextViewInEmbeddedView3ESFkO8, Integer.valueOf(iIntValue), null);
            }
            return false;
        }
        InlineClassHelperKt.throwIllegalStateExceptionForNullCheck("Invalid focus direction");
    ...
    public boolean mo6510moveFocusInChildren3ESFkO8(int focusDirection) {
        if (ComposeUiFlags.isViewFocusFixEnabled) {
            return m8702moveFocusInChildrenViewFocusFix3ESFkO8(focusDirection);
        }
        if (ComposeUiFlags.isBypassUnfocusableComposeViewEnabled) {
            return m8700moveFocusInChildrenBypassUnfocusableComposeView3ESFkO8(focusDirection);
        }
        return m8701moveFocusInChildrenCurrent3ESFkO8(focusDirection);
    }

    /* JADX INFO: renamed from: findNextViewInEmbeddedView-3ESFkO8, reason: not valid java name */
    private final View m8697findNextViewInEmbeddedView3ESFkO8(int focusDirection) {
    ...
    public Object textInputSession(Function2<? super PlatformTextInputSessionScope, ? super Continuation<?>, ? extends Object> function2, Continuation<?> continuation) {
        ...
        if (i == 0) {
            ...
            c07701.label = 1;
            if (SessionMutex.m6309withSessionCancellingPreviousimpl(atomicReference, function1, function2, c07701) == coroutine_suspended) {
    ...
    public static final void sendHoverExitEvent$lambda$0(AndroidComposeView androidComposeView) {
        ...
        androidComposeView.m8704sendMotionEvent8iAsVTc(motionEvent);
    }
    ...
    public void getFocusedRect(android.graphics.Rect rect) {
        ...
        if (!Intrinsics.areEqual((Object) getFocusOwner().mo6463focusSearchULY8qGw(FocusDirection.INSTANCE.m6448getDowndhqQ8s(), null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.getFocusedRect.1
            @Override // kotlin.jvm.functions.Function1
    ...
    public View focusSearch(View focused, int direction) {
        ...
        int value = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m6448getDowndhqQ8s();
        final Ref.ObjectRef objectRef = new Ref.ObjectRef();
        if (getFocusOwner().mo6463focusSearchULY8qGw(value, rectCalculateFocusRectRelativeTo, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$focusSearch$searchResult$1
        ...
        if (objectRef.element == 0) {
            ...
            if (FocusOwnerImplKt.m6471is1dFocusSearch3ESFkO8(value)) {
                if (ComposeUiFlags.isBypassUnfocusableComposeViewEnabled) {
                    return this;
                }
                return super.focusSearch(focused, direction);
            ...
            AndroidComposeView androidComposeView = this;
            if (TwoDimensionalFocusSearchKt.m6517isBetterCandidateI7lrPNg(FocusTraversalKt.focusRect((FocusTargetNode) objectRef.element), FocusInteropUtils_androidKt.calculateFocusRectRelativeTo(viewFindNextFocus, androidComposeView), rectCalculateFocusRectRelativeTo, value)) {
    ...
    public final boolean requestFocusCurrent(int direction, android.graphics.Rect previouslyFocusedRect) {
        ...
        FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(direction);
        final int value = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m6449getEnterdhqQ8s();
        return Intrinsics.areEqual((Object) getFocusOwner().mo6463focusSearchULY8qGw(value, previouslyFocusedRect != null ? RectHelper_androidKt.toComposeRect(previouslyFocusedRect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.requestFocusCurrent.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                return Boolean.valueOf(focusTargetNode.mo6478requestFocus3ESFkO8(value));
            }
        }), (Object) true);
    }
    ...
    public final boolean requestFocusViewFocusFix(int direction, android.graphics.Rect previouslyFocusedRect) {
        ...
        FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(direction);
        final int value = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m6449getEnterdhqQ8s();
        if (hasFocus() && mo6510moveFocusInChildren3ESFkO8(value)) {
            return true;
        }
        final Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        Boolean boolMo6463focusSearchULY8qGw = getFocusOwner().mo6463focusSearchULY8qGw(value, previouslyFocusedRect != null ? RectHelper_androidKt.toComposeRect(previouslyFocusedRect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocusViewFocusFix$focusSearchResult$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        if (boolMo6463focusSearchULY8qGw == null) {
            return false;
        }
        if (boolMo6463focusSearchULY8qGw.booleanValue()) {
            return true;
        }
        if (booleanRef.element) {
            return false;
        }
        if ((previouslyFocusedRect != null && !hasFocus() && Intrinsics.areEqual((Object) getFocusOwner().mo6463focusSearchULY8qGw(value, null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocusViewFocusFix$altFocus$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public final boolean requestFocusBypassUnfocusableComposeView(int direction, android.graphics.Rect previouslyFocusedRect) {
        ...
        FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(direction);
        final int value = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m6449getEnterdhqQ8s();
        if (Intrinsics.areEqual((Object) getFocusOwner().mo6463focusSearchULY8qGw(value, previouslyFocusedRect != null ? RectHelper_androidKt.toComposeRect(previouslyFocusedRect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocusBypassUnfocusableComposeView$requestFocusWithPrevRect$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        if (ComposeUiFlags.isIgnoreInvalidPrevFocusRectEnabled && Intrinsics.areEqual((Object) getFocusOwner().mo6463focusSearchULY8qGw(value, null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocusBypassUnfocusableComposeView$requestFocusWithoutPrevRect$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        if (hasFocus() && FocusOwnerImplKt.m6471is1dFocusSearch3ESFkO8(value)) {
            return getFocusOwner().mo6466resetFocus3ESFkO8(value);
        }
        return false;
    }
    ...
    public boolean mo6511requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect) {
        Integer numM6456toAndroidFocusDirection3ESFkO8;
        if (ComposeUiFlags.isBypassUnfocusableComposeViewEnabled) {
            if (isFocused()) {
                return true;
            }
        ...
        return super.requestFocus((focusDirection == null || (numM6456toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m6456toAndroidFocusDirection3ESFkO8(focusDirection.getValue())) == null) ? 130 : numM6456toAndroidFocusDirection3ESFkO8.intValue(), previouslyFocusedRect != null ? RectHelper_androidKt.toAndroidRect(previouslyFocusedRect) : null);
    }
    ...
    public void onFocusChanged(FocusTargetModifierNode previous, FocusTargetModifierNode current) {
        ...
        int iM8585constructorimpl = NodeKind.m8585constructorimpl(2097152);
        ...
        if (current != null) {
            ...
            int iM8585constructorimpl2 = NodeKind.m8585constructorimpl(2097152);
            ...
            while (layoutNodeRequireLayoutNode2 != null) {
                if ((layoutNodeRequireLayoutNode2.getNodes().getHead().getAggregateChildKindSet() & iM8585constructorimpl2) != 0) {
                    while (node2 != null) {
                        if ((node2.getKindSet() & iM8585constructorimpl2) != 0) {
                            ...
                            while (nodePop2 != null) {
                                ...
                                } else if (((nodePop2.getKindSet() & iM8585constructorimpl2) != 0) && (nodePop2 instanceof DelegatingNode)) {
                                    int i2 = 0;
                                    for (Modifier.Node delegate$ui2 = ((DelegatingNode) nodePop2).getDelegate(); delegate$ui2 != null; delegate$ui2 = delegate$ui2.getChild()) {
                                        if ((delegate$ui2.getKindSet() & iM8585constructorimpl2) != 0) {
                                            i2++;
                                            if (i2 == 1) {
    ...
    public boolean mo8653sendKeyEventZmokQxo(KeyEvent keyEvent) {
        return getFocusOwner().mo6461dispatchInterceptedSoftKeyboardEventZmokQxo(keyEvent) || FocusOwner.m6459dispatchKeyEventYhN2O0w$default(getFocusOwner(), keyEvent, null, 2, null);
    }
    ...
    public boolean dispatchKeyEvent(final KeyEvent event) {
        if (isFocused()) {
            this._windowInfo.m8779setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m8196constructorimpl(event.getMetaState()));
            return FocusOwner.m6459dispatchKeyEventYhN2O0w$default(getFocusOwner(), androidx.compose.ui.input.key.KeyEvent.m7961constructorimpl(event), null, 2, null) || super.dispatchKeyEvent(event);
        }
        return getFocusOwner().mo6462dispatchKeyEventYhN2O0w(androidx.compose.ui.input.key.KeyEvent.m7961constructorimpl(event), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.dispatchKeyEvent.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    public boolean dispatchKeyEventPreIme(KeyEvent event) {
        return (isFocused() && getFocusOwner().mo6461dispatchInterceptedSoftKeyboardEventZmokQxo(androidx.compose.ui.input.key.KeyEvent.m7961constructorimpl(event))) || super.dispatchKeyEventPreIme(event);
    }
    ...
    public final boolean m8705startDrag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
            ...
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                ...
                while (true) {
                    if (parent$ui == null) {
                        parent$ui = null;
                        break;
                    } else if (parent$ui.getNodes().m8546hasH91voCI$ui(NodeKind.m8585constructorimpl(8))) {
                        break;
                    } else {
    ...
    public void mo8652measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m8533measureAndLayout0kLqBqw(layoutNode, constraints);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            long jM8696convertMeasureSpecI7RO_PI = m8696convertMeasureSpecI7RO_PI(widthMeasureSpec);
            int iM14954constructorimpl = (int) ULong.m14954constructorimpl(jM8696convertMeasureSpecI7RO_PI >>> 32);
            int iM14954constructorimpl2 = (int) ULong.m14954constructorimpl(jM8696convertMeasureSpecI7RO_PI & 4294967295L);
            long jM8696convertMeasureSpecI7RO_PI2 = m8696convertMeasureSpecI7RO_PI(heightMeasureSpec);
            long jM9648fitPrioritizingHeightZbe2FdA = Constraints.INSTANCE.m9648fitPrioritizingHeightZbe2FdA(iM14954constructorimpl, iM14954constructorimpl2, (int) ULong.m14954constructorimpl(jM8696convertMeasureSpecI7RO_PI2 >>> 32), (int) ULong.m14954constructorimpl(4294967295L & jM8696convertMeasureSpecI7RO_PI2));
            Constraints constraints = this.onMeasureConstraints;
            boolean zM9633equalsimpl0 = false;
            if (constraints == null) {
                this.onMeasureConstraints = Constraints.m9627boximpl(jM9648fitPrioritizingHeightZbe2FdA);
                this.wasMeasuredWithMultipleConstraints = false;
            } else {
                if (constraints != null) {
                    zM9633equalsimpl0 = Constraints.m9633equalsimpl0(constraints.getValue(), jM9648fitPrioritizingHeightZbe2FdA);
                }
                if (!zM9633equalsimpl0) {
                    this.wasMeasuredWithMultipleConstraints = true;
                }
            }
            this.measureAndLayoutDelegate.m8534updateRootConstraintsBRTryo0(jM9648fitPrioritizingHeightZbe2FdA);
    ...
    private final int m8694component1VKZWuLQ(long j) {
        return (int) ULong.m14954constructorimpl(j >>> 32);
    }

    /* JADX INFO: renamed from: component2-VKZWuLQ, reason: not valid java name */
    private final int m8695component2VKZWuLQ(long j) {
        return (int) ULong.m14954constructorimpl(j & 4294967295L);
    }

    /* JADX INFO: renamed from: pack-ZIaKswc, reason: not valid java name */
    private final long m8703packZIaKswc(int a, int b) {
        return ULong.m14954constructorimpl(ULong.m14954constructorimpl(ULong.m14954constructorimpl(a) << 32) | ULong.m14954constructorimpl(b));
    }

    /* JADX INFO: renamed from: convertMeasureSpec-I7RO_PI, reason: not valid java name */
    private final long m8696convertMeasureSpecI7RO_PI(int measureSpec) {
        int mode = View.MeasureSpec.getMode(measureSpec);
        int size = View.MeasureSpec.getSize(measureSpec);
        if (mode == Integer.MIN_VALUE) {
            return m8703packZIaKswc(0, size);
        }
        if (mode == 0) {
            return m8703packZIaKswc(0, Integer.MAX_VALUE);
        }
        if (mode == 1073741824) {
            return m8703packZIaKswc(size, size);
        }
    ...
    private final void updatePositionCacheAndDispatch() {
        ...
        int iM9815getXimpl = IntOffset.m9815getXimpl(j);
        int iM9816getYimpl = IntOffset.m9816getYimpl(j);
        int[] iArr = this.tmpPositionArray;
        boolean z = false;
        int i = iArr[0];
        if (iM9815getXimpl != i || iM9816getYimpl != iArr[1] || this.lastMatrixRecalculationAnimationTime < 0) {
            this.globalPosition = IntOffset.m9809constructorimpl((((long) i) << 32) | (((long) iArr[1]) & 4294967295L));
            if (iM9815getXimpl != Integer.MAX_VALUE && iM9816getYimpl != Integer.MAX_VALUE) {
        ...
        getRectManager().m8855updateOffsetsgTq6Wqs(this.globalPosition, IntOffsetKt.m9832roundk4lQ0M(this.windowPosition), this.viewToWindowMatrix, rootView.getWidth(), rootView.getHeight());
    ...
    protected void onAttachedToWindow() {
        ...
        this._inputModeManager.m7635setInputModeiuPiT84(isInTouchMode() ? InputMode.INSTANCE.m7632getTouchaOaMEAU() : InputMode.INSTANCE.m7631getKeyboardaOaMEAU());
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 8) {
            ...
            return (m8699handleMotionEvent8iAsVTc(motionEvent) & 1) != 0;
        }
        if (motionEvent.isFromSource(2097152)) {
            AndroidIndirectPointerEvent androidIndirectPointerEventM8053convertToIndirectPointerEventk92h6UU$ui = this.motionEventAdapter.m8053convertToIndirectPointerEventk92h6UU$ui(motionEvent, this.primaryDirectionalMotionAxisOverride);
            if (androidIndirectPointerEventM8053convertToIndirectPointerEventk92h6UU$ui != null) {
                if (handleIndirectPointerEvent(androidIndirectPointerEventM8053convertToIndirectPointerEventk92h6UU$ui)) {
                    return true;
                }
            } else {
                getFocusOwner().dispatchIndirectPointerCancel();
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int iM8699handleMotionEvent8iAsVTc = m8699handleMotionEvent8iAsVTc(motionEvent);
        if ((iM8699handleMotionEvent8iAsVTc & 2) != 0) {
        ...
        if (z && z2) {
            ...
            if (view == null || (objM8721boximpl = view.getTag(R.id.auto_clear_focus_behavior_tag)) == null) {
                objM8721boximpl = AutoClearFocusBehavior.m8721boximpl(AutoClearFocusBehavior.INSTANCE.m8729getDefault4UtRPd4());
            }
            if (Intrinsics.areEqual(objM8721boximpl, AutoClearFocusBehavior.m8721boximpl(AutoClearFocusBehavior.INSTANCE.m8728getCursorBased4UtRPd4())) && (activeFocusTargetNode = getFocusOwner().getActiveFocusTargetNode()) != null) {
                if (!LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.requireLayoutCoordinates(activeFocusTargetNode)).m6595containsk4lQ0M(Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(motionEvent.getX())) << 32) | (((long) Float.floatToRawIntBits(motionEvent.getY())) & 4294967295L)))) {
                    FocusManager.clearFocus$default(getFocusOwner(), false, 1, null);
                }
            }
        }
        return (iM8699handleMotionEvent8iAsVTc & 1) != 0;
    }
    ...
    private final int m8699handleMotionEvent8iAsVTc(MotionEvent motionEvent) {
        ...
        try {
            ...
            try {
                ...
                int iM8704sendMotionEvent8iAsVTc = m8704sendMotionEvent8iAsVTc(motionEvent);
                Trace.endSection();
                androidComposeView.forceUseMatrixCache = false;
                return iM8704sendMotionEvent8iAsVTc;
            } catch (Throwable th2) {
                th = th2;
            }
        } catch (Throwable th3) {
    ...
    private final int m8704sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        PointerInputEventData pointerInputEventData;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m8779setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m8196constructorimpl(motionEvent.getMetaState()));
        }
        AndroidComposeView androidComposeView = this;
        ...
        if (pointerInputEventConvertToPointerInputEvent$ui != null) {
            ...
            if (pointerInputEventData2 != null) {
                this.lastDownPointerPosition = pointerInputEventData2.m8150getPositionF1C5BW0();
            }
            int iM8155processBIzXfog = this.pointerInputEventProcessor.m8155processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui, androidComposeView, isInBounds(motionEvent));
            pointerInputEventConvertToPointerInputEvent$ui.setMotionEvent(null);
            if ((actionMasked != 0 && actionMasked != 5) || (iM8155processBIzXfog & 1) != 0) {
                return iM8155processBIzXfog;
            }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i3 < pointerCount) {
            ...
            long jMo8214localToScreenMKHz9U = mo8214localToScreenMKHz9U(Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(pointerCoords.y)) & 4294967295L) | (((long) Float.floatToRawIntBits(f)) << 32)));
            pointerCoords.x = Float.intBitsToFloat((int) (jMo8214localToScreenMKHz9U >> 32));
            pointerCoords.y = Float.intBitsToFloat((int) (jMo8214localToScreenMKHz9U & 4294967295L));
            i3++;
        }
        ...
        this.pointerInputEventProcessor.m8155processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui, androidComposeView, true);
        motionEventObtain.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int direction) {
        return this.composeAccessibilityDelegate.m8715canScroll0AR0LA0$ui(false, direction, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int direction) {
        return this.composeAccessibilityDelegate.m8715canScroll0AR0LA0$ui(true, direction, this.lastDownPointerPosition);
    }
    ...
    public long mo8214localToScreenMKHz9U(long localPosition) {
        recalculateWindowPosition();
        long jM7066mapMKHz9U = Matrix.m7066mapMKHz9U(this.viewToWindowMatrix, localPosition);
        float fIntBitsToFloat = Float.intBitsToFloat((int) (jM7066mapMKHz9U >> 32)) + Float.intBitsToFloat((int) (this.windowPosition >> 32));
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (jM7066mapMKHz9U & 4294967295L)) + Float.intBitsToFloat((int) (this.windowPosition & 4294967295L)))) & 4294967295L) | (Float.floatToRawIntBits(fIntBitsToFloat) << 32));
    }

    @Override // androidx.compose.ui.input.pointer.MatrixPositionCalculator
    /* JADX INFO: renamed from: localToScreen-58bKbWc */
    public void mo8050localToScreen58bKbWc(float[] localTransform) {
        recalculateWindowPosition();
        Matrix.m7079timesAssign58bKbWc(localTransform, this.viewToWindowMatrix);
        AndroidComposeView_androidKt.m8720preTranslatecG2Xzmc(localTransform, Float.intBitsToFloat((int) (this.windowPosition >> 32)), Float.intBitsToFloat((int) (this.windowPosition & 4294967295L)), this.tmpMatrix);
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* JADX INFO: renamed from: screenToLocal-MK-Hz9U */
    public long mo8215screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        ...
        return Matrix.m7066mapMKHz9U(this.windowToViewMatrix, Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(fIntBitsToFloat2)) & 4294967295L) | (Float.floatToRawIntBits(fIntBitsToFloat) << 32)));
    }
    ...
    private final void recalculateWindowPosition() {
        ...
        if (jCurrentAnimationTimeMillis != this.lastMatrixRecalculationAnimationTime) {
            ...
            this.windowPosition = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(f - iArr2[0])) << 32) | (((long) Float.floatToRawIntBits(f2 - iArr2[1])) & 4294967295L));
        }
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        float x = motionEvent.getX();
        long jM7066mapMKHz9U = Matrix.m7066mapMKHz9U(fArr, Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(motionEvent.getY())) & 4294967295L) | (Float.floatToRawIntBits(x) << 32)));
        this.windowPosition = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(motionEvent.getRawX() - Float.intBitsToFloat((int) (jM7066mapMKHz9U >> 32)))) << 32) | (((long) Float.floatToRawIntBits(motionEvent.getRawY() - Float.intBitsToFloat((int) (jM7066mapMKHz9U & 4294967295L)))) & 4294967295L));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo8731calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m8770invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }
    ...
    public boolean onCheckIsTextEditor() {
        AndroidPlatformTextInputSession androidPlatformTextInputSession = (AndroidPlatformTextInputSession) SessionMutex.m6306getCurrentSessionimpl(this.textInputSessionMutex);
    ...
    public long mo8649calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m7066mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }

    @Override // androidx.compose.ui.node.Owner
    /* JADX INFO: renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo8650calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m7066mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }
    ...
    public boolean dispatchHoverEvent(MotionEvent event) {
        ...
        if (!isBadMotionEvent(event) && isAttachedToWindow()) {
            ...
            if ((m8699handleMotionEvent8iAsVTc(event) & 1) != 0) {
                return true;
            }
        }
        return false;
    ...
    public void mo8651dispatchOnScrollChangedk4lQ0M(long delta) {
    ...
    final class RootModifierNode extends Modifier.Node implements BringIntoViewModifierNode, SemanticsModifierNode, RotaryInputModifierNode, KeyInputModifierNode, LayoutModifierNode, TraversableNode, WindowInsetsRulerProvider {
        ...
        public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            ...
            return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo0.getWidth(), placeableMo8265measureBRTryo0.getHeight(), null, this.rulerLambda, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.platform.AndroidComposeView$RootModifierNode$measure$1
                {
                    super(1);
                }
        ...
        public Object bringIntoView(LayoutCoordinates layoutCoordinates, Function0<Rect> function0, Continuation<? super Unit> continuation) {
            ...
            Rect rectM6606translatek4lQ0M = rectInvoke != null ? rectInvoke.m6606translatek4lQ0M(jPositionInRoot) : null;
            if (rectM6606translatek4lQ0M != null) {
                AndroidComposeView.this.requestRectangleOnScreen(RectHelper_androidKt.toAndroidRect(rectM6606translatek4lQ0M), false);
            }
            return Unit.INSTANCE;
        }
        ...
        public boolean mo555onKeyEventZmokQxo(KeyEvent event) {
            Boolean boolMo6463focusSearchULY8qGw;
            final FocusDirection focusDirectionM6457toFocusDirectionZmokQxo = FocusInteropUtils_androidKt.m6457toFocusDirectionZmokQxo(event);
            if (focusDirectionM6457toFocusDirectionZmokQxo == null || !KeyEventType.m7970equalsimpl0(KeyEvent_androidKt.m7978getTypeZmokQxo(event), KeyEventType.INSTANCE.m7974getKeyDownCS__XNY())) {
                return false;
            }
            if (ComposeUiFlags.isBypassUnfocusableComposeViewEnabled) {
                FocusTargetNode activeFocusTargetNode = AndroidComposeView.this.getFocusOwner().getActiveFocusTargetNode();
                if (activeFocusTargetNode != null && activeFocusTargetNode.getIsInteropViewHost() && AndroidComposeView.this.mo6510moveFocusInChildren3ESFkO8(focusDirectionM6457toFocusDirectionZmokQxo.getValue())) {
                    return true;
                }
                Boolean boolMo6463focusSearchULY8qGw2 = AndroidComposeView.this.getFocusOwner().mo6463focusSearchULY8qGw(focusDirectionM6457toFocusDirectionZmokQxo.getValue(), AndroidComposeView.this.getEmbeddedViewFocusRect(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$RootModifierNode$onKeyEvent$focusWasMovedOrCancelled$1
                    {
                        super(1);
                    }
                    ...
                    @Override // kotlin.jvm.functions.Function1
                    public final Boolean invoke(FocusTargetNode focusTargetNode) {
                        return Boolean.valueOf(focusTargetNode.mo6478requestFocus3ESFkO8(focusDirectionM6457toFocusDirectionZmokQxo.getValue()));
                    }
                });
                if (boolMo6463focusSearchULY8qGw2 != null ? boolMo6463focusSearchULY8qGw2.booleanValue() : true) {
                    return true;
                }
                if (FocusOwnerImplKt.m6471is1dFocusSearch3ESFkO8(focusDirectionM6457toFocusDirectionZmokQxo.getValue())) {
                    Integer numM6456toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m6456toAndroidFocusDirection3ESFkO8(focusDirectionM6457toFocusDirectionZmokQxo.getValue());
                    int iIntValue = numM6456toAndroidFocusDirection3ESFkO8 != null ? numM6456toAndroidFocusDirection3ESFkO8.intValue() : 2;
                    FocusFinder focusFinder = FocusFinder.getInstance();
                    ...
                    if (viewFindNextFocus == null || Intrinsics.areEqual(viewFindNextFocus, AndroidComposeView.this)) {
                        return AndroidComposeView.this.getFocusOwner().mo6466resetFocus3ESFkO8(focusDirectionM6457toFocusDirectionZmokQxo.getValue());
                    }
                }
                return false;
            }
            Integer numM6456toAndroidFocusDirection3ESFkO9 = FocusInteropUtils_androidKt.m6456toAndroidFocusDirection3ESFkO8(focusDirectionM6457toFocusDirectionZmokQxo.getValue());
            if (ComposeUiFlags.isViewFocusFixEnabled && AndroidComposeView.this.hasFocus() && numM6456toAndroidFocusDirection3ESFkO9 != null && AndroidComposeView.this.mo6510moveFocusInChildren3ESFkO8(focusDirectionM6457toFocusDirectionZmokQxo.getValue())) {
                return true;
            }
            Rect embeddedViewFocusRect = AndroidComposeView.this.getEmbeddedViewFocusRect();
            Boolean boolMo6463focusSearchULY8qGw3 = AndroidComposeView.this.getFocusOwner().mo6463focusSearchULY8qGw(focusDirectionM6457toFocusDirectionZmokQxo.getValue(), embeddedViewFocusRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$RootModifierNode$onKeyEvent$focusWasMovedOrCancelled$2
                {
                    super(1);
                }
            ...
            if (boolMo6463focusSearchULY8qGw3 != null ? boolMo6463focusSearchULY8qGw3.booleanValue() : true) {
                return true;
            }
            if (!FocusOwnerImplKt.m6471is1dFocusSearch3ESFkO8(focusDirectionM6457toFocusDirectionZmokQxo.getValue())) {
                return false;
            }
            if (numM6456toAndroidFocusDirection3ESFkO9 != null) {
                View viewFindNextNonChildView = AndroidComposeView.this.findNextNonChildView(numM6456toAndroidFocusDirection3ESFkO9.intValue());
                ...
                if (viewFindNextNonChildView != null) {
                    ...
                    if (androidRect != null) {
                        ...
                        if (FocusInteropUtils_androidKt.requestInteropFocus(viewFindNextNonChildView, numM6456toAndroidFocusDirection3ESFkO9, androidRect)) {
                            return true;
                        }
                    } else {
            ...
            if (AndroidComposeView.this.getFocusOwner().mo6460clearFocusI7lrPNg(false, true, false, focusDirectionM6457toFocusDirectionZmokQxo.getValue()) && (boolMo6463focusSearchULY8qGw = AndroidComposeView.this.getFocusOwner().mo6463focusSearchULY8qGw(focusDirectionM6457toFocusDirectionZmokQxo.getValue(), null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$RootModifierNode$onKeyEvent$1
                {
                    super(1);
                }
                ...
                return boolMo6463focusSearchULY8qGw.booleanValue();
            }
            return true;
        }
    }
