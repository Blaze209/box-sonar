...
public final class AndroidComposeViewAccessibilityDelegateCompat_androidKt {
    ...
    public static final String getInfoStateDescriptionOrNull(SemanticsNode semanticsNode, Resources resources) {
        ...
        if (toggleableState != null) {
            ...
            if (i == 1) {
                if ((role == null ? false : Role.m8828equalsimpl0(role.getValue(), Role.INSTANCE.m8838getSwitcho7Vup1c())) && orNull == null) {
        ...
        if (bool != null) {
            ...
            if (!(role == null ? false : Role.m8828equalsimpl0(role.getValue(), Role.INSTANCE.m8839getTabo7Vup1c())) && orNull == null) {
                if (zBooleanValue) {
    ...
    public static final boolean getInfoIsCheckable(SemanticsNode semanticsNode) {
        ...
        if (bool != null) {
            bool.booleanValue();
            if (!(role != null ? Role.m8828equalsimpl0(role.getValue(), Role.INSTANCE.m8839getTabo7Vup1c()) : false)) {
                return true;
            }
        }
        return z;
