...
public final class AndroidClipboardManager implements ClipboardManager {
    ...
    public void setText(AnnotatedString annotatedString) {
        MAMClipboard.setPrimaryClip(this.clipboardManager, ClipData.newPlainText("plain text", AndroidClipboardManager_androidKt.convertToCharSequence(annotatedString)));
    }
    ...
    public void setClip(ClipEntry clipEntry) {
        if (clipEntry == null) {
            ...
            MAMClipboard.setPrimaryClip(this.clipboardManager, clipEntry.getClipData());
        }
    }
