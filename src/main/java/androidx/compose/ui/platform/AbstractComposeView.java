...
public abstract class AbstractComposeView extends MAMViewGroup {
    ...
    public final int m8689getAutoClearFocusBehavior4UtRPd4() {
        ...
        return autoClearFocusBehavior != null ? autoClearFocusBehavior.getValue() : AutoClearFocusBehavior.INSTANCE.m8729getDefault4UtRPd4();
    }

    /* JADX INFO: renamed from: setAutoClearFocusBehavior-17tfJxM, reason: not valid java name */
    public final void m8690setAutoClearFocusBehavior17tfJxM(int i) {
        setTag(R.id.auto_clear_focus_behavior_tag, AutoClearFocusBehavior.m8721boximpl(i));
    }
