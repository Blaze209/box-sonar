...
public final class SemanticsUtils_androidKt {
    ...
    public static final String m8806toLegacyClassNameV4PA4sw(int i) {
        if (Role.m8828equalsimpl0(i, Role.INSTANCE.m8832getButtono7Vup1c())) {
            return "android.widget.Button";
        }
        if (Role.m8828equalsimpl0(i, Role.INSTANCE.m8834getCheckboxo7Vup1c())) {
            return "android.widget.CheckBox";
        }
        if (Role.m8828equalsimpl0(i, Role.INSTANCE.m8837getRadioButtono7Vup1c())) {
            return "android.widget.RadioButton";
        }
        if (Role.m8828equalsimpl0(i, Role.INSTANCE.m8836getImageo7Vup1c())) {
            return "android.widget.ImageView";
        }
        if (Role.m8828equalsimpl0(i, Role.INSTANCE.m8835getDropdownListo7Vup1c())) {
            return "android.widget.Spinner";
        }
        if (Role.m8828equalsimpl0(i, Role.INSTANCE.m8840getValuePickero7Vup1c())) {
