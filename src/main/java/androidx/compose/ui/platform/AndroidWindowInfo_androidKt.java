...
public final class AndroidWindowInfo_androidKt {
    public static final DerivedSize calculateWindowSize(View view) {
        ...
        if (contextTryUnwrapContext != null) {
            ...
            return DerivedSize.INSTANCE.m8745fromPxSizeviCIZxY(IntSize.m9853constructorimpl((((long) windowMetricsComputeCurrentWindowMetrics.getBounds().width()) << 32) | (((long) windowMetricsComputeCurrentWindowMetrics.getBounds().height()) & 4294967295L)), AndroidDensity_androidKt.Density(contextTryUnwrapContext));
        }
        Configuration configuration = context.getResources().getConfiguration();
        return DerivedSize.INSTANCE.m8744fromDpSizeitqla9I(DpKt.m9709DpSizeYgX7TsA(Dp.m9687constructorimpl(configuration.screenWidthDp), Dp.m9687constructorimpl(configuration.screenHeightDp)), AndroidDensity_androidKt.Density(context));
    }
