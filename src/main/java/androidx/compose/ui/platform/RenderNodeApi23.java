...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m6905getAutoNrFUSI();
    ...
    public void mo8748setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().mo6689setBlendModes9anfk8(i);
    ...
    public void mo8749setCompositingStrategyaDBOjCE(int i) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m8804applyCompositingStrategyQu9p0E8(this.renderNode, CompositingStrategy.INSTANCE.m6907getOffscreenNrFUSI());
        } else {
            m8804applyCompositingStrategyQu9p0E8(this.renderNode, this.internalCompositingStrategy);
        }
    }

    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m6901equalsimpl0(getInternalCompositingStrategy(), CompositingStrategy.INSTANCE.m6907getOffscreenNrFUSI()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m6723equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m6754getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    private final void m8804applyCompositingStrategyQu9p0E8(RenderNode renderNode, int i) {
        if (CompositingStrategy.m6901equalsimpl0(i, CompositingStrategy.INSTANCE.m6907getOffscreenNrFUSI())) {
        ...
        if (CompositingStrategy.m6901equalsimpl0(i, CompositingStrategy.INSTANCE.m6906getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui() {
        return CompositingStrategy.m6901equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m6907getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m6785clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
