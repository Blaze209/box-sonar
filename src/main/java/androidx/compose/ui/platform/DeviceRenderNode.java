...
public interface DeviceRenderNode {
    ...
    int mo8747getCompositingStrategyNrFUSI();
    ...
    void mo8748setBlendModes9anfk8(int i);
    ...
    void mo8749setCompositingStrategyaDBOjCE(int i);
