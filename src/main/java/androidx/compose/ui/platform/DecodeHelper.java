...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte != 1) {
                if (bDecodeByte != 2) {
                    if (bDecodeByte != 3) {
                        if (bDecodeByte != 4) {
                            if (bDecodeByte != 5) {
                                        ...
                                        if (bDecodeByte != 8) {
                                            if (bDecodeByte != 9) {
                                                if (bDecodeByte != 10) {
                                                    ...
                                                    mutableSpanStyle.m8787setBackground8_81llA(m8738decodeColor0d7_KjU());
                                                }
                                            } else {
                                                if (dataAvailable() < 8) {
                                                    break;
                                            ...
                                            mutableSpanStyle.m8788setBaselineShift_isdbwI(BaselineShift.m9388boximpl(m8736decodeBaselineShifty9eOQZs()));
                                        }
                                    } else {
                                        if (dataAvailable() < 5) {
                                            break;
                                        }
                                        mutableSpanStyle.m8793setLetterSpacingR2X_6o(m8741decodeTextUnitXSAIIZE());
                                    }
                                } else {
                                ...
                                mutableSpanStyle.m8792setFontSynthesistDdu0R4(FontSynthesis.m9213boximpl(m8740decodeFontSynthesisGVVA2EU()));
                            }
                        } else {
                            if (dataAvailable() < 1) {
                                break;
                            }
                            mutableSpanStyle.m8791setFontStylemLjRB2g(FontStyle.m9202boximpl(m8739decodeFontStyle_LCdwA()));
                        }
                    } else {
                        if (dataAvailable() < 4) {
                            break;
                    ...
                    mutableSpanStyle.m8790setFontSizeR2X_6o(m8741decodeTextUnitXSAIIZE());
                }
            } else {
                if (dataAvailable() < 8) {
                    break;
                }
                mutableSpanStyle.m8789setColor8_81llA(m8738decodeColor0d7_KjU());
            }
        }
    ...
    public final long m8738decodeColor0d7_KjU() {
    ...
    public final long m8741decodeTextUnitXSAIIZE() {
        long jM9915getUnspecifiedUIouoOA;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
            jM9915getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m9914getSpUIouoOA();
        } else if (bDecodeByte == 2) {
            jM9915getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m9913getEmUIouoOA();
        } else {
            jM9915getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m9915getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m9909equalsimpl0(jM9915getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m9915getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m9892getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m9893TextUnitanM5pPY(decodeFloat(), jM9915getUnspecifiedUIouoOA);
    }
    ...
    public final int m8739decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
    ...
    public final int m8740decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontSynthesis.INSTANCE.m9223getNoneGVVA2EU();
        }
        if (bDecodeByte == 1) {
            return FontSynthesis.INSTANCE.m9222getAllGVVA2EU();
        }
        if (bDecodeByte == 3) {
            return FontSynthesis.INSTANCE.m9224getStyleGVVA2EU();
        }
        if (bDecodeByte == 2) {
            return FontSynthesis.INSTANCE.m9225getWeightGVVA2EU();
        }
        return FontSynthesis.INSTANCE.m9223getNoneGVVA2EU();
    }

    /* JADX INFO: renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m8736decodeBaselineShifty9eOQZs() {
        return BaselineShift.m9389constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        long jM8738decodeColor0d7_KjU = m8738decodeColor0d7_KjU();
        float fDecodeFloat = decodeFloat();
        return new Shadow(jM8738decodeColor0d7_KjU, Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(decodeFloat())) & 4294967295L) | (Float.floatToRawIntBits(fDecodeFloat) << 32)), decodeFloat(), null);
    }
    ...
    private final long m8737decodeULongsVKNKU() {
        return ULong.m14954constructorimpl(this.parcel.readLong());
    }
