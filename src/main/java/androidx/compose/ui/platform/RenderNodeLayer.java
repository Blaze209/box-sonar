...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((mutatedFields & 64) != 0) {
            this.renderNode.setAmbientShadowColor(ColorKt.m6868toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields & 128) != 0) {
            this.renderNode.setSpotShadowColor(ColorKt.m6868toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if (i != 0) {
            this.renderNode.setPivotX(TransformOrigin.m7224getPivotFractionXimpl(this.transformOrigin) * this.renderNode.getWidth());
            this.renderNode.setPivotY(TransformOrigin.m7225getPivotFractionYimpl(this.transformOrigin) * this.renderNode.getHeight());
        }
        ...
        if ((524288 & mutatedFields) != 0) {
            this.renderNode.mo8748setBlendModes9anfk8(scope.getBlendMode());
        }
        if ((32768 & mutatedFields) != 0) {
            this.renderNode.mo8749setCompositingStrategyaDBOjCE(scope.getCompositingStrategy());
        }
    ...
    public void mo8647resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m7224getPivotFractionXimpl(this.transformOrigin) * i);
        this.renderNode.setPivotY(TransformOrigin.m7225getPivotFractionYimpl(this.transformOrigin) * i2);
    ...
    public void mo8646movegyyYBs(long position) {
        ...
        if (left == iM9815getXimpl && top == iM9816getYimpl) {
            return;
        }
        if (left != iM9815getXimpl) {
            this.renderNode.offsetLeftAndRight(iM9815getXimpl - left);
        }
        if (top != iM9816getYimpl) {
            this.renderNode.offsetTopAndBottom(iM9816getYimpl - top);
        }
        triggerRepaint();
        this.matrixCache.invalidate();
    }
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer parentLayer) {
        ...
        canvas.mo6665concat58bKbWc(this.matrixCache.m8773calculateMatrixGrdbGEg(this.renderNode));
    ...
    public float[] mo8642getUnderlyingMatrixsQKQjiQ() {
        return this.matrixCache.m8773calculateMatrixGrdbGEg(this.renderNode);
    }
    ...
    public long mo8645mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            return this.matrixCache.m8775mapInverseR5De75A(this.renderNode, point);
        }
        return this.matrixCache.m8774mapR5De75A(this.renderNode, point);
    }
    ...
    public void mo8648transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m7079timesAssign58bKbWc(matrix, this.matrixCache.m8773calculateMatrixGrdbGEg(this.renderNode));
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* JADX INFO: renamed from: inverseTransform-58bKbWc */
    public void mo8643inverseTransform58bKbWc(float[] matrix) {
        float[] fArrM8772calculateInverseMatrixbWbORWo = this.matrixCache.m8772calculateInverseMatrixbWbORWo(this.renderNode);
