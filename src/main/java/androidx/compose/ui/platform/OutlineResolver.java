...
public final class OutlineResolver {
    ...
    public OutlineResolver() {
        ...
        this.rectTopLeft = Offset.INSTANCE.m6585getZeroF1C5BW0();
        this.rectSize = Size.INSTANCE.m6647getZeroNHjbRc();
    }
    ...
    public final boolean m8803updateS_szKao(androidx.compose.ui.graphics.Outline outline, float alpha, boolean clipToOutline, float elevation, long size) {
    ...
    public final boolean m8802isInOutlinek4lQ0M(long position) {
    ...
    public final void clipToOutline(Canvas canvas) {
        ...
        if (clipPath != null) {
            Canvas.m6785clipPathmtrdDE$default(canvas, clipPath, 0, 2, null);
            return;
        }
        ...
        if (f > 0.0f) {
            ...
            if (Path == null || !m8801isSameBounds4L21HEs(roundRect, this.rectTopLeft, this.rectSize, f)) {
                ...
                RoundRect roundRectM6623RoundRectgG7oq9Y = RoundRectKt.m6623RoundRectgG7oq9Y(fIntBitsToFloat, fIntBitsToFloat2, fIntBitsToFloat3, fIntBitsToFloat4, CornerRadius.m6523constructorimpl((((long) Float.floatToRawIntBits(f2)) << 32) | (((long) Float.floatToRawIntBits(f2)) & 4294967295L)));
                if (Path == null) {
                    Path = AndroidPath_androidKt.Path();
                } else {
                    Path.reset();
                }
                Path.addRoundRect$default(Path, roundRectM6623RoundRectgG7oq9Y, null, 2, null);
                this.tmpRoundRect = roundRectM6623RoundRectgG7oq9Y;
                this.tmpPath = Path;
            }
            Canvas.m6785clipPathmtrdDE$default(canvas, Path, 0, 2, null);
            return;
        }
        Canvas.m6786clipRectN_I0leg$default(canvas, Float.intBitsToFloat((int) (this.rectTopLeft >> 32)), Float.intBitsToFloat((int) (this.rectTopLeft & 4294967295L)), Float.intBitsToFloat((int) (this.rectTopLeft >> 32)) + Float.intBitsToFloat((int) (this.rectSize >> 32)), Float.intBitsToFloat((int) (this.rectTopLeft & 4294967295L)) + Float.intBitsToFloat((int) (this.rectSize & 4294967295L)), 0, 16, null);
    }
    ...
    private final void updateCacheWithRect(Rect rect) {
        ...
        this.rectTopLeft = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(rect.getTop())) & 4294967295L) | (Float.floatToRawIntBits(left) << 32));
        float right = rect.getRight() - rect.getLeft();
        this.rectSize = Size.m6629constructorimpl((((long) Float.floatToRawIntBits(rect.getBottom() - rect.getTop())) & 4294967295L) | (Float.floatToRawIntBits(right) << 32));
    ...
    private final void updateCacheWithRoundRect(RoundRect roundRect) {
        float fIntBitsToFloat = Float.intBitsToFloat((int) (roundRect.m6619getTopLeftCornerRadiuskKHJgLs() >> 32));
        float left = roundRect.getLeft();
        this.rectTopLeft = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(roundRect.getTop())) & 4294967295L) | (Float.floatToRawIntBits(left) << 32));
        float width = roundRect.getWidth();
        this.rectSize = Size.m6629constructorimpl((((long) Float.floatToRawIntBits(roundRect.getHeight())) & 4294967295L) | (Float.floatToRawIntBits(width) << 32));
    ...
    private final boolean m8801isSameBounds4L21HEs(RoundRect roundRect, long j, long j2, float f) {
        ...
        return roundRect.getTop() == Float.intBitsToFloat(i2) && roundRect.getRight() == Float.intBitsToFloat(i) + Float.intBitsToFloat((int) (j2 >> 32)) && roundRect.getBottom() == Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j2 & 4294967295L)) && Float.intBitsToFloat((int) (roundRect.m6619getTopLeftCornerRadiuskKHJgLs() >> 32)) == f;
    }
}
