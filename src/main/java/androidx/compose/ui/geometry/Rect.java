...
public final /* data */ class Rect {
    ...
    public static /* synthetic */ void m6594getSizeNHjbRc$annotations() {
    }
    ...
    public final Rect m6606translatek4lQ0M(long offset) {
        int i = (int) (offset >> 32);
    ...
    public final long m6604getTopLeftF1C5BW0() {
        float f = this.left;
        float f2 = this.top;
    ...
    public final long m6603getTopCenterF1C5BW0() {
        float right = this.left + ((getRight() - getLeft()) / 2.0f);
        float f = this.top;
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(right)) << 32) | (((long) Float.floatToRawIntBits(f)) & 4294967295L));
    }

    /* JADX INFO: renamed from: getTopRight-F1C5BW0, reason: not valid java name */
    public final long m6605getTopRightF1C5BW0() {
        float f = this.right;
        float f2 = this.top;
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(f)) << 32) | (((long) Float.floatToRawIntBits(f2)) & 4294967295L));
    }
    ...
    public final long m6600getCenterLeftF1C5BW0() {
        float f = this.left;
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(this.top + ((getBottom() - getTop()) / 2.0f))) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }

    /* JADX INFO: renamed from: getCenter-F1C5BW0, reason: not valid java name */
    public final long m6599getCenterF1C5BW0() {
        float right = this.left + ((getRight() - getLeft()) / 2.0f);
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(this.top + ((getBottom() - getTop()) / 2.0f))) & 4294967295L) | (Float.floatToRawIntBits(right) << 32));
    }

    /* JADX INFO: renamed from: getCenterRight-F1C5BW0, reason: not valid java name */
    public final long m6601getCenterRightF1C5BW0() {
        float f = this.right;
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(this.top + ((getBottom() - getTop()) / 2.0f))) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }

    /* JADX INFO: renamed from: getBottomLeft-F1C5BW0, reason: not valid java name */
    public final long m6597getBottomLeftF1C5BW0() {
        float f = this.left;
    ...
    public final long m6596getBottomCenterF1C5BW0() {
        float right = this.left + ((getRight() - getLeft()) / 2.0f);
        float f = this.bottom;
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(right)) << 32) | (((long) Float.floatToRawIntBits(f)) & 4294967295L));
    }
    ...
    public final long m6598getBottomRightF1C5BW0() {
        float f = this.right;
        float f2 = this.bottom;
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(f)) << 32) | (((long) Float.floatToRawIntBits(f2)) & 4294967295L));
    }
    ...
    public final long m6602getSizeNHjbRc() {
        float right = getRight() - getLeft();
        return Size.m6629constructorimpl((((long) Float.floatToRawIntBits(getBottom() - getTop())) & 4294967295L) | (Float.floatToRawIntBits(right) << 32));
    }
    ...
    public final boolean m6595containsk4lQ0M(long offset) {
