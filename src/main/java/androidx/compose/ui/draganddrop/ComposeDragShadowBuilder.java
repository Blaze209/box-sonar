...
public final class ComposeDragShadowBuilder extends View.DragShadowBuilder {
    ...
    public void onProvideShadowMetrics(Point outShadowSize, Point outShadowTouchPoint) {
        ...
        outShadowSize.set(density.mo748roundToPx0680j_4(density.mo750toDpu2uoSUM(Float.intBitsToFloat((int) (this.decorationSize >> 32)))), density.mo748roundToPx0680j_4(density.mo750toDpu2uoSUM(Float.intBitsToFloat((int) (this.decorationSize & 4294967295L)))));
    ...
    public void onDrawShadow(Canvas canvas) {
        ...
        drawParams2.m7315setSizeuvyYCjk(j);
        Canvas.save();
