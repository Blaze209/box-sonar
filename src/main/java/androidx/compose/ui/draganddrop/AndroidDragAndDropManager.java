...
public final class AndroidDragAndDropManager implements View.OnDragListener, DragAndDropManager {
    ...
    public void mo6318requestDragAndDropTransferUv8p0NA(DragAndDropNode node, long offset) {
        final Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        node.m6324startDragAndDropTransferd4ec7I(new DragAndDropStartTransferScope() { // from class: androidx.compose.ui.draganddrop.AndroidDragAndDropManager$requestDragAndDropTransfer$dragAndDropSourceScope$1
            ...
            public boolean mo6319startDragAndDropTransfer12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
                booleanRef.element = ((Boolean) this.startDrag.invoke(transferData, Size.m6626boximpl(decorationSize), drawDragDecoration)).booleanValue();
