...
public interface DragAndDropStartTransferScope {
    ...
    boolean mo6319startDragAndDropTransfer12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration);
}
