...
public final class DragAndDropNode extends Modifier.Node implements TraversableNode, DragAndDropModifierNode, DragAndDropSourceModifierNode, DragAndDropTargetModifierNode, DragAndDropTarget {
    ...
    public final void m6323setSizeozmzZPI$ui(long j) {
        this.size = j;
    }
    ...
    public void mo6322requestDragAndDropTransferk4lQ0M(long offset) {
        if (!(this.onStartTransfer != null)) {
            InlineClassHelperKt.throwIllegalStateException("Check failed.");
        }
        getDragAndDropManager().mo6318requestDragAndDropTransferUv8p0NA(this, offset);
    }

    /* JADX INFO: renamed from: startDragAndDropTransfer-d-4ec7I, reason: not valid java name */
    public final void m6324startDragAndDropTransferd4ec7I(final DragAndDropStartTransferScope dragAndDropStartTransferScope, final long j, final Function0<Boolean> function0) {
        ...
        DragAndDropNodeKt.traverseSelfAndDescendants(this, new Function1<DragAndDropNode, TraversableNode.Companion.TraverseDescendantsAction>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$startDragAndDropTransfer$1
            ...
            public final TraversableNode.Companion.TraverseDescendantsAction invoke(DragAndDropNode dragAndDropNode) {
                if (dragAndDropNode.getIsAttached()) {
                    ...
                    if (!Offset.m6566equalsimpl0(j, Offset.INSTANCE.m6584getUnspecifiedF1C5BW0())) {
                        long jMo8274localPositionOfR5De75A = DelegatableNodeKt.requireLayoutNode(dragAndDropNode).getCoordinates().mo8274localPositionOfR5De75A(coordinates, j);
                        if (!SizeKt.m6659toRectuvyYCjk(IntSizeKt.m9870toSizeozmzZPI(dragAndDropNode.getSize())).m6595containsk4lQ0M(jMo8274localPositionOfR5De75A)) {
                            return TraversableNode.Companion.TraverseDescendantsAction.ContinueTraversal;
                        }
                        function2.invoke(dragAndDropStartTransferScope, Offset.m6558boximpl(jMo8274localPositionOfR5De75A));
                    } else {
                        function2.invoke(dragAndDropStartTransferScope, Offset.m6558boximpl(Offset.INSTANCE.m6584getUnspecifiedF1C5BW0()));
                    }
    ...
    public void mo6320drag12SF9DM(final DragAndDropTransferData transferData, final long decorationSize, final Function1<? super DrawScope, Unit> drawDragDecoration) {
        if (!(this.onStartTransfer == null)) {
            InlineClassHelperKt.throwIllegalStateException("Check failed.");
        }
        this.onStartTransfer = new Function2<DragAndDropStartTransferScope, Offset, Unit>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$drag$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(DragAndDropStartTransferScope dragAndDropStartTransferScope, Offset offset) {
                m6325invokeUv8p0NA(dragAndDropStartTransferScope, offset.m6579unboximpl());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-Uv8p0NA, reason: not valid java name */
            public final void m6325invokeUv8p0NA(DragAndDropStartTransferScope dragAndDropStartTransferScope, long j) {
                dragAndDropStartTransferScope.mo6319startDragAndDropTransfer12SF9DM(transferData, decorationSize, drawDragDecoration);
            }
        };
        getDragAndDropManager().mo6318requestDragAndDropTransferUv8p0NA(this, Offset.INSTANCE.m6584getUnspecifiedF1C5BW0());
    ...
    public void onMoved(final DragAndDropEvent event) {
        ...
        if (dragAndDropNode2 == null || !DragAndDropNodeKt.m6327containsUv8p0NA(dragAndDropNode2, DragAndDrop_androidKt.getPositionInRoot(event))) {
            ...
            if (dragAndDropNode3.getNode().getIsAttached()) {
                ...
                TraversableNodeKt.traverseDescendants(dragAndDropNode3, new Function1<DragAndDropNode, TraversableNode.Companion.TraverseDescendantsAction>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$onMoved$$inlined$firstDescendantOrNull$1
                    ...
                    public final TraversableNode.Companion.TraverseDescendantsAction invoke(DragAndDropNode dragAndDropNode4) {
                        ...
                        if (this.getDragAndDropManager().isInterestedTarget(dragAndDropNode5) && DragAndDropNodeKt.m6327containsUv8p0NA(dragAndDropNode5, DragAndDrop_androidKt.getPositionInRoot(event))) {
