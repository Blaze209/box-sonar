...
public final class DragAndDropNodeKt {
    ...
    public static final boolean m6327containsUv8p0NA(DragAndDropNode dragAndDropNode, long j) {
        ...
        float fM6321getSizeYbymL2g$ui = ((int) (dragAndDropNode.getSize() >> 32)) + fIntBitsToFloat;
        float fM6321getSizeYbymL2g$ui2 = ((int) (dragAndDropNode.getSize() & 4294967295L)) + fIntBitsToFloat2;
        float fIntBitsToFloat3 = Float.intBitsToFloat((int) (j >> 32));
        if (fIntBitsToFloat <= fIntBitsToFloat3 && fIntBitsToFloat3 <= fM6321getSizeYbymL2g$ui) {
            float fIntBitsToFloat4 = Float.intBitsToFloat((int) (j & 4294967295L));
            if (fIntBitsToFloat2 <= fIntBitsToFloat4 && fIntBitsToFloat4 <= fM6321getSizeYbymL2g$ui2) {
                return true;
            }
        }
        return false;
