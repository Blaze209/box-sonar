...
public final class LineHeightStyleSpan implements android.text.style.LineHeightSpan {
    ...
    public void chooseHeight(CharSequence text, int start, int end, int spanStartVertical, int lineHeight, Paint.FontMetricsInt fontMetricsInt) {
        ...
        if (z && z2 && this.trimFirstLineTop && this.trimLastLineBottom && !LineHeightStyle.Mode.m9499equalsimpl0(this.mode, LineHeightStyle.Mode.INSTANCE.m9505getTightlzQqcRY())) {
            return;
        }
    ...
    private final void calculateTargetMetrics(Paint.FontMetricsInt fontMetricsInt) {
        ...
        if (LineHeightStyle.Mode.m9499equalsimpl0(this.mode, LineHeightStyle.Mode.INSTANCE.m9504getMinimumlzQqcRY()) && i <= 0) {
        ...
        int i3 = fontMetricsInt.descent + ((int) dCeil);
        this.descent = i3;
        this.ascent = i3 - iCeil;
        if (LineHeightStyle.Mode.m9499equalsimpl0(this.mode, LineHeightStyle.Mode.INSTANCE.m9503getFixedlzQqcRY()) || i >= 0) {
        ...
        if (LineHeightStyle.Mode.m9499equalsimpl0(this.mode, LineHeightStyle.Mode.INSTANCE.m9505getTightlzQqcRY())) {
