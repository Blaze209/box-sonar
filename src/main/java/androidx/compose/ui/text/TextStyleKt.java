...
public final class TextStyleKt {
    ...
    public static final int m9137resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int i) {
        if (TextDirection.m9539equalsimpl0(i, TextDirection.INSTANCE.m9543getContents_7Xco())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                return TextDirection.INSTANCE.m9544getContentOrLtrs_7Xco();
            }
            if (i2 != 2) {
                throw new NoWhenBranchMatchedException();
            }
            return TextDirection.INSTANCE.m9545getContentOrRtls_7Xco();
        }
        if (!TextDirection.m9539equalsimpl0(i, TextDirection.INSTANCE.m9548getUnspecifieds_7Xco())) {
            return i;
        }
        int i3 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
        if (i3 == 1) {
            return TextDirection.INSTANCE.m9546getLtrs_7Xco();
        }
        if (i3 != 2) {
            throw new NoWhenBranchMatchedException();
        }
        return TextDirection.INSTANCE.m9547getRtls_7Xco();
    }
