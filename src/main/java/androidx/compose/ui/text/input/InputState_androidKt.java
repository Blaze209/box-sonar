...
public final class InputState_androidKt {
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m9089getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m9088getMaximpl(textFieldValue.getSelection());
