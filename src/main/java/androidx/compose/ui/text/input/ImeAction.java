...
public final class ImeAction {
    ...
    private static final int Unspecified = m9261constructorimpl(-1);
    private static final int Default = m9261constructorimpl(1);
    private static final int None = m9261constructorimpl(0);
    private static final int Go = m9261constructorimpl(2);
    private static final int Search = m9261constructorimpl(3);
    private static final int Send = m9261constructorimpl(4);
    private static final int Previous = m9261constructorimpl(5);
    private static final int Next = m9261constructorimpl(6);
    private static final int Done = m9261constructorimpl(7);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ImeAction m9260boximpl(int i) {
        return new ImeAction(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m9261constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m9262equalsimpl(int i, Object obj) {
        return (obj instanceof ImeAction) && i == ((ImeAction) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m9263equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m9264hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object other) {
        return m9262equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m9264hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m9265toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m9265toStringimpl(int i) {
        if (m9263equalsimpl0(i, Unspecified)) {
            return "Unspecified";
        }
        if (m9263equalsimpl0(i, None)) {
            return "None";
        }
        if (m9263equalsimpl0(i, Default)) {
            return "Default";
        }
        if (m9263equalsimpl0(i, Go)) {
            return "Go";
        }
        if (m9263equalsimpl0(i, Search)) {
            return "Search";
        }
        if (m9263equalsimpl0(i, Send)) {
            return "Send";
        }
        if (m9263equalsimpl0(i, Previous)) {
            return "Previous";
        }
        if (m9263equalsimpl0(i, Next)) {
            return "Next";
        }
        return m9263equalsimpl0(i, Done) ? "Done" : "Invalid";
    }
