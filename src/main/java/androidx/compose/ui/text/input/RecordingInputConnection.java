...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        if (this.isActive) {
            ...
            int iM9089getMinimpl = composition != null ? TextRange.m9089getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m9089getMinimpl(state.getSelection()), TextRange.m9088getMaximpl(state.getSelection()), iM9089getMinimpl, composition2 != null ? TextRange.m9088getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m9085getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m9089getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        int iM9276getDefaulteUduSuo;
        boolean z = this.isActive;
        if (!z) {
            return z;
        }
        if (editorAction == 0) {
            iM9276getDefaulteUduSuo = ImeAction.INSTANCE.m9276getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    iM9276getDefaulteUduSuo = ImeAction.INSTANCE.m9278getGoeUduSuo();
                    break;
                case 3:
                    iM9276getDefaulteUduSuo = ImeAction.INSTANCE.m9282getSearcheUduSuo();
                    break;
                case 4:
                    iM9276getDefaulteUduSuo = ImeAction.INSTANCE.m9283getSendeUduSuo();
                    break;
                case 5:
                    iM9276getDefaulteUduSuo = ImeAction.INSTANCE.m9279getNexteUduSuo();
                    break;
                case 6:
                    iM9276getDefaulteUduSuo = ImeAction.INSTANCE.m9277getDoneeUduSuo();
                    break;
                case 7:
                    iM9276getDefaulteUduSuo = ImeAction.INSTANCE.m9281getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo9295onImeActionKlQnJC8(iM9276getDefaulteUduSuo);
        return true;
    }
