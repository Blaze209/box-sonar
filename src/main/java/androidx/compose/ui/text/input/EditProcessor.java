...
public final class EditProcessor {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.INSTANCE.m9096getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    ...
    public final void reset(TextFieldValue value, TextInputSession textInputSession) {
        boolean zAreEqual = Intrinsics.areEqual(value.getComposition(), this.mBuffer.m9257getCompositionMzsxiRA$ui_text());
        boolean z = true;
        boolean z2 = false;
        ...
        } else if (TextRange.m9084equalsimpl0(this.mBufferState.getSelection(), value.getSelection())) {
            z = false;
        } else {
            this.mBuffer.setSelection$ui_text(TextRange.m9089getMinimpl(value.getSelection()), TextRange.m9088getMaximpl(value.getSelection()));
            z2 = true;
            z = false;
        }
        if (value.getComposition() == null) {
            this.mBuffer.commitComposition$ui_text();
        } else if (!TextRange.m9085getCollapsedimpl(value.getComposition().getPackedValue())) {
            this.mBuffer.setComposition$ui_text(TextRange.m9089getMinimpl(value.getComposition().getPackedValue()), TextRange.m9088getMaximpl(value.getComposition().getPackedValue()));
        }
        if (z || (!z2 && !zAreEqual)) {
            this.mBuffer.commitComposition$ui_text();
            value = TextFieldValue.m9340copy3r_uNRQ$default(value, (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null);
        }
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> editCommands, final EditCommand failedCommand) {
        ...
        StringBuilder sbAppend = sb.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text() + ", composition=" + this.mBuffer.m9257getCompositionMzsxiRA$ui_text() + ", selection=" + ((Object) TextRange.m9094toStringimpl(this.mBuffer.m9258getSelectiond9O1mEE$ui_text())) + "):");
        Intrinsics.checkNotNullExpressionValue(sbAppend, "append(...)");
        Intrinsics.checkNotNullExpressionValue(sbAppend.append('\n'), "append(...)");
        CollectionsKt.joinTo(editCommands, sb, (112 & 2) != 0 ? ", " : "\n", (112 & 4) != 0 ? "" : null, (112 & 8) != 0 ? "" : null, (112 & 16) != 0 ? -1 : 0, (112 & 32) != 0 ? "..." : null, (112 & 64) != 0 ? null : new Function1() { // from class: androidx.compose.ui.text.input.EditProcessor$$ExternalSyntheticLambda0
    ...
    public final TextFieldValue apply(List<? extends EditCommand> editCommands) {
        ...
        try {
            ...
            long jM9258getSelectiond9O1mEE$ui_text = this.mBuffer.m9258getSelectiond9O1mEE$ui_text();
            TextRange textRangeM9079boximpl = TextRange.m9079boximpl(jM9258getSelectiond9O1mEE$ui_text);
            textRangeM9079boximpl.getPackedValue();
            TextRange textRange = TextRange.m9090getReversedimpl(this.mBufferState.getSelection()) ? null : textRangeM9079boximpl;
            TextFieldValue textFieldValue = new TextFieldValue(annotatedString$ui_text, textRange != null ? textRange.getPackedValue() : TextRangeKt.TextRange(TextRange.m9088getMaximpl(jM9258getSelectiond9O1mEE$ui_text), TextRange.m9089getMinimpl(jM9258getSelectiond9O1mEE$ui_text)), this.mBuffer.m9257getCompositionMzsxiRA$ui_text(), (DefaultConstructorMarker) null);
