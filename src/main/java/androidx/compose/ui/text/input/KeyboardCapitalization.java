...
public final class KeyboardCapitalization {
    ...
    private static final int Unspecified = m9297constructorimpl(-1);
    private static final int None = m9297constructorimpl(0);
    private static final int Characters = m9297constructorimpl(1);
    private static final int Words = m9297constructorimpl(2);
    private static final int Sentences = m9297constructorimpl(3);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ KeyboardCapitalization m9296boximpl(int i) {
        return new KeyboardCapitalization(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m9297constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m9298equalsimpl(int i, Object obj) {
        return (obj instanceof KeyboardCapitalization) && i == ((KeyboardCapitalization) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m9299equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m9300hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object other) {
        return m9298equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m9300hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m9301toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m9301toStringimpl(int i) {
        if (m9299equalsimpl0(i, Unspecified)) {
            return "Unspecified";
        }
        if (m9299equalsimpl0(i, None)) {
            return "None";
        }
        if (m9299equalsimpl0(i, Characters)) {
            return "Characters";
        }
        if (m9299equalsimpl0(i, Words)) {
            return "Words";
        }
        return m9299equalsimpl0(i, Sentences) ? "Sentences" : "Invalid";
    }
