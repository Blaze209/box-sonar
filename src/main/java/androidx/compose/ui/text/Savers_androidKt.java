...
public final class Savers_androidKt {
    ...
    public static final Object PlatformParagraphStyleSaver$lambda$0(SaverScope saverScope, PlatformParagraphStyle platformParagraphStyle) {
        return CollectionsKt.arrayListOf(SaversKt.save(Boolean.valueOf(platformParagraphStyle.getIncludeFontPadding())), SaversKt.save(EmojiSupportMatch.m8911boximpl(platformParagraphStyle.getEmojiSupportMatch()), getSaver(EmojiSupportMatch.INSTANCE), saverScope));
    }
    ...
    public static final EmojiSupportMatch emojiSupportMatchSaver$lambda$1(Object obj) {
        ...
        return EmojiSupportMatch.m8911boximpl(EmojiSupportMatch.m8912constructorimpl(((Integer) obj).intValue()));
    }
    ...
    public static final LineBreak LineBreakSaver$lambda$1(Object obj) {
        Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlin.Int");
        return LineBreak.m9424boximpl(LineBreak.m9425constructorimpl(((Integer) obj).intValue()));
    }
    ...
    public static final Object TextMotionSaver$lambda$0(SaverScope saverScope, TextMotion textMotion) {
        return CollectionsKt.arrayListOf(SaversKt.save(TextMotion.Linearity.m9561boximpl(textMotion.getLinearity()), getSaver(TextMotion.Linearity.INSTANCE), saverScope), SaversKt.save(Boolean.valueOf(textMotion.getSubpixelTextPositioning())));
    }
    ...
    public static final TextMotion.Linearity TextMotionLinearitySaver$lambda$1(Object obj) {
        Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlin.Int");
        return TextMotion.Linearity.m9561boximpl(TextMotion.Linearity.m9562constructorimpl(((Integer) obj).intValue()));
    }
}
