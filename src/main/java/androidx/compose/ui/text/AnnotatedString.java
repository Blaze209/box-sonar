...
public final class AnnotatedString implements CharSequence {
    ...
    public final AnnotatedString m8896subSequence5zctL8(long range) {
        return subSequence(TextRange.m9089getMinimpl(range), TextRange.m9088getMaximpl(range));
    }
    ...
    public static final class Builder implements Appendable {
        ...
        public final void addStringAnnotation(String tag, String annotation, int start, int end) {
            this.annotations.add(new MutableRange<>(StringAnnotation.m9038boximpl(StringAnnotation.m9039constructorimpl(annotation)), start, end, tag));
        }
        ...
        public final void m8898addBulletr9BaKPg(Bullet bullet, long indentation, int start, int end) {
        ...
        public static /* synthetic */ Object m8897withBulletListo2QH7mI$default(Builder builder, long j, Bullet bullet, Function1 function1, int i, Object obj) {
            if ((i & 1) != 0) {
                j = Bullet.INSTANCE.m8908getDefaultIndentationXSAIIZE();
            }
            if ((i & 2) != 0) {
                bullet = Bullet.INSTANCE.getDefault();
            }
            return builder.m8899withBulletListo2QH7mI(j, bullet, function1);
        }

        /* JADX INFO: renamed from: withBulletList-o2QH7mI, reason: not valid java name */
        public final <R> R m8899withBulletListo2QH7mI(long indentation, Bullet bullet, Function1<? super BulletScope, ? extends R> block) {
            long j;
            long em;
            ...
            if (pair != null) {
                ...
                if (!TextUnitType.m9909equalsimpl0(TextUnit.m9880getTypeUIouoOA(packedValue), TextUnit.m9880getTypeUIouoOA(indentation))) {
                    InlineClassHelperKt.throwIllegalStateException("Indentation unit types of nested bullet lists must match. Current " + ((Object) TextUnit.m9888toStringimpl(packedValue)) + " and previous is " + ((Object) TextUnit.m9888toStringimpl(indentation)));
                }
                long jM9880getTypeUIouoOA = TextUnit.m9880getTypeUIouoOA(indentation);
                if (TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9914getSpUIouoOA())) {
                    em = TextUnitKt.getSp(TextUnit.m9881getValueimpl(indentation) + TextUnit.m9881getValueimpl(packedValue));
                } else {
                    em = TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9913getEmUIouoOA()) ? TextUnitKt.getEm(TextUnit.m9881getValueimpl(indentation) + TextUnit.m9881getValueimpl(packedValue)) : indentation;
                }
                j = em;
            } else {
                j = indentation;
            ...
            this.bulletScope.getBulletListSettingStack$ui_text().add(new Pair<>(TextUnit.m9871boximpl(j), bullet));
            try {
        ...
        public final <R> R withBulletListItem(BulletScope bulletScope, Bullet bullet, Function1<? super Builder, ? extends R> function1) {
            ...
            long packedValue = pair != null ? ((TextUnit) pair.getFirst()).getPackedValue() : Bullet.INSTANCE.m8908getDefaultIndentationXSAIIZE();
            if (bullet != null) {
                bullet2 = bullet;
        ...
        public final int pushStringAnnotation(String tag, String annotation) {
            MutableRange<? extends Annotation> mutableRange = new MutableRange<>(StringAnnotation.m9038boximpl(StringAnnotation.m9039constructorimpl(annotation)), this.text.length(), 0, tag, 4, null);
            this.styleStack.add(mutableRange);
            this.annotations.add(mutableRange);
            return this.styleStack.size() - 1;
        }
