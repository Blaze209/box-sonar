...
public final class TextOverflow {
    ...
    private static final int Clip = m9572constructorimpl(1);
    private static final int Ellipsis = m9572constructorimpl(2);
    private static final int Visible = m9572constructorimpl(3);
    private static final int StartEllipsis = m9572constructorimpl(4);
    private static final int MiddleEllipsis = m9572constructorimpl(5);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextOverflow m9571boximpl(int i) {
        return new TextOverflow(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m9572constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m9573equalsimpl(int i, Object obj) {
        return (obj instanceof TextOverflow) && i == ((TextOverflow) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m9574equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m9575hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object other) {
        return m9573equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m9575hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m9576toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m9576toStringimpl(int i) {
        if (m9574equalsimpl0(i, Clip)) {
            return "Clip";
        }
        if (m9574equalsimpl0(i, Ellipsis)) {
            return "Ellipsis";
        }
        if (m9574equalsimpl0(i, MiddleEllipsis)) {
            return "MiddleEllipsis";
        }
        if (m9574equalsimpl0(i, Visible)) {
            return "Visible";
        }
        return m9574equalsimpl0(i, StartEllipsis) ? "StartEllipsis" : "Invalid";
    }
