...
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u000e\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0007\u0018\u0000 \u001c2\u00020\u0001:\u0004\u001c\u001d\u001e\u001fB\u001f\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0004\b\b\u0010\tB\u0019\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0004\b\b\u0010\nJ+\u0010\u0012\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u0007¢\u0006\u0004\b\u0013\u0010\u0014J\u0013\u0010\u0015\u001a\u00020\u00162\b\u0010\u0017\u001a\u0004\u0018\u00010\u0001H\u0096\u0002J\b\u0010\u0018\u001a\u00020\u0019H\u0016J\b\u0010\u001a\u001a\u00020\u001bH\u0016R\u0013\u0010\u0002\u001a\u00020\u0003¢\u0006\n\n\u0002\u0010\r\u001a\u0004\b\u000b\u0010\fR\u0013\u0010\u0004\u001a\u00020\u0005¢\u0006\n\n\u0002\u0010\u0010\u001a\u0004\b\u000e\u0010\u000fR\u0013\u0010\u0006\u001a\u00020\u0007¢\u0006\n\n\u0002\u0010\u0010\u001a\u0004\b\u0011\u0010\u000f¨\u0006 "}, d2 = {"Landroidx/compose/ui/text/style/LineHeightStyle;", "", "alignment", "Landroidx/compose/ui/text/style/LineHeightStyle$Alignment;", "trim", "Landroidx/compose/ui/text/style/LineHeightStyle$Trim;", DiagnosisParams.DIAGNOSIS_MODE, "Landroidx/compose/ui/text/style/LineHeightStyle$Mode;", "<init>", "(FIILkotlin/jvm/internal/DefaultConstructorMarker;)V", "(FILkotlin/jvm/internal/DefaultConstructorMarker;)V", "getAlignment-PIaL0Z0", "()F", "F", "getTrim-EVpEnUU", "()I", "I", "getMode-lzQqcRY", BoxAmplitudeAnalytics.JobEventPropertyBuilder.JOB_TYPE_COPY_JOB, "copy-38bxuX8", "(FII)Landroidx/compose/ui/text/style/LineHeightStyle;", "equals", "", "other", "hashCode", "", "toString", "", "Companion", "Trim", "Alignment", "Mode", "ui-text"}, k = 1, mv = {2, 0, 0}, xi = 48)
public final class LineHeightStyle {
    ...
    private LineHeightStyle(float f, int i) {
        this(f, i, Mode.INSTANCE.m9503getFixedlzQqcRY(), null);
    }
    ...
    static {
        ...
        Default = new LineHeightStyle(Alignment.INSTANCE.m9494getProportionalPIaL0Z0(), Trim.INSTANCE.m9515getBothEVpEnUU(), Mode.INSTANCE.m9503getFixedlzQqcRY(), defaultConstructorMarker);
    }

    /* JADX INFO: renamed from: copy-38bxuX8$default, reason: not valid java name */
    public static /* synthetic */ LineHeightStyle m9480copy38bxuX8$default(LineHeightStyle lineHeightStyle, float f, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        return lineHeightStyle.m9481copy38bxuX8(f, i, i2);
    }

    /* JADX INFO: renamed from: copy-38bxuX8, reason: not valid java name */
    public final LineHeightStyle m9481copy38bxuX8(float alignment, int trim, int mode) {
    ...
    public boolean equals(Object other) {
        ...
        return Alignment.m9488equalsimpl0(this.alignment, lineHeightStyle.alignment) && Trim.m9509equalsimpl0(this.trim, lineHeightStyle.trim) && Mode.m9499equalsimpl0(this.mode, lineHeightStyle.mode);
    }

    public int hashCode() {
        return (((Alignment.m9489hashCodeimpl(this.alignment) * 31) + Trim.m9510hashCodeimpl(this.trim)) * 31) + Mode.m9500hashCodeimpl(this.mode);
    }

    public String toString() {
        return "LineHeightStyle(alignment=" + ((Object) Alignment.m9490toStringimpl(this.alignment)) + ", trim=" + ((Object) Trim.m9513toStringimpl(this.trim)) + ",mode=" + ((Object) Mode.m9501toStringimpl(this.mode)) + ')';
    }
    ...
    public static final class Trim {
        ...
        private static final int FirstLineTop = m9507constructorimpl(1);
        private static final int LastLineBottom = m9507constructorimpl(16);
        private static final int Both = m9507constructorimpl(17);
        private static final int None = m9507constructorimpl(0);

        /* JADX INFO: renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Trim m9506boximpl(int i) {
            return new Trim(i);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static int m9507constructorimpl(int i) {
            return i;
        }

        /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
        public static boolean m9508equalsimpl(int i, Object obj) {
            return (obj instanceof Trim) && i == ((Trim) obj).getValue();
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m9509equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m9510hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        /* JADX INFO: renamed from: isTrimFirstLineTop-impl$ui_text, reason: not valid java name */
        public static final boolean m9511isTrimFirstLineTopimpl$ui_text(int i) {
            return (i & 1) > 0;
        }

        /* JADX INFO: renamed from: isTrimLastLineBottom-impl$ui_text, reason: not valid java name */
        public static final boolean m9512isTrimLastLineBottomimpl$ui_text(int i) {
            return (i & 16) > 0;
        }

        public boolean equals(Object other) {
            return m9508equalsimpl(this.value, other);
        }

        public int hashCode() {
            return m9510hashCodeimpl(this.value);
        }
        ...
        public String toString() {
            return m9513toStringimpl(this.value);
        }

        /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
        public static String m9513toStringimpl(int i) {
            if (i == FirstLineTop) {
    ...
    public static final class Alignment {
        ...
        /* JADX INFO: renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final float Top = m9486constructorimpl(0.0f);
        private static final float Center = m9486constructorimpl(0.5f);
        private static final float Proportional = m9486constructorimpl(-1.0f);
        private static final float Bottom = m9486constructorimpl(1.0f);

        /* JADX INFO: renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Alignment m9485boximpl(float f) {
            return new Alignment(f);
        }

        /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
        public static boolean m9487equalsimpl(float f, Object obj) {
            return (obj instanceof Alignment) && Float.compare(f, ((Alignment) obj).getTopRatio()) == 0;
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m9488equalsimpl0(float f, float f2) {
            return Float.compare(f, f2) == 0;
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m9489hashCodeimpl(float f) {
            return Float.hashCode(f);
        }

        public boolean equals(Object other) {
            return m9487equalsimpl(this.topRatio, other);
        }

        public int hashCode() {
            return m9489hashCodeimpl(this.topRatio);
        }
        ...
        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static float m9486constructorimpl(float f) {
        ...
        public String toString() {
            return m9490toStringimpl(this.topRatio);
        }

        /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
        public static String m9490toStringimpl(float f) {
            if (f == Top) {
    ...
    public static final class Mode {
        ...
        /* JADX INFO: renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final int Fixed = m9497constructorimpl(0);
        private static final int Minimum = m9497constructorimpl(1);
        private static final int Tight = m9497constructorimpl(2);
        private final int value;

        /* JADX INFO: renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Mode m9496boximpl(int i) {
            return new Mode(i);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static int m9497constructorimpl(int i) {
            return i;
        }

        /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
        public static boolean m9498equalsimpl(int i, Object obj) {
            return (obj instanceof Mode) && i == ((Mode) obj).getValue();
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m9499equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m9500hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        public boolean equals(Object other) {
            return m9498equalsimpl(this.value, other);
        }

        public int hashCode() {
            return m9500hashCodeimpl(this.value);
        }
        ...
        public String toString() {
            return m9501toStringimpl(this.value);
        }

        /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
        public static String m9501toStringimpl(int i) {
            if (m9499equalsimpl0(i, Fixed)) {
                return "LineHeightStyle.Mode.Fixed";
            }
            if (m9499equalsimpl0(i, Minimum)) {
                return "LineHeightStyle.Mode.Minimum";
            }
            return m9499equalsimpl0(i, Tight) ? "LineHeightStyle.Mode.Tight" : "Invalid";
        }
