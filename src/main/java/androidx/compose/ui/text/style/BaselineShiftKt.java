...
public final class BaselineShiftKt {
    ...
    public static final boolean m9403isSpecified4Dl_Bck(float f) {
        return !Float.isNaN(f);
    }

    /* JADX INFO: renamed from: takeOrElse-JpAxnlU, reason: not valid java name */
    public static final float m9405takeOrElseJpAxnlU(float f, Function0<BaselineShift> function0) {
        return Float.isNaN(f) ? function0.invoke().m9394unboximpl() : f;
    }

    /* JADX INFO: renamed from: lerp-jWV1Mfo, reason: not valid java name */
    public static final float m9404lerpjWV1Mfo(float f, float f2, float f3) {
        return BaselineShift.m9389constructorimpl(MathHelpersKt.lerp(f, f2, f3));
    }
}
