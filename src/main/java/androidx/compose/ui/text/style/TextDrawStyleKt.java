...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle textForegroundStyle, TextForegroundStyle textForegroundStyle2, float f) {
        ...
        if (!z && !(textForegroundStyle2 instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m9553from8_81llA(ColorKt.m6865lerpjxsXWHM(textForegroundStyle.mo9406getColor0d7_KjU(), textForegroundStyle2.mo9406getColor0d7_KjU(), f));
        }
        if (z && (textForegroundStyle2 instanceof BrushStyle)) {
    ...
    public static final long m9552modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m6813copywmQWz5c$default(j, Color.m6816getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
