...
public final class TextIndent {
    ...
    public static /* synthetic */ TextIndent m9554copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m9555copyNB67dxo(j, j2);
    }

    /* JADX INFO: renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m9555copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m9878equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m9878equalsimpl0(this.restLine, textIndent.restLine);
    }

    public int hashCode() {
        return (TextUnit.m9882hashCodeimpl(this.firstLine) * 31) + TextUnit.m9882hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m9888toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m9888toStringimpl(this.restLine)) + ')';
    }
}
