...
public final class MultiParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public final ParagraphStyle resolveTextDirection(ParagraphStyle style, ParagraphStyle defaultStyle) {
        return !TextDirection.m9539equalsimpl0(style.getTextDirection(), TextDirection.INSTANCE.m9548getUnspecifieds_7Xco()) ? style : ParagraphStyle.m8954copyykzQM6k$default(style, 0, defaultStyle.getTextDirection(), 0L, null, null, null, 0, 0, null, 509, null);
    }
}
