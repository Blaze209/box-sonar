...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j, int i, int i2) {
        ...
        this.maxLines = i;
        boolean z = true;
        if (!(Constraints.m9642getMinWidthimpl(j) == 0 && Constraints.m9641getMinHeightimpl(j) == 0)) {
        ...
        while (true) {
            ...
            if (Constraints.m9635getHasBoundedHeightimpl(j)) {
                iM9639getMaxHeightimpl = RangesKt.coerceAtLeast(Constraints.m9639getMaxHeightimpl(j) - ParagraphKt.ceilToInt(f), 0);
            } else {
                iM9639getMaxHeightimpl = Constraints.m9639getMaxHeightimpl(j);
            }
            Paragraph paragraphM8948ParagraphczeNHc = ParagraphKt.m8948ParagraphczeNHc(intrinsics, ConstraintsKt.Constraints$default(0, iM9640getMaxWidthimpl, 0, iM9639getMaxHeightimpl, 5, null), this.maxLines - i3, i2);
            float height = f + paragraphM8948ParagraphczeNHc.getHeight();
            int lineCount = i3 + paragraphM8948ParagraphczeNHc.getLineCount();
            arrayList.add(new ParagraphInfo(paragraphM8948ParagraphczeNHc, paragraphIntrinsicInfo.getStartIndex(), paragraphIntrinsicInfo.getEndIndex(), i3, lineCount, f, height));
            if (paragraphM8948ParagraphczeNHc.getDidExceedMaxLines() || (lineCount == this.maxLines && i4 != CollectionsKt.getLastIndex(this.intrinsics.getInfoList$ui_text()))) {
                i3 = lineCount;
                f = height;
                break;
            } else {
        ...
        this.width = Constraints.m9640getMaxWidthimpl(j);
    ...
    public /* synthetic */ MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j, int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(multiParagraphIntrinsics, j, (i3 & 4) != 0 ? Integer.MAX_VALUE : i, (i3 & 8) != 0 ? TextOverflow.INSTANCE.m9583getClipgIe3tQ8() : i2, (DefaultConstructorMarker) null);
    }
    ...
    private MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j, int i, boolean z) {
        this(multiParagraphIntrinsics, j, i, z ? TextOverflow.INSTANCE.m9584getEllipsisgIe3tQ8() : TextOverflow.INSTANCE.m9583getClipgIe3tQ8(), (DefaultConstructorMarker) null);
    }
    ...
    public MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, int i, boolean z, float f) {
        ...
        this(multiParagraphIntrinsics, jConstraints$default, i, z ? companion.m9584getEllipsisgIe3tQ8() : companion.m9583getClipgIe3tQ8(), (DefaultConstructorMarker) null);
    }
    ...
    public MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> list, int i, boolean z, float f, Density density, Font.ResourceLoader resourceLoader) {
        ...
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        this(multiParagraphIntrinsics, ConstraintsKt.Constraints$default(0, ParagraphKt.ceilToInt(f), 0, 0, 13, null), i, z ? companion.m9584getEllipsisgIe3tQ8() : companion.m9583getClipgIe3tQ8(), (DefaultConstructorMarker) null);
    }
    ...
    private MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, long j, Density density, FontFamily.Resolver resolver, List<AnnotatedString.Range<Placeholder>> list, int i, boolean z) {
        MultiParagraphIntrinsics multiParagraphIntrinsics = new MultiParagraphIntrinsics(annotatedString, textStyle, list, density, resolver);
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        this(multiParagraphIntrinsics, j, i, z ? companion.m9584getEllipsisgIe3tQ8() : companion.m9583getClipgIe3tQ8(), (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, long j, Density density, FontFamily.Resolver resolver, List list, int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, j, density, resolver, (i3 & 32) != 0 ? CollectionsKt.emptyList() : list, (i3 & 64) != 0 ? Integer.MAX_VALUE : i, (i3 & 128) != 0 ? TextOverflow.INSTANCE.m9583getClipgIe3tQ8() : i2, (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ void m8922paintRPmYEkk$default(MultiParagraph multiParagraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, int i, Object obj) {
        if ((i & 2) != 0) {
            j = Color.INSTANCE.m6850getUnspecified0d7_KjU();
        }
        multiParagraph.m8929paintRPmYEkk(canvas, j, (i & 4) != 0 ? null : shadow, (i & 8) != 0 ? null : textDecoration);
    }
    ...
    public final /* synthetic */ void m8929paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration decoration) {
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int i = 0; i < size; i++) {
            ParagraphInfo paragraphInfo = list.get(i);
            Paragraph.m8933paintLG529CI$default(paragraphInfo.getParagraph(), canvas, color, shadow, decoration, null, 0, 48, null);
    ...
    public final void m8928paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int i = 0; i < size; i++) {
            ParagraphInfo paragraphInfo = list.get(i);
            paragraphInfo.getParagraph().mo8881paintLG529CI(canvas, color, shadow, decoration, drawStyle, blendMode);
            canvas.translate(0.0f, paragraphInfo.getParagraph().getHeight());
        }
        canvas.restore();
    }
    ...
    public static /* synthetic */ void m8923painthn5TExg$default(MultiParagraph multiParagraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            f = Float.NaN;
        }
        multiParagraph.m8930painthn5TExg(canvas, brush, f, (i2 & 8) != 0 ? null : shadow, (i2 & 16) != 0 ? null : textDecoration, (i2 & 32) != 0 ? null : drawStyle, (i2 & 64) != 0 ? DrawScope.INSTANCE.m7397getDefaultBlendMode0nO6VwU() : i);
    }

    /* JADX INFO: renamed from: paint-hn5TExg, reason: not valid java name */
    public final void m8930painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        AndroidMultiParagraphDraw_androidKt.m9351drawMultiParagraph7AXcY_I(this, canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
    }
    ...
    public final Path getPathForRange(final int start, final int end) {
        ...
        MultiParagraphKt.m8932findParagraphsByRangeSbBc2M(this.paragraphInfoList, TextRangeKt.TextRange(start, end), new Function1() { // from class: androidx.compose.ui.text.MultiParagraph$$ExternalSyntheticLambda1
    ...
    public static final Unit getPathForRange$lambda$1(Path path, int i, int i2, ParagraphInfo paragraphInfo) {
        Path.m7100addPathUv8p0NA$default(path, paragraphInfo.toGlobal(paragraphInfo.getParagraph().getPathForRange(paragraphInfo.toLocalIndex(i), paragraphInfo.toLocalIndex(i2))), 0L, 2, null);
    ...
    public final int m8925getOffsetForPositionk4lQ0M(long position) {
        ...
        return paragraphInfo.toGlobalIndex(paragraphInfo.getParagraph().mo8877getOffsetForPositionk4lQ0M(paragraphInfo.m8941toLocalMKHz9U(position)));
    }

    /* JADX INFO: renamed from: getRangeForRect-8-6BmAI, reason: not valid java name */
    public final long m8926getRangeForRect86BmAI(Rect rect, int granularity, TextInclusionStrategy inclusionStrategy) {
        ...
        if (this.paragraphInfoList.get(iFindParagraphByY).getBottom() >= rect.getBottom() || iFindParagraphByY == CollectionsKt.getLastIndex(this.paragraphInfoList)) {
            ...
            return ParagraphInfo.m8939toGlobalxdX6G0$default(paragraphInfo, paragraphInfo.getParagraph().mo8879getRangeForRect86BmAI(paragraphInfo.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
        }
        int iFindParagraphByY2 = MultiParagraphKt.findParagraphByY(this.paragraphInfoList, rect.getBottom());
        long jM9096getZerod9O1mEE = TextRange.INSTANCE.m9096getZerod9O1mEE();
        while (TextRange.m9084equalsimpl0(jM9096getZerod9O1mEE, TextRange.INSTANCE.m9096getZerod9O1mEE()) && iFindParagraphByY <= iFindParagraphByY2) {
            ParagraphInfo paragraphInfo2 = this.paragraphInfoList.get(iFindParagraphByY);
            jM9096getZerod9O1mEE = ParagraphInfo.m8939toGlobalxdX6G0$default(paragraphInfo2, paragraphInfo2.getParagraph().mo8879getRangeForRect86BmAI(paragraphInfo2.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            iFindParagraphByY++;
        }
        if (TextRange.m9084equalsimpl0(jM9096getZerod9O1mEE, TextRange.INSTANCE.m9096getZerod9O1mEE())) {
            return TextRange.INSTANCE.m9096getZerod9O1mEE();
        }
        long jM9096getZerod9O1mEE2 = TextRange.INSTANCE.m9096getZerod9O1mEE();
        while (TextRange.m9084equalsimpl0(jM9096getZerod9O1mEE2, TextRange.INSTANCE.m9096getZerod9O1mEE()) && iFindParagraphByY <= iFindParagraphByY2) {
            ParagraphInfo paragraphInfo3 = this.paragraphInfoList.get(iFindParagraphByY2);
            jM9096getZerod9O1mEE2 = ParagraphInfo.m8939toGlobalxdX6G0$default(paragraphInfo3, paragraphInfo3.getParagraph().mo8879getRangeForRect86BmAI(paragraphInfo3.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            iFindParagraphByY2--;
        }
        return TextRange.m9084equalsimpl0(jM9096getZerod9O1mEE2, TextRange.INSTANCE.m9096getZerod9O1mEE()) ? jM9096getZerod9O1mEE : TextRangeKt.TextRange(TextRange.m9091getStartimpl(jM9096getZerod9O1mEE), TextRange.m9086getEndimpl(jM9096getZerod9O1mEE2));
    }
    ...
    public final float[] m8924fillBoundingBoxes8ffj60Q(final long range, final float[] array, int arrayStart) {
        requireIndexInRange(TextRange.m9089getMinimpl(range));
        requireIndexInRangeInclusiveEnd(TextRange.m9088getMaximpl(range));
        final Ref.IntRef intRef = new Ref.IntRef();
        intRef.element = arrayStart;
        final Ref.FloatRef floatRef = new Ref.FloatRef();
        MultiParagraphKt.m8932findParagraphsByRangeSbBc2M(this.paragraphInfoList, range, new Function1() { // from class: androidx.compose.ui.text.MultiParagraph$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static final Unit fillBoundingBoxes_8ffj60Q$lambda$0(long j, float[] fArr, Ref.IntRef intRef, Ref.FloatRef floatRef, ParagraphInfo paragraphInfo) {
        long jTextRange = TextRangeKt.TextRange(paragraphInfo.toLocalIndex(paragraphInfo.getStartIndex() > TextRange.m9089getMinimpl(j) ? paragraphInfo.getStartIndex() : TextRange.m9089getMinimpl(j)), paragraphInfo.toLocalIndex(paragraphInfo.getEndIndex() < TextRange.m9088getMaximpl(j) ? paragraphInfo.getEndIndex() : TextRange.m9088getMaximpl(j)));
        paragraphInfo.getParagraph().mo8875fillBoundingBoxes8ffj60Q(jTextRange, fArr, intRef.element);
        int iM9087getLengthimpl = intRef.element + (TextRange.m9087getLengthimpl(jTextRange) * 4);
        for (int i = intRef.element; i < iM9087getLengthimpl; i += 4) {
            int i2 = i + 1;
            fArr[i2] = fArr[i2] + floatRef.element;
            int i3 = i + 3;
            fArr[i3] = fArr[i3] + floatRef.element;
        }
        intRef.element = iM9087getLengthimpl;
    ...
    public final long m8927getWordBoundaryjx7JFs(int offset) {
        int iFindParagraphByIndex;
        requireIndexInRangeInclusiveEnd(offset);
        if (offset == getAnnotatedString().length()) {
            iFindParagraphByIndex = CollectionsKt.getLastIndex(this.paragraphInfoList);
        ...
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(iFindParagraphByIndex);
        return paragraphInfo.m8940toGlobalxdX6G0(paragraphInfo.getParagraph().mo8880getWordBoundaryjx7JFs(paragraphInfo.toLocalIndex(offset)), false);
    }
