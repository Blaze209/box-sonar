...
public final class Placeholder {
    ...
    public static /* synthetic */ Placeholder m8974copyK8Q__8$default(Placeholder placeholder, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j = placeholder.width;
        }
        long j3 = j;
        ...
        return placeholder.m8975copyK8Q__8(j3, j4, i);
    }

    /* JADX INFO: renamed from: copy-K8Q-__8, reason: not valid java name */
    public final Placeholder m8975copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m9878equalsimpl0(this.width, placeholder.width) && TextUnit.m9878equalsimpl0(this.height, placeholder.height) && PlaceholderVerticalAlign.m8982equalsimpl0(this.placeholderVerticalAlign, placeholder.placeholderVerticalAlign);
    }

    public int hashCode() {
        return (((TextUnit.m9882hashCodeimpl(this.width) * 31) + TextUnit.m9882hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m8983hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m9888toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m9888toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m8984toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}
