...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        float fM9881getValueimpl;
        if (textIndent != null) {
            if ((TextUnit.m9878equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) && TextUnit.m9878equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) || TextUnit.m9879getRawTypeimpl(textIndent.getFirstLine()) == 0 || TextUnit.m9879getRawTypeimpl(textIndent.getRestLine()) == 0) {
                return;
            }
            long jM9880getTypeUIouoOA = TextUnit.m9880getTypeUIouoOA(textIndent.getFirstLine());
            float fM9881getValueimpl2 = 0.0f;
            if (TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9914getSpUIouoOA())) {
                fM9881getValueimpl = density.mo753toPxR2X_6o(textIndent.getFirstLine());
            } else {
                fM9881getValueimpl = TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9913getEmUIouoOA()) ? TextUnit.m9881getValueimpl(textIndent.getFirstLine()) * f : 0.0f;
            }
            long jM9880getTypeUIouoOA2 = TextUnit.m9880getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA2, TextUnitType.INSTANCE.m9914getSpUIouoOA())) {
                fM9881getValueimpl2 = density.mo753toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA2, TextUnitType.INSTANCE.m9913getEmUIouoOA())) {
                fM9881getValueimpl2 = TextUnit.m9881getValueimpl(textIndent.getRestLine()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(fM9881getValueimpl), (int) Math.ceil(fM9881getValueimpl2)), 0, spannable.length());
        }
    }
    ...
    public static final void setBulletSpans(Spannable spannable, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, float f, Density density, TextIndent textIndent) {
        ...
        float fM9881getValueimpl = 0.0f;
        if (textIndent != null) {
            long jM9880getTypeUIouoOA = TextUnit.m9880getTypeUIouoOA(textIndent.getFirstLine());
            if (TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9914getSpUIouoOA())) {
                fM9881getValueimpl = density2.mo753toPxR2X_6o(textIndent.getFirstLine());
            } else if (TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9913getEmUIouoOA())) {
                fM9881getValueimpl = TextUnit.m9881getValueimpl(textIndent.getFirstLine()) * f;
            }
        }
        float f2 = fM9881getValueimpl;
        int size = list.size();
        int i = 0;
        while (i < size) {
            ...
            if (bullet != null) {
                float fM9372resolveBulletTextUnitToPxo2QH7mI = m9372resolveBulletTextUnitToPxo2QH7mI(bullet.getWidth(), f, density2);
                float fM9372resolveBulletTextUnitToPxo2QH7mI2 = m9372resolveBulletTextUnitToPxo2QH7mI(bullet.getHeight(), f, density2);
                float fM9372resolveBulletTextUnitToPxo2QH7mI3 = m9372resolveBulletTextUnitToPxo2QH7mI(bullet.getPadding(), f, density2);
                if (!Float.isNaN(fM9372resolveBulletTextUnitToPxo2QH7mI) && !Float.isNaN(fM9372resolveBulletTextUnitToPxo2QH7mI2) && !Float.isNaN(fM9372resolveBulletTextUnitToPxo2QH7mI3)) {
                    setSpan(spannable, new CustomBulletSpan(bullet.getShape(), fM9372resolveBulletTextUnitToPxo2QH7mI, fM9372resolveBulletTextUnitToPxo2QH7mI2, fM9372resolveBulletTextUnitToPxo2QH7mI3, bullet.getBrush(), bullet.getAlpha(), bullet.getDrawStyle(), density2, f2), range.getStart(), range.getEnd());
                }
            }
            i++;
            density2 = density;
    ...
    private static final float m9372resolveBulletTextUnitToPxo2QH7mI(long j, float f, Density density) {
        if (TextUnit.m9878equalsimpl0(j, TextUnit.INSTANCE.m9892getUnspecifiedXSAIIZE())) {
            return f;
        }
        long jM9880getTypeUIouoOA = TextUnit.m9880getTypeUIouoOA(j);
        if (TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9914getSpUIouoOA())) {
            return density.mo753toPxR2X_6o(j);
        }
        if (TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9913getEmUIouoOA())) {
            return TextUnit.m9881getValueimpl(j) * f;
        }
        return Float.NaN;
    }

    /* JADX INFO: renamed from: setLineHeight-KmRG4DE, reason: not valid java name */
    public static final void m9378setLineHeightKmRG4DE(Spannable spannable, long j, float f, Density density, LineHeightStyle lineHeightStyle) {
        float fM9373resolveLineHeightInPxo2QH7mI = m9373resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM9373resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        Spannable spannable2 = spannable;
        setSpan(spannable, new LineHeightStyleSpan(fM9373resolveLineHeightInPxo2QH7mI, 0, (spannable2.length() == 0 || StringsKt.last(spannable2) == '\n') ? spannable.length() + 1 : spannable.length(), LineHeightStyle.Trim.m9511isTrimFirstLineTopimpl$ui_text(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m9512isTrimLastLineBottomimpl$ui_text(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment(), lineHeightStyle.getMode(), null), 0, spannable.length());
    }

    /* JADX INFO: renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m9379setLineHeightr9BaKPg(Spannable spannable, long j, float f, Density density) {
        float fM9373resolveLineHeightInPxo2QH7mI = m9373resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM9373resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(spannable, new LineHeightSpan(fM9373resolveLineHeightInPxo2QH7mI), 0, spannable.length());
    }

    /* JADX INFO: renamed from: resolveLineHeightInPx-o2QH7mI, reason: not valid java name */
    private static final float m9373resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        float fM9881getValueimpl;
        long jM9880getTypeUIouoOA = TextUnit.m9880getTypeUIouoOA(j);
        if (TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9914getSpUIouoOA())) {
            ...
            fM9881getValueimpl = TextUnit.m9881getValueimpl(j) / TextUnit.m9881getValueimpl(density.mo757toSpkPz2Gy4(f));
        } else {
            if (!TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9913getEmUIouoOA())) {
                return Float.NaN;
            }
            fM9881getValueimpl = TextUnit.m9881getValueimpl(j);
        }
        return fM9881getValueimpl * f;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle textStyle, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        MetricAffectingSpan metricAffectingSpanM9371createLetterSpacingSpaneAf_CNQ;
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (item instanceof SpanStyle) {
                    ...
                    if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (metricAffectingSpanM9371createLetterSpacingSpaneAf_CNQ = m9371createLetterSpacingSpaneAf_CNQ(((SpanStyle) item).getLetterSpacing(), density)) != null) {
                        setSpan(spannable, metricAffectingSpanM9371createLetterSpacingSpaneAf_CNQ, start2, end2);
                    }
                }
            }
        }
    ...
    private static final void setSpanStyle(Spannable spannable, SpanStyle spanStyle, int i, int i2, Density density) {
        m9375setBaselineShift0ocSgnM(spannable, spanStyle.getBaselineShift(), i, i2);
        m9376setColorRPmYEkk(spannable, spanStyle.m9031getColor0d7_KjU(), i, i2);
        ...
        m9377setFontSizeKmRG4DE(spannable, spanStyle.getFontSize(), density, i, i2);
        ...
        m9374setBackgroundRPmYEkk(spannable, spanStyle.getBackground(), i, i2);
    ...
    public static final Unit setFontAttributes$lambda$2(Spannable spannable, Function4 function4, SpanStyle spanStyle, int i, int i2) {
        ...
        spannable.setSpan(new TypefaceSpan((Typeface) function4.invoke(fontFamily, fontWeight, fontStyleM9202boximpl, FontSynthesis.m9213boximpl(fontSynthesis != null ? fontSynthesis.m9221unboximpl() : FontSynthesis.INSTANCE.m9222getAllGVVA2EU()))), i, i2, 33);
    ...
    private static final MetricAffectingSpan m9371createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long jM9880getTypeUIouoOA = TextUnit.m9880getTypeUIouoOA(j);
        if (TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9914getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo753toPxR2X_6o(j));
        }
        if (TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9913getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m9881getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        return TextUnitType.m9909equalsimpl0(TextUnit.m9880getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m9914getSpUIouoOA()) || TextUnitType.m9909equalsimpl0(TextUnit.m9880getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m9913getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m6868toArgb8_81llA(shadow.getColor()), Float.intBitsToFloat((int) (shadow.getOffset() >> 32)), Float.intBitsToFloat((int) (shadow.getOffset() & 4294967295L)), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m9374setBackgroundRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new BackgroundColorSpan(ColorKt.m6868toArgb8_81llA(j)), i, i2);
        }
    }
    ...
    public static final void m9377setFontSizeKmRG4DE(Spannable spannable, long j, Density density, int i, int i2) {
        long jM9880getTypeUIouoOA = TextUnit.m9880getTypeUIouoOA(j);
        if (TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9914getSpUIouoOA())) {
            setSpan(spannable, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo753toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m9909equalsimpl0(jM9880getTypeUIouoOA, TextUnitType.INSTANCE.m9913getEmUIouoOA())) {
            setSpan(spannable, new RelativeSizeSpan(TextUnit.m9881getValueimpl(j)), i, i2);
        }
    }
    ...
    public static final void m9376setColorRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new ForegroundColorSpan(ColorKt.m6868toArgb8_81llA(j)), i, i2);
        }
    }

    /* JADX INFO: renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m9375setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m9394unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m9376setColorRPmYEkk(spannable, ((SolidColor) brush).getValue(), i, i2);
            } else {
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m9124getFontSynthesisZQGJjVo() != null;
    }
