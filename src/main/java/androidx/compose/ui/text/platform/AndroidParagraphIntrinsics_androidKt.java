...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m9355resolveTextDirectionHeuristicsHklW4sA$default(int i, LocaleList localeList, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            localeList = null;
        }
        return m9354resolveTextDirectionHeuristicsHklW4sA(i, localeList);
    }

    /* JADX INFO: renamed from: resolveTextDirectionHeuristics-HklW4sA, reason: not valid java name */
    public static final int m9354resolveTextDirectionHeuristicsHklW4sA(int i, LocaleList localeList) {
        Locale platformLocale;
        if (TextDirection.m9539equalsimpl0(i, TextDirection.INSTANCE.m9544getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (TextDirection.m9539equalsimpl0(i, TextDirection.INSTANCE.m9545getContentOrRtls_7Xco())) {
            return 3;
        }
        if (TextDirection.m9539equalsimpl0(i, TextDirection.INSTANCE.m9546getLtrs_7Xco())) {
            return 0;
        }
        if (TextDirection.m9539equalsimpl0(i, TextDirection.INSTANCE.m9547getRtls_7Xco())) {
            return 1;
        }
        if (TextDirection.m9539equalsimpl0(i, TextDirection.INSTANCE.m9543getContents_7Xco()) || TextDirection.m9539equalsimpl0(i, TextDirection.INSTANCE.m9548getUnspecifieds_7Xco())) {
    ...
    public static final boolean getHasEmojiCompat(TextStyle textStyle) {
        ...
        EmojiSupportMatch emojiSupportMatchM8911boximpl = (platformStyle == null || (paragraphStyle = platformStyle.getParagraphStyle()) == null) ? null : EmojiSupportMatch.m8911boximpl(paragraphStyle.getEmojiSupportMatch());
        return !(emojiSupportMatchM8911boximpl == null ? false : EmojiSupportMatch.m8914equalsimpl0(emojiSupportMatchM8911boximpl.getValue(), EmojiSupportMatch.INSTANCE.m8920getNone_3YsG6Y()));
    }
}
