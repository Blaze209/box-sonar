...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            textPaint.setStrokeJoin(DrawStyleSpan_androidKt.m9385toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
            textPaint.setStrokeCap(DrawStyleSpan_androidKt.m9384toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
