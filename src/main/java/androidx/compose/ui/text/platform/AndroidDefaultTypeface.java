...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo9349getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        return TypefaceHelperMethodsApi28.INSTANCE.create(Typeface.DEFAULT, fontWeight.getWeight(), FontStyle.m9205equalsimpl0(fontStyle, FontStyle.INSTANCE.m9211getItalic_LCdwA()));
    }
}
