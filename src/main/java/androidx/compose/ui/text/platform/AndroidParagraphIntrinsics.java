...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String str, TextStyle textStyle, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, List<AnnotatedString.Range<Placeholder>> list2, FontFamily.Resolver resolver, Density density) {
        ...
        this.textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m9354resolveTextDirectionHeuristicsHklW4sA(textStyle.m9134getTextDirections_7Xco(), textStyle.getLocaleList());
    ...
    public static final Typeface _init_$lambda$0(AndroidParagraphIntrinsics androidParagraphIntrinsics, FontFamily fontFamily, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis) {
        State<Object> stateMo9177resolveDPcqOEQ = androidParagraphIntrinsics.fontFamilyResolver.mo9177resolveDPcqOEQ(fontFamily, fontWeight, fontStyle.m9208unboximpl(), fontSynthesis.m9221unboximpl());
        if (!(stateMo9177resolveDPcqOEQ instanceof TypefaceResult.Immutable)) {
            TypefaceDirtyTrackerLinkedList typefaceDirtyTrackerLinkedList = new TypefaceDirtyTrackerLinkedList(stateMo9177resolveDPcqOEQ, androidParagraphIntrinsics.resolvedTypefaces);
        ...
        Object value = ((TypefaceResult.Immutable) stateMo9177resolveDPcqOEQ).getValue();
