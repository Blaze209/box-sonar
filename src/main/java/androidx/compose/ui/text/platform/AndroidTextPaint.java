...
public final class AndroidTextPaint extends TextPaint {
    ...
    public static /* synthetic */ void m9358getBrushSizeVsRJwc0$ui_text$annotations() {
    }
    ...
    public AndroidTextPaint(int i, float f) {
        ...
        this.backingBlendMode = DrawScope.INSTANCE.m7397getDefaultBlendMode0nO6VwU();
    ...
    public final void m9364setBrushSizeiaC8Vc4$ui_text(Size size) {
        this.brushSize = size;
    }
    ...
    public final void setShadow(Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
            ...
            setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Float.intBitsToFloat((int) (this.shadow.getOffset() >> 32)), Float.intBitsToFloat((int) (this.shadow.getOffset() & 4294967295L)), ColorKt.m6868toArgb8_81llA(this.shadow.getColor()));
        }
    }

    /* JADX INFO: renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m9365setColor8_81llA(long color) {
        Color color2 = this.lastColor;
        if (color2 == null ? false : Color.m6815equalsimpl0(color2.m6824unboximpl(), color)) {
            return;
        }
        if (color != 16) {
            this.lastColor = Color.m6804boximpl(color);
            setColor(ColorKt.m6868toArgb8_81llA(color));
            clearShader();
        }
    }

    /* JADX INFO: renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m9359setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m9363setBrush12SF9DM(brush, j, f);
    }

    /* JADX WARN: Code duplicated, block: B:18:0x0034  */
    /* JADX WARN: Code duplicated, block: B:20:0x003d  */
    /* JADX INFO: renamed from: setBrush-12SF9DM, reason: not valid java name */
    public final void m9363setBrush12SF9DM(final Brush brush, final long size, float alpha) {
        if (brush == null) {
            clearShader();
            return;
        }
        if (brush instanceof SolidColor) {
            m9365setColor8_81llA(TextDrawStyleKt.m9552modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            return;
        }
        ...
        if (Intrinsics.areEqual(this.brush, brush)) {
            ...
            if (!(size2 == null ? false : Size.m6634equalsimpl0(size2.m6643unboximpl(), size))) {
                if (size != InlineClassHelperKt.UnspecifiedPackedFloats) {
                    this.brush = brush;
                    this.brushSize = Size.m6626boximpl(size);
                    this.shaderState = SnapshotStateKt.derivedStateOf(new Function0() { // from class: androidx.compose.ui.text.platform.AndroidTextPaint$$ExternalSyntheticLambda0
                        ...
                        public final Object invoke() {
                            return AndroidTextPaint.setBrush_12SF9DM$lambda$0(brush, size);
                        }
                    });
                }
            }
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        ...
        getComposePaint().mo6694setStylek9PVt8s(PaintingStyle.INSTANCE.m7098getStrokeTiuSbCo());
        Stroke stroke = (Stroke) drawStyle;
        getComposePaint().setStrokeWidth(stroke.getWidth());
        getComposePaint().setStrokeMiterLimit(stroke.getMiter());
        getComposePaint().mo6693setStrokeJoinWw9F2mQ(stroke.getJoin());
        getComposePaint().mo6692setStrokeCapBeK7IIE(stroke.getCap());
    ...
    public final void m9362setBlendModes9anfk8(int i) {
        if (BlendMode.m6723equalsimpl0(i, this.backingBlendMode)) {
            return;
        }
        getComposePaint().mo6689setBlendModes9anfk8(i);
