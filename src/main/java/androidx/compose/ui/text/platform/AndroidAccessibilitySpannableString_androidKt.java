...
public final class AndroidAccessibilitySpannableString_androidKt {
    public static final SpannableString toAccessibilitySpannableString(AnnotatedString annotatedString, Density density, FontFamily.Resolver resolver, URLSpanCache uRLSpanCache) {
        ...
        if (spanStylesOrNull$ui_text != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                setSpanStyle(spannableString, SpanStyle.m9022copyGSF8kmg$default(range.component1(), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65503, null), range.getStart(), range.getEnd(), density, resolver);
            }
        }
    ...
    private static final void setSpanStyle(SpannableString spannableString, SpanStyle spanStyle, int i, int i2, Density density, FontFamily.Resolver resolver) {
        ...
        SpannableExtensions_androidKt.m9376setColorRPmYEkk(spannableString2, spanStyle.m9031getColor0d7_KjU(), i, i2);
        SpannableExtensions_androidKt.m9377setFontSizeKmRG4DE(spannableString2, spanStyle.getFontSize(), density, i, i2);
        if (spanStyle.getFontWeight() != null || spanStyle.getFontStyle() != null) {
            ...
            spannableString.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m9156getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle != null ? fontStyle.m9208unboximpl() : FontStyle.INSTANCE.m9212getNormal_LCdwA())), i, i2, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = FontFamily.Resolver.m9176resolveDPcqOEQ$default(resolver, fontFamily, null, 0, fontSynthesis != null ? fontSynthesis.m9221unboximpl() : FontSynthesis.INSTANCE.m9222getAllGVVA2EU(), 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m9374setBackgroundRPmYEkk(spannableString2, spanStyle.getBackground(), i, i2);
    }
