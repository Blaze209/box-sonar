...
public final class BulletSpan_androidKt {
    ...
    public static final void setDrawStyle(Paint paint, DrawStyle drawStyle) {
        ...
        paint.setStrokeCap(DrawStyleSpan_androidKt.m9384toAndroidCapBeK7IIE(stroke.getCap()));
        paint.setStrokeJoin(DrawStyleSpan_androidKt.m9385toAndroidJoinWw9F2mQ(stroke.getJoin()));
    ...
    public static final void draw(Outline outline, Canvas canvas, Paint paint, float f, float f2, int i) {
        ...
        if (outline instanceof Outline.Rounded) {
            ...
            float fIntBitsToFloat = Float.intBitsToFloat((int) (rounded.getRoundRect().m6619getTopLeftCornerRadiuskKHJgLs() >> 32));
    ...
    public static final void m9382setBrushAndDrawyzxVdVo(Paint paint, Brush brush, float f, long j, Function0<Unit> function0) {
        ...
        if (brush instanceof SolidColor) {
            ...
            paint.setColor(ColorKt.m6868toArgb8_81llA(((SolidColor) brush).getValue()));
            function0.invoke();
        ...
        paint.setShader(((ShaderBrush) brush).mo6783createShaderuvyYCjk(j));
        function0.invoke();
