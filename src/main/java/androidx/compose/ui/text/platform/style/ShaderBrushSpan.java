...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public static final Shader shaderState$lambda$0(ShaderBrushSpan shaderBrushSpan) {
        if (shaderBrushSpan.m9386getSizeNHjbRc() == InlineClassHelperKt.UnspecifiedPackedFloats || Size.m6640isEmptyimpl(shaderBrushSpan.m9386getSizeNHjbRc())) {
            return null;
        }
        return shaderBrushSpan.shaderBrush.mo6783createShaderuvyYCjk(shaderBrushSpan.m9386getSizeNHjbRc());
    }
