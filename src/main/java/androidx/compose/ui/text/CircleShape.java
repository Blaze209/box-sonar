...
final class CircleShape implements Shape {
    ...
    public Outline mo655createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        float fM6637getMinDimensionimpl = Size.m6637getMinDimensionimpl(size) / 2.0f;
        long jM6523constructorimpl = CornerRadius.m6523constructorimpl((((long) Float.floatToRawIntBits(fM6637getMinDimensionimpl)) << 32) | (((long) Float.floatToRawIntBits(fM6637getMinDimensionimpl)) & 4294967295L));
        return new Outline.Rounded(RoundRectKt.m6621RoundRectZAM2FJo(SizeKt.m6659toRectuvyYCjk(size), jM6523constructorimpl, jM6523constructorimpl, jM6523constructorimpl, jM6523constructorimpl));
    }
}
