...
public final class AndroidParagraph implements Paragraph {
    ...
    /* JADX WARN: Code duplicated, block: B:59:0x01d2 A[LOOP:0: B:58:0x01d0->B:59:0x01d2, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:62:0x01f9  */
    /* JADX WARN: Code duplicated, block: B:63:0x01ff  */
    /* JADX WARN: Code duplicated, block: B:65:0x0219  */
    ...
    /* JADX WARN: Code duplicated, block: B:78:0x0256  */
    /* JADX WARN: Instruction removed from duplicated block: B:57:0x01ce, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:63:0x01ff, please report this as an issue */
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics androidParagraphIntrinsics, int i, int i2, long j) {
        ...
        this.overflow = i2;
        this.constraints = j;
        if (!(Constraints.m9641getMinHeightimpl(j) == 0 && Constraints.m9642getMinWidthimpl(j) == 0)) {
        ...
        if (AndroidParagraph_androidKt.shouldAttachIndentationFixSpan(style, TextOverflow.m9574equalsimpl0(i2, TextOverflow.INSTANCE.m9584getEllipsisgIe3tQ8()))) {
        ...
        int iM8890toLayoutAlignaXe7zB0 = AndroidParagraph_androidKt.m8890toLayoutAlignaXe7zB0(style.m9132getTextAligne0LSkKk());
        boolean zM9522equalsimpl0 = TextAlign.m9522equalsimpl0(style.m9132getTextAligne0LSkKk(), TextAlign.INSTANCE.m9528getJustifye0LSkKk());
        int iM8892toLayoutHyphenationFrequency3fSNIE = AndroidParagraph_androidKt.m8892toLayoutHyphenationFrequency3fSNIE(style.getParagraphStyle().getHyphens());
        int iM8891toLayoutBreakStrategyxImikfE = AndroidParagraph_androidKt.m8891toLayoutBreakStrategyxImikfE(LineBreak.m9431getStrategyfcGXIks(style.m9129getLineBreakrAG3T2k()));
        int iM8893toLayoutLineBreakStylehpcqdu8 = AndroidParagraph_androidKt.m8893toLayoutLineBreakStylehpcqdu8(LineBreak.m9432getStrictnessusljTpc(style.m9129getLineBreakrAG3T2k()));
        int iM8894toLayoutLineBreakWordStylewPN0Rpw = AndroidParagraph_androidKt.m8894toLayoutLineBreakWordStylewPN0Rpw(LineBreak.m9433getWordBreakjp8hJ3c(style.m9129getLineBreakrAG3T2k()));
        if (TextOverflow.m9574equalsimpl0(i2, TextOverflow.INSTANCE.m9584getEllipsisgIe3tQ8())) {
            truncateAt = TextUtils.TruncateAt.END;
        } else {
            if (!TextOverflow.m9574equalsimpl0(i2, TextOverflow.INSTANCE.m9585getMiddleEllipsisgIe3tQ8())) {
                if (TextOverflow.m9574equalsimpl0(i2, TextOverflow.INSTANCE.m9586getStartEllipsisgIe3tQ8())) {
                ...
                textLayoutConstructTextLayout$default = constructTextLayout$default(this, iM8890toLayoutAlignaXe7zB0, zM9522equalsimpl0, truncateAt2, i, iM8892toLayoutHyphenationFrequency3fSNIE, iM8891toLayoutBreakStrategyxImikfE, iM8893toLayoutLineBreakStylehpcqdu8, iM8894toLayoutLineBreakWordStylewPN0Rpw, null, 256, null);
                if (Build.VERSION.SDK_INT < 35 || getTextPaint$ui_text().getLetterSpacing() == 0.0f || (!(TextOverflow.m9574equalsimpl0(i2, TextOverflow.INSTANCE.m9586getStartEllipsisgIe3tQ8()) || TextOverflow.m9574equalsimpl0(i2, TextOverflow.INSTANCE.m9585getMiddleEllipsisgIe3tQ8())) || textLayoutConstructTextLayout$default.getLineEllipsisCount(0) <= 0)) {
                    i3 = i;
                    r15 = 1;
                } else {
                    ...
                    r15 = 1;
                    i3 = i;
                    textLayoutConstructTextLayout$default = constructTextLayout(iM8890toLayoutAlignaXe7zB0, zM9522equalsimpl0, truncateAt2, i3, iM8892toLayoutHyphenationFrequency3fSNIE, iM8891toLayoutBreakStrategyxImikfE, iM8893toLayoutLineBreakStylehpcqdu8, iM8894toLayoutLineBreakWordStylewPN0Rpw, TextUtils.concat(charSequence3.subSequence(0, lineEllipsisOffset), "…", charSequence3.subSequence(textLayoutConstructTextLayout$default.getLineEllipsisCount(0) + lineEllipsisOffset, charSequence3.length())));
                }
                if (!TextOverflow.m9574equalsimpl0(i2, TextOverflow.INSTANCE.m9584getEllipsisgIe3tQ8()) && textLayoutConstructTextLayout$default.getHeight() > Constraints.m9639getMaxHeightimpl(j) && i3 > r15) {
                    int iNumberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(textLayoutConstructTextLayout$default, Constraints.m9639getMaxHeightimpl(j));
                    if (iNumberOfLinesThatFitMaxHeight < 0 || iNumberOfLinesThatFitMaxHeight == i3) {
                        ...
                        textLayoutConstructTextLayout$default = constructTextLayout$default(androidParagraph2, iM8890toLayoutAlignaXe7zB0, zM9522equalsimpl0, truncateAt2, iCoerceAtLeast, iM8892toLayoutHyphenationFrequency3fSNIE, iM8891toLayoutBreakStrategyxImikfE, iM8893toLayoutLineBreakStylehpcqdu8, iM8894toLayoutLineBreakWordStylewPN0Rpw, null, 256, null);
                    ...
                    i4 = 2;
                    androidParagraph3.layout = textLayoutConstructTextLayout$default;
                    r0 = androidParagraph3;
                }
                r0.getTextPaint$ui_text().m9363setBrush12SF9DM(style.getBrush(), Size.m6629constructorimpl((((long) Float.floatToRawIntBits(r0.getHeight())) & 4294967295L) | (((long) Float.floatToRawIntBits(r0.getWidth())) << 32)), style.getAlpha());
                ...
                if (shaderBrushSpans != null) {
                    for (ShaderBrushSpan shaderBrushSpan : shaderBrushSpans) {
                        shaderBrushSpan.m9387setSizeuvyYCjk(Size.m6629constructorimpl((((long) Float.floatToRawIntBits(r0.getHeight())) & 4294967295L) | (((long) Float.floatToRawIntBits(r0.getWidth())) << 32)));
                    }
                }
                charSequence2 = r0.charSequence;
                if (charSequence2 instanceof Spanned) {
                    ...
                    for (Object obj : spans) {
                        ...
                        lineForOffset = r0.layout.getLineForOffset(spanStart);
                        if (lineForOffset >= r0.maxLines) {
                            r11 = r15;
                        } else {
                            r11 = 0;
                        }
                        if (r0.layout.getLineEllipsisCount(lineForOffset) > 0 || spanEnd <= r0.layout.getLineStart(lineForOffset) + r0.layout.getLineEllipsisOffset(lineForOffset)) {
                            r13 = 0;
                        } else {
                            r13 = r15;
                        }
                        if (spanEnd > r0.layout.getLineEnd(lineForOffset)) {
                            r9 = r15;
                        } else {
                            r9 = 0;
                        }
        ...
        textLayoutConstructTextLayout$default = constructTextLayout$default(this, iM8890toLayoutAlignaXe7zB0, zM9522equalsimpl0, truncateAt3, i, iM8892toLayoutHyphenationFrequency3fSNIE, iM8891toLayoutBreakStrategyxImikfE, iM8893toLayoutLineBreakStylehpcqdu8, iM8894toLayoutLineBreakWordStylewPN0Rpw, null, 256, null);
        ...
        if (!TextOverflow.m9574equalsimpl0(i2, TextOverflow.INSTANCE.m9584getEllipsisgIe3tQ8())) {
            ...
            i4 = 2;
            androidParagraph4.layout = textLayoutConstructTextLayout$default;
            r0 = androidParagraph4;
        } else {
            AndroidParagraph androidParagraph5 = this;
            i4 = 2;
            androidParagraph5.layout = textLayoutConstructTextLayout$default;
            r0 = androidParagraph5;
        }
        r0.getTextPaint$ui_text().m9363setBrush12SF9DM(style.getBrush(), Size.m6629constructorimpl((((long) Float.floatToRawIntBits(r0.getHeight())) & 4294967295L) | (((long) Float.floatToRawIntBits(r0.getWidth())) << 32)), style.getAlpha());
        shaderBrushSpans = r0.getShaderBrushSpans(r0.layout);
        if (shaderBrushSpans != null) {
        ...
        if (charSequence2 instanceof Spanned) {
            ...
            while (i5 < r5) {
                ...
                lineForOffset = r0.layout.getLineForOffset(spanStart2);
                if (lineForOffset >= r0.maxLines) {
                    r11 = r15;
                } else {
                    r11 = 0;
                }
                if (r0.layout.getLineEllipsisCount(lineForOffset) > 0) {
                    r13 = 0;
                } else {
                    r13 = 0;
                }
    ...
    public float getWidth() {
        return Constraints.m9640getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo8877getOffsetForPositionk4lQ0M(long position) {
    ...
    public long mo8879getRangeForRect86BmAI(Rect rect, int granularity, final TextInclusionStrategy inclusionStrategy) {
        int[] rangeForRect = this.layout.getRangeForRect(RectHelper_androidKt.toAndroidRectF(rect), AndroidParagraph_androidKt.m8895toLayoutTextGranularityduNsdkg(granularity), new Function2() { // from class: androidx.compose.ui.text.AndroidParagraph$$ExternalSyntheticLambda0
    ...
    public void mo8875fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        this.layout.fillBoundingBoxes(TextRange.m9089getMinimpl(range), TextRange.m9088getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo8880getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo8882paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        AndroidTextPaint textPaint$ui_text = getTextPaint$ui_text();
        textPaint$ui_text.m9365setColor8_81llA(color);
    ...
    public void mo8881paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        ...
        textPaint$ui_text.m9362setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text().m9362setBlendModes9anfk8(backingBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* JADX INFO: renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo8883painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int backingBlendMode = getTextPaint$ui_text().getBackingBlendMode();
        AndroidTextPaint textPaint$ui_text = getTextPaint$ui_text();
        float width = getWidth();
        textPaint$ui_text.m9363setBrush12SF9DM(brush, Size.m6629constructorimpl((((long) Float.floatToRawIntBits(getHeight())) & 4294967295L) | (Float.floatToRawIntBits(width) << 32)), alpha);
        textPaint$ui_text.setShadow(shadow);
        textPaint$ui_text.setTextDecoration(textDecoration);
        textPaint$ui_text.setDrawStyle(drawStyle);
        textPaint$ui_text.m9362setBlendModes9anfk8(blendMode);
