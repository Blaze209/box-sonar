...
public final class TextRangeKt {
    ...
    public static final String m9098substringFDrldGo(CharSequence charSequence, long j) {
        return charSequence.subSequence(TextRange.m9089getMinimpl(j), TextRange.m9088getMaximpl(j)).toString();
    }

    public static final long TextRange(int i, int i2) {
        return TextRange.m9080constructorimpl(packWithCheck(i, i2));
    }
    ...
    public static final long m9097coerceIn8ffj60Q(long j, int i, int i2) {
        int iM9091getStartimpl = TextRange.m9091getStartimpl(j);
        if (iM9091getStartimpl < i) {
            iM9091getStartimpl = i;
        }
        if (iM9091getStartimpl > i2) {
            iM9091getStartimpl = i2;
        }
        int iM9086getEndimpl = TextRange.m9086getEndimpl(j);
        if (iM9086getEndimpl >= i) {
            i = iM9086getEndimpl;
        }
        if (i <= i2) {
            i2 = i;
        }
        return (iM9091getStartimpl == TextRange.m9091getStartimpl(j) && i2 == TextRange.m9086getEndimpl(j)) ? j : TextRange(iM9091getStartimpl, i2);
    }
