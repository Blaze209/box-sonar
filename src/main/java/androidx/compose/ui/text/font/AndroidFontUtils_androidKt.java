...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m9156getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m9205equalsimpl0(i, FontStyle.INSTANCE.m9211getItalic_LCdwA()));
    }
}
