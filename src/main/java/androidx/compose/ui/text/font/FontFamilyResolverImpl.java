...
public final class FontFamilyResolverImpl implements FontFamily.Resolver {
    ...
    public static final Object createDefaultTypeface$lambda$0(FontFamilyResolverImpl fontFamilyResolverImpl, TypefaceRequest typefaceRequest) {
        return fontFamilyResolverImpl.resolve(TypefaceRequest.m9248copye1PVR60$default(typefaceRequest, null, null, 0, 0, null, 30, null)).getValue();
    }
    ...
    public Object preload(FontFamily fontFamily, Continuation<? super Unit> continuation) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            arrayList.add(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(font.getWeight()), this.platformResolveInterceptor.m9232interceptFontStyleT2F_aPo(font.getStyle()), FontSynthesis.INSTANCE.m9222getAllGVVA2EU(), this.platformFontLoader.getCacheKey(), null));
        }
    ...
    public State<Object> mo9177resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis) {
        return resolve(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(fontWeight), this.platformResolveInterceptor.m9232interceptFontStyleT2F_aPo(fontStyle), this.platformResolveInterceptor.m9233interceptFontSynthesisMscr08Y(fontSynthesis), this.platformFontLoader.getCacheKey(), null));
    }
