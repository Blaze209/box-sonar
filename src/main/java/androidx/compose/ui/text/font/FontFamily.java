...
public abstract class FontFamily {
    ...
    public interface Resolver {
        ...
        State<Object> mo9177resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis);

        /* JADX INFO: renamed from: resolve-DPcqOEQ$default, reason: not valid java name */
        static /* synthetic */ State m9176resolveDPcqOEQ$default(Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
            if (obj != null) {
            ...
            return resolver.mo9177resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
        }
    }
