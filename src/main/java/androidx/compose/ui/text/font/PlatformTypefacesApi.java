...
final class PlatformTypefacesApi implements PlatformTypefaces {
    ...
    public android.graphics.Typeface mo9234createDefaultFO1MlWM(FontWeight fontWeight, int fontStyle) {
        return m9237createAndroidTypefaceUsingTypefaceStyleRetOiIg(null, fontWeight, fontStyle);
    }
    ...
    public android.graphics.Typeface mo9235createNamedRetOiIg(GenericFontFamily name, FontWeight fontWeight, int fontStyle) {
        android.graphics.Typeface typefaceM9239loadNamedFromTypefaceCacheOrNullRetOiIg = m9239loadNamedFromTypefaceCacheOrNullRetOiIg(PlatformTypefaces_androidKt.getWeightSuffixForFallbackFamilyName(name.getName(), fontWeight), fontWeight, fontStyle);
        return typefaceM9239loadNamedFromTypefaceCacheOrNullRetOiIg == null ? m9237createAndroidTypefaceUsingTypefaceStyleRetOiIg(name.getName(), fontWeight, fontStyle) : typefaceM9239loadNamedFromTypefaceCacheOrNullRetOiIg;
    }
    ...
    public android.graphics.Typeface mo9236optionalOnDeviceFontFamilyByName78DK7lM(String familyName, FontWeight weight, int style, FontVariation.Settings variationSettings, Context context) {
        ...
        if (Intrinsics.areEqual(familyName, FontFamily.INSTANCE.getSansSerif().getName())) {
            ...
            typefaceMo9235createNamedRetOiIg = Intrinsics.areEqual(familyName, FontFamily.INSTANCE.getCursive().getName()) ? mo9235createNamedRetOiIg(FontFamily.INSTANCE.getCursive(), weight, style) : m9239loadNamedFromTypefaceCacheOrNullRetOiIg(familyName, weight, style);
        }
    ...
    private final android.graphics.Typeface m9239loadNamedFromTypefaceCacheOrNullRetOiIg(String familyName, FontWeight weight, int style) {
        if (familyName.length() == 0) {
            return null;
        }
        android.graphics.Typeface typefaceM9237createAndroidTypefaceUsingTypefaceStyleRetOiIg = m9237createAndroidTypefaceUsingTypefaceStyleRetOiIg(familyName, weight, style);
        if (Intrinsics.areEqual(typefaceM9237createAndroidTypefaceUsingTypefaceStyleRetOiIg, android.graphics.Typeface.create(android.graphics.Typeface.DEFAULT, AndroidFontUtils_androidKt.m9156getAndroidTypefaceStyleFO1MlWM(weight, style))) || Intrinsics.areEqual(typefaceM9237createAndroidTypefaceUsingTypefaceStyleRetOiIg, m9237createAndroidTypefaceUsingTypefaceStyleRetOiIg(null, weight, style))) {
            return null;
        }
        return typefaceM9237createAndroidTypefaceUsingTypefaceStyleRetOiIg;
    }

    /* JADX INFO: renamed from: createAndroidTypefaceUsingTypefaceStyle-RetOiIg$default, reason: not valid java name */
    static /* synthetic */ android.graphics.Typeface m9238createAndroidTypefaceUsingTypefaceStyleRetOiIg$default(PlatformTypefacesApi platformTypefacesApi, String str, FontWeight fontWeight, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = null;
        }
        if ((i2 & 2) != 0) {
        ...
        if ((i2 & 4) != 0) {
            i = FontStyle.INSTANCE.m9212getNormal_LCdwA();
        }
        return platformTypefacesApi.m9237createAndroidTypefaceUsingTypefaceStyleRetOiIg(str, fontWeight, i);
    }

    /* JADX INFO: renamed from: createAndroidTypefaceUsingTypefaceStyle-RetOiIg, reason: not valid java name */
    private final android.graphics.Typeface m9237createAndroidTypefaceUsingTypefaceStyleRetOiIg(String genericFontFamily, FontWeight fontWeight, int fontStyle) {
        String str;
        ...
        int iM9156getAndroidTypefaceStyleFO1MlWM = AndroidFontUtils_androidKt.m9156getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle);
        String str2 = genericFontFamily;
        if (str2 == null || str2.length() == 0) {
            return android.graphics.Typeface.defaultFromStyle(iM9156getAndroidTypefaceStyleFO1MlWM);
        }
        return android.graphics.Typeface.create(genericFontFamily, iM9156getAndroidTypefaceStyleFO1MlWM);
    }
}
