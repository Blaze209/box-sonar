...
public interface PlatformTypefaces {
    ...
    android.graphics.Typeface mo9234createDefaultFO1MlWM(FontWeight fontWeight, int fontStyle);

    /* JADX INFO: renamed from: createNamed-RetOiIg, reason: not valid java name */
    android.graphics.Typeface mo9235createNamedRetOiIg(GenericFontFamily name, FontWeight fontWeight, int fontStyle);

    /* JADX INFO: renamed from: optionalOnDeviceFontFamilyByName-78DK7lM, reason: not valid java name */
    android.graphics.Typeface mo9236optionalOnDeviceFontFamilyByName78DK7lM(String familyName, FontWeight weight, int style, FontVariation.Settings variationSettings, Context context);
}
