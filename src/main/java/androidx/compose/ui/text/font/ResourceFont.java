...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m9245getLoadingStrategyPKNRLFQ$annotations() {
    }
    ...
    public /* synthetic */ ResourceFont(int i, FontWeight fontWeight, int i2, FontVariation.Settings settings, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        int iM9212getNormal_LCdwA = (i4 & 4) != 0 ? FontStyle.INSTANCE.m9212getNormal_LCdwA() : i2;
        this(i, normal, iM9212getNormal_LCdwA, (i4 & 8) != 0 ? FontVariation.INSTANCE.m9228Settings6EWAqTQ(normal, iM9212getNormal_LCdwA, new FontVariation.Setting[0]) : settings, (i4 & 16) != 0 ? FontLoadingStrategy.INSTANCE.m9196getAsyncPKNRLFQ() : i3, null);
    }
    ...
    public static /* synthetic */ ResourceFont m9244copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        return resourceFont.m9247copyRetOiIg(i, fontWeight, i2);
    }

    /* JADX INFO: renamed from: copy-RetOiIg, reason: not valid java name */
    public final ResourceFont m9247copyRetOiIg(int resId, FontWeight weight, int style) {
        return m9243copyF3nL8kk$default(this, resId, weight, style, getLoadingStrategy(), null, 16, null);
    }

    /* JADX INFO: renamed from: copy-F3nL8kk$default, reason: not valid java name */
    public static /* synthetic */ ResourceFont m9243copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        if ((i4 & 2) != 0) {
        ...
        int i5 = i2;
        return resourceFont.m9246copyF3nL8kk(i, fontWeight, i5, i3, settings2);
    }

    /* JADX INFO: renamed from: copy-F3nL8kk, reason: not valid java name */
    public final ResourceFont m9246copyF3nL8kk(int resId, FontWeight weight, int style, int loadingStrategy, FontVariation.Settings variationSettings) {
    ...
    public boolean equals(Object other) {
        ...
        return this.resId == resourceFont.resId && Intrinsics.areEqual(getWeight(), resourceFont.getWeight()) && FontStyle.m9205equalsimpl0(getStyle(), resourceFont.getStyle()) && Intrinsics.areEqual(this.variationSettings, resourceFont.variationSettings) && FontLoadingStrategy.m9192equalsimpl0(getLoadingStrategy(), resourceFont.getLoadingStrategy());
    }

    public int hashCode() {
        return (((((((this.resId * 31) + getWeight().hashCode()) * 31) + FontStyle.m9206hashCodeimpl(getStyle())) * 31) + FontLoadingStrategy.m9193hashCodeimpl(getLoadingStrategy())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m9207toStringimpl(getStyle())) + ", loadingStrategy=" + ((Object) FontLoadingStrategy.m9194toStringimpl(getLoadingStrategy())) + ')';
    }
}
