...
public final class Html_androidKt {
    ...
    private static final void addSpans(AnnotatedString.Builder builder, Spanned spanned, TextLinkStyles textLinkStyles, LinkInteractionListener linkInteractionListener) {
        for (Object obj : spanned.getSpans(0, builder.getLength(), Object.class)) {
            ...
            addSpan(builder, obj, TextRange.m9091getStartimpl(jTextRange), TextRange.m9086getEndimpl(jTextRange), textLinkStyles, linkInteractionListener);
        }
    }
    ...
    private static final void addSpan(AnnotatedString.Builder builder, Object obj, int i, int i2, TextLinkStyles textLinkStyles, LinkInteractionListener linkInteractionListener) {
        ...
        if (obj instanceof BulletSpanWithLevel) {
            long jM8908getDefaultIndentationXSAIIZE = Bullet.INSTANCE.m8908getDefaultIndentationXSAIIZE();
            ...
            TextUnitKt.m9894checkArithmeticR2X_6o(jM8908getDefaultIndentationXSAIIZE);
            builder.m8898addBulletr9BaKPg(bulletSpanWithLevel.getBullet(), TextUnitKt.pack(TextUnit.m9879getRawTypeimpl(jM8908getDefaultIndentationXSAIIZE), TextUnit.m9881getValueimpl(jM8908getDefaultIndentationXSAIIZE) * indentationLevel), i, i2);
            return;
        }
        ...
        if (obj instanceof SubscriptSpan) {
            builder.addStyle(new SpanStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, BaselineShift.m9388boximpl(BaselineShift.INSTANCE.m9400getSubscripty9eOQZs()), (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65279, (DefaultConstructorMarker) null), i, i2);
            return;
        }
        if (obj instanceof SuperscriptSpan) {
            builder.addStyle(new SpanStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, BaselineShift.m9388boximpl(BaselineShift.INSTANCE.m9401getSuperscripty9eOQZs()), (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65279, (DefaultConstructorMarker) null), i, i2);
            return;
        }
    ...
    private static final ParagraphStyle toParagraphStyle(AlignmentSpan alignmentSpan) {
        int iM9531getStarte0LSkKk;
        Layout.Alignment alignment = alignmentSpan.getAlignment();
        int i = alignment == null ? -1 : WhenMappings.$EnumSwitchMapping$0[alignment.ordinal()];
        if (i == 1) {
            iM9531getStarte0LSkKk = TextAlign.INSTANCE.m9531getStarte0LSkKk();
        } else if (i == 2) {
            iM9531getStarte0LSkKk = TextAlign.INSTANCE.m9526getCentere0LSkKk();
        } else if (i == 3) {
            iM9531getStarte0LSkKk = TextAlign.INSTANCE.m9527getEnde0LSkKk();
        } else {
            iM9531getStarte0LSkKk = TextAlign.INSTANCE.m9532getUnspecifiede0LSkKk();
        }
        return new ParagraphStyle(iM9531getStarte0LSkKk, 0, 0L, (TextIndent) null, (PlatformParagraphStyle) null, (LineHeightStyle) null, 0, 0, (TextMotion) null, 510, (DefaultConstructorMarker) null);
    }
    ...
    private static final SpanStyle toSpanStyle(StyleSpan styleSpan) {
        ...
        if (style == 2) {
            return new SpanStyle(0L, 0L, (FontWeight) null, FontStyle.m9202boximpl(FontStyle.INSTANCE.m9211getItalic_LCdwA()), (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65527, (DefaultConstructorMarker) null);
        }
        if (style != 3) {
            return null;
        }
        return new SpanStyle(0L, 0L, FontWeight.INSTANCE.getBold(), FontStyle.m9202boximpl(FontStyle.INSTANCE.m9211getItalic_LCdwA()), (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65523, (DefaultConstructorMarker) null);
    }
