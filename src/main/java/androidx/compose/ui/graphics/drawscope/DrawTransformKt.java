...
public final class DrawTransformKt {
    ...
    public static /* synthetic */ void m7461rotateRad0AR0LA0$default(DrawTransform drawTransform, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawTransform.mo7320getCenterF1C5BW0();
        }
        drawTransform.mo7322rotateUv8p0NA(DegreesKt.degrees(f), j);
    }

    /* JADX INFO: renamed from: rotateRad-0AR0LA0, reason: not valid java name */
    public static final void m7460rotateRad0AR0LA0(DrawTransform drawTransform, float f, long j) {
        drawTransform.mo7322rotateUv8p0NA(DegreesKt.degrees(f), j);
    }

    /* JADX INFO: renamed from: scale-0AR0LA0, reason: not valid java name */
    public static final void m7462scale0AR0LA0(DrawTransform drawTransform, float f, long j) {
        drawTransform.mo7323scale0AR0LA0(f, f, j);
    }

    /* JADX INFO: renamed from: scale-0AR0LA0$default, reason: not valid java name */
    public static /* synthetic */ void m7463scale0AR0LA0$default(DrawTransform drawTransform, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawTransform.mo7320getCenterF1C5BW0();
        }
        drawTransform.mo7323scale0AR0LA0(f, f, j);
