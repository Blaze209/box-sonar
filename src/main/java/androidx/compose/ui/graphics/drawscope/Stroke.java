...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m7190getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m7201getMiterLxFBmk8();
    ...
    public boolean equals(Object other) {
        ...
        return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m7186equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m7196equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
    }

    public int hashCode() {
        int iHashCode = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m7187hashCodeimpl(this.cap)) * 31) + StrokeJoin.m7197hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return iHashCode + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m7188toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m7198toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
