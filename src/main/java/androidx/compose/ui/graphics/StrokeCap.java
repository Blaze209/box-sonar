...
public final class StrokeCap {
    ...
    private static final int Butt = m7184constructorimpl(0);
    private static final int Round = m7184constructorimpl(1);
    private static final int Square = m7184constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StrokeCap m7183boximpl(int i) {
    ...
    public static boolean m7185equalsimpl(int i, Object obj) {
        return (obj instanceof StrokeCap) && i == ((StrokeCap) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m7186equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m7187hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object other) {
        return m7185equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m7187hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m7188toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m7188toStringimpl(int i) {
        if (m7186equalsimpl0(i, Butt)) {
            return "Butt";
        }
        if (m7186equalsimpl0(i, Round)) {
            return "Round";
        }
        return m7186equalsimpl0(i, Square) ? "Square" : "Unknown";
    }
}
