...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint paint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m6754getSrcOver0nO6VwU();
    }
    ...
    public long mo6684getColor0d7_KjU() {
    ...
    public void mo6690setColor8_81llA(long j) {
        AndroidPaint_androidKt.m6696setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo6689setBlendModes9anfk8(int i) {
        if (BlendMode.m6723equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m6695setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo6688getStyleTiuSbCo() {
    ...
    public void mo6694setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m6700setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo6686getStrokeCapKaPHkGw() {
    ...
    public void mo6692setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m6698setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo6687getStrokeJoinLxFBmk8() {
    ...
    public void mo6693setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m6699setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo6685getFilterQualityfv9h1I() {
    ...
    public void mo6691setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m6697setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
