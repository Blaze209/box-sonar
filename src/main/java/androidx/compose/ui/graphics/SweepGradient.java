...
public final class SweepGradient extends ShaderBrush implements Interpolatable {
    ...
    public Shader mo6783createShaderuvyYCjk(long size) {
        ...
        if ((9223372034707292159L & j) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            jM6561constructorimpl = SizeKt.m6648getCenteruvyYCjk(size);
        } else {
            ...
            jM6561constructorimpl = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (size & 4294967295L)))) & 4294967295L) | (((long) Float.floatToRawIntBits(fIntBitsToFloat)) << 32));
        }
        return ShaderKt.m7154SweepGradientShader9KIMszo(jM6561constructorimpl, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m6566equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int iM6571hashCodeimpl = ((Offset.m6571hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return iM6571hashCodeimpl + (list != null ? list.hashCode() : 0);
    }

    public String toString() {
        return "SweepGradient(" + ((this.center & 9223372034707292159L) != androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats ? "center=" + ((Object) Offset.m6577toStringimpl(this.center)) + ", " : "") + "colors=" + this.colors + ", stops=" + this.stops + ')';
    }
    ...
    public Object lerp(Object other, float t) {
        ...
        SweepGradient sweepGradient = (SweepGradient) other;
        return new SweepGradient(OffsetKt.m6592lerpWko1d7g(this.center, sweepGradient.center, t), BrushKt.lerpColorList(this.colors, sweepGradient.colors, t), BrushKt.lerpNullableFloatList(this.stops, sweepGradient.stops, t), null);
    }
}
