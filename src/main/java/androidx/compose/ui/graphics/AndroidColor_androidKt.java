...
public final class AndroidColor_androidKt {
    ...
    public static final long m6677toColorLong8_81llA(long j) {
        long j2 = 63 & j;
        return Long.compareUnsigned(ULong.m14954constructorimpl(j2), 16L) < 0 ? j : ULong.m14954constructorimpl(ULong.m14954constructorimpl(j & ULong.m14954constructorimpl(-64L)) | ULong.m14954constructorimpl(ULong.m14954constructorimpl(j2) - 1));
    }
    ...
    public static final long fromColorLong(Color.Companion companion, long j) {
        ...
        return Color.m6810constructorimpl(ULong.m14954constructorimpl(j));
    }
}
