...
public final class PointMode {
    ...
    private static final int Points = m7129constructorimpl(0);
    private static final int Lines = m7129constructorimpl(1);
    private static final int Polygon = m7129constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointMode m7128boximpl(int i) {
    ...
    public static String m7133toStringimpl(int i) {
        if (m7131equalsimpl0(i, Points)) {
            return "Points";
        }
        if (m7131equalsimpl0(i, Lines)) {
            return "Lines";
        }
        return m7131equalsimpl0(i, Polygon) ? "Polygon" : "Unknown";
    }
}
