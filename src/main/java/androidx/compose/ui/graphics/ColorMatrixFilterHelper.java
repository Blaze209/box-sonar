...
final class ColorMatrixFilterHelper {
    ...
    public final float[] m6893getColorMatrix8unuwjk(android.graphics.ColorMatrixColorFilter colorFilter) {
        android.graphics.ColorMatrix colorMatrix = new android.graphics.ColorMatrix();
        colorFilter.getColorMatrix(colorMatrix);
        return ColorMatrix.m6870constructorimpl(colorMatrix.getArray());
    }
}
