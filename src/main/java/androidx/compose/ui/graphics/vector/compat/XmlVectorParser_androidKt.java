...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m7587getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m7190getButtKaPHkGw();
        }
        return m7586getStrokeLineCapCSYIeUk(i, i2);
    }

    /* JADX INFO: renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m7586getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m7190getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m7192getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m7191getRoundKaPHkGw();
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m7589getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m7201getMiterLxFBmk8();
        }
        return m7588getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m7588getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m7201getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m7200getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m7202getRoundLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) throws XmlPullParserException {
        ...
        if (typedArrayObtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type != 2 && (namedColorStateList = androidVectorParser.getNamedColorStateList(typedArrayObtainAttributes, theme, "tint", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) != null) {
                jM6850getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
            } else {
        ...
        if (i == -1) {
            iM6752getSrcIn0nO6VwU = BlendMode.INSTANCE.m6752getSrcIn0nO6VwU();
        } else if (i == 3) {
            iM6752getSrcIn0nO6VwU = BlendMode.INSTANCE.m6754getSrcOver0nO6VwU();
        } else if (i == 5) {
            iM6752getSrcIn0nO6VwU = BlendMode.INSTANCE.m6752getSrcIn0nO6VwU();
        } else if (i == 9) {
            iM6752getSrcIn0nO6VwU = BlendMode.INSTANCE.m6751getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    iM6752getSrcIn0nO6VwU = BlendMode.INSTANCE.m6743getModulate0nO6VwU();
                    break;
                case 15:
                    iM6752getSrcIn0nO6VwU = BlendMode.INSTANCE.m6748getScreen0nO6VwU();
                    break;
                case 16:
                    iM6752getSrcIn0nO6VwU = BlendMode.INSTANCE.m6746getPlus0nO6VwU();
                    break;
                default:
                    iM6752getSrcIn0nO6VwU = BlendMode.INSTANCE.m6752getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = iM6752getSrcIn0nO6VwU;
        float fM9687constructorimpl = Dp.m9687constructorimpl(dimension / resources.getDisplayMetrics().density);
        float fM9687constructorimpl2 = Dp.m9687constructorimpl(dimension2 / resources.getDisplayMetrics().density);
        typedArrayObtainAttributes.recycle();
        return new ImageVector.Builder(null, fM9687constructorimpl, fM9687constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int iM7586getStrokeLineCapCSYIeUk = m7586getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m7190getButtKaPHkGw());
        int iM7588getStrokeLineJoinkLtJ_vA = m7588getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m7201getMiterLxFBmk8());
        ...
        typedArrayObtainAttributes.recycle();
        builder.m7553addPathoIyEayM(list, namedInt == 0 ? PathFillType.INSTANCE.m7113getNonZeroRgk1Os() : PathFillType.INSTANCE.m7112getEvenOddRgk1Os(), str, obtainBrushFromComplexColor(namedComplexColor), namedFloat, obtainBrushFromComplexColor(namedComplexColor2), namedFloat3, namedFloat4, iM7586getStrokeLineCapCSYIeUk, iM7588getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
