...
public final class PathComponent extends VNode {
    ...
    public final void m7559setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo6704setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m7560setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m7561setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int iMo6702getFillTypeRgk1Os = this.renderPath.mo6702getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo6704setFillTypeoQ8Xj4U(iMo6702getFillTypeRgk1Os);
        }
        ...
        if (f3 > f4) {
            ...
            Path.m7100addPathUv8p0NA$default(this.renderPath, tmpPath, 0L, 2, null);
            tmpPath.reset();
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m7384drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m7384drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
