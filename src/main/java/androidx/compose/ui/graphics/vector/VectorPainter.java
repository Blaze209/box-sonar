...
public final class VectorPainter extends Painter {
    ...
    public VectorPainter(GroupComponent groupComponent) {
        this.size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m6626boximpl(Size.INSTANCE.m6647getZeroNHjbRc()), null, 2, null);
    ...
    public final long m7573getViewportSizeNHjbRc$ui() {
        return this.vector.m7563getViewportSizeNHjbRc$ui();
    }

    /* JADX INFO: renamed from: setViewportSize-uvyYCjk$ui, reason: not valid java name */
    public final void m7575setViewportSizeuvyYCjk$ui(long j) {
        this.vector.m7564setViewportSizeuvyYCjk$ui(j);
    }
    ...
    public final int m7571getBitmapConfig_sVssgQ$ui() {
        return this.vector.m7562getCacheBitmapConfig_sVssgQ$ui();
    }
