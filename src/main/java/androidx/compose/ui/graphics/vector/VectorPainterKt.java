...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m7581rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, String str, long j, int i, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4, Composer composer, int i2, int i3) {
        ...
        long jM6850getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.INSTANCE.m6850getUnspecified0d7_KjU() : j;
        int iM6752getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.INSTANCE.m6752getSrcIn0nO6VwU() : i;
        ...
        VectorPainter vectorPainterM7582rememberVectorPaintervIP8VLU = m7582rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, jM6850getUnspecified0d7_KjU, iM6752getSrcIn0nO6VwU, false, function4, composer, (i2 & 14) | 12582912 | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return vectorPainterM7582rememberVectorPaintervIP8VLU;
    }

    /* JADX INFO: renamed from: rememberVectorPainter-vIP8VLU, reason: not valid java name */
    public static final VectorPainter m7582rememberVectorPaintervIP8VLU(float f, float f2, float f3, float f4, String str, long j, int i, boolean z, final Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4, Composer composer, int i2, int i3) {
        Object obj;
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long jM7579obtainSizePxVpY3zN4 = m7579obtainSizePxVpY3zN4((Density) objConsume, f, f2);
        final long jM7580obtainViewportSizePq9zytI = m7580obtainViewportSizePq9zytI(jM7579obtainSizePxVpY3zN4, f5, f6);
        ComposerKt.sourceInformationMarkerStart(composer, 789574375, "CC(remember):VectorPainter.kt#9igjgp");
        boolean z3 = z2;
        String str3 = str2;
        boolean z4 = ((((458752 & i2) ^ ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) > 131072 && composer.changed(jM6850getUnspecified0d7_KjU)) || (i2 & ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) == 131072) | ((((3670016 & i2) ^ 1572864) > 1048576 && composer.changed(iM6752getSrcIn0nO6VwU)) || (i2 & 1572864) == 1048576);
        Object objRememberedValue = composer.rememberedValue();
        if (z4 || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = m7578createColorFilterxETnrds(jM6850getUnspecified0d7_KjU, iM6752getSrcIn0nO6VwU);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        m7576configureVectorPainterT4PVSW8(vectorPainter, jM7579obtainSizePxVpY3zN4, jM7580obtainViewportSizePq9zytI, str3, colorFilter, z3);
        ...
        if (z5 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
            ...
            composition2.setContent(ComposableLambdaKt.composableLambdaInstance(1749374910, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorPainterKt$rememberVectorPainter$2$composition$1$1
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    function4.invoke(Float.valueOf(Float.intBitsToFloat((int) (jM7580obtainViewportSizePq9zytI >> 32))), Float.valueOf(Float.intBitsToFloat((int) (jM7580obtainViewportSizePq9zytI & 4294967295L))), composer2, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
    ...
    private static final long m7579obtainSizePxVpY3zN4(Density density, float f, float f2) {
        float fMo754toPx0680j_4 = density.mo754toPx0680j_4(f);
        float fMo754toPx0680j_5 = density.mo754toPx0680j_4(f2);
    ...
    private static final long m7580obtainViewportSizePq9zytI(long j, float f, float f2) {
        if (Float.isNaN(f)) {
        ...
        return Size.m6629constructorimpl((((long) Float.floatToRawIntBits(f)) << 32) | (((long) Float.floatToRawIntBits(f2)) & 4294967295L));
    }

    /* JADX INFO: renamed from: createColorFilter-xETnrds, reason: not valid java name */
    private static final ColorFilter m7578createColorFilterxETnrds(long j, int i) {
        if (j != 16) {
            return ColorFilter.INSTANCE.m6858tintxETnrds(j, i);
        }
        return null;
    }

    /* JADX INFO: renamed from: configureVectorPainter-T4PVSW8$default, reason: not valid java name */
    public static /* synthetic */ VectorPainter m7577configureVectorPainterT4PVSW8$default(VectorPainter vectorPainter, long j, long j2, String str, ColorFilter colorFilter, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            str = RootGroupName;
        }
        return m7576configureVectorPainterT4PVSW8(vectorPainter, j, j2, str, colorFilter, (i & 16) != 0 ? false : z);
    }

    /* JADX INFO: renamed from: configureVectorPainter-T4PVSW8, reason: not valid java name */
    public static final VectorPainter m7576configureVectorPainterT4PVSW8(VectorPainter vectorPainter, long j, long j2, String str, ColorFilter colorFilter, boolean z) {
        vectorPainter.m7574setSizeuvyYCjk$ui(j);
        vectorPainter.setAutoMirror$ui(z);
        vectorPainter.setIntrinsicColorFilter$ui(colorFilter);
        vectorPainter.m7575setViewportSizeuvyYCjk$ui(j2);
    ...
    public static final VectorPainter createVectorPainterFromImageVector(Density density, ImageVector imageVector, GroupComponent groupComponent) {
        long jM7579obtainSizePxVpY3zN4 = m7579obtainSizePxVpY3zN4(density, imageVector.getDefaultWidth(), imageVector.getDefaultHeight());
        return m7576configureVectorPainterT4PVSW8(new VectorPainter(groupComponent), jM7579obtainSizePxVpY3zN4, m7580obtainViewportSizePq9zytI(jM7579obtainSizePxVpY3zN4, imageVector.getViewportWidth(), imageVector.getViewportHeight()), imageVector.getName(), m7578createColorFilterxETnrds(imageVector.getTintColor(), imageVector.getTintBlendMode()), imageVector.getAutoMirror());
    }
    ...
    public static final GroupComponent createGroupComponent(GroupComponent groupComponent, VectorGroup vectorGroup) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (vectorNode instanceof VectorPath) {
                ...
                pathComponent.m7559setPathFillTypeoQ8Xj4U(vectorPath.getPathFillType());
                ...
                pathComponent.m7560setStrokeLineCapBeK7IIE(vectorPath.getStrokeLineCap());
                pathComponent.m7561setStrokeLineJoinWw9F2mQ(vectorPath.getStrokeLineJoin());
    ...
    /* JADX WARN: Code duplicated, block: B:48:0x028b  */
    /* JADX WARN: Code duplicated, block: B:53:0x02a2  */
    /* JADX WARN: Code duplicated, block: B:54:0x02a6  */
