...
public final class GroupComponent extends VNode {
    ...
    public GroupComponent() {
        ...
        this.tintColor = Color.INSTANCE.m6850getUnspecified0d7_KjU();
    ...
    private final void markTintForBrush(Brush brush) {
        if (this.isTintable && brush != null) {
            if (brush instanceof SolidColor) {
                m7546markTintForColor8_81llA(((SolidColor) brush).getValue());
            } else {
                markNotTintable();
            }
        }
    ...
    private final void m7546markTintForColor8_81llA(long color) {
        if (this.isTintable && color != 16) {
            long j = this.tintColor;
            if (j == 16) {
                this.tintColor = color;
            } else {
                if (VectorKt.m7569rgbEqualOWjLjI(j, color)) {
                    return;
                }
                markNotTintable();
            }
    ...
    public final void markTintForVNode(VNode node) {
        if (node instanceof PathComponent) {
            ...
            if (groupComponent.isTintable && this.isTintable) {
                m7546markTintForColor8_81llA(groupComponent.tintColor);
            } else {
                markNotTintable();
            }
        }
    ...
    private final void updateMatrix() {
        float[] fArrM7060constructorimpl$default = this.groupMatrix;
        if (fArrM7060constructorimpl$default == null) {
            fArrM7060constructorimpl$default = Matrix.m7060constructorimpl$default(null, 1, null);
            this.groupMatrix = fArrM7060constructorimpl$default;
        } else {
            Matrix.m7069resetimpl(fArrM7060constructorimpl$default);
        }
        float[] fArr = fArrM7060constructorimpl$default;
        Matrix.m7082translateimpl$default(fArr, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m7074rotateZimpl(fArr, this.rotation);
        Matrix.m7075scaleimpl(fArr, this.scaleX, this.scaleY, 1.0f);
        Matrix.m7082translateimpl$default(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        try {
            ...
            if (fArr != null) {
                transform.mo7324transform58bKbWc((fArr != null ? Matrix.m7058boximpl(fArr) : null).m7083unboximpl());
            }
            Path path = this.clipPath;
            if (getWillClipPath() && path != null) {
                DrawTransform.m7451clipPathmtrdDE$default(transform, path, 0, 2, null);
            }
