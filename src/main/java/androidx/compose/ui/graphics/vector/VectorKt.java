...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m7190getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m7201getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m6752getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m6849getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m7113getNonZeroRgk1Os();
    ...
    public static final boolean m7569rgbEqualOWjLjI(long j, long j2) {
        return Color.m6820getRedimpl(j) == Color.m6820getRedimpl(j2) && Color.m6819getGreenimpl(j) == Color.m6819getGreenimpl(j2) && Color.m6817getBlueimpl(j) == Color.m6817getBlueimpl(j2);
    }

    /* JADX INFO: renamed from: toOpaque-8_81llA, reason: not valid java name */
    public static final long m7570toOpaque8_81llA(long j) {
        return Color.m6816getAlphaimpl(j) == 1.0f ? j : Color.m6813copywmQWz5c$default(j, 1.0f, 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        ...
        return BlendMode.m6723equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m6752getSrcIn0nO6VwU()) || BlendMode.m6723equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m6754getSrcOver0nO6VwU());
    }
}
