...
public final class LayerSnapshotV22 implements LayerSnapshotImpl {
    ...
    @DebugMetadata(c = "androidx.compose.ui.graphics.layer.LayerSnapshotV22", f = "LayerSnapshot.android.kt", i = {0, 0, 0, 0}, l = {JfifUtil.MARKER_APP1}, m = "toBitmap", n = {"graphicsLayer", "looper", "reader", "$completion$iv"}, s = {"L$0", "L$1", "L$3", "L$4"}, v = 1)
            ...
            try {
                ...
                imageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() { // from class: androidx.compose.ui.graphics.layer.LayerSnapshotV22$toBitmap$2$image$1$1
                    ...
                    public final void onImageAvailable(ImageReader imageReader2) {
                        ...
                        cancellableContinuation.resumeWith(Result.m14780constructorimpl(imageReader2.acquireLatestImage()));
                    }
                }, HandlerCompat.createAsync(looperMyLooper));
                Surface surface = imageReader.getSurface();
                Canvas canvasLockCanvas = SurfaceUtils.INSTANCE.lockCanvas(surface);
                try {
                    canvasLockCanvas.drawColor(ColorKt.m6868toArgb8_81llA(Color.INSTANCE.m6840getBlack0d7_KjU()), PorterDuff.Mode.CLEAR);
