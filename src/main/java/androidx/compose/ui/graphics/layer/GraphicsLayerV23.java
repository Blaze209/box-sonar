...
public final class GraphicsLayerV23 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV23(View view, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.outlineSize = IntSize.INSTANCE.m9863getZeroYbymL2g();
        ...
        renderNodeCreate.setClipToBounds(false);
        m7510applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m7475getAutoke2Ky5w());
        this.compositingStrategy = CompositingStrategy.INSTANCE.m7475getAutoke2Ky5w();
        this.blendMode = BlendMode.INSTANCE.m6754getSrcOver0nO6VwU();
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m6584getUnspecifiedF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
        this.ambientShadowColor = Color.INSTANCE.m6840getBlack0d7_KjU();
        this.spotShadowColor = Color.INSTANCE.m6840getBlack0d7_KjU();
    ...
    public void mo7505setCompositingStrategyWpw9cng(int i) {
        this.compositingStrategy = i;
        updateLayerProperties();
    }

    /* JADX INFO: renamed from: applyCompositingStrategy-Wpw9cng, reason: not valid java name */
    private final void m7510applyCompositingStrategyWpw9cng(int compositingStrategy) {
        RenderNode renderNode = this.renderNode;
        if (CompositingStrategy.m7471equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m7477getOffscreenke2Ky5w())) {
            renderNode.setLayerType(2);
            renderNode.setLayerPaint(this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m7471equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m7476getModulateAlphake2Ky5w())) {
    ...
    public void mo7504setBlendModes9anfk8(int i) {
        if (BlendMode.m6723equalsimpl0(this.blendMode, i)) {
            return;
        }
        this.blendMode = i;
        obtainLayerPaint().setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m6662toPorterDuffModes9anfk8(i)));
        updateLayerProperties();
    }

    private final boolean requiresCompositingLayer() {
        return (!CompositingStrategy.m7471equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m7477getOffscreenke2Ky5w()) && BlendMode.m6723equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m6754getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }

    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m7510applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m7477getOffscreenke2Ky5w());
        } else {
            m7510applyCompositingStrategyWpw9cng(getCompositingStrategy());
        }
    }
    ...
    public void mo7507setPivotOffsetk4lQ0M(long j) {
        this.pivotOffset = j;
    ...
    public void mo7503setAmbientShadowColor8_81llA(long j) {
        this.ambientShadowColor = j;
        RenderNodeVerificationHelper28.INSTANCE.setAmbientShadowColor(this.renderNode, ColorKt.m6868toArgb8_81llA(j));
    }
    ...
    public void mo7509setSpotShadowColor8_81llA(long j) {
        this.spotShadowColor = j;
        RenderNodeVerificationHelper28.INSTANCE.setSpotShadowColor(this.renderNode, ColorKt.m6868toArgb8_81llA(j));
    }
    ...
    public void mo7508setPositionH0pRuoY(int x, int y, long size) {
        int i = (int) (size >> 32);
        int i2 = (int) (4294967295L & size);
        this.renderNode.setLeftTopRightBottom(x, y, x + i, y + i2);
        if (IntSize.m9856equalsimpl0(this.size, size)) {
            return;
        }
    ...
    public void mo7506setOutlineO0kMr_c(Outline outline, long outlineSize) {
