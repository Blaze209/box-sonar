...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.size = Size.INSTANCE.m6647getZeroNHjbRc();
        renderNode.setClipToBounds(false);
        m7511applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.INSTANCE.m7475getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo7504setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().setBlendMode(AndroidBlendMode_androidKt.m6661toAndroidBlendModes9anfk8(i));
    ...
    public void mo7503setAmbientShadowColor8_81llA(long j) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m6868toArgb8_81llA(j));
    }
    ...
    public void mo7509setSpotShadowColor8_81llA(long j) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m6868toArgb8_81llA(j));
    }
    ...
    private final void m7511applyCompositingStrategyZ1X6vPc(RenderNode renderNode, int i) {
        if (CompositingStrategy.m7471equalsimpl0(i, CompositingStrategy.INSTANCE.m7477getOffscreenke2Ky5w())) {
            renderNode.setUseCompositingLayer(true, this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m7471equalsimpl0(i, CompositingStrategy.INSTANCE.m7476getModulateAlphake2Ky5w())) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m7511applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.INSTANCE.m7477getOffscreenke2Ky5w());
        } else {
            m7511applyCompositingStrategyZ1X6vPc(this.renderNode, getCompositingStrategy());
        }
    }
    ...
    public void mo7508setPositionH0pRuoY(int x, int y, long size) {
        ...
        this.size = IntSizeKt.m9870toSizeozmzZPI(size);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        try {
            ...
            drawContext.mo7317setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m7471equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m7477getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }
