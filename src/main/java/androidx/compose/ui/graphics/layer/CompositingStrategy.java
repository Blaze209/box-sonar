...
public final class CompositingStrategy {
    ...
    private static final int Auto = m7469constructorimpl(0);
    private static final int Offscreen = m7469constructorimpl(1);
    private static final int ModulateAlpha = m7469constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ CompositingStrategy m7468boximpl(int i) {
    ...
    public boolean equals(Object other) {
        return m7470equalsimpl(this.value, other);
    }
