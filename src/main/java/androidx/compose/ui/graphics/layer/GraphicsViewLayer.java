...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer drawChildContainer, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m6585getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
    ...
    private final void m7512applyCompositingLayerWpw9cng(int compositingStrategy) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m7512applyCompositingLayerWpw9cng(CompositingStrategy.INSTANCE.m7477getOffscreenke2Ky5w());
        } else {
            m7512applyCompositingLayerWpw9cng(getCompositingStrategy());
        }
    }
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m7471equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m7477getOffscreenke2Ky5w()) || requiresLayerPaint();
    }
    ...
    public void mo7503setAmbientShadowColor8_81llA(long j) {
        ...
        ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m6868toArgb8_81llA(j));
    }
    ...
    public void mo7509setSpotShadowColor8_81llA(long j) {
        ...
        ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m6868toArgb8_81llA(j));
    }
