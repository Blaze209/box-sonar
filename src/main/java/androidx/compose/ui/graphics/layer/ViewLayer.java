...
public final class ViewLayer extends View {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        long jM6629constructorimpl = Size.m6629constructorimpl((((long) Float.floatToRawIntBits(getHeight())) & 4294967295L) | (Float.floatToRawIntBits(width) << 32));
        ...
        drawContext.mo7317setSizeuvyYCjk(jM6629constructorimpl);
