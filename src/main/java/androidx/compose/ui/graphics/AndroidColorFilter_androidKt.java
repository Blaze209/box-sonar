...
public final class AndroidColorFilter_androidKt {
    ...
    public static final android.graphics.ColorFilter m6676actualTintColorFilterxETnrds(long j, int i) {
        return BlendModeColorFilterHelper.INSTANCE.m6758BlendModeColorFilterxETnrds(j, i);
    }

    /* JADX INFO: renamed from: actualColorMatrixColorFilter-jHG-Opc, reason: not valid java name */
    public static final android.graphics.ColorFilter m6674actualColorMatrixColorFilterjHGOpc(float[] fArr) {
    ...
    public static final android.graphics.ColorFilter m6675actualLightingColorFilterOWjLjI(long j, long j2) {
        return new android.graphics.LightingColorFilter(ColorKt.m6868toArgb8_81llA(j), ColorKt.m6868toArgb8_81llA(j2));
    }

    public static final float[] actualColorMatrixFromFilter(android.graphics.ColorFilter colorFilter) {
        if ((colorFilter instanceof android.graphics.ColorMatrixColorFilter) && supportsColorMatrixQuery()) {
            return ColorMatrixFilterHelper.INSTANCE.m6893getColorMatrix8unuwjk((android.graphics.ColorMatrixColorFilter) colorFilter);
        }
