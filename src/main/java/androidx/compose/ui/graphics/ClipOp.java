...
public final class ClipOp {
    ...
    private static final int Difference = m6796constructorimpl(0);
    private static final int Intersect = m6796constructorimpl(1);
    private final int value;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ClipOp m6795boximpl(int i) {
        return new ClipOp(i);
    }
    ...
    public static String m6800toStringimpl(int i) {
        if (m6798equalsimpl0(i, Difference)) {
            return "Difference";
        }
        return m6798equalsimpl0(i, Intersect) ? "Intersect" : "Unknown";
    }
}
