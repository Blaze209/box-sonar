...
public final class AndroidPathEffect_androidKt {
    ...
    public static final PathEffect m6707actualStampedPathEffect7aD1DOk(Path path, float f, float f2, int i) {
        if (path instanceof AndroidPath) {
            return new AndroidPathEffect(new PathDashPathEffect(((AndroidPath) path).getInternalPath(), f, f2, m6708toAndroidPathDashPathEffectStyleoQv6xUo(i)));
        }
        throw new UnsupportedOperationException("Unable to obtain android.graphics.Path");
    }

    /* JADX INFO: renamed from: toAndroidPathDashPathEffectStyle-oQv6xUo, reason: not valid java name */
    public static final PathDashPathEffect.Style m6708toAndroidPathDashPathEffectStyleoQv6xUo(int i) {
        if (StampedPathEffectStyle.m7176equalsimpl0(i, StampedPathEffectStyle.INSTANCE.m7180getMorphYpspkwk())) {
            return PathDashPathEffect.Style.MORPH;
        }
        if (StampedPathEffectStyle.m7176equalsimpl0(i, StampedPathEffectStyle.INSTANCE.m7181getRotateYpspkwk())) {
            return PathDashPathEffect.Style.ROTATE;
        }
        return StampedPathEffectStyle.m7176equalsimpl0(i, StampedPathEffectStyle.INSTANCE.m7182getTranslateYpspkwk()) ? PathDashPathEffect.Style.TRANSLATE : PathDashPathEffect.Style.TRANSLATE;
    }
}
