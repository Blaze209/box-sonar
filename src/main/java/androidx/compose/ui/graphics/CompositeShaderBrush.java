...
public final class CompositeShaderBrush extends ShaderBrush {
    ...
    public Shader mo6783createShaderuvyYCjk(long size) {
        return ShaderKt.m7147CompositeShader7EN7VTw(this.dstBrush.mo6783createShaderuvyYCjk(size), this.srcBrush.mo6783createShaderuvyYCjk(size), this.blendMode);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.dstBrush, compositeShaderBrush.dstBrush) && Intrinsics.areEqual(this.srcBrush, compositeShaderBrush.srcBrush) && BlendMode.m6723equalsimpl0(this.blendMode, compositeShaderBrush.blendMode);
    }

    public int hashCode() {
        return (((this.dstBrush.hashCode() * 31) + this.srcBrush.hashCode()) * 31) + BlendMode.m6724hashCodeimpl(this.blendMode);
    }

    public String toString() {
        return "CompositeShaderBrush(dstBrush=" + this.dstBrush + ", srcBrush=" + this.srcBrush + ", blendMode=" + ((Object) BlendMode.m6725toStringimpl(this.blendMode)) + ')';
    }
}
