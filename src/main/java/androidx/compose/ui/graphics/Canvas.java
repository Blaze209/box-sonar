...
public interface Canvas {
    ...
    void mo6666drawCircle9KIMszo(long center, float radius, Paint paint);

    /* JADX INFO: renamed from: drawImage-d-4ec7I */
    void mo6667drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* JADX INFO: renamed from: drawImageRect-HPBpro0 */
    void mo6668drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* JADX INFO: renamed from: drawLine-Wko1d7g */
    void mo6669drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo6670drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* JADX INFO: renamed from: drawRawPoints-O7TthRY */
    void mo6671drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo6672drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m6792clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Canvas.super.m6789clipRectmtrdDE(rect, i);
        }
    ...
    static /* synthetic */ void m6787clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.m6789clipRectmtrdDE(rect, i);
    }

    /* JADX INFO: renamed from: clipRect-mtrdD-E, reason: not valid java name */
    default void m6789clipRectmtrdDE(Rect rect, int clipOp) {
        mo6664clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
    }

    /* JADX INFO: renamed from: clipRect-N_I0leg$default, reason: not valid java name */
    static /* synthetic */ void m6786clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo6664clipRectN_I0leg(f, f2, f3, f4, i);
    }

    /* JADX INFO: renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
    static /* synthetic */ void m6785clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo6663clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m6788drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        long jM9853constructorimpl;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long jM9826getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m9826getZeronOccac() : j;
        if ((i & 4) != 0) {
        ...
        canvas.mo6668drawImageRectHPBpro0(imageBitmap, jM9826getZeronOccac, jM9853constructorimpl, (i & 8) != 0 ? IntOffset.INSTANCE.m9826getZeronOccac() : j3, (i & 16) != 0 ? jM9853constructorimpl : j4, paint);
    }
}
