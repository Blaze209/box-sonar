...
public final class LinearGradient extends ShaderBrush implements Interpolatable {
    ...
    public /* synthetic */ LinearGradient(List list, List list2, long j, long j2, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(list, (i2 & 2) != 0 ? null : list2, j, j2, (i2 & 16) != 0 ? TileMode.INSTANCE.m7211getClamp3opZhB0() : i, null);
    }
    ...
    public long getIntrinsicSize() {
        ...
        return Size.m6629constructorimpl((((long) Float.floatToRawIntBits(fAbs)) << 32) | (((long) Float.floatToRawIntBits(fAbs2)) & 4294967295L));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.colors, linearGradient.colors) && Intrinsics.areEqual(this.stops, linearGradient.stops) && Offset.m6566equalsimpl0(this.start, linearGradient.start) && Offset.m6566equalsimpl0(this.end, linearGradient.end) && TileMode.m7207equalsimpl0(this.tileMode, linearGradient.tileMode);
    }

    public int hashCode() {
        int iHashCode = this.colors.hashCode() * 31;
        List<Float> list = this.stops;
        return ((((((iHashCode + (list != null ? list.hashCode() : 0)) * 31) + Offset.m6571hashCodeimpl(this.start)) * 31) + Offset.m6571hashCodeimpl(this.end)) * 31) + TileMode.m7208hashCodeimpl(this.tileMode);
    }

    public String toString() {
        return "LinearGradient(colors=" + this.colors + ", stops=" + this.stops + ", " + (((((this.start & androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase) ^ androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase) - androidx.compose.ui.geometry.InlineClassHelperKt.Uint64Low32) & (-9223372034707292160L)) == 0 ? "start=" + ((Object) Offset.m6577toStringimpl(this.start)) + ", " : "") + ((((androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase ^ (this.end & androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase)) - androidx.compose.ui.geometry.InlineClassHelperKt.Uint64Low32) & (-9223372034707292160L)) == 0 ? "end=" + ((Object) Offset.m6577toStringimpl(this.end)) + ", " : "") + "tileMode=" + ((Object) TileMode.m7209toStringimpl(this.tileMode)) + ')';
    }

    @Override // androidx.compose.ui.graphics.Interpolatable
    public Object lerp(Object other, float t) {
        Object solidColor = other == null ? new SolidColor(Color.INSTANCE.m6849getTransparent0d7_KjU(), null) : other;
        if (solidColor instanceof SolidColor) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                arrayList.add(Color.m6804boximpl(((SolidColor) solidColor).getValue()));
            }
        ...
        return new LinearGradient(BrushKt.lerpColorList(this.colors, linearGradient.colors, t), BrushKt.lerpNullableFloatList(this.stops, linearGradient.stops, t), BrushKt.m6782lerpSafeWko1d7g(this.start, linearGradient.start, t), BrushKt.m6782lerpSafeWko1d7g(this.end, linearGradient.end, t), t < 0.5f ? this.tileMode : linearGradient.tileMode, null);
    }
}
