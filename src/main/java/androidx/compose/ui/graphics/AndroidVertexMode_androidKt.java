...
public final class AndroidVertexMode_androidKt {
    ...
    public static final android.graphics.Canvas.VertexMode m6718toAndroidVertexModeJOOmi9M(int i) {
        if (VertexMode.m7234equalsimpl0(i, VertexMode.INSTANCE.m7240getTrianglesc2xauaI())) {
            return android.graphics.Canvas.VertexMode.TRIANGLES;
        }
        if (VertexMode.m7234equalsimpl0(i, VertexMode.INSTANCE.m7239getTriangleStripc2xauaI())) {
            return android.graphics.Canvas.VertexMode.TRIANGLE_STRIP;
        }
        return VertexMode.m7234equalsimpl0(i, VertexMode.INSTANCE.m7238getTriangleFanc2xauaI()) ? android.graphics.Canvas.VertexMode.TRIANGLE_FAN : android.graphics.Canvas.VertexMode.TRIANGLES;
    }
}
