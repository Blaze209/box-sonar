...
public final class PaintingStyle {
    ...
    private static final int Fill = m7091constructorimpl(0);
    private static final int Stroke = m7091constructorimpl(1);
    private final int value;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m7090boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m7097getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* JADX INFO: renamed from: getStroke-TiuSbCo, reason: not valid java name */
        public final int m7098getStrokeTiuSbCo() {
            return PaintingStyle.Stroke;
        }
    }

    public String toString() {
        return m7095toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m7095toStringimpl(int i) {
        if (m7093equalsimpl0(i, Fill)) {
            return "Fill";
        }
        return m7093equalsimpl0(i, Stroke) ? "Stroke" : "Unknown";
    }
}
