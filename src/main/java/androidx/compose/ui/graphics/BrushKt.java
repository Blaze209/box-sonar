...
public final class BrushKt {
    public static final ShaderBrush toShaderBrush(Brush brush) {
        ...
        Brush brushM6769verticalGradient8A3gB4$default = Brush.Companion.m6769verticalGradient8A3gB4$default(Brush.INSTANCE, CollectionsKt.listOf((Object[]) new Color[]{Color.m6804boximpl(solidColor.getValue()), Color.m6804boximpl(solidColor.getValue())}), 0.0f, 0.0f, 0, 14, (Object) null);
        Intrinsics.checkNotNull(brushM6769verticalGradient8A3gB4$default, "null cannot be cast to non-null type androidx.compose.ui.graphics.ShaderBrush");
        return (ShaderBrush) brushM6769verticalGradient8A3gB4$default;
    }
    ...
    public static final List<Color> lerpColorList(List<Color> list, List<Color> list2, float f) {
        ...
        for (int i = 0; i < iMax; i++) {
            arrayList.add(Color.m6804boximpl(ColorKt.m6865lerpjxsXWHM(list.get(Math.min(i, list.size() - 1)).m6824unboximpl(), list2.get(Math.min(i, list2.size() - 1)).m6824unboximpl(), f)));
        }
        return arrayList;
    }
    ...
    public static final long m6782lerpSafeWko1d7g(long j, long j2, float f) {
        if (((((j & androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase) ^ androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase) - androidx.compose.ui.geometry.InlineClassHelperKt.Uint64Low32) & (-9223372034707292160L)) == 0 && (((androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase ^ (j2 & androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase)) - androidx.compose.ui.geometry.InlineClassHelperKt.Uint64Low32) & (-9223372034707292160L)) == 0) {
            return OffsetKt.m6592lerpWko1d7g(j, j2, f);
        }
        return f < 0.5f ? j : j2;
    }
