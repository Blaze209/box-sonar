...
public final class BitmapPainter extends Painter {
    ...
    private BitmapPainter(ImageBitmap imageBitmap, long j, long j2) {
        ...
        this.srcOffset = j;
        this.srcSize = j2;
        this.filterQuality = FilterQuality.INSTANCE.m6916getLowfv9h1I();
        this.size = m7513validateSizeN5eqBDc(j, j2);
        this.alpha = 1.0f;
    }
    ...
    public /* synthetic */ BitmapPainter(ImageBitmap imageBitmap, long j, long j2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(imageBitmap, (i & 2) != 0 ? IntOffset.INSTANCE.m9826getZeronOccac() : j, (i & 4) != 0 ? IntSize.m9853constructorimpl((((long) imageBitmap.getHeight()) & 4294967295L) | (((long) imageBitmap.getWidth()) << 32)) : j2, null);
    }
    ...
    public final void m7516setFilterQualityvDHp3xo$ui_graphics(int i) {
    ...
    protected void onDraw(DrawScope drawScope) {
        ...
        int iRound = Math.round(Float.intBitsToFloat((int) (drawScope.mo7395getSizeNHjbRc() >> 32)));
        long j3 = ((long) iRound) << 32;
        DrawScope.m7378drawImageAZ2fEMs$default(drawScope, imageBitmap, j, j2, 0L, IntSize.m9853constructorimpl((((long) Math.round(Float.intBitsToFloat((int) (drawScope.mo7395getSizeNHjbRc() & 4294967295L)))) & 4294967295L) | j3), this.alpha, null, this.colorFilter, 0, this.filterQuality, 328, null);
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    /* JADX INFO: renamed from: getIntrinsicSize-NH-jbRc, reason: not valid java name */
    public long mo7515getIntrinsicSizeNHjbRc() {
        return IntSizeKt.m9870toSizeozmzZPI(this.size);
    }
    ...
    private final long m7513validateSizeN5eqBDc(long srcOffset, long srcSize) {
        int i;
        int i2;
        if (IntOffset.m9815getXimpl(srcOffset) < 0 || IntOffset.m9816getYimpl(srcOffset) < 0 || (i = (int) (srcSize >> 32)) < 0 || (i2 = (int) (4294967295L & srcSize)) < 0 || i > this.image.getWidth() || i2 > this.image.getHeight()) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.image, bitmapPainter.image) && IntOffset.m9814equalsimpl0(this.srcOffset, bitmapPainter.srcOffset) && IntSize.m9856equalsimpl0(this.srcSize, bitmapPainter.srcSize) && FilterQuality.m6911equalsimpl0(this.filterQuality, bitmapPainter.filterQuality);
    }

    public int hashCode() {
        return (((((this.image.hashCode() * 31) + IntOffset.m9817hashCodeimpl(this.srcOffset)) * 31) + IntSize.m9859hashCodeimpl(this.srcSize)) * 31) + FilterQuality.m6912hashCodeimpl(this.filterQuality);
    }

    public String toString() {
        return "BitmapPainter(image=" + this.image + ", srcOffset=" + ((Object) IntOffset.m9822toStringimpl(this.srcOffset)) + ", srcSize=" + ((Object) IntSize.m9861toStringimpl(this.srcSize)) + ", filterQuality=" + ((Object) FilterQuality.m6913toStringimpl(this.filterQuality)) + ')';
    }
}
