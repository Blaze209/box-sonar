...
public final class BlurKt {
    ...
    public static /* synthetic */ Paint m7530configureShadowFoewPVk$default(Paint paint, long j, int i, BlurMaskFilter blurMaskFilter, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            j = Color.INSTANCE.m6840getBlack0d7_KjU();
        }
        long j2 = j;
        if ((i3 & 2) != 0) {
            i = BlendMode.INSTANCE.m6754getSrcOver0nO6VwU();
        }
        int i4 = i;
        if ((i3 & 4) != 0) {
            blurMaskFilter = null;
        ...
        if ((i3 & 8) != 0) {
            i2 = PaintingStyle.INSTANCE.m7097getFillTiuSbCo();
        }
        return m7529configureShadowFoewPVk(paint, j2, i4, blurMaskFilter2, i2);
    }

    /* JADX INFO: renamed from: configureShadow-FoewPVk, reason: not valid java name */
    public static final Paint m7529configureShadowFoewPVk(Paint paint, long j, int i, BlurMaskFilter blurMaskFilter, int i2) {
        paint.mo6690setColor8_81llA(j);
        paint.mo6689setBlendModes9anfk8(i);
        paint.mo6694setStylek9PVt8s(i2);
