...
public final class Shadow {
    ...
    private Shadow(float f, Brush brush, float f2, long j, float f3, int i) {
        this(f, f2, j, Color.INSTANCE.m6840getBlack0d7_KjU(), brush, f3, i, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ Shadow(float f, long j, float f2, long j2, float f3, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(f, (i2 & 2) != 0 ? Color.INSTANCE.m6840getBlack0d7_KjU() : j, (i2 & 4) != 0 ? Dp.m9687constructorimpl(0) : f2, (i2 & 8) != 0 ? DpOffset.INSTANCE.m9758getZeroRKDOV3M() : j2, (i2 & 16) != 0 ? 1.0f : f3, (i2 & 32) != 0 ? DrawScope.INSTANCE.m7397getDefaultBlendMode0nO6VwU() : i, (DefaultConstructorMarker) null);
    }

    private Shadow(float f, long j, float f2, long j2, float f3, int i) {
        this(f, f2, j2, j != 16 ? j : Color.INSTANCE.m6840getBlack0d7_KjU(), (Brush) null, f3, i, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m9692equalsimpl0(this.radius, shadow.radius) && Dp.m9692equalsimpl0(this.spread, shadow.spread) && DpOffset.m9747equalsimpl0(this.offset, shadow.offset) && this.alpha == shadow.alpha && BlendMode.m6723equalsimpl0(this.blendMode, shadow.blendMode) && Color.m6815equalsimpl0(this.color, shadow.color) && Intrinsics.areEqual(this.brush, shadow.brush);
    }

    public int hashCode() {
        int iM9693hashCodeimpl = ((((((((((Dp.m9693hashCodeimpl(this.radius) * 31) + Dp.m9693hashCodeimpl(this.spread)) * 31) + DpOffset.m9752hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.alpha)) * 31) + BlendMode.m6724hashCodeimpl(this.blendMode)) * 31) + Color.m6821hashCodeimpl(this.color)) * 31;
        Brush brush = this.brush;
        return iM9693hashCodeimpl + (brush != null ? brush.hashCode() : 0);
    }

    public String toString() {
        return "Shadow(radius=" + ((Object) Dp.m9698toStringimpl(this.radius)) + ", spread=" + ((Object) Dp.m9698toStringimpl(this.spread)) + ", offset=" + ((Object) DpOffset.m9755toStringimpl(this.offset)) + ", alpha=" + this.alpha + ", blendMode=" + ((Object) BlendMode.m6725toStringimpl(this.blendMode)) + ", color=" + ((Object) Color.m6822toStringimpl(this.color)) + ", brush=" + this.brush + ')';
    }

    public final Shadow copyWithoutOffset$ui_graphics() {
        return new Shadow(this.radius, this.spread, DpOffset.INSTANCE.m9758getZeroRKDOV3M(), this.color, this.brush, this.alpha, this.blendMode, (DefaultConstructorMarker) null);
    }

    public final Shadow transparentCopy$ui_graphics() {
        return new Shadow(this.radius, Color.INSTANCE.m6849getTransparent0d7_KjU(), this.spread, this.offset, this.alpha, this.blendMode, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ Shadow(float f, Brush brush, float f2, long j, float f3, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(f, brush, (i2 & 4) != 0 ? Dp.m9687constructorimpl(0) : f2, (i2 & 8) != 0 ? DpOffset.INSTANCE.m9758getZeroRKDOV3M() : j, (i2 & 16) != 0 ? 1.0f : f3, (i2 & 32) != 0 ? DrawScope.INSTANCE.m7397getDefaultBlendMode0nO6VwU() : i, (DefaultConstructorMarker) null);
    }
}
