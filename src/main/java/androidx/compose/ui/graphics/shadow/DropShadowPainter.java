...
public final class DropShadowPainter extends Painter {
    ...
    protected void onDraw(DrawScope drawScope) {
        DropShadowRenderer dropShadowRendererMo7522obtainDropShadowRenderereZhPAX0 = this.renderCreator.mo7522obtainDropShadowRenderereZhPAX0(this.shape, drawScope.mo7395getSizeNHjbRc(), drawScope.getLayoutDirection(), drawScope, this.shadow);
        float f = drawScope.mo754toPx0680j_4(DpOffset.m9748getXD9Ej5fM(this.shadow.getOffset()));
        float f2 = drawScope.mo754toPx0680j_4(DpOffset.m9750getYD9Ej5fM(this.shadow.getOffset()));
        drawScope.getDrawContext().getTransform().translate(f, f2);
        try {
            dropShadowRendererMo7522obtainDropShadowRenderereZhPAX0.m7544drawShadowerFMhIw(drawScope, this.colorFilter, drawScope.mo7395getSizeNHjbRc(), dropShadowRendererMo7522obtainDropShadowRenderereZhPAX0.getShadow().getColor(), dropShadowRendererMo7522obtainDropShadowRenderereZhPAX0.getShadow().getBrush(), RangesKt.coerceIn(this.alpha * dropShadowRendererMo7522obtainDropShadowRenderereZhPAX0.getShadow().getAlpha(), 0.0f, 1.0f), dropShadowRendererMo7522obtainDropShadowRenderereZhPAX0.getShadow().getBlendMode());
        } finally {
            drawScope.getDrawContext().getTransform().translate(-f, -f2);
        }
    }
