...
public final class InnerShadowPainter extends Painter {
    ...
    protected void onDraw(DrawScope drawScope) {
        this.renderCreator.mo7523obtainInnerShadowRenderereZhPAX0(this.shape, drawScope.mo7395getSizeNHjbRc(), drawScope.getLayoutDirection(), drawScope, this.shadow).m7544drawShadowerFMhIw(drawScope, this.colorFilter, drawScope.mo7395getSizeNHjbRc(), this.shadow.getColor(), this.shadow.getBrush(), RangesKt.coerceIn(this.alpha * this.shadow.getAlpha(), 0.0f, 1.0f), this.shadow.getBlendMode());
    }
