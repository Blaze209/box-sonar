...
public final class BlendModeColorFilter extends ColorFilter {
    ...
    private BlendModeColorFilter(long j, int i) {
        this(j, i, AndroidColorFilter_androidKt.m6676actualTintColorFilterxETnrds(j, i), null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.color, blendModeColorFilter.color) && BlendMode.m6723equalsimpl0(this.blendMode, blendModeColorFilter.blendMode);
    }
    ...
    public String toString() {
        return "BlendModeColorFilter(color=" + ((Object) Color.m6822toStringimpl(this.color)) + ", blendMode=" + ((Object) BlendMode.m6725toStringimpl(this.blendMode)) + ')';
    }
}
