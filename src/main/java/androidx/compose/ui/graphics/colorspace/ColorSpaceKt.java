...
public final class ColorSpaceKt {
    ...
    private static final Connector m7259createConnectorYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        if (colorSpace == colorSpace2) {
            return Connector.INSTANCE.identity$ui_graphics(colorSpace);
        }
        DefaultConstructorMarker defaultConstructorMarker = null;
        if (ColorModel.m7246equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m7253getRgbxdoWZVw()) && ColorModel.m7246equalsimpl0(colorSpace2.getModel(), ColorModel.INSTANCE.m7253getRgbxdoWZVw())) {
    ...
    public static /* synthetic */ Connector m7258connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.INSTANCE.m7274getPerceptualuksYyKA();
        }
        return m7257connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* JADX INFO: renamed from: connect-YBCOT_4, reason: not valid java name */
    public static final Connector m7257connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        int id$ui_graphics = colorSpace.getId();
        int id$ui_graphics2 = colorSpace2.getId();
        if ((id$ui_graphics | id$ui_graphics2) < 0) {
            return m7259createConnectorYBCOT_4(colorSpace, colorSpace2, i);
        }
        MutableIntObjectMap<Connector> connectors = ConnectorKt.getConnectors();
        int i2 = id$ui_graphics | (id$ui_graphics2 << 6) | (i << 12);
        Connector connectorM7259createConnectorYBCOT_4 = connectors.get(i2);
        if (connectorM7259createConnectorYBCOT_4 == null) {
            connectorM7259createConnectorYBCOT_4 = m7259createConnectorYBCOT_4(colorSpace, colorSpace2, i);
            connectors.set(i2, connectorM7259createConnectorYBCOT_4);
        }
        return connectorM7259createConnectorYBCOT_4;
    }
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        if (ColorModel.m7246equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m7253getRgbxdoWZVw())) {
            Intrinsics.checkNotNull(colorSpace, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
