...
public final class RenderIntent {
    ...
    private static final int Perceptual = m7267constructorimpl(0);
    private static final int Relative = m7267constructorimpl(1);
    private static final int Saturation = m7267constructorimpl(2);
    private static final int Absolute = m7267constructorimpl(3);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ RenderIntent m7266boximpl(int i) {
    ...
    public static String m7271toStringimpl(int i) {
        if (m7269equalsimpl0(i, Perceptual)) {
            return "Perceptual";
        }
        if (m7269equalsimpl0(i, Relative)) {
            return "Relative";
        }
        if (m7269equalsimpl0(i, Saturation)) {
            return ExifInterface.TAG_SATURATION;
        }
        return m7269equalsimpl0(i, Absolute) ? "Absolute" : "Unknown";
    }
}
