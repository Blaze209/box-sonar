...
final class BlendModeColorFilterHelper {
    ...
    public final android.graphics.BlendModeColorFilter m6758BlendModeColorFilterxETnrds(long color, int blendMode) {
        return new android.graphics.BlendModeColorFilter(ColorKt.m6868toArgb8_81llA(color), AndroidBlendMode_androidKt.m6661toAndroidBlendModes9anfk8(blendMode));
    }
