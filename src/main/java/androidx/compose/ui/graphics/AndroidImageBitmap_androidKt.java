...
public final class AndroidImageBitmap_androidKt {
    ...
    public static final ImageBitmap m6679ActualImageBitmapx__hDU(int i, int i2, int i3, boolean z, ColorSpace colorSpace) {
        m6680toBitmapConfig1JJdX4A(i3);
        return new AndroidImageBitmap(Bitmap.createBitmap((DisplayMetrics) null, i, i2, m6680toBitmapConfig1JJdX4A(i3), z, AndroidColorSpace_androidKt.toAndroidColorSpace(colorSpace)));
    }
    ...
    public static final Bitmap.Config m6680toBitmapConfig1JJdX4A(int i) {
        if (ImageBitmapConfig.m7042equalsimpl0(i, ImageBitmapConfig.INSTANCE.m7047getArgb8888_sVssgQ())) {
            return Bitmap.Config.ARGB_8888;
        }
        if (ImageBitmapConfig.m7042equalsimpl0(i, ImageBitmapConfig.INSTANCE.m7046getAlpha8_sVssgQ())) {
            return Bitmap.Config.ALPHA_8;
        }
        if (ImageBitmapConfig.m7042equalsimpl0(i, ImageBitmapConfig.INSTANCE.m7050getRgb565_sVssgQ())) {
            return Bitmap.Config.RGB_565;
        }
        if (ImageBitmapConfig.m7042equalsimpl0(i, ImageBitmapConfig.INSTANCE.m7048getF16_sVssgQ())) {
            return Bitmap.Config.RGBA_F16;
        }
        if (ImageBitmapConfig.m7042equalsimpl0(i, ImageBitmapConfig.INSTANCE.m7049getGpu_sVssgQ())) {
    ...
    public static final int toImageConfig(Bitmap.Config config) {
        if (config == Bitmap.Config.ALPHA_8) {
            return ImageBitmapConfig.INSTANCE.m7046getAlpha8_sVssgQ();
        }
        if (config == Bitmap.Config.RGB_565) {
            return ImageBitmapConfig.INSTANCE.m7050getRgb565_sVssgQ();
        }
        if (config == Bitmap.Config.ARGB_4444) {
            return ImageBitmapConfig.INSTANCE.m7047getArgb8888_sVssgQ();
        }
        if (config == Bitmap.Config.RGBA_F16) {
            return ImageBitmapConfig.INSTANCE.m7048getF16_sVssgQ();
        }
        if (config == Bitmap.Config.HARDWARE) {
            return ImageBitmapConfig.INSTANCE.m7049getGpu_sVssgQ();
        }
        return ImageBitmapConfig.INSTANCE.m7047getArgb8888_sVssgQ();
    }
}
