...
public final class PathHitTester {
    ...
    public final boolean m7114containsk4lQ0M(long position) {
        int i;
        int iLineWinding;
        if (!this.path.isEmpty() && this.bounds.m6595containsk4lQ0M(position)) {
            ...
            if (PathFillType.m7108equalsimpl0(this.path.mo6702getFillTypeRgk1Os(), PathFillType.INSTANCE.m7112getEvenOddRgk1Os())) {
                i &= 1;
            }
            if (i != 0) {
                return true;
