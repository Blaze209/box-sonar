...
public final class BlockGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode, SemanticsModifierNode {
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo0.getWidth(), placeableMo8265measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.BlockGraphicsLayerModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.placeWithLayer$default(placementScope, placeableMo8265measureBRTryo0, 0, 0, 0.0f, this.getLayerBlock(), 4, (Object) null);
            }
        }, 4, null);
    }
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        if (ComposeUiFlags.isGraphicsLayerShapeSemanticsEnabled) {
            NodeCoordinator nodeCoordinatorM8436requireCoordinator64DMado = DelegatableNodeKt.m8436requireCoordinator64DMado(this, NodeKind.m8585constructorimpl(2));
            if (!nodeCoordinatorM8436requireCoordinator64DMado.getWasLayerBlockInvoked()) {
                ...
                reusableGraphicsLayerScope2.setGraphicsDensity$ui(nodeCoordinatorM8436requireCoordinator64DMado.getLayoutNode().getDensity());
                reusableGraphicsLayerScope2.m7144setSizeuvyYCjk(IntSizeKt.m9870toSizeozmzZPI(nodeCoordinatorM8436requireCoordinator64DMado.mo8273getSizeYbymL2g()));
                ...
                lastShape = nodeCoordinatorM8436requireCoordinator64DMado.getLastShape();
                lastClip = nodeCoordinatorM8436requireCoordinator64DMado.getLastClip();
            }
            if (lastClip) {
