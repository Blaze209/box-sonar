...
public final class TileMode {
    ...
    private static final int Clamp = m7205constructorimpl(0);
    private static final int Repeated = m7205constructorimpl(1);
    private static final int Mirror = m7205constructorimpl(2);
    private static final int Decal = m7205constructorimpl(3);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TileMode m7204boximpl(int i) {
        return new TileMode(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m7205constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object other) {
        return m7206equalsimpl(this.value, other);
    }
    ...
    public static String m7209toStringimpl(int i) {
        if (m7207equalsimpl0(i, Clamp)) {
            return "Clamp";
        }
        if (m7207equalsimpl0(i, Repeated)) {
            return "Repeated";
        }
        if (m7207equalsimpl0(i, Mirror)) {
            return "Mirror";
        }
        return m7207equalsimpl0(i, Decal) ? "Decal" : "Unknown";
    }
}
