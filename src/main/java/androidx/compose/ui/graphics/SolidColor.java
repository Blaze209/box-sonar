...
public final class SolidColor extends Brush implements Interpolatable {
    ...
    public void mo6759applyToPq9zytI(long size, Paint p, float alpha) {
        long jM6813copywmQWz5c$default;
        p.setAlpha(1.0f);
        if (alpha != 1.0f) {
            long j = this.value;
            jM6813copywmQWz5c$default = Color.m6813copywmQWz5c$default(j, Color.m6816getAlphaimpl(j) * alpha, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            jM6813copywmQWz5c$default = this.value;
        }
        p.mo6690setColor8_81llA(jM6813copywmQWz5c$default);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m6815equalsimpl0(this.value, ((SolidColor) other).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m6822toStringimpl(this.value)) + ')';
    }
    ...
    public Object lerp(Object other, float t) {
        ...
        if (other instanceof SolidColor) {
            return new SolidColor(ColorKt.m6865lerpjxsXWHM(this.value, ((SolidColor) other).value, t), defaultConstructorMarker);
        }
        return null;
    }
}
