...
public class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m6855tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.INSTANCE.m6752getSrcIn0nO6VwU();
            }
            return companion.m6858tintxETnrds(j, i);
        }

        /* JADX INFO: renamed from: tint-xETnrds, reason: not valid java name */
        public final ColorFilter m6858tintxETnrds(long color, int blendMode) {
        ...
        public final ColorFilter m6856colorMatrixjHGOpc(float[] colorMatrix) {
        ...
        public final ColorFilter m6857lightingOWjLjI(long multiply, long add) {
