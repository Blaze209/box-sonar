...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m6905getAutoNrFUSI();
    private long size = Size.INSTANCE.m6646getUnspecifiedNHjbRc();
    ...
    public void mo7013setAmbientShadowColor8_81llA(long j) {
        if (Color.m6815equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public void mo7016setSpotShadowColor8_81llA(long j) {
        if (Color.m6815equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public void mo7017setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m7223equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public void mo7015setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m6901equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public void m7144setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public void mo7014setBlendModes9anfk8(int i) {
    ...
    public final void reset() {
        ...
        mo7013setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo7016setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo7017setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m7229getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        setColorFilter(null);
        mo7014setBlendModes9anfk8(BlendMode.INSTANCE.m6754getSrcOver0nO6VwU());
        mo7015setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m6905getAutoNrFUSI());
        m7144setSizeuvyYCjk(Size.INSTANCE.m6646getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui() {
        this.outline = getShape().mo655createOutlinePq9zytI(getSize(), this.layoutDirection, this.graphicsDensity);
    }
}
