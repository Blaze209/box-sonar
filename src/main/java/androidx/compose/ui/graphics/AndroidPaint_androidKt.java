...
public final class AndroidPaint_androidKt {
    ...
    public static final void m6695setNativeBlendModeGB0RdKg(android.graphics.Paint paint, int i) {
        WrapperVerificationHelperMethods.INSTANCE.m7242setBlendModeGB0RdKg(paint, i);
    }
    ...
    public static final void m6696setNativeColor4WTKRHQ(android.graphics.Paint paint, long j) {
        paint.setColor(ColorKt.m6868toArgb8_81llA(j));
    }

    /* JADX INFO: renamed from: setNativeStyle--5YerkU, reason: not valid java name */
    public static final void m6700setNativeStyle5YerkU(android.graphics.Paint paint, int i) {
        paint.setStyle(PaintingStyle.m7093equalsimpl0(i, PaintingStyle.INSTANCE.m7098getStrokeTiuSbCo()) ? android.graphics.Paint.Style.STROKE : android.graphics.Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint paint) {
        ...
        if ((style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1) {
            return PaintingStyle.INSTANCE.m7098getStrokeTiuSbCo();
        }
        return PaintingStyle.INSTANCE.m7097getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(android.graphics.Paint paint) {
        ...
        if (i == 3) {
            return StrokeCap.INSTANCE.m7192getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m7190getButtKaPHkGw();
    }

    /* JADX INFO: renamed from: setNativeStrokeCap-CSYIeUk, reason: not valid java name */
    public static final void m6698setNativeStrokeCapCSYIeUk(android.graphics.Paint paint, int i) {
        android.graphics.Paint.Cap cap;
        if (StrokeCap.m7186equalsimpl0(i, StrokeCap.INSTANCE.m7192getSquareKaPHkGw())) {
            cap = android.graphics.Paint.Cap.SQUARE;
        } else if (StrokeCap.m7186equalsimpl0(i, StrokeCap.INSTANCE.m7191getRoundKaPHkGw())) {
            cap = android.graphics.Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m7186equalsimpl0(i, StrokeCap.INSTANCE.m7190getButtKaPHkGw()) ? android.graphics.Paint.Cap.BUTT : android.graphics.Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(android.graphics.Paint paint) {
        ...
        if (i == 2) {
            return StrokeJoin.INSTANCE.m7200getBevelLxFBmk8();
        }
        if (i == 3) {
    ...
    public static final void m6699setNativeStrokeJoinkLtJ_vA(android.graphics.Paint paint, int i) {
        ...
        } else if (StrokeJoin.m7196equalsimpl0(i, StrokeJoin.INSTANCE.m7200getBevelLxFBmk8())) {
            join = android.graphics.Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m7196equalsimpl0(i, StrokeJoin.INSTANCE.m7202getRoundLxFBmk8()) ? android.graphics.Paint.Join.ROUND : android.graphics.Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint paint) {
        if (!paint.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m6918getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m6916getLowfv9h1I();
    }

    /* JADX INFO: renamed from: setNativeFilterQuality-50PEsBU, reason: not valid java name */
    public static final void m6697setNativeFilterQuality50PEsBU(android.graphics.Paint paint, int i) {
        paint.setFilterBitmap(!FilterQuality.m6911equalsimpl0(i, FilterQuality.INSTANCE.m6918getNonefv9h1I()));
    }
