...
public final class VertexMode {
    ...
    private static final int Triangles = m7232constructorimpl(0);
    private static final int TriangleStrip = m7232constructorimpl(1);
    private static final int TriangleFan = m7232constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ VertexMode m7231boximpl(int i) {
        return new VertexMode(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m7232constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m7233equalsimpl(int i, Object obj) {
        return (obj instanceof VertexMode) && i == ((VertexMode) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m7234equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m7235hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object other) {
        return m7233equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m7235hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m7240getTrianglesc2xauaI() {
            return VertexMode.Triangles;
        }

        /* JADX INFO: renamed from: getTriangleStrip-c2xauaI, reason: not valid java name */
        public final int m7239getTriangleStripc2xauaI() {
            return VertexMode.TriangleStrip;
        }

        /* JADX INFO: renamed from: getTriangleFan-c2xauaI, reason: not valid java name */
        public final int m7238getTriangleFanc2xauaI() {
            return VertexMode.TriangleFan;
        }
    }

    public String toString() {
        return m7236toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m7236toStringimpl(int i) {
        if (m7234equalsimpl0(i, Triangles)) {
            return "Triangles";
        }
        if (m7234equalsimpl0(i, TriangleStrip)) {
            return "TriangleStrip";
        }
        return m7234equalsimpl0(i, TriangleFan) ? "TriangleFan" : "Unknown";
    }
}
