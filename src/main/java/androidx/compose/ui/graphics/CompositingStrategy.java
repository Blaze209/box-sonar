...
public final class CompositingStrategy {
    ...
    private static final int Auto = m6899constructorimpl(0);
    private static final int Offscreen = m6899constructorimpl(1);
    private static final int ModulateAlpha = m6899constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ CompositingStrategy m6898boximpl(int i) {
        return new CompositingStrategy(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m6899constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m6900equalsimpl(int i, Object obj) {
        return (obj instanceof CompositingStrategy) && i == ((CompositingStrategy) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6901equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m6902hashCodeimpl(int i) {
    ...
    public boolean equals(Object other) {
        return m6900equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m6902hashCodeimpl(this.value);
    }
