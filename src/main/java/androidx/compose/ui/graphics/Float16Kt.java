...
public final class Float16Kt {
    ...
    public static final short m6963minAoSsdG0(short s, short s2) {
        if (Float16.m6935isNaNimpl(s) || Float16.m6935isNaNimpl(s2)) {
            return Float16.Companion.m6957getNaNslo4al4();
        }
        return Float16.m6922compareTo41bOqos(s, s2) <= 0 ? s : s2;
    }

    /* JADX INFO: renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m6962maxAoSsdG0(short s, short s2) {
        if (Float16.m6935isNaNimpl(s) || Float16.m6935isNaNimpl(s2)) {
            return Float16.Companion.m6957getNaNslo4al4();
        }
        return Float16.m6922compareTo41bOqos(s, s2) >= 0 ? s : s2;
