...
public final class AndroidExternalSurfaceZOrder {
    ...
    private static final int Behind = m571constructorimpl(0);
    private static final int MediaOverlay = m571constructorimpl(1);
    private static final int OnTop = m571constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ AndroidExternalSurfaceZOrder m570boximpl(int i) {
        return new AndroidExternalSurfaceZOrder(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m571constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m572equalsimpl(int i, Object obj) {
        return (obj instanceof AndroidExternalSurfaceZOrder) && i == ((AndroidExternalSurfaceZOrder) obj).m576unboximpl();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m573equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m574hashCodeimpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m572equalsimpl(this.zOrder, obj);
    }

    public int hashCode() {
        return m574hashCodeimpl(this.zOrder);
    }

    public String toString() {
        return m575toStringimpl(this.zOrder);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ int m576unboximpl() {
        return this.zOrder;
    }
