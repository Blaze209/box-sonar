...
public abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode, SemanticsModifierNode, TraversableNode, CompositionLocalConsumerModifierNode, ObserverModifierNode, IndirectPointerInputModifierNode {
    ...
    protected abstract boolean mo553onClickKeyDownEventZmokQxo(KeyEvent event);

    /* JADX INFO: renamed from: onClickKeyUpEvent-ZmokQxo, reason: not valid java name */
    protected abstract boolean mo554onClickKeyUpEventZmokQxo(KeyEvent event);

    @Override // androidx.compose.ui.input.key.KeyInputModifierNode
    /* JADX INFO: renamed from: onPreKeyEvent-ZmokQxo, reason: not valid java name */
    public final boolean mo557onPreKeyEventZmokQxo(KeyEvent event) {
        return false;
    }
    ...
    private AbstractClickableNode(MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z, boolean z2, String str, Role role, Function0<Unit> function0) {
        ...
        this.focusableNode = new FocusableNode(this.interactionSource, Focusability.INSTANCE.m6505getSystemDefinedLCbbffg(), new AbstractClickableNode$focusableNode$1(this), null);
        this.currentKeyPressInteractions = LongObjectMapKt.mutableLongObjectMapOf();
        this.centerOffset = Offset.INSTANCE.m6585getZeroF1C5BW0();
    ...
    protected final void m558updateCommonO2vRcR0(MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean useLocalIndication, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
        boolean z;
        boolean z2;
    ...
    /* JADX WARN: Code duplicated, block: B:26:0x007b A[LOOP:0: B:16:0x003d->B:26:0x007b, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:30:0x007e A[EDGE_INSN: B:30:0x007e->B:27:0x007e BREAK  A[LOOP:0: B:16:0x003d->B:26:0x007b], SYNTHETIC] */
    ...
    /* JADX WARN: Code duplicated, block: B:21:0x0066 A[LOOP:0: B:11:0x001c->B:21:0x0066, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:28:0x0069 A[EDGE_INSN: B:28:0x0069->B:22:0x0069 BREAK  A[LOOP:0: B:11:0x001c->B:21:0x0066], SYNTHETIC] */
    ...
    public void mo556onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        long jM9864getCenterozmzZPI = IntSizeKt.m9864getCenterozmzZPI(bounds);
        this.centerOffset = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(IntOffset.m9815getXimpl(jM9864getCenterozmzZPI))) << 32) | (((long) Float.floatToRawIntBits(IntOffset.m9816getYimpl(jM9864getCenterozmzZPI))) & 4294967295L));
        initializeIndicationAndInteractionSourceIfNeeded();
        if (this.enabled && pass == PointerEventPass.Main) {
            int type = pointerEvent.getType();
            if (PointerEventType.m8083equalsimpl0(type, PointerEventType.INSTANCE.m8087getEnter7fucELk())) {
            ...
            } else if (PointerEventType.m8083equalsimpl0(type, PointerEventType.INSTANCE.m8088getExit7fucELk())) {
    ...
    public final boolean mo555onKeyEventZmokQxo(KeyEvent event) {
        boolean z;
        initializeIndicationAndInteractionSourceIfNeeded();
        long jM7977getKeyZmokQxo = KeyEvent_androidKt.m7977getKeyZmokQxo(event);
        if (this.enabled && ClickableKt.m645isPressZmokQxo(event)) {
            if (this.currentKeyPressInteractions.containsKey(jM7977getKeyZmokQxo)) {
                z = false;
            } else {
                PressInteraction.Press press = new PressInteraction.Press(this.centerOffset, null);
                this.currentKeyPressInteractions.set(jM7977getKeyZmokQxo, press);
                if (this.interactionSource != null) {
            ...
            return mo553onClickKeyDownEventZmokQxo(event) || z;
        }
        if (this.enabled && ClickableKt.m643isClickZmokQxo(event)) {
            PressInteraction.Press pressRemove = this.currentKeyPressInteractions.remove(jM7977getKeyZmokQxo);
            if (pressRemove != null) {
                if (this.interactionSource != null) {
                ...
                mo554onClickKeyUpEventZmokQxo(event);
            }
            if (pressRemove != null) {
                return true;
            }
    ...
    public final void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        if (role != null) {
            ...
            SemanticsPropertiesKt.m8851setRolekuIjeqM(semanticsPropertyReceiver, role.getValue());
        }
    ...
    protected final void m552handlePressInteractionStart3MmeM6k(long offset, boolean indirectPointer) {
        MutableInteractionSource mutableInteractionSource = this.interactionSource;
        if (mutableInteractionSource != null) {
    ...
    protected final void m551handlePressInteractionRelease3MmeM6k(long offset, boolean indirectPointer) {
        MutableInteractionSource mutableInteractionSource = this.interactionSource;
        if (mutableInteractionSource != null) {
    ...
    protected final Object m550handlePressInteractiond4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
            ...
            if (pass == PointerEventPass.Main) {
                ...
                if (indirectPointerInputChange == null) {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        if (ClickableKt.changedToDownIgnoreConsumed(changes.get(i2))) {
                            ...
                            this.node.m552handlePressInteractionStart3MmeM6k(indirectPointerInputChange2.getPosition(), true);
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    if (ClickableKt.isMovingIgnoreConsumed(changes2.get(i3))) {
                        if (Math.abs(Offset.m6567getDistanceimpl(Offset.m6573minusMKHz9U(pointerEvent.getChanges().get(0).getPosition(), indirectPointerInputChange.getPosition()))) > ((ViewConfiguration) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.node, CompositionLocalsKt.getLocalViewConfiguration())).getTouchSlop()) {
                            resetDetector();
                            return;
                        }
                        return;
                ...
                for (int i4 = 0; i4 < size3; i4++) {
                    if (!ClickableKt.changedToUp(changes3.get(i4))) {
                ...
                this.node.m551handlePressInteractionRelease3MmeM6k(indirectPointerInputChange.getPosition(), true);
                onClick.invoke();
                this.downEvent = null;
                return;
            }
