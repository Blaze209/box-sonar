...
public final class ScrollNode extends Modifier.Node implements LayoutModifierNode, SemanticsModifierNode {
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(Constraints.m9630copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m9640getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m9639getMaxHeightimpl(j), 5, null));
        int iCoerceAtMost = RangesKt.coerceAtMost(placeableMo8265measureBRTryo0.getWidth(), Constraints.m9640getMaxWidthimpl(j));
        int iCoerceAtMost2 = RangesKt.coerceAtMost(placeableMo8265measureBRTryo0.getHeight(), Constraints.m9639getMaxHeightimpl(j));
        final int height = placeableMo8265measureBRTryo0.getHeight() - iCoerceAtMost2;
        int width = placeableMo8265measureBRTryo0.getWidth() - iCoerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
        ...
        this.state.setContentSize$foundation(this.isVertical ? placeableMo8265measureBRTryo0.getHeight() : placeableMo8265measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measureScope, iCoerceAtMost, iCoerceAtMost2, null, new Function1() { // from class: androidx.compose.foundation.ScrollNode$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return ScrollNode.measure_3p2s80s$lambda$0(this.f$0, height, placeableMo8265measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
