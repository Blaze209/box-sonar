...
final class HoverableNode extends Modifier.Node implements PointerInputModifierNode {
    ...
    public final Object emitExit(Continuation<? super Unit> continuation) {
        C05981 c05981;
        if (continuation instanceof C05981) {
            c05981 = (C05981) continuation;
            if ((c05981.label & Integer.MIN_VALUE) != 0) {
                c05981.label -= Integer.MIN_VALUE;
            } else {
                c05981 = new C05981(continuation);
            }
        } else {
            c05981 = new C05981(continuation);
        }
        Object obj = c05981.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c05981.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            if (enter != null) {
                ...
                c05981.label = 1;
                if (this.interactionSource.emit(exit, c05981) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
