...
public final class ContextMenuSpec {
    ...
    private static final float ContainerWidthMin = Dp.m9687constructorimpl(112);
    private static final float ContainerWidthMax = Dp.m9687constructorimpl(280);
    private static final float ListItemHeight = Dp.m9687constructorimpl(48);
    private static final float MenuContainerElevation = Dp.m9687constructorimpl(3);
    private static final float CornerRadius = Dp.m9687constructorimpl(4);
    private static final Alignment.Vertical LabelVerticalTextAlignment = Alignment.INSTANCE.getCenterVertically();
    private static final int LabelHorizontalTextAlignment = TextAlign.INSTANCE.m9531getStarte0LSkKk();
    private static final float HorizontalPadding = Dp.m9687constructorimpl(12);
    private static final float IconSize = Dp.m9687constructorimpl(24);
    private static final float DividerHeight = Dp.m9687constructorimpl(1);
    ...
    static {
        float f = 8;
        VerticalPadding = Dp.m9687constructorimpl(f);
        DividerVerticalPadding = Dp.m9687constructorimpl(f);
    }
}
