...
public final class ComposableSingletons$ContextMenuUiKt {
    ...
    public final Function3<ContextMenuColors, Composer, Integer, Unit> m710getLambda$1455401925$foundation() {
        return f6lambda$1455401925;
    }

    /* JADX INFO: renamed from: getLambda$-1571120048$foundation, reason: not valid java name */
    public final Function8<Modifier, String, Boolean, ContextMenuColors, Function3<? super Color, ? super Composer, ? super Integer, Unit>, Function0<Unit>, Composer, Integer, Unit> m711getLambda$1571120048$foundation() {
    ...
    public static final Unit lambda__1455401925$lambda$0(ContextMenuColors contextMenuColors, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 19) != 18, i & 1)) {
            ...
            BoxKt.Box(BackgroundKt.m589backgroundbw27NRU$default(SizeKt.m1252height3ABfNKs(SizeKt.fillMaxWidth$default(PaddingKt.m1220paddingVpY3zN4$default(Modifier.INSTANCE, 0.0f, ContextMenuSpec.INSTANCE.m723getDividerVerticalPaddingD9Ej5fM(), 1, null), 0.0f, 1, null), ContextMenuSpec.INSTANCE.m722getDividerHeightD9Ej5fM()), contextMenuColors.getIconColor(), null, 2, null), composer, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
