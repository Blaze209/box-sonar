...
public final class ContextMenuUi_androidKt {
    ...
    public static final ContextMenuColors computeContextMenuColors(int i, int i2, Composer composer, int i3) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            long jM740resolveColorg2O1Hgs = m740resolveColorg2O1Hgs(context, i, R.attr.colorBackground, ContextMenuUiKt.getDefaultContextMenuColors().getBackgroundColor());
            ColorStateList colorStateListResolveColorStateList = resolveColorStateList(context, i2, R.attr.textColorPrimary);
            long jM739enabledColor4WTKRHQ = m739enabledColor4WTKRHQ(colorStateListResolveColorStateList, ContextMenuUiKt.getDefaultContextMenuColors().getTextColor());
            long jM738disabledColor4WTKRHQ = m738disabledColor4WTKRHQ(colorStateListResolveColorStateList, ContextMenuUiKt.getDefaultContextMenuColors().getDisabledTextColor());
            Object contextMenuColors = new ContextMenuColors(jM740resolveColorg2O1Hgs, jM739enabledColor4WTKRHQ, jM739enabledColor4WTKRHQ, jM738disabledColor4WTKRHQ, jM738disabledColor4WTKRHQ, null);
    ...
    private static final long m740resolveColorg2O1Hgs(Context context, int i, int i2, long j) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(i, new int[]{i2});
        int iM6868toArgb8_81llA = ColorKt.m6868toArgb8_81llA(j);
        int color = typedArrayObtainStyledAttributes.getColor(0, iM6868toArgb8_81llA);
        typedArrayObtainStyledAttributes.recycle();
        return color == iM6868toArgb8_81llA ? j : ColorKt.Color(color);
    }
    ...
    private static final long m739enabledColor4WTKRHQ(ColorStateList colorStateList, long j) {
        int iM6868toArgb8_81llA = ColorKt.m6868toArgb8_81llA(j);
        Integer numValueOf = colorStateList != null ? Integer.valueOf(colorStateList.getColorForState(new int[]{R.attr.state_enabled}, iM6868toArgb8_81llA)) : null;
        return (numValueOf == null || numValueOf.intValue() == iM6868toArgb8_81llA) ? j : ColorKt.Color(numValueOf.intValue());
    }

    /* JADX INFO: renamed from: disabledColor-4WTKRHQ, reason: not valid java name */
    private static final long m738disabledColor4WTKRHQ(ColorStateList colorStateList, long j) {
        int iM6868toArgb8_81llA = ColorKt.m6868toArgb8_81llA(j);
        Integer numValueOf = colorStateList != null ? Integer.valueOf(colorStateList.getColorForState(new int[]{-16842910}, iM6868toArgb8_81llA)) : null;
        return (numValueOf == null || numValueOf.intValue() == iM6868toArgb8_81llA) ? j : ColorKt.Color(numValueOf.intValue());
    }
}
