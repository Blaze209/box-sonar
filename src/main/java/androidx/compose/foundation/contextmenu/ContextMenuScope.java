...
public final class ContextMenuScope {
    ...
    public final void separator() {
        this.composables.add(ComposableSingletons$ContextMenuUiKt.INSTANCE.m710getLambda$1455401925$foundation());
    }
}
