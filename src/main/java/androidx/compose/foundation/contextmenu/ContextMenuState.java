...
public final class ContextMenuState {
    ...
    public static abstract class Status {
        ...
        public static final class Open extends Status {
            ...
            public String toString() {
                return "Open(offset=" + ((Object) Offset.m6577toStringimpl(this.offset)) + ')';
            }

            public int hashCode() {
                return Offset.m6571hashCodeimpl(this.offset);
            }
            ...
            public boolean equals(Object other) {
                ...
                if (other instanceof Open) {
                    return Offset.m6566equalsimpl0(this.offset, ((Open) other).offset);
                }
                return false;
            }
        }
