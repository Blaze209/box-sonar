...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    private ContextMenuPopupPositionProvider(final long j, Function2<? super IntOffset, ? super IntRect, Unit> function2) {
        this((Function0<IntOffset>) new Function0() { // from class: androidx.compose.foundation.contextmenu.ContextMenuPopupPositionProvider$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                return IntOffset.m9806boximpl(j);
            }
        }, function2);
    }
    ...
    public long mo718calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long jM9824unboximpl = this.anchorPositionBlock.invoke().m9824unboximpl();
        long jM9809constructorimpl = IntOffset.m9809constructorimpl((((long) ContextMenuPopupPositionProviderKt.alignPopupAxis(anchorBounds.getLeft() + IntOffset.m9815getXimpl(jM9824unboximpl), (int) (popupContentSize >> 32), (int) (windowSize >> 32), layoutDirection == LayoutDirection.Ltr)) << 32) | (4294967295L & ((long) ContextMenuPopupPositionProviderKt.alignPopupAxis$default(anchorBounds.getTop() + IntOffset.m9816getYimpl(jM9824unboximpl), (int) (popupContentSize & 4294967295L), (int) (windowSize & 4294967295L), false, 8, null))));
        Function2<IntOffset, IntRect, Unit> function2 = this.onPositionCalculated;
        if (function2 != null) {
            function2.invoke(IntOffset.m9806boximpl(jM9824unboximpl), IntRectKt.m9848IntRectVbeCjmY(jM9809constructorimpl, popupContentSize));
        }
