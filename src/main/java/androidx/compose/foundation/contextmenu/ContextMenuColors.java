...
public final class ContextMenuColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.backgroundColor, contextMenuColors.backgroundColor) && Color.m6815equalsimpl0(this.textColor, contextMenuColors.textColor) && Color.m6815equalsimpl0(this.iconColor, contextMenuColors.iconColor) && Color.m6815equalsimpl0(this.disabledTextColor, contextMenuColors.disabledTextColor) && Color.m6815equalsimpl0(this.disabledIconColor, contextMenuColors.disabledIconColor);
    }

    public int hashCode() {
        return (((((((Color.m6821hashCodeimpl(this.backgroundColor) * 31) + Color.m6821hashCodeimpl(this.textColor)) * 31) + Color.m6821hashCodeimpl(this.iconColor)) * 31) + Color.m6821hashCodeimpl(this.disabledTextColor)) * 31) + Color.m6821hashCodeimpl(this.disabledIconColor);
    }

    public String toString() {
        return "ContextMenuColors(backgroundColor=" + ((Object) Color.m6822toStringimpl(this.backgroundColor)) + ", textColor=" + ((Object) Color.m6822toStringimpl(this.textColor)) + ", iconColor=" + ((Object) Color.m6822toStringimpl(this.iconColor)) + ", disabledTextColor=" + ((Object) Color.m6822toStringimpl(this.disabledTextColor)) + ", disabledIconColor=" + ((Object) Color.m6822toStringimpl(this.disabledIconColor)) + ')';
    }
}
