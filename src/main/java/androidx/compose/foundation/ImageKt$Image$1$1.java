...
final class ImageKt$Image$1$1 implements MeasurePolicy {
    ...
    public final MeasureResult mo344measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m9642getMinWidthimpl(j), Constraints.m9641getMinHeightimpl(j), null, new Function1() { // from class: androidx.compose.foundation.ImageKt$Image$1$1$$ExternalSyntheticLambda0
