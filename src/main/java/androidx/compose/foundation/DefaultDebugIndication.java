...
final class DefaultDebugIndication implements IndicationNodeFactory {
    ...
    static final class DefaultDebugIndicationInstance extends Modifier.Node implements DrawModifierNode {
        ...
        public void draw(ContentDrawScope contentDrawScope) {
            ...
            if (this.isPressed) {
                DrawScope.m7389drawRectnJ9OG0$default(contentDrawScope, Color.m6813copywmQWz5c$default(Color.INSTANCE.m6840getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo7395getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            } else if (this.isHovered || this.isFocused) {
                DrawScope.m7389drawRectnJ9OG0$default(contentDrawScope, Color.m6813copywmQWz5c$default(Color.INSTANCE.m6840getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo7395getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            }
        }
    }
}
