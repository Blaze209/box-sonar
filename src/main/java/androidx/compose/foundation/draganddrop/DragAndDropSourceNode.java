...
public final class DragAndDropSourceNode extends DelegatingNode implements LayoutAwareModifierNode {
    ...
    public static final Unit dragAndDropModifierNode$lambda$0(DragAndDropSourceNode dragAndDropSourceNode, DragAndDropStartTransferScope dragAndDropStartTransferScope, Offset offset) {
        ...
        if (dragAndDropTransferDataInvoke != null) {
            dragAndDropStartTransferScope.mo6319startDragAndDropTransfer12SF9DM(dragAndDropTransferDataInvoke, IntSizeKt.m9870toSizeozmzZPI(dragAndDropSourceNode.size), dragAndDropSourceNode.drawDragDecoration);
        }
            ...
            this.inputModifierNode = (PointerInputModifierNode) delegate(SuspendingPointerInputFilterKt.SuspendingPointerInputModifierNode(new PointerInputEventHandler() { // from class: androidx.compose.foundation.draganddrop.DragAndDropSourceNode.onAttach.1
                ...
                public static final class C00131 implements DragAndDropStartDetectorScope, PointerInputScope {
                    ...
                    public long mo744getExtendedTouchPaddingNHjbRc() {
                        return this.$$delegate_0.mo744getExtendedTouchPaddingNHjbRc();
                    }
                    ...
                    public void mo746requestDragAndDropTransferk4lQ0M(long offset) {
                        this.this$0.dragAndDropModifierNode.mo6322requestDragAndDropTransferk4lQ0M(offset);
                    }
                }
    ...
    public void mo743onRemeasuredozmzZPI(long size) {
        this.size = size;
        this.dragAndDropModifierNode.mo743onRemeasuredozmzZPI(size);
    }
}
