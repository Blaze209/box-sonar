...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, SemanticsModifierNode {
    ...
    private BackgroundNode(long j, Brush brush, float f, Shape shape) {
        ...
        this.alpha = f;
        this.shape = shape;
        this.lastSize = Size.INSTANCE.m6646getUnspecifiedNHjbRc();
    }
    ...
    public final void m591setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m6815equalsimpl0(this.color, Color.INSTANCE.m6850getUnspecified0d7_KjU())) {
            DrawScope.m7389drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.m7388drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }
    ...
    private final void drawOutline(ContentDrawScope contentDrawScope) {
        ...
        if (!Color.m6815equalsimpl0(this.color, Color.INSTANCE.m6850getUnspecified0d7_KjU())) {
            OutlineKt.m7089drawOutlinewDX37Ww$default(contentDrawScope, outline, this.color, 0.0f, null, null, 0, 60, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m7087drawOutlinehn5TExg$default(contentDrawScope, outline, brush, this.alpha, null, null, 0, 56, null);
        }
    }

    private final Outline getOutline(final ContentDrawScope contentDrawScope) {
        Outline outline;
        if (Size.m6634equalsimpl0(contentDrawScope.mo7395getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
        ...
        this.lastSize = contentDrawScope.mo7395getSizeNHjbRc();
    ...
    public static final Unit getOutline$lambda$0(BackgroundNode backgroundNode, ContentDrawScope contentDrawScope) {
        backgroundNode.tmpOutline = backgroundNode.shape.mo655createOutlinePq9zytI(contentDrawScope.mo7395getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
