...
public final class RoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo1556createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        long jM6523constructorimpl2 = CornerRadius.m6523constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (((long) Float.floatToRawIntBits(f2)) << 32));
        float f3 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        long jM6523constructorimpl3 = CornerRadius.m6523constructorimpl((((long) Float.floatToRawIntBits(f3)) << 32) | (((long) Float.floatToRawIntBits(f3)) & 4294967295L));
        float f4 = layoutDirection == LayoutDirection.Ltr ? bottomStart : bottomEnd;
        return new Outline.Rounded(RoundRectKt.m6621RoundRectZAM2FJo(rectM6659toRectuvyYCjk, jM6523constructorimpl, jM6523constructorimpl2, jM6523constructorimpl3, CornerRadius.m6523constructorimpl((4294967295L & ((long) Float.floatToRawIntBits(f4))) | (((long) Float.floatToRawIntBits(f4)) << 32))));
    }
