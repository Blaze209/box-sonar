...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo1556createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        if (topStart + topEnd + bottomEnd + bottomStart == 0.0f) {
            return new Outline.Rectangle(SizeKt.m6659toRectuvyYCjk(size));
        }
        return new Outline.Rounded(RoundRectKt.m6621RoundRectZAM2FJo(SizeKt.m6659toRectuvyYCjk(size), CornerRadius.m6523constructorimpl((((long) Float.floatToRawIntBits(topStart)) << 32) | (((long) Float.floatToRawIntBits(topStart)) & 4294967295L)), CornerRadius.m6523constructorimpl((((long) Float.floatToRawIntBits(topEnd)) << 32) | (((long) Float.floatToRawIntBits(topEnd)) & 4294967295L)), CornerRadius.m6523constructorimpl((((long) Float.floatToRawIntBits(bottomEnd)) << 32) | (((long) Float.floatToRawIntBits(bottomEnd)) & 4294967295L)), CornerRadius.m6523constructorimpl((((long) Float.floatToRawIntBits(bottomStart)) & 4294967295L) | (Float.floatToRawIntBits(bottomStart) << 32))));
    }
    ...
    private final long m1560toRadiusBz7bX_o(float f) {
        return CornerRadius.m6523constructorimpl((((long) Float.floatToRawIntBits(f)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
}
