...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte != 1) {
                if (bDecodeByte != 2) {
                    if (bDecodeByte != 3) {
                        if (bDecodeByte != 4) {
                            if (bDecodeByte != 5) {
                                        ...
                                        if (bDecodeByte != 8) {
                                            if (bDecodeByte != 9) {
                                                if (bDecodeByte != 10) {
                                                    ...
                                                    mutableSpanStyle.m1029setBackground8_81llA(m1012decodeColor0d7_KjU());
                                                }
                                            } else {
                                                if (dataAvailable() < 8) {
                                                    break;
                                            ...
                                            mutableSpanStyle.m1030setBaselineShift_isdbwI(BaselineShift.m9388boximpl(m1010decodeBaselineShifty9eOQZs()));
                                        }
                                    } else {
                                        if (dataAvailable() < 5) {
                                            break;
                                        }
                                        mutableSpanStyle.m1035setLetterSpacingR2X_6o(m1015decodeTextUnitXSAIIZE());
                                    }
                                } else {
                                ...
                                mutableSpanStyle.m1034setFontSynthesistDdu0R4(FontSynthesis.m9213boximpl(m1014decodeFontSynthesisGVVA2EU()));
                            }
                        } else {
                            if (dataAvailable() < 1) {
                                break;
                            }
                            mutableSpanStyle.m1033setFontStylemLjRB2g(FontStyle.m9202boximpl(m1013decodeFontStyle_LCdwA()));
                        }
                    } else {
                        if (dataAvailable() < 4) {
                            break;
                    ...
                    mutableSpanStyle.m1032setFontSizeR2X_6o(m1015decodeTextUnitXSAIIZE());
                }
            } else {
                if (dataAvailable() < 8) {
                    break;
                }
                mutableSpanStyle.m1031setColor8_81llA(m1012decodeColor0d7_KjU());
            }
        }
    ...
    public final long m1012decodeColor0d7_KjU() {
    ...
    public final long m1015decodeTextUnitXSAIIZE() {
    ...
    public final int m1013decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
    ...
    public final int m1014decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
    ...
    private final float m1010decodeBaselineShifty9eOQZs() {
    ...
    private final Shadow decodeShadow() {
        long jM1012decodeColor0d7_KjU = m1012decodeColor0d7_KjU();
        float fDecodeFloat = decodeFloat();
        return new Shadow(jM1012decodeColor0d7_KjU, Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(decodeFloat())) & 4294967295L) | (Float.floatToRawIntBits(fDecodeFloat) << 32)), decodeFloat(), null);
    }
    ...
    private final long m1011decodeULongsVKNKU() {
