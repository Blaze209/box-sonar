...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final long m1384childConstraintsJhjzzOo$foundation(int startSlot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m9652fixedWidthOenEA2s(iCoerceAtLeast);
        }
        return Constraints.INSTANCE.m9651fixedHeightOenEA2s(iCoerceAtLeast);
    }
    ...
    public final LazyGridMeasuredLine getAndMeasure(int lineIndex) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            int iM1357getCurrentLineSpanimpl = GridItemSpan.m1357getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i3).getPackedValue());
            LazyGridMeasuredItem lazyGridMeasuredItemM1383getAndMeasurem8Kt_7k = this.measuredItemProvider.m1383getAndMeasurem8Kt_7k(lineConfiguration.getFirstItemIndex() + i3, m1384childConstraintsJhjzzOo$foundation(i2, iM1357getCurrentLineSpanimpl), i2, iM1357getCurrentLineSpanimpl, i);
            i2 += iM1357getCurrentLineSpanimpl;
            Unit unit = Unit.INSTANCE;
            lazyGridMeasuredItemArr[i3] = lazyGridMeasuredItemM1383getAndMeasurem8Kt_7k;
        }
