...
public abstract class LazyGridMeasuredItemProvider extends LazyLayoutMeasuredItemProvider<LazyGridMeasuredItem> {
    ...
    public abstract LazyGridMeasuredItem mo1376createItemO3s9Psw(int index, Object key, Object contentType, int crossAxisSize, int mainAxisSpacing, List<? extends Placeable> placeables, long constraints, int lane, int span);
    ...
    public LazyGridMeasuredItem mo1346getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return m1383getAndMeasurem8Kt_7k(index, constraints, lane, span, this.defaultMainAxisSpacing);
    }

    /* JADX INFO: renamed from: getAndMeasure-m8Kt_7k, reason: not valid java name */
    public final LazyGridMeasuredItem m1383getAndMeasurem8Kt_7k(int index, long constraints, int lane, int span, int mainAxisSpacing) {
        ...
        List<Placeable> list = m1423getPlaceables3p2s80s(this.measureScope, index, constraints);
        if (Constraints.m9638getHasFixedWidthimpl(constraints)) {
            iM9641getMinHeightimpl = Constraints.m9642getMinWidthimpl(constraints);
        } else {
        ...
        return mo1376createItemO3s9Psw(index, key, contentType, iM9641getMinHeightimpl, mainAxisSpacing, list, constraints, lane, span);
    }
