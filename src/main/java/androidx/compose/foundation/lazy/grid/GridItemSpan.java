...
public final class GridItemSpan {
    ...
    public static final /* synthetic */ GridItemSpan m1353boximpl(long j) {
        return new GridItemSpan(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m1354constructorimpl(long j) {
        return j;
    }
    ...
    public static final int m1357getCurrentLineSpanimpl(long j) {
        return (int) j;
    }
    ...
    public boolean equals(Object other) {
        return m1355equalsimpl(this.packedValue, other);
    }

    public int hashCode() {
        return m1358hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m1359toStringimpl(this.packedValue);
    }
