...
public final class LazyGridLayoutInfoKt {
    ...
    public static final int getSingleAxisViewportSize(LazyGridLayoutInfo lazyGridLayoutInfo) {
        return (int) (lazyGridLayoutInfo.getOrientation() == Orientation.Vertical ? lazyGridLayoutInfo.mo1377getViewportSizeYbymL2g() & 4294967295L : lazyGridLayoutInfo.mo1377getViewportSizeYbymL2g() >> 32);
    }
