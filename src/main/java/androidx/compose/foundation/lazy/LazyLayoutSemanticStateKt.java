    ...
    public static final class AnonymousClass1 implements LazyLayoutSemanticState {
        ...
        public int getViewport() {
            ...
            if (this.$state.getLayoutInfo().getOrientation() == Orientation.Vertical) {
                jMo1336getViewportSizeYbymL2g = this.$state.getLayoutInfo().mo1336getViewportSizeYbymL2g() & 4294967295L;
            } else {
                jMo1336getViewportSizeYbymL2g = this.$state.getLayoutInfo().mo1336getViewportSizeYbymL2g() >> 32;
            }
