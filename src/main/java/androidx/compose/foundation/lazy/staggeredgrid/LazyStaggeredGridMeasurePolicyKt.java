    ...
    public static final LazyLayoutMeasurePolicy m1481rememberStaggeredGridMeasurePolicyqKj4JfE(final LazyStaggeredGridState lazyStaggeredGridState, final Function0<? extends LazyStaggeredGridItemProvider> function0, final PaddingValues paddingValues, final boolean z, final Orientation orientation, final float f, float f2, final CoroutineScope coroutineScope, final LazyGridStaggeredGridSlotsProvider lazyGridStaggeredGridSlotsProvider, final GraphicsContext graphicsContext, Composer composer, int i) {
        ...
        if (zChanged || lazyLayoutMeasurePolicyRememberedValue == Composer.INSTANCE.getEmpty()) {
            lazyLayoutMeasurePolicyRememberedValue = new LazyLayoutMeasurePolicy() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                ...
                public final MeasureResult mo1333measure0kLqBqw(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
                    long jM9809constructorimpl;
                    ObservableScopeInvalidator.m1436attachToScopeimpl(lazyStaggeredGridState.m1486getMeasurementScopeInvalidatorzYiylxw$foundation());
                    boolean z2 = lazyStaggeredGridState.getHasLookaheadOccurred() || lazyLayoutMeasureScope.isLookingAhead();
                    CheckScrollableContainerConstraintsKt.m623checkScrollableContainerConstraintsK40F9xA(j, orientation);
                    LazyStaggeredGridSlots lazyStaggeredGridSlotsMo1456invoke0kLqBqw = lazyGridStaggeredGridSlotsProvider.mo1456invoke0kLqBqw(lazyLayoutMeasureScope, j);
                    ...
                    int i2 = lazyLayoutMeasureScope.mo748roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.beforePadding(paddingValues, orientation, z, lazyLayoutMeasureScope.getLayoutDirection()));
                    int i3 = lazyLayoutMeasureScope.mo748roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.afterPadding(paddingValues, orientation, z, lazyLayoutMeasureScope.getLayoutDirection()));
                    int i4 = lazyLayoutMeasureScope.mo748roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.startPadding(paddingValues, orientation, lazyLayoutMeasureScope.getLayoutDirection()));
                    int iM9639getMaxHeightimpl = ((z3 ? Constraints.m9639getMaxHeightimpl(j) : Constraints.m9640getMaxWidthimpl(j)) - i2) - i3;
                    if (z3) {
                        jM9809constructorimpl = IntOffset.m9809constructorimpl((((long) i2) & 4294967295L) | (((long) i4) << 32));
                    } else {
                        jM9809constructorimpl = IntOffset.m9809constructorimpl((((long) i2) << 32) | (((long) i4) & 4294967295L));
                    }
                    long j2 = jM9809constructorimpl;
                    PaddingValues paddingValues2 = paddingValues;
                    int i5 = lazyLayoutMeasureScope.mo748roundToPx0680j_4(Dp.m9687constructorimpl(PaddingKt.calculateStartPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection()) + PaddingKt.calculateEndPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection())));
                    PaddingValues paddingValues3 = paddingValues;
                    int i6 = lazyLayoutMeasureScope.mo748roundToPx0680j_4(Dp.m9687constructorimpl(paddingValues3.getTop() + paddingValues3.getBottom()));
                    LazyStaggeredGridMeasureResult lazyStaggeredGridMeasureResultM1480measureStaggeredGridC6celF4 = LazyStaggeredGridMeasureKt.m1480measureStaggeredGridC6celF4(lazyLayoutMeasureScope, lazyStaggeredGridState, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(lazyStaggeredGridItemProviderInvoke, lazyStaggeredGridState.getPinnedItems(), lazyStaggeredGridState.getBeyondBoundsInfo()), lazyStaggeredGridItemProviderInvoke, lazyStaggeredGridSlotsMo1456invoke0kLqBqw, Constraints.m9630copyZbe2FdA$default(j, ConstraintsKt.m9657constrainWidthK40F9xA(j, i5), 0, ConstraintsKt.m9656constrainHeightK40F9xA(j, i6), 0, 10, null), z3, z, j2, iM9639getMaxHeightimpl, lazyLayoutMeasureScope.mo748roundToPx0680j_4(f), i2, i3, coroutineScope, z2, lazyLayoutMeasureScope.isLookingAhead(), lazyStaggeredGridState.getApproachLayoutInfo(), graphicsContext);
                    LazyStaggeredGridState.applyMeasureResult$foundation$default(lazyStaggeredGridState, lazyStaggeredGridMeasureResultM1480measureStaggeredGridC6celF4, lazyLayoutMeasureScope.isLookingAhead(), false, 4, null);
                    return lazyStaggeredGridMeasureResultM1480measureStaggeredGridC6celF4;
                }
            };
