...
public abstract class LazyStaggeredGridMeasureProvider extends LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    public abstract LazyStaggeredGridMeasuredItem mo1476createItempitSLOA(int index, int lane, int span, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private final long m1482childConstraintsJhjzzOo(int slot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m9652fixedWidthOenEA2s(i);
        }
        return Constraints.INSTANCE.m9651fixedHeightOenEA2s(i);
    }

    /* JADX INFO: renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m1483getAndMeasurejy6DScQ(int index, long span) {
        ...
        long jM1482childConstraintsJhjzzOo = m1482childConstraintsJhjzzOo(iCoerceAtMost, iCoerceAtMost2);
        return mo1476createItempitSLOA(index, iCoerceAtMost, iCoerceAtMost2, key, contentType, m1423getPlaceables3p2s80s(this.measureScope, index, jM1482childConstraintsJhjzzOo), jM1482childConstraintsJhjzzOo);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider
    /* JADX INFO: renamed from: getAndMeasure--hBUhpc */
    public LazyStaggeredGridMeasuredItem mo1346getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return mo1476createItempitSLOA(index, lane, span, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), m1423getPlaceables3p2s80s(this.measureScope, index, constraints), constraints);
    }
