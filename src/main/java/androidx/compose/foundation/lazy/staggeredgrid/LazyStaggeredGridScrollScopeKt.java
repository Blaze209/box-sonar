    ...
    public static final class AnonymousClass1 implements LazyLayoutScrollScope, ScrollScope {
        ...
        public int calculateDistanceTo(int targetIndex, int targetOffset) {
            ...
            if (lazyStaggeredGridItemInfo2 == null) {
                ...
                iM9815getXimpl = (iVisibleItemsAverageSize * ((targetIndex / laneCount$foundation) - (getFirstVisibleItemIndex() / laneCount$foundation))) - getFirstVisibleItemScrollOffset();
            } else if (layoutInfo.getOrientation() == Orientation.Vertical) {
                iM9815getXimpl = IntOffset.m9816getYimpl(lazyStaggeredGridItemInfo2.getOffset());
            } else {
                iM9815getXimpl = IntOffset.m9815getXimpl(lazyStaggeredGridItemInfo2.getOffset());
            }
            return iM9815getXimpl + targetOffset;
        }
    }
