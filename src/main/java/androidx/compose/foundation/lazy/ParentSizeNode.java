...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        int iM9642getMinWidthimpl = iRound != Integer.MAX_VALUE ? iRound : Constraints.m9642getMinWidthimpl(j);
        int iM9641getMinHeightimpl = iRound2 != Integer.MAX_VALUE ? iRound2 : Constraints.m9641getMinHeightimpl(j);
        if (iRound == Integer.MAX_VALUE) {
            iRound = Constraints.m9640getMaxWidthimpl(j);
        }
        if (iRound2 == Integer.MAX_VALUE) {
            iRound2 = Constraints.m9639getMaxHeightimpl(j);
        }
        final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(ConstraintsKt.Constraints(iM9642getMinWidthimpl, iRound, iM9641getMinHeightimpl, iRound2));
        return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo0.getWidth(), placeableMo8265measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return ParentSizeNode.measure_3p2s80s$lambda$2(placeableMo8265measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
