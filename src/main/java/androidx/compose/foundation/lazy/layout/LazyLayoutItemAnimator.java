...
public final class LazyLayoutItemAnimator<T extends LazyLayoutMeasuredItem> {
    ...
    /* JADX WARN: Code duplicated, block: B:227:0x00d6 A[EDGE_INSN: B:227:0x00d6->B:42:0x00d6 BREAK  A[LOOP:1: B:28:0x008e->B:40:0x00cb], SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:39:0x00c9 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:40:0x00cb A[LOOP:1: B:28:0x008e->B:40:0x00cb, LOOP_END] */
    ...
    public final void onMeasured(int consumedScroll, int layoutWidth, int layoutHeight, List<T> positionedItems, final LazyLayoutKeyIndexMap keyIndexMap, LazyLayoutMeasuredItemProvider<T> itemProvider, boolean isVertical, boolean isLookingAhead, int laneCount, boolean hasLookaheadOccurred, int layoutMinOffset, int layoutMaxOffset, CoroutineScope coroutineScope, GraphicsContext graphicsContext) {
        ...
        while (true) {
            if (i5 < size) {
                if (getHasAnimations(positionedItems.get(i5))) {
                    break;
                } else {
                    i5++;
                }
        ...
        if (isVertical) {
            jM9809constructorimpl = IntOffset.m9809constructorimpl((((long) consumedScroll) & 4294967295L) | (((long) 0) << 32));
        } else {
            jM9809constructorimpl = IntOffset.m9809constructorimpl((((long) consumedScroll) << 32) | (((long) 0) & 4294967295L));
        }
            ...
            if (getHasAnimations(t)) {
                ...
                if (itemInfo2 == null) {
                    ...
                    if (t.getIndex() == index || index == -1) {
                        long jMo1344getOffsetBjo55l4 = t.mo1344getOffsetBjo55l4(0);
                        initializeAnimation(t, t.getIsVertical() ? IntOffset.m9816getYimpl(jMo1344getOffsetBjo55l4) : IntOffset.m9815getXimpl(jMo1344getOffsetBjo55l4), itemInfo3);
                        if (z3) {
                        ...
                        if (index < i6) {
                            zAdd2 = this.movingInFromStartBound.add(t);
                        } else {
                            zAdd2 = this.movingInFromEndBound.add(t);
                        }
                        Boolean.valueOf(zAdd2);
                    }
                } else {
                    i3 = size2;
                    i4 = i10;
                    if (z) {
                        ...
                        while (i11 < length2) {
                            ...
                            int i12 = length2;
                            if (lazyLayoutItemAnimation2 != null && !IntOffset.m9814equalsimpl0(lazyLayoutItemAnimation2.getRawOffset(), LazyLayoutItemAnimation.INSTANCE.m1411getNotInitializednOccac())) {
                                lazyLayoutItemAnimation2.m1410setRawOffsetgyyYBs(IntOffset.m9819plusqkQi6aY(lazyLayoutItemAnimation2.getRawOffset(), jM9809constructorimpl));
                            }
                            i11++;
        ...
        if (length3 >= 0) {
            ...
            while (true) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    int i17 = 0;
                    while (i17 < i16) {
                        if ((j2 & 255) >= 128 || (itemInfo = this.keyToItemInfoMap.get((obj = objArr5[(i15 << 3) + i17]))) == 0) {
                            jArr2 = jArr4;
                            objArr2 = objArr5;
                            i = i17;
                        } else {
                            ...
                            if (index2 == -1) {
                                ...
                                LazyLayoutMeasuredItem lazyLayoutMeasuredItemMo1346getAndMeasurehBUhpc = itemProvider.mo1346getAndMeasurehBUhpc(index2, itemInfo.getLane(), itemInfo.getSpan(), constraints.getValue());
                                lazyLayoutMeasuredItemMo1346getAndMeasurehBUhpc.setNonScrollableItem(true);
                                ...
                                while (true) {
                                    ...
                                    itemInfo.updateAnimation(lazyLayoutMeasuredItemMo1346getAndMeasurehBUhpc, coroutineScope, graphicsContext, layoutMinOffset, layoutMaxOffset, itemInfo.getCrossAxisOffset());
                                    if (index2 < this.firstVisibleIndex) {
                                        zAdd = this.movingAwayToStartBound.add((T) lazyLayoutMeasuredItemMo1346getAndMeasurehBUhpc);
                                    } else {
                                        zAdd = this.movingAwayToEndBound.add((T) lazyLayoutMeasuredItemMo1346getAndMeasurehBUhpc);
                                    }
        ...
        if (!this.movingAwayToStartBound.isEmpty()) {
            ...
            for (int i23 = 0; i23 < size5; i23++) {
                ...
                if (isLookingAhead) {
                    ...
                    layoutMinOffset2 = itemInfo5.getLayoutMinOffset();
                }
                t4.position(layoutMinOffset2 - iUpdateAndReturnOffsetFor, itemInfo5.getCrossAxisOffset(), layoutWidth, layoutHeight);
                if (z) {
    ...
    /* JADX WARN: Code duplicated, block: B:26:0x0060 A[EDGE_INSN: B:26:0x0060->B:23:0x0060 BREAK  A[LOOP:0: B:7:0x0017->B:22:0x005d], SYNTHETIC] */
    ...
    private final void initializeAnimation(T item, int mainAxisOffset, LazyLayoutItemAnimator<T>.ItemInfo itemInfo) {
        long jM9811copyiSbpLlY$default;
        int i = 0;
        long jMo1344getOffsetBjo55l4 = item.mo1344getOffsetBjo55l4(0);
        if (item.getIsVertical()) {
            jM9811copyiSbpLlY$default = IntOffset.m9811copyiSbpLlY$default(jMo1344getOffsetBjo55l4, 0, mainAxisOffset, 1, null);
        } else {
            jM9811copyiSbpLlY$default = IntOffset.m9811copyiSbpLlY$default(jMo1344getOffsetBjo55l4, mainAxisOffset, 0, 2, null);
        }
        ...
        while (i < length) {
            ...
            int i3 = i2 + 1;
            if (lazyLayoutItemAnimation != null) {
                lazyLayoutItemAnimation.m1410setRawOffsetgyyYBs(IntOffset.m9819plusqkQi6aY(jM9811copyiSbpLlY$default, IntOffset.m9818minusqkQi6aY(item.mo1344getOffsetBjo55l4(i2), jMo1344getOffsetBjo55l4)));
            }
            i++;
            i2 = i3;
        }
    ...
    private final void startPlacementAnimationsIfNeeded(T item, boolean isMovingAway) {
        ...
        while (i < length) {
            ...
            int i3 = i2 + 1;
            if (lazyLayoutItemAnimation != null) {
                long jMo1344getOffsetBjo55l4 = item.mo1344getOffsetBjo55l4(i2);
                long rawOffset = lazyLayoutItemAnimation.getRawOffset();
                if (!IntOffset.m9814equalsimpl0(rawOffset, LazyLayoutItemAnimation.INSTANCE.m1411getNotInitializednOccac()) && !IntOffset.m9814equalsimpl0(rawOffset, jMo1344getOffsetBjo55l4)) {
                    lazyLayoutItemAnimation.m1403animatePlacementDeltaar5cAso(IntOffset.m9818minusqkQi6aY(jMo1344getOffsetBjo55l4, rawOffset), isMovingAway);
                }
                lazyLayoutItemAnimation.m1410setRawOffsetgyyYBs(jMo1344getOffsetBjo55l4);
            }
            i++;
            i2 = i3;
        }
    ...
    public final long m1413getMinSizeToFitDisappearingItemsYbymL2g() {
        long jM9863getZeroYbymL2g = IntSize.INSTANCE.m9863getZeroYbymL2g();
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layer != null) {
                int iMax = Math.max((int) (jM9863getZeroYbymL2g >> 32), IntOffset.m9815getXimpl(lazyLayoutItemAnimation.getRawOffset()) + ((int) (layer.getSize() >> 32)));
                jM9863getZeroYbymL2g = IntSize.m9853constructorimpl((((long) Math.max((int) (jM9863getZeroYbymL2g & 4294967295L), IntOffset.m9816getYimpl(lazyLayoutItemAnimation.getRawOffset()) + ((int) (layer.getSize() & 4294967295L)))) & 4294967295L) | (((long) iMax) << 32));
            }
        }
        return jM9863getZeroYbymL2g;
    }
    ...
    private final int getMainAxisOffset(LazyLayoutMeasuredItem lazyLayoutMeasuredItem) {
        long jMo1344getOffsetBjo55l4 = lazyLayoutMeasuredItem.mo1344getOffsetBjo55l4(0);
        return lazyLayoutMeasuredItem.getIsVertical() ? IntOffset.m9816getYimpl(jMo1344getOffsetBjo55l4) : IntOffset.m9815getXimpl(jMo1344getOffsetBjo55l4);
    }
    ...
    final class ItemInfo {
        ...
        public final void m1416setConstraints_Sx5XlM(Constraints constraints) {
        ...
        public final void updateAnimation(T positionedItem, CoroutineScope coroutineScope, GraphicsContext graphicsContext, int layoutMinOffset, int layoutMaxOffset, int crossAxisOffset) {
            ...
            this.constraints = Constraints.m9627boximpl(positionedItem.getConstraints());
    ...
    /* JADX INFO: compiled from: LazyLayoutItemAnimator.kt */
    @Metadata(d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0082\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0013\u0012\n\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\b\u0010\u0007\u001a\u00020\u0002H\u0016J\u0010\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u0002H\u0016J\f\u0010\u000b\u001a\u00020\t*\u00020\fH\u0016J\r\u0010\r\u001a\u0006\u0012\u0002\b\u00030\u0004HÂ\u0003J\u0017\u0010\u000e\u001a\u00020\u00002\f\b\u0002\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u0004HÆ\u0001J\u0013\u0010\u000f\u001a\u00020\u00102\b\u0010\u0011\u001a\u0004\u0018\u00010\u0012HÖ\u0003J\t\u0010\u0013\u001a\u00020\u0014HÖ\u0001J\t\u0010\u0015\u001a\u00020\u0016HÖ\u0001R\u0012\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0017"}, d2 = {"Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$DisplayingDisappearingItemsElement;", "Landroidx/compose/ui/node/ModifierNodeElement;", "Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$DisplayingDisappearingItemsNode;", "animator", "Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;", "<init>", "(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;)V", PasskeyWebListener.CREATE_UNIQUE_KEY, "update", "", "node", "inspectableProperties", "Landroidx/compose/ui/platform/InspectorInfo;", "component1", BoxAmplitudeAnalytics.JobEventPropertyBuilder.JOB_TYPE_COPY_JOB, "equals", "", "other", "", "hashCode", "", "toString", "", "foundation"}, k = 1, mv = {2, 0, 0}, xi = 48)
    ...
    private static final /* data */ class DisplayingDisappearingItemsNode extends Modifier.Node implements DrawModifierNode {
        ...
        public void draw(ContentDrawScope contentDrawScope) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                GraphicsLayer layer = lazyLayoutItemAnimation.getLayer();
                if (layer != null) {
                    float fM9815getXimpl = IntOffset.m9815getXimpl(lazyLayoutItemAnimation.getFinalOffset());
                    float fM9816getYimpl = IntOffset.m9816getYimpl(lazyLayoutItemAnimation.getFinalOffset());
                    ContentDrawScope contentDrawScope2 = contentDrawScope;
                    float fM9815getXimpl2 = fM9815getXimpl - IntOffset.m9815getXimpl(layer.getTopLeft());
                    float fM9816getYimpl2 = fM9816getYimpl - IntOffset.m9816getYimpl(layer.getTopLeft());
                    contentDrawScope2.getDrawContext().getTransform().translate(fM9815getXimpl2, fM9816getYimpl2);
                    try {
