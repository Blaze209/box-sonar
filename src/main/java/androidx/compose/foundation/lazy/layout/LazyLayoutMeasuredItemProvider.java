...
public abstract class LazyLayoutMeasuredItemProvider<T extends LazyLayoutMeasuredItem> {
    ...
    public abstract T mo1346getAndMeasurehBUhpc(int index, int lane, int span, long constraints);

    /* JADX INFO: renamed from: getPlaceables-3p2s80s, reason: not valid java name */
    public final List<Placeable> m1423getPlaceables3p2s80s(LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, long j) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(listCompose.get(i2).mo8265measureBRTryo0(j));
        }
