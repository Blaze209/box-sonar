...
public interface NestedPrefetchScope {
    ...
    void mo1430schedulePrecompositionAndPremeasure0kLqBqw(int index, long constraints);
    ...
    default void m1435schedulePrefetch0kLqBqw(int index, long constraints) {
        mo1430schedulePrecompositionAndPremeasure0kLqBqw(index, constraints);
    }
}
