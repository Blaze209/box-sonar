...
public final class PrefetchHandleProvider {
    ...
    public final LazyLayoutPrefetchState.PrefetchHandle m1447schedulePremeasurem8Kt_7k(int index, long constraints, PrefetchMetrics prefetchMetrics, boolean isHighPriority, Function1<? super LazyLayoutPrefetchState.PrefetchResultScope, Unit> onItemPremeasured) {
        PrefetchScheduler prefetchScheduler = this.executor;
    ...
    public final PrefetchRequest m1446createNestedPrefetchRequestVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
        PrefetchScheduler prefetchScheduler = this.executor;
    ...
    final class HandleAndRequestImpl implements LazyLayoutPrefetchState.PrefetchHandle, PrefetchRequest, LazyLayoutPrefetchState.PrefetchResultScope {
        ...
        public HandleAndRequestImpl(int i, PrefetchMetrics prefetchMetrics, PriorityPrefetchScheduler priorityPrefetchScheduler, Function1<? super LazyLayoutPrefetchState.PrefetchResultScope, Unit> function1) {
            ...
            this.startTime = TimeSource.Monotonic.INSTANCE.m16274markNowz9LOYto();
        }
        ...
        private HandleAndRequestImpl(PrefetchHandleProvider prefetchHandleProvider, int i, long j, PrefetchMetrics prefetchMetrics, PriorityPrefetchScheduler priorityPrefetchScheduler, Function1<? super LazyLayoutPrefetchState.PrefetchResultScope, Unit> function1) {
            ...
            this.premeasureConstraints = Constraints.m9627boximpl(j);
        }
        ...
        public long mo1431getSizeYEO4UFw(int placeableIndex) {
            SubcomposeLayoutState.PrecomposedSlotHandle precomposedSlotHandle = this.precomposeHandle;
            return precomposedSlotHandle != null ? precomposedSlotHandle.mo8292getSizeYEO4UFw(placeableIndex) : IntSize.INSTANCE.m9863getZeroYbymL2g();
        }
        ...
        private final void updateElapsedAndAvailableTime() {
            long jM16274markNowz9LOYto = TimeSource.Monotonic.INSTANCE.m16274markNowz9LOYto();
            long jM16169getInWholeNanosecondsimpl = Duration.m16169getInWholeNanosecondsimpl(TimeSource.Monotonic.ValueTimeMark.m16285minus6eNON_k(jM16274markNowz9LOYto, this.startTime));
            this.elapsedTimeNanos = jM16169getInWholeNanosecondsimpl;
            long j = this.availableTimeNanos - jM16169getInWholeNanosecondsimpl;
            this.availableTimeNanos = j;
            this.startTime = jM16274markNowz9LOYto;
            ...
            if (!this.isCanceled) {
                ...
                if (index >= 0 && index < itemCount) {
                    ...
                    if (!this.isMeasured && constraints != null) {
                        ...
                        try {
                            m1448performMeasureBRTryo0(constraints.getValue());
        ...
        private final void m1448performMeasureBRTryo0(long constraints) {
            if (this.isCanceled) {
            ...
            if (precomposedSlotHandle != null) {
                ...
                for (int i = 0; i < placeablesCount; i++) {
                    precomposedSlotHandle.mo8293premeasure0kLqBqw(i, constraints);
                }
                return;
            }
