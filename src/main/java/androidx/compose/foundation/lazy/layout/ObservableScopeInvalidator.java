...
public final class ObservableScopeInvalidator {
    ...
    public static final /* synthetic */ ObservableScopeInvalidator m1437boximpl(MutableState mutableState) {
        return new ObservableScopeInvalidator(mutableState);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static MutableState<Unit> m1438constructorimpl(MutableState<Unit> mutableState) {
        return mutableState;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1440equalsimpl(MutableState<Unit> mutableState, Object obj) {
    ...
    public static final boolean m1441equalsimpl0(MutableState<Unit> mutableState, MutableState<Unit> mutableState2) {
        return Intrinsics.areEqual(mutableState, mutableState2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m1442hashCodeimpl(MutableState<Unit> mutableState) {
        return mutableState.hashCode();
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1444toStringimpl(MutableState<Unit> mutableState) {
        return "ObservableScopeInvalidator(state=" + mutableState + ')';
    }

    public boolean equals(Object other) {
        return m1440equalsimpl(this.state, other);
    }

    public int hashCode() {
        return m1442hashCodeimpl(this.state);
    }

    public String toString() {
        return m1444toStringimpl(this.state);
    }
    ...
    public static /* synthetic */ MutableState m1439constructorimpl$default(MutableState mutableState, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            mutableState = SnapshotStateKt.mutableStateOf(Unit.INSTANCE, SnapshotStateKt.neverEqualPolicy());
        }
        return m1438constructorimpl(mutableState);
    }

    /* JADX INFO: renamed from: attachToScope-impl, reason: not valid java name */
    public static final void m1436attachToScopeimpl(MutableState<Unit> mutableState) {
        mutableState.getValue();
    }

    /* JADX INFO: renamed from: invalidateScope-impl, reason: not valid java name */
    public static final void m1443invalidateScopeimpl(MutableState<Unit> mutableState) {
