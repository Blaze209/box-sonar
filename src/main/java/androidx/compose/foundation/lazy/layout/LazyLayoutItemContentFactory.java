        ...
        public static final Unit createContentLambda$lambda$0(LazyLayoutItemContentFactory lazyLayoutItemContentFactory, final CachedItemContent cachedItemContent, Composer composer, int i) {
            ...
            if (!composer.shouldExecute((i & 3) != 2, i & 1)) {
                ...
                if (i2 != -1) {
                    ...
                    composer2 = composer;
                    LazyLayoutItemContentFactoryKt.m1419SkippableItemJVlU9Rs(lazyLayoutItemProviderInvoke, StableValue.m1450constructorimpl(lazyLayoutItemContentFactory.saveableStateHolder), i2, StableValue.m1450constructorimpl(cachedItemContent.key), composer2, 0);
                } else {
                    composer2 = composer;
