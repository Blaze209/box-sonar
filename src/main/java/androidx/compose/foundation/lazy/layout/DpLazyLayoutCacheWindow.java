...
final class DpLazyLayoutCacheWindow implements LazyLayoutCacheWindow {
    ...
    public int calculateAheadWindow(Density density, int i) {
        return density.mo748roundToPx0680j_4(this.ahead);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutCacheWindow
    public int calculateBehindWindow(Density density, int i) {
        return density.mo748roundToPx0680j_4(this.behind);
    }

    public int hashCode() {
        return (Dp.m9693hashCodeimpl(this.ahead) * 31) + Dp.m9693hashCodeimpl(this.behind);
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof DpLazyLayoutCacheWindow) {
            ...
            if (Dp.m9692equalsimpl0(dpLazyLayoutCacheWindow.ahead, this.ahead) && Dp.m9692equalsimpl0(dpLazyLayoutCacheWindow.behind, this.behind)) {
                return true;
            }
        }
        return false;
