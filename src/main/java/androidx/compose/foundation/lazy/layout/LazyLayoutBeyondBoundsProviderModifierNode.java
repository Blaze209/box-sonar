...
public final class LazyLayoutBeyondBoundsProviderModifierNode extends Modifier.Node implements LayoutModifierNode, BeyondBoundsLayoutProviderModifierNode, BeyondBoundsLayout {
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo0.getWidth(), placeableMo8265measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsProviderModifierNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return LazyLayoutBeyondBoundsProviderModifierNode.measure_3p2s80s$lambda$0(placeableMo8265measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public <T> T mo1398layouto7g1Pn8(final int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        ...
        if (m1396isForward4vf7U8o(direction)) {
        ...
        T tInvoke = null;
        int i = 0;
        while (tInvoke == null && m1395hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction) && i < iCoerceAtMost) {
            T t = (T) m1394addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction);
            ...
            tInvoke = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsProviderModifierNode$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    return this.this$0.m1395hasMoreContentFR3nfPY(objectRef.element, direction);
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
    ...
    private final boolean m1396isForward4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m8248equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m8254getBeforehoxUOeE())) {
            return false;
        }
        if (BeyondBoundsLayout.LayoutDirection.m8248equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m8253getAfterhoxUOeE())) {
            return true;
        }
        if (BeyondBoundsLayout.LayoutDirection.m8248equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m8252getAbovehoxUOeE())) {
            return this.reverseLayout;
        }
        if (BeyondBoundsLayout.LayoutDirection.m8248equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m8255getBelowhoxUOeE())) {
            return !this.reverseLayout;
        }
        if (BeyondBoundsLayout.LayoutDirection.m8248equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m8256getLefthoxUOeE())) {
        ...
        if (!BeyondBoundsLayout.LayoutDirection.m8248equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m8257getRighthoxUOeE())) {
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m1394addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval currentInterval, int direction) {
    ...
    public final boolean m1395hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        if (m1397isOppositeToOrientation4vf7U8o(i)) {
            return false;
        }
        if (m1396isForward4vf7U8o(i)) {
    ...
    private final boolean m1397isOppositeToOrientation4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m8248equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m8252getAbovehoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m8248equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m8255getBelowhoxUOeE())) {
            return this.orientation == Orientation.Horizontal;
        }
        if (BeyondBoundsLayout.LayoutDirection.m8248equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m8256getLefthoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m8248equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m8257getRighthoxUOeE())) {
            return this.orientation == Orientation.Vertical;
        }
        if (BeyondBoundsLayout.LayoutDirection.m8248equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m8254getBeforehoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m8248equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m8253getAfterhoxUOeE())) {
            return false;
        }
        LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
        throw new KotlinNothingValueException();
