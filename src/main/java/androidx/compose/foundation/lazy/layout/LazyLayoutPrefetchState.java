...
public final class LazyLayoutPrefetchState {
    ...
    public interface PrefetchResultScope {
        ...
        long mo1431getSizeYEO4UFw(int placeableIndex);
    }
    ...
    public static /* synthetic */ PrefetchHandle m1426schedulePrecompositionAndPremeasureVKLhPVY$default(LazyLayoutPrefetchState lazyLayoutPrefetchState, int i, long j, Function1 function1, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            function1 = null;
        }
        return lazyLayoutPrefetchState.m1428schedulePrecompositionAndPremeasureVKLhPVY(i, j, function1);
    }

    /* JADX INFO: renamed from: schedulePrecompositionAndPremeasure-VKLhPVY, reason: not valid java name */
    public final PrefetchHandle m1428schedulePrecompositionAndPremeasureVKLhPVY(int index, long constraints, Function1<? super PrefetchResultScope, Unit> onItemPremeasured) {
        return m1429schedulePrecompositionAndPremeasure_EkL_Y$foundation(index, constraints, true, onItemPremeasured);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: schedulePrecompositionAndPremeasure-_EkL_-Y$foundation$default, reason: not valid java name */
    public static /* synthetic */ PrefetchHandle m1427schedulePrecompositionAndPremeasure_EkL_Y$foundation$default(LazyLayoutPrefetchState lazyLayoutPrefetchState, int i, long j, boolean z, Function1 function1, int i2, Object obj) {
        if ((i2 & 8) != 0) {
            function1 = null;
        }
        return lazyLayoutPrefetchState.m1429schedulePrecompositionAndPremeasure_EkL_Y$foundation(i, j, z, function1);
    }

    /* JADX INFO: renamed from: schedulePrecompositionAndPremeasure-_EkL_-Y$foundation, reason: not valid java name */
    public final PrefetchHandle m1429schedulePrecompositionAndPremeasure_EkL_Y$foundation(int index, long constraints, boolean isHighPriority, Function1<? super PrefetchResultScope, Unit> onItemPremeasured) {
        PrefetchHandle prefetchHandleM1447schedulePremeasurem8Kt_7k;
        PrefetchHandleProvider prefetchHandleProvider = this.prefetchHandleProvider;
        return (prefetchHandleProvider == null || (prefetchHandleM1447schedulePremeasurem8Kt_7k = prefetchHandleProvider.m1447schedulePremeasurem8Kt_7k(index, constraints, this.prefetchMetrics, isHighPriority, onItemPremeasured)) == null) ? DummyHandle.INSTANCE : prefetchHandleM1447schedulePremeasurem8Kt_7k;
    }
    ...
    private final class NestedPrefetchScopeImpl implements NestedPrefetchScope {
        ...
        public void mo1430schedulePrecompositionAndPremeasure0kLqBqw(int index, long constraints) {
            PrefetchHandleProvider prefetchHandleProvider = LazyLayoutPrefetchState.this.getPrefetchHandleProvider();
            if (prefetchHandleProvider == null) {
                return;
            }
            this._requests.add(prefetchHandleProvider.m1446createNestedPrefetchRequestVKLhPVY(index, constraints, LazyLayoutPrefetchState.this.prefetchMetrics));
        }
    }
}
