...
public abstract class LazyListMeasuredItemProvider extends LazyLayoutMeasuredItemProvider<LazyListMeasuredItem> {
    ...
    public abstract LazyListMeasuredItem mo1334createItemX9ElhV4(int index, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private LazyListMeasuredItemProvider(long j, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m9640getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, z ? Integer.MAX_VALUE : Constraints.m9639getMaxHeightimpl(j), 5, null);
    }
    ...
    public LazyListMeasuredItem mo1346getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return m1347getAndMeasure0kLqBqw(index, constraints);
    }

    /* JADX INFO: renamed from: getAndMeasure-0kLqBqw$default, reason: not valid java name */
    public static /* synthetic */ LazyListMeasuredItem m1345getAndMeasure0kLqBqw$default(LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i, long j, int i2, Object obj) {
        if (obj != null) {
        ...
        return lazyListMeasuredItemProvider.m1347getAndMeasure0kLqBqw(i, j);
    }

    /* JADX INFO: renamed from: getAndMeasure-0kLqBqw, reason: not valid java name */
    public final LazyListMeasuredItem m1347getAndMeasure0kLqBqw(int index, long constraints) {
        return mo1334createItemX9ElhV4(index, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), m1423getPlaceables3p2s80s(this.measureScope, index, constraints), constraints);
    }
