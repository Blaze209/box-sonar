...
final class EdgeEffectWrapper {
    ...
    private final EdgeEffect createEdgeEffect(Orientation orientation) {
        ...
        if (!IntSize.m9856equalsimpl0(this.size, IntSize.INSTANCE.m9863getZeroYbymL2g())) {
    ...
    public final void m653updateSizeozmzZPI(long size) {
        this.size = size;
        EdgeEffect edgeEffect = this.topEffect;
        if (edgeEffect != null) {
