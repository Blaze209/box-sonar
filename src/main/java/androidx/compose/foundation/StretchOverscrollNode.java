...
final class StretchOverscrollNode extends DelegatingNode implements DrawModifierNode {
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float f = contentDrawScope.mo754toPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
        ...
        if (edgeEffectWrapper.isLeftAnimating()) {
            ...
            if (edgeEffectWrapper.isLeftStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateLeftEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateLeftEffect), 1 - Float.intBitsToFloat((int) (this.overscrollEffect.m566displacementF1C5BW0$foundation() & 4294967295L)));
            }
        } else {
        ...
        if (edgeEffectWrapper.isTopAnimating()) {
            ...
            if (edgeEffectWrapper.isTopStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateTopEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateTopEffect), Float.intBitsToFloat((int) (this.overscrollEffect.m566displacementF1C5BW0$foundation() >> 32)));
            }
        }
        ...
        if (edgeEffectWrapper.isRightAnimating()) {
            ...
            if (edgeEffectWrapper.isRightStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateRightEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateRightEffect), Float.intBitsToFloat((int) (this.overscrollEffect.m566displacementF1C5BW0$foundation() & 4294967295L)));
            }
        }
        ...
        if (edgeEffectWrapper.isBottomAnimating()) {
            ...
            if (edgeEffectWrapper.isBottomStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateBottomEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateBottomEffect), 1 - Float.intBitsToFloat((int) (this.overscrollEffect.m566displacementF1C5BW0$foundation() >> 32)));
            }
            zDrawLeftStretch = z;
        }
        if (zDrawLeftStretch) {
        ...
        long jMo7316getSizeNHjbRc = contentDrawScope2.getDrawContext().mo7316getSizeNHjbRc();
