...
public final class AndroidOverscroll_androidKt {
    ...
    private static final PaddingValues DefaultGlowPaddingValues = PaddingKt.m1213PaddingValuesYgX7TsA$default(0.0f, 0.0f, 3, null);
    ...
    public static final OverscrollFactory m587rememberPlatformOverscrollFactory3JVO9M(long j, PaddingValues paddingValues, Composer composer, int i, int i2) {
    ...
    public static final float m586destretchMultiplierGyEprt8(int i) {
        return NestedScrollSource.m8002equalsimpl0(i, NestedScrollSource.INSTANCE.m8013getSideEffectWNlRxjI()) ? 4.0f : 1.0f;
    }
}
