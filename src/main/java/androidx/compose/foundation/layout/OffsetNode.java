...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m1179setX0680j_4(float f) {
        this.x = f;
    }

    /* JADX INFO: renamed from: setY-0680j_4, reason: not valid java name */
    public final void m1180setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public final void m1181updateMdfbLM(float x, float y, boolean rtlAware) {
        if (!Dp.m9692equalsimpl0(this.x, x) || !Dp.m9692equalsimpl0(this.y, y) || this.rtlAware != rtlAware) {
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo0.getWidth(), placeableMo8265measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.OffsetNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return OffsetNode.measure_3p2s80s$lambda$0(this.f$0, placeableMo8265measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit measure_3p2s80s$lambda$0(OffsetNode offsetNode, Placeable placeable, Placeable.PlacementScope placementScope) {
        if (offsetNode.rtlAware) {
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable, placementScope.mo748roundToPx0680j_4(offsetNode.x), placementScope.mo748roundToPx0680j_4(offsetNode.y), 0.0f, 4, null);
        } else {
            Placeable.PlacementScope.place$default(placementScope, placeable, placementScope.mo748roundToPx0680j_4(offsetNode.x), placementScope.mo748roundToPx0680j_4(offsetNode.y), 0.0f, 4, null);
        }
