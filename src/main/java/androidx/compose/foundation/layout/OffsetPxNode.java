...
final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo0.getWidth(), placeableMo8265measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.OffsetPxNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return OffsetPxNode.measure_3p2s80s$lambda$0(this.f$0, placeableMo8265measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit measure_3p2s80s$lambda$0(OffsetPxNode offsetPxNode, Placeable placeable, Placeable.PlacementScope placementScope) {
        long jM9824unboximpl = offsetPxNode.offset.invoke(placementScope).m9824unboximpl();
        if (offsetPxNode.rtlAware) {
            Placeable.PlacementScope.placeRelativeWithLayer$default(placementScope, placeable, IntOffset.m9815getXimpl(jM9824unboximpl), IntOffset.m9816getYimpl(jM9824unboximpl), 0.0f, (Function1) null, 12, (Object) null);
        } else {
            Placeable.PlacementScope.placeWithLayer$default(placementScope, placeable, IntOffset.m9815getXimpl(jM9824unboximpl), IntOffset.m9816getYimpl(jM9824unboximpl), 0.0f, (Function1) null, 12, (Object) null);
        }
