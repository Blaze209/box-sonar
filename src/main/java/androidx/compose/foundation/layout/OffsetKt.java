...
public final class OffsetKt {
    ...
    public static final Modifier m1174offsetVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static final Unit offset_VpY3zN4$lambda$0(float f, float f2, InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("x", Dp.m9685boximpl(f));
        inspectorInfo.getProperties().set("y", Dp.m9685boximpl(f2));
        return Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: absoluteOffset-VpY3zN4, reason: not valid java name */
    public static final Modifier m1172absoluteOffsetVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m1175offsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1174offsetVpY3zN4(modifier, f, f2);
    }

    /* JADX INFO: renamed from: absoluteOffset-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m1173absoluteOffsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m9687constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m1172absoluteOffsetVpY3zN4(modifier, f, f2);
    }
}
