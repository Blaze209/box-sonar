...
public final class SizeKt {
    ...
    public static final Modifier m1271width3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m1252height3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m1267size6HolHcs(Modifier modifier, long j) {
        return m1268sizeVpY3zN4(modifier, DpSize.m9785getWidthD9Ej5fM(j), DpSize.m9783getHeightD9Ej5fM(j));
    }

    /* JADX INFO: renamed from: widthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m1273widthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1272widthInVpY3zN4(modifier, f, f2);
    }

    /* JADX INFO: renamed from: widthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m1272widthInVpY3zN4(Modifier modifier, final float f, final float f2) {
        return modifier.then(new SizeElement(f, 0.0f, f2, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("min", Dp.m9685boximpl(f));
                inspectorInfo.getProperties().set("max", Dp.m9685boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* JADX INFO: renamed from: heightIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m1254heightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m9707getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m1253heightInVpY3zN4(modifier, f, f2);
    }

    /* JADX INFO: renamed from: heightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m1253heightInVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m1270sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m9707getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.INSTANCE.m9707getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.INSTANCE.m9707getUnspecifiedD9Ej5fM();
        }
        return m1269sizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* JADX INFO: renamed from: sizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m1269sizeInqDBjuR0(Modifier modifier, final float f, final float f2, final float f3, final float f4) {
        return modifier.then(new SizeElement(f, f2, f3, f4, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set(ViewProps.MIN_WIDTH, Dp.m9685boximpl(f));
                inspectorInfo.getProperties().set(ViewProps.MIN_HEIGHT, Dp.m9685boximpl(f2));
                inspectorInfo.getProperties().set(ViewProps.MAX_WIDTH, Dp.m9685boximpl(f3));
                inspectorInfo.getProperties().set(ViewProps.MAX_HEIGHT, Dp.m9685boximpl(f4));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* JADX INFO: renamed from: requiredWidth-3ABfNKs, reason: not valid java name */
    public static final Modifier m1263requiredWidth3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m1255requiredHeight3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m1259requiredSize6HolHcs(Modifier modifier, long j) {
        return m1260requiredSizeVpY3zN4(modifier, DpSize.m9785getWidthD9Ej5fM(j), DpSize.m9783getHeightD9Ej5fM(j));
    }

    /* JADX INFO: renamed from: requiredWidthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m1265requiredWidthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m9707getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m1264requiredWidthInVpY3zN4(modifier, f, f2);
    }

    /* JADX INFO: renamed from: requiredWidthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m1264requiredWidthInVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m1257requiredHeightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m9707getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m1256requiredHeightInVpY3zN4(modifier, f, f2);
    }

    /* JADX INFO: renamed from: requiredHeightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m1256requiredHeightInVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m1262requiredSizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m9707getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m1261requiredSizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* JADX INFO: renamed from: requiredSizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m1261requiredSizeInqDBjuR0(Modifier modifier, final float f, final float f2, final float f3, final float f4) {
    ...
    public static /* synthetic */ Modifier m1251defaultMinSizeVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m9707getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m1250defaultMinSizeVpY3zN4(modifier, f, f2);
    }

    /* JADX INFO: renamed from: defaultMinSize-VpY3zN4, reason: not valid java name */
    public static final Modifier m1250defaultMinSizeVpY3zN4(Modifier modifier, float f, float f2) {
    ...
    public static final Modifier m1266size3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m1268sizeVpY3zN4(Modifier modifier, final float f, final float f2) {
        return modifier.then(new SizeElement(f, f2, f, f2, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName("size");
                inspectorInfo.getProperties().set("width", Dp.m9685boximpl(f));
                inspectorInfo.getProperties().set("height", Dp.m9685boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* JADX INFO: renamed from: requiredSize-3ABfNKs, reason: not valid java name */
    public static final Modifier m1258requiredSize3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m1260requiredSizeVpY3zN4(Modifier modifier, final float f, final float f2) {
