...
public final class ContextualFlowRowOverflow extends FlowLayoutOverflow {
    ...
    public static final class Companion {
        ...
        public final ContextualFlowRowOverflow m1115expandOrCollapseIndicatorjt2gSs(final Function3<? super ContextualFlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function3, final Function3<? super ContextualFlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function4, int i, float f, Composer composer, int i2, int i3) {
            ...
            boolean z = true;
            int i4 = (i3 & 4) != 0 ? 1 : i;
            float fM9687constructorimpl = (i3 & 8) != 0 ? Dp.m9687constructorimpl(0) : f;
            if (ComposerKt.isTraceInProgress()) {
            ...
            int iMo748roundToPx0680j_4 = ((Density) objConsume).mo748roundToPx0680j_4(fM9687constructorimpl);
            ComposerKt.sourceInformationMarkerStart(composer, 1297597357, "CC(remember):FlowLayoutOverflow.kt#9igjgp");
            boolean zChanged = ((((i2 & 896) ^ 384) > 256 && composer.changed(i4)) || (i2 & 384) == 256) | composer.changed(iMo748roundToPx0680j_4) | ((((i2 & 14) ^ 6) > 4 && composer.changed(function3)) || (i2 & 6) == 4);
            ...
            if (z2 || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                ContextualFlowRowOverflow contextualFlowRowOverflow = new ContextualFlowRowOverflow(FlowLayoutOverflow.OverflowType.ExpandOrCollapseIndicator, i4, iMo748roundToPx0680j_4, new Function1() { // from class: androidx.compose.foundation.layout.ContextualFlowRowOverflow$Companion$$ExternalSyntheticLambda2
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
