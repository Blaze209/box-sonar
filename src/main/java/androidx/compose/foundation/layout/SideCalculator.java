...
interface SideCalculator {
    ...
    long mo1247consumedOffsetsMKHz9U(long available);

    /* JADX INFO: renamed from: consumedVelocity-QWom1Mo, reason: not valid java name */
    long mo1248consumedVelocityQWom1Mo(long available, float remaining);
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo1248consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(Velocity.m9925getXimpl(available) - remaining, 0.0f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* JADX INFO: renamed from: consumedOffsets-MK-Hz9U */
            public long mo1247consumedOffsetsMKHz9U(long available) {
                return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (available >> 32)))) << 32) | (((long) Float.floatToRawIntBits(0.0f)) & 4294967295L));
            }
        };
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* JADX INFO: renamed from: consumedVelocity-QWom1Mo */
            public long mo1248consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(0.0f, Velocity.m9926getYimpl(available) - remaining);
            }
            ...
            public long mo1247consumedOffsetsMKHz9U(long available) {
                ...
                return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(0.0f)) << 32) | (4294967295L & ((long) Float.floatToRawIntBits(fIntBitsToFloat))));
            }
        };
        ...
        public final SideCalculator m1249chooseCalculatorni1skBw(int side, LayoutDirection layoutDirection) {
            if (WindowInsetsSides.m1308equalsimpl0(side, WindowInsetsSides.INSTANCE.m1322getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m1308equalsimpl0(side, WindowInsetsSides.INSTANCE.m1325getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m1308equalsimpl0(side, WindowInsetsSides.INSTANCE.m1323getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m1308equalsimpl0(side, WindowInsetsSides.INSTANCE.m1319getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m1308equalsimpl0(side, WindowInsetsSides.INSTANCE.m1324getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m1308equalsimpl0(side, WindowInsetsSides.INSTANCE.m1320getEndJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return RightSideCalculator;
                }
                return LeftSideCalculator;
