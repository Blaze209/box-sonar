...
public class InsetsPaddingModifierNode extends InsetsConsumingModifierNode implements LayoutModifierNode {
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(ConstraintsKt.m9659offsetNN6EwU(j, -right, -bottom));
        return MeasureScope.layout$default(measureScope, ConstraintsKt.m9657constrainWidthK40F9xA(j, placeableMo8265measureBRTryo0.getWidth() + right), ConstraintsKt.m9656constrainHeightK40F9xA(j, placeableMo8265measureBRTryo0.getHeight() + bottom), null, new Function1() { // from class: androidx.compose.foundation.layout.InsetsPaddingModifierNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return InsetsPaddingModifierNode.measure_3p2s80s$lambda$0(placeableMo8265measureBRTryo0, left, top, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
