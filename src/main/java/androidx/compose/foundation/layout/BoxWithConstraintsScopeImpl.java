...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m1104copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m1106copy0kLqBqw(density, j);
    }
    ...
    public final BoxWithConstraintsScopeImpl m1106copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m9633equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m9643hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m9645toStringimpl(this.constraints)) + ')';
    }
    ...
    public long mo1099getConstraintsmsEJaDk() {
        return this.constraints;
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinWidth-D9Ej5fM */
    public float mo1103getMinWidthD9Ej5fM() {
        return this.density.mo751toDpu2uoSUM(Constraints.m9642getMinWidthimpl(mo1099getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxWidth-D9Ej5fM */
    public float mo1101getMaxWidthD9Ej5fM() {
        return Constraints.m9636getHasBoundedWidthimpl(mo1099getConstraintsmsEJaDk()) ? this.density.mo751toDpu2uoSUM(Constraints.m9640getMaxWidthimpl(mo1099getConstraintsmsEJaDk())) : Dp.INSTANCE.m9706getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinHeight-D9Ej5fM */
    public float mo1102getMinHeightD9Ej5fM() {
        return this.density.mo751toDpu2uoSUM(Constraints.m9641getMinHeightimpl(mo1099getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxHeight-D9Ej5fM */
    public float mo1100getMaxHeightD9Ej5fM() {
        return Constraints.m9635getHasBoundedHeightimpl(mo1099getConstraintsmsEJaDk()) ? this.density.mo751toDpu2uoSUM(Constraints.m9639getMaxHeightimpl(mo1099getConstraintsmsEJaDk())) : Dp.INSTANCE.m9706getInfinityD9Ej5fM();
    }
}
