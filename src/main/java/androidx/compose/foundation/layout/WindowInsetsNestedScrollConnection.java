...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo1299onPreScrollOzD1aCk(long available, int source) {
        return m1297scroll8S9VItk(available, this.sideCalculator.hideMotion(Float.intBitsToFloat((int) (available >> 32)), Float.intBitsToFloat((int) (4294967295L & available))));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostScroll-DzOQY0M */
    public long mo946onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m1297scroll8S9VItk(available, this.sideCalculator.showMotion(Float.intBitsToFloat((int) (available >> 32)), Float.intBitsToFloat((int) (4294967295L & available))));
    }

    /* JADX INFO: renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m1297scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (scrollAmount != 0.0f) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo1247consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo1298onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m1296flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m9925getXimpl(j), Velocity.m9926getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostFling-RZ2iAVY */
    public Object mo945onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m1296flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m9925getXimpl(j2), Velocity.m9926getYimpl(j2)), true, continuation);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Code duplicated, block: B:7:0x001c  */
    /* JADX INFO: renamed from: fling-huYlsQE, reason: not valid java name */
    public final Object m1296flinghuYlsQE(long j, float f, boolean z, Continuation<? super Velocity> continuation) {
        ...
        int i = windowInsetsNestedScrollConnection$fling$2.label;
        if (i == 0) {
        ...
        if (i != 1) {
            if (i == 2) {
                ...
                ResultKt.throwOnFailure(obj);
                return Velocity.m9916boximpl(this.sideCalculator.mo1248consumedVelocityQWom1Mo(j3, floatRef.element));
            }
            if (i != 3) {
            ...
            ResultKt.throwOnFailure(obj);
            return Velocity.m9916boximpl(this.sideCalculator.mo1248consumedVelocityQWom1Mo(j4, 0.0f));
        }
        ...
        if (fFlingDistance > iValueOf2 || fFlingDistance < f4) {
            ...
            WindowInsetsNestedScrollConnection$fling$2 windowInsetsNestedScrollConnection$fling$3 = new WindowInsetsNestedScrollConnection$fling$2(this, iValueOf3, f3, splineBasedFloatDecayAnimationSpec, iValueOf, iValueOf2, floatRef2, windowInsetsAnimationController, z2, null);
            ...
            WindowInsetsNestedScrollConnection$fling$3 windowInsetsNestedScrollConnection$fling$4 = new WindowInsetsNestedScrollConnection$fling$3(this, iValueOf3, i2, f3, windowInsetsAnimationController, z2, null);
            windowInsetsNestedScrollConnection$fling$2.J$0 = j2;
