...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m9882hashCodeimpl(this.before)) * 31) + TextUnit.m9882hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return alignmentLineOffsetTextUnitElement != null && Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnitElement.alignmentLine) && TextUnit.m9878equalsimpl0(this.before, alignmentLineOffsetTextUnitElement.before) && TextUnit.m9878equalsimpl0(this.after, alignmentLineOffsetTextUnitElement.after);
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m1058setBeforeR2X_6o(this.before);
        node.m1057setAfterR2X_6o(this.after);
    }
}
