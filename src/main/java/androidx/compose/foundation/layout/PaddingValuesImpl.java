...
public final class PaddingValuesImpl implements PaddingValues {
    ...
    public static /* synthetic */ void m1236getBottomD9Ej5fM$annotations() {
    }

    /* JADX INFO: renamed from: getEnd-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m1237getEndD9Ej5fM$annotations() {
    }

    /* JADX INFO: renamed from: getStart-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m1238getStartD9Ej5fM$annotations() {
    }

    /* JADX INFO: renamed from: getTop-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m1239getTopD9Ej5fM$annotations() {
    }
    ...
    public float mo1163calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
    ...
    public float mo1164calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m9692equalsimpl0(this.start, paddingValuesImpl.start) && Dp.m9692equalsimpl0(this.top, paddingValuesImpl.top) && Dp.m9692equalsimpl0(this.end, paddingValuesImpl.end) && Dp.m9692equalsimpl0(this.bottom, paddingValuesImpl.bottom);
    }

    public int hashCode() {
        return (((((Dp.m9693hashCodeimpl(this.start) * 31) + Dp.m9693hashCodeimpl(this.top)) * 31) + Dp.m9693hashCodeimpl(this.end)) * 31) + Dp.m9693hashCodeimpl(this.bottom);
    }

    public String toString() {
        return "PaddingValues(start=" + ((Object) Dp.m9698toStringimpl(this.start)) + ", top=" + ((Object) Dp.m9698toStringimpl(this.top)) + ", end=" + ((Object) Dp.m9698toStringimpl(this.end)) + ", bottom=" + ((Object) Dp.m9698toStringimpl(this.bottom)) + ')';
    }
    ...
    public /* synthetic */ PaddingValuesImpl(float f, float f2, float f3, float f4, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m9687constructorimpl(0) : f, (i & 2) != 0 ? Dp.m9687constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m9687constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m9687constructorimpl(0) : f4, null);
    }
}
