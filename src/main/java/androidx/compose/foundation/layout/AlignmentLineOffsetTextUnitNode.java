...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m1058setBeforeR2X_6o(long j) {
        this.before = j;
    }
    ...
    public final void m1057setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        return AlignmentLineKt.m1038alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, TextUnit.m9879getRawTypeimpl(this.before) == 0 ? Dp.INSTANCE.m9707getUnspecifiedD9Ej5fM() : measureScope.mo749toDpGaN1DYA(this.before), TextUnit.m9879getRawTypeimpl(this.after) == 0 ? Dp.INSTANCE.m9707getUnspecifiedD9Ej5fM() : measureScope.mo749toDpGaN1DYA(this.after), measurable, j);
    }
}
