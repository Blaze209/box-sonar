...
public final /* data */ class FlowLayoutOverflowState {
    ...
    public final IntIntPair m1135ellipsisSizeF35zmw$foundation_layout(boolean hasNext, int lineIndex, int totalCrossAxisSize) {
    ...
    /* JADX WARN: Code duplicated, block: B:36:0x0074 A[PHI: r11 r12
      0x0074: PHI (r11v10 androidx.compose.ui.layout.Measurable) = (r11v4 androidx.compose.ui.layout.Measurable), (r11v14 androidx.compose.ui.layout.Measurable) binds: [B:33:0x006d, B:20:0x003e] A[DONT_GENERATE, DONT_INLINE]
      0x0074: PHI (r12v4 androidx.collection.IntIntPair) = (r12v1 androidx.collection.IntIntPair), (r12v7 androidx.collection.IntIntPair) binds: [B:33:0x006d, B:20:0x003e] A[DONT_GENERATE, DONT_INLINE]] */
    public final FlowLayoutBuildingBlocks.WrapEllipsisInfo ellipsisInfo$foundation_layout(boolean hasNext, int lineIndex, int totalCrossAxisSize) {
        ...
        if (hasNext) {
            ...
            if (lineIndex < this.minLinesToShowCollapse - 1 || totalCrossAxisSize < this.minCrossAxisSizeToShowCollapse) {
                ...
                if (function3 == null || (measurableInvoke = function3.invoke(false, Integer.valueOf(getShownItemCount$foundation_layout()))) == null) {
    ...
    public final void m1137setOverflowMeasurableshBUhpc$foundation_layout(IntrinsicMeasurable seeMoreMeasurable, IntrinsicMeasurable collapseMeasurable, boolean isHorizontal, long constraints) {
        long jM1186constructorimpl = OrientationIndependentConstraints.m1186constructorimpl(constraints, isHorizontal ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical);
        if (seeMoreMeasurable != null) {
            int iMainAxisMin = FlowLayoutKt.mainAxisMin(seeMoreMeasurable, isHorizontal, Constraints.m9639getMaxHeightimpl(jM1186constructorimpl));
            this.seeMoreSize = IntIntPair.m324boximpl(IntIntPair.m327constructorimpl(iMainAxisMin, FlowLayoutKt.crossAxisMin(seeMoreMeasurable, isHorizontal, iMainAxisMin)));
        ...
        if (collapseMeasurable != null) {
            int iMainAxisMin2 = FlowLayoutKt.mainAxisMin(collapseMeasurable, isHorizontal, Constraints.m9639getMaxHeightimpl(jM1186constructorimpl));
            this.collapseSize = IntIntPair.m324boximpl(IntIntPair.m327constructorimpl(iMainAxisMin2, FlowLayoutKt.crossAxisMin(collapseMeasurable, isHorizontal, iMainAxisMin2)));
    ...
    /* JADX INFO: renamed from: setOverflowMeasurables--hBUhpc$foundation_layout, reason: not valid java name */
    public final void m1136setOverflowMeasurableshBUhpc$foundation_layout(final FlowLineMeasurePolicy measurePolicy, Measurable seeMoreMeasurable, Measurable collapseMeasurable, long constraints) {
        LayoutOrientation layoutOrientation = measurePolicy.isHorizontal() ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical;
        long jM1199toBoxConstraintsOenEA2s = OrientationIndependentConstraints.m1199toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m1188copyyUG9Ft0$default(OrientationIndependentConstraints.m1186constructorimpl(constraints, layoutOrientation), 0, 0, 0, 0, 10, null), layoutOrientation);
        if (seeMoreMeasurable != null) {
            FlowLayoutKt.m1131measureAndCacherqJ1uqs(seeMoreMeasurable, measurePolicy, jM1199toBoxConstraintsOenEA2s, new Function1() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$$ExternalSyntheticLambda0
        ...
        if (collapseMeasurable != null) {
            FlowLayoutKt.m1131measureAndCacherqJ1uqs(collapseMeasurable, measurePolicy, jM1199toBoxConstraintsOenEA2s, new Function1() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
    ...
    public static final Unit setOverflowMeasurables__hBUhpc$lambda$2$0(FlowLayoutOverflowState flowLayoutOverflowState, FlowLineMeasurePolicy flowLineMeasurePolicy, Placeable placeable) {
        ...
        flowLayoutOverflowState.seeMoreSize = IntIntPair.m324boximpl(IntIntPair.m327constructorimpl(iMainAxisSize, iCrossAxisSize));
    ...
    public static final Unit setOverflowMeasurables__hBUhpc$lambda$3$0(FlowLayoutOverflowState flowLayoutOverflowState, FlowLineMeasurePolicy flowLineMeasurePolicy, Placeable placeable) {
        ...
        flowLayoutOverflowState.collapseSize = IntIntPair.m324boximpl(IntIntPair.m327constructorimpl(iMainAxisSize, iCrossAxisSize));
    ...
    public final void m1138setOverflowMeasurablesVKLhPVY$foundation_layout(FlowLineMeasurePolicy measurePolicy, long constraints, Function2<? super Boolean, ? super Integer, ? extends Measurable> getOverflowMeasurable) {
        this.itemShown = 0;
        this.getOverflowMeasurable = getOverflowMeasurable;
        m1136setOverflowMeasurableshBUhpc$foundation_layout(measurePolicy, getOverflowMeasurable.invoke(true, 0), getOverflowMeasurable.invoke(false, 0), constraints);
    }
}
