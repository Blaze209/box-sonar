...
public final class AspectRatioKt {
    ...
    public static final boolean m1090isSatisfiedByNN6EwU(long j, int i, int i2) {
        int iM9642getMinWidthimpl = Constraints.m9642getMinWidthimpl(j);
        if (i > Constraints.m9640getMaxWidthimpl(j) || iM9642getMinWidthimpl > i) {
            return false;
        }
        return i2 <= Constraints.m9639getMaxHeightimpl(j) && Constraints.m9641getMinHeightimpl(j) <= i2;
    }
}
