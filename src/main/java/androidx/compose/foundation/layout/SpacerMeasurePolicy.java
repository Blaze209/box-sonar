...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo344measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m9638getHasFixedWidthimpl(j) ? Constraints.m9640getMaxWidthimpl(j) : 0, Constraints.m9637getHasFixedHeightimpl(j) ? Constraints.m9639getMaxHeightimpl(j) : 0, null, new Function1() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$$ExternalSyntheticLambda0
