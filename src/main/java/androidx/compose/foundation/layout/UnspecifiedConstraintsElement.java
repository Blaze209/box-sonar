...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        node.m1289setMinWidth0680j_4(this.minWidth);
        node.m1288setMinHeight0680j_4(this.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("defaultMinSize");
        inspectorInfo.getProperties().set(ViewProps.MIN_WIDTH, Dp.m9685boximpl(this.minWidth));
        inspectorInfo.getProperties().set(ViewProps.MIN_HEIGHT, Dp.m9685boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m9692equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m9692equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m9693hashCodeimpl(this.minWidth) * 31) + Dp.m9693hashCodeimpl(this.minHeight);
    }
}
