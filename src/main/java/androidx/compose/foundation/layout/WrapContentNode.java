...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo372measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m9642getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m9640getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m9641getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m9639getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int iCoerceIn = RangesKt.coerceIn(placeableMo8265measureBRTryo0.getWidth(), Constraints.m9642getMinWidthimpl(j), Constraints.m9640getMaxWidthimpl(j));
        final int iCoerceIn2 = RangesKt.coerceIn(placeableMo8265measureBRTryo0.getHeight(), Constraints.m9641getMinHeightimpl(j), Constraints.m9639getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, iCoerceIn, iCoerceIn2, null, new Function1() { // from class: androidx.compose.foundation.layout.WrapContentNode$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return WrapContentNode.measure_3p2s80s$lambda$0(this.f$0, iCoerceIn, placeableMo8265measureBRTryo0, iCoerceIn2, measureScope, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit measure_3p2s80s$lambda$0(WrapContentNode wrapContentNode, int i, Placeable placeable, int i2, MeasureScope measureScope, Placeable.PlacementScope placementScope) {
        Placeable.PlacementScope.m8331place70tqf50$default(placementScope, placeable, wrapContentNode.alignmentCallback.invoke(IntSize.m9850boximpl(IntSize.m9853constructorimpl((((long) (i - placeable.getWidth())) << 32) | (((long) (i2 - placeable.getHeight())) & 4294967295L))), measureScope.getLayoutDirection()).m9824unboximpl(), 0.0f, 2, null);
