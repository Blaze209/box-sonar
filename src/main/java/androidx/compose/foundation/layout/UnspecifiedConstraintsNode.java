...
final class UnspecifiedConstraintsNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m1289setMinWidth0680j_4(float f) {
        this.minWidth = f;
    }
    ...
    public final void m1288setMinHeight0680j_4(float f) {
        this.minHeight = f;
    }
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (!Float.isNaN(this.minWidth) && Constraints.m9642getMinWidthimpl(j) == 0) {
            int i = measureScope.mo748roundToPx0680j_4(this.minWidth);
            iM9642getMinWidthimpl = Constraints.m9640getMaxWidthimpl(j);
            if (i < 0) {
                i = 0;
            }
            if (i <= iM9642getMinWidthimpl) {
                iM9642getMinWidthimpl = i;
            }
        } else {
            iM9642getMinWidthimpl = Constraints.m9642getMinWidthimpl(j);
        }
        int iM9640getMaxWidthimpl = Constraints.m9640getMaxWidthimpl(j);
        if (!Float.isNaN(this.minHeight) && Constraints.m9641getMinHeightimpl(j) == 0) {
            int i2 = measureScope.mo748roundToPx0680j_4(this.minHeight);
            iM9641getMinHeightimpl = Constraints.m9639getMaxHeightimpl(j);
            int i3 = i2 >= 0 ? i2 : 0;
            if (i3 <= iM9641getMinHeightimpl) {
                iM9641getMinHeightimpl = i3;
            }
        } else {
            iM9641getMinHeightimpl = Constraints.m9641getMinHeightimpl(j);
        }
        final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(ConstraintsKt.Constraints(iM9642getMinWidthimpl, iM9640getMaxWidthimpl, iM9641getMinHeightimpl, Constraints.m9639getMaxHeightimpl(j)));
        return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo0.getWidth(), placeableMo8265measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.UnspecifiedConstraintsNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return UnspecifiedConstraintsNode.measure_3p2s80s$lambda$0(placeableMo8265measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        ...
        int i2 = !Float.isNaN(this.minWidth) ? intrinsicMeasureScope.mo748roundToPx0680j_4(this.minWidth) : 0;
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        ...
        int i2 = !Float.isNaN(this.minHeight) ? intrinsicMeasureScope.mo748roundToPx0680j_4(this.minHeight) : 0;
