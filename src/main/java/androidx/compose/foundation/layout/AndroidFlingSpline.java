...
final class AndroidFlingSpline {
    ...
    public final long m1059flingPositionLfoxSSI(float time) {
        float f;
        float f2;
        float f3 = 100;
        int i = (int) (f3 * time);
        ...
        return FlingResult.m1061constructorimpl((((long) Float.floatToRawIntBits(f)) << 32) | (((long) Float.floatToRawIntBits(f2)) & 4294967295L));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m1060boximpl(long j) {
            return new FlingResult(j);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static long m1061constructorimpl(long j) {
            return j;
        }

        /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
        public static boolean m1062equalsimpl(long j, Object obj) {
            return (obj instanceof FlingResult) && j == ((FlingResult) obj).getPackedValue();
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m1063equalsimpl0(long j, long j2) {
            return j == j2;
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m1066hashCodeimpl(long j) {
        ...
        public boolean equals(Object obj) {
            return m1062equalsimpl(this.packedValue, obj);
        }

        public int hashCode() {
            return m1066hashCodeimpl(this.packedValue);
        }

        public String toString() {
            return m1067toStringimpl(this.packedValue);
        }
        ...
        public static final float m1064getDistanceCoefficientimpl(long j) {
            return Float.intBitsToFloat((int) (j >> 32));
        }

        /* JADX INFO: renamed from: getVelocityCoefficient-impl, reason: not valid java name */
        public static final float m1065getVelocityCoefficientimpl(long j) {
