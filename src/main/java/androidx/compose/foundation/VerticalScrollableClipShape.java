...
final class VerticalScrollableClipShape implements Shape {
    ...
    public Outline mo655createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        return new Outline.Rectangle(new Rect(-fMo748roundToPx0680j_4, 0.0f, Float.intBitsToFloat((int) (size >> 32)) + fMo748roundToPx0680j_4, Float.intBitsToFloat((int) (size & 4294967295L))));
    }
}
