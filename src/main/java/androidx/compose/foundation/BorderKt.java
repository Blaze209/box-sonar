...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier modifier, BorderStroke borderStroke, Shape shape) {
        return m606borderziNgDLE(modifier, borderStroke.getWidth(), borderStroke.getBrush(), shape);
    }

    /* JADX INFO: renamed from: border-xT4_qwU$default, reason: not valid java name */
    public static /* synthetic */ Modifier m605borderxT4_qwU$default(Modifier modifier, float f, long j, Shape shape, int i, Object obj) {
        if ((i & 4) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m604borderxT4_qwU(modifier, f, j, shape);
    }

    /* JADX INFO: renamed from: border-xT4_qwU, reason: not valid java name */
    public static final Modifier m604borderxT4_qwU(Modifier modifier, float f, long j, Shape shape) {
        return m606borderziNgDLE(modifier, f, new SolidColor(j, null), shape);
    }

    /* JADX INFO: renamed from: border-ziNgDLE, reason: not valid java name */
    public static final Modifier m606borderziNgDLE(Modifier modifier, float f, Brush brush, Shape shape) {
    ...
    public static final DrawResult m607drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, final Brush brush, long j, long j2, boolean z, float f) {
        final long jM6585getZeroF1C5BW0 = z ? Offset.INSTANCE.m6585getZeroF1C5BW0() : j;
        final long jM6349getSizeNHjbRc = z ? cacheDrawScope.m6349getSizeNHjbRc() : j2;
        ...
        return cacheDrawScope.onDrawWithContent(new Function1() { // from class: androidx.compose.foundation.BorderKt$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return BorderKt.drawRectBorder_NsqcLGU$lambda$0(brush, jM6585getZeroF1C5BW0, jM6349getSizeNHjbRc, stroke, (ContentDrawScope) obj);
            }
        });
    }
    ...
    public static final Unit drawRectBorder_NsqcLGU$lambda$0(Brush brush, long j, long j2, DrawStyle drawStyle, ContentDrawScope contentDrawScope) {
        contentDrawScope.drawContent();
        DrawScope.m7388drawRectAsUm42w$default(contentDrawScope, brush, j, j2, 0.0f, drawStyle, null, 0, 104, null);
        return Unit.INSTANCE;
    }
    ...
    public static final Path createRoundRectPath(Path path, RoundRect roundRect, float f, boolean z) {
        ...
        if (!z) {
            ...
            path.mo6703opN5in7k0(path, Path, PathOperation.INSTANCE.m7122getDifferenceb3I0S0c());
        }
        return path;
    }

    private static final RoundRect createInsetRoundedRect(float f, RoundRect roundRect) {
        return new RoundRect(f, f, roundRect.getWidth() - f, roundRect.getHeight() - f, m608shrinkKibmq7A(roundRect.m6619getTopLeftCornerRadiuskKHJgLs(), f), m608shrinkKibmq7A(roundRect.m6620getTopRightCornerRadiuskKHJgLs(), f), m608shrinkKibmq7A(roundRect.m6618getBottomRightCornerRadiuskKHJgLs(), f), m608shrinkKibmq7A(roundRect.m6617getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: shrink-Kibmq7A, reason: not valid java name */
    public static final long m608shrinkKibmq7A(long j, float f) {
        ...
        return CornerRadius.m6523constructorimpl((((long) Float.floatToRawIntBits(fMax)) << 32) | (((long) Float.floatToRawIntBits(fMax2)) & 4294967295L));
    }
}
