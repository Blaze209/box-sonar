...
public final class TextFieldFocusModifier_androidKt {
    public static final Modifier interceptDPadAndMoveFocus(Modifier modifier, final LegacyTextFieldState legacyTextFieldState, final FocusManager focusManager) {
        return KeyInputModifierKt.onPreviewKeyEvent(modifier, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.foundation.text.TextFieldFocusModifier_androidKt.interceptDPadAndMoveFocus.1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m1732invokeZmokQxo(keyEvent.m7966unboximpl());
            }

            /* JADX INFO: renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m1732invokeZmokQxo(android.view.KeyEvent keyEvent) {
                InputDevice device = keyEvent.getDevice();
                boolean zMo6458moveFocus3ESFkO8 = false;
                if (device != null && device.supportsSource(InputDeviceCompat.SOURCE_DPAD) && ((!device.isVirtual() || keyEvent.getSource() == 33554433) && KeyEventType.m7970equalsimpl0(KeyEvent_androidKt.m7978getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m7974getKeyDownCS__XNY()) && keyEvent.getSource() != 257)) {
                    if (TextFieldFocusModifier_androidKt.m1731isKeyCodeYhN2O0w(keyEvent, 19)) {
                        zMo6458moveFocus3ESFkO8 = focusManager.mo6458moveFocus3ESFkO8(FocusDirection.INSTANCE.m6455getUpdhqQ8s());
                    } else if (TextFieldFocusModifier_androidKt.m1731isKeyCodeYhN2O0w(keyEvent, 20)) {
                        zMo6458moveFocus3ESFkO8 = focusManager.mo6458moveFocus3ESFkO8(FocusDirection.INSTANCE.m6448getDowndhqQ8s());
                    } else if (TextFieldFocusModifier_androidKt.m1731isKeyCodeYhN2O0w(keyEvent, 21)) {
                        zMo6458moveFocus3ESFkO8 = focusManager.mo6458moveFocus3ESFkO8(FocusDirection.INSTANCE.m6451getLeftdhqQ8s());
                    } else if (TextFieldFocusModifier_androidKt.m1731isKeyCodeYhN2O0w(keyEvent, 22)) {
                        zMo6458moveFocus3ESFkO8 = focusManager.mo6458moveFocus3ESFkO8(FocusDirection.INSTANCE.m6454getRightdhqQ8s());
                    } else if (TextFieldFocusModifier_androidKt.m1731isKeyCodeYhN2O0w(keyEvent, 23)) {
                        SoftwareKeyboardController keyboardController = legacyTextFieldState.getKeyboardController();
                        if (keyboardController != null) {
                            keyboardController.show();
                        }
                        zMo6458moveFocus3ESFkO8 = true;
                    }
                }
                return Boolean.valueOf(zMo6458moveFocus3ESFkO8);
            }
        });
    }
    ...
    public static final boolean m1731isKeyCodeYhN2O0w(android.view.KeyEvent keyEvent, int i) {
