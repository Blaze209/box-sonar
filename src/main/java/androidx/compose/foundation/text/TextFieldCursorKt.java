...
public final class TextFieldCursorKt {
    ...
    public static final Modifier cursor$lambda$0(final Brush brush, final LegacyTextFieldState legacyTextFieldState, final TextFieldValue textFieldValue, final OffsetMapping offsetMapping, Modifier modifier, Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        if (((WindowInfo) objConsume2).isWindowFocused() && legacyTextFieldState.getHasFocus() && TextRange.m9085getCollapsedimpl(textFieldValue.getSelection()) && z) {
            ...
            TextRange textRangeM9079boximpl = TextRange.m9079boximpl(textFieldValue.getSelection());
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            EffectsKt.LaunchedEffect(annotatedString, textRangeM9079boximpl, (Function2) objRememberedValue2, composer, 0);
    ...
    public static final Unit cursor$lambda$0$2$0(CursorAnimationState cursorAnimationState, OffsetMapping offsetMapping, TextFieldValue textFieldValue, LegacyTextFieldState legacyTextFieldState, Brush brush, ContentDrawScope contentDrawScope) {
        ...
        if (cursorAlpha != 0.0f) {
            int iOriginalToTransformed = offsetMapping.originalToTransformed(TextRange.m9091getStartimpl(textFieldValue.getSelection()));
            ...
            float fCoerceAtLeast = RangesKt.coerceAtLeast((float) Math.floor(contentDrawScope.mo754toPx0680j_4(TextFieldCursor_androidKt.getDefaultCursorThickness())), 1.0f);
            float f = fCoerceAtLeast / 2;
            float fCoerceAtLeast2 = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(rect.getLeft() + f, Float.intBitsToFloat((int) (contentDrawScope.mo7395getSizeNHjbRc() >> 32)) - f), f);
            if (((int) fCoerceAtLeast) % 2 == 1) {
                fRint = ((float) Math.floor(fCoerceAtLeast2)) + 0.5f;
            } else {
                fRint = (float) Math.rint(fCoerceAtLeast2);
            }
            DrawScope.m7380drawLine1RTmtNc$default(contentDrawScope, brush, Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(rect.getTop())) & 4294967295L) | (((long) Float.floatToRawIntBits(fRint)) << 32)), Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(rect.getBottom())) & 4294967295L) | (((long) Float.floatToRawIntBits(fRint)) << 32)), fCoerceAtLeast, 0, null, cursorAlpha, null, 0, 432, null);
        }
