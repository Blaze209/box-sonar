...
public interface TextAutoSize {
    ...
    long mo1581getFontSizeCi0_558(TextAutoSizeLayoutScope textAutoSizeLayoutScope, long j, AnnotatedString annotatedString);
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ TextAutoSize m1705StepBasedvU0ePk$default(Companion companion, long j, long j2, long j3, int i, Object obj) {
            if ((i & 1) != 0) {
                j = TextAutoSizeDefaults.INSTANCE.m1708getMinFontSizeXSAIIZE();
            }
            long j4 = j;
            if ((i & 2) != 0) {
                j2 = TextAutoSizeDefaults.INSTANCE.m1707getMaxFontSizeXSAIIZE();
            }
            long j5 = j2;
            if ((i & 4) != 0) {
                j3 = TextUnitKt.getSp(0.25d);
            }
            return companion.m1706StepBasedvU0ePk(j4, j5, j3);
        }

        /* JADX INFO: renamed from: StepBased-vU-0ePk, reason: not valid java name */
        public final TextAutoSize m1706StepBasedvU0ePk(long minFontSize, long maxFontSize, long stepSize) {
