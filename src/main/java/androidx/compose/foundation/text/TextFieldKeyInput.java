...
public final class TextFieldKeyInput {
    ...
    private final CommitTextCommand m1738typedCommandZmokQxo(KeyEvent event) {
        Integer numM1659consumeZmokQxo;
        if (TextFieldKeyInput_androidKt.m1745isTypedEventZmokQxo(event) && (numM1659consumeZmokQxo = this.keyCombiner.m1659consumeZmokQxo(event)) != null) {
            return new CommitTextCommand(StringHelpers_jvmKt.appendCodePointX(new StringBuilder(), numM1659consumeZmokQxo.intValue()).toString(), 1);
        }
        return null;
    }

    /* JADX INFO: renamed from: process-ZmokQxo, reason: not valid java name */
    public final boolean m1739processZmokQxo(KeyEvent event) {
        final KeyCommand keyCommandMo1663mapZmokQxo;
        CommitTextCommand commitTextCommandM1738typedCommandZmokQxo = m1738typedCommandZmokQxo(event);
        if (commitTextCommandM1738typedCommandZmokQxo != null) {
            if (!this.editable) {
                return false;
            }
            apply(commitTextCommandM1738typedCommandZmokQxo);
            this.preparedSelectionState.resetCachedX();
            return true;
        }
        if (!KeyEventType.m7970equalsimpl0(KeyEvent_androidKt.m7978getTypeZmokQxo(event), KeyEventType.INSTANCE.m7974getKeyDownCS__XNY()) || (keyCommandMo1663mapZmokQxo = this.keyMapping.mo1663mapZmokQxo(event)) == null || (keyCommandMo1663mapZmokQxo.getEditsText() && !this.editable)) {
            return false;
        }
        ...
        commandExecutionContext(new Function1() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return TextFieldKeyInput.process_ZmokQxo$lambda$1(keyCommandMo1663mapZmokQxo, this, booleanRef, (TextFieldPreparedSelection) obj);
            }
        });
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[keyCommand.ordinal()]) {
            ...
            case 26:
                if (!textFieldKeyInput.singleLine) {
                    ...
                    booleanRef.element = textFieldKeyInput.state.getOnImeActionPerformedWithResult().invoke(ImeAction.m9260boximpl(textFieldKeyInput.imeAction)).booleanValue();
                }
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$2(TextFieldPreparedSelection textFieldPreparedSelection) {
        ...
        return new DeleteSurroundingTextCommand(TextRange.m9086getEndimpl(textFieldPreparedSelection.getSelection()) - precedingCodePointOrEmojiStartIndex, 0);
    }
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$3(TextFieldPreparedSelection textFieldPreparedSelection) {
        ...
        if (nextCharacterIndex != -1) {
            return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m9086getEndimpl(textFieldPreparedSelection.getSelection()));
        }
        return null;
    }
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$4(TextFieldPreparedSelection textFieldPreparedSelection) {
        ...
        if (previousWordOffset != null) {
            deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m9086getEndimpl(textFieldPreparedSelection.getSelection()) - previousWordOffset.intValue(), 0);
        } else {
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$5(TextFieldPreparedSelection textFieldPreparedSelection) {
        ...
        return nextWordOffset != null ? new DeleteSurroundingTextCommand(0, nextWordOffset.intValue() - TextRange.m9086getEndimpl(textFieldPreparedSelection.getSelection())) : null;
    }
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$6(TextFieldPreparedSelection textFieldPreparedSelection) {
        ...
        if (lineStartByOffset != null) {
            deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m9086getEndimpl(textFieldPreparedSelection.getSelection()) - lineStartByOffset.intValue(), 0);
        } else {
            deleteSurroundingTextCommand = null;
        }
        return deleteSurroundingTextCommand;
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$7(TextFieldPreparedSelection textFieldPreparedSelection) {
        ...
        return lineEndByOffset != null ? new DeleteSurroundingTextCommand(0, lineEndByOffset.intValue() - TextRange.m9086getEndimpl(textFieldPreparedSelection.getSelection())) : null;
    }
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (TextRange.m9084equalsimpl0(textFieldPreparedSelection.getSelection(), this.value.getSelection()) && Intrinsics.areEqual(textFieldPreparedSelection.getAnnotatedString(), this.value.getAnnotatedString())) {
            return;
        }
