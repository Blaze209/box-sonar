...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m1759getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m1760getOffsetForPosition3MmeM6k(j, z);
    }

    /* JADX INFO: renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1760getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        if (coerceInVisibleBounds) {
            position = m1758coercedInVisibleBoundsOfInputTextMKHz9U(position);
        }
        return this.value.m9061getOffsetForPositionk4lQ0M(m1762translateDecorationToInnerCoordinatesMKHz9U$foundation(position));
    }
    ...
    public final boolean m1761isPositionOnTextk4lQ0M(long offset) {
        long jM1762translateDecorationToInnerCoordinatesMKHz9U$foundation = m1762translateDecorationToInnerCoordinatesMKHz9U$foundation(m1758coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Float.intBitsToFloat((int) (4294967295L & jM1762translateDecorationToInnerCoordinatesMKHz9U$foundation)));
        int i = (int) (jM1762translateDecorationToInnerCoordinatesMKHz9U$foundation >> 32);
    ...
    public final long m1762translateDecorationToInnerCoordinatesMKHz9U$foundation(long offset) {
        ...
        if (layoutCoordinates2 != null) {
            ...
            if (layoutCoordinates2 != null && (layoutCoordinates = this.decorationBoxCoordinates) != null) {
                ...
                if (layoutCoordinates3 != null) {
                    return layoutCoordinates2.mo8274localPositionOfR5De75A(layoutCoordinates3, offset);
                }
            }
        }
        return offset;
    ...
    public final long m1763translateInnerToDecorationCoordinatesMKHz9U$foundation(long offset) {
        LayoutCoordinates layoutCoordinates;
        LayoutCoordinates layoutCoordinates2 = this.innerTextFieldCoordinates;
        if (layoutCoordinates2 != null) {
            if (!layoutCoordinates2.isAttached()) {
            ...
            if (layoutCoordinates2 != null && (layoutCoordinates = this.decorationBoxCoordinates) != null) {
                LayoutCoordinates layoutCoordinates3 = layoutCoordinates.isAttached() ? layoutCoordinates : null;
                if (layoutCoordinates3 != null) {
                    return layoutCoordinates3.mo8274localPositionOfR5De75A(layoutCoordinates2, offset);
                }
            }
        }
        return offset;
    ...
    private final long m1758coercedInVisibleBoundsOfInputTextMKHz9U(long j) {
        Rect zero;
        ...
        return TextLayoutResultProxyKt.m1765coerceIn3MmeM6k(j, zero);
    }

    public final int getLineForVerticalPosition(float vertical) {
        return this.value.getLineForVerticalPosition(Float.intBitsToFloat((int) (m1762translateDecorationToInnerCoordinatesMKHz9U$foundation(m1758coercedInVisibleBoundsOfInputTextMKHz9U(Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(0.0f)) << 32) | (((long) Float.floatToRawIntBits(vertical)) & 4294967295L)))) & 4294967295L)));
    }
}
