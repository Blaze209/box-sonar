...
public final class TextDelegate {
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i, int i2, boolean z, int i3, Density density, FontFamily.Resolver resolver, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i4 & 4) != 0 ? Integer.MAX_VALUE : i, (i4 & 8) != 0 ? 1 : i2, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? TextOverflow.INSTANCE.m9583getClipgIe3tQ8() : i3, density, resolver, (i4 & 256) != 0 ? CollectionsKt.emptyList() : list, null);
    }
    ...
    private final MultiParagraph m1712layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        layoutIntrinsics(layoutDirection);
        int iM9642getMinWidthimpl = Constraints.m9642getMinWidthimpl(constraints);
        int iM9640getMaxWidthimpl = ((this.softWrap || TextOverflow.m9574equalsimpl0(this.overflow, TextOverflow.INSTANCE.m9584getEllipsisgIe3tQ8())) && Constraints.m9636getHasBoundedWidthimpl(constraints)) ? Constraints.m9640getMaxWidthimpl(constraints) : Integer.MAX_VALUE;
        int i = (this.softWrap || !TextOverflow.m9574equalsimpl0(this.overflow, TextOverflow.INSTANCE.m9584getEllipsisgIe3tQ8())) ? this.maxLines : 1;
        if (iM9642getMinWidthimpl != iM9640getMaxWidthimpl) {
            iM9640getMaxWidthimpl = RangesKt.coerceIn(getMaxIntrinsicWidth(), iM9642getMinWidthimpl, iM9640getMaxWidthimpl);
        }
        return new MultiParagraph(getNonNullIntrinsics(), Constraints.INSTANCE.m9649fitPrioritizingWidthZbe2FdA(0, iM9640getMaxWidthimpl, 0, Constraints.m9639getMaxHeightimpl(constraints)), i, this.overflow, (DefaultConstructorMarker) null);
    }

    /* JADX INFO: renamed from: layout-NN6Ew-U$default, reason: not valid java name */
    public static /* synthetic */ TextLayoutResult m1711layoutNN6EwU$default(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
        if ((i & 4) != 0) {
            textLayoutResult = null;
        }
        return textDelegate.m1714layoutNN6EwU(j, layoutDirection, textLayoutResult);
    }

    /* JADX INFO: renamed from: layout-NN6Ew-U, reason: not valid java name */
    public final TextLayoutResult m1714layoutNN6EwU(long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResult) {
        if (prevResult != null && TextLayoutHelperKt.m1756canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
            return prevResult.m9060copyO0kMr_c(new TextLayoutInput(prevResult.getLayoutInput().getText(), this.style, prevResult.getLayoutInput().getPlaceholders(), prevResult.getLayoutInput().getMaxLines(), prevResult.getLayoutInput().getSoftWrap(), prevResult.getLayoutInput().getOverflow(), prevResult.getLayoutInput().getDensity(), prevResult.getLayoutInput().getLayoutDirection(), prevResult.getLayoutInput().getFontFamilyResolver(), constraints, (DefaultConstructorMarker) null), ConstraintsKt.m9654constrain4WqzIAM(constraints, IntSize.m9853constructorimpl((((long) TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getHeight())) & 4294967295L) | (((long) TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getWidth())) << 32))));
        }
        MultiParagraph multiParagraphM1712layoutTextK40F9xA = m1712layoutTextK40F9xA(constraints, layoutDirection);
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints, (DefaultConstructorMarker) null), multiParagraphM1712layoutTextK40F9xA, ConstraintsKt.m9654constrain4WqzIAM(constraints, IntSize.m9853constructorimpl((((long) TextDelegateKt.ceilToIntPx(multiParagraphM1712layoutTextK40F9xA.getHeight())) & 4294967295L) | (((long) TextDelegateKt.ceilToIntPx(multiParagraphM1712layoutTextK40F9xA.getWidth())) << 32))), null);
    }
