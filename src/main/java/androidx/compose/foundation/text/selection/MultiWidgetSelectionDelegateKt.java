...
public final class MultiWidgetSelectionDelegateKt {
    ...
    public static final void m2120appendSelectableInfoParwq6A(SelectionLayoutBuilder selectionLayoutBuilder, TextLayoutResult textLayoutResult, long j, long j2, long j3) {
        Direction direction;
        ...
        int iM2121getOffsetForPosition3MmeM6k;
        ...
        Direction directionM2122getXDirection3MmeM6k = m2122getXDirection3MmeM6k(j, rect);
        Direction directionM2123getYDirection3MmeM6k = m2123getYDirection3MmeM6k(j, rect);
        if (selectionLayoutBuilder.getIsStartHandle()) {
            Selection previousSelection = selectionLayoutBuilder.getPreviousSelection();
            direction = directionM2123getYDirection3MmeM6k;
            direction2 = directionM2122getXDirection3MmeM6k;
            j4 = j3;
        ...
        if (isSelected(SelectionLayoutKt.resolve2dDirection(direction2, direction), direction5)) {
            ...
            if (selectionLayoutBuilder.getIsStartHandle()) {
                previousAdjustedOffset = m2121getOffsetForPosition3MmeM6k(j, textLayoutResult);
                Selection previousSelection3 = selectionLayoutBuilder.getPreviousSelection();
                iM2121getOffsetForPosition3MmeM6k = (previousSelection3 == null || (end = previousSelection3.getEnd()) == null) ? previousAdjustedOffset : getPreviousAdjustedOffset(end, selectionLayoutBuilder.getSelectableIdOrderingComparator(), j4, length);
            } else {
                iM2121getOffsetForPosition3MmeM6k = m2121getOffsetForPosition3MmeM6k(j, textLayoutResult);
                Selection previousSelection4 = selectionLayoutBuilder.getPreviousSelection();
                previousAdjustedOffset = (previousSelection4 == null || (start = previousSelection4.getStart()) == null) ? iM2121getOffsetForPosition3MmeM6k : getPreviousAdjustedOffset(start, selectionLayoutBuilder.getSelectableIdOrderingComparator(), j4, length);
            }
            selectionLayoutBuilder.appendInfo(j4, previousAdjustedOffset, direction4, directionAppendSelectableInfo_Parwq6A$otherDirection, iM2121getOffsetForPosition3MmeM6k, direction3, directionAppendSelectableInfo_Parwq6A$otherDirection2, (9223372034707292159L & j2) == InlineClassHelperKt.UnspecifiedPackedFloats ? -1 : m2121getOffsetForPosition3MmeM6k(j2, textLayoutResult), textLayoutResult);
        }
    }
    ...
    private static final Direction m2122getXDirection3MmeM6k(long j, Rect rect) {
        int i = (int) (j >> 32);
    ...
    private static final Direction m2123getYDirection3MmeM6k(long j, Rect rect) {
    ...
    private static final int m2121getOffsetForPosition3MmeM6k(long j, TextLayoutResult textLayoutResult) {
        ...
        return textLayoutResult.m9061getOffsetForPositionk4lQ0M(j);
    }
}
