...
public final class TextSelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m6815equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }

    public int hashCode() {
        return (Color.m6821hashCodeimpl(this.handleColor) * 31) + Color.m6821hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m6822toStringimpl(this.handleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m6822toStringimpl(this.backgroundColor)) + ')';
    }
}
