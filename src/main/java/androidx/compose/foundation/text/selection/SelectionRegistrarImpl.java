...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
    ...
    public static final int sort$lambda$0(LayoutCoordinates layoutCoordinates, Selectable selectable, Selectable selectable2) {
        ...
        long jM6585getZeroF1C5BW1;
        long jM6585getZeroF1C5BW2;
        long jM6585getZeroF1C5BW3;
        ...
        if (layoutCoordinates2 != null) {
            jM6585getZeroF1C5BW0 = layoutCoordinates.mo8274localPositionOfR5De75A(layoutCoordinates2, Offset.INSTANCE.m6585getZeroF1C5BW0());
            float fIntBitsToFloat = Float.intBitsToFloat((int) (jM6585getZeroF1C5BW0 >> 32)) + ((int) (layoutCoordinates2.mo8273getSizeYbymL2g() >> 32));
            jM6585getZeroF1C5BW1 = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (jM6585getZeroF1C5BW0 & 4294967295L)) + ((int) (layoutCoordinates2.mo8273getSizeYbymL2g() & 4294967295L)))) & 4294967295L) | (Float.floatToRawIntBits(fIntBitsToFloat) << 32));
        } else {
            jM6585getZeroF1C5BW0 = Offset.INSTANCE.m6585getZeroF1C5BW0();
            jM6585getZeroF1C5BW1 = Offset.INSTANCE.m6585getZeroF1C5BW0();
        }
        long j = jM6585getZeroF1C5BW0;
        long j2 = jM6585getZeroF1C5BW1;
        if (layoutCoordinates3 != null) {
            jM6585getZeroF1C5BW2 = layoutCoordinates.mo8274localPositionOfR5De75A(layoutCoordinates3, Offset.INSTANCE.m6585getZeroF1C5BW0());
            float fIntBitsToFloat2 = Float.intBitsToFloat((int) (jM6585getZeroF1C5BW2 >> 32)) + ((int) (layoutCoordinates3.mo8273getSizeYbymL2g() >> 32));
            jM6585getZeroF1C5BW3 = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (jM6585getZeroF1C5BW2 & 4294967295L)) + ((int) (layoutCoordinates3.mo8273getSizeYbymL2g() & 4294967295L)))) & 4294967295L) | (Float.floatToRawIntBits(fIntBitsToFloat2) << 32));
        } else {
            jM6585getZeroF1C5BW2 = Offset.INSTANCE.m6585getZeroF1C5BW0();
            jM6585getZeroF1C5BW3 = Offset.INSTANCE.m6585getZeroF1C5BW0();
        }
        long j3 = jM6585getZeroF1C5BW2;
        if (SelectionRegistrarImplKt.m2193inARowzwwh4xc(j, j2, j3, jM6585getZeroF1C5BW3)) {
    ...
    public void mo2192notifySelectionUpdateStartubNVwUQ(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function4 != null) {
            function4.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m6558boximpl(startPosition), adjustment);
        }
    }
    ...
    public boolean mo2191notifySelectionUpdatenjBpvok(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function6 != null) {
            return function6.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m6558boximpl(newPosition), Offset.m6558boximpl(previousPosition), Boolean.valueOf(isStartHandle), adjustment).booleanValue();
        }
        return true;
    }
