...
public final class TextFieldSelectionManager_androidKt {
    ...
    public static final Offset textFieldMagnifier$lambda$0$3$0(TextFieldSelectionManager textFieldSelectionManager, MutableState mutableState) {
        return Offset.m6558boximpl(TextFieldSelectionManagerKt.m2222calculateSelectionMagnifierCenterAndroidO0kMr_c(textFieldSelectionManager, textFieldMagnifier$lambda$0$1(mutableState)));
    }
    ...
    public static final Modifier textFieldMagnifier$lambda$0$4$0(final Density density, final MutableState mutableState, final Function0 function0) {
        return Magnifier_androidKt.m671magnifierjPUL71Q$default(Modifier.INSTANCE, new Function1() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$$ExternalSyntheticLambda10
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static final Unit textFieldMagnifier$lambda$0$4$0$1(Density density, MutableState mutableState, DpSize dpSize) {
        textFieldMagnifier$lambda$0$2(mutableState, IntSize.m9853constructorimpl((((long) density.mo748roundToPx0680j_4(DpSize.m9785getWidthD9Ej5fM(dpSize.getPackedValue()))) << 32) | (((long) density.mo748roundToPx0680j_4(DpSize.m9783getHeightD9Ej5fM(dpSize.getPackedValue()))) & 4294967295L)));
    ...
    static /* synthetic */ void addBasicTextFieldTextContextMenuComponents$lambda$0$textFieldItem$default(TextContextMenuBuilderScope textContextMenuBuilderScope, Context context, TextContextMenuItems textContextMenuItems, boolean z, Function0 function0, Function0 function1, int i, Object obj) {
        if ((i & 8) != 0) {
            function0 = null;
        }
    ...
    public static final Unit addBasicTextFieldTextContextMenuComponents$lambda$0(final TextFieldSelectionManager textFieldSelectionManager, final CoroutineScope coroutineScope, TextContextMenuBuilderScope textContextMenuBuilderScope, final Context context) {
        ...
        if (latestSelection != null) {
            ...
            textRangeM9079boximpl = TextRange.m9079boximpl(TextRangeKt.TextRange(offsetMapping.originalToTransformed(TextRange.m9091getStartimpl(packedValue)), offsetMapping.originalToTransformed(TextRange.m9086getEndimpl(packedValue))));
        }
        PlatformSelectionBehaviors_androidKt.m2136addPlatformTextContextMenuItems71BSaZU(textContextMenuBuilderScope, context, editable, text, textRangeM9079boximpl, textFieldSelectionManager.getPlatformSelectionBehaviors(), new Function1() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$$ExternalSyntheticLambda5
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
