...
public interface MouseSelectionObserver {
    ...
    boolean mo2039onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment);

    void onDragDone();

    /* JADX INFO: renamed from: onExtend-k-4lQ0M */
    boolean mo2040onExtendk4lQ0M(long downPosition);

    /* JADX INFO: renamed from: onExtendDrag-k-4lQ0M */
    boolean mo2041onExtendDragk4lQ0M(long dragPosition);

    /* JADX INFO: renamed from: onStart-9KIMszo */
    boolean mo2042onStart9KIMszo(long downPosition, SelectionAdjustment adjustment, int clickCount);
}
