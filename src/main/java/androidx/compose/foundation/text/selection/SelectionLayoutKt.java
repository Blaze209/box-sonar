...
public final class SelectionLayoutKt {
    ...
    public static final SelectionLayout m2152getTextFieldSelectionLayoutRcvTLA(TextLayoutResult textLayoutResult, int i, int i2, int i3, long j, boolean z, boolean z2) {
        return new SingleSelectionLayout(z2, 1, 1, z ? null : new Selection(new Selection.AnchorInfo(SelectionHelpersKt.getTextDirectionForOffset(textLayoutResult, TextRange.m9091getStartimpl(j)), TextRange.m9091getStartimpl(j), 1L), new Selection.AnchorInfo(SelectionHelpersKt.getTextDirectionForOffset(textLayoutResult, TextRange.m9086getEndimpl(j)), TextRange.m9086getEndimpl(j), 1L), TextRange.m9090getReversedimpl(j)), new SelectableInfo(1L, 1, i, i2, i3, textLayoutResult));
    }
