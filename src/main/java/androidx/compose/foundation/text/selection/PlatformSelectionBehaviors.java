...
public interface PlatformSelectionBehaviors {
    ...
    Object mo2124onShowContextMenu_2OEclM(CharSequence charSequence, long j, Offset offset, Continuation<? super Unit> continuation);

    /* JADX INFO: renamed from: onShowSelectionToolbar-Sb-Bc2M, reason: not valid java name */
    Object mo2125onShowSelectionToolbarSbBc2M(CharSequence charSequence, long j, Continuation<? super Unit> continuation);

    /* JADX INFO: renamed from: suggestSelectionForLongPressOrDoubleClick-pYaCw-w, reason: not valid java name */
    Object mo2126suggestSelectionForLongPressOrDoubleClickpYaCww(CharSequence charSequence, long j, Continuation<? super TextRange> continuation);
}
