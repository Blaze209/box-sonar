...
public final class MultiWidgetSelectionDelegate implements Selectable {
    ...
    public void appendSelectableInfoToBuilder(SelectionLayoutBuilder builder) {
        ...
        long jM6573minusMKHz9U;
        LayoutCoordinates layoutCoordinates = getLayoutCoordinates();
        if (layoutCoordinates == null || (textLayoutResultInvoke = this.layoutResultCallback.invoke()) == null) {
            return;
        }
        long jMo8274localPositionOfR5De75A = builder.getContainerCoordinates().mo8274localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m6585getZeroF1C5BW0());
        long jM6573minusMKHz9U2 = Offset.m6573minusMKHz9U(builder.getCurrentPosition(), jMo8274localPositionOfR5De75A);
        if ((builder.getPreviousHandlePosition() & 9223372034707292159L) == InlineClassHelperKt.UnspecifiedPackedFloats) {
            jM6573minusMKHz9U = Offset.INSTANCE.m6584getUnspecifiedF1C5BW0();
        } else {
            jM6573minusMKHz9U = Offset.m6573minusMKHz9U(builder.getPreviousHandlePosition(), jMo8274localPositionOfR5De75A);
        }
        MultiWidgetSelectionDelegateKt.m2120appendSelectableInfoParwq6A(builder, textLayoutResultInvoke, jM6573minusMKHz9U2, jM6573minusMKHz9U, getSelectableId());
    }
    ...
    public long mo2118getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle) {
        TextLayoutResult textLayoutResultInvoke;
    ...
    public long mo2119getRangeOfLineContainingjx7JFs(int offset) {
        TextLayoutResult textLayoutResultInvoke = this.layoutResultCallback.invoke();
        if (textLayoutResultInvoke == null) {
