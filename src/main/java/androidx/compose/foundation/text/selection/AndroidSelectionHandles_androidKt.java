...
public final class AndroidSelectionHandles_androidKt {
    ...
    public static final Unit SelectionHandle_wLIcFTc$lambda$2(OffsetProvider offsetProvider, boolean z, ResolvedTextDirection resolvedTextDirection, boolean z2, long j, float f, Modifier modifier, int i, int i2, Composer composer, int i3) {
        m2113SelectionHandlewLIcFTc(offsetProvider, z, resolvedTextDirection, z2, j, f, modifier, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
        return Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: SelectionHandle-wLIcFTc, reason: not valid java name */
    public static final void m2113SelectionHandlewLIcFTc(final OffsetProvider offsetProvider, final boolean z, final ResolvedTextDirection resolvedTextDirection, final boolean z2, long j, final float f, final Modifier modifier, Composer composer, final int i, final int i2) {
        int i3;
        long jM9794getUnspecifiedMYxV2XQ;
        ...
        if ((i & 24576) == 0) {
            jM9794getUnspecifiedMYxV2XQ = j;
            i3 |= ((i2 & 16) == 0 && composerStartRestartGroup.changed(jM9794getUnspecifiedMYxV2XQ)) ? 16384 : 8192;
        } else {
            jM9794getUnspecifiedMYxV2XQ = j;
        }
        if ((1572864 & i) == 0) {
        ...
        if (composerStartRestartGroup.shouldExecute((533651 & i3) != 533650, i3 & 1)) {
            ...
            if ((i & 1) != 0 && !composerStartRestartGroup.getDefaultsInvalid()) {
                ...
                jM9794getUnspecifiedMYxV2XQ = DpSize.INSTANCE.m9794getUnspecifiedMYxV2XQ();
                i3 &= -57345;
            }
            ...
            final long j2 = jM9794getUnspecifiedMYxV2XQ;
            ...
            jM9794getUnspecifiedMYxV2XQ = j2;
        } else {
            composerStartRestartGroup.skipToGroupEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
        if (scopeUpdateScopeEndRestartGroup != null) {
            final long j3 = jM9794getUnspecifiedMYxV2XQ;
    ...
    public static final Unit SelectionHandle_wLIcFTc$lambda$0$0(OffsetProvider offsetProvider, boolean z, boolean z2, SemanticsPropertyReceiver semanticsPropertyReceiver) {
        long jMo1598provideF1C5BW0 = offsetProvider.mo1598provideF1C5BW0();
        semanticsPropertyReceiver.set(SelectionHandlesKt.getSelectionHandleInfoKey(), new SelectionHandleInfo(z ? Handle.SelectionStart : Handle.SelectionEnd, jMo1598provideF1C5BW0, z2 ? SelectionHandleAnchor.Left : SelectionHandleAnchor.Right, (9223372034707292159L & jMo1598provideF1C5BW0) != InlineClassHelperKt.UnspecifiedPackedFloats, null));
        return Unit.INSTANCE;
    }
    ...
    public static final boolean SelectionHandle_wLIcFTc$lambda$1$0$0$0$0(OffsetProvider offsetProvider) {
        return (offsetProvider.mo1598provideF1C5BW0() & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats;
    }
    ...
    public static final void SelectionHandleIcon(final Modifier modifier, final Function0<Boolean> function0, final boolean z, Composer composer, final int i) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i2 & Token.DOTQUERY) != 146, i2 & 1)) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m1268sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), function0, z), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final DrawResult drawSelectionHandle$lambda$0$0$0(long j, final Function0 function0, final boolean z, CacheDrawScope cacheDrawScope) {
        final ImageBitmap imageBitmapCreateHandleImage = createHandleImage(cacheDrawScope, Float.intBitsToFloat((int) (cacheDrawScope.m6349getSizeNHjbRc() >> 32)) / 2.0f);
        ...
        return cacheDrawScope.onDrawWithContent(new Function1() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$$ExternalSyntheticLambda9
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return AndroidSelectionHandles_androidKt.drawSelectionHandle$lambda$0$0$0$0(function0, z, imageBitmapCreateHandleImage, colorFilterM6855tintxETnrds$default, (ContentDrawScope) obj);
            }
        });
    }
    ...
    public static final Unit drawSelectionHandle$lambda$0$0$0$0(Function0 function0, boolean z, ImageBitmap imageBitmap, ColorFilter colorFilter, ContentDrawScope contentDrawScope) {
        ...
        if (z) {
            ...
            DrawScope.m7379drawImagegbVJVH8$default(contentDrawScope, imageBitmap, 0L, 0.0f, null, colorFilter, 0, 46, null);
        }
        return Unit.INSTANCE;
    }
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope cacheDrawScope, float f) {
        ...
        if (imageBitmap == null || canvas == null || iCeil > imageBitmap.getWidth() || iCeil > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m7052ImageBitmapx__hDU$default(iCeil, iCeil, ImageBitmapConfig.INSTANCE.m7046getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        long jM6629constructorimpl = Size.m6629constructorimpl((((long) Float.floatToRawIntBits(imageBitmap2.getWidth())) << 32) | (((long) Float.floatToRawIntBits(imageBitmap2.getHeight())) & 4294967295L));
        ...
        drawParams2.m7315setSizeuvyYCjk(jM6629constructorimpl);
        canvas2.save();
        CanvasDrawScope canvasDrawScope3 = canvasDrawScope2;
        DrawScope.m7389drawRectnJ9OG0$default(canvasDrawScope3, Color.INSTANCE.m6840getBlack0d7_KjU(), 0L, canvasDrawScope3.mo7395getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m6727getClear0nO6VwU(), 58, null);
        DrawScope.m7389drawRectnJ9OG0$default(canvasDrawScope3, ColorKt.Color(4278190080L), Offset.INSTANCE.m6585getZeroF1C5BW0(), Size.m6629constructorimpl((((long) Float.floatToRawIntBits(f)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32)), 0.0f, null, null, 0, 120, null);
        DrawScope.m7376drawCircleVaOC9Bg$default(canvasDrawScope3, ColorKt.Color(4278190080L), f, Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(f)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32)), 0.0f, null, null, 0, 120, null);
        canvas2.restore();
