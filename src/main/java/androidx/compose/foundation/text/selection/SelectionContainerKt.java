...
public final class SelectionContainerKt {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$$ExternalSyntheticLambda11
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return SelectionContainerKt.SelectionContainer$lambda$4(modifier, function3, i, i2, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final void SelectionContainer(Modifier modifier, final Selection selection, final Function1<? super Selection, Unit> function1, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i3 & 1171) != 1170, i3 & 1)) {
            ...
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            final SelectionRegistrarImpl selectionRegistrarImpl = (SelectionRegistrarImpl) RememberSaveableKt.m6247rememberSaveable(objArr, (Saver) saver, (Function0) objRememberedValue, composerStartRestartGroup, 384);
            ...
            if (!selectionManager.isInTouchMode() || !selectionManager.getHasFocus() || selectionManager.isTriviallyCollapsedSelection$foundation()) {
                ...
                if (selection == null) {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        ...
                        ComposerKt.sourceInformationMarkerEnd(composer);
                        AndroidSelectionHandles_androidKt.m2113SelectionHandlewLIcFTc(selectionContainerKt$sam$androidx_compose_foundation_text_selection_OffsetProvider$0, zBooleanValue, direction, handlesCrossed, 0L, f, SuspendingPointerInputFilterKt.pointerInput(companion, textDragObserver, (PointerInputEventHandler) objRememberedValue3), composer, 0, 16);
                    }
    ...
    public static final Offset SelectionContainer$lambda$9$0$0$0$0$1$0(SelectionManager selectionManager) {
        Offset offsetM2175getStartHandlePosition_m7T9E = selectionManager.m2175getStartHandlePosition_m7T9E();
        return Offset.m6558boximpl(offsetM2175getStartHandlePosition_m7T9E != null ? offsetM2175getStartHandlePosition_m7T9E.m6579unboximpl() : Offset.INSTANCE.m6584getUnspecifiedF1C5BW0());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Offset SelectionContainer$lambda$9$0$0$0$0$1$1(SelectionManager selectionManager) {
        Offset offsetM2174getEndHandlePosition_m7T9E = selectionManager.m2174getEndHandlePosition_m7T9E();
        return Offset.m6558boximpl(offsetM2174getEndHandlePosition_m7T9E != null ? offsetM2174getEndHandlePosition_m7T9E.m6579unboximpl() : Offset.INSTANCE.m6584getUnspecifiedF1C5BW0());
    }
