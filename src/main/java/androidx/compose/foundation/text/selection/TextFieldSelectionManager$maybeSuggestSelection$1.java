...
final class TextFieldSelectionManager$maybeSuggestSelection$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = this.$platformSelectionBehaviors.mo2126suggestSelectionForLongPressOrDoubleClickpYaCww(this.$text, this.$transformedSelection, this);
        ...
        if (textRange != null) {
            ...
            long jTextRange = TextRangeKt.TextRange(offsetMapping.transformedToOriginal(TextRange.m9091getStartimpl(packedValue)), offsetMapping.transformedToOriginal(TextRange.m9086getEndimpl(packedValue)));
            if (!TextRange.m9083equalsimpl(jTextRange, this.$selection) && Intrinsics.areEqual(this.this$0.getValue$foundation().getText(), this.$text) && this.$offsetMapping == this.this$0.getOffsetMapping()) {
                Function1<TextFieldValue, Unit> onValueChange$foundation = this.this$0.getOnValueChange$foundation();
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                onValueChange$foundation.invoke(textFieldSelectionManager.m2204createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation().getAnnotatedString(), jTextRange));
                this.this$0.m2216setLatestSelectionOEnZFl4$foundation(TextRange.m9079boximpl(jTextRange));
            }
