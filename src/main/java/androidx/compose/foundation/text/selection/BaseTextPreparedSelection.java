...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final void m2116setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final int getPrecedingCodePointOrEmojiStartIndex() {
        return StringHelpers_androidKt.findCodePointOrEmojiStartBefore(this.annotatedString.getText(), TextRange.m9086getEndimpl(this.selection), -1);
    }

    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m9086getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m9086getEndimpl(this.selection));
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.originalText.length()) {
            ...
            if (TextRange.m9086getEndimpl(jM9063getWordBoundaryjx7JFs) > i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m9086getEndimpl(jM9063getWordBoundaryjx7JFs));
            }
            i++;
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            ...
            if (TextRange.m9091getStartimpl(jM9063getWordBoundaryjx7JFs) < i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m9091getStartimpl(jM9063getWordBoundaryjx7JFs));
            }
            i--;
        }
        return 0;
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        ...
        return this.offsetMapping.transformedToOriginal(textLayoutResult.m9061getOffsetForPositionk4lQ0M(Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(f.floatValue())) << 32) | (((long) Float.floatToRawIntBits(lineBottom)) & 4294967295L))));
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m9086getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m9089getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m9088getMaximpl(this.selection));
    }
    ...
    public final T deselect() {
        getState().resetCachedX();
        if (getText$foundation().length() > 0) {
            setCursor(TextRange.m9086getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation().length() > 0) {
            if (TextRange.m9085getCollapsedimpl(this.selection)) {
                ...
                setCursor(TextRange.m9089getMinimpl(this.selection));
            } else {
                setCursor(TextRange.m9088getMaximpl(this.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final T moveCursorPrevByParagraph() {
        getState().resetCachedX();
        if (getText$foundation().length() > 0) {
            int iFindParagraphStart = StringHelpersKt.findParagraphStart(getText$foundation(), TextRange.m9089getMinimpl(this.selection));
    ...
    public final T moveCursorNextByParagraph() {
        getState().resetCachedX();
        if (getText$foundation().length() > 0) {
            int iFindParagraphEnd = StringHelpersKt.findParagraphEnd(getText$foundation(), TextRange.m9088getMaximpl(this.selection));
            if (iFindParagraphEnd == TextRange.m9088getMaximpl(this.selection) && iFindParagraphEnd != getText$foundation().length()) {
    ...
    public final T selectMovement() {
        if (getText$foundation().length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m9091getStartimpl(this.originalSelection), TextRange.m9086getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
