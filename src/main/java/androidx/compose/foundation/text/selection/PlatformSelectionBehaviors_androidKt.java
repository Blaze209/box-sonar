...
public final class PlatformSelectionBehaviors_androidKt {
    ...
    public static final boolean m2137canReuseh5sm0ck(TextClassificationResult textClassificationResult, CharSequence charSequence, long j) {
        return TextRange.m9084equalsimpl0(j, textClassificationResult.m2197getSelectiond9O1mEE()) && Intrinsics.areEqual(charSequence, textClassificationResult.getText());
    }

    /* JADX INFO: renamed from: addPlatformTextContextMenuItems-71BSaZU, reason: not valid java name */
    public static final void m2136addPlatformTextContextMenuItems71BSaZU(TextContextMenuBuilderScope textContextMenuBuilderScope, Context context, boolean z, CharSequence charSequence, TextRange textRange, PlatformSelectionBehaviors platformSelectionBehaviors, Function1<? super TextContextMenuBuilderScope, Unit> function1) {
        if (charSequence == null || textRange == null || platformSelectionBehaviors == null || !(platformSelectionBehaviors instanceof PlatformSelectionBehaviorsImpl)) {
            ...
            ProcessText_androidKt.m1773addProcessedTextContextMenuItemsUAq72N0(textContextMenuBuilderScope, context, z, charSequence, textRange.getPackedValue());
            return;
        }
        ((PlatformSelectionBehaviorsImpl) platformSelectionBehaviors).m2131addSmartSelectionTextContextMenuItemsYmzfRxQ$foundation(textContextMenuBuilderScope, charSequence, textRange.getPackedValue(), function1);
        ProcessText_androidKt.m1773addProcessedTextContextMenuItemsUAq72N0(textContextMenuBuilderScope, context, z, charSequence, textRange.getPackedValue());
    }
}
