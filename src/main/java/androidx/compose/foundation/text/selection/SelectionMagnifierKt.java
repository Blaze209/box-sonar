...
public final class SelectionMagnifierKt {
    ...
    static {
        long jM6561constructorimpl = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(0.01f)) << 32) | (((long) Float.floatToRawIntBits(0.01f)) & 4294967295L));
        OffsetDisplacementThreshold = jM6561constructorimpl;
        MagnifierSpringSpec = new SpringSpec<>(0.0f, 0.0f, Offset.m6558boximpl(jM6561constructorimpl), 3, null);
    }
    ...
    public static final AnimationVector2D UnspecifiedSafeOffsetVectorConverter$lambda$0(Offset offset) {
        if ((offset.m6579unboximpl() & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats) {
    ...
    public static final Offset animatedSelectionMagnifier$lambda$0$1$0(State state) {
        return Offset.m6558boximpl(animatedSelectionMagnifier$lambda$0$0(state));
    }
    ...
    private static final State<Offset> rememberAnimatedMagnifierPosition(Function0<Offset> function0, Composer composer, int i) {
        ...
        if (objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
            Object animatable = new Animatable(Offset.m6558boximpl(rememberAnimatedMagnifierPosition$lambda$1(state)), UnspecifiedSafeOffsetVectorConverter, Offset.m6558boximpl(OffsetDisplacementThreshold), null, 8, null);
