...
public final class TextFieldSelectionManagerKt {
        ...
        if (!composerStartRestartGroup.shouldExecute((i2 & Token.DOTQUERY) != 146, i2 & 1)) {
            ...
            if (zChangedInstance || offsetProviderRememberedValue == Composer.INSTANCE.getEmpty()) {
                offsetProviderRememberedValue = new OffsetProvider() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$TextFieldSelectionHandle$1$1
                    ...
                    public final long mo1598provideF1C5BW0() {
                        return textFieldSelectionManager.m2212getHandlePositiontuRUvjQ$foundation(z);
                    }
                };
            ...
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            boolean zM9090getReversedimpl = TextRange.m9090getReversedimpl(textFieldSelectionManager.getValue$foundation().getSelection());
    ...
    public static final boolean isSelectionHandleInVisibleBoundDefault(TextFieldSelectionManager textFieldSelectionManager, boolean z) {
        ...
        return SelectionManagerKt.m2182containsInclusiveUv8p0NA(rectVisibleBounds, textFieldSelectionManager.m2212getHandlePositiontuRUvjQ$foundation(z));
    }

    /* JADX INFO: renamed from: calculateSelectionMagnifierCenterAndroid-O0kMr_c, reason: not valid java name */
    public static final long m2222calculateSelectionMagnifierCenterAndroidO0kMr_c(TextFieldSelectionManager textFieldSelectionManager, long j) {
        ...
        if (offsetM2210getCurrentDragPosition_m7T9E == null) {
            return Offset.INSTANCE.m6584getUnspecifiedF1C5BW0();
        }
        long jM6579unboximpl = offsetM2210getCurrentDragPosition_m7T9E.m6579unboximpl();
        ...
        if (i == 1 || i == 2) {
            iM9091getStartimpl = TextRange.m9091getStartimpl(textFieldSelectionManager.getValue$foundation().getSelection());
        } else {
            if (i != 3) {
                throw new NoWhenBranchMatchedException();
            }
            iM9091getStartimpl = TextRange.m9086getEndimpl(textFieldSelectionManager.getValue$foundation().getSelection());
        }
        LegacyTextFieldState state = textFieldSelectionManager.getState();
        ...
        int iCoerceIn = RangesKt.coerceIn(textFieldSelectionManager.getOffsetMapping().originalToTransformed(iM9091getStartimpl), 0, text.length());
        float fIntBitsToFloat = Float.intBitsToFloat((int) (layoutResult.m1762translateDecorationToInnerCoordinatesMKHz9U$foundation(jM6579unboximpl) >> 32));
        ...
        if (!IntSize.m9856equalsimpl0(j, IntSize.INSTANCE.m9863getZeroYbymL2g()) && Math.abs(fIntBitsToFloat - fCoerceIn) > ((int) (j >> 32)) / 2) {
            return Offset.INSTANCE.m6584getUnspecifiedF1C5BW0();
        }
        float lineTop = value.getLineTop(lineForOffset);
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(fCoerceIn)) << 32) | (((long) Float.floatToRawIntBits(((value.getLineBottom(lineForOffset) - lineTop) / 2) + lineTop)) & 4294967295L));
    }
    ...
    public static final Unit contextMenuBuilder$lambda$0(State state, final TextFieldSelectionManager textFieldSelectionManager, ContextMenuState contextMenuState, ContextMenuScope contextMenuScope) {
        int iM1703unboximpl = ((MenuItemsAvailability) state.getValue()).m1703unboximpl();
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, TextContextMenuItems.Cut, MenuItemsAvailability.m1698getCanCutimpl(iM1703unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return TextFieldSelectionManagerKt.contextMenuBuilder$lambda$0$0(textFieldSelectionManager);
            }
        });
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, TextContextMenuItems.Copy, MenuItemsAvailability.m1697getCanCopyimpl(iM1703unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return TextFieldSelectionManagerKt.contextMenuBuilder$lambda$0$1(textFieldSelectionManager);
            }
        });
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, TextContextMenuItems.Paste, MenuItemsAvailability.m1699getCanPasteimpl(iM1703unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return TextFieldSelectionManagerKt.contextMenuBuilder$lambda$0$2(textFieldSelectionManager);
            }
        });
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, TextContextMenuItems.SelectAll, MenuItemsAvailability.m1700getCanSelectAllimpl(iM1703unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$$ExternalSyntheticLambda5
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        if (PlatformUtils_androidKt.isAutofillAvailable()) {
            contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, TextContextMenuItems.Autofill, MenuItemsAvailability.m1696getCanAutofillimpl(iM1703unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$$ExternalSyntheticLambda6
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
