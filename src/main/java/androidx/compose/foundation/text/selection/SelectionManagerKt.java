...
public final class SelectionManagerKt {
    ...
    public static final Rect getSelectedRegionRect(List<? extends Pair<? extends Selectable, Selection>> list, LayoutCoordinates layoutCoordinates) {
        ...
        while (i < size) {
            ...
            if (offset != offset2 && (layoutCoordinates2 = selectableComponent1.getLayoutCoordinates()) != null) {
                ...
                long jM6561constructorimpl = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(left2)) << 32) | (((long) Float.floatToRawIntBits(top2)) & 4294967295L));
                long jM6561constructorimpl2 = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(bottom2)) & 4294967295L) | (((long) Float.floatToRawIntBits(right2)) << 32));
                long jMo8274localPositionOfR5De75A = layoutCoordinates.mo8274localPositionOfR5De75A(layoutCoordinates2, jM6561constructorimpl);
                long jMo8274localPositionOfR5De75A2 = layoutCoordinates.mo8274localPositionOfR5De75A(layoutCoordinates2, jM6561constructorimpl2);
                left = Math.min(left, Float.intBitsToFloat((int) (jMo8274localPositionOfR5De75A >> 32)));
                top = Math.min(top, Float.intBitsToFloat((int) (jMo8274localPositionOfR5De75A & 4294967295L)));
                right = Math.max(right, Float.intBitsToFloat((int) (jMo8274localPositionOfR5De75A2 >> 32)));
                bottom = Math.max(bottom, Float.intBitsToFloat((int) (jMo8274localPositionOfR5De75A2 & 4294967295L)));
            }
            i++;
            list2 = list;
            c = 0;
    ...
    public static final long m2181calculateSelectionMagnifierCenterAndroidO0kMr_c(SelectionManager selectionManager, long j) {
        ...
        if (i == 1) {
            return m2183getMagnifierCenterJVtK1S4(selectionManager, j, selection.getStart());
        }
        if (i == 2) {
            return m2183getMagnifierCenterJVtK1S4(selectionManager, j, selection.getEnd());
        }
        if (i != 3) {
    ...
    private static final long m2183getMagnifierCenterJVtK1S4(SelectionManager selectionManager, long j, Selection.AnchorInfo anchorInfo) {
        ...
        if (anchorSelectable$foundation != null && (containerLayoutCoordinates = selectionManager.getContainerLayoutCoordinates()) != null && (layoutCoordinates = anchorSelectable$foundation.getLayoutCoordinates()) != null && (offset = anchorInfo.getOffset()) <= anchorSelectable$foundation.getLastVisibleOffset()) {
            Offset offsetM2171getCurrentDragPosition_m7T9E = selectionManager.m2171getCurrentDragPosition_m7T9E();
            Intrinsics.checkNotNull(offsetM2171getCurrentDragPosition_m7T9E);
            float fIntBitsToFloat = Float.intBitsToFloat((int) (layoutCoordinates.mo8274localPositionOfR5De75A(containerLayoutCoordinates, offsetM2171getCurrentDragPosition_m7T9E.m6579unboximpl()) >> 32));
            long jMo2119getRangeOfLineContainingjx7JFs = anchorSelectable$foundation.mo2119getRangeOfLineContainingjx7JFs(offset);
            if (TextRange.m9085getCollapsedimpl(jMo2119getRangeOfLineContainingjx7JFs)) {
                fCoerceIn = anchorSelectable$foundation.getLineLeft(offset);
            } else {
                float lineLeft = anchorSelectable$foundation.getLineLeft(TextRange.m9091getStartimpl(jMo2119getRangeOfLineContainingjx7JFs));
                float lineRight = anchorSelectable$foundation.getLineRight(TextRange.m9086getEndimpl(jMo2119getRangeOfLineContainingjx7JFs) - 1);
            ...
            return containerLayoutCoordinates.mo8274localPositionOfR5De75A(layoutCoordinates, Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(fCoerceIn)) << 32) | (4294967295L & ((long) Float.floatToRawIntBits(centerYForOffset)))));
        }
        return Offset.INSTANCE.m6584getUnspecifiedF1C5BW0();
    }
    ...
    public static final Rect visibleBounds(LayoutCoordinates layoutCoordinates) {
        ...
        return RectKt.m6607Rect0a9Yr6o(layoutCoordinates.mo8282windowToLocalMKHz9U(rectBoundsInWindow$default.m6604getTopLeftF1C5BW0()), layoutCoordinates.mo8282windowToLocalMKHz9U(rectBoundsInWindow$default.m6598getBottomRightF1C5BW0()));
    }

    /* JADX INFO: renamed from: containsInclusive-Uv8p0NA, reason: not valid java name */
    public static final boolean m2182containsInclusiveUv8p0NA(Rect rect, long j) {
        float left = rect.getLeft();
        float right = rect.getRight();
