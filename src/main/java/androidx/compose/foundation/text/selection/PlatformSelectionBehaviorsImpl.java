...
public final class PlatformSelectionBehaviorsImpl implements PlatformSelectionBehaviors {
    ...
    public Object mo2126suggestSelectionForLongPressOrDoubleClickpYaCww(CharSequence charSequence, long j, Continuation<? super TextRange> continuation) {
        if (charSequence.length() == 0 || TextRange.m9085getCollapsedimpl(j)) {
            return null;
        }
    ...
    public final Object m2130onShowContextMenuOrSelectionToolbarSbBc2M(CharSequence charSequence, long j, Continuation<? super Unit> continuation) {
        if (charSequence.length() == 0 || TextRange.m9085getCollapsedimpl(j)) {
    ...
    public Object mo2124onShowContextMenu_2OEclM(CharSequence charSequence, long j, Offset offset, Continuation<? super Unit> continuation) {
        Object objM2130onShowContextMenuOrSelectionToolbarSbBc2M = m2130onShowContextMenuOrSelectionToolbarSbBc2M(charSequence, j, continuation);
        return objM2130onShowContextMenuOrSelectionToolbarSbBc2M == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objM2130onShowContextMenuOrSelectionToolbarSbBc2M : Unit.INSTANCE;
    }

    @Override // androidx.compose.foundation.text.selection.PlatformSelectionBehaviors
    /* JADX INFO: renamed from: onShowSelectionToolbar-Sb-Bc2M */
    public Object mo2125onShowSelectionToolbarSbBc2M(CharSequence charSequence, long j, Continuation<? super Unit> continuation) {
        Object objM2130onShowContextMenuOrSelectionToolbarSbBc2M = m2130onShowContextMenuOrSelectionToolbarSbBc2M(charSequence, j, continuation);
        return objM2130onShowContextMenuOrSelectionToolbarSbBc2M == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objM2130onShowContextMenuOrSelectionToolbarSbBc2M : Unit.INSTANCE;
    }
    ...
    public final Object m2129classifyTextM8tDOmk(CharSequence charSequence, long j, TextClassifier textClassifier, Continuation<? super Unit> continuation) {
        ...
        try {
            ...
            if (textClassificationResult != null && PlatformSelectionBehaviors_androidKt.m2137canReuseh5sm0ck(textClassificationResult, charSequence2, j2)) {
            ...
            mutex.unlock(null);
            textClassificationClassifyText = textClassifier2.classifyText(new TextClassification.Request.Builder(charSequence2, TextRange.m9089getMinimpl(j2), TextRange.m9088getMaximpl(j2)).setDefaultLocales(getAndroidLocalList()).build());
    ...
    public final void m2131addSmartSelectionTextContextMenuItemsYmzfRxQ$foundation(TextContextMenuBuilderScope textContextMenuBuilderScope, CharSequence charSequence, long j, Function1<? super TextContextMenuBuilderScope, Unit> function1) {
        TextClassification textClassificationM2132tryGetTextClassificationFDrldGo = m2132tryGetTextClassificationFDrldGo(charSequence, j);
        if (textClassificationM2132tryGetTextClassificationFDrldGo == null) {
            function1.invoke(textContextMenuBuilderScope);
            return;
        }
        if (!textClassificationM2132tryGetTextClassificationFDrldGo.getActions().isEmpty()) {
            TextContextMenuBuilderScope_androidKt.textClassificationItem(textContextMenuBuilderScope, this.AssistantItemKey, textClassificationM2132tryGetTextClassificationFDrldGo, 0);
        } else if (TextClassifierHelperMethods.INSTANCE.hasLegacyAssistItem$foundation(textClassificationM2132tryGetTextClassificationFDrldGo)) {
            TextContextMenuBuilderScope_androidKt.textClassificationItem(textContextMenuBuilderScope, this.AssistantItemKey, textClassificationM2132tryGetTextClassificationFDrldGo, -1);
        }
        function1.invoke(textContextMenuBuilderScope);
        List<RemoteAction> actions = textClassificationM2132tryGetTextClassificationFDrldGo.getActions();
        int size = actions.size();
        for (int i = 0; i < size; i++) {
            actions.get(i);
            if (i > 0) {
                TextContextMenuBuilderScope_androidKt.textClassificationItem(textContextMenuBuilderScope, this.AssistantItemKey, textClassificationM2132tryGetTextClassificationFDrldGo, i);
            }
        }
    }

    /* JADX INFO: renamed from: tryGetTextClassification-FDrldGo, reason: not valid java name */
    public final TextClassification m2132tryGetTextClassificationFDrldGo(CharSequence text, long selection) {
        if (!Mutex.DefaultImpls.tryLock$default(this.mutex, null, 1, null)) {
            return null;
        }
        TextClassificationResult textClassificationResult = getTextClassificationResult();
        TextClassification textClassification = (textClassificationResult == null || !PlatformSelectionBehaviors_androidKt.m2137canReuseh5sm0ck(textClassificationResult, text, selection)) ? null : textClassificationResult.getTextClassification();
            ...
            try {
                ...
                if (i != 1) {
                    ...
                    try {
                        ...
                        this.L$1 = null;
                        this.label = 3;
                        objWithTimeoutOrNull = TimeoutKt.withTimeoutOrNull(200L, new AnonymousClass1(textClassifier, this.$block, null), this);
