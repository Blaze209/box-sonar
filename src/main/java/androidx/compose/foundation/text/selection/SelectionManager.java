...
public final class SelectionManager {
    ...
    private final MutableState dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m6558boximpl(Offset.INSTANCE.m6585getZeroF1C5BW0()), null, 2, null);

    /* JADX INFO: renamed from: dragTotalDistance$delegate, reason: from kotlin metadata */
    private final MutableState dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m6558boximpl(Offset.INSTANCE.m6585getZeroF1C5BW0()), null, 2, null);
    ...
    public final Modifier getModifier() {
        return addContextMenuComponents(KeyInputModifierKt.onKeyEvent(SelectionGesturesKt.updateSelectionTouchMode(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0() { // from class: androidx.compose.foundation.text.selection.SelectionManager$$ExternalSyntheticLambda0
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m2180invokeZmokQxo(keyEvent.m7966unboximpl());
            }

            /* JADX INFO: renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m2180invokeZmokQxo(android.view.KeyEvent keyEvent) {
                boolean z;
                if (SelectionManager_androidKt.m2187isCopyKeyEventZmokQxo(keyEvent)) {
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates layoutCoordinates) {
        ...
        Offset offsetM6558boximpl = layoutCoordinates != null ? Offset.m6558boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, offsetM6558boximpl)) {
            return;
        }
        this.previousPosition = offsetM6558boximpl;
        updateHandleOffsets();
        updateSelectionToolbar();
    }
    ...
    public final void m2166setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition.setValue(Offset.m6558boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getDragBeginPosition-F1C5BW0$foundation, reason: not valid java name */
    public final long m2172getDragBeginPositionF1C5BW0$foundation() {
        return ((Offset) this.dragBeginPosition.getValue()).m6579unboximpl();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: setDragTotalDistance-k-4lQ0M, reason: not valid java name */
    public final void m2167setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance.setValue(Offset.m6558boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getDragTotalDistance-F1C5BW0$foundation, reason: not valid java name */
    public final long m2173getDragTotalDistanceF1C5BW0$foundation() {
        return ((Offset) this.dragTotalDistance.getValue()).m6579unboximpl();
    }

    /* JADX INFO: renamed from: setStartHandlePosition-_kEHs6E, reason: not valid java name */
    private final void m2169setStartHandlePosition_kEHs6E(Offset offset) {
        this.startHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getStartHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m2175getStartHandlePosition_m7T9E() {
    ...
    private final void m2168setEndHandlePosition_kEHs6E(Offset offset) {
        this.endHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getEndHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m2174getEndHandlePosition_m7T9E() {
    ...
    public final void m2165setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m2171getCurrentDragPosition_m7T9E() {
    ...
    public static final Unit _init_$lambda$1(SelectionManager selectionManager, boolean z, LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
        long jM1970coerceIn3MmeM6k;
        long jMo8273getSizeYbymL2g = layoutCoordinates.mo8273getSizeYbymL2g();
        Rect rect = new Rect(0.0f, 0.0f, (int) (jMo8273getSizeYbymL2g >> 32), (int) (jMo8273getSizeYbymL2g & 4294967295L));
        if (SelectionManagerKt.m2182containsInclusiveUv8p0NA(rect, offset.m6579unboximpl())) {
            jM1970coerceIn3MmeM6k = offset.m6579unboximpl();
        } else {
            jM1970coerceIn3MmeM6k = TextLayoutStateKt.m1970coerceIn3MmeM6k(offset.m6579unboximpl(), rect);
        }
        long jM2163convertToContainerCoordinatesR5De75A = selectionManager.m2163convertToContainerCoordinatesR5De75A(layoutCoordinates, jM1970coerceIn3MmeM6k);
        if ((9223372034707292159L & jM2163convertToContainerCoordinatesR5De75A) != androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            selectionManager.setInTouchMode(z);
            selectionManager.m2170startSelection9KIMszo(jM2163convertToContainerCoordinatesR5De75A, false, selectionAdjustment);
            FocusRequester.m6474requestFocus3ESFkO8$default(selectionManager.focusRequester, 0, 1, null);
    ...
    public static final boolean _init_$lambda$3(SelectionManager selectionManager, boolean z, LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, boolean z2, SelectionAdjustment selectionAdjustment) {
        long jM2163convertToContainerCoordinatesR5De75A = selectionManager.m2163convertToContainerCoordinatesR5De75A(layoutCoordinates, offset.m6579unboximpl());
        long jM2163convertToContainerCoordinatesR5De75A2 = selectionManager.m2163convertToContainerCoordinatesR5De75A(layoutCoordinates, offset2.m6579unboximpl());
        selectionManager.setInTouchMode(z);
        return selectionManager.m2178updateSelectionqNKwrvQ$foundation(Offset.m6558boximpl(jM2163convertToContainerCoordinatesR5De75A), jM2163convertToContainerCoordinatesR5De75A2, z2, selectionAdjustment);
    }
    ...
    public static final Unit _init_$lambda$4(SelectionManager selectionManager) {
        ...
        selectionManager.m2165setCurrentDragPosition_kEHs6E(null);
        ...
        if (iNextIndex != -1) {
            ...
            while (i < size) {
                ...
                if (selection2 != null) {
                    ...
                    objectRef2.element = TextRange.m9079boximpl(jTextRange);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                if (platformSelectionBehaviors != null) {
                    this.label = 1;
                    obj = platformSelectionBehaviors.mo2126suggestSelectionForLongPressOrDoubleClickpYaCww(this.$textInSelectable.element, this.$selectionInSelectable.element.getPackedValue(), this);
                ...
                if (textRange != null && !Intrinsics.areEqual(textRange, this.$selectionInSelectable.element) && (selectable = SelectionManager.this.selectionRegistrar.getSelectableMap$foundation().get(this.$targetSelectableId.element)) != null && selectable.getText() == this.$textInSelectable.element) {
                    ...
                    Selection selection = new Selection(new Selection.AnchorInfo(SelectionHelpersKt.getTextDirectionForOffset(textLayoutResult, TextRange.m9091getStartimpl(textRange.getPackedValue())), TextRange.m9091getStartimpl(textRange.getPackedValue()), this.$targetSelectableId.element), new Selection.AnchorInfo(SelectionHelpersKt.getTextDirectionForOffset(textLayoutResult, TextRange.m9086getEndimpl(textRange.getPackedValue())), TextRange.m9086getEndimpl(textRange.getPackedValue()), this.$targetSelectableId.element), false, 4, null);
            ...
            if (textRange != null) {
                ...
                Selection selection2 = new Selection(new Selection.AnchorInfo(SelectionHelpersKt.getTextDirectionForOffset(textLayoutResult, TextRange.m9091getStartimpl(textRange.getPackedValue())), TextRange.m9091getStartimpl(textRange.getPackedValue()), this.$targetSelectableId.element), new Selection.AnchorInfo(SelectionHelpersKt.getTextDirectionForOffset(textLayoutResult, TextRange.m9086getEndimpl(textRange.getPackedValue())), TextRange.m9086getEndimpl(textRange.getPackedValue()), this.$targetSelectableId.element), false, 4, null);
    ...
    private final void updateHandleOffsets() {
        ...
        if (selection == null || layoutCoordinates == null || !layoutCoordinates.isAttached() || (layoutCoordinates2 == null && layoutCoordinates3 == null)) {
            m2169setStartHandlePosition_kEHs6E(null);
            m2168setEndHandlePosition_kEHs6E(null);
            return;
        }
        Rect rectVisibleBounds = SelectionManagerKt.visibleBounds(layoutCoordinates);
        if (layoutCoordinates2 != null) {
            long jMo2118getHandlePositiondBAh8RU = anchorSelectable$foundation.mo2118getHandlePositiondBAh8RU(selection, true);
            if ((jMo2118getHandlePositiondBAh8RU & 9223372034707292159L) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
                offsetM6558boximpl = null;
            } else {
                offsetM6558boximpl = Offset.m6558boximpl(layoutCoordinates.mo8274localPositionOfR5De75A(layoutCoordinates2, jMo2118getHandlePositiondBAh8RU));
                long jM6579unboximpl = offsetM6558boximpl.m6579unboximpl();
                if (getDraggingHandle() != Handle.SelectionStart && !SelectionManagerKt.m2182containsInclusiveUv8p0NA(rectVisibleBounds, jM6579unboximpl)) {
                    offsetM6558boximpl = null;
                }
            }
        } else {
        ...
        m2169setStartHandlePosition_kEHs6E(offsetM6558boximpl);
        if (layoutCoordinates3 != null) {
            long jMo2118getHandlePositiondBAh8RU2 = anchorSelectable$foundation2.mo2118getHandlePositiondBAh8RU(selection, false);
            if ((9223372034707292159L & jMo2118getHandlePositiondBAh8RU2) != androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
                Offset offsetM6558boximpl2 = Offset.m6558boximpl(layoutCoordinates.mo8274localPositionOfR5De75A(layoutCoordinates3, jMo2118getHandlePositiondBAh8RU2));
                long jM6579unboximpl2 = offsetM6558boximpl2.m6579unboximpl();
                if (getDraggingHandle() == Handle.SelectionEnd || SelectionManagerKt.m2182containsInclusiveUv8p0NA(rectVisibleBounds, jM6579unboximpl2)) {
                    offset = offsetM6558boximpl2;
                }
            }
        }
        m2168setEndHandlePosition_kEHs6E(offset);
    }
        ...
        if (iNextIndex != -1) {
            ...
            while (i < size) {
                ...
                if (selection2 != null) {
                    ...
                    builder.append(text, TextRange.m9089getMinimpl(jTextRange), TextRange.m9088getMaximpl(jTextRange));
                    if (!z) {
                        builder.append('\n');
                    }
                }
    ...
    public final Pair<AnnotatedString, TextRange> getContextTextAndSelection$foundation() {
        ...
        if (iNextIndex != -1) {
            ...
            while (i < size) {
                ...
                if (selection2 != null) {
                    ...
                    boolean z = i >= iNextIndex;
                    selectable.getSelectableId();
                    if (iM9089getMinimpl == -1) {
                        iM9089getMinimpl = TextRange.m9089getMinimpl(jTextRange);
                        builder.append(text, 0, TextRange.m9089getMinimpl(jTextRange));
                    }
                    pair = pair2;
                    builder.append(text, TextRange.m9089getMinimpl(jTextRange), TextRange.m9088getMaximpl(jTextRange));
                    if (!z) {
                        ...
                        builder.append(text, TextRange.m9088getMaximpl(jTextRange), text.length());
                    }
                } else {
                    pair = pair2;
                }
        ...
        return (iM9089getMinimpl == -1 || length == -1) ? pair2 : new Pair<>(builder.toAnnotatedString(), TextRange.m9079boximpl(TextRangeKt.TextRange(iM9089getMinimpl, length)));
    }
    ...
    public final void forEachSelectableWithSelection$foundation(Function4<? super Long, ? super AnnotatedString, ? super TextRange, ? super Boolean, Boolean> block) {
        ...
        while (i < size) {
            ...
            Selection selection2 = this.selectionRegistrar.getSubselections().get(selectable.getSelectableId());
            if (selection2 != null) {
                if (!block.invoke(Long.valueOf(selectable.getSelectableId()), selectable.getText(), TextRange.m9079boximpl(TextRangeKt.TextRange(selection2.getStart().getOffset(), selection2.getEnd().getOffset())), Boolean.valueOf(i >= iNextIndex)).booleanValue()) {
                    return;
                }
            }
            i++;
    ...
    private final void updateSelectionTextToolbar() {
        ...
        if (this.showToolbar && isInTouchMode()) {
            ...
            TextToolbar.showMenu$default(textToolbar, contentRect, canCopy$foundation() ? new C06981(this) : null, null, null, isEntireContainerSelected$foundation() ? null : new C06992(this), null, 12, null);
            return;
        }
    ...
    static final /* synthetic */ class C06981 extends FunctionReferenceImpl implements Function0<Unit> {
        C06981(Object obj) {
    ...
    /* JADX INFO: compiled from: SelectionManager.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 48)
    static final /* synthetic */ class C06992 extends FunctionReferenceImpl implements Function0<Unit> {
        C06992(Object obj) {
    ...
    public final Rect getContentRect() {
        ...
        Rect rectM6606translatek4lQ0M = rectIntersect.m6606translatek4lQ0M(LayoutCoordinatesKt.positionInRoot(layoutCoordinates));
        return Rect.copy$default(rectM6606translatek4lQ0M, 0.0f, 0.0f, 0.0f, rectM6606translatek4lQ0M.getBottom() + (SelectionHandlesKt.getHandleHeight() * 4), 7, null);
    }
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager.handleDragObserver.1
            ...
            public void mo1717onDownk4lQ0M(long point) {
                LayoutCoordinates layoutCoordinates;
                Offset offsetM2175getStartHandlePosition_m7T9E = isStartHandle ? this.m2175getStartHandlePosition_m7T9E() : this.m2174getEndHandlePosition_m7T9E();
                if (offsetM2175getStartHandlePosition_m7T9E != null) {
                    offsetM2175getStartHandlePosition_m7T9E.m6579unboximpl();
                    ...
                    long jMo2118getHandlePositiondBAh8RU = anchorSelectable$foundation.mo2118getHandlePositiondBAh8RU(selection, isStartHandle);
                    if ((9223372034707292159L & jMo2118getHandlePositiondBAh8RU) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
                        return;
                    }
                    long jM2148getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m2148getAdjustedCoordinatesk4lQ0M(jMo2118getHandlePositiondBAh8RU);
                    SelectionManager selectionManager = this;
                    selectionManager.m2165setCurrentDragPosition_kEHs6E(Offset.m6558boximpl(selectionManager.requireContainerCoordinates$foundation().mo8274localPositionOfR5De75A(layoutCoordinates, jM2148getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo1719onStart3MmeM6k(long startPoint, SelectionAdjustment selectionAdjustment) {
                ...
                if (selectable != null) {
                    ...
                    if (layoutCoordinates != null) {
                        long jMo2118getHandlePositiondBAh8RU = selectable2.mo2118getHandlePositiondBAh8RU(selection, isStartHandle);
                        if ((9223372034707292159L & jMo2118getHandlePositiondBAh8RU) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
                            return;
                        }
                        long jM2148getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m2148getAdjustedCoordinatesk4lQ0M(jMo2118getHandlePositiondBAh8RU);
                        SelectionManager selectionManager = this;
                        selectionManager.m2166setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation().mo8274localPositionOfR5De75A(layoutCoordinates, jM2148getAdjustedCoordinatesk4lQ0M));
                        this.m2167setDragTotalDistancek4lQ0M(Offset.INSTANCE.m6585getZeroF1C5BW0());
                        return;
                    }
            ...
            public void mo1718onDragk4lQ0M(long delta) {
                ...
                SelectionManager selectionManager = this;
                selectionManager.m2167setDragTotalDistancek4lQ0M(Offset.m6574plusMKHz9U(selectionManager.m2173getDragTotalDistanceF1C5BW0$foundation(), delta));
                long jM6574plusMKHz9U = Offset.m6574plusMKHz9U(this.m2172getDragBeginPositionF1C5BW0$foundation(), this.m2173getDragTotalDistanceF1C5BW0$foundation());
                if (this.m2178updateSelectionqNKwrvQ$foundation(Offset.m6558boximpl(jM6574plusMKHz9U), this.m2172getDragBeginPositionF1C5BW0$foundation(), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                    this.m2166setDragBeginPositionk4lQ0M(jM6574plusMKHz9U);
                    this.m2167setDragTotalDistancek4lQ0M(Offset.INSTANCE.m6585getZeroF1C5BW0());
                }
            }
            ...
            private final void done() {
                ...
                this.m2165setCurrentDragPosition_kEHs6E(null);
            }
    ...
    private final Modifier onClearSelectionRequested(Modifier modifier, final Function0<Unit> function0) {
        return SuspendingPointerInputFilterKt.pointerInput(modifier, Unit.INSTANCE, new PointerInputEventHandler() { // from class: androidx.compose.foundation.text.selection.SelectionManager.onClearSelectionRequested.1
            ...
            static final class C00441 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C00441(SelectionManager selectionManager, Function0<Unit> function0, Continuation<? super C00441> continuation) {
                    super(2, continuation);
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    C00441 c00441 = new C00441(this.this$0, this.$block, continuation);
                    c00441.L$0 = obj;
                    return c00441;
                }
                ...
                */
                public final java.lang.Object invokeSuspend(java.lang.Object r11) {
                    ...
                    L65:
                        ...
                        return r10
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.SelectionManager.C06971.C00441.invokeSuspend(java.lang.Object):java.lang.Object");
                }
            }

            @Override // androidx.compose.ui.input.pointer.PointerInputEventHandler
            public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
                Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture(pointerInputScope, new C00441(SelectionManager.this, function0, null), continuation);
    ...
    private final long m2163convertToContainerCoordinatesR5De75A(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 == null || !layoutCoordinates2.isAttached()) {
            return Offset.INSTANCE.m6584getUnspecifiedF1C5BW0();
        }
        return requireContainerCoordinates$foundation().mo8274localPositionOfR5De75A(layoutCoordinates, offset);
    }

    /* JADX INFO: renamed from: startSelection-9KIMszo, reason: not valid java name */
    private final void m2170startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        this.previousSelectionLayout = null;
        m2177updateSelectionjyLRC_s$foundation(position, Offset.INSTANCE.m6584getUnspecifiedF1C5BW0(), isStartHandle, adjustment);
    }

    /* JADX INFO: renamed from: updateSelection-qNKwrvQ$foundation, reason: not valid java name */
    public final boolean m2178updateSelectionqNKwrvQ$foundation(Offset newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        if (newPosition == null) {
            return false;
        }
        return m2177updateSelectionjyLRC_s$foundation(newPosition.m6579unboximpl(), previousPosition, isStartHandle, adjustment);
    }

    /* JADX INFO: renamed from: updateSelection-jyLRC_s$foundation, reason: not valid java name */
    public final boolean m2177updateSelectionjyLRC_s$foundation(long position, long previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m2165setCurrentDragPosition_kEHs6E(Offset.m6558boximpl(position));
        SelectionLayout selectionLayoutM2164getSelectionLayoutWko1d7g = m2164getSelectionLayoutWko1d7g(position, previousHandlePosition, isStartHandle);
        if (selectionLayoutM2164getSelectionLayoutWko1d7g == null || !selectionLayoutM2164getSelectionLayoutWko1d7g.shouldRecomputeSelection(this.previousSelectionLayout)) {
            return false;
        }
        Selection selectionAdjust = adjustment.adjust(selectionLayoutM2164getSelectionLayoutWko1d7g);
        if (!Intrinsics.areEqual(selectionAdjust, getSelection())) {
            selectionChanged(selectionLayoutM2164getSelectionLayoutWko1d7g, selectionAdjust);
            this.isLongPressOrClickSelection = false;
        }
        this.previousSelectionLayout = selectionLayoutM2164getSelectionLayoutWko1d7g;
        return true;
    }

    /* JADX INFO: renamed from: getSelectionLayout-Wko1d7g, reason: not valid java name */
    private final SelectionLayout m2164getSelectionLayoutWko1d7g(long position, long previousHandlePosition, boolean isStartHandle) {
    ...
    public final void m2176selectWordAtPositionIfNotAlreadySelectedk4lQ0M(long position) {
        LayoutCoordinates layoutCoordinates;
        boolean zM1757isPositionInsideSelectionuaM50fQ;
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 != null && layoutCoordinates2.isAttached()) {
            List<Selectable> selectables$foundation = this.selectionRegistrar.getSelectables$foundation();
            int size = selectables$foundation.size();
            for (int i = 0; i < size; i++) {
                ...
                if (selection == null || (layoutCoordinates = selectable.getLayoutCoordinates()) == null) {
                    zM1757isPositionInsideSelectionuaM50fQ = false;
                } else {
                    long jMo8274localPositionOfR5De75A = layoutCoordinates.mo8274localPositionOfR5De75A(layoutCoordinates2, position);
                    TextLayoutResult textLayoutResult = selectable.textLayoutResult();
                    if (textLayoutResult == null) {
                        zM1757isPositionInsideSelectionuaM50fQ = false;
                    } else {
                        zM1757isPositionInsideSelectionuaM50fQ = TextLayoutHelperKt.m1757isPositionInsideSelectionuaM50fQ(textLayoutResult, jMo8274localPositionOfR5De75A, TextRange.m9079boximpl(selection.m2138toTextRanged9O1mEE()));
                    }
                }
                if (zM1757isPositionInsideSelectionuaM50fQ) {
                    return;
                }
            }
            m2170startSelection9KIMszo(position, true, SelectionAdjustment.INSTANCE.getWord());
        }
    }
}
