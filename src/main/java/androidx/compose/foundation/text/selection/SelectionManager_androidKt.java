...
public final class SelectionManager_androidKt {
    ...
    public static final boolean m2187isCopyKeyEventZmokQxo(KeyEvent keyEvent) {
        return KeyMapping_androidKt.getPlatformDefaultKeyMapping().mo1663mapZmokQxo(keyEvent) == KeyCommand.COPY;
    }
    ...
    public static final Modifier selectionMagnifier$lambda$0(final SelectionManager selectionManager, Modifier modifier, Composer composer, int i) {
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m9850boximpl(IntSize.INSTANCE.m9863getZeroYbymL2g()), null, 2, null);
    ...
    private static final long selectionMagnifier$lambda$0$1(MutableState<IntSize> mutableState) {
        return mutableState.getValue().m9862unboximpl();
    }

    private static final void selectionMagnifier$lambda$0$2(MutableState<IntSize> mutableState, long j) {
        mutableState.setValue(IntSize.m9850boximpl(j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Offset selectionMagnifier$lambda$0$3$0(SelectionManager selectionManager, MutableState mutableState) {
        return Offset.m6558boximpl(SelectionManagerKt.m2181calculateSelectionMagnifierCenterAndroidO0kMr_c(selectionManager, selectionMagnifier$lambda$0$1(mutableState)));
    }
    ...
    public static final Modifier selectionMagnifier$lambda$0$4$0(final Density density, final MutableState mutableState, final Function0 function0) {
        return Magnifier_androidKt.m671magnifierjPUL71Q$default(Modifier.INSTANCE, new Function1() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$$ExternalSyntheticLambda10
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static final Unit selectionMagnifier$lambda$0$4$0$1(Density density, MutableState mutableState, DpSize dpSize) {
        selectionMagnifier$lambda$0$2(mutableState, IntSize.m9853constructorimpl((((long) density.mo748roundToPx0680j_4(DpSize.m9785getWidthD9Ej5fM(dpSize.getPackedValue()))) << 32) | (((long) density.mo748roundToPx0680j_4(DpSize.m9783getHeightD9Ej5fM(dpSize.getPackedValue()))) & 4294967295L)));
    ...
    static /* synthetic */ void addSelectionContainerTextContextMenuComponents$lambda$0$selectionContainerItem$default(TextContextMenuBuilderScope textContextMenuBuilderScope, Context context, TextContextMenuItems textContextMenuItems, boolean z, Function0 function0, Function0 function1, int i, Object obj) {
        if ((i & 8) != 0) {
            function0 = null;
        }
    ...
    public static final Unit addSelectionContainerTextContextMenuComponents$lambda$0(final SelectionManager selectionManager, TextContextMenuBuilderScope textContextMenuBuilderScope, final Context context) {
        ...
        PlatformSelectionBehaviors_androidKt.m2136addPlatformTextContextMenuItems71BSaZU(textContextMenuBuilderScope, context, false, contextTextAndSelection$foundation != null ? contextTextAndSelection$foundation.getFirst() : null, contextTextAndSelection$foundation != null ? contextTextAndSelection$foundation.getSecond() : null, selectionManager.getPlatformSelectionBehaviors(), new Function1() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
