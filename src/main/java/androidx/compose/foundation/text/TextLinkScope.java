...
public final class TextLinkScope {
    ...
    public static final IntOffset textRange$lambda$0$0() {
        return IntOffset.m9806boximpl(IntOffset.INSTANCE.m9826getZeronOccac());
    }
    ...
    public static final IntOffset textRange$lambda$0$2(IntRect intRect) {
        return IntOffset.m9806boximpl(intRect.m9844getTopLeftnOccac());
    }
        ...
        if (!composerStartRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            while (i4 < size) {
                ...
                if (range.getStart() == range.getEnd()) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
                    BoxKt.Box(ClickableKt.m636combinedClickableauXiCPI$default(modifierPointerHoverIcon$default, mutableInteractionSource, null, false, null, null, null, null, null, false, (Function0) objRememberedValue3, 508, null), composerStartRestartGroup, 0);
