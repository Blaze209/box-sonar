...
public final class HeightInLinesModifierKt {
    ...
    public static final Modifier heightInLines$lambda$1(int i, int i2, TextStyle textStyle, Modifier modifier, Composer composer, int i3) {
        ...
        Modifier modifierM1253heightInVpY3zN4 = SizeKt.m1253heightInVpY3zN4(Modifier.INSTANCE, numValueOf != null ? density.mo751toDpu2uoSUM(numValueOf.intValue()) : Dp.INSTANCE.m9707getUnspecifiedD9Ej5fM(), numValueOf2 != null ? density.mo751toDpu2uoSUM(numValueOf2.intValue()) : Dp.INSTANCE.m9707getUnspecifiedD9Ej5fM());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return modifierM1253heightInVpY3zN4;
    }
