...
public final class LegacyTextFieldState {
    ...
    private final MutableState minHeightForSingleLineField = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m9685boximpl(Dp.m9687constructorimpl(0)), null, 2, null);
    ...
    private long selectionBackgroundColor = Color.INSTANCE.m6850getUnspecified0d7_KjU();

    /* JADX INFO: renamed from: selectionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState selectionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m9079boximpl(TextRange.INSTANCE.m9096getZerod9O1mEE()), null, 2, null);

    /* JADX INFO: renamed from: deletionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState deletionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m9079boximpl(TextRange.INSTANCE.m9096getZerod9O1mEE()), null, 2, null);
    ...
    public final float m1682getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField.getValue()).m9701unboximpl();
    }

    /* JADX INFO: renamed from: setMinHeightForSingleLineField-0680j_4, reason: not valid java name */
    public final void m1686setMinHeightForSingleLineField0680j_4(float f) {
        this.minHeightForSingleLineField.setValue(Dp.m9685boximpl(f));
    }
    ...
    public static final Unit onValueChange$lambda$0(LegacyTextFieldState legacyTextFieldState, TextFieldValue textFieldValue) {
        ...
        legacyTextFieldState.m1688setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m9096getZerod9O1mEE());
    ...
    public static final Unit onImeActionPerformed$lambda$0(LegacyTextFieldState legacyTextFieldState, ImeAction imeAction) {
        legacyTextFieldState.keyboardActionRunner.m1666runActionKlQnJC8(imeAction.getValue());
        return Unit.INSTANCE;
    }
    ...
    public static final boolean onImeActionPerformedWithResult$lambda$0(LegacyTextFieldState legacyTextFieldState, ImeAction imeAction) {
        return legacyTextFieldState.keyboardActionRunner.m1666runActionKlQnJC8(imeAction.getValue());
    }
    ...
    public final void m1687setSelectionBackgroundColor8_81llA(long j) {
    ...
    public final long m1684getSelectionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m1688setSelectionPreviewHighlightRange5zctL8(long j) {
        this.selectionPreviewHighlightRange.setValue(TextRange.m9079boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getDeletionPreviewHighlightRange-d9O1mEE, reason: not valid java name */
    public final long m1681getDeletionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m1685setDeletionPreviewHighlightRange5zctL8(long j) {
        this.deletionPreviewHighlightRange.setValue(TextRange.m9079boximpl(j));
    }

    public final boolean hasHighlight() {
        return (TextRange.m9085getCollapsedimpl(m1684getSelectionPreviewHighlightRanged9O1mEE()) && TextRange.m9085getCollapsedimpl(m1681getDeletionPreviewHighlightRanged9O1mEE())) ? false : true;
    }

    /* JADX INFO: renamed from: update-fnh65Uc, reason: not valid java name */
    public final void m1689updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        TextDelegate textDelegateM1716updateTextDelegaterm0N8CA$default = TextDelegateKt.m1716updateTextDelegaterm0N8CA$default(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, softWrap, 0, 0, 0, CollectionsKt.emptyList(), 448, null);
        if (this.textDelegate != textDelegateM1716updateTextDelegaterm0N8CA$default) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = textDelegateM1716updateTextDelegaterm0N8CA$default;
    }
}
