...
public final class MenuItemsAvailability {
    ...
    public static final /* synthetic */ MenuItemsAvailability m1691boximpl(int i) {
        return new MenuItemsAvailability(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m1692constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1694equalsimpl(int i, Object obj) {
        return (obj instanceof MenuItemsAvailability) && i == ((MenuItemsAvailability) obj).m1703unboximpl();
    }
    ...
    public static final boolean m1696getCanAutofillimpl(int i) {
        return (i & 16) == 16;
    }

    /* JADX INFO: renamed from: getCanCopy-impl, reason: not valid java name */
    public static final boolean m1697getCanCopyimpl(int i) {
        return (i & 1) == 1;
    }

    /* JADX INFO: renamed from: getCanCut-impl, reason: not valid java name */
    public static final boolean m1698getCanCutimpl(int i) {
        return (i & 4) == 4;
    }

    /* JADX INFO: renamed from: getCanPaste-impl, reason: not valid java name */
    public static final boolean m1699getCanPasteimpl(int i) {
        return (i & 2) == 2;
    }

    /* JADX INFO: renamed from: getCanSelectAll-impl, reason: not valid java name */
    public static final boolean m1700getCanSelectAllimpl(int i) {
        return (i & 8) == 8;
    }
    ...
    public boolean equals(Object other) {
        return m1694equalsimpl(this.value, other);
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m1693constructorimpl(boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        return m1692constructorimpl((z ? 1 : 0) | (z2 ? 2 : 0) | (z3 ? 4 : 0) | (z4 ? 8 : 0) | (z5 ? 16 : 0));
    }
    ...
    public static final class Companion {
        ...
        public final int m1704getNoneJKCFgKw() {
