...
public final class TextFieldDecoratorModifierNode extends DelegatingNode implements DrawModifierNode, PlatformTextInputModifierNode, SemanticsModifierNode, GlobalPositionAwareModifierNode, PointerInputModifierNode, KeyInputModifierNode, CompositionLocalConsumerModifierNode, ModifierLocalModifierNode, ObserverModifierNode, LayoutAwareModifierNode, FocusPropertiesModifierNode {
    ...
    public TextFieldDecoratorModifierNode(TransformedTextFieldState transformedTextFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation inputTransformation, boolean z, boolean z2, KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, boolean z3, MutableInteractionSource mutableInteractionSource, boolean z4, MutableSharedFlow<Unit> mutableSharedFlow) {
        ...
        this.clipboardKeyCommandsHandler = ClipboardKeyCommandsHandler.m1864constructorimpl(new Function1() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$$ExternalSyntheticLambda16
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static final Unit dragAndDropNode$lambda$4(TextFieldDecoratorModifierNode textFieldDecoratorModifierNode, Offset offset) {
        long jM1973fromWindowToDecorationUv8p0NA = TextLayoutStateKt.m1973fromWindowToDecorationUv8p0NA(textFieldDecoratorModifierNode.textLayoutState, offset.m6579unboximpl());
        int iM1963getOffsetForPosition3MmeM6k$default = TextLayoutState.m1963getOffsetForPosition3MmeM6k$default(textFieldDecoratorModifierNode.textLayoutState, jM1973fromWindowToDecorationUv8p0NA, false, 2, null);
        if (iM1963getOffsetForPosition3MmeM6k$default >= 0) {
            textFieldDecoratorModifierNode.textFieldState.m1984selectCharsIn5zctL8(TextRangeKt.TextRange(iM1963getOffsetForPosition3MmeM6k$default));
        }
        textFieldDecoratorModifierNode.textFieldSelectionState.m2033updateHandleDraggingUv8p0NA(Handle.Cursor, jM1973fromWindowToDecorationUv8p0NA);
        return Unit.INSTANCE;
    }
    ...
    public static final boolean dragAndDropNode$lambda$1(TextFieldDecoratorModifierNode textFieldDecoratorModifierNode, ClipEntry clipEntry, ClipMetadata clipMetadata) {
        ...
        if (receiveContentConfiguration != null) {
            TransferableContent transferableContentOnReceive = receiveContentConfiguration.getReceiveContentListener().onReceive(new TransferableContent(clipEntry, clipMetadata, TransferableContent.Source.INSTANCE.m708getDragAndDropkB6V9T0(), null, 8, null));
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (getAutofillHighlightOn()) {
            ...
            DrawScope.m7388drawRectAsUm42w$default(contentDrawScope, AutofillHighlightKt.m1582resolveAutofillHighlightWkMShQ((Brush) CompositionLocalConsumerModifierNodeKt.currentValueOf(textFieldDecoratorModifierNode, AutofillHighlightKt.getLocalAutofillHighlightBrush()), ((Color) CompositionLocalConsumerModifierNodeKt.currentValueOf(textFieldDecoratorModifierNode, AutofillHighlightKt.getLocalAutofillHighlightColor())).m6824unboximpl(), AutofillHighlight_androidKt.autofillHighlightColor()), 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
    }
    ...
    public final void updateNode(TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation filter, boolean enabled, boolean readOnly, KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, boolean singleLine, MutableInteractionSource interactionSource, boolean isPassword, MutableSharedFlow<Unit> stylusHandwritingTrigger) {
        ...
        if (enabled != z || z4 != z2 || !ImeAction.m9263equalsimpl0(keyboardOptions.m1679getImeActionOrDefaulteUduSuo$foundation(), keyboardOptions2.m1679getImeActionOrDefaulteUduSuo$foundation()) || isPassword != z3) {
        ...
        if (!Intrinsics.areEqual(textFieldSelectionState, textFieldSelectionState2)) {
            ...
            if (getIsAttached()) {
                ...
                if (isFocused() && (job = this.toolbarAndHandlesVisibilityObserverJob) != null) {
                    ...
                    this.toolbarAndHandlesVisibilityObserverJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C06831(textFieldSelectionState, null), 3, null);
                }
            }
    ...
    static final class C06831 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06831(TextFieldSelectionState textFieldSelectionState, Continuation<? super C06831> continuation) {
            super(2, continuation);
            this.$textFieldSelectionState = textFieldSelectionState;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C06831(this.$textFieldSelectionState, continuation);
        }
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        SemanticsPropertiesKt.m8852setTextSelectionRangeFDrldGo(semanticsPropertyReceiver, selection);
        if (!this.enabled) {
        ...
        if (KeyboardType.m9316equalsimpl0(keyboardType, KeyboardType.INSTANCE.m9332getEmailPjHm6EE())) {
            SemanticsPropertiesKt.setContentType(semanticsPropertyReceiver, ContentType.INSTANCE.getEmailAddress());
        } else if (KeyboardType.m9316equalsimpl0(keyboardType, KeyboardType.INSTANCE.m9335getPasswordPjHm6EE()) || KeyboardType.m9316equalsimpl0(keyboardType, KeyboardType.INSTANCE.m9334getNumberPasswordPjHm6EE())) {
        ...
        final int iM1679getImeActionOrDefaulteUduSuo$foundation = this.keyboardOptions.m1679getImeActionOrDefaulteUduSuo$foundation();
        SemanticsPropertiesKt.m8848onImeAction9UiTYpY$default(semanticsPropertyReceiver, iM1679getImeActionOrDefaulteUduSuo$foundation, null, new Function0() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$$ExternalSyntheticLambda24
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Boolean.valueOf(TextFieldDecoratorModifierNode.applySemantics$lambda$6(this.f$0, iM1679getImeActionOrDefaulteUduSuo$foundation));
            }
        }, 2, null);
        ...
        if (!TextRange.m9085getCollapsedimpl(selection) && !this.isPassword) {
    ...
    public static final boolean applySemantics$lambda$5(TextFieldDecoratorModifierNode textFieldDecoratorModifierNode, int i, int i2, boolean z) {
        ...
        if (i == TextRange.m9091getStartimpl(selection) && i2 == TextRange.m9086getEndimpl(selection)) {
            return true;
        }
        ...
        if (z) {
            textFieldDecoratorModifierNode.textFieldState.m1985selectUntransformedCharsIn5zctL8(jTextRange);
        } else {
            textFieldDecoratorModifierNode.textFieldState.m1984selectCharsIn5zctL8(jTextRange);
        }
        return true;
    }
    ...
    public static final boolean applySemantics$lambda$6(TextFieldDecoratorModifierNode textFieldDecoratorModifierNode, int i) {
        textFieldDecoratorModifierNode.m1945onImeActionPerformedKlQnJC8(i);
        return true;
    }
    ...
    public boolean mo557onPreKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1855onPreKeyEventMyFupTE(event, this.textFieldState, this.textFieldSelectionState, (FocusManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFocusManager()), requireKeyboardController());
    }

    @Override // androidx.compose.ui.input.key.KeyInputModifierNode
    /* JADX INFO: renamed from: onKeyEvent-ZmokQxo */
    public boolean mo555onKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1854onKeyEvent8zsqlwg(event, this.textFieldState, this.textLayoutState, this.textFieldSelectionState, this.clipboardKeyCommandsHandler, requireKeyboardController(), this.enabled && !this.readOnly, this.singleLine, new Function0() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$$ExternalSyntheticLambda17
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final boolean onKeyEvent_ZmokQxo$lambda$0(TextFieldDecoratorModifierNode textFieldDecoratorModifierNode) {
        return textFieldDecoratorModifierNode.m1945onImeActionPerformedKlQnJC8(textFieldDecoratorModifierNode.keyboardOptions.m1679getImeActionOrDefaulteUduSuo$foundation());
    }
    ...
    public void mo743onRemeasuredozmzZPI(long size) {
        this.dragAndDropNode.mo743onRemeasuredozmzZPI(size);
    }
    ...
    public final void startInputSession(boolean fromTap) {
        if (fromTap || this.keyboardOptions.getShowKeyboardOnFocusOrDefault$foundation()) {
            this.inputSessionJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C06821(ReceiveContentConfigurationKt.getReceiveContentConfiguration(this), null), 3, null);
        }
    }
    ...
    static final class C06821 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06821(ReceiveContentConfiguration receiveContentConfiguration, Continuation<? super C06821> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C06821(this.$receiveContentConfiguration, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.label = 1;
                if (PlatformTextInputModifierNodeKt.establishTextInputSession(TextFieldDecoratorModifierNode.this, new C00371(TextFieldDecoratorModifierNode.this, this.$receiveContentConfiguration, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
        ...
        static final class C00371 extends SuspendLambda implements Function2<PlatformTextInputSessionScope, Continuation<?>, Object> {
            final /* synthetic */ ReceiveContentConfiguration $receiveContentConfiguration;
            private /* synthetic */ Object L$0;
            int label;
            final /* synthetic */ TextFieldDecoratorModifierNode this$0;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00371(TextFieldDecoratorModifierNode textFieldDecoratorModifierNode, ReceiveContentConfiguration receiveContentConfiguration, Continuation<? super C00371> continuation) {
                super(2, continuation);
                this.this$0 = textFieldDecoratorModifierNode;
                this.$receiveContentConfiguration = receiveContentConfiguration;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00371 c00371 = new C00371(this.this$0, this.$receiveContentConfiguration, continuation);
                c00371.L$0 = obj;
                return c00371;
            }
            ...
            public final Object invoke(PlatformTextInputSessionScope platformTextInputSessionScope, Continuation<?> continuation) {
                return ((C00371) create(platformTextInputSessionScope, continuation)).invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    Function0 function0 = new Function0() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$startInputSession$1$1$$ExternalSyntheticLambda0
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            return TextFieldDecoratorModifierNode.C06821.C00371.invokeSuspend$lambda$0(textFieldDecoratorModifierNode);
                        }
                    };
                    ...
                    this.label = 1;
                    if (AndroidTextInputSession_androidKt.platformSpecificTextInputSession(platformTextInputSessionScope, textFieldState, textLayoutState, imeOptions$foundation, receiveContentConfiguration, c00381, function0, stylusHandwritingTrigger, viewConfiguration, new Function1() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$startInputSession$1$1$$ExternalSyntheticLambda1
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj2) {
                            return TextFieldDecoratorModifierNode.C06821.C00371.invokeSuspend$lambda$1(textFieldDecoratorModifierNode2, ((Boolean) obj2).booleanValue());
                        }
            ...
            static final /* synthetic */ class C00381 extends AdaptedFunctionReference implements Function1<ImeAction, Unit> {
                C00381(Object obj) {
                ...
                public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                    m1950invokeKlQnJC8(imeAction.getValue());
                    return Unit.INSTANCE;
                }

                /* JADX INFO: renamed from: invoke-KlQnJC8, reason: not valid java name */
                public final void m1950invokeKlQnJC8(int i) {
                    ((TextFieldDecoratorModifierNode) this.receiver).m1945onImeActionPerformedKlQnJC8(i);
                }
            }
    ...
    public final boolean m1945onImeActionPerformedKlQnJC8(final int imeAction) {
        KeyboardActionHandler keyboardActionHandler;
        if (ImeAction.m9263equalsimpl0(imeAction, ImeAction.INSTANCE.m9280getNoneeUduSuo()) || ImeAction.m9263equalsimpl0(imeAction, ImeAction.INSTANCE.m9276getDefaulteUduSuo()) || (keyboardActionHandler = this.keyboardActionHandler) == null) {
            return m1944defaultKeyboardActionWithResultKlQnJC8(imeAction);
        }
    ...
    public static final Unit onImeActionPerformed_KlQnJC8$lambda$0(TextFieldDecoratorModifierNode textFieldDecoratorModifierNode, int i) {
        textFieldDecoratorModifierNode.keyboardActionScope.mo1665defaultKeyboardActionKlQnJC8(i);
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: defaultKeyboardActionWithResult-KlQnJC8, reason: not valid java name */
    public final boolean m1944defaultKeyboardActionWithResultKlQnJC8(int imeAction) {
        if (ImeAction.m9263equalsimpl0(imeAction, ImeAction.INSTANCE.m9279getNexteUduSuo())) {
            ((FocusManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFocusManager())).mo6458moveFocus3ESFkO8(FocusDirection.INSTANCE.m6452getNextdhqQ8s());
            return true;
        }
        if (ImeAction.m9263equalsimpl0(imeAction, ImeAction.INSTANCE.m9281getPreviouseUduSuo())) {
            ((FocusManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFocusManager())).mo6458moveFocus3ESFkO8(FocusDirection.INSTANCE.m6453getPreviousdhqQ8s());
            return true;
        }
        if (!ImeAction.m9263equalsimpl0(imeAction, ImeAction.INSTANCE.m9277getDoneeUduSuo())) {
            return false;
        }
