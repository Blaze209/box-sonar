...
public final class CursorAnchorInfoBuilder_androidKt {
    ...
    public static /* synthetic */ CursorAnchorInfo m1874buildvxqZcH0$default(CursorAnchorInfo.Builder builder, CharSequence charSequence, long j, TextRange textRange, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4, int i, Object obj) {
        if ((i & 128) != 0) {
            z = true;
        }
        if ((i & 256) != 0) {
        ...
        return m1873buildvxqZcH0(builder, charSequence, j, textRange, textLayoutResult, matrix, rect, rect2, z, z2, z3, z4);
    }

    /* JADX INFO: renamed from: build-vxqZcH0, reason: not valid java name */
    public static final CursorAnchorInfo m1873buildvxqZcH0(CursorAnchorInfo.Builder builder, CharSequence charSequence, long j, TextRange textRange, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        builder.reset();
        builder.setMatrix(matrix);
        int iM9089getMinimpl = TextRange.m9089getMinimpl(j);
        builder.setSelectionRange(iM9089getMinimpl, TextRange.m9088getMaximpl(j));
        if (z) {
            setInsertionMarker(builder, iM9089getMinimpl, textLayoutResult, rect);
        }
        if (z2) {
            int iM9089getMinimpl2 = textRange != null ? TextRange.m9089getMinimpl(textRange.getPackedValue()) : -1;
            int iM9088getMaximpl = textRange != null ? TextRange.m9088getMaximpl(textRange.getPackedValue()) : -1;
            if (iM9089getMinimpl2 >= 0 && iM9089getMinimpl2 < iM9088getMaximpl) {
                builder.setComposingText(iM9089getMinimpl2, charSequence.subSequence(iM9089getMinimpl2, iM9088getMaximpl));
                addCharacterBounds(builder, iM9089getMinimpl2, iM9088getMaximpl, textLayoutResult, rect);
            }
        }
    ...
    private static final CursorAnchorInfo.Builder addCharacterBounds(CursorAnchorInfo.Builder builder, int i, int i2, TextLayoutResult textLayoutResult, Rect rect) {
        ...
        textLayoutResult.getMultiParagraph().m8924fillBoundingBoxes8ffj60Q(TextRangeKt.TextRange(i, i2), fArr, 0);
