...
public final class TextFieldState {
    ...
    private TextFieldState(String str, long j, TextUndoManager textUndoManager) {
        ...
        String str2 = str;
        this.mainBuffer = new TextFieldBuffer(new TextFieldCharSequence(str2, TextRangeKt.m9097coerceIn8ffj60Q(j, 0, str.length()), null, null, null, null, 60, null), null, null, null, 14, null);
    ...
    public final TextRange m1828getCompositionMzsxiRA() {
    ...
    public String toString() {
        ...
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m9094toStringimpl(m1829getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
    ...
    public final void commitEdit(TextFieldBuffer newValue) {
        ...
        boolean zM9084equalsimpl0 = TextRange.m9084equalsimpl0(newValue.getSelectionInChars(), this.mainBuffer.getSelectionInChars());
        boolean z2 = !zM9084equalsimpl0;
        if (!z && zM9084equalsimpl0) {
            newValue.setCanCallAddStyle$foundation(true);
        }
        if (z) {
            textFieldBuffer = newValue;
            recordEditForUndo(getValue$foundation(), TextFieldBuffer.m1816toTextFieldCharSequencewFTz33Y$foundation$default(textFieldBuffer, 0L, null, null, null, 15, null), textFieldBuffer.getChanges(), TextFieldEditUndoBehavior.NeverMerge);
        } else {
            textFieldBuffer = newValue;
        }
    ...
    public final void editWithNoSideEffects$foundation(Function1<? super TextFieldBuffer, Unit> block) {
        getMainBuffer().getChangeTracker$foundation().clearChanges();
        block.invoke(getMainBuffer());
        updateValueAndNotifyListeners(getValue$foundation(), TextFieldBuffer.m1816toTextFieldCharSequencewFTz33Y$foundation$default(getMainBuffer(), 0L, null, null, null, 15, null), true);
    }
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean restartImeIfContentChanges, TextFieldEditUndoBehavior undoBehavior) {
        ...
        if (this.mainBuffer.getChangeTracker$foundation().getChangeCount() == 0 && TextRange.m9084equalsimpl0(value$foundation.getSelection(), this.mainBuffer.getSelectionInChars())) {
            ...
            updateValueAndNotifyListeners(getValue$foundation(), new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.getSelectionInChars(), this.mainBuffer.getComposition(), this.mainBuffer.getHighlight$foundation(), TextFieldStateKt.m1831finalizeComposingAnnotationsitr0ztk(this.mainBuffer.getComposition(), this.mainBuffer.getComposingAnnotations$foundation()), null, 32, null), restartImeIfContentChanges);
            return;
        }
        boolean z = false;
        boolean z2 = this.mainBuffer.getChangeTracker$foundation().getChangeCount() != 0;
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.getSelectionInChars(), this.mainBuffer.getComposition(), this.mainBuffer.getHighlight$foundation(), TextFieldStateKt.m1831finalizeComposingAnnotationsitr0ztk(this.mainBuffer.getComposition(), this.mainBuffer.getComposingAnnotations$foundation()), null, 32, null);
        ...
        boolean zM9084equalsimpl0 = TextRange.m9084equalsimpl0(textFieldBuffer.getSelectionInChars(), textFieldCharSequence.getSelection());
        boolean z4 = !zM9084equalsimpl0;
        if (!zContentEquals || !zM9084equalsimpl0) {
            syncMainBufferToTemporaryBuffer$foundation(textFieldBuffer, z3, z4);
        } else {
            updateValueAndNotifyListeners(value$foundation, TextFieldBuffer.m1816toTextFieldCharSequencewFTz33Y$foundation$default(textFieldBuffer, 0L, textFieldCharSequence.getComposition(), null, null, 13, null), restartImeIfContentChanges);
        }
    ...
    public final void syncMainBufferToTemporaryBuffer$foundation(TextFieldBuffer temporaryBuffer, boolean textChanged, boolean selectionChanged) {
        TextFieldCharSequence textFieldCharSequenceM1816toTextFieldCharSequencewFTz33Y$foundation$default = TextFieldBuffer.m1816toTextFieldCharSequencewFTz33Y$foundation$default(this.mainBuffer, 0L, null, null, null, 15, null);
        if (textChanged) {
            ...
            this.mainBuffer.m1821setSelection5zctL8(TextRangeKt.TextRange(TextRange.m9091getStartimpl(temporaryBuffer.getSelectionInChars()), TextRange.m9086getEndimpl(temporaryBuffer.getSelectionInChars())));
        }
        if (textChanged || selectionChanged || !Intrinsics.areEqual(textFieldCharSequenceM1816toTextFieldCharSequencewFTz33Y$foundation$default.getComposition(), temporaryBuffer.getComposition())) {
            this.mainBuffer.commitComposition$foundation();
        }
        updateValueAndNotifyListeners(textFieldCharSequenceM1816toTextFieldCharSequencewFTz33Y$foundation$default, TextFieldBuffer.m1816toTextFieldCharSequencewFTz33Y$foundation$default(this.mainBuffer, 0L, null, null, null, 15, null), true);
    }
    ...
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope saverScope, TextFieldState textFieldState) {
            return CollectionsKt.listOf(textFieldState.getText().toString(), Integer.valueOf(TextRange.m9091getStartimpl(textFieldState.m1829getSelectiond9O1mEE())), Integer.valueOf(TextRange.m9086getEndimpl(textFieldState.m1829getSelectiond9O1mEE())), TextUndoManager.Companion.Saver.INSTANCE.save(saverScope, textFieldState.getTextUndoManager()));
        }
