...
public final class LegacyCursorAnchorInfoBuilder_androidKt {
    ...
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        builder.setSelectionRange(iM9089getMinimpl, TextRange.m9088getMaximpl(textFieldValue.getSelection()));
        if (z) {
            setInsertionMarker(builder, iM9089getMinimpl, offsetMapping, textLayoutResult, rect);
        }
        if (z2) {
            ...
            int iM9088getMaximpl = composition2 != null ? TextRange.m9088getMaximpl(composition2.getPackedValue()) : -1;
            if (iM9089getMinimpl2 >= 0 && iM9089getMinimpl2 < iM9088getMaximpl) {
                builder.setComposingText(iM9089getMinimpl2, textFieldValue.getText().subSequence(iM9089getMinimpl2, iM9088getMaximpl));
                addCharacterBounds(builder, iM9089getMinimpl2, iM9088getMaximpl, offsetMapping, textLayoutResult, rect);
            }
        }
    ...
    private static final CursorAnchorInfo.Builder addCharacterBounds(CursorAnchorInfo.Builder builder, int i, int i2, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Rect rect) {
        ...
        textLayoutResult.getMultiParagraph().m8924fillBoundingBoxes8ffj60Q(TextRangeKt.TextRange(iOriginalToTransformed, iOriginalToTransformed2), fArr, 0);
