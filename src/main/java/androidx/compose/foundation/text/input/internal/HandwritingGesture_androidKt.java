...
public final class HandwritingGesture_androidKt {
    ...
    public static final long m1892adjustHandwritingDeleteGestureRange72CqOWE(long j, CharSequence charSequence) {
        int iM9091getStartimpl = TextRange.m9091getStartimpl(j);
        int iM9086getEndimpl = TextRange.m9086getEndimpl(j);
        int iCodePointBefore = iM9091getStartimpl > 0 ? Character.codePointBefore(charSequence, iM9091getStartimpl) : 10;
        int iCodePointAt = iM9086getEndimpl < charSequence.length() ? Character.codePointAt(charSequence, iM9086getEndimpl) : 10;
        if (isWhitespaceExceptNewline(iCodePointBefore) && (isWhitespace(iCodePointAt) || isPunctuation(iCodePointAt))) {
            do {
                iM9091getStartimpl -= Character.charCount(iCodePointBefore);
                if (iM9091getStartimpl == 0) {
                    break;
                }
                iCodePointBefore = Character.codePointBefore(charSequence, iM9091getStartimpl);
            } while (isWhitespaceExceptNewline(iCodePointBefore));
            return TextRangeKt.TextRange(iM9091getStartimpl, iM9086getEndimpl);
        }
        ...
        do {
            iM9086getEndimpl += Character.charCount(iCodePointAt);
            if (iM9086getEndimpl == charSequence.length()) {
                break;
            }
            iCodePointAt = Character.codePointAt(charSequence, iM9086getEndimpl);
    ...
    public static final long toOffset(PointF pointF) {
        float f = pointF.x;
        float f2 = pointF.y;
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(f)) << 32) | (((long) Float.floatToRawIntBits(f2)) & 4294967295L));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: getRangeForScreenRect-OH9lIzo, reason: not valid java name */
    public static final long m1901getRangeForScreenRectOH9lIzo(TextLayoutState textLayoutState, Rect rect, int i, TextInclusionStrategy textInclusionStrategy) {
        TextLayoutResult layoutResult = textLayoutState.getLayoutResult();
        return m1899getRangeForScreenRectO048IG0(layoutResult != null ? layoutResult.getMultiParagraph() : null, rect, textLayoutState.getTextLayoutNodeCoordinates(), i, textInclusionStrategy);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: getRangeForScreenRects-O048IG0, reason: not valid java name */
    public static final long m1903getRangeForScreenRectsO048IG0(TextLayoutState textLayoutState, Rect rect, Rect rect2, int i, TextInclusionStrategy textInclusionStrategy) {
        long jM1901getRangeForScreenRectOH9lIzo = m1901getRangeForScreenRectOH9lIzo(textLayoutState, rect, i, textInclusionStrategy);
        if (TextRange.m9085getCollapsedimpl(jM1901getRangeForScreenRectOH9lIzo)) {
            return TextRange.INSTANCE.m9096getZerod9O1mEE();
        }
        long jM1901getRangeForScreenRectOH9lIzo2 = m1901getRangeForScreenRectOH9lIzo(textLayoutState, rect2, i, textInclusionStrategy);
        return TextRange.m9085getCollapsedimpl(jM1901getRangeForScreenRectOH9lIzo2) ? TextRange.INSTANCE.m9096getZerod9O1mEE() : m1893enclosurepWDy79M(jM1901getRangeForScreenRectOH9lIzo, jM1901getRangeForScreenRectOH9lIzo2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: getRangeForScreenRect-OH9lIzo, reason: not valid java name */
    public static final long m1900getRangeForScreenRectOH9lIzo(LegacyTextFieldState legacyTextFieldState, Rect rect, int i, TextInclusionStrategy textInclusionStrategy) {
        TextLayoutResult value;
        TextLayoutResultProxy layoutResult = legacyTextFieldState.getLayoutResult();
        return m1899getRangeForScreenRectO048IG0((layoutResult == null || (value = layoutResult.getValue()) == null) ? null : value.getMultiParagraph(), rect, legacyTextFieldState.getLayoutCoordinates(), i, textInclusionStrategy);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: getRangeForScreenRects-O048IG0, reason: not valid java name */
    public static final long m1902getRangeForScreenRectsO048IG0(LegacyTextFieldState legacyTextFieldState, Rect rect, Rect rect2, int i, TextInclusionStrategy textInclusionStrategy) {
        long jM1900getRangeForScreenRectOH9lIzo = m1900getRangeForScreenRectOH9lIzo(legacyTextFieldState, rect, i, textInclusionStrategy);
        if (TextRange.m9085getCollapsedimpl(jM1900getRangeForScreenRectOH9lIzo)) {
            return TextRange.INSTANCE.m9096getZerod9O1mEE();
        }
        long jM1900getRangeForScreenRectOH9lIzo2 = m1900getRangeForScreenRectOH9lIzo(legacyTextFieldState, rect2, i, textInclusionStrategy);
        return TextRange.m9085getCollapsedimpl(jM1900getRangeForScreenRectOH9lIzo2) ? TextRange.INSTANCE.m9096getZerod9O1mEE() : m1893enclosurepWDy79M(jM1900getRangeForScreenRectOH9lIzo, jM1900getRangeForScreenRectOH9lIzo2);
    }
    ...
    public static final int m1896getOffsetForHandwritingGestured4ec7I(TextLayoutState textLayoutState, long j, ViewConfiguration viewConfiguration) {
        MultiParagraph multiParagraph;
        TextLayoutResult layoutResult = textLayoutState.getLayoutResult();
        if (layoutResult == null || (multiParagraph = layoutResult.getMultiParagraph()) == null) {
            return -1;
        }
        return m1897getOffsetForHandwritingGestureubNVwUQ(multiParagraph, j, textLayoutState.getTextLayoutNodeCoordinates(), viewConfiguration);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: getOffsetForHandwritingGesture-d-4ec7I, reason: not valid java name */
    public static final int m1895getOffsetForHandwritingGestured4ec7I(LegacyTextFieldState legacyTextFieldState, long j, ViewConfiguration viewConfiguration) {
        TextLayoutResult value;
        MultiParagraph multiParagraph;
        TextLayoutResultProxy layoutResult = legacyTextFieldState.getLayoutResult();
        ...
        return m1897getOffsetForHandwritingGestureubNVwUQ(multiParagraph, j, legacyTextFieldState.getLayoutCoordinates(), viewConfiguration);
    }
    ...
    private static final long m1899getRangeForScreenRectO048IG0(MultiParagraph multiParagraph, Rect rect, LayoutCoordinates layoutCoordinates, int i, TextInclusionStrategy textInclusionStrategy) {
        if (multiParagraph == null || layoutCoordinates == null) {
            return TextRange.INSTANCE.m9096getZerod9O1mEE();
        }
        return multiParagraph.m8926getRangeForRect86BmAI(rect.m6606translatek4lQ0M(layoutCoordinates.mo8279screenToLocalMKHz9U(Offset.INSTANCE.m6585getZeroF1C5BW0())), i, textInclusionStrategy);
    }

    /* JADX INFO: renamed from: getOffsetForHandwritingGesture-ubNVwUQ, reason: not valid java name */
    private static final int m1897getOffsetForHandwritingGestureubNVwUQ(MultiParagraph multiParagraph, long j, LayoutCoordinates layoutCoordinates, ViewConfiguration viewConfiguration) {
        long jMo8279screenToLocalMKHz9U;
        int iM1894getLineForHandwritingGestured4ec7I;
        if (layoutCoordinates == null || (iM1894getLineForHandwritingGestured4ec7I = m1894getLineForHandwritingGestured4ec7I(multiParagraph, (jMo8279screenToLocalMKHz9U = layoutCoordinates.mo8279screenToLocalMKHz9U(j)), viewConfiguration)) == -1) {
            return -1;
        }
        return multiParagraph.m8925getOffsetForPositionk4lQ0M(Offset.m6563copydBAh8RU$default(jMo8279screenToLocalMKHz9U, 0.0f, (multiParagraph.getLineTop(iM1894getLineForHandwritingGestured4ec7I) + multiParagraph.getLineBottom(iM1894getLineForHandwritingGestured4ec7I)) / 2.0f, 1, null));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: getRangeForRemoveSpaceGesture-5iVPX68, reason: not valid java name */
    public static final long m1898getRangeForRemoveSpaceGesture5iVPX68(TextLayoutResult textLayoutResult, long j, long j2, LayoutCoordinates layoutCoordinates, ViewConfiguration viewConfiguration) {
        if (textLayoutResult == null || layoutCoordinates == null) {
            return TextRange.INSTANCE.m9096getZerod9O1mEE();
        }
        long jMo8279screenToLocalMKHz9U = layoutCoordinates.mo8279screenToLocalMKHz9U(j);
        long jMo8279screenToLocalMKHz9U2 = layoutCoordinates.mo8279screenToLocalMKHz9U(j2);
        int iM1894getLineForHandwritingGestured4ec7I = m1894getLineForHandwritingGestured4ec7I(textLayoutResult.getMultiParagraph(), jMo8279screenToLocalMKHz9U, viewConfiguration);
        int iM1894getLineForHandwritingGestured4ec7I2 = m1894getLineForHandwritingGestured4ec7I(textLayoutResult.getMultiParagraph(), jMo8279screenToLocalMKHz9U2, viewConfiguration);
        if (iM1894getLineForHandwritingGestured4ec7I != -1) {
            if (iM1894getLineForHandwritingGestured4ec7I2 != -1) {
                iM1894getLineForHandwritingGestured4ec7I = Math.min(iM1894getLineForHandwritingGestured4ec7I, iM1894getLineForHandwritingGestured4ec7I2);
            }
            iM1894getLineForHandwritingGestured4ec7I2 = iM1894getLineForHandwritingGestured4ec7I;
        } else if (iM1894getLineForHandwritingGestured4ec7I2 == -1) {
            return TextRange.INSTANCE.m9096getZerod9O1mEE();
        }
        float lineTop = (textLayoutResult.getLineTop(iM1894getLineForHandwritingGestured4ec7I2) + textLayoutResult.getLineBottom(iM1894getLineForHandwritingGestured4ec7I2)) / 2;
        int i = (int) (jMo8279screenToLocalMKHz9U >> 32);
        int i2 = (int) (jMo8279screenToLocalMKHz9U2 >> 32);
        return textLayoutResult.getMultiParagraph().m8926getRangeForRect86BmAI(new Rect(Math.min(Float.intBitsToFloat(i), Float.intBitsToFloat(i2)), lineTop - 0.1f, Math.max(Float.intBitsToFloat(i), Float.intBitsToFloat(i2)), lineTop + 0.1f), TextGranularity.INSTANCE.m9052getCharacterDRrd7Zo(), TextInclusionStrategy.INSTANCE.getAnyOverlap());
    }

    /* JADX INFO: renamed from: getLineForHandwritingGesture-d-4ec7I, reason: not valid java name */
    private static final int m1894getLineForHandwritingGestured4ec7I(MultiParagraph multiParagraph, long j, ViewConfiguration viewConfiguration) {
    ...
    private static final long m1893enclosurepWDy79M(long j, long j2) {
        return TextRangeKt.TextRange(Math.min(TextRange.m9091getStartimpl(j), TextRange.m9091getStartimpl(j)), Math.max(TextRange.m9086getEndimpl(j2), TextRange.m9086getEndimpl(j2)));
    }
}
