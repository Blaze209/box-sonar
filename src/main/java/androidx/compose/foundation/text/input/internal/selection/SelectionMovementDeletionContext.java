...
public final class SelectionMovementDeletionContext {
    ...
    public final void m2005setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m9086getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m9086getEndimpl(this.selection));
    }
    ...
    public final SelectionMovementDeletionContext moveCursorUpByLine() {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(RangesKt.coerceAtLeast(iJumpByLinesOffset, 0), iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
            }
            if (wedgeAffinityM1993component2impl != null) {
                setWedgeAffinity(wedgeAffinityM1993component2impl);
            }
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext moveCursorDownByLine() {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(RangesKt.coerceAtMost(iJumpByLinesOffset, this.text.length()), iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    private final boolean isLtr() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        return textLayoutResult == null || (paragraphDirection = textLayoutResult.getParagraphDirection(TextRange.m9086getEndimpl(this.selection))) == null || paragraphDirection == ResolvedTextDirection.Ltr;
    }
    ...
    static /* synthetic */ int getNextWordOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m9086getEndimpl(selectionMovementDeletionContext.selection);
        }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.initialValue.length()) {
            long jM9063getWordBoundaryjx7JFs = textLayoutResult.m9063getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m9086getEndimpl(jM9063getWordBoundaryjx7JFs) > i) {
                return TextRange.m9086getEndimpl(jM9063getWordBoundaryjx7JFs);
            }
            i++;
        }
    ...
    private final int getPrevWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            long jM9063getWordBoundaryjx7JFs = textLayoutResult.m9063getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m9091getStartimpl(jM9063getWordBoundaryjx7JFs) < i) {
                return TextRange.m9091getStartimpl(jM9063getWordBoundaryjx7JFs);
            }
            i--;
        }
        return 0;
    ...
    static /* synthetic */ int getLineStartByOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m9089getMinimpl(selectionMovementDeletionContext.selection);
        }
    ...
    static /* synthetic */ int getLineEndByOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m9088getMaximpl(selectionMovementDeletionContext.selection);
        }
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        int iM9086getEndimpl = TextRange.m9086getEndimpl(this.selection);
        if (Float.isNaN(this.textPreparedSelectionState.getCachedX())) {
            this.textPreparedSelectionState.setCachedX(textLayoutResult.getCursorRect(iM9086getEndimpl).getLeft());
        }
        int lineForOffset = textLayoutResult.getLineForOffset(iM9086getEndimpl) + i;
        if (lineForOffset < 0) {
        ...
        return textLayoutResult.m9061getOffsetForPositionk4lQ0M(Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(cachedX)) << 32) | (((long) Float.floatToRawIntBits(lineBottom)) & 4294967295L)));
    }

    private final int jumpByPagesOffset(int pagesAmount) {
        int iM9086getEndimpl = TextRange.m9086getEndimpl(this.initialValue.getSelection());
        if (this.textLayoutResult == null || Float.isNaN(this.visibleTextLayoutHeight)) {
            return iM9086getEndimpl;
        }
        Rect rectTranslate = this.textLayoutResult.getCursorRect(iM9086getEndimpl).translate(0.0f, this.visibleTextLayoutHeight * pagesAmount);
        ...
        if (Math.abs(rectTranslate.getTop() - lineBottom) > Math.abs(rectTranslate.getBottom() - lineBottom)) {
            return this.textLayoutResult.m9061getOffsetForPositionk4lQ0M(rectTranslate.m6604getTopLeftF1C5BW0());
        }
        return this.textLayoutResult.m9061getOffsetForPositionk4lQ0M(rectTranslate.m6597getBottomLeftF1C5BW0());
    }
    ...
    public final SelectionMovementDeletionContext deselect() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m9086getEndimpl(this.selection));
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext collapseLeftOr(Function1<? super SelectionMovementDeletionContext, Unit> or) {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            if (TextRange.m9085getCollapsedimpl(this.selection)) {
                or.invoke(this);
                return this;
            }
            if (isLtr()) {
                this.selection = TextRangeKt.TextRange(TextRange.m9089getMinimpl(this.selection));
                return this;
            }
            this.selection = TextRangeKt.TextRange(TextRange.m9088getMaximpl(this.selection));
        }
        return this;
    }
    ...
    private final SelectionMovementDeletionContext moveCursorTo(boolean resetCachedX, Function0<Integer> proposedCursorMovement) {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(proposedCursorMovement.invoke().intValue(), iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    static /* synthetic */ SelectionMovementDeletionContext moveCursorTo$default(SelectionMovementDeletionContext selectionMovementDeletionContext, boolean z, Function0 function0, int i, Object obj) {
        ...
        if (selectionMovementDeletionContext.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(selectionMovementDeletionContext.getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(((Number) function0.invoke()).intValue(), iM9086getEndimpl, selectionMovementDeletionContext.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(selectionMovementDeletionContext.getSelection())) {
                selectionMovementDeletionContext.m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
            }
            if (wedgeAffinityM1993component2impl != null) {
                selectionMovementDeletionContext.setWedgeAffinity(wedgeAffinityM1993component2impl);
            }
        }
        return selectionMovementDeletionContext;
    }
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByCodePointOrEmoji() {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findCodePointOrEmojiStartBefore(this.text, TextRange.m9086getEndimpl(this.selection), -1), iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByChar() {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m9086getEndimpl(this.selection)), iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorNextByChar() {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m9086getEndimpl(this.selection)), iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToHome() {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(0, iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToEnd() {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(this.text.length(), iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorNextByWord() {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getNextWordOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : this.text.length(), iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByWord() {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getPrevWordOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : 0, iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByParagraph() {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            int iFindParagraphStart = StringHelpersKt.findParagraphStart(this.text, TextRange.m9089getMinimpl(this.selection));
            if (iFindParagraphStart == TextRange.m9089getMinimpl(this.selection) && iFindParagraphStart != 0) {
                iFindParagraphStart = StringHelpersKt.findParagraphStart(this.text, iFindParagraphStart - 1);
            }
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(iFindParagraphStart, iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorNextByParagraph() {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            int iFindParagraphEnd = StringHelpersKt.findParagraphEnd(this.text, TextRange.m9088getMaximpl(this.selection));
            if (iFindParagraphEnd == TextRange.m9088getMaximpl(this.selection) && iFindParagraphEnd != this.text.length()) {
                iFindParagraphEnd = StringHelpersKt.findParagraphEnd(this.text, iFindParagraphEnd + 1);
            }
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(iFindParagraphEnd, iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToLineStart() {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getLineStartByOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : 0, iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToLineEnd() {
        ...
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getLineEndByOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : this.text.length(), iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorUpByPage() {
        if (this.text.length() > 0) {
            int iM9086getEndimpl = TextRange.m9086getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(jumpByPagesOffset(-1), iM9086getEndimpl, this.state);
            int iM1992component1impl = CursorAndWedgeAffinity.m1992component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM1993component2impl = CursorAndWedgeAffinity.m1993component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM1992component1impl != iM9086getEndimpl || !TextRange.m9085getCollapsedimpl(getSelection())) {
                m2005setSelection5zctL8(TextRangeKt.TextRange(iM1992component1impl));
    ...
    public final SelectionMovementDeletionContext selectMovement() {
        if (this.text.length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m9091getStartimpl(this.initialValue.getSelection()), TextRange.m9086getEndimpl(this.selection));
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext deleteMovement() {
        if (this.text.length() > 0) {
            if (!TextRange.m9085getCollapsedimpl(this.initialValue.getSelection())) {
                this.state.deleteSelectedText();
            } else {
                TransformedTextFieldState.m1977replaceTextM8tDOmk$default(this.state, "", TextRangeKt.TextRange(TextRange.m9091getStartimpl(this.initialValue.getSelection()), TextRange.m9086getEndimpl(this.selection)), null, !this.isFromSoftKeyboard, 4, null);
            }
