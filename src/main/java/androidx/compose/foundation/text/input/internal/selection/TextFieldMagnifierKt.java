...
public final class TextFieldMagnifierKt {
    ...
    public static final long m2011calculateSelectionMagnifierCenterAndroidhUlJWOE(TransformedTextFieldState transformedTextFieldState, TextFieldSelectionState textFieldSelectionState, TextLayoutState textLayoutState, long j) {
        int iM9091getStartimpl;
        long jM2031getHandleDragPositionF1C5BW0 = textFieldSelectionState.m2031getHandleDragPositionF1C5BW0();
        if ((9223372034707292159L & jM2031getHandleDragPositionF1C5BW0) == InlineClassHelperKt.UnspecifiedPackedFloats || transformedTextFieldState.getVisualText().length() == 0) {
        ...
        if (i == 1 || i == 2) {
            iM9091getStartimpl = TextRange.m9091getStartimpl(selection);
        } else {
            if (i != 3) {
                throw new NoWhenBranchMatchedException();
            }
            iM9091getStartimpl = TextRange.m9086getEndimpl(selection);
        }
        TextLayoutResult layoutResult = textLayoutState.getLayoutResult();
        if (layoutResult == null) {
            return Offset.INSTANCE.m6584getUnspecifiedF1C5BW0();
        }
        float fIntBitsToFloat = Float.intBitsToFloat((int) (jM2031getHandleDragPositionF1C5BW0 >> 32));
        int lineForOffset = layoutResult.getLineForOffset(iM9091getStartimpl);
        ...
        long jM6561constructorimpl = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(((layoutResult.getLineBottom(lineForOffset) - lineTop) / 2) + lineTop)) & 4294967295L) | (((long) Float.floatToRawIntBits(fCoerceIn)) << 32));
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null) {
                jM6561constructorimpl = TextLayoutStateKt.m1970coerceIn3MmeM6k(jM6561constructorimpl, SelectionManagerKt.visibleBounds(textLayoutNodeCoordinates));
            }
        }
        return TextLayoutStateKt.m1972fromTextLayoutToCoreUv8p0NA(textLayoutState, jM6561constructorimpl);
    }
}
