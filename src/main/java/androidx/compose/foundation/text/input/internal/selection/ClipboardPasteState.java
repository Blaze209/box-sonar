...
public final class ClipboardPasteState {
    ...
    public final Object update(Continuation<? super Unit> continuation) {
        ...
        boolean zHasPrimaryClip = MAMClipboard.hasPrimaryClip(this.clipboard.getNativeClipboard());
        this._hasClip = zHasPrimaryClip;
        if (zHasPrimaryClip && (primaryClipDescription = MAMClipboard.getPrimaryClipDescription(this.clipboard.getNativeClipboard())) != null) {
