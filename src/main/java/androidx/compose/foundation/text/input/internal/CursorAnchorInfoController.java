...
public final class CursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m7060constructorimpl$default(null, 1, null);
    ...
    @DebugMetadata(c = "androidx.compose.foundation.text.input.internal.CursorAnchorInfoController$startOrStopMonitoring$1", f = "CursorAnchorInfoController.android.kt", i = {}, l = {Token.LET}, m = "invokeSuspend", n = {}, s = {}, v = 1)
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null && (coreNodeCoordinates = this.textLayoutState.getCoreNodeCoordinates()) != null) {
                ...
                if (coreNodeCoordinates != null && (decoratorNodeCoordinates = this.textLayoutState.getDecoratorNodeCoordinates()) != null) {
                    ...
                    Matrix.m7069resetimpl(this.matrix);
                    textLayoutNodeCoordinates.mo8281transformToScreen58bKbWc(this.matrix);
                    AndroidMatrixConversions_androidKt.m6681setFromEL8BTi8(this.androidMatrix, this.matrix);
                    return CursorAnchorInfoBuilder_androidKt.m1873buildvxqZcH0(this.builder, visualText, visualText.getSelection(), visualText.getComposition(), layoutResult, this.androidMatrix, SelectionManagerKt.visibleBounds(coreNodeCoordinates).m6606translatek4lQ0M(textLayoutNodeCoordinates.mo8274localPositionOfR5De75A(coreNodeCoordinates, Offset.INSTANCE.m6585getZeroF1C5BW0())), SelectionManagerKt.visibleBounds(decoratorNodeCoordinates).m6606translatek4lQ0M(textLayoutNodeCoordinates.mo8274localPositionOfR5De75A(decoratorNodeCoordinates, Offset.INSTANCE.m6585getZeroF1C5BW0())), this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds);
                }
            }
        }
        return null;
