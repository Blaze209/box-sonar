...
public abstract class TextFieldKeyEventHandler {
    ...
    public boolean mo1855onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        if (TextRange.m9085getCollapsedimpl(textFieldState.getVisualText().getSelection()) || !KeyEventHelpers_androidKt.m1662cancelsTextSelectionZmokQxo(event)) {
            return false;
        }
    ...
    public boolean mo1854onKeyEvent8zsqlwg(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, Function1<? super KeyCommand, ? extends Unit> clipboardKeyCommandsHandler, SoftwareKeyboardController keyboardController, boolean editable, boolean singleLine, Function0<Boolean> onSubmit) {
        ...
        if (KeyEventType.m7970equalsimpl0(KeyEvent_androidKt.m7978getTypeZmokQxo(event), KeyEventType.INSTANCE.m7975getKeyUpCS__XNY())) {
            ...
            if (mutableLongSet == null || !mutableLongSet.contains(jM7977getKeyZmokQxo)) {
                return false;
            }
            MutableLongSet mutableLongSet2 = this.currentlyConsumedDownKeys;
            if (mutableLongSet2 != null) {
                mutableLongSet2.remove(jM7977getKeyZmokQxo);
            }
            return true;
        }
        if (KeyEventType.m7970equalsimpl0(KeyEvent_androidKt.m7978getTypeZmokQxo(event), KeyEventType.INSTANCE.m7976getUnknownCS__XNY()) && !TextFieldKeyInput_androidKt.m1745isTypedEventZmokQxo(event)) {
            return false;
        }
        boolean zM1952processKeyDownEventq0GpTC0 = m1952processKeyDownEventq0GpTC0(event, textFieldState, textLayoutState, clipboardKeyCommandsHandler, keyboardController, editable, singleLine, onSubmit);
        if (zM1952processKeyDownEventq0GpTC0) {
            ...
            mutableLongSet3.plusAssign(jM7977getKeyZmokQxo);
        }
        return zM1952processKeyDownEventq0GpTC0;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:99:0x0255  */
    /* JADX INFO: renamed from: processKeyDownEvent-q0GpTC0, reason: not valid java name */
    private final boolean m1952processKeyDownEventq0GpTC0(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, Function1<? super KeyCommand, ? extends Unit> clipboardKeyCommandsHandler, SoftwareKeyboardController keyboardController, boolean editable, boolean singleLine, Function0<Boolean> onSubmit) {
        WedgeAffinity wedgeAffinity;
        Integer numM1659consumeZmokQxo;
        boolean zBooleanValue = false;
        if (TextFieldKeyInput_androidKt.m1745isTypedEventZmokQxo(event) && (numM1659consumeZmokQxo = this.deadKeyCombiner.m1659consumeZmokQxo(event)) != null) {
            String string = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(2), numM1659consumeZmokQxo.intValue()).toString();
            if (!editable) {
                return false;
            }
            TransformedTextFieldState.replaceSelectedText$default(textFieldState, string, true, null, !TextFieldKeyEventHandler_androidKt.m1954isFromSoftKeyboardZmokQxo(event), 4, null);
            this.preparedSelectionState.resetCachedX();
            return true;
        }
        KeyCommand keyCommandMo1663mapZmokQxo = this.keyMapping.mo1663mapZmokQxo(event);
        if (keyCommandMo1663mapZmokQxo != null && (!keyCommandMo1663mapZmokQxo.getEditsText() || editable)) {
            SelectionMovementDeletionContext selectionMovementDeletionContext = new SelectionMovementDeletionContext(textFieldState, textLayoutState.getLayoutResult(), TextFieldKeyEventHandler_androidKt.m1954isFromSoftKeyboardZmokQxo(event), getVisibleTextLayoutHeight(textLayoutState), this.preparedSelectionState);
            switch (WhenMappings.$EnumSwitchMapping$0[keyCommandMo1663mapZmokQxo.ordinal()]) {
                case 1:
                case 2:
                case 3:
                    clipboardKeyCommandsHandler.invoke(keyCommandMo1663mapZmokQxo);
                    Unit unit = Unit.INSTANCE;
                    zBooleanValue = true;
                    if (ComposeFoundationFlags.isTextFieldDpadNavigationEnabled && (keyCommandMo1663mapZmokQxo == KeyCommand.UP || keyCommandMo1663mapZmokQxo == KeyCommand.DOWN || keyCommandMo1663mapZmokQxo == KeyCommand.LEFT_CHAR || keyCommandMo1663mapZmokQxo == KeyCommand.RIGHT_CHAR)) {
                        zBooleanValue = !TextRange.m9084equalsimpl0(selectionMovementDeletionContext.getInitialValue().getSelection(), selectionMovementDeletionContext.getSelection());
                    }
                    if (!TextRange.m9084equalsimpl0(selectionMovementDeletionContext.getSelection(), selectionMovementDeletionContext.getInitialValue().getSelection())) {
                        textFieldState.m1984selectCharsIn5zctL8(selectionMovementDeletionContext.getSelection());
                    }
                    if (selectionMovementDeletionContext.getWedgeAffinity() != null && (wedgeAffinity = selectionMovementDeletionContext.getWedgeAffinity()) != null) {
                        if (TextRange.m9085getCollapsedimpl(textFieldState.getUntransformedText().getSelection())) {
                ...
                case 26:
                    if (!singleLine) {
                        TransformedTextFieldState.replaceSelectedText$default(textFieldState, "\n", true, null, !TextFieldKeyEventHandler_androidKt.m1954isFromSoftKeyboardZmokQxo(event), 4, null);
                        zBooleanValue = true;
                    } else {
                ...
                case 27:
                    if (!singleLine) {
                        TransformedTextFieldState.replaceSelectedText$default(textFieldState, "\t", true, null, !TextFieldKeyEventHandler_androidKt.m1954isFromSoftKeyboardZmokQxo(event), 4, null);
                        zBooleanValue = true;
                    }
    ...
    private final float getVisibleTextLayoutHeight(TextLayoutState textLayoutState) {
        ...
        if (rectLocalBoundingBoxOf$default != null) {
            return Float.intBitsToFloat((int) (rectLocalBoundingBoxOf$default.m6602getSizeNHjbRc() & 4294967295L));
        }
        return Float.NaN;
    }
}
