...
public final class DefaultImeEditCommandScope implements ImeEditCommandScope {
    ...
    public long mo1858mapFromTransformedGEjPoXI(long range) {
        return this.transformedTextFieldState.m1980mapFromTransformedGEjPoXI(range);
    }

    @Override // androidx.compose.foundation.text.input.internal.ImeEditCommandScope
    /* JADX INFO: renamed from: mapToTransformed-GEjPoXI */
    public long mo1859mapToTransformedGEjPoXI(long range) {
        return this.transformedTextFieldState.m1982mapToTransformedGEjPoXI(range);
    }
