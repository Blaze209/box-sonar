...
public final class CoreTextFieldSemanticsModifierNode extends DelegatingNode implements SemanticsModifierNode {
    ...
    public void applySemantics(final SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        SemanticsPropertiesKt.m8852setTextSelectionRangeFDrldGo(semanticsPropertyReceiver, this.value.getSelection());
        ...
        SemanticsPropertiesKt.m8848onImeAction9UiTYpY$default(semanticsPropertyReceiver, this.imeOptions.getImeAction(), null, new Function0() { // from class: androidx.compose.foundation.text.input.internal.CoreTextFieldSemanticsModifierNode$$ExternalSyntheticLambda11
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        if (!TextRange.m9085getCollapsedimpl(this.value.getSelection()) && !this.isPassword) {
    ...
    public static final boolean applySemantics$lambda$4(CoreTextFieldSemanticsModifierNode coreTextFieldSemanticsModifierNode, SemanticsPropertyReceiver semanticsPropertyReceiver, AnnotatedString annotatedString) {
        ...
        if (inputSession != null) {
            ...
            coreTextFieldSemanticsModifierNode.state.getOnValueChange().invoke(new TextFieldValue(StringsKt.replaceRange((CharSequence) coreTextFieldSemanticsModifierNode.value.getText(), TextRange.m9091getStartimpl(coreTextFieldSemanticsModifierNode.value.getSelection()), TextRange.m9086getEndimpl(coreTextFieldSemanticsModifierNode.value.getSelection()), (CharSequence) annotatedString).toString(), TextRangeKt.TextRange(TextRange.m9091getStartimpl(coreTextFieldSemanticsModifierNode.value.getSelection()) + annotatedString.length()), (TextRange) null, 4, (DefaultConstructorMarker) null));
        }
        return true;
    }
    ...
    public static final boolean applySemantics$lambda$5(CoreTextFieldSemanticsModifierNode coreTextFieldSemanticsModifierNode, int i, int i2, boolean z) {
        ...
        if (i == TextRange.m9091getStartimpl(coreTextFieldSemanticsModifierNode.value.getSelection()) && i2 == TextRange.m9086getEndimpl(coreTextFieldSemanticsModifierNode.value.getSelection())) {
            return false;
        }
    ...
    public static final boolean applySemantics$lambda$6(CoreTextFieldSemanticsModifierNode coreTextFieldSemanticsModifierNode) {
        coreTextFieldSemanticsModifierNode.state.getOnImeActionPerformed().invoke(ImeAction.m9260boximpl(coreTextFieldSemanticsModifierNode.imeOptions.getImeAction()));
        return true;
    }
    ...
    public final void updateNodeSemantics(TransformedText transformedText, TextFieldValue value, LegacyTextFieldState state, boolean readOnly, boolean enabled, boolean isPassword, OffsetMapping offsetMapping, TextFieldSelectionManager manager, ImeOptions imeOptions, FocusRequester focusRequester) {
        ...
        this.imeOptions = imeOptions;
        this.focusRequester = focusRequester;
        if (enabled != z || z4 != z2 || !Intrinsics.areEqual(imeOptions, imeOptions2) || isPassword != z3 || !TextRange.m9085getCollapsedimpl(value.getSelection())) {
