...
public final class TextLayoutState {
    ...
    public TextLayoutState() {
        ...
        this.minHeightForSingleLineField = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m9685boximpl(Dp.m9687constructorimpl(0)), null, 2, null);
    ...
    public final float m1965getMinHeightForSingleLineFieldD9Ej5fM() {
    ...
    public final void m1969setMinHeightForSingleLineField0680j_4(float f) {
    ...
    public final TextLayoutResult m1968layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        TextLayoutResult textLayoutResultM1956layoutWithNewMeasureInputshBUhpc = this.layoutCache.m1956layoutWithNewMeasureInputshBUhpc(density, layoutDirection, fontFamilyResolver, constraints);
        ...
        return textLayoutResultM1956layoutWithNewMeasureInputshBUhpc;
    }
    ...
    public static /* synthetic */ int m1963getOffsetForPosition3MmeM6k$default(TextLayoutState textLayoutState, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutState.m1966getOffsetForPosition3MmeM6k(j, z);
    }

    /* JADX INFO: renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1966getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return -1;
        }
        if (coerceInVisibleBounds) {
            position = m1964coercedInVisibleBoundsOfInputTextMKHz9U$foundation(position);
        }
        return layoutResult.m9061getOffsetForPositionk4lQ0M(TextLayoutStateKt.m1971fromDecorationToTextLayoutUv8p0NA(this, position));
    }

    /* JADX INFO: renamed from: isPositionOnText-k-4lQ0M, reason: not valid java name */
    public final boolean m1967isPositionOnTextk4lQ0M(long offset) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return false;
        }
        long jM1971fromDecorationToTextLayoutUv8p0NA = TextLayoutStateKt.m1971fromDecorationToTextLayoutUv8p0NA(this, m1964coercedInVisibleBoundsOfInputTextMKHz9U$foundation(offset));
        int lineForVerticalPosition = layoutResult.getLineForVerticalPosition(Float.intBitsToFloat((int) (4294967295L & jM1971fromDecorationToTextLayoutUv8p0NA)));
        int i = (int) (jM1971fromDecorationToTextLayoutUv8p0NA >> 32);
    ...
    public final long m1964coercedInVisibleBoundsOfInputTextMKHz9U$foundation(long offset) {
        Rect zero;
        ...
        return TextLayoutStateKt.m1970coerceIn3MmeM6k(offset, zero);
    }
}
