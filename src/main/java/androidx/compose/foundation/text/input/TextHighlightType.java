...
public final class TextHighlightType {
    ...
    private static final int HandwritingSelectPreview = m1834constructorimpl(0);
    private static final int HandwritingDeletePreview = m1834constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextHighlightType m1833boximpl(int i) {
        return new TextHighlightType(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m1834constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1835equalsimpl(int i, Object obj) {
        return (obj instanceof TextHighlightType) && i == ((TextHighlightType) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1836equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m1837hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1838toStringimpl(int i) {
        return "TextHighlightType(value=" + i + ')';
    }

    public boolean equals(Object other) {
        return m1835equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m1837hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m1841getHandwritingSelectPreviewsxJuwY() {
        ...
        public final int m1840getHandwritingDeletePreviewsxJuwY() {
