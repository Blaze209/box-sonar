...
public final class LegacyCursorAnchorInfoController {
    ...
    private final void updateCursorAnchorInfo() {
        ...
        this.localToScreen.invoke(Matrix.m7058boximpl(this.matrix));
        ...
        Matrix.m7081translateimpl(fArr, f, -rect2.getTop(), 0.0f);
