...
public final class TextUndoOperation {
    ...
    private static final Saver<TextUndoOperation, Object> Saver = new Saver<TextUndoOperation, Object>() { // from class: androidx.compose.foundation.text.input.internal.undo.TextUndoOperation$Companion$Saver$1
        ...
        public Object save(SaverScope saverScope, TextUndoOperation textUndoOperation) {
            return CollectionsKt.listOf(Integer.valueOf(textUndoOperation.getIndex()), textUndoOperation.getPreText(), textUndoOperation.getPostText(), Integer.valueOf(TextRange.m9091getStartimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m9086getEndimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m9091getStartimpl(textUndoOperation.getPostSelection())), Integer.valueOf(TextRange.m9086getEndimpl(textUndoOperation.getPostSelection())), Long.valueOf(textUndoOperation.getTimeInMillis()));
        }
    ...
    public final TextDeleteType getDeletionType() {
        if (this.textEditType == TextEditType.Delete && TextRange.m9085getCollapsedimpl(this.postSelection)) {
            if (TextRange.m9085getCollapsedimpl(this.preSelection)) {
                if (TextRange.m9091getStartimpl(this.preSelection) > TextRange.m9091getStartimpl(this.postSelection)) {
                    return TextDeleteType.Start;
                }
                return TextDeleteType.End;
            }
            if (TextRange.m9091getStartimpl(this.preSelection) == TextRange.m9091getStartimpl(this.postSelection) && TextRange.m9091getStartimpl(this.preSelection) == this.index) {
