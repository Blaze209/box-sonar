...
public final class TextFieldBuffer implements Appendable {
    ...
    public interface ChangeList {
        ...
        long mo1823getOriginalRangejx7JFs(int changeIndex);

        /* JADX INFO: renamed from: getRange--jx7JFs, reason: not valid java name */
        long mo1824getRangejx7JFs(int changeIndex);
    }
    ...
    public final long m1818getOriginalSelectiond9O1mEE() {
    ...
    public final boolean hasSelection() {
        return !TextRange.m9085getCollapsedimpl(getSelectionInChars());
    }
    ...
    public final void m1821setSelection5zctL8(long j) {
        m1814requireValidRange5zctL8(j);
    ...
    private final void m1815setCompositionOEnZFl4(TextRange textRange) {
        if (textRange == null || TextRange.m9085getCollapsedimpl(textRange.getPackedValue())) {
    ...
    public final void commitComposition$foundation() {
        m1815setCompositionOEnZFl4(null);
    }
    ...
    public final void setComposition$foundation(int start, int end, List<AnnotatedString.Range<AnnotatedString.Annotation>> annotations) {
        ...
        m1815setCompositionOEnZFl4(TextRange.m9079boximpl(TextRangeKt.TextRange(start, end)));
        MutableVector<AnnotatedString.Range<AnnotatedString.Annotation>> mutableVector = this.composingAnnotations;
        if (mutableVector != null) {
            mutableVector.clear();
        }
    ...
    public final void m1820setHighlightK7f2yys$foundation(int type, int start, int end) {
        if (start >= end) {
            throw new IllegalArgumentException("Do not set reversed or empty range: " + start + " > " + end);
        }
        this.highlight = new Pair<>(TextHighlightType.m1833boximpl(type), TextRange.m9079boximpl(TextRangeKt.TextRange(RangesKt.coerceIn(start, 0, getLength()), RangesKt.coerceIn(end, 0, getLength()))));
    }
    ...
    private final void onTextWillChange(int replaceStart, int replaceEnd, int newLength) {
        ...
        this.selectionInChars = TextFieldBufferKt.m1825adjustTextRangevJH6DeI(getSelectionInChars(), replaceStart, replaceEnd, newLength);
    }
    ...
    public final void revertAllChanges() {
        ...
        m1821setSelection5zctL8(this.originalValue.getSelection());
        clearChangeList();
    }
    ...
    public static /* synthetic */ TextFieldCharSequence m1816toTextFieldCharSequencewFTz33Y$foundation$default(TextFieldBuffer textFieldBuffer, long j, TextRange textRange, List list, List list2, int i, Object obj) {
        ...
        return textFieldBuffer.m1822toTextFieldCharSequencewFTz33Y$foundation(j2, textRange2, list, (i & 8) != 0 ? null : list2);
    }

    /* JADX INFO: renamed from: toTextFieldCharSequence-wFTz33Y$foundation, reason: not valid java name */
    public final TextFieldCharSequence m1822toTextFieldCharSequencewFTz33Y$foundation(long selection, TextRange composition, List<AnnotatedString.Range<AnnotatedString.Annotation>> composingAnnotations, List<AnnotatedString.Range<AnnotatedString.Annotation>> outputAnnotations) {
    ...
    private final void m1814requireValidRange5zctL8(long range) {
        long jTextRange = TextRangeKt.TextRange(0, getLength());
        if (TextRange.m9081contains5zctL8(jTextRange, range)) {
            return;
        }
        InlineClassHelperKt.throwIllegalArgumentException("Expected " + ((Object) TextRange.m9094toStringimpl(range)) + " to be in " + ((Object) TextRange.m9094toStringimpl(jTextRange)));
    }
