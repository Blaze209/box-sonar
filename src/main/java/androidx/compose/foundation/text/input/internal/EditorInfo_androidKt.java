...
public final class EditorInfo_androidKt {
    ...
    public static /* synthetic */ void m1877updatepLxbY9I$default(EditorInfo editorInfo, CharSequence charSequence, long j, ImeOptions imeOptions, String[] strArr, int i, Object obj) {
        if ((i & 8) != 0) {
            strArr = null;
        }
        m1876updatepLxbY9I(editorInfo, charSequence, j, imeOptions, strArr);
    }

    /* JADX INFO: renamed from: update-pLxbY9I, reason: not valid java name */
    public static final void m1876updatepLxbY9I(EditorInfo editorInfo, CharSequence charSequence, long j, ImeOptions imeOptions, String[] strArr) {
        ...
        if (KeyboardType.m9316equalsimpl0(keyboardType, KeyboardType.INSTANCE.m9337getTextPjHm6EE())) {
            ...
            if (KeyboardType.m9316equalsimpl0(keyboardType, KeyboardType.INSTANCE.m9339getUriPjHm6EE())) {
                i = 17;
                ...
                if (!KeyboardType.m9316equalsimpl0(keyboardType, KeyboardType.INSTANCE.m9331getDecimalPjHm6EE())) {
        ...
        editorInfo.initialSelStart = TextRange.m9091getStartimpl(j);
        editorInfo.initialSelEnd = TextRange.m9086getEndimpl(j);
        EditorInfoCompat.setInitialSurroundingText(editorInfo, charSequence);
        if (strArr != null) {
            EditorInfoCompat.setContentMimeTypes(editorInfo, strArr);
        }
        editorInfo.imeOptions |= 33554432;
        if (StylusHandwriting_androidKt.isStylusHandwritingSupported() && !KeyboardType.m9316equalsimpl0(imeOptions.getKeyboardType(), KeyboardType.INSTANCE.m9335getPasswordPjHm6EE()) && !KeyboardType.m9316equalsimpl0(imeOptions.getKeyboardType(), KeyboardType.INSTANCE.m9334getNumberPasswordPjHm6EE())) {
