...
public final class TextFieldTextLayoutModifierNode extends DelegatingNode implements LayoutModifierNode, GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        TextLayoutResult textLayoutResultM1968layoutWithNewMeasureInputshBUhpc = this.textLayoutState.m1968layoutWithNewMeasureInputshBUhpc(measureScope, measureScope.getLayoutDirection(), (FontFamily.Resolver) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFontFamilyResolver()), j);
        final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(Constraints.INSTANCE.m9649fitPrioritizingWidthZbe2FdA((int) (textLayoutResultM1968layoutWithNewMeasureInputshBUhpc.getSize() >> 32), (int) (textLayoutResultM1968layoutWithNewMeasureInputshBUhpc.getSize() >> 32), (int) (textLayoutResultM1968layoutWithNewMeasureInputshBUhpc.getSize() & 4294967295L), (int) (textLayoutResultM1968layoutWithNewMeasureInputshBUhpc.getSize() & 4294967295L)));
        TextLayoutState textLayoutState = this.textLayoutState;
        if (this.singleLine) {
            fM9687constructorimpl = measureScope.mo751toDpu2uoSUM(TextDelegateKt.ceilToIntPx(textLayoutResultM1968layoutWithNewMeasureInputshBUhpc.getLineBottom(0)));
        } else {
            fM9687constructorimpl = Dp.m9687constructorimpl(0);
        }
        textLayoutState.m1969setMinHeightForSingleLineField0680j_4(fM9687constructorimpl);
        LinkedHashMap linkedHashMap = this.baselineCache;
        if (linkedHashMap == null) {
            linkedHashMap = new LinkedHashMap(2);
        }
        linkedHashMap.put(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(Math.round(textLayoutResultM1968layoutWithNewMeasureInputshBUhpc.getFirstBaseline())));
        linkedHashMap.put(AlignmentLineKt.getLastBaseline(), Integer.valueOf(Math.round(textLayoutResultM1968layoutWithNewMeasureInputshBUhpc.getLastBaseline())));
        this.baselineCache = linkedHashMap;
        int size = (int) (textLayoutResultM1968layoutWithNewMeasureInputshBUhpc.getSize() >> 32);
        int size2 = (int) (textLayoutResultM1968layoutWithNewMeasureInputshBUhpc.getSize() & 4294967295L);
        ...
        return measureScope.layout(size, size2, map, new Function1() { // from class: androidx.compose.foundation.text.input.internal.TextFieldTextLayoutModifierNode$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return TextFieldTextLayoutModifierNode.measure_3p2s80s$lambda$0(placeableMo8265measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        });
    }
