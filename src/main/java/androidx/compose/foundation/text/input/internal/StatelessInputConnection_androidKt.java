...
public final class StatelessInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldCharSequence textFieldCharSequence) {
        ...
        extractedText.selectionStart = TextRange.m9089getMinimpl(textFieldCharSequence.getSelection());
        extractedText.selectionEnd = TextRange.m9088getMaximpl(textFieldCharSequence.getSelection());
    ...
    public static final TransferableContent toTransferableContent(InputContentInfoCompat inputContentInfoCompat, Bundle bundle) {
        ...
        int iM709getKeyboardkB6V9T0 = TransferableContent.Source.INSTANCE.m709getKeyboardkB6V9T0();
        ...
        return new TransferableContent(clipEntry, clipMetadata, iM709getKeyboardkB6V9T0, new PlatformTransferableContent(linkUri, bundle), null);
    }
