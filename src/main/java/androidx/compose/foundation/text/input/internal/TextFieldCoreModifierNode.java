...
public final class TextFieldCoreModifierNode extends DelegatingNode implements LayoutModifierNode, DrawModifierNode, CompositionLocalConsumerModifierNode, GlobalPositionAwareModifierNode, SemanticsModifierNode {
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        if (this.orientation == Orientation.Vertical) {
            return m1932measureVerticalScroll3p2s80s(measureScope, measurable, j);
        }
        return m1931measureHorizontalScroll3p2s80s(measureScope, measurable, j);
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (TextRange.m9085getCollapsedimpl(visualText.getSelection())) {
            ...
            if (visualText.shouldShowSelection()) {
                m1930drawSelectionSbBc2M(contentDrawScope, visualText.getSelection(), layoutResult);
            }
    ...
    private final MeasureResult m1932measureVerticalScroll3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(Constraints.m9630copyZbe2FdA$default(j, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int iMin = Math.min(placeableMo8265measureBRTryo0.getHeight(), Constraints.m9639getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo0.getWidth(), iMin, null, new Function1() { // from class: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return TextFieldCoreModifierNode.measureVerticalScroll_3p2s80s$lambda$0(this.f$0, iMin, placeableMo8265measureBRTryo0, measureScope, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit measureVerticalScroll_3p2s80s$lambda$0(TextFieldCoreModifierNode textFieldCoreModifierNode, int i, Placeable placeable, MeasureScope measureScope, Placeable.PlacementScope placementScope) {
        textFieldCoreModifierNode.m1933updateScrollStatetIlFzwE(placementScope, i, placeable.getHeight(), textFieldCoreModifierNode.textFieldState.getVisualText().getSelection(), measureScope.getLayoutDirection());
    ...
    private final MeasureResult m1931measureHorizontalScroll3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final int iMin = Math.min(placeableMo8265measureBRTryo0.getWidth(), Constraints.m9640getMaxWidthimpl(j));
        return MeasureScope.layout$default(measureScope, iMin, placeableMo8265measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return TextFieldCoreModifierNode.measureHorizontalScroll_3p2s80s$lambda$0(this.f$0, iMin, placeableMo8265measureBRTryo0, measureScope, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit measureHorizontalScroll_3p2s80s$lambda$0(TextFieldCoreModifierNode textFieldCoreModifierNode, int i, Placeable placeable, MeasureScope measureScope, Placeable.PlacementScope placementScope) {
        textFieldCoreModifierNode.m1933updateScrollStatetIlFzwE(placementScope, i, placeable.getWidth(), textFieldCoreModifierNode.textFieldState.getVisualText().getSelection(), measureScope.getLayoutDirection());
    ...
    private final int m1929calculateOffsetToFollow8ffj60Q(long currSelection, int currContainerSize, int currTextLayoutSize) {
        TextRange textRange = this.previousSelection;
        if (textRange == null || TextRange.m9086getEndimpl(currSelection) != TextRange.m9086getEndimpl(textRange.getPackedValue())) {
            return TextRange.m9086getEndimpl(currSelection);
        }
        TextRange textRange2 = this.previousSelection;
        if (textRange2 == null || TextRange.m9091getStartimpl(currSelection) != TextRange.m9091getStartimpl(textRange2.getPackedValue())) {
            return TextRange.m9091getStartimpl(currSelection);
        }
    ...
    private final void m1933updateScrollStatetIlFzwE(Density density, int i, int i2, long j, LayoutDirection layoutDirection) {
        TextLayoutResult layoutResult;
        float f;
        this.scrollState.setViewportSize$foundation(i);
        this.scrollState.setMaxValue$foundation(i2 - i);
        int iM1929calculateOffsetToFollow8ffj60Q = m1929calculateOffsetToFollow8ffj60Q(j, i, i2);
        if (iM1929calculateOffsetToFollow8ffj60Q < 0 || !getShowCursor() || (layoutResult = this.textLayoutState.getLayoutResult()) == null) {
            return;
        }
        Rect cursorRect = layoutResult.getCursorRect(RangesKt.coerceIn(iM1929calculateOffsetToFollow8ffj60Q, (ClosedRange<Integer>) new IntRange(0, layoutResult.getLayoutInput().getText().length())));
        ...
        if (z || i != this.previousContainerSize) {
            ...
            this.previousSelection = TextRange.m9079boximpl(j);
    ...
    private final void m1930drawSelectionSbBc2M(DrawScope drawScope, long j, TextLayoutResult textLayoutResult) {
        int iM9089getMinimpl = TextRange.m9089getMinimpl(j);
        int iM9088getMaximpl = TextRange.m9088getMaximpl(j);
        if (iM9089getMinimpl != iM9088getMaximpl) {
            DrawScope.m7385drawPathLG529CI$default(drawScope, textLayoutResult.getPathForRange(iM9089getMinimpl, iM9088getMaximpl), ((TextSelectionColors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, TextSelectionColorsKt.getLocalTextSelectionColors())).getBackgroundColor(), 0.0f, null, null, 0, 60, null);
        }
    }
    ...
    private final void drawHighlight(DrawScope drawScope, Pair<TextHighlightType, TextRange> pair, TextLayoutResult textLayoutResult) {
        ...
        if (TextRange.m9085getCollapsedimpl(packedValue)) {
            return;
        }
        Path pathForRange = textLayoutResult.getPathForRange(TextRange.m9089getMinimpl(packedValue), TextRange.m9088getMaximpl(packedValue));
        if (TextHighlightType.m1836equalsimpl0(value, TextHighlightType.INSTANCE.m1840getHandwritingDeletePreviewsxJuwY())) {
            Brush brush = textLayoutResult.getLayoutInput().getStyle().getBrush();
            if (brush != null) {
                DrawScope.m7384drawPathGBMwjPU$default(drawScope, pathForRange, brush, 0.2f, null, null, 0, 56, null);
                return;
            }
            long jM9121getColor0d7_KjU = textLayoutResult.getLayoutInput().getStyle().m9121getColor0d7_KjU();
            if (jM9121getColor0d7_KjU == 16) {
                jM9121getColor0d7_KjU = Color.INSTANCE.m6840getBlack0d7_KjU();
            }
            long j = jM9121getColor0d7_KjU;
            DrawScope.m7385drawPathLG529CI$default(drawScope, pathForRange, Color.m6813copywmQWz5c$default(j, Color.m6816getAlphaimpl(j) * 0.2f, 0.0f, 0.0f, 0.0f, 14, null), 0.0f, null, null, 0, 60, null);
            return;
        }
        DrawScope.m7385drawPathLG529CI$default(drawScope, pathForRange, ((TextSelectionColors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, TextSelectionColorsKt.getLocalTextSelectionColors())).getBackgroundColor(), 0.0f, null, null, 0, 60, null);
    }
    ...
    private final void drawCursor(DrawScope drawScope) {
        ...
        if (cursorAlpha != 0.0f && getShowCursor()) {
            ...
            DrawScope.m7380drawLine1RTmtNc$default(drawScope, this.cursorBrush, cursorRect.m6603getTopCenterF1C5BW0(), cursorRect.m6596getBottomCenterF1C5BW0(), cursorRect.getRight() - cursorRect.getLeft(), 0, null, cursorAlpha, null, 0, 432, null);
        }
    }
