...
public final class TextUndoManagerKt {
    ...
    public static final void recordChanges(TextUndoManager textUndoManager, TextFieldCharSequence textFieldCharSequence, TextFieldCharSequence textFieldCharSequence2, TextFieldBuffer.ChangeList changeList, boolean z) {
        ...
        if (changeList.getChangeCount() == 1) {
            long jMo1823getOriginalRangejx7JFs = changeList.mo1823getOriginalRangejx7JFs(0);
            long jMo1824getRangejx7JFs = changeList.mo1824getRangejx7JFs(0);
            if (TextRange.m9085getCollapsedimpl(jMo1823getOriginalRangejx7JFs) && TextRange.m9085getCollapsedimpl(jMo1824getRangejx7JFs)) {
                return;
            }
            textUndoManager.record(new TextUndoOperation(TextRange.m9089getMinimpl(jMo1823getOriginalRangejx7JFs), TextRangeKt.m9098substringFDrldGo(textFieldCharSequence, jMo1823getOriginalRangejx7JFs), TextRangeKt.m9098substringFDrldGo(textFieldCharSequence2, jMo1824getRangejx7JFs), textFieldCharSequence.getSelection(), textFieldCharSequence2.getSelection(), 0L, z, 32, null));
        }
    }
