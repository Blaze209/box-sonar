...
public final class TextFieldSelectionStateKt {
    ...
    public static final Object defaultDetectTextFieldTapGestures(final TextFieldSelectionState textFieldSelectionState, PointerInputScope pointerInputScope, MutableInteractionSource mutableInteractionSource, final Function0<Unit> function0, final Function0<Unit> function1, Continuation<? super Unit> continuation) {
        Object objDetectTapAndPress = TapGestureDetectorKt.detectTapAndPress(pointerInputScope, new AnonymousClass2(mutableInteractionSource, textFieldSelectionState, null), new Function1() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionStateKt$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return TextFieldSelectionStateKt.defaultDetectTextFieldTapGestures$lambda$0(function0, textFieldSelectionState, function1, (Offset) obj);
            }
        }, continuation);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit defaultDetectTextFieldTapGestures$lambda$0(Function0 function0, TextFieldSelectionState textFieldSelectionState, Function0 function1, Offset offset) {
        ...
        if (textFieldSelectionState.getEnabled() && textFieldSelectionState.getIsFocused()) {
            ...
            textFieldSelectionState.m2032placeCursorAtNearestOffsetk4lQ0M(TextLayoutStateKt.m1971fromDecorationToTextLayoutUv8p0NA(textFieldSelectionState.getTextLayoutState(), textFieldSelectionState.getTextLayoutState().m1964coercedInVisibleBoundsOfInputTextMKHz9U$foundation(offset.m6579unboximpl())));
        }
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m2047invoked4ec7I(pressGestureScope, offset.m6579unboximpl(), continuation);
        }

        /* JADX INFO: renamed from: invoke-d-4ec7I, reason: not valid java name */
        public final Object m2047invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
    ...
    public static final long m2046reverse5zctL8(long j) {
        return TextRangeKt.TextRange(TextRange.m9086getEndimpl(j), TextRange.m9091getStartimpl(j));
    }
    ...
    public static final Unit contextMenuBuilder$lambda$0(State state, ContextMenuState contextMenuState, Function2 function2, TextFieldSelectionState textFieldSelectionState, ContextMenuScope contextMenuScope) {
        ...
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.Cut, MenuItemsAvailability.m1698getCanCutimpl(iM1703unboximpl));
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.Copy, MenuItemsAvailability.m1697getCanCopyimpl(iM1703unboximpl));
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.Paste, MenuItemsAvailability.m1699getCanPasteimpl(iM1703unboximpl));
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.SelectAll, MenuItemsAvailability.m1700getCanSelectAllimpl(iM1703unboximpl));
        if (PlatformUtils_androidKt.isAutofillAvailable()) {
            contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.Autofill, MenuItemsAvailability.m1696getCanAutofillimpl(iM1703unboximpl));
        }
        return Unit.INSTANCE;
    }
