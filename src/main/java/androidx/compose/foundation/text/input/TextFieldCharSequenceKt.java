...
public final class TextFieldCharSequenceKt {
    public static final CharSequence getTextBeforeSelection(TextFieldCharSequence textFieldCharSequence, int i) {
        int iM9089getMinimpl = TextRange.m9089getMinimpl(textFieldCharSequence.getSelection());
        int i2 = iM9089getMinimpl - i;
        if (((i ^ iM9089getMinimpl) & (iM9089getMinimpl ^ i2)) < 0) {
            i2 = 0;
        }
        return textFieldCharSequence.subSequence(Math.max(0, i2), TextRange.m9089getMinimpl(textFieldCharSequence.getSelection()));
    }

    public static final CharSequence getTextAfterSelection(TextFieldCharSequence textFieldCharSequence, int i) {
        int iM9088getMaximpl = TextRange.m9088getMaximpl(textFieldCharSequence.getSelection());
        int iM9088getMaximpl2 = TextRange.m9088getMaximpl(textFieldCharSequence.getSelection());
        int length = iM9088getMaximpl2 + i;
        if (((i ^ length) & (iM9088getMaximpl2 ^ length)) < 0) {
            length = textFieldCharSequence.length();
        }
        return textFieldCharSequence.subSequence(iM9088getMaximpl, Math.min(length, textFieldCharSequence.length()));
    }

    public static final CharSequence getSelectedText(TextFieldCharSequence textFieldCharSequence) {
        return textFieldCharSequence.subSequence(TextRange.m9089getMinimpl(textFieldCharSequence.getSelection()), TextRange.m9088getMaximpl(textFieldCharSequence.getSelection()));
    }
}
