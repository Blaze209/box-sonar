...
public final class TextFieldMagnifierNodeImpl28 extends TextFieldMagnifierNode implements CompositionLocalConsumerModifierNode {
    ...
    private final MutableState magnifierSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m9850boximpl(IntSize.INSTANCE.m9863getZeroYbymL2g()), null, 2, null);
    ...
    public TextFieldMagnifierNodeImpl28(TransformedTextFieldState transformedTextFieldState, TextFieldSelectionState textFieldSelectionState, TextLayoutState textLayoutState, boolean z) {
        ...
        this.visible = z;
        this.animatable = new Animatable<>(Offset.m6558boximpl(TextFieldMagnifierKt.m2011calculateSelectionMagnifierCenterAndroidhUlJWOE(this.textFieldState, this.textFieldSelectionState, this.textLayoutState, m2013getMagnifierSizeYbymL2g())), SelectionMagnifierKt.getUnspecifiedSafeOffsetVectorConverter(), Offset.m6558boximpl(SelectionMagnifierKt.getOffsetDisplacementThreshold()), null, 8, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getMagnifierSize-YbymL2g, reason: not valid java name */
    public final long m2013getMagnifierSizeYbymL2g() {
        return ((IntSize) this.magnifierSize.getValue()).m9862unboximpl();
    }

    /* JADX INFO: renamed from: setMagnifierSize-ozmzZPI, reason: not valid java name */
    private final void m2014setMagnifierSizeozmzZPI(long j) {
        this.magnifierSize.setValue(IntSize.m9850boximpl(j));
    }
    ...
    public static final Unit magnifierNode$lambda$1(TextFieldMagnifierNodeImpl28 textFieldMagnifierNodeImpl28, DpSize dpSize) {
        ...
        textFieldMagnifierNodeImpl28.m2014setMagnifierSizeozmzZPI(IntSize.m9853constructorimpl((((long) density.mo748roundToPx0680j_4(DpSize.m9785getWidthD9Ej5fM(dpSize.getPackedValue()))) << 32) | (((long) density.mo748roundToPx0680j_4(DpSize.m9783getHeightD9Ej5fM(dpSize.getPackedValue()))) & 4294967295L)));
    ...
    @DebugMetadata(c = "androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28$restartAnimationJob$1", f = "AndroidTextFieldMagnifier.android.kt", i = {}, l = {Token.DOTDOT}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            if (i == 0) {
                ...
                if (flowSnapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28.restartAnimationJob.1.2
                    ...
                    public /* bridge */ /* synthetic */ Object emit(Object obj2, Continuation continuation) {
                        return m2015emit3MmeM6k(((Offset) obj2).m6579unboximpl(), continuation);
                    }

                    /* JADX INFO: renamed from: emit-3MmeM6k, reason: not valid java name */
                    public final Object m2015emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                        if ((((Offset) textFieldMagnifierNodeImpl29.animatable.getValue()).m6579unboximpl() & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats && (j & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats && Float.intBitsToFloat((int) (((Offset) textFieldMagnifierNodeImpl29.animatable.getValue()).m6579unboximpl() & 4294967295L)) != Float.intBitsToFloat((int) (j & 4294967295L))) {
                            BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C00391(textFieldMagnifierNodeImpl29, j, null), 3, null);
                            return Unit.INSTANCE;
                        }
                        Object objSnapTo = textFieldMagnifierNodeImpl29.animatable.snapTo(Offset.m6558boximpl(j), continuation);
                    ...
                    static final class C00391 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        C00391(TextFieldMagnifierNodeImpl28 textFieldMagnifierNodeImpl28, long j, Continuation<? super C00391> continuation) {
                            super(2, continuation);
                        ...
                        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                            return new C00391(this.this$0, this.f57$$v$c$androidxcomposeuigeometryOffset$targetValue$0, continuation);
                        }
                        ...
                        public final Object invokeSuspend(Object obj) {
                            ...
                            if (i == 0) {
                                ResultKt.throwOnFailure(obj);
                                this.label = 1;
                                if (Animatable.animateTo$default(this.this$0.animatable, Offset.m6558boximpl(this.f57$$v$c$androidxcomposeuigeometryOffset$targetValue$0), SelectionMagnifierKt.getMagnifierSpringSpec(), null, null, this, 12, null) == coroutine_suspended) {
        ...
        public static final Offset invokeSuspend$lambda$0(TextFieldMagnifierNodeImpl28 textFieldMagnifierNodeImpl28) {
            ...
            return Offset.m6558boximpl(TextFieldMagnifierKt.m2011calculateSelectionMagnifierCenterAndroidhUlJWOE(textFieldMagnifierNodeImpl28.textFieldState, textFieldMagnifierNodeImpl28.textFieldSelectionState, textFieldMagnifierNodeImpl28.textLayoutState, textFieldMagnifierNodeImpl28.m2013getMagnifierSizeYbymL2g()));
        }
    }
