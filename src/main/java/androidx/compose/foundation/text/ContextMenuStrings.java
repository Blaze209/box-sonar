...
public final class ContextMenuStrings {
    ...
    public static final /* synthetic */ ContextMenuStrings m1636boximpl(int i) {
    ...
    public static boolean m1638equalsimpl(int i, Object obj) {
        return (obj instanceof ContextMenuStrings) && i == ((ContextMenuStrings) obj).m1642unboximpl();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1639equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m1640hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1641toStringimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m1645getCut9Hzcbyc() {
            return ContextMenuStrings.m1637constructorimpl(R.string.cut);
        }

        /* JADX INFO: renamed from: getCopy-9Hzcbyc, reason: not valid java name */
        public final int m1644getCopy9Hzcbyc() {
            return ContextMenuStrings.m1637constructorimpl(R.string.copy);
        }

        /* JADX INFO: renamed from: getPaste-9Hzcbyc, reason: not valid java name */
        public final int m1646getPaste9Hzcbyc() {
            return ContextMenuStrings.m1637constructorimpl(R.string.paste);
        }

        /* JADX INFO: renamed from: getSelectAll-9Hzcbyc, reason: not valid java name */
        public final int m1647getSelectAll9Hzcbyc() {
            return ContextMenuStrings.m1637constructorimpl(R.string.selectAll);
        }

        /* JADX INFO: renamed from: getAutofill-9Hzcbyc, reason: not valid java name */
        public final int m1643getAutofill9Hzcbyc() {
            return ContextMenuStrings.m1637constructorimpl(R.string.autofill);
        }
    }
