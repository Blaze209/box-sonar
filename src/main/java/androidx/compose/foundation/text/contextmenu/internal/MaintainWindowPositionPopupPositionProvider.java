...
final class MaintainWindowPositionPopupPositionProvider implements PopupPositionProvider {
    ...
    public final void m1792setPreviousWindowSizefhxjrPA(IntSize intSize) {
    ...
    public final void m1790setPreviousPopupContentSizefhxjrPA(IntSize intSize) {
    ...
    public final void m1791setPreviousPositionfg0MpWk(IntOffset intOffset) {
    ...
    public long mo718calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (intOffset != null) {
            ...
            if ((intSize == null ? false : IntSize.m9856equalsimpl0(intSize.m9862unboximpl(), windowSize)) && this.previousLayoutDirection == layoutDirection) {
                IntSize intSize2 = this.previousPopupContentSize;
                if (intSize2 != null ? IntSize.m9856equalsimpl0(intSize2.m9862unboximpl(), popupContentSize) : false) {
                    return intOffset.m9824unboximpl();
                }
            }
        }
        long jMo718calculatePositionllwVHH4 = this.popupPositionProvider.mo718calculatePositionllwVHH4(anchorBounds, windowSize, layoutDirection, popupContentSize);
        this.previousWindowSize = IntSize.m9850boximpl(windowSize);
        this.previousLayoutDirection = layoutDirection;
        this.previousPopupContentSize = IntSize.m9850boximpl(popupContentSize);
        this.previousPosition = IntOffset.m9806boximpl(jMo718calculatePositionllwVHH4);
        return jMo718calculatePositionllwVHH4;
    }
}
