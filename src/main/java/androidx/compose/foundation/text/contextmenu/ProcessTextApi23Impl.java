...
public final class ProcessTextApi23Impl {
    ...
    public static final List processTextActivitiesQuery$lambda$0(Context context) {
        List<ResolveInfo> listQueryIntentActivities = MAMPackageManagement.queryIntentActivities(context.getPackageManager(), INSTANCE.createProcessTextIntent(), 0);
    ...
    public static final Unit onClickProcessTextItem$lambda$0(Context context, ResolveInfo resolveInfo, boolean z, CharSequence charSequence, TextRange textRange) {
        String string = charSequence.subSequence(TextRange.m9089getMinimpl(textRange.getPackedValue()), TextRange.m9088getMaximpl(textRange.getPackedValue())).toString();
