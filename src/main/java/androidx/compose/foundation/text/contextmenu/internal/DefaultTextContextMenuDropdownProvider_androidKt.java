...
public final class DefaultTextContextMenuDropdownProvider_androidKt {
    ...
    public static final Unit IconBox_RPmYEkk$lambda$1(int i, long j, int i2, Composer composer, int i3) {
        m1784IconBoxRPmYEkk(i, j, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
        return Unit.INSTANCE;
    }
    ...
    public static final void ProvideDefaultTextContextMenuDropdown(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.text.contextmenu.internal.DefaultTextContextMenuDropdownProvider_androidKt$$ExternalSyntheticLambda5
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return DefaultTextContextMenuDropdownProvider_androidKt.ProvideDefaultTextContextMenuDropdown$lambda$1(modifier2, function3, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final BasicTextContextMenuProvider defaultTextContextMenuDropdown(Composer composer, int i) {
        ...
        BasicTextContextMenuProvider basicTextContextMenuProvider = BasicTextContextMenuProviderKt.basicTextContextMenuProvider(ComposableSingletons$DefaultTextContextMenuDropdownProvider_androidKt.INSTANCE.m1778getLambda$1357803046$foundation(), composer, 6);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    public static final IntOffset OpenContextMenu$lambda$0$0(TextContextMenuDataProvider textContextMenuDataProvider, Function0 function0) {
        return IntOffset.m9806boximpl(IntOffsetKt.m9832roundk4lQ0M(textContextMenuDataProvider.mo1804positiontuRUvjQ((LayoutCoordinates) function0.invoke())));
    }
            ...
            if (textContextMenuComponent instanceof TextContextMenuItem) {
                ...
                ContextMenuScope.item$default(contextMenuScope2, new Function2() { // from class: androidx.compose.foundation.text.contextmenu.internal.DefaultTextContextMenuDropdownProvider_androidKt$$ExternalSyntheticLambda6
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Color color, Composer composer, Integer num) {
                        m1786invokeek8zF_U(color.m6824unboximpl(), composer, num.intValue());
                        return Unit.INSTANCE;
                    }

                    /* JADX INFO: renamed from: invoke-ek8zF_U, reason: not valid java name */
                    public final void m1786invokeek8zF_U(long j, Composer composer, int i2) {
                        ...
                        DefaultTextContextMenuDropdownProvider_androidKt.m1784IconBoxRPmYEkk(((TextContextMenuItem) textContextMenuComponent).getLeadingIcon(), j, composer, (i2 << 3) & 112);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                    }
    ...
    public static final void m1784IconBoxRPmYEkk(final int i, final long j, Composer composer, final int i2) {
        int i3;
        ...
        if (!composerStartRestartGroup.shouldExecute((i3 & 19) != 18, i3 & 1)) {
            ...
            if (iIntValue == -1) {
                ...
                Object objRememberedValue2 = composerStartRestartGroup.rememberedValue();
                if (z || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue2 = j == 16 ? null : ColorFilter.Companion.m6855tintxETnrds$default(ColorFilter.INSTANCE, j, 0, 2, null);
                    composerStartRestartGroup.updateRememberedValue(objRememberedValue2);
                }
                ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
                BoxKt.Box(PainterModifierKt.paint$default(SizeKt.m1266size3ABfNKs(Modifier.INSTANCE, ContextMenuSpec.INSTANCE.m726getIconSizeD9Ej5fM()), painterPainterResource, false, null, ContentScale.INSTANCE.getFit(), 0.0f, (ColorFilter) objRememberedValue2, 22, null), composerStartRestartGroup, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
