...
public final class ContextMenuIcons {
    ...
    public static final /* synthetic */ ContextMenuIcons m1624boximpl(int i) {
    ...
    public static boolean m1626equalsimpl(int i, Object obj) {
        return (obj instanceof ContextMenuIcons) && i == ((ContextMenuIcons) obj).m1630unboximpl();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1627equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m1628hashCodeimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m1632getActionModeCutDrawable3I4p1mQ() {
            return ContextMenuIcons.m1625constructorimpl(R.attr.actionModeCutDrawable);
        }

        /* JADX INFO: renamed from: getActionModeCopyDrawable-3I4p1mQ, reason: not valid java name */
        public final int m1631getActionModeCopyDrawable3I4p1mQ() {
            return ContextMenuIcons.m1625constructorimpl(R.attr.actionModeCopyDrawable);
        }

        /* JADX INFO: renamed from: getActionModePasteDrawable-3I4p1mQ, reason: not valid java name */
        public final int m1633getActionModePasteDrawable3I4p1mQ() {
            return ContextMenuIcons.m1625constructorimpl(R.attr.actionModePasteDrawable);
        }

        /* JADX INFO: renamed from: getActionModeSelectAllDrawable-3I4p1mQ, reason: not valid java name */
        public final int m1634getActionModeSelectAllDrawable3I4p1mQ() {
            return ContextMenuIcons.m1625constructorimpl(R.attr.actionModeSelectAllDrawable);
        }

        /* JADX INFO: renamed from: getID_NULL-3I4p1mQ, reason: not valid java name */
        public final int m1635getID_NULL3I4p1mQ() {
            return ContextMenuIcons.m1625constructorimpl(0);
        }
    }
