...
public final class TextFieldDelegate {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ Triple m1724layout_EkL_Y$foundation$default(Companion companion, TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
            if ((i & 8) != 0) {
                textLayoutResult = null;
            }
            return companion.m1727layout_EkL_Y$foundation(textDelegate, j, layoutDirection, textLayoutResult);
        }

        @JvmStatic
        /* JADX INFO: renamed from: layout-_EkL_-Y$foundation, reason: not valid java name */
        public final Triple<Integer, Integer, TextLayoutResult> m1727layout_EkL_Y$foundation(TextDelegate textDelegate, long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResultText) {
            TextLayoutResult textLayoutResultM1714layoutNN6EwU = textDelegate.m1714layoutNN6EwU(constraints, layoutDirection, prevResultText);
            return new Triple<>(Integer.valueOf((int) (textLayoutResultM1714layoutNN6EwU.getSize() >> 32)), Integer.valueOf((int) (textLayoutResultM1714layoutNN6EwU.getSize() & 4294967295L)), textLayoutResultM1714layoutNN6EwU);
        }

        @JvmStatic
        /* JADX INFO: renamed from: draw-Q1vqE60$foundation, reason: not valid java name */
        public final void m1726drawQ1vqE60$foundation(Canvas canvas, TextFieldValue value, long selectionPreviewHighlightRange, long deletionPreviewHighlightRange, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Paint highlightPaint, long selectionBackgroundColor) {
            if (!TextRange.m9085getCollapsedimpl(selectionPreviewHighlightRange)) {
                highlightPaint.mo6690setColor8_81llA(selectionBackgroundColor);
                m1723drawHighlightLepunE(canvas, selectionPreviewHighlightRange, offsetMapping, textLayoutResult, highlightPaint);
            } else if (!TextRange.m9085getCollapsedimpl(deletionPreviewHighlightRange)) {
                Color colorM6804boximpl = Color.m6804boximpl(textLayoutResult.getLayoutInput().getStyle().m9121getColor0d7_KjU());
                if (colorM6804boximpl.m6824unboximpl() == 16) {
                    colorM6804boximpl = null;
                }
                long jM6824unboximpl = colorM6804boximpl != null ? colorM6804boximpl.m6824unboximpl() : Color.INSTANCE.m6840getBlack0d7_KjU();
                highlightPaint.mo6690setColor8_81llA(Color.m6813copywmQWz5c$default(jM6824unboximpl, Color.m6816getAlphaimpl(jM6824unboximpl) * 0.2f, 0.0f, 0.0f, 0.0f, 14, null));
                m1723drawHighlightLepunE(canvas, deletionPreviewHighlightRange, offsetMapping, textLayoutResult, highlightPaint);
            } else if (!TextRange.m9085getCollapsedimpl(value.getSelection())) {
                highlightPaint.mo6690setColor8_81llA(selectionBackgroundColor);
                m1723drawHighlightLepunE(canvas, value.getSelection(), offsetMapping, textLayoutResult, highlightPaint);
            }
            TextPainter.INSTANCE.paint(canvas, textLayoutResult);
        }

        /* JADX INFO: renamed from: drawHighlight-Le-punE, reason: not valid java name */
        private final void m1723drawHighlightLepunE(Canvas canvas, long range, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Paint paint) {
            int iOriginalToTransformed = offsetMapping.originalToTransformed(TextRange.m9089getMinimpl(range));
            int iOriginalToTransformed2 = offsetMapping.originalToTransformed(TextRange.m9088getMaximpl(range));
        ...
        public final void notifyFocusedRect$foundation(TextFieldValue value, final TextDelegate textDelegate, TextLayoutResult textLayoutResult, LayoutCoordinates layoutCoordinates, TextInputSession textInputSession, boolean hasFocus, OffsetMapping offsetMapping) {
            if (hasFocus) {
                textInputSession.notifyFocusedRect(TextFieldDelegateKt.focusedRectInRoot(textLayoutResult, layoutCoordinates, offsetMapping.originalToTransformed(TextRange.m9088getMaximpl(value.getSelection())), new Function0() { // from class: androidx.compose.foundation.text.TextFieldDelegate$Companion$$ExternalSyntheticLambda0
        ...
        public static final IntSize notifyFocusedRect$lambda$0(TextDelegate textDelegate) {
            return IntSize.m9850boximpl(TextFieldDelegateKt.computeSizeForDefaultText$default(textDelegate.getStyle(), textDelegate.getDensity(), textDelegate.getFontFamilyResolver(), null, 0, 24, null));
        }
        ...
        public final void updateTextLayoutResult$foundation(TextInputSession textInputSession, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResultProxy textLayoutResult) {
            ...
            textInputSession.updateTextLayoutResult(textFieldValue, offsetMapping, textLayoutResult.getValue(), new Function1<Matrix, Unit>() { // from class: androidx.compose.foundation.text.TextFieldDelegate$Companion$updateTextLayoutResult$1$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Matrix matrix) {
                    m1729invoke58bKbWc(matrix.m7083unboximpl());
                    return Unit.INSTANCE;
                }

                /* JADX INFO: renamed from: invoke-58bKbWc, reason: not valid java name */
                public final void m1729invoke58bKbWc(float[] fArr) {
                    if (innerTextFieldCoordinates.isAttached()) {
                        LayoutCoordinatesKt.findRootCoordinates(innerTextFieldCoordinates).mo8280transformFromEL8BTi8(innerTextFieldCoordinates, fArr);
                    }
                }
        ...
        public final void m1728setCursorOffsetULxng0E$foundation(long position, TextLayoutResultProxy textLayoutResult, EditProcessor editProcessor, OffsetMapping offsetMapping, Function1<? super TextFieldValue, Unit> onValueChange) {
            onValueChange.invoke(TextFieldValue.m9340copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, TextRangeKt.TextRange(offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1759getOffsetForPosition3MmeM6k$default(textLayoutResult, position, false, 2, null))), (TextRange) null, 5, (Object) null));
        }
        ...
        public final void onBlur$foundation(TextInputSession textInputSession, EditProcessor editProcessor, Function1<? super TextFieldValue, Unit> onValueChange) {
            onValueChange.invoke(TextFieldValue.m9340copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null));
            textInputSession.dispose();
        }

        /* JADX INFO: renamed from: applyCompositionDecoration-72CqOWE, reason: not valid java name */
        public final TransformedText m1725applyCompositionDecoration72CqOWE(long compositionRange, TransformedText transformed) {
            int iOriginalToTransformed = transformed.getOffsetMapping().originalToTransformed(TextRange.m9091getStartimpl(compositionRange));
            int iOriginalToTransformed2 = transformed.getOffsetMapping().originalToTransformed(TextRange.m9086getEndimpl(compositionRange));
