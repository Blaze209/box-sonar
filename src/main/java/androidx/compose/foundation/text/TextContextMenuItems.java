...
public enum TextContextMenuItems {
    Cut(TextContextMenuKeys.INSTANCE.getCutKey(), ContextMenuStrings.INSTANCE.m1645getCut9Hzcbyc(), ContextMenuIcons.INSTANCE.m1632getActionModeCutDrawable3I4p1mQ()),
    Copy(TextContextMenuKeys.INSTANCE.getCopyKey(), ContextMenuStrings.INSTANCE.m1644getCopy9Hzcbyc(), ContextMenuIcons.INSTANCE.m1631getActionModeCopyDrawable3I4p1mQ()),
    Paste(TextContextMenuKeys.INSTANCE.getPasteKey(), ContextMenuStrings.INSTANCE.m1646getPaste9Hzcbyc(), ContextMenuIcons.INSTANCE.m1633getActionModePasteDrawable3I4p1mQ()),
    SelectAll(TextContextMenuKeys.INSTANCE.getSelectAllKey(), ContextMenuStrings.INSTANCE.m1647getSelectAll9Hzcbyc(), ContextMenuIcons.INSTANCE.m1634getActionModeSelectAllDrawable3I4p1mQ()),
    Autofill(TextContextMenuKeys.INSTANCE.getAutofillKey(), ContextMenuStrings.INSTANCE.m1643getAutofill9Hzcbyc(), ContextMenuIcons.INSTANCE.m1635getID_NULL3I4p1mQ());
    ...
    public final String resolvedString(Composer composer, int i) {
        ...
        String strM1648getStringtk4Tqcs = ContextMenuStrings_androidKt.m1648getStringtk4Tqcs(this.stringId, composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return strM1648getStringtk4Tqcs;
    }
}
