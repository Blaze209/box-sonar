...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m9096getZerod9O1mEE();
    ...
    public final void m1751setPreviousSelection5zctL8(long j) {
    ...
    public final int m1749getOffsetToFollow5zctL8(long selection) {
        if (TextRange.m9091getStartimpl(selection) != TextRange.m9091getStartimpl(this.previousSelection)) {
            return TextRange.m9091getStartimpl(selection);
        }
        return TextRange.m9086getEndimpl(selection) != TextRange.m9086getEndimpl(this.previousSelection) ? TextRange.m9086getEndimpl(selection) : TextRange.m9089getMinimpl(selection);
    }
