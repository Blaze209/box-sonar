...
public final class TextFieldDelegateKt {
    ...
    public static final long computeSizeForDefaultText(TextStyle textStyle, Density density, FontFamily.Resolver resolver, String str, int i) {
        Paragraph paragraphM8944ParagraphUl8oQg4 = ParagraphKt.m8944ParagraphUl8oQg4(str, textStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), density, resolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : CollectionsKt.emptyList(), (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : i, (64 & 256) != 0 ? TextOverflow.INSTANCE.m9583getClipgIe3tQ8() : TextOverflow.INSTANCE.m9583getClipgIe3tQ8());
        return IntSize.m9853constructorimpl((((long) TextDelegateKt.ceilToIntPx(paragraphM8944ParagraphUl8oQg4.getMinIntrinsicWidth())) << 32) | (((long) TextDelegateKt.ceilToIntPx(paragraphM8944ParagraphUl8oQg4.getHeight())) & 4294967295L));
    }
    ...
    public static final Rect focusedRectInRoot(TextLayoutResult textLayoutResult, LayoutCoordinates layoutCoordinates, int i, Function0<IntSize> function0) {
        ...
        if (i < textLayoutResult.getLayoutInput().getText().length()) {
            ...
            rect = new Rect(0.0f, 0.0f, 1.0f, (int) (function0.invoke().m9862unboximpl() & 4294967295L));
        }
        float left = rect.getLeft();
        long jMo8276localToRootMKHz9U = layoutCoordinates.mo8276localToRootMKHz9U(Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(rect.getTop())) & 4294967295L) | (Float.floatToRawIntBits(left) << 32)));
        long jM6561constructorimpl = Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (jMo8276localToRootMKHz9U >> 32)))) << 32) | (((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (jMo8276localToRootMKHz9U & 4294967295L)))) & 4294967295L));
        float right = rect.getRight() - rect.getLeft();
        return RectKt.m6609Recttz77jQw(jM6561constructorimpl, Size.m6629constructorimpl((((long) Float.floatToRawIntBits(rect.getBottom() - rect.getTop())) & 4294967295L) | (Float.floatToRawIntBits(right) << 32)));
    }
}
