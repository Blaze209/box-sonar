...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo1661measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        long j2;
        if (measurable.maxIntrinsicWidth(Constraints.m9639getMaxHeightimpl(j)) < Constraints.m9640getMaxWidthimpl(j)) {
            j2 = j;
        } else {
            j2 = j;
            j = Constraints.m9630copyZbe2FdA$default(j2, 0, Integer.MAX_VALUE, 0, 0, 13, null);
        }
        final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(j);
        final int iMin = Math.min(placeableMo8265measureBRTryo0.getWidth(), Constraints.m9640getMaxWidthimpl(j2));
        return MeasureScope.layout$default(measureScope, iMin, placeableMo8265measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return HorizontalScrollLayoutModifier.measure_3p2s80s$lambda$0(this.f$0, measureScope, placeableMo8265measureBRTryo0, iMin, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
