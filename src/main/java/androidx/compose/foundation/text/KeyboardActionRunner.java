...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final boolean m1666runActionKlQnJC8(int imeAction) {
        ...
        if (ImeAction.m9263equalsimpl0(imeAction, ImeAction.INSTANCE.m9277getDoneeUduSuo())) {
            ...
            if (!ImeAction.m9263equalsimpl0(imeAction, ImeAction.INSTANCE.m9276getDefaulteUduSuo()) && !ImeAction.m9263equalsimpl0(imeAction, ImeAction.INSTANCE.m9280getNoneeUduSuo())) {
        ...
        return m1664defaultKeyboardActionWithResultKlQnJC8(imeAction);
    }

    /* JADX INFO: renamed from: defaultKeyboardActionWithResult-KlQnJC8, reason: not valid java name */
    private final boolean m1664defaultKeyboardActionWithResultKlQnJC8(int imeAction) {
        SoftwareKeyboardController softwareKeyboardController;
        if (ImeAction.m9263equalsimpl0(imeAction, ImeAction.INSTANCE.m9279getNexteUduSuo())) {
            getFocusManager().mo6458moveFocus3ESFkO8(FocusDirection.INSTANCE.m6452getNextdhqQ8s());
            return true;
        }
        if (ImeAction.m9263equalsimpl0(imeAction, ImeAction.INSTANCE.m9281getPreviouseUduSuo())) {
            getFocusManager().mo6458moveFocus3ESFkO8(FocusDirection.INSTANCE.m6453getPreviousdhqQ8s());
            return true;
        }
        if (!ImeAction.m9263equalsimpl0(imeAction, ImeAction.INSTANCE.m9277getDoneeUduSuo()) || (softwareKeyboardController = this.keyboardController) == null) {
            return false;
        }
    ...
    public void mo1665defaultKeyboardActionKlQnJC8(int imeAction) {
        m1664defaultKeyboardActionWithResultKlQnJC8(imeAction);
    }
}
