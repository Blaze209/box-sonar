...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m9583getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m2111updateLayoutRelatedArgsHuAbxIM(TextStyle style, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged) {
        if (textChanged || layoutChanged) {
            getLayoutCache().m2101updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
        }
        if (getIsAttached()) {
    ...
    private final boolean setSubstitution(String updatedText) {
        ...
        if (textSubstitutionValue != null) {
            ...
            layoutCache.m2101updateL6sJoHM(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
            return true;
        }
    ...
    public static final boolean applySemantics$lambda$0(TextStringSimpleNode textStringSimpleNode, List list) {
        ...
        TextLayoutResult textLayoutResultSlowCreateTextLayoutResultOrNull = layoutCache.slowCreateTextLayoutResultOrNull(TextStyle.m9111mergedA7vx0o$default(textStyle, colorProducer != null ? colorProducer.mo2379invoke0d7_KjU() : Color.INSTANCE.m6850getUnspecified0d7_KjU(), 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, 0, 0, null, null, 16777214, null));
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        try {
            ...
            boolean zM2099layoutWithConstraintsK40F9xA = layoutCacheForMeasure.m2099layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
            ...
            if (zM2099layoutWithConstraintsK40F9xA) {
            ...
            final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(Constraints.INSTANCE.m9649fitPrioritizingWidthZbe2FdA(i, i, i2, i2));
            ...
            return measureScope.layout(i, i2, map2, new Function1() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$$ExternalSyntheticLambda4
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return TextStringSimpleNode.measure_3p2s80s$lambda$0$0(placeableMo8265measureBRTryo0, (Placeable.PlacementScope) obj);
                }
            });
        } finally {
            Trace.endSection();
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        if (getIsAttached()) {
            ...
            if (didOverflow) {
                ...
                canvas.save();
                Canvas.m6786clipRectN_I0leg$default(canvas, 0.0f, 0.0f, layoutSize, layoutSize2, 0, 16, null);
            }
            try {
                ...
                if (brush != null) {
                    Paragraph.m8935painthn5TExg$default(paragraph, canvas, brush, this.style.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
                } else {
                    ...
                    Paragraph.m8933paintLG529CI$default(paragraph, canvas, jMo2379invoke0d7_KjU, shadow2, textDecoration2, drawStyle2, 0, 32, null);
                }
            } finally {
                if (didOverflow) {
                    canvas.restore();
