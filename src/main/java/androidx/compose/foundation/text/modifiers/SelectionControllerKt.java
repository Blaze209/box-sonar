...
public final class SelectionControllerKt {
    ...
    public static final Modifier makeDefaultSelectionModifier(final SelectionRegistrar selectionRegistrar, final long j, final Function0<? extends LayoutCoordinates> function0) {
        final ?? r0 = new TextDragObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeDefaultSelectionModifier$longPressDragObserver$1
            private long lastPosition = Offset.INSTANCE.m6585getZeroF1C5BW0();
            ...
            public void mo1719onStart3MmeM6k(long startPoint, SelectionAdjustment selectionAdjustment) {
                ...
                if (layoutCoordinatesInvoke != null) {
                    ...
                    selectionRegistrar2.mo2192notifySelectionUpdateStartubNVwUQ(layoutCoordinatesInvoke, startPoint, this.selectionAdjustmentMode, true);
            ...
            public void mo1718onDragk4lQ0M(long delta) {
                ...
                if (layoutCoordinatesInvoke != null) {
                    ...
                    if (layoutCoordinatesInvoke.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2)) {
                        ...
                        long jM6574plusMKHz9U2 = Offset.m6574plusMKHz9U(this.lastPosition, jM6574plusMKHz9U);
                        if (selectionRegistrar2.mo2191notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, jM6574plusMKHz9U2, this.lastPosition, false, this.selectionAdjustmentMode, true)) {
                            this.lastPosition = jM6574plusMKHz9U2;
                            this.dragTotalDistance = Offset.INSTANCE.m6585getZeroF1C5BW0();
                        }
                    }
                }
        ...
        final ?? r1 = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeDefaultSelectionModifier$mouseSelectionObserver$1
            ...
            public boolean mo2040onExtendk4lQ0M(long downPosition) {
                ...
                if (selectionRegistrar2.mo2191notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, downPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false)) {
            ...
            public boolean mo2041onExtendDragk4lQ0M(long dragPosition) {
                ...
                if (!selectionRegistrar2.mo2191notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, dragPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false)) {
                    return true;
                }
            ...
            public boolean mo2042onStart9KIMszo(long downPosition, SelectionAdjustment adjustment, int clickCount) {
                ...
                selectionRegistrar2.mo2192notifySelectionUpdateStartubNVwUQ(layoutCoordinatesInvoke, downPosition, adjustment, false);
                this.lastPosition = downPosition;
                return SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2);
            }
            ...
            public boolean mo2039onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                ...
                if (!selectionRegistrar2.mo2191notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, dragPosition, this.lastPosition, false, adjustment, false)) {
                    return true;
                }
                this.lastPosition = dragPosition;
                return true;
