...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final boolean m2109updateLayoutRelatedArgsy0kMQk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow, TextAutoSize autoSize) {
        ...
        if (!TextOverflow.m9574equalsimpl0(this.overflow, overflow)) {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        if (textChanged || layoutChanged || callbacksChanged) {
            getLayoutCache().m2089updateJ2qo7bo(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders, this.autoSize);
        }
        if (getIsAttached()) {
    ...
    private final boolean setSubstitution(AnnotatedString updatedText) {
        ...
        if (textSubstitutionValue != null) {
            ...
            layoutCache.m2089updateJ2qo7bo(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, CollectionsKt.emptyList(), this.autoSize);
            return true;
        }
    ...
    public static final boolean applySemantics$lambda$0(TextAnnotatedStringNode textAnnotatedStringNode, List list) {
        ...
        if (layoutOrNull != null) {
            ...
            textLayoutResultM9059copyO0kMr_c$default = TextLayoutResult.m9059copyO0kMr_c$default(layoutOrNull, new TextLayoutInput(text, TextStyle.m9111mergedA7vx0o$default(textStyle, colorProducer != null ? colorProducer.mo2379invoke0d7_KjU() : Color.INSTANCE.m6850getUnspecified0d7_KjU(), 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, 0, 0, null, null, 16777214, null), layoutOrNull.getLayoutInput().getPlaceholders(), layoutOrNull.getLayoutInput().getMaxLines(), layoutOrNull.getLayoutInput().getSoftWrap(), layoutOrNull.getLayoutInput().getOverflow(), layoutOrNull.getLayoutInput().getDensity(), layoutOrNull.getLayoutInput().getLayoutDirection(), layoutOrNull.getLayoutInput().getFontFamilyResolver(), layoutOrNull.getLayoutInput().getConstraints(), (DefaultConstructorMarker) null), 0L, 2, null);
            if (textLayoutResultM9059copyO0kMr_c$default != null) {
                list.add(textLayoutResultM9059copyO0kMr_c$default);
            } else {
                textLayoutResultM9059copyO0kMr_c$default = null;
            }
        } else {
            textLayoutResultM9059copyO0kMr_c$default = null;
        }
        return textLayoutResultM9059copyO0kMr_c$default != null;
    }
    ...
    public final MeasureResult m2108measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
        return mo372measure3p2s80s(measureScope, measurable, constraints);
    }
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        try {
            ...
            boolean zM2088layoutWithConstraintsK40F9xA = layoutCache.m2088layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
            ...
            if (zM2088layoutWithConstraintsK40F9xA) {
            ...
            final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(Constraints.INSTANCE.m9649fitPrioritizingWidthZbe2FdA((int) (textLayoutResult.getSize() >> 32), (int) (textLayoutResult.getSize() >> 32), (int) (textLayoutResult.getSize() & 4294967295L), (int) (textLayoutResult.getSize() & 4294967295L)));
            ...
            return measureScope.layout(size, size2, map, new Function1() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return TextAnnotatedStringNode.measure_3p2s80s$lambda$0$0(placeableMo8265measureBRTryo0, (Placeable.PlacementScope) obj);
                }
            });
        } finally {
            Trace.endSection();
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        if (getIsAttached()) {
            ...
            boolean z = true;
            boolean z2 = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m9574equalsimpl0(this.overflow, TextOverflow.INSTANCE.m9587getVisiblegIe3tQ8());
            if (z2) {
                Rect rectM6609Recttz77jQw = RectKt.m6609Recttz77jQw(Offset.INSTANCE.m6585getZeroF1C5BW0(), Size.m6629constructorimpl((((long) Float.floatToRawIntBits((int) (textLayoutResult.getSize() >> 32))) << 32) | (((long) Float.floatToRawIntBits((int) (textLayoutResult.getSize() & 4294967295L))) & 4294967295L)));
                canvas.save();
            ...
            try {
                ...
                if (brush != null) {
                    MultiParagraph.m8923painthn5TExg$default(multiParagraph, canvas, brush, this.style.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
                } else {
                    ColorProducer colorProducer = this.overrideColor;
                    long jMo2379invoke0d7_KjU = colorProducer != null ? colorProducer.mo2379invoke0d7_KjU() : Color.INSTANCE.m6850getUnspecified0d7_KjU();
                    if (jMo2379invoke0d7_KjU == 16) {
                        if (this.style.m9121getColor0d7_KjU() != 16) {
                            jMo2379invoke0d7_KjU = this.style.m9121getColor0d7_KjU();
                        } else {
                            jMo2379invoke0d7_KjU = Color.INSTANCE.m6840getBlack0d7_KjU();
                        }
                    }
                    multiParagraph.m8928paintLG529CI(canvas, (32 & 2) != 0 ? Color.INSTANCE.m6850getUnspecified0d7_KjU() : jMo2379invoke0d7_KjU, (32 & 4) != 0 ? null : shadow2, (32 & 8) != 0 ? null : textDecoration2, (32 & 16) == 0 ? drawStyle2 : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m7397getDefaultBlendMode0nO6VwU() : 0);
                }
                if (z2) {
                    canvas.restore();
                }
