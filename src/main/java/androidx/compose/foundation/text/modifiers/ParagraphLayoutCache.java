...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3) {
        ...
        long j = 0;
        this.layoutSize = IntSize.m9853constructorimpl((j & 4294967295L) | (j << 32));
        this.prevConstraints = Constraints.INSTANCE.m9650fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m9583getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final void setDensity$foundation(Density density) {
        ...
        if (density2 == null) {
            ...
            this.density = density;
            this.lastDensity = jM2054constructorimpl;
            m2094recordHistory4ETZmGE(LayoutCacheOperation.INSTANCE.m2071getMarkDirtyDensityDEKiAbY());
            markDirty();
        }
    }
    ...
    public final void m2100setLayoutSizeozmzZPI$foundation(long j) {
        this.layoutSize = j;
    }
    ...
    private final void m2094recordHistory4ETZmGE(long op) {
        this.historyFlag = op | (this.historyFlag << 2);
    }

    /* JADX INFO: renamed from: layoutWithConstraints-K40F9xA, reason: not valid java name */
    public final boolean m2099layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ParagraphLayoutCache paragraphLayoutCache;
        LayoutDirection layoutDirection2;
        m2094recordHistory4ETZmGE(LayoutCacheOperation.INSTANCE.m2070getLayoutWithConstraintsDEKiAbY());
        boolean z = true;
        if (this.minLines > 1) {
            paragraphLayoutCache = this;
            layoutDirection2 = layoutDirection;
            constraints = m2096useMinLinesConstrainereuUD3Qg$default(paragraphLayoutCache, constraints, layoutDirection2, null, 4, null);
        } else {
            paragraphLayoutCache = this;
            layoutDirection2 = layoutDirection;
        }
        boolean z2 = false;
        if (!paragraphLayoutCache.m2093newLayoutWillBeDifferentK40F9xA(constraints, layoutDirection2)) {
            if (!Constraints.m9633equalsimpl0(constraints, paragraphLayoutCache.prevConstraints)) {
                Paragraph paragraph = paragraphLayoutCache.paragraph;
                Intrinsics.checkNotNull(paragraph);
                long jM9654constrain4WqzIAM = ConstraintsKt.m9654constrain4WqzIAM(constraints, IntSize.m9853constructorimpl((((long) TextDelegateKt.ceilToIntPx(paragraph.getHeight())) & 4294967295L) | (((long) TextDelegateKt.ceilToIntPx(Math.min(paragraph.getMaxIntrinsicWidth(), paragraph.getWidth()))) << 32)));
                paragraphLayoutCache.layoutSize = jM9654constrain4WqzIAM;
                if (TextOverflow.m9574equalsimpl0(paragraphLayoutCache.overflow, TextOverflow.INSTANCE.m9587getVisiblegIe3tQ8()) || (((int) (jM9654constrain4WqzIAM >> 32)) >= paragraph.getWidth() && ((int) (4294967295L & jM9654constrain4WqzIAM)) >= paragraph.getHeight())) {
                    z = false;
                }
        ...
        Paragraph paragraphM2098layoutTextK40F9xA$foundation = paragraphLayoutCache.m2098layoutTextK40F9xA$foundation(constraints, layoutDirection2);
        paragraphLayoutCache.prevConstraints = constraints;
        long jM9654constrain4WqzIAM2 = ConstraintsKt.m9654constrain4WqzIAM(constraints, IntSize.m9853constructorimpl((((long) TextDelegateKt.ceilToIntPx(paragraphM2098layoutTextK40F9xA$foundation.getHeight())) & 4294967295L) | (((long) TextDelegateKt.ceilToIntPx(paragraphM2098layoutTextK40F9xA$foundation.getWidth())) << 32)));
        paragraphLayoutCache.layoutSize = jM9654constrain4WqzIAM2;
        if (!TextOverflow.m9574equalsimpl0(paragraphLayoutCache.overflow, TextOverflow.INSTANCE.m9587getVisiblegIe3tQ8()) && (((int) (jM9654constrain4WqzIAM2 >> 32)) < paragraphM2098layoutTextK40F9xA$foundation.getWidth() || ((int) (jM9654constrain4WqzIAM2 & 4294967295L)) < paragraphM2098layoutTextK40F9xA$foundation.getHeight())) {
            z2 = true;
        }
        paragraphLayoutCache.didOverflow = z2;
        paragraphLayoutCache.paragraph = paragraphM2098layoutTextK40F9xA$foundation;
        return true;
    }

    /* JADX INFO: renamed from: useMinLinesConstrainer-euUD3Qg$default, reason: not valid java name */
    static /* synthetic */ long m2096useMinLinesConstrainereuUD3Qg$default(ParagraphLayoutCache paragraphLayoutCache, long j, LayoutDirection layoutDirection, TextStyle textStyle, int i, Object obj) {
        if ((i & 4) != 0) {
            textStyle = paragraphLayoutCache.style;
        }
        return paragraphLayoutCache.m2095useMinLinesConstrainereuUD3Qg(j, layoutDirection, textStyle);
    }

    /* JADX INFO: renamed from: useMinLinesConstrainer-euUD3Qg, reason: not valid java name */
    private final long m2095useMinLinesConstrainereuUD3Qg(long constraints, LayoutDirection layoutDirection, TextStyle style) {
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        if (this.minLines > 1) {
            paragraphLayoutCache = this;
            layoutDirection2 = layoutDirection;
            jConstraints = m2096useMinLinesConstrainereuUD3Qg$default(paragraphLayoutCache, jConstraints, layoutDirection2, null, 4, null);
        } else {
            paragraphLayoutCache = this;
            layoutDirection2 = layoutDirection;
        }
        int iCoerceAtLeast = RangesKt.coerceAtLeast(TextDelegateKt.ceilToIntPx(paragraphLayoutCache.m2098layoutTextK40F9xA$foundation(jConstraints, layoutDirection2).getHeight()), Constraints.m9641getMinHeightimpl(jConstraints));
    ...
    public final void m2101updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        this.text = text;
        this.style = style;
        ...
        m2094recordHistory4ETZmGE(LayoutCacheOperation.INSTANCE.m2072getMarkDirtyNodeDEKiAbY());
        markDirty();
    }
    ...
    public final Paragraph m2098layoutTextK40F9xA$foundation(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics layoutDirection2 = setLayoutDirection(layoutDirection);
        return ParagraphKt.m8948ParagraphczeNHc(layoutDirection2, LayoutUtilsKt.m2074finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m2075finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), this.overflow);
    }

    /* JADX INFO: renamed from: newLayoutWillBeDifferent-K40F9xA, reason: not valid java name */
    private final boolean m2093newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m9633equalsimpl0(constraints, this.prevConstraints)) {
            return false;
        }
        return Constraints.m9640getMaxWidthimpl(constraints) != Constraints.m9640getMaxWidthimpl(this.prevConstraints) || Constraints.m9642getMinWidthimpl(constraints) != Constraints.m9642getMinWidthimpl(this.prevConstraints) || ((float) Constraints.m9639getMaxHeightimpl(constraints)) < paragraph.getHeight() || paragraph.getDidExceedMaxLines();
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull(TextStyle style) {
        ...
        long jM9628constructorimpl = Constraints.m9628constructorimpl(this.prevConstraints & ConstraintsKt.MaxDimensionsAndFocusMask);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, jM9628constructorimpl, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), density, this.fontFamilyResolver), jM9628constructorimpl, this.maxLines, this.overflow, (DefaultConstructorMarker) null), this.layoutSize, null);
    }
    ...
    public String toString() {
        return "ParagraphLayoutCache(paragraph=" + (this.paragraph != null ? "<paragraph>" : AbstractJsonLexerKt.NULL) + ", lastDensity=" + ((Object) InlineDensity.m2060toStringimpl(this.lastDensity)) + ", history=" + this.historyFlag + ", constraints=$)";
    }
}
