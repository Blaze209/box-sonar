    ...
    public MeasureResult mo344measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        if (listInvoke != null) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                Pair pair = rect != null ? new Pair(((Measurable) arrayList3.get(i2)).mo8265measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) Math.floor(rect.getRight() - rect.getLeft()), 0, (int) Math.floor(rect.getBottom() - rect.getTop()), 5, null)), IntOffset.m9806boximpl(IntOffset.m9809constructorimpl((((long) Math.round(rect.getTop())) & 4294967295L) | (((long) Math.round(rect.getLeft())) << 32)))) : null;
                if (pair != null) {
                    arrayList4.add(pair);
                }
            }
        ...
        return MeasureScope.layout$default(measureScope, Constraints.m9640getMaxWidthimpl(j), Constraints.m9639getMaxHeightimpl(j), null, new Function1() { // from class: androidx.compose.foundation.text.TextMeasurePolicy$$ExternalSyntheticLambda0
    ...
    public static final Unit measure_3p2s80s$lambda$3(List list, List list2, Placeable.PlacementScope placementScope) {
        if (list != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Placeable.PlacementScope.m8331place70tqf50$default(placementScope, (Placeable) pair.component1(), ((IntOffset) pair.component2()).m9824unboximpl(), 0.0f, 2, null);
            }
        }
        if (list2 != null) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                Placeable.PlacementScope.m8331place70tqf50$default(placementScope, placeable, function0 != null ? ((IntOffset) function0.invoke()).m9824unboximpl() : IntOffset.INSTANCE.m9826getZeronOccac(), 0.0f, 2, null);
            }
        }
