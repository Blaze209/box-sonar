...
public final class CoreTextFieldKt$CoreTextField$8$1$1$2 implements MeasurePolicy {
    ...
    public MeasureResult mo344measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        try {
            ...
            Triple<Integer, Integer, TextLayoutResult> tripleM1727layout_EkL_Y$foundation = TextFieldDelegate.INSTANCE.m1727layout_EkL_Y$foundation(this.$state.getTextDelegate(), j, measureScope.getLayoutDirection(), value);
            int iIntValue = tripleM1727layout_EkL_Y$foundation.component1().intValue();
            int iIntValue2 = tripleM1727layout_EkL_Y$foundation.component2().intValue();
            TextLayoutResult textLayoutResultComponent3 = tripleM1727layout_EkL_Y$foundation.component3();
            ...
            this.$state.m1686setMinHeightForSingleLineField0680j_4(this.$density.mo751toDpu2uoSUM(this.$maxLines == 1 ? TextDelegateKt.ceilToIntPx(textLayoutResultComponent3.getLineBottom(0)) : 0));
