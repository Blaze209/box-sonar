...
public final class KeyboardOptions {
    ...
    private static final KeyboardOptions SecureTextField = new KeyboardOptions(0, (Boolean) false, KeyboardType.INSTANCE.m9335getPasswordPjHm6EE(), 0, (PlatformImeOptions) (null == true ? 1 : 0), (Boolean) (null == true ? 1 : 0), (LocaleList) null, 121, (DefaultConstructorMarker) null);
    ...
    public /* synthetic */ KeyboardOptions(int i, Boolean bool, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool2, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        int iM9311getUnspecifiedIUNYP9k = (i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m9311getUnspecifiedIUNYP9k() : i;
        Boolean bool3 = (i4 & 2) != 0 ? null : bool;
        int iM9338getUnspecifiedPjHm6EE = (i4 & 4) != 0 ? KeyboardType.INSTANCE.m9338getUnspecifiedPjHm6EE() : i2;
        int iM9284getUnspecifiedeUduSuo = (i4 & 8) != 0 ? ImeAction.INSTANCE.m9284getUnspecifiedeUduSuo() : i3;
        PlatformImeOptions platformImeOptions2 = (i4 & 16) != 0 ? null : platformImeOptions;
        Boolean bool4 = (i4 & 32) != 0 ? null : bool2;
        this(iM9311getUnspecifiedIUNYP9k, bool3, iM9338getUnspecifiedPjHm6EE, iM9284getUnspecifiedeUduSuo, platformImeOptions2, bool4, (i4 & 64) == 0 ? localeList : null, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m9311getUnspecifiedIUNYP9k() : i, z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m9338getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m9284getUnspecifiedeUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (i4 & 32) != 0 ? null : bool, (i4 & 64) != 0 ? null : localeList, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m9311getUnspecifiedIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m9338getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m9276getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m9309getNoneIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m9337getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m9276getDefaulteUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (DefaultConstructorMarker) null);
    }
    ...
    private final int m1671getCapitalizationOrDefaultIUNYP9k() {
        KeyboardCapitalization keyboardCapitalizationM9296boximpl = KeyboardCapitalization.m9296boximpl(this.capitalization);
        if (KeyboardCapitalization.m9299equalsimpl0(keyboardCapitalizationM9296boximpl.getValue(), KeyboardCapitalization.INSTANCE.m9311getUnspecifiedIUNYP9k())) {
            keyboardCapitalizationM9296boximpl = null;
        }
        return keyboardCapitalizationM9296boximpl != null ? keyboardCapitalizationM9296boximpl.getValue() : KeyboardCapitalization.INSTANCE.m9309getNoneIUNYP9k();
    }

    /* JADX INFO: renamed from: getKeyboardTypeOrDefault-PjHm6EE, reason: not valid java name */
    private final int m1672getKeyboardTypeOrDefaultPjHm6EE() {
        KeyboardType keyboardTypeM9313boximpl = KeyboardType.m9313boximpl(this.keyboardType);
        if (KeyboardType.m9316equalsimpl0(keyboardTypeM9313boximpl.getValue(), KeyboardType.INSTANCE.m9338getUnspecifiedPjHm6EE())) {
            keyboardTypeM9313boximpl = null;
        }
        return keyboardTypeM9313boximpl != null ? keyboardTypeM9313boximpl.getValue() : KeyboardType.INSTANCE.m9337getTextPjHm6EE();
    }

    /* JADX INFO: renamed from: getImeActionOrDefault-eUduSuo$foundation, reason: not valid java name */
    public final int m1679getImeActionOrDefaulteUduSuo$foundation() {
        ImeAction imeActionM9260boximpl = ImeAction.m9260boximpl(this.imeAction);
        if (ImeAction.m9263equalsimpl0(imeActionM9260boximpl.getValue(), ImeAction.INSTANCE.m9284getUnspecifiedeUduSuo())) {
            imeActionM9260boximpl = null;
        }
        return imeActionM9260boximpl != null ? imeActionM9260boximpl.getValue() : ImeAction.INSTANCE.m9276getDefaulteUduSuo();
    }
    ...
    private final boolean isCompletelyUnspecified() {
        return KeyboardCapitalization.m9299equalsimpl0(this.capitalization, KeyboardCapitalization.INSTANCE.m9311getUnspecifiedIUNYP9k()) && this.autoCorrectEnabled == null && KeyboardType.m9316equalsimpl0(this.keyboardType, KeyboardType.INSTANCE.m9338getUnspecifiedPjHm6EE()) && ImeAction.m9263equalsimpl0(this.imeAction, ImeAction.INSTANCE.m9284getUnspecifiedeUduSuo()) && this.platformImeOptions == null && this.showKeyboardOnFocus == null && this.hintLocales == null;
    }
    ...
    public final ImeOptions toImeOptions$foundation(boolean singleLine) {
        return new ImeOptions(singleLine, m1671getCapitalizationOrDefaultIUNYP9k(), getAutoCorrectOrDefault(), m1672getKeyboardTypeOrDefaultPjHm6EE(), m1679getImeActionOrDefaulteUduSuo$foundation(), this.platformImeOptions, getHintLocalesOrDefault(), (DefaultConstructorMarker) null);
    }

    /* JADX INFO: renamed from: copy-INvB4aQ$default, reason: not valid java name */
    public static /* synthetic */ KeyboardOptions m1668copyINvB4aQ$default(KeyboardOptions keyboardOptions, int i, Boolean bool, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool2, LocaleList localeList, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m1674copyINvB4aQ(i, bool, i2, i3, platformImeOptions, bool2, (i4 & 64) != 0 ? null : localeList);
    }

    /* JADX INFO: renamed from: copy-INvB4aQ, reason: not valid java name */
    public final KeyboardOptions m1674copyINvB4aQ(int capitalization, Boolean autoCorrectEnabled, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, Boolean showKeyboardOnFocus, LocaleList hintLocales) {
    ...
    /* JADX INFO: renamed from: copy-INvB4aQ$default, reason: not valid java name */
    public static /* synthetic */ KeyboardOptions m1669copyINvB4aQ$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool, LocaleList localeList, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        int i5 = i2;
        return keyboardOptions.m1675copyINvB4aQ(i, z, i5, i3, platformImeOptions2, bool2, localeList2);
    }
    ...
    /* JADX INFO: renamed from: copy-INvB4aQ, reason: not valid java name */
    public final /* synthetic */ KeyboardOptions m1675copyINvB4aQ(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, Boolean showKeyboardOnFocus, LocaleList hintLocales) {
    ...
    public static /* synthetic */ KeyboardOptions m1670copyij11fho$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        PlatformImeOptions platformImeOptions2 = platformImeOptions;
        int i5 = i2;
        return keyboardOptions.m1676copyij11fho(i, z, i5, i3, platformImeOptions2);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Maintained for binary compatibility")
    /* JADX INFO: renamed from: copy-ij11fho, reason: not valid java name */
    public final /* synthetic */ KeyboardOptions m1676copyij11fho(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions) {
    ...
    public static /* synthetic */ KeyboardOptions m1667copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        return keyboardOptions.m1673copy3m2b7yw(i, z, i2, i3);
    }
    ...
    public final /* synthetic */ KeyboardOptions m1673copy3m2b7yw(int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return KeyboardCapitalization.m9299equalsimpl0(this.capitalization, keyboardOptions.capitalization) && Intrinsics.areEqual(this.autoCorrectEnabled, keyboardOptions.autoCorrectEnabled) && KeyboardType.m9316equalsimpl0(this.keyboardType, keyboardOptions.keyboardType) && ImeAction.m9263equalsimpl0(this.imeAction, keyboardOptions.imeAction) && Intrinsics.areEqual(this.platformImeOptions, keyboardOptions.platformImeOptions) && Intrinsics.areEqual(this.showKeyboardOnFocus, keyboardOptions.showKeyboardOnFocus) && Intrinsics.areEqual(this.hintLocales, keyboardOptions.hintLocales);
    }

    public int hashCode() {
        int iM9300hashCodeimpl = KeyboardCapitalization.m9300hashCodeimpl(this.capitalization) * 31;
        Boolean bool = this.autoCorrectEnabled;
        int iHashCode = (((((iM9300hashCodeimpl + (bool != null ? bool.hashCode() : 0)) * 31) + KeyboardType.m9317hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m9264hashCodeimpl(this.imeAction)) * 31;
    ...
    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m9301toStringimpl(this.capitalization)) + ", autoCorrectEnabled=" + this.autoCorrectEnabled + ", keyboardType=" + ((Object) KeyboardType.m9318toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m9265toStringimpl(this.imeAction)) + ", platformImeOptions=" + this.platformImeOptions + "showKeyboardOnFocus=" + this.showKeyboardOnFocus + ", hintLocales=" + this.hintLocales + ')';
    }
    ...
    public final KeyboardOptions fillUnspecifiedValuesWith$foundation(KeyboardOptions other) {
        ...
        int value = keyboardCapitalizationM9296boximpl != null ? keyboardCapitalizationM9296boximpl.getValue() : other.capitalization;
        Boolean bool = this.autoCorrectEnabled;
        if (bool == null) {
        ...
        int value2 = keyboardTypeM9313boximpl != null ? keyboardTypeM9313boximpl.getValue() : other.keyboardType;
        ImeAction imeActionM9260boximpl = ImeAction.m9260boximpl(this.imeAction);
        ImeAction imeAction = ImeAction.m9263equalsimpl0(imeActionM9260boximpl.getValue(), ImeAction.INSTANCE.m9284getUnspecifiedeUduSuo()) ? null : imeActionM9260boximpl;
