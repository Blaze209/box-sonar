...
final class WrappedOverscrollEffect implements OverscrollEffect {
    ...
    public long mo565applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
        if (this.eventHandlingEnabled) {
            return this.innerOverscrollEffect.mo565applyToScrollRhakbz0(delta, source, performScroll);
        }
    ...
    public Object mo564applyToFlingBMRW4eQ(long j, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        if (this.eventHandlingEnabled) {
            Object objMo564applyToFlingBMRW4eQ = this.innerOverscrollEffect.mo564applyToFlingBMRW4eQ(j, function2, continuation);
            return objMo564applyToFlingBMRW4eQ == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMo564applyToFlingBMRW4eQ : Unit.INSTANCE;
        }
        Object objInvoke = function2.invoke(Velocity.m9916boximpl(j), continuation);
