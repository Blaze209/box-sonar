...
final class DefaultPagerNestedScrollConnection implements NestedScrollConnection {
    ...
    public final long m1501consumeOnOrientationQWom1Mo(long j, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            return Velocity.m9921copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null);
        }
        return Velocity.m9921copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPreScroll-OzD1aCk */
    public long mo1299onPreScrollOzD1aCk(long available, int source) {
        if (NestedScrollSource.m8002equalsimpl0(source, NestedScrollSource.INSTANCE.m8014getUserInputWNlRxjI()) && Math.abs(this.state.getCurrentPageOffsetFraction()) > 1.0E-6d && Math.abs(m1500toFloatk4lQ0M(available)) > 0.0f) {
            ...
            float fIntBitsToFloat = -this.state.dispatchRawDelta(-RangesKt.coerceIn(m1500toFloatk4lQ0M(available), currentPageOffsetFraction, pageSize));
            ...
            return Offset.m6562copydBAh8RU(available, fIntBitsToFloat2, fIntBitsToFloat);
        }
        return Offset.INSTANCE.m6585getZeroF1C5BW0();
    }

    /* JADX INFO: renamed from: toFloat-k-4lQ0M, reason: not valid java name */
    private final float m1500toFloatk4lQ0M(long j) {
    ...
    public long mo946onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (NestedScrollSource.m8002equalsimpl0(source, NestedScrollSource.INSTANCE.m8013getSideEffectWNlRxjI()) && m1499mainAxisk4lQ0M(available) != 0.0f) {
    ...
    public Object mo945onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return Velocity.m9916boximpl(m1501consumeOnOrientationQWom1Mo(j2, this.orientation));
    }

    /* JADX INFO: renamed from: mainAxis-k-4lQ0M, reason: not valid java name */
    private final float m1499mainAxisk4lQ0M(long j) {
        return Float.intBitsToFloat((int) (this.orientation == Orientation.Horizontal ? j >> 32 : j & 4294967295L));
    }
}
