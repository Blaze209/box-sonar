...
public final class PagerMeasureKt {
    ...
    public static final PagerMeasureResult m1519measurePager7L1iB3k(final LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, final PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, long j, final Orientation orientation, final Alignment.Vertical vertical, final Alignment.Horizontal horizontal, final boolean z, final long j2, final int i8, int i9, List<Integer> list, SnapPosition snapPosition, final MutableState<Unit> mutableState, CoroutineScope coroutineScope, Density density, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> function3, final MutableIntObjectMap<List<Placeable>> mutableIntObjectMap) {
        ...
        final long jConstraints$default = ConstraintsKt.Constraints$default(0, orientation == Orientation.Vertical ? Constraints.m9640getMaxWidthimpl(j) : i8, 0, orientation != Orientation.Vertical ? Constraints.m9639getMaxHeightimpl(j) : i8, 5, null);
        if (i <= 0) {
            return new PagerMeasureResult(CollectionsKt.emptyList(), i8, i5, i4, orientation, -i3, i2 + i4, false, iCoerceAtMost, null, null, 0.0f, 0, false, snapPosition, function3.invoke(Integer.valueOf(Constraints.m9642getMinWidthimpl(j)), Integer.valueOf(Constraints.m9641getMinHeightimpl(j)), new Function1() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$$ExternalSyntheticLambda0
        ...
        while (i21 < 0 && i16 > 0) {
            int i22 = i16 - 1;
            MeasuredPage measuredPageM1518getAndMeasureG5IdpRk = m1518getAndMeasureG5IdpRk(lazyLayoutMeasureScope, i22, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8, mutableIntObjectMap);
            arrayDeque.add(0, measuredPageM1518getAndMeasureG5IdpRk);
            iMax2 = Math.max(iMax2, measuredPageM1518getAndMeasureG5IdpRk.getCrossAxisSize());
            i21 += iCoerceAtLeast;
            i16 = i22;
        }
        if (i21 < i20) {
        ...
        while (i30 < i && (i26 < iCoerceAtLeast2 || i26 <= 0 || arrayDeque.isEmpty())) {
            ...
            int i32 = i30;
            int iMax3 = iMax2;
            MeasuredPage measuredPageM1518getAndMeasureG5IdpRk2 = m1518getAndMeasureG5IdpRk(lazyLayoutMeasureScope, i32, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8, mutableIntObjectMap);
            int i33 = i29;
            int i34 = i - 1;
            ...
            if (i26 <= i20 && i32 != i34) {
                ...
                iMax3 = Math.max(iMax3, measuredPageM1518getAndMeasureG5IdpRk2.getCrossAxisSize());
                Boolean.valueOf(arrayDeque.add(measuredPageM1518getAndMeasureG5IdpRk2));
                i14 = i25;
                i29 = i33;
            }
            iMax2 = iMax3;
        ...
        if (i26 < i2) {
            ...
            while (i11 < i3 && i12 > 0) {
                int i39 = i12 - 1;
                MeasuredPage measuredPageM1518getAndMeasureG5IdpRk3 = m1518getAndMeasureG5IdpRk(lazyLayoutMeasureScope, i39, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8, mutableIntObjectMap);
                arrayDeque.add(0, measuredPageM1518getAndMeasureG5IdpRk3);
                iMax = Math.max(iMax, measuredPageM1518getAndMeasureG5IdpRk3.getCrossAxisSize());
                i11 += iCoerceAtLeast;
                i36 = i36;
                i12 = i39;
            }
        ...
        int iM9657constrainWidthK40F9xA = ConstraintsKt.m9657constrainWidthK40F9xA(j, orientation == Orientation.Vertical ? iMax4 : i26);
        if (orientation == Orientation.Vertical) {
            iMax4 = i26;
        }
        int iM9656constrainHeightK40F9xA = ConstraintsKt.m9656constrainHeightK40F9xA(j, iMax4);
        int i47 = i10;
        int i48 = i26;
        final List<MeasuredPage> listCalculatePagesOffsets = calculatePagesOffsets(lazyLayoutMeasureScope, arrayDeque, list3, listCreatePagesAfterList, iM9657constrainWidthK40F9xA, iM9656constrainHeightK40F9xA, i48, i2, i13, orientation, z, lazyLayoutMeasureScope, i5, i8);
        if (z5) {
        ...
        MeasuredPage measuredPageCalculateNewCurrentPage = calculateNewCurrentPage(i52, list2, i3, i4, i8, snapPosition, i);
        return new PagerMeasureResult(list2, i8, i5, i4, orientation, i19, i24, z, i46, measuredPage9, measuredPageCalculateNewCurrentPage, iCoerceAtLeast == 0 ? 0.0f : RangesKt.coerceIn((snapPosition.position(i52, i8, i3, i4, measuredPageCalculateNewCurrentPage != null ? measuredPageCalculateNewCurrentPage.getIndex() : 0, i) - (measuredPageCalculateNewCurrentPage != null ? measuredPageCalculateNewCurrentPage.getOffset() : 0)) / iCoerceAtLeast, -0.5f, 0.5f), i43, i47 < i || i48 > i2, snapPosition, function3.invoke(Integer.valueOf(iM9657constrainWidthK40F9xA), Integer.valueOf(iM9656constrainHeightK40F9xA), new Function1() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static final MeasuredPage measurePager_7L1iB3k$lambda$10(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j, PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, long j2, Orientation orientation, Alignment.Horizontal horizontal, Alignment.Vertical vertical, boolean z, int i, MutableIntObjectMap mutableIntObjectMap, int i2) {
        return m1518getAndMeasureG5IdpRk(lazyLayoutMeasureScope, i2, j, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i, mutableIntObjectMap);
    }
    ...
    private static final MeasuredPage m1518getAndMeasureG5IdpRk(LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, long j, PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, long j2, Orientation orientation, Alignment.Horizontal horizontal, Alignment.Vertical vertical, LayoutDirection layoutDirection, boolean z, int i2, MutableIntObjectMap<List<Placeable>> mutableIntObjectMap) {
        ...
        if (arrayList == null) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                arrayList2.add(listCompose.get(i3).mo8265measureBRTryo0(j));
            }
            arrayList = arrayList2;
    ...
    private static final List<MeasuredPage> calculatePagesOffsets(LazyLayoutMeasureScope lazyLayoutMeasureScope, List<MeasuredPage> list, List<MeasuredPage> list2, List<MeasuredPage> list3, int i, int i2, int i3, int i4, int i5, Orientation orientation, boolean z, Density density, int i6, int i7) {
        ...
        if (z2) {
            ...
            Arrangement.HorizontalOrVertical horizontalOrVerticalM1076spacedBy0680j_4 = Arrangement.Absolute.INSTANCE.m1076spacedBy0680j_4(lazyLayoutMeasureScope.mo751toDpu2uoSUM(i6));
            if (orientation == Orientation.Vertical) {
                horizontalOrVerticalM1076spacedBy0680j_4.arrange(density, i10, iArr, iArr2);
                arrayList = arrayList2;
            } else {
                arrayList = arrayList2;
                horizontalOrVerticalM1076spacedBy0680j_4.arrange(density, i10, iArr, LayoutDirection.Ltr, iArr2);
            }
