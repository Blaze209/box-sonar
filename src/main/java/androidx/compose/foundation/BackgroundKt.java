...
public final class BackgroundKt {
    ...
    public static /* synthetic */ Modifier m589backgroundbw27NRU$default(Modifier modifier, long j, Shape shape, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m588backgroundbw27NRU(modifier, j, shape);
    }
    ...
    public static final Modifier m588backgroundbw27NRU(Modifier modifier, final long j, final Shape shape) {
        return modifier.then(new BackgroundElement(j, null, 1.0f, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BackgroundKt$background-bw27NRU$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName(AppStateModule.APP_STATE_BACKGROUND);
                inspectorInfo.setValue(Color.m6804boximpl(j));
                inspectorInfo.getProperties().set("color", Color.m6804boximpl(j));
                inspectorInfo.getProperties().set("shape", shape);
            }
