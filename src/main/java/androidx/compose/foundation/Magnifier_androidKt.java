...
public final class Magnifier_androidKt {
    ...
    public static /* synthetic */ Modifier m669magnifierUpNRX3w$default(Modifier modifier, Function1 function1, Function1 function2, Function1 function3, float f, long j, float f2, float f3, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            function2 = null;
        }
        if ((i & 4) != 0) {
        ...
        return m668magnifierUpNRX3w(modifier, function1, function2, function3, f, j, f2, f3, z);
    }

    /* JADX INFO: renamed from: magnifier-UpNRX3w, reason: not valid java name */
    public static final Modifier m668magnifierUpNRX3w(Modifier modifier, Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function2, Function1<? super DpSize, Unit> function3, float f, long j, float f2, float f3, boolean z) {
        return m671magnifierjPUL71Q$default(modifier, function1, function2, function3, f, false, j, f2, f3, z, null, 512, null);
    }

    /* JADX INFO: renamed from: magnifier-jPUL71Q$default, reason: not valid java name */
    public static /* synthetic */ Modifier m671magnifierjPUL71Q$default(Modifier modifier, Function1 function1, Function1 function2, Function1 function3, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory, int i, Object obj) {
        if ((i & 2) != 0) {
            function2 = null;
        }
        if ((i & 4) != 0) {
        ...
        return m670magnifierjPUL71Q(modifier, function1, function2, function3, f, z, j, f2, f3, z2, platformMagnifierFactory);
    }

    /* JADX INFO: renamed from: magnifier-jPUL71Q, reason: not valid java name */
    public static final Modifier m670magnifierjPUL71Q(Modifier modifier, Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function2, Function1<? super DpSize, Unit> function3, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory) {
