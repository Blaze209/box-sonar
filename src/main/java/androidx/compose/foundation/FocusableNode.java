...
public final class FocusableNode extends DelegatingNode implements SemanticsModifierNode, GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode, ObserverModifierNode, TraversableNode {
    ...
    private FocusableNode(MutableInteractionSource mutableInteractionSource, int i, Function1<? super Boolean, Unit> function1) {
        ...
        this.focusTargetNode = (FocusTargetModifierNode) delegate(FocusTargetModifierNodeKt.m6480FocusTargetModifierNodePYyLHbc(i, new FocusableNode$focusTargetNode$1(this)));
    }
    ...
    public /* synthetic */ FocusableNode(MutableInteractionSource mutableInteractionSource, int i, Function1 function1, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(mutableInteractionSource, (i2 & 2) != 0 ? Focusability.INSTANCE.m6503getAlwaysLCbbffg() : i, (i2 & 4) != 0 ? null : function1, null);
    }
    ...
    public final boolean requestFocus() {
        return FocusTargetModifierNode.m6476requestFocus3ESFkO8$default(this.focusTargetNode, 0, 1, null);
    }
    ...
    public final void onFocusStateChange(FocusState previousState, FocusState currentState) {
        ...
        if (getIsAttached() && (zIsFocused = currentState.isFocused()) != previousState.isFocused()) {
            ...
            if (zIsFocused) {
                BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C05971(null), 3, null);
    ...
    @DebugMetadata(c = "androidx.compose.foundation.FocusableNode$onFocusStateChange$1", f = "Focusable.kt", i = {}, l = {JfifUtil.MARKER_APP1}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    static final class C05971 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return FocusableNode.this.new C05971(continuation);
        }
    ...
    private final void emitWithFallback(final MutableInteractionSource mutableInteractionSource, final Interaction interaction) {
        if (getIsAttached()) {
            ...
            BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C05961(mutableInteractionSource, interaction, job != null ? job.invokeOnCompletion(new Function1() { // from class: androidx.compose.foundation.FocusableNode$$ExternalSyntheticLambda0
    ...
    static final class C05961 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C05961(MutableInteractionSource mutableInteractionSource, Interaction interaction, DisposableHandle disposableHandle, Continuation<? super C05961> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C05961(this.$this_emitWithFallback, this.$interaction, this.$handler, continuation);
        }
