...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl mo695createnHHXs2Y(View view, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Density density, float initialZoom) {
        if (useTextDefault) {
            return new PlatformMagnifierImpl(new Magnifier(view));
        }
        long jMo755toSizeXkaWNTQ = density.mo755toSizeXkaWNTQ(size);
        float fMo754toPx0680j_4 = density.mo754toPx0680j_4(cornerRadius);
        float fMo754toPx0680j_5 = density.mo754toPx0680j_4(elevation);
        Magnifier.Builder builder = new Magnifier.Builder(view);
        if (jMo755toSizeXkaWNTQ != InlineClassHelperKt.UnspecifiedPackedFloats) {
            builder.setSize(MathKt.roundToInt(Float.intBitsToFloat((int) (jMo755toSizeXkaWNTQ >> 32))), MathKt.roundToInt(Float.intBitsToFloat((int) (jMo755toSizeXkaWNTQ & 4294967295L))));
        }
        if (!Float.isNaN(fMo754toPx0680j_4)) {
            builder.setCornerRadius(fMo754toPx0680j_4);
        }
        if (!Float.isNaN(fMo754toPx0680j_5)) {
            builder.setElevation(fMo754toPx0680j_5);
        }
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void mo694updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            if (!Float.isNaN(zoom)) {
