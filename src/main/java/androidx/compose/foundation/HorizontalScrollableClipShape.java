...
final class HorizontalScrollableClipShape implements Shape {
    ...
    public Outline mo655createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        float fMo748roundToPx0680j_4 = density.mo748roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
        return new Outline.Rectangle(new Rect(0.0f, -fMo748roundToPx0680j_4, Float.intBitsToFloat((int) (size >> 32)), Float.intBitsToFloat((int) (size & 4294967295L)) + fMo748roundToPx0680j_4));
    }
}
