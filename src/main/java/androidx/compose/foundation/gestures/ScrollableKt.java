...
public final class ScrollableKt {
    ...
    public static final boolean CanDragCalculation$lambda$0(PointerType pointerType) {
        return !(pointerType == null ? false : PointerType.m8205equalsimpl0(pointerType.getValue(), PointerType.INSTANCE.m8210getMouseT8wyACA()));
    }
    ...
    public static final Object m944semanticsScrollByd4ec7I(ScrollingLogic scrollingLogic, long j, Continuation<? super Offset> continuation) {
        ...
        return Offset.m6558boximpl(scrollingLogic2.m963toOffsettuRUvjQ(floatRef.element));
    }
}
