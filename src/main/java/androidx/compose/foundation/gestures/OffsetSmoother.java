...
public final class OffsetSmoother {
    ...
    public final long m903smoothEventPositionMKHz9U(long offset) {
        if (this.eventRotatingArray.size() == 3) {
            ...
            list.set(i, Offset.m6558boximpl(offset));
        } else {
            this.eventRotatingArray.add(Offset.m6558boximpl(offset));
        }
        ...
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(Float.valueOf(Float.intBitsToFloat((int) (list2.get(i2).m6579unboximpl() >> 32))));
        }
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            arrayList2.add(Float.valueOf(Float.intBitsToFloat((int) (4294967295L & list3.get(i3).m6579unboximpl()))));
        }
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(fAverageOfFloat)) << 32) | (((long) Float.floatToRawIntBits((float) CollectionsKt.averageOfFloat(arrayList2))) & 4294967295L));
    }
