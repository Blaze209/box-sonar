...
@DebugMetadata(c = "androidx.compose.foundation.gestures.DragGestureDetectorKt$awaitLongPressOrCancellation$2", f = "DragGestureDetector.kt", i = {0, 0, 1, 1, 1}, l = {AnalyticsListener.EVENT_DRM_KEYS_REMOVED, 1048}, m = "invokeSuspend", n = {"$this$withTimeout", "finished", "$this$withTimeout", "event", "finished"}, s = {"L$0", "I$0", "L$0", "L$1", "I$0"}, v = 1)
final class DragGestureDetectorKt$awaitLongPressOrCancellation$2 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code duplicated, block: B:20:0x0073 A[LOOP:2: B:16:0x0064->B:20:0x0073, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:72:0x0076 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:73:0x0077 A[EDGE_INSN: B:73:0x0077->B:22:0x0077 BREAK  A[LOOP:2: B:16:0x0064->B:20:0x0073], SYNTHETIC] */
