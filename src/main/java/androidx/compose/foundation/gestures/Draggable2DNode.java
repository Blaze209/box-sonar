...
public final class Draggable2DNode extends DragGestureNode {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<Drag2DScope, Continuation<? super Unit>, Object> {
        ...
        public static final Unit invokeSuspend$lambda$0(Drag2DScope drag2DScope, Draggable2DNode draggable2DNode, DragEvent.DragDelta dragDelta) {
            ...
            if (draggable2DNode.reverseDirection) {
                delta = Offset.m6561constructorimpl((-9223372034707292160L) ^ delta);
            }
            drag2DScope.mo802dragByk4lQ0M(delta);
            return Unit.INSTANCE;
        }
    }
    ...
    public void mo775onDragStartedk4lQ0M(long startedPosition) {
        this.onDragStarted.invoke(Offset.m6558boximpl(startedPosition));
    }

    @Override // androidx.compose.foundation.gestures.DragGestureNode
    public void onDragStopped(DragEvent.DragStopped event) {
        this.onDragStopped.invoke(Velocity.m9916boximpl(event.getVelocity()));
    }
    ...
    private final long m854reverseIfNeededMKHz9U(long j) {
        return this.reverseDirection ? Offset.m6561constructorimpl(j ^ (-9223372034707292160L)) : j;
    }
}
