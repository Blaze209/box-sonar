...
final class TransformableStateKt$animatePanBy$2 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AnimationState animationState = new AnimationState(VectorConvertersKt.getVectorConverter(Offset.INSTANCE), Offset.m6558boximpl(this.$previous.element), null, 0L, 0L, false, 60, null);
            Offset offsetM6558boximpl = Offset.m6558boximpl(this.f19$$v$c$androidxcomposeuigeometryOffset$offset$0);
            AnimationSpec<Offset> animationSpec = this.$animationSpec;
            final Ref.LongRef longRef = this.$previous;
            this.label = 1;
            if (SuspendAnimationKt.animateTo$default(animationState, offsetM6558boximpl, animationSpec, false, new Function1() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animatePanBy$2$$ExternalSyntheticLambda0
    ...
    public static final Unit invokeSuspend$lambda$0(Ref.LongRef longRef, TransformScope transformScope, AnimationScope animationScope) {
        TransformScope.m985transformByd4ec7I$default(transformScope, 0.0f, Offset.m6573minusMKHz9U(((Offset) animationScope.getValue()).m6579unboximpl(), longRef.element), 0.0f, 5, null);
        longRef.element = ((Offset) animationScope.getValue()).m6579unboximpl();
        return Unit.INSTANCE;
    }
}
