        ...
        if (i == 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic2D$doFlingAnimation$2$flingScope$1
                ...
                public float scrollBy(float pixels) {
                    ...
                    if (Offset.m6566equalsimpl0(jDoFlingAnimation_QWom1Mo$toDecomposedOffset, Offset.INSTANCE.m6585getZeroF1C5BW0()) || ((Boolean) scrollingLogic2D.isScrollableNodeAttached.invoke()).booleanValue()) {
                        return ScrollingLogic2D.doFlingAnimation_QWom1Mo$toMagnitudeFloat(nestedScrollScope.mo902scrollByWithOverscrollOzD1aCk(jDoFlingAnimation_QWom1Mo$toDecomposedOffset, NestedScrollSource.INSTANCE.m8013getSideEffectWNlRxjI()));
                    }
            ...
            float fM938getMagnitudeTH1AsA0 = Scrollable2DKt.m938getMagnitudeTH1AsA0(j3);
            this.L$0 = longRef2;
            this.J$0 = j3;
            this.label = 1;
            obj = scrollingLogic2D2.flingBehavior.performFling(scrollScope, fM938getMagnitudeTH1AsA0, this);
