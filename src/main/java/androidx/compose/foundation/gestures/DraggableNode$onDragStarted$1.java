...
final class DraggableNode$onDragStarted$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Offset offsetM6558boximpl = Offset.m6558boximpl(this.f10$$v$c$androidxcomposeuigeometryOffset$startedPosition$0);
            this.label = 1;
            if (function3.invoke(coroutineScope, offsetM6558boximpl, this) == coroutine_suspended) {
