...
final class ScrollableNode$setScrollSemanticsActions$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (ScrollableKt.m944semanticsScrollByd4ec7I(scrollingLogic, Offset.m6561constructorimpl((jFloatToRawIntBits << 32) | (jFloatToRawIntBits2 & 4294967295L)), this) == coroutine_suspended) {
