...
final class Scrollable2DKt$semanticsScrollBy$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Offset offsetM6558boximpl2 = Offset.m6558boximpl(this.f13$$v$c$androidxcomposeuigeometryOffset$offset$0);
            final Ref.LongRef longRef = this.$previousValue;
            this.label = 1;
            if (SuspendAnimationKt.animate$default(vectorConverter, offsetM6558boximpl, offsetM6558boximpl2, null, null, new Function2() { // from class: androidx.compose.foundation.gestures.Scrollable2DKt$semanticsScrollBy$2$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function2
    ...
    public static final Unit invokeSuspend$lambda$0(Ref.LongRef longRef, NestedScrollScope nestedScrollScope, Offset offset, Offset offset2) {
        longRef.element = Offset.m6574plusMKHz9U(longRef.element, nestedScrollScope.mo901scrollByOzD1aCk(Offset.m6573minusMKHz9U(offset.m6579unboximpl(), longRef.element), NestedScrollSource.INSTANCE.m8014getUserInputWNlRxjI()));
        return Unit.INSTANCE;
    }
}
