...
public final class DraggableNode extends DragGestureNode {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
        ...
        public static final Unit invokeSuspend$lambda$0(DragScope dragScope, DraggableNode draggableNode, DragEvent.DragDelta dragDelta) {
            dragScope.dragBy(DraggableKt.m856toFloat3MmeM6k(draggableNode.m863reverseIfNeededMKHz9U(dragDelta.getDelta()), draggableNode.orientation));
            return Unit.INSTANCE;
        }
    }
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Float fBoxFloat = Boxing.boxFloat(DraggableKt.m857toFloatsFctU(DraggableNode.this.m862reverseIfNeededAH228Gc(this.$event.getVelocity()), DraggableNode.this.orientation));
                this.label = 1;
    ...
    public final long m862reverseIfNeededAH228Gc(long j) {
        return Velocity.m9931timesadjELrA(j, this.reverseDirection ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m863reverseIfNeededMKHz9U(long j) {
        return Offset.m6576timestuRUvjQ(j, this.reverseDirection ? -1.0f : 1.0f);
    }
}
