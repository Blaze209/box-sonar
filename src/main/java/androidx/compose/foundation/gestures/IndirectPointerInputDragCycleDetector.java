...
public final class IndirectPointerInputDragCycleDetector {
    ...
    static /* synthetic */ void m867moveToAwaitTouchSlopStateaWI9W7U$default(IndirectPointerInputDragCycleDetector indirectPointerInputDragCycleDetector, IndirectPointerInputChange indirectPointerInputChange, long j, long j2, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
        ...
        indirectPointerInputDragCycleDetector.m866moveToAwaitTouchSlopStateaWI9W7U(indirectPointerInputChange, j, j3, z);
    }

    /* JADX INFO: renamed from: moveToAwaitTouchSlopState-aWI9W7U, reason: not valid java name */
    private final void m866moveToAwaitTouchSlopStateaWI9W7U(IndirectPointerInputChange initialDown, long pointerId, long initialTouchSlopPositionChange, boolean verifyConsumptionInFinalPass) {
        ...
        awaitTouchSlopState.m875setPointerId0FcD4WY(pointerId);
        TouchSlopDetector touchSlopDetector = this.touchSlopDetector;
        if (touchSlopDetector == null) {
    ...
    private final void m868moveToDraggingState0FcD4WY(long pointerId) {
        DragDetectionState.Dragging draggingState = getDraggingState();
        draggingState.m877setPointerId0FcD4WY(pointerId);
    ...
    private final void m865moveToAwaitGesturePickupStaternUCldI(IndirectPointerInputChange initialDown, long pointerId, TouchSlopDetector touchSlopDetector) {
        ...
        awaitGesturePickupState.m873setPointerId0FcD4WY(pointerId);
    ...
    private final void processInitialDownState(IndirectPointerEvent indirectPointerInputEvent, PointerEventPass pass, DragDetectionState.AwaitDown state) {
        ...
        if (pass == PointerEventPass.Main) {
            if (awaitTouchSlop == DragDetectionState.AwaitDown.AwaitTouchSlop.Yes) {
                m867moveToAwaitTouchSlopStateaWI9W7U$default(this, indirectPointerInputChange, indirectPointerInputChange.getId(), 0L, false, 12, null);
            } else if (state.getConsumedOnInitial()) {
                m870sendDragStart3f7A7Is(indirectPointerInputChange, indirectPointerInputChange, IndirectPointerEventPrimaryDirectionalMotionAxis.m7640boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()), Offset.INSTANCE.m6585getZeroF1C5BW0());
                m869sendDragEventEu1f8Dk(indirectPointerInputChange, IndirectPointerEventPrimaryDirectionalMotionAxis.m7640boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()), Offset.INSTANCE.m6585getZeroF1C5BW0());
                m868moveToDraggingState0FcD4WY(indirectPointerInputChange.getId());
            }
        }
    }
    ...
    private final void processAwaitTouchSlop(IndirectPointerEvent indirectPointerInputEvent, PointerEventPass pass, DragDetectionState.AwaitTouchSlop state) {
        ...
        while (true) {
            ...
            if (PointerId.m8116equalsimpl0(indirectPointerInputChange2.getId(), state.getPointerId())) {
                break;
            } else {
                i++;
            }
        ...
        if (indirectPointerInputChange4 == null) {
            ...
            state.m875setPointerId0FcD4WY(indirectPointerInputChange4.getId());
        }
            ...
            if (!indirectPointerInputChange5.getIsConsumed()) {
                if (IndirectPointerInputDragCycleDetectorKt.changedToUpIgnoreConsumed(indirectPointerInputChange5)) {
                    ...
                    if (indirectPointerInputChange7 == null) {
                        ...
                        state.m875setPointerId0FcD4WY(indirectPointerInputChange7.getId());
                    }
                } else {
                    long jM979addPositionsakrDWew = requireTouchSlopDetector().m979addPositionsakrDWew(IndirectPointerInputDragCycleDetectorKt.m888primaryAxisPosition_bfSUIo(indirectPointerInputChange5, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m7640boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis())), IndirectPointerInputDragCycleDetectorKt.m890primaryAxisPreviousPosition_bfSUIo(indirectPointerInputChange5, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m7640boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis())), DragGestureDetectorKt.m840pointerSlopE8SPZFQ((ViewConfiguration) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.node, CompositionLocalsKt.getLocalViewConfiguration()), PointerType.INSTANCE.m8212getTouchT8wyACA()));
                    if ((9223372034707292159L & jM979addPositionsakrDWew) != InlineClassHelperKt.UnspecifiedPackedFloats) {
                        ...
                        m870sendDragStart3f7A7Is(initialDown, indirectPointerInputChange5, IndirectPointerEventPrimaryDirectionalMotionAxis.m7640boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()), jM979addPositionsakrDWew);
                        m869sendDragEventEu1f8Dk(indirectPointerInputChange5, IndirectPointerEventPrimaryDirectionalMotionAxis.m7640boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()), jM979addPositionsakrDWew);
                        m868moveToDraggingState0FcD4WY(indirectPointerInputChange5.getId());
                    } else {
                ...
                TouchSlopDetector touchSlopDetector = this.touchSlopDetector;
                if (touchSlopDetector != null) {
                    m865moveToAwaitGesturePickupStaternUCldI(initialDown2, pointerId, touchSlopDetector);
                } else {
        ...
        if (pass == PointerEventPass.Final && state.getVerifyConsumptionInFinalPass()) {
            if (indirectPointerInputChange5.getIsConsumed()) {
                ...
                TouchSlopDetector touchSlopDetector2 = this.touchSlopDetector;
                if (touchSlopDetector2 != null) {
                    m865moveToAwaitGesturePickupStaternUCldI(initialDown3, pointerId2, touchSlopDetector2);
                    return;
                }
                throw new IllegalArgumentException("AwaitTouchSlop.touchSlopDetector was not initialized".toString());
            }
    ...
    private final void processAwaitGesturePickup(IndirectPointerEvent indirectPointerInputEvent, PointerEventPass pass, DragDetectionState.AwaitGesturePickup state) {
        ...
        while (true) {
            if (i >= size) {
                ...
                if (changes.get(i).getIsConsumed()) {
                    z = false;
                    break;
                }
                i++;
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            if (changes2.get(i2).getPressed()) {
                ...
                if (z) {
                    long jM888primaryAxisPosition_bfSUIo = IndirectPointerInputDragCycleDetectorKt.m888primaryAxisPosition_bfSUIo((IndirectPointerInputChange) CollectionsKt.first((List) indirectPointerInputEvent.getChanges()), this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m7640boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()));
                    IndirectPointerInputChange initialDown = state.getInitialDown();
                    Intrinsics.checkNotNull(initialDown);
                    long jM6573minusMKHz9U = Offset.m6573minusMKHz9U(jM888primaryAxisPosition_bfSUIo, IndirectPointerInputDragCycleDetectorKt.m888primaryAxisPosition_bfSUIo(initialDown, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m7640boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis())));
                    IndirectPointerInputChange initialDown2 = state.getInitialDown();
                    if (initialDown2 != null) {
                        m867moveToAwaitTouchSlopStateaWI9W7U$default(this, initialDown2, state.getPointerId(), jM6573minusMKHz9U, false, 8, null);
                        return;
                    }
    ...
    private final void processDraggingState(IndirectPointerEvent indirectPointerInputEvent, PointerEventPass pass, DragDetectionState.Dragging state) {
        ...
        while (true) {
            ...
            indirectPointerInputChange2 = changes.get(i);
            if (PointerId.m8116equalsimpl0(indirectPointerInputChange2.getId(), pointerId)) {
                break;
            } else {
                i++;
            }
        ...
        if (IndirectPointerInputDragCycleDetectorKt.changedToUpIgnoreConsumed(indirectPointerInputChange3)) {
            ...
            int size2 = changes2.size();
            for (int i2 = 0; i2 < size2; i2++) {
                IndirectPointerInputChange indirectPointerInputChange4 = changes2.get(i2);
            ...
            if (indirectPointerInputChange5 == null) {
                if (!indirectPointerInputChange3.getIsConsumed() && IndirectPointerInputDragCycleDetectorKt.changedToUpIgnoreConsumed(indirectPointerInputChange3)) {
                    m871sendDragStoppedk92h6UU(indirectPointerInputChange3, IndirectPointerEventPrimaryDirectionalMotionAxis.m7640boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()));
                } else {
                    sendDragCancelled();
                }
                moveToAwaitDownState();
            ...
            state.m877setPointerId0FcD4WY(indirectPointerInputChange5.getId());
            return;
        }
        if (indirectPointerInputChange3.getIsConsumed()) {
            sendDragCancelled();
        } else {
            if (Offset.m6567getDistanceimpl(IndirectPointerInputDragCycleDetectorKt.m885positionChangeIgnoreConsumed_bfSUIo(indirectPointerInputChange3, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m7640boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()))) == 0.0f) {
                return;
            }
            m869sendDragEventEu1f8Dk(indirectPointerInputChange3, IndirectPointerEventPrimaryDirectionalMotionAxis.m7640boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis()), IndirectPointerInputDragCycleDetectorKt.m884positionChange_bfSUIo(indirectPointerInputChange3, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m7640boximpl(indirectPointerInputEvent.getPrimaryDirectionalMotionAxis())));
            indirectPointerInputChange3.consume();
        }
    }

    /* JADX INFO: renamed from: sendDragStart-3f7A7Is, reason: not valid java name */
    private final void m870sendDragStart3f7A7Is(IndirectPointerInputChange down, IndirectPointerInputChange slopTriggerChange, IndirectPointerEventPrimaryDirectionalMotionAxis primaryDirectionalMotionAxis, long overSlopOffset) {
        if (this.velocityTracker == null) {
            this.velocityTracker = new VelocityTracker();
        }
        this.nodeOffset = Offset.INSTANCE.m6585getZeroF1C5BW0();
        IndirectPointerInputDragCycleDetectorKt.m883addIndirectPointerInputChangeQf4Zb88(requireVelocityTracker(), down, this.node.getOrientationLock(), primaryDirectionalMotionAxis, this.touchSmooth, this.nodeOffset);
        long jM6573minusMKHz9U = Offset.m6573minusMKHz9U(IndirectPointerInputDragCycleDetectorKt.m888primaryAxisPosition_bfSUIo(slopTriggerChange, this.node.getOrientationLock(), primaryDirectionalMotionAxis), overSlopOffset);
        if (this.node.getCanDrag().invoke(PointerType.m8202boximpl(PointerType.INSTANCE.m8212getTouchT8wyACA())).booleanValue()) {
            this.previousPositionOnScreen = LayoutCoordinatesKt.positionOnScreen(DelegatableNodeKt.requireLayoutCoordinates(this.node));
            this.node.onDragEvent(new DragEvent.DragStarted(jM6573minusMKHz9U, null));
        }
        this.offsetSmoother.reset();
    }

    /* JADX INFO: renamed from: sendDragEvent-Eu1f8Dk, reason: not valid java name */
    private final void m869sendDragEventEu1f8Dk(IndirectPointerInputChange change, IndirectPointerEventPrimaryDirectionalMotionAxis primaryDirectionalMotionAxis, long dragAmount) {
        ...
        if (Math.abs(DraggableKt.m856toFloat3MmeM6k(dragAmount, orientationLock)) > 2.0f) {
            IndirectPointerInputDragCycleDetectorKt.m883addIndirectPointerInputChangeQf4Zb88(requireVelocityTracker(), change, this.node.getOrientationLock(), primaryDirectionalMotionAxis, this.touchSmooth, this.nodeOffset);
            this.node.onDragEvent(new DragEvent.DragDelta(this.offsetSmoother.m903smoothEventPositionMKHz9U(dragAmount), true, null));
        }
    }

    /* JADX INFO: renamed from: sendDragStopped-k92h6UU, reason: not valid java name */
    private final void m871sendDragStoppedk92h6UU(IndirectPointerInputChange change, IndirectPointerEventPrimaryDirectionalMotionAxis primaryDirectionalMotionAxis) {
        IndirectPointerInputDragCycleDetectorKt.m883addIndirectPointerInputChangeQf4Zb88(requireVelocityTracker(), change, this.node.getOrientationLock(), primaryDirectionalMotionAxis, this.touchSmooth, this.nodeOffset);
        ...
        this.node.onDragEvent(new DragEvent.DragStopped(DraggableKt.m858toValidVelocityTH1AsA0(jM8240calculateVelocityAH228Gc), true, null));
    }
    ...
    public static abstract class DragDetectionState {
        ...
        public static final class AwaitTouchSlop extends DragDetectionState {
            ...
            public /* synthetic */ AwaitTouchSlop(IndirectPointerInputChange indirectPointerInputChange, long j, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
                this((i & 1) != 0 ? null : indirectPointerInputChange, (i & 2) != 0 ? PointerId.m8114constructorimpl(Long.MAX_VALUE) : j, (i & 4) != 0 ? false : z, null);
            }
            ...
            public final void m875setPointerId0FcD4WY(long j) {
                this.pointerId = j;
            }
        ...
        public static final class AwaitGesturePickup extends DragDetectionState {
            ...
            public /* synthetic */ AwaitGesturePickup(IndirectPointerInputChange indirectPointerInputChange, long j, TouchSlopDetector touchSlopDetector, int i, DefaultConstructorMarker defaultConstructorMarker) {
                this((i & 1) != 0 ? null : indirectPointerInputChange, (i & 2) != 0 ? PointerId.m8114constructorimpl(Long.MAX_VALUE) : j, (i & 4) != 0 ? null : touchSlopDetector, null);
            }
            ...
            /* JADX INFO: renamed from: setPointerId-0FcD4WY, reason: not valid java name */
            public final void m873setPointerId0FcD4WY(long j) {
                this.pointerId = j;
            }
        ...
        public static final class Dragging extends DragDetectionState {
            ...
            public /* synthetic */ Dragging(long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
                this((i & 1) != 0 ? PointerId.m8114constructorimpl(Long.MAX_VALUE) : j, null);
            }
            ...
            /* JADX INFO: renamed from: setPointerId-0FcD4WY, reason: not valid java name */
            public final void m877setPointerId0FcD4WY(long j) {
                this.pointerId = j;
            }
        }
    }
