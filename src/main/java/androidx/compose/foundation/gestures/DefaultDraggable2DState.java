...
final class DefaultDraggable2DState implements Draggable2DState {
    ...
    private final Drag2DScope drag2DScope = new Drag2DScope() { // from class: androidx.compose.foundation.gestures.DefaultDraggable2DState$drag2DScope$1
        ...
        public void mo802dragByk4lQ0M(long pixels) {
            this.this$0.getOnDelta().invoke(Offset.m6558boximpl(pixels));
        }
    };
    ...
    @DebugMetadata(c = "androidx.compose.foundation.gestures.DefaultDraggable2DState$drag$2", f = "Draggable2D.kt", i = {}, l = {BoxRequestsFile.DownloadThumbnail.SIZE_320}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    ...
    public void mo801dispatchRawDeltak4lQ0M(long delta) {
        this.onDelta.invoke(Offset.m6558boximpl(delta));
    }
}
