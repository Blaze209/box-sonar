...
final class DefaultScrollable2DState implements Scrollable2DState {
    ...
    private final Scroll2DScope scrollScope = new Scroll2DScope() { // from class: androidx.compose.foundation.gestures.DefaultScrollable2DState$scrollScope$1
        ...
        public long mo805scrollByMKHz9U(long delta) {
            ...
            return this.this$0.getOnDelta().invoke(Offset.m6558boximpl(delta)).m6579unboximpl();
        }
    };
    ...
    public boolean mo803canScrollk4lQ0M(long offset) {
        return true;
    }
    ...
    @DebugMetadata(c = "androidx.compose.foundation.gestures.DefaultScrollable2DState$scroll$2", f = "Scrollable2DState.kt", i = {}, l = {Token.XML}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @DebugMetadata(c = "androidx.compose.foundation.gestures.DefaultScrollable2DState$scroll$2$1", f = "Scrollable2DState.kt", i = {}, l = {Token.XMLEND}, m = "invokeSuspend", n = {}, s = {}, v = 1)
    ...
    public long mo804dispatchRawDeltaMKHz9U(long delta) {
        return this.onDelta.invoke(Offset.m6558boximpl(delta)).m6579unboximpl();
    }
