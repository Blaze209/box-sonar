...
public final class DraggableKt {
    ...
    public static final float m856toFloat3MmeM6k(long j, Orientation orientation) {
    ...
    public static final float m857toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m9926getYimpl(j) : Velocity.m9925getXimpl(j);
    }

    /* JADX INFO: renamed from: toValidVelocity-TH1AsA0, reason: not valid java name */
    public static final long m858toValidVelocityTH1AsA0(long j) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m9925getXimpl(j)) ? 0.0f : Velocity.m9925getXimpl(j), Float.isNaN(Velocity.m9926getYimpl(j)) ? 0.0f : Velocity.m9926getYimpl(j));
    }
}
