...
public final class AndroidConfig implements ScrollConfig {
    ...
    public long mo783calculateMouseWheelScroll8xgXZGE(Density density, PointerEvent pointerEvent, long j) {
        ...
        for (int i = 0; i < size; i++) {
            offsetM6558boximpl = Offset.m6558boximpl(Offset.m6574plusMKHz9U(offsetM6558boximpl.m6579unboximpl(), changes.get(i).getScrollDelta()));
        }
        long jM6579unboximpl = offsetM6558boximpl.m6579unboximpl();
        float fIntBitsToFloat = Float.intBitsToFloat((int) (jM6579unboximpl >> 32)) * f2;
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (jM6579unboximpl & 4294967295L)) * f;
        return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(fIntBitsToFloat)) << 32) | (((long) Float.floatToRawIntBits(fIntBitsToFloat2)) & 4294967295L));
    }
}
