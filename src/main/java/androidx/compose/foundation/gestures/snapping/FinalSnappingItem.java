...
public final class FinalSnappingItem {
    ...
    private static final int ClosestItem = m997constructorimpl(0);
    private static final int NextItem = m997constructorimpl(1);
    private static final int PreviousItem = m997constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FinalSnappingItem m996boximpl(int i) {
    ...
    public boolean equals(Object other) {
        return m998equalsimpl(this.value, other);
    }
