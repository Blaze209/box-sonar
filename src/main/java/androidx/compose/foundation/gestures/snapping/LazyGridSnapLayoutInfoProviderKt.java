...
public final class LazyGridSnapLayoutInfoProviderKt {
    ...
    public static final SnapLayoutInfoProvider SnapLayoutInfoProvider(final LazyGridState lazyGridState, final SnapPosition snapPosition) {
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.gestures.snapping.LazyGridSnapLayoutInfoProviderKt.SnapLayoutInfoProvider.1
            ...
            public float calculateSnapOffset(float velocity) {
                ...
                return SnapFlingBehaviorKt.m1008calculateFinalOffsetFhqu1e0(LazyListSnapLayoutInfoProviderKt.calculateFinalSnappingItem(lazyGridState.getDensity$foundation(), velocity), f, f2);
            }
        };
    }
    ...
    public static final int getSingleAxisViewportSize(LazyGridLayoutInfo lazyGridLayoutInfo) {
        long jMo1377getViewportSizeYbymL2g;
        if (lazyGridLayoutInfo.getOrientation() == Orientation.Vertical) {
            jMo1377getViewportSizeYbymL2g = lazyGridLayoutInfo.mo1377getViewportSizeYbymL2g() & 4294967295L;
        } else {
            jMo1377getViewportSizeYbymL2g = lazyGridLayoutInfo.mo1377getViewportSizeYbymL2g() >> 32;
        }
        return (int) jMo1377getViewportSizeYbymL2g;
    }

    public static final int sizeOnMainAxis(LazyGridItemInfo lazyGridItemInfo, Orientation orientation) {
        long jMo1372getSizeYbymL2g;
        if (orientation == Orientation.Vertical) {
            jMo1372getSizeYbymL2g = lazyGridItemInfo.getSize() & 4294967295L;
        } else {
            jMo1372getSizeYbymL2g = lazyGridItemInfo.getSize() >> 32;
        }
        return (int) jMo1372getSizeYbymL2g;
    }

    public static final int offsetOnMainAxis(LazyGridItemInfo lazyGridItemInfo, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            return IntOffset.m9816getYimpl(lazyGridItemInfo.getOffset());
        }
        return IntOffset.m9815getXimpl(lazyGridItemInfo.getOffset());
    }
}
