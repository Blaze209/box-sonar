...
public final class SnapFlingBehaviorKt {
    ...
    private static final float MinFlingVelocityDp = Dp.m9687constructorimpl(400);
    ...
    public static final Object animateDecay(final ScrollScope scrollScope, final float f, AnimationState<Float, AnimationVector1D> animationState, DecayAnimationSpec<Float> decayAnimationSpec, final Function1<? super Float, Unit> function1, Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
        ...
        if (i == 0) {
            ...
            Function1 function2 = new Function1() { // from class: androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt$$ExternalSyntheticLambda0
    ...
    public static final Object animateWithTarget(final ScrollScope scrollScope, float f, final float f2, AnimationState<Float, AnimationVector1D> animationState, AnimationSpec<Float> animationSpec, final Function1<? super Float, Unit> function1, Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
        ...
        C06411 c06412 = c06411;
        Object obj = c06412.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c06412.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            boolean z = animationState.getVelocity().floatValue() == 0.0f;
            Function1 function2 = new Function1() { // from class: androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj2) {
                    return SnapFlingBehaviorKt.animateWithTarget$lambda$0(f2, floatRef2, scrollScope, function1, (AnimationScope) obj2);
                }
            };
            c06412.L$0 = animationState;
            c06412.L$1 = floatRef2;
            f3 = f;
            c06412.F$0 = f3;
            c06412.F$1 = fFloatValue;
            c06412.label = 1;
            if (SuspendAnimationKt.animateTo(animationState, fBoxFloat, animationSpec, !z, function2, c06412) == coroutine_suspended) {
                return coroutine_suspended;
            }
            ...
            f4 = c06412.F$1;
            float f5 = c06412.F$0;
            floatRef = (Ref.FloatRef) c06412.L$1;
            AnimationState<Float, AnimationVector1D> animationState3 = (AnimationState) c06412.L$0;
            ResultKt.throwOnFailure(obj);
            f3 = f5;
    ...
    public static final float m1008calculateFinalOffsetFhqu1e0(int i, float f, float f2) {
        if (FinalSnappingItem.m999equalsimpl0(i, FinalSnappingItem.INSTANCE.m1003getClosestItembbeMdSM())) {
            if (Math.abs(f2) <= Math.abs(f)) {
                f = f2;
            }
        } else if (FinalSnappingItem.m999equalsimpl0(i, FinalSnappingItem.INSTANCE.m1004getNextItembbeMdSM())) {
            f = f2;
        } else if (!FinalSnappingItem.m999equalsimpl0(i, FinalSnappingItem.INSTANCE.m1005getPreviousItembbeMdSM())) {
            f = 0.0f;
        }
