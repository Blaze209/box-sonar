...
public final class MarqueeAnimationMode {
    ...
    private static final int Immediately = m673constructorimpl(0);
    private static final int WhileFocused = m673constructorimpl(1);
    private final int value;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m672boximpl(int i) {
        return new MarqueeAnimationMode(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m673constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object other) {
        return m674equalsimpl(this.value, other);
    }
    ...
    public static String m677toStringimpl(int i) {
        if (m675equalsimpl0(i, Immediately)) {
            return "Immediately";
        }
        if (m675equalsimpl0(i, WhileFocused)) {
            return "WhileFocused";
        }
