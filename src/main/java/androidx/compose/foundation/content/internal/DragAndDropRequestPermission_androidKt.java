...
public final class DragAndDropRequestPermission_androidKt {
    public static final void dragAndDropRequestPermission(DelegatableNode delegatableNode, DragAndDropEvent dragAndDropEvent) {
        ...
        if (containsContentUri(MAMDragEventManagement.getClipData(DragAndDrop_androidKt.toAndroidDragEvent(dragAndDropEvent))) && delegatableNode.getNode().getIsAttached() && (activityTryGetActivity = tryGetActivity(DelegatableNode_androidKt.requireView(delegatableNode))) != null) {
