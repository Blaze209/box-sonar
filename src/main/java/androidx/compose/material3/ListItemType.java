...
final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m3711constructorimpl(1);
    private static final int TwoLine = m3711constructorimpl(2);
    private static final int ThreeLine = m3711constructorimpl(3);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ListItemType m3709boximpl(int i) {
        return new ListItemType(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m3711constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3712equalsimpl(int i, Object obj) {
        return (obj instanceof ListItemType) && i == ((ListItemType) obj).getLines();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3713equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3714hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3715toStringimpl(int i) {
        return "ListItemType(lines=" + i + ')';
    }

    public boolean equals(Object other) {
        return m3712equalsimpl(this.lines, other);
    }

    public int hashCode() {
        return m3714hashCodeimpl(this.lines);
    }

    public String toString() {
        return m3715toStringimpl(this.lines);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m3716compareToyh95HIg(listItemType.getLines());
    }
    ...
    public static int m3710compareToyh95HIg(int i, int i2) {
        return Intrinsics.compare(i, i2);
    }

    /* JADX INFO: renamed from: compareTo-yh95HIg, reason: not valid java name */
    public int m3716compareToyh95HIg(int i) {
        return m3710compareToyh95HIg(this.lines, i);
    }
