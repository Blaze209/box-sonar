...
public final class VerticalFloatingToolbarOverrideScope {
    ...
    public /* synthetic */ VerticalFloatingToolbarOverrideScope(boolean z, Modifier modifier, FloatingToolbarColors floatingToolbarColors, PaddingValues paddingValues, FloatingToolbarScrollBehavior floatingToolbarScrollBehavior, Shape shape, Function3 function3, Function3 function4, float f, float f2, Function3 function5, DefaultConstructorMarker defaultConstructorMarker) {
        this(z, modifier, floatingToolbarColors, paddingValues, floatingToolbarScrollBehavior, shape, function3, function4, f, f2, function5);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private VerticalFloatingToolbarOverrideScope(boolean z, Modifier modifier, FloatingToolbarColors floatingToolbarColors, PaddingValues paddingValues, FloatingToolbarScrollBehavior floatingToolbarScrollBehavior, Shape shape, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function4, float f, float f2, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function5) {
        this.isExpanded = z;
        ...
        this.trailingContent = function4;
    ...
    public /* synthetic */ VerticalFloatingToolbarOverrideScope(boolean z, Modifier modifier, FloatingToolbarColors floatingToolbarColors, PaddingValues paddingValues, FloatingToolbarScrollBehavior floatingToolbarScrollBehavior, Shape shape, Function3 function3, Function3 function4, float f, float f2, Function3 function5, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(z, (i & 2) != 0 ? Modifier.INSTANCE : modifier, floatingToolbarColors, paddingValues, floatingToolbarScrollBehavior, shape, function3, function4, f, f2, function5, null);
    }
    ...
    /* JADX INFO: renamed from: getExpandedShadowElevation-D9Ej5fM, reason: not valid java name and from getter */
    public final float getExpandedShadowElevation() {
        return this.expandedShadowElevation;
    }

    /* JADX INFO: renamed from: getCollapsedShadowElevation-D9Ej5fM, reason: not valid java name and from getter */
