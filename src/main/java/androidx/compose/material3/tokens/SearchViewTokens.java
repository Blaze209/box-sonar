...
public final class SearchViewTokens {
    ...
    private static final float DockedHeaderContainerHeight = Dp.m9687constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens FullScreenContainerShape = ShapeKeyTokens.CornerNone;
    private static final float FullScreenHeaderContainerHeight = Dp.m9687constructorimpl((float) 72.0d);
    ...
    public final float m5720getContainerElevationD9Ej5fM() {
    ...
    public final float m5721getDockedHeaderContainerHeightD9Ej5fM() {
    ...
    public final float m5722getFullScreenHeaderContainerHeightD9Ej5fM() {
