...
public final class SliderTokens {
    ...
    private static final float ValueIndicatorActiveBottomSpace = Dp.m9687constructorimpl((float) 12.0d);
    ...
    static {
        float f = (float) 44.0d;
        ActiveHandleHeight = Dp.m9687constructorimpl(f);
        float f2 = (float) 6.0d;
        ActiveHandleLeadingSpace = Dp.m9687constructorimpl(f2);
        ActiveHandlePadding = Dp.m9687constructorimpl(f2);
        ActiveHandleTrailingSpace = Dp.m9687constructorimpl(f2);
        float f3 = (float) 4.0d;
        ActiveHandleWidth = Dp.m9687constructorimpl(f3);
        float f4 = (float) 16.0d;
        ActiveTrackHeight = Dp.m9687constructorimpl(f4);
        DisabledHandleWidth = Dp.m9687constructorimpl(f3);
        float f5 = (float) 2.0d;
        FocusHandleWidth = Dp.m9687constructorimpl(f5);
        HandleHeight = Dp.m9687constructorimpl(f);
        HandleWidth = Dp.m9687constructorimpl(f3);
        HoverHandleWidth = Dp.m9687constructorimpl(f3);
        InactiveTrackHeight = Dp.m9687constructorimpl(f4);
        PressedHandleWidth = Dp.m9687constructorimpl(f5);
        StopIndicatorSize = Dp.m9687constructorimpl(f3);
        StopIndicatorTrailingSpace = Dp.m9687constructorimpl(f2);
    }
    ...
    public final float m5759getActiveHandleTrailingSpaceD9Ej5fM() {
        return ActiveHandleTrailingSpace;
    }

    /* JADX INFO: renamed from: getActiveHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m5760getActiveHandleWidthD9Ej5fM() {
    ...
    public final float m5761getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m5762getDisabledHandleWidthD9Ej5fM() {
    ...
    public final float m5763getFocusHandleWidthD9Ej5fM() {
    ...
    public final float m5764getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m5765getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m5766getHoverHandleWidthD9Ej5fM() {
    ...
    public final float m5767getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m5768getPressedHandleWidthD9Ej5fM() {
    ...
    public final float m5769getStopIndicatorSizeD9Ej5fM() {
        return StopIndicatorSize;
    }

    /* JADX INFO: renamed from: getStopIndicatorTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m5770getStopIndicatorTrailingSpaceD9Ej5fM() {
    ...
    public final float m5771getValueIndicatorActiveBottomSpaceD9Ej5fM() {
