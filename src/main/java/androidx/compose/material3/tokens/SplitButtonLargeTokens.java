...
public final class SplitButtonLargeTokens {
    ...
    private static final float TrailingIconSize = Dp.m9687constructorimpl((float) 38.0d);
    ...
    public final float m5785getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m5786getContainerHeightD9Ej5fM() {
    ...
    public final float m5789getTrailingButtonLeadingSpaceD9Ej5fM() {
    ...
    public final float m5790getTrailingButtonTrailingSpaceD9Ej5fM() {
