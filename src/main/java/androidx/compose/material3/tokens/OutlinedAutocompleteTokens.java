...
public final class OutlinedAutocompleteTokens {
    ...
    private static final float TextFieldFocusOutlineWidth = Dp.m9687constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 1.0d;
        TextFieldDisabledOutlineWidth = Dp.m9687constructorimpl(f);
        TextFieldHoverOutlineWidth = Dp.m9687constructorimpl(f);
        float f2 = (float) 24.0d;
        TextFieldLeadingIconSize = Dp.m9687constructorimpl(f2);
        TextFieldOutlineWidth = Dp.m9687constructorimpl(f);
        TextFieldTrailingIconSize = Dp.m9687constructorimpl(f2);
    }
    ...
    public final float m5593getMenuContainerElevationD9Ej5fM() {
    ...
    public final float m5594getTextFieldDisabledOutlineWidthD9Ej5fM() {
    ...
    public final float m5595getTextFieldFocusOutlineWidthD9Ej5fM() {
    ...
    public final float m5596getTextFieldHoverOutlineWidthD9Ej5fM() {
    ...
    public final float m5597getTextFieldLeadingIconSizeD9Ej5fM() {
    ...
    public final float m5598getTextFieldOutlineWidthD9Ej5fM() {
    ...
    public final float m5599getTextFieldTrailingIconSizeD9Ej5fM() {
