...
public final class SecondaryNavigationTabTokens {
    ...
    private static final float DividerHeight = Dp.m9687constructorimpl((float) 1.0d);
    ...
    public final float m5724getContainerHeightD9Ej5fM() {
    ...
    public final float m5725getDividerHeightD9Ej5fM() {
    ...
    public final float m5726getIconSizeD9Ej5fM() {
        return IconSize;
    }
