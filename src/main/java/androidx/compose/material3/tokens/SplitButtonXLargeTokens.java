...
public final class SplitButtonXLargeTokens {
    ...
    private static final float TrailingIconSize = Dp.m9687constructorimpl((float) 50.0d);
    ...
    public final float m5806getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m5807getContainerHeightD9Ej5fM() {
    ...
    public final float m5810getTrailingButtonLeadingSpaceD9Ej5fM() {
    ...
    public final float m5811getTrailingButtonTrailingSpaceD9Ej5fM() {
        return TrailingButtonTrailingSpace;
    }

    static {
        float f = (float) 64.0d;
        LeadingButtonLeadingSpace = Dp.m9687constructorimpl(f);
        LeadingButtonTrailingSpace = Dp.m9687constructorimpl(f);
        float f2 = (float) 43.0d;
        TrailingButtonLeadingSpace = Dp.m9687constructorimpl(f2);
        TrailingButtonTrailingSpace = Dp.m9687constructorimpl(f2);
    }
}
