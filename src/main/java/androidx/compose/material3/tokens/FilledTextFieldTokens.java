...
public final class FilledTextFieldTokens {
    ...
    private static final float FocusActiveIndicatorHeight = Dp.m9687constructorimpl((float) 2.0d);
    ...
    static {
        ...
        DisabledActiveIndicatorHeight = Dp.m9687constructorimpl(f);
        HoverActiveIndicatorHeight = Dp.m9687constructorimpl(f);
    ...
    public final float m5445getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m5446getDisabledActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m5447getFocusActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m5448getHoverActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m5449getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m5450getTrailingIconSizeD9Ej5fM() {
