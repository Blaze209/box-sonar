...
public final class FloatingToolbarTokens {
    ...
    private static final float ContainerBetweenSpace = Dp.m9687constructorimpl((float) 4.0d);
    private static final float ContainerExternalPadding = Dp.m9687constructorimpl((float) 16.0d);
    ...
    public final float m5479getContainerTrailingSpaceD9Ej5fM() {
    ...
    static {
        float f = (float) 8.0d;
        ContainerLeadingSpace = Dp.m9687constructorimpl(f);
        ContainerTrailingSpace = Dp.m9687constructorimpl(f);
    }
}
