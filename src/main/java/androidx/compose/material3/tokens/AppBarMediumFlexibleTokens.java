...
public final class AppBarMediumFlexibleTokens {
    ...
    private static final float ContainerHeight = Dp.m9687constructorimpl((float) 112.0d);
    ...
    private static final float LargeContainerHeight = Dp.m9687constructorimpl((float) 136.0d);
    ...
    public final float m5127getLargeContainerHeightD9Ej5fM() {
