...
public final class AppBarLargeFlexibleTokens {
    ...
    private static final float ContainerHeight = Dp.m9687constructorimpl((float) 120.0d);
    ...
    private static final float LargeContainerHeight = Dp.m9687constructorimpl((float) 152.0d);

    private AppBarLargeFlexibleTokens() {
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m5123getContainerHeightD9Ej5fM() {
    ...
    public final float m5124getLargeContainerHeightD9Ej5fM() {
