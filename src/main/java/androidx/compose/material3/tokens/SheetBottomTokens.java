...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m9687constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = Dp.m9687constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m5364getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m5364getLevel1D9Ej5fM();
    ...
    public final float m5752getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* JADX INFO: renamed from: getDockedDragHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m5753getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m5754getDockedModalContainerElevationD9Ej5fM() {
    ...
    public final float m5755getDockedStandardContainerElevationD9Ej5fM() {
