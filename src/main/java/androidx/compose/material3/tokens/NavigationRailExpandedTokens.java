...
public final class NavigationRailExpandedTokens {
    ...
    private static final float ContainerWidthMaximum = Dp.m9687constructorimpl((float) 360.0d);
    private static final float ContainerWidthMinimum = Dp.m9687constructorimpl((float) 220.0d);
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m5365getLevel2D9Ej5fM();
    private static final ShapeKeyTokens ModalContainerShape = ShapeKeyTokens.CornerLarge;
    private static final float TopSpace = Dp.m9687constructorimpl((float) 44.0d);
    ...
    public final float m5578getContainerElevationD9Ej5fM() {
    ...
    public final float m5582getTopSpaceD9Ej5fM() {
        return TopSpace;
    }
