...
public final class SplitButtonMediumTokens {
    ...
    private static final float TrailingIconSize = Dp.m9687constructorimpl((float) 26.0d);
    ...
    public final float m5792getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m5793getContainerHeightD9Ej5fM() {
    ...
    public final float m5796getTrailingButtonLeadingSpaceD9Ej5fM() {
    ...
    public final float m5797getTrailingButtonTrailingSpaceD9Ej5fM() {
