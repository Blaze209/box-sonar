...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m9687constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m9687constructorimpl((float) 336.0d);
    ...
    private static final float ContainerWidth = Dp.m9687constructorimpl((float) 360.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m5364getLevel1D9Ej5fM();
    private static final ColorSchemeKeyTokens StandardContainerColor = ColorSchemeKeyTokens.Surface;
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m5363getLevel0D9Ej5fM();
    ...
    public final float m5560getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m5561getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m5562getContainerWidthD9Ej5fM() {
    ...
    public final float m5563getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m5564getModalContainerElevationD9Ej5fM() {
    ...
    public final float m5565getStandardContainerElevationD9Ej5fM() {
