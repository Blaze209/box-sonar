...
public final class DockedToolbarTokens {
    ...
    private static final float ContainerMaxSpacing = Dp.m9687constructorimpl((float) 32.0d);
    private static final float ContainerMinSpacing = Dp.m9687constructorimpl((float) 4.0d);
    ...
    public final float m5340getContainerTrailingSpaceD9Ej5fM() {
