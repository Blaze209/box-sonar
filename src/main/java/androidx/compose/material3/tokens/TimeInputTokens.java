...
public final class TimeInputTokens {
    ...
    private static final float PeriodSelectorContainerWidth = Dp.m9687constructorimpl((float) 52.0d);
    ...
    private static final float TimeFieldContainerWidth = Dp.m9687constructorimpl((float) 96.0d);
    ...
    private static final float TimeFieldFocusOutlineWidth = Dp.m9687constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 72.0d;
        PeriodSelectorContainerHeight = Dp.m9687constructorimpl(f);
        TimeFieldContainerHeight = Dp.m9687constructorimpl(f);
    }
    ...
    public final float m5844getContainerElevationD9Ej5fM() {
    ...
    public final float m5845getPeriodSelectorContainerHeightD9Ej5fM() {
    ...
    public final float m5846getPeriodSelectorContainerWidthD9Ej5fM() {
    ...
    public final float m5847getPeriodSelectorOutlineWidthD9Ej5fM() {
    ...
    public final float m5848getTimeFieldContainerHeightD9Ej5fM() {
    ...
    public final float m5849getTimeFieldContainerWidthD9Ej5fM() {
    ...
    public final float m5850getTimeFieldFocusOutlineWidthD9Ej5fM() {
