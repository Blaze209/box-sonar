...
public final class NavigationRailVerticalItemTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m9687constructorimpl((float) 32.0d);
    private static final float ActiveIndicatorWidth = Dp.m9687constructorimpl((float) 56.0d);
    private static final float IconLabelSpace = Dp.m9687constructorimpl((float) 4.0d);
