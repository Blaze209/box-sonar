...
public final class SearchBarTokens {
    ...
    private static final float AvatarSize = Dp.m9687constructorimpl((float) 30.0d);
    ...
    public final float m5717getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
    ...
    public final float m5718getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m5719getContainerHeightD9Ej5fM() {
