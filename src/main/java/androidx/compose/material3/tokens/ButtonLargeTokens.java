...
public final class ButtonLargeTokens {
    ...
    private static final float IconLabelSpace = Dp.m9687constructorimpl((float) 12.0d);
    private static final float IconSize = Dp.m9687constructorimpl((float) 32.0d);
    ...
    public final float m5163getContainerHeightD9Ej5fM() {
    ...
    public final float m5168getTrailingSpaceD9Ej5fM() {
