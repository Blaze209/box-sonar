...
public final class DateInputModalTokens {
    ...
    private static final float ContainerHeight = Dp.m9687constructorimpl((float) 512.0d);
    ...
    public final float m5311getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m5312getContainerHeightD9Ej5fM() {
