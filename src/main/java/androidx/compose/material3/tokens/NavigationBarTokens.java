...
public final class NavigationBarTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m5365getLevel2D9Ej5fM();
    ...
    private static final float ItemActiveIndicatorIconLabelSpace = Dp.m9687constructorimpl((float) 4.0d);
    ...
    private static final float ItemBetweenSpace = Dp.m9687constructorimpl((float) 0.0d);
    ...
    private static final float TallContainerHeight = Dp.m9687constructorimpl((float) 80.0d);
    ...
    public final float m5551getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m5552getContainerHeightD9Ej5fM() {
    ...
    public final float m5553getItemActiveIndicatorIconLabelSpaceD9Ej5fM() {
    ...
    public final float m5554getItemBetweenSpaceD9Ej5fM() {
    ...
    public final float m5555getTallContainerHeightD9Ej5fM() {
