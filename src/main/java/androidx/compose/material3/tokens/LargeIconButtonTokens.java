...
public final class LargeIconButtonTokens {
    ...
    private static final float ContainerHeight = Dp.m9687constructorimpl((float) 96.0d);
    ...
    private static final float OutlinedOutlineWidth = Dp.m9687constructorimpl((float) 2.0d);
    ...
    public final float m5488getContainerHeightD9Ej5fM() {
