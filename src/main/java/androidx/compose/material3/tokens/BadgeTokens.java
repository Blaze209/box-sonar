...
public final class BadgeTokens {
    ...
    private static final float LargeSize = Dp.m9687constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = Dp.m9687constructorimpl((float) 6.0d);
    ...
    public final float m5147getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m5148getSizeD9Ej5fM() {
        return Size;
    }
}
