...
public final class NavigationRailHorizontalItemTokens {
    ...
    static {
        float f = (float) 16.0d;
        FullWidthLeadingSpace = Dp.m9687constructorimpl(f);
        FullWidthTrailingSpace = Dp.m9687constructorimpl(f);
