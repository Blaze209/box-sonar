...
public final class InputChipTokens {
    ...
    private static final float SelectedOutlineWidth = Dp.m9687constructorimpl((float) 0.0d);
    ...
    private static final float UnselectedOutlineWidth = Dp.m9687constructorimpl((float) 1.0d);
    ...
    private static final float AvatarSize = Dp.m9687constructorimpl((float) 24.0d);
    ...
    static {
        float f = (float) 18.0d;
        LeadingIconSize = Dp.m9687constructorimpl(f);
        TrailingIconSize = Dp.m9687constructorimpl(f);
    }

    /* JADX INFO: renamed from: getContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m5481getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m5482getContainerHeightD9Ej5fM() {
    ...
    public final float m5483getDraggedContainerElevationD9Ej5fM() {
    ...
    public final float m5485getSelectedOutlineWidthD9Ej5fM() {
    ...
    public final float m5487getUnselectedOutlineWidthD9Ej5fM() {
    ...
    public final float m5480getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
    ...
    public final float m5484getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m5486getTrailingIconSizeD9Ej5fM() {
