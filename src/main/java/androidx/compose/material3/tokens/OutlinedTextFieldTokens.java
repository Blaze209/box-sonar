...
public final class OutlinedTextFieldTokens {
    ...
    private static final float FocusOutlineWidth = Dp.m9687constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 1.0d;
        DisabledOutlineWidth = Dp.m9687constructorimpl(f);
        HoverOutlineWidth = Dp.m9687constructorimpl(f);
        float f2 = (float) 24.0d;
        LeadingIconSize = Dp.m9687constructorimpl(f2);
        OutlineWidth = Dp.m9687constructorimpl(f);
        TrailingIconSize = Dp.m9687constructorimpl(f2);
    }
    ...
    public final float m5611getContainerHeightD9Ej5fM() {
    ...
    public final float m5612getDisabledOutlineWidthD9Ej5fM() {
    ...
    public final float m5613getFocusOutlineWidthD9Ej5fM() {
    ...
    public final float m5614getHoverOutlineWidthD9Ej5fM() {
    ...
    public final float m5615getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m5616getOutlineWidthD9Ej5fM() {
        return OutlineWidth;
    }
