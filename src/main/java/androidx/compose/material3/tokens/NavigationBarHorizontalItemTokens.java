...
public final class NavigationBarHorizontalItemTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m9687constructorimpl((float) 40.0d);
    ...
    public final float m5547getActiveIndicatorHeightD9Ej5fM() {
        return ActiveIndicatorHeight;
    }

    /* JADX INFO: renamed from: getActiveIndicatorLeadingSpace-D9Ej5fM, reason: not valid java name */
    public final float m5548getActiveIndicatorLeadingSpaceD9Ej5fM() {
    ...
    public final float m5549getActiveIndicatorTrailingSpaceD9Ej5fM() {
        return ActiveIndicatorTrailingSpace;
    }

    /* JADX INFO: renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m5550getIconSizeD9Ej5fM() {
        return IconSize;
    }
