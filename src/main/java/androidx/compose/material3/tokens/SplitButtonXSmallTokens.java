...
public final class SplitButtonXSmallTokens {
    ...
    private static final float BetweenSpace = Dp.m9687constructorimpl((float) 2.0d);
    ...
    private static final float LeadingButtonLeadingSpace = Dp.m9687constructorimpl((float) 12.0d);
    private static final float LeadingButtonTrailingSpace = Dp.m9687constructorimpl((float) 10.0d);
    private static final float OuterCornerCornerSizePercent = 50.0f;
    private static final float TrailingIconSize = Dp.m9687constructorimpl((float) 22.0d);
    ...
    public final float m5813getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m5814getContainerHeightD9Ej5fM() {
    ...
    public final float m5815getLeadingButtonLeadingSpaceD9Ej5fM() {
        return LeadingButtonLeadingSpace;
    }

    /* JADX INFO: renamed from: getLeadingButtonTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m5816getLeadingButtonTrailingSpaceD9Ej5fM() {
    ...
    public final float m5819getTrailingIconSizeD9Ej5fM() {
    ...
    public final float m5817getTrailingButtonLeadingSpaceD9Ej5fM() {
    ...
    public final float m5818getTrailingButtonTrailingSpaceD9Ej5fM() {
        return TrailingButtonTrailingSpace;
    }

    static {
        float f = (float) 13.0d;
        TrailingButtonLeadingSpace = Dp.m9687constructorimpl(f);
        TrailingButtonTrailingSpace = Dp.m9687constructorimpl(f);
    }
}
