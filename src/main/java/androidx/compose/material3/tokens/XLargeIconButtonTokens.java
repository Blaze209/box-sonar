...
public final class XLargeIconButtonTokens {
    ...
    private static final float ContainerHeight = Dp.m9687constructorimpl((float) 136.0d);
    ...
    private static final float IconSize = Dp.m9687constructorimpl((float) 40.0d);
    private static final float OutlinedOutlineWidth = Dp.m9687constructorimpl((float) 3.0d);
    ...
    public final float m5959getContainerHeightD9Ej5fM() {
    ...
    public final float m5966getWideLeadingSpaceD9Ej5fM() {
        return WideLeadingSpace;
    }

    /* JADX INFO: renamed from: getWideTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m5967getWideTrailingSpaceD9Ej5fM() {
        return WideTrailingSpace;
    }

    static {
        float f = (float) 48.0d;
        DefaultLeadingSpace = Dp.m9687constructorimpl(f);
        DefaultTrailingSpace = Dp.m9687constructorimpl(f);
        float f2 = (float) 32.0d;
        NarrowLeadingSpace = Dp.m9687constructorimpl(f2);
        NarrowTrailingSpace = Dp.m9687constructorimpl(f2);
        float f3 = (float) 72.0d;
        WideLeadingSpace = Dp.m9687constructorimpl(f3);
        WideTrailingSpace = Dp.m9687constructorimpl(f3);
    }
}
