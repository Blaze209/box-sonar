...
public final class FabMenuBaselineTokens {
    ...
    private static final float CloseButtonContainerElevation = ElevationTokens.INSTANCE.m5366getLevel3D9Ej5fM();
    private static final ShapeKeyTokens CloseButtonContainerShape = ShapeKeyTokens.CornerFull;
    private static final float CloseButtonIconSize = Dp.m9687constructorimpl((float) 20.0d);
    private static final float ListItemBetweenSpace = Dp.m9687constructorimpl((float) 4.0d);
    private static final float ListItemContainerElevation = ElevationTokens.INSTANCE.m5366getLevel3D9Ej5fM();
    ...
    public final float m5403getCloseButtonBetweenSpaceD9Ej5fM() {
        return CloseButtonBetweenSpace;
    }

    /* JADX INFO: renamed from: getCloseButtonContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m5404getCloseButtonContainerElevationD9Ej5fM() {
    ...
    public final float m5405getCloseButtonContainerHeightD9Ej5fM() {
    ...
    public final float m5411getListItemIconLabelSpaceD9Ej5fM() {
        return ListItemIconLabelSpace;
    }

    /* JADX INFO: renamed from: getListItemIconSize-D9Ej5fM, reason: not valid java name */
    public final float m5412getListItemIconSizeD9Ej5fM() {
        return ListItemIconSize;
    }

    /* JADX INFO: renamed from: getListItemLeadingSpace-D9Ej5fM, reason: not valid java name */
    public final float m5413getListItemLeadingSpaceD9Ej5fM() {
        return ListItemLeadingSpace;
    }

    /* JADX INFO: renamed from: getListItemTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m5414getListItemTrailingSpaceD9Ej5fM() {
        return ListItemTrailingSpace;
    }

    static {
        float f = (float) 8.0d;
        CloseButtonBetweenSpace = Dp.m9687constructorimpl(f);
        float f2 = (float) 56.0d;
        CloseButtonContainerHeight = Dp.m9687constructorimpl(f2);
        CloseButtonContainerWidth = Dp.m9687constructorimpl(f2);
        ListItemContainerHeight = Dp.m9687constructorimpl(f2);
        ListItemIconLabelSpace = Dp.m9687constructorimpl(f);
        float f3 = (float) 24.0d;
        ListItemIconSize = Dp.m9687constructorimpl(f3);
        ListItemLeadingSpace = Dp.m9687constructorimpl(f3);
        ListItemTrailingSpace = Dp.m9687constructorimpl(f3);
    }
}
