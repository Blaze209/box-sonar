...
public final class MediumIconButtonTokens {
    ...
    public final float m5537getContainerHeightD9Ej5fM() {
    ...
    public final float m5544getWideLeadingSpaceD9Ej5fM() {
        return WideLeadingSpace;
    }

    /* JADX INFO: renamed from: getWideTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m5545getWideTrailingSpaceD9Ej5fM() {
    ...
    static {
        ...
        NarrowLeadingSpace = Dp.m9687constructorimpl(f3);
        NarrowTrailingSpace = Dp.m9687constructorimpl(f3);
        WideLeadingSpace = Dp.m9687constructorimpl(f2);
        WideTrailingSpace = Dp.m9687constructorimpl(f2);
    }
}
