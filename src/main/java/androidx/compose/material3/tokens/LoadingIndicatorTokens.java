...
public final class LoadingIndicatorTokens {
    ...
    private static final float ActiveSize = Dp.m9687constructorimpl((float) 38.0d);
    ...
    static {
        float f = (float) 48.0d;
        ContainerHeight = Dp.m9687constructorimpl(f);
    ...
    public final float m5534getActiveSizeD9Ej5fM() {
        return ActiveSize;
    }
    ...
    public final float m5535getContainerHeightD9Ej5fM() {
    ...
    public final float m5536getContainerWidthD9Ej5fM() {
