...
public final class SmallIconButtonTokens {
    ...
    private static final float OutlinedOutlineWidth = Dp.m9687constructorimpl((float) 1.0d);
    ...
    public final float m5772getContainerHeightD9Ej5fM() {
    ...
    public final float m5779getWideLeadingSpaceD9Ej5fM() {
        return WideLeadingSpace;
    }

    /* JADX INFO: renamed from: getWideTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m5780getWideTrailingSpaceD9Ej5fM() {
