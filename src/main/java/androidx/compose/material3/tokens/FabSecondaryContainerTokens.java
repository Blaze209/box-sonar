...
public final class FabSecondaryContainerTokens {
    ...
    private static final float FocusedContainerElevation = ElevationTokens.INSTANCE.m5366getLevel3D9Ej5fM();
    private static final ColorSchemeKeyTokens FocusedIconColor = ColorSchemeKeyTokens.OnSecondaryContainer;
    private static final float HoveredContainerElevation = ElevationTokens.INSTANCE.m5367getLevel4D9Ej5fM();
    ...
    public final float m5419getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getFocusedContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m5420getFocusedContainerElevationD9Ej5fM() {
    ...
    public final float m5421getHoveredContainerElevationD9Ej5fM() {
    ...
    public final float m5422getPressedContainerElevationD9Ej5fM() {
