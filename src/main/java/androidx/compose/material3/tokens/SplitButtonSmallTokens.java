...
public final class SplitButtonSmallTokens {
    ...
    private static final float LeadingButtonLeadingSpace = Dp.m9687constructorimpl((float) 16.0d);
    private static final float LeadingButtonTrailingSpace = Dp.m9687constructorimpl((float) 12.0d);
    ...
    public final float m5799getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }
    ...
    public final float m5803getTrailingButtonLeadingSpaceD9Ej5fM() {
    ...
    public final float m5804getTrailingButtonTrailingSpaceD9Ej5fM() {
