...
final class DatePickerStateImpl extends BaseDatePickerStateImpl implements DatePickerState {
    ...
    public static final class Companion {
        ...
        public static final List Saver$lambda$0(SaverScope saverScope, DatePickerStateImpl datePickerStateImpl) {
            return CollectionsKt.listOf(datePickerStateImpl.getSelectedDateMillis(), Long.valueOf(datePickerStateImpl.getDisplayedMonthMillis()), Integer.valueOf(datePickerStateImpl.getYearRange().getFirst()), Integer.valueOf(datePickerStateImpl.getYearRange().getLast()), Integer.valueOf(datePickerStateImpl.mo3202getDisplayModejFl4v0()));
        }
        ...
        public static final DatePickerStateImpl Saver$lambda$1(SelectableDates selectableDates, Locale locale, List list) {
            ...
            return new DatePickerStateImpl(l, l2, intRange, DisplayMode.m3270constructorimpl(((Integer) obj3).intValue()), selectableDates, locale, null);
        }
    }
}
