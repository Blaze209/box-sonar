...
public final class SegmentedButtonContentMeasurePolicy implements MultiContentMeasurePolicy {
    ...
    public MeasureResult mo1154measure3p2s80s(final MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(list2.get(i2).mo8265measureBRTryo0(j));
        }
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            arrayList3.add(list3.get(i4).mo8265measureBRTryo0(j));
        }
        ...
        int iMax = Math.max(measureScope.mo748roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m4141getIconSizeD9Ej5fM()), width3) + measureScope.mo748roundToPx0680j_4(SegmentedButtonKt.IconSpacing) + (numValueOf != null ? numValueOf.intValue() : 0);
        int i6 = width3 == 0 ? (-(measureScope.mo748roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m4141getIconSizeD9Ej5fM()) + measureScope.mo748roundToPx0680j_4(SegmentedButtonKt.IconSpacing))) / 2 : 0;
        ...
        return MeasureScope.layout$default(measureScope, iMax, i7, null, new Function1() { // from class: androidx.compose.material3.SegmentedButtonContentMeasurePolicy$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj7) {
                return SegmentedButtonContentMeasurePolicy.measure_3p2s80s$lambda$6(arrayList2, measureScope, this, i8, arrayList4, i7, (Placeable.PlacementScope) obj7);
            }
        }, 4, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit measure_3p2s80s$lambda$6(List list, MeasureScope measureScope, SegmentedButtonContentMeasurePolicy segmentedButtonContentMeasurePolicy, int i, List list2, int i2, Placeable.PlacementScope placementScope) {
        int size = list.size();
        ...
        int i4 = measureScope.mo748roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m4141getIconSizeD9Ej5fM()) + measureScope.mo748roundToPx0680j_4(SegmentedButtonKt.IconSpacing);
