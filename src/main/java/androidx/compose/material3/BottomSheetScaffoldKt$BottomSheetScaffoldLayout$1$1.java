...
final class BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1 implements MultiContentMeasurePolicy {
    ...
    public final MeasureResult mo1154measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(list4.get(i2).mo8265measureBRTryo0(jM9630copyZbe2FdA$default));
        }
        final ArrayList arrayList2 = arrayList;
        ArrayList arrayList3 = new ArrayList(list2.size());
        int size2 = list2.size();
        for (int i3 = 0; i3 < size2; i3++) {
            arrayList3.add(list2.get(i3).mo8265measureBRTryo0(jM9630copyZbe2FdA$default));
        }
        ...
        long jM9630copyZbe2FdA$default2 = Constraints.m9630copyZbe2FdA$default(jM9630copyZbe2FdA$default, 0, 0, 0, iM9639getMaxHeightimpl - iIntValue, 7, null);
        ...
        return MeasureScope.layout$default(measureScope, iM9640getMaxWidthimpl, iM9639getMaxHeightimpl, null, new Function1() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1.measure_3p2s80s$lambda$5(arrayList2, iM9640getMaxWidthimpl, arrayList8, sheetState, function0, iM9639getMaxHeightimpl, arrayList6, arrayList4, iIntValue, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
