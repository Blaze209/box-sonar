...
public final class CarouselItemScopeImpl implements CarouselItemScope {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new GenericShape(new Function3() { // from class: androidx.compose.material3.carousel.CarouselItemScopeImpl$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2, Object obj3) {
                    return CarouselItemScopeImpl.rememberMaskShape$lambda$0$0(this.f$0, shape, density, (Path) obj, (Size) obj2, (LayoutDirection) obj3);
                }
            });
    ...
    public static final Unit rememberMaskShape$lambda$0$0(CarouselItemScopeImpl carouselItemScopeImpl, Shape shape, Density density, Path path, Size size, LayoutDirection layoutDirection) {
        Rect rectIntersect = carouselItemScopeImpl.getItemInfo().getMaskRect().intersect(SizeKt.m6659toRectuvyYCjk(size.m6643unboximpl()));
        OutlineKt.addOutline(path, shape.mo655createOutlinePq9zytI(rectIntersect.m6602getSizeNHjbRc(), layoutDirection, density));
        float left = rectIntersect.getLeft();
        float top = rectIntersect.getTop();
        path.mo6706translatek4lQ0M(Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(left)) << 32) | (((long) Float.floatToRawIntBits(top)) & 4294967295L)));
