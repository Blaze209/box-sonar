...
public final class CarouselDefaults {
    ...
    private static final float MinSmallItemSize = Dp.m9687constructorimpl(40);
    private static final float MaxSmallItemSize = Dp.m9687constructorimpl(56);
    private static final float AnchorSize = Dp.m9687constructorimpl(10);
    ...
    public final TargetedFlingBehavior singleAdvanceFlingBehavior(CarouselState carouselState, AnimationSpec<Float> animationSpec, Composer composer, int i, int i2) {
        ComposerKt.sourceInformationMarkerStart(composer, 1701587199, "C(singleAdvanceFlingBehavior)N(state,snapAnimationSpec)727@33104L174:Carousel.kt#dcf9yb");
        if ((i2 & 2) != 0) {
            animationSpec = AnimationSpecKt.spring$default(0.0f, 400.0f, null, 5, null);
        }
        AnimationSpec<Float> animationSpec2 = animationSpec;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1701587199, i, -1, "androidx.compose.material3.carousel.CarouselDefaults.singleAdvanceFlingBehavior (Carousel.kt:726)");
        }
    ...
    public final TargetedFlingBehavior multiBrowseFlingBehavior(CarouselState carouselState, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec, Composer composer, int i, int i2) {
        ComposerKt.sourceInformationMarkerStart(composer, -1105043293, "C(multiBrowseFlingBehavior)N(state,decayAnimationSpec,snapAnimationSpec)757@34760L26,772@35364L217:Carousel.kt#dcf9yb");
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1105043293, i, -1, "androidx.compose.material3.carousel.CarouselDefaults.multiBrowseFlingBehavior (Carousel.kt:759)");
        }
    ...
    public final TargetedFlingBehavior noSnapFlingBehavior(Composer composer, int i) {
        ComposerKt.sourceInformationMarkerStart(composer, -418415756, "C(noSnapFlingBehavior)789@35995L158,795@36170L75:Carousel.kt#dcf9yb");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-418415756, i, -1, "androidx.compose.material3.carousel.CarouselDefaults.noSnapFlingBehavior (Carousel.kt:788)");
        }
