...
public final class CarouselStateKt {
        ...
        if (z3 || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function0() { // from class: androidx.compose.material3.carousel.CarouselStateKt$$ExternalSyntheticLambda0
                ...
                public final Object invoke() {
                    return CarouselStateKt.rememberCarouselState$lambda$0$0(i, function0);
                }
            };
            composer.updateRememberedValue(objRememberedValue);
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        CarouselState carouselState = (CarouselState) RememberSaveableKt.m6247rememberSaveable(objArr, (Saver) saver, (Function0) objRememberedValue, composer, 0);
    ...
    public static final Object animateScrollToPage(final LazyLayoutScrollScope lazyLayoutScrollScope, PagerState pagerState, int i, float f, AnimationSpec<Float> animationSpec, Function2<? super ScrollScope, ? super Integer, Unit> function2, Continuation<? super Unit> continuation) {
        ...
        Object objAnimate$default = SuspendAnimationKt.animate$default(0.0f, fCalculateScrollDistanceTo, 0.0f, animationSpec, new Function2() { // from class: androidx.compose.material3.carousel.CarouselStateKt$$ExternalSyntheticLambda1
            ...
            public final Object invoke(Object obj, Object obj2) {
                return CarouselStateKt.animateScrollToPage$lambda$0(floatRef, lazyLayoutScrollScope, ((Float) obj).floatValue(), ((Float) obj2).floatValue());
            }
        }, continuation, 4, null);
    ...
    private static final float calculateScrollDistanceTo(PagerState pagerState, int i, int i2) {
        int iMo1515getViewportSizeYbymL2g = (int) (pagerState.getLayoutInfo().getOrientation() == Orientation.Horizontal ? pagerState.getLayoutInfo().mo1515getViewportSizeYbymL2g() >> 32 : pagerState.getLayoutInfo().mo1515getViewportSizeYbymL2g() & 4294967295L);
        return ((i2 - i) * (pagerState.getLayoutInfo().getPageSize() + pagerState.getLayoutInfo().getPageSpacing())) + (pagerState.getLayoutInfo().getSnapPosition().position(iMo1515getViewportSizeYbymL2g, pagerState.getLayoutInfo().getPageSize(), pagerState.getLayoutInfo().getBeforeContentPadding(), pagerState.getLayoutInfo().getAfterContentPadding(), i, pagerState.getPageCount()) - pagerState.getLayoutInfo().getSnapPosition().position(iMo1515getViewportSizeYbymL2g, pagerState.getLayoutInfo().getPageSize(), pagerState.getLayoutInfo().getBeforeContentPadding(), pagerState.getLayoutInfo().getAfterContentPadding(), i2, pagerState.getPageCount()));
    }
}
