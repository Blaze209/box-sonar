...
public final class DateInputValidator {
    ...
    /* JADX WARN: Code duplicated, block: B:32:0x00ac A[ORIG_RETURN, RETURN] */
    /* JADX WARN: Code duplicated, block: B:36:? A[RETURN, SYNTHETIC] */
    /* JADX INFO: renamed from: validate-XivgLIo, reason: not valid java name */
    public final String m3121validateXivgLIo(CalendarDate dateToValidate, int inputIdentifier, Locale locale) {
        long utcTimeMillis;
        Long l;
        long jLongValue;
        ...
        if (InputIdentifier.m3605equalsimpl0(inputIdentifier, InputIdentifier.INSTANCE.m3611getStartDateInputJ2x2o4M())) {
            ...
            if (utcTimeMillis2 <= (l2 != null ? l2.longValue() : Long.MAX_VALUE)) {
                if (InputIdentifier.m3605equalsimpl0(inputIdentifier, InputIdentifier.INSTANCE.m3609getEndDateInputJ2x2o4M())) {
        ...
        } else if (InputIdentifier.m3605equalsimpl0(inputIdentifier, InputIdentifier.INSTANCE.m3609getEndDateInputJ2x2o4M())) {
            utcTimeMillis = dateToValidate.getUtcTimeMillis();
            l = this.currentStartDateMillis;
            if (l != null) {
                jLongValue = l.longValue();
