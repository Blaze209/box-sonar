        ...
        if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function0() { // from class: androidx.compose.material3.WideNavigationRailStateKt$$ExternalSyntheticLambda0
                ...
                public final Object invoke() {
                    return WideNavigationRailStateKt.rememberWideNavigationRailState$lambda$0$0(wideNavigationRailValue, finiteAnimationSpecValue);
                }
            };
            composer.updateRememberedValue(objRememberedValue);
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        WideNavigationRailState wideNavigationRailState = (WideNavigationRailState) RememberSaveableKt.m6247rememberSaveable(objArr, (Saver) Saver, (Function0) objRememberedValue, composer, 0);
        if (ComposerKt.isTraceInProgress()) {
