...
public final class ExposedDropdownMenuAnchorType {
    ...
    private static final String PrimaryNotEditable = m3316constructorimpl("PrimaryNotEditable");
    private static final String PrimaryEditable = m3316constructorimpl("PrimaryEditable");
    private static final String SecondaryEditable = m3316constructorimpl("SecondaryEditable");

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ExposedDropdownMenuAnchorType m3315boximpl(String str) {
        return new ExposedDropdownMenuAnchorType(str);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static String m3316constructorimpl(String str) {
        return str;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3317equalsimpl(String str, Object obj) {
    ...
    public static final boolean m3318equalsimpl0(String str, String str2) {
        return Intrinsics.areEqual(str, str2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3319hashCodeimpl(String str) {
        return str.hashCode();
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3320toStringimpl(String str) {
        return str;
    }

    public boolean equals(Object other) {
        return m3317equalsimpl(this.name, other);
    }

    public int hashCode() {
        return m3319hashCodeimpl(this.name);
    }
    ...
    public static final class Companion {
        ...
        public final String m3323getPrimaryNotEditableoYjWRB4() {
        ...
        public final String m3322getPrimaryEditableoYjWRB4() {
        ...
        public final String m3324getSecondaryEditableoYjWRB4() {
    ...
    public String toString() {
        return m3320toStringimpl(this.name);
    }
}
