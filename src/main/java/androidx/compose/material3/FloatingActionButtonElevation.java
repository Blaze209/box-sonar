...
public class FloatingActionButtonElevation {
    ...
    public final State<Dp> shadowElevation$material3(InteractionSource interactionSource, Composer composer, int i) {
        ComposerKt.sourceInformationMarkerStart(composer, -424810125, "C(shadowElevation)N(interactionSource)1289@59048L55:FloatingActionButton.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-424810125, i, -1, "androidx.compose.material3.FloatingActionButtonElevation.shadowElevation (FloatingActionButton.kt:1288)");
        }
    ...
    private final State<Dp> animateElevation(InteractionSource interactionSource, Composer composer, int i) {
        ComposerKt.sourceInformationMarkerStart(composer, -1845106002, "C(animateElevation)N(interactionSource)1299@59327L346,1308@59704L277,1308@59683L298,1317@60025L1282,1317@59991L1316:FloatingActionButton.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1845106002, i, -1, "androidx.compose.material3.FloatingActionButtonElevation.animateElevation (FloatingActionButton.kt:1297)");
        }
    ...
    public boolean equals(Object other) {
        ...
        if (Dp.m9692equalsimpl0(this.defaultElevation, floatingActionButtonElevation.defaultElevation) && Dp.m9692equalsimpl0(this.pressedElevation, floatingActionButtonElevation.pressedElevation) && Dp.m9692equalsimpl0(this.focusedElevation, floatingActionButtonElevation.focusedElevation)) {
            return Dp.m9692equalsimpl0(this.hoveredElevation, floatingActionButtonElevation.hoveredElevation);
        }
        return false;
    }

    public int hashCode() {
        return (((((Dp.m9693hashCodeimpl(this.defaultElevation) * 31) + Dp.m9693hashCodeimpl(this.pressedElevation)) * 31) + Dp.m9693hashCodeimpl(this.focusedElevation)) * 31) + Dp.m9693hashCodeimpl(this.hoveredElevation);
    }
}
