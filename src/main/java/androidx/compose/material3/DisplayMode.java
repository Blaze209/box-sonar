...
public final class DisplayMode {
    ...
    private static final int Picker = m3270constructorimpl(0);
    private static final int Input = m3270constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ DisplayMode m3269boximpl(int i) {
    ...
    public boolean equals(Object other) {
        return m3271equalsimpl(this.value, other);
    }
    ...
    public static String m3274toStringimpl(int i) {
        if (m3272equalsimpl0(i, Picker)) {
            return "Picker";
        }
        return m3272equalsimpl0(i, Input) ? "Input" : "Unknown";
    }
}
