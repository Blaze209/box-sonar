...
public final class MinimumInteractiveModifierNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, LayoutModifierNode {
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final int height;
        float f = 0;
        float fM9687constructorimpl = Dp.m9687constructorimpl(RangesKt.coerceAtLeast(((Dp) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, InteractiveComponentSizeKt.getLocalMinimumInteractiveComponentSize())).m9701unboximpl(), Dp.m9687constructorimpl(f)));
        final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(j);
        boolean z = getIsAttached() && !Float.isNaN(fM9687constructorimpl) && Dp.m9686compareTo0680j_4(fM9687constructorimpl, Dp.m9687constructorimpl(f)) > 0;
        int i = Float.isNaN(fM9687constructorimpl) ? 0 : measureScope.mo748roundToPx0680j_4(fM9687constructorimpl);
        if (z) {
            width = Math.max(placeableMo8265measureBRTryo0.getWidth(), i);
        } else {
            width = placeableMo8265measureBRTryo0.getWidth();
        }
        if (z) {
            height = Math.max(placeableMo8265measureBRTryo0.getHeight(), i);
        } else {
            height = placeableMo8265measureBRTryo0.getHeight();
        }
        if (z) {
            updateAlignmentLines(i, placeableMo8265measureBRTryo0);
        }
        ...
        return measureScope.layout(width, height, mapEmptyMap, new Function1() { // from class: androidx.compose.material3.MinimumInteractiveModifierNode$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return MinimumInteractiveModifierNode.measure_3p2s80s$lambda$0(width, placeableMo8265measureBRTryo0, height, (Placeable.PlacementScope) obj);
            }
        });
    }
