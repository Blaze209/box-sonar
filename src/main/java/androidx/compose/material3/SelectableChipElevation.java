...
public final class SelectableChipElevation {
    ...
    public final State<Dp> shadowElevation$material3(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ComposerKt.sourceInformationMarkerStart(composer, -1888175651, "C(shadowElevation)N(enabled,interactionSource)2874@137153L74:Chip.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1888175651, i, -1, "androidx.compose.material3.SelectableChipElevation.shadowElevation (Chip.kt:2873)");
        }
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        float f;
        ComposerKt.sourceInformationMarkerStart(composer, 664514136, "C(animateElevation)N(enabled,interactionSource)2882@137403L46,2883@137481L47,2884@137571L1473,2884@137537L1507,2936@139599L51,2938@139683L515,2938@139660L538:Chip.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(664514136, i, -1, "androidx.compose.material3.SelectableChipElevation.animateElevation (Chip.kt:2881)");
        }
        ...
        if (objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
            Object animatable = new Animatable(Dp.m9685boximpl(f), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(dpM9685boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) objRememberedValue5, composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m9692equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m9692equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m9692equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m9692equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m9692equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m9693hashCodeimpl(this.elevation) * 31) + Dp.m9693hashCodeimpl(this.pressedElevation)) * 31) + Dp.m9693hashCodeimpl(this.focusedElevation)) * 31) + Dp.m9693hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m9693hashCodeimpl(this.disabledElevation);
    }
}
