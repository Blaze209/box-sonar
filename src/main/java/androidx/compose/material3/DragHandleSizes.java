...
public final class DragHandleSizes {
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m9782equalsimpl0(this.size, dragHandleSizes.size) && DpSize.m9782equalsimpl0(this.pressedSize, dragHandleSizes.pressedSize) && DpSize.m9782equalsimpl0(this.draggedSize, dragHandleSizes.draggedSize);
    }

    public int hashCode() {
        return (((DpSize.m9787hashCodeimpl(this.size) * 31) + DpSize.m9787hashCodeimpl(this.pressedSize)) * 31) + DpSize.m9787hashCodeimpl(this.draggedSize);
    }
}
