...
public final class TooltipAnchorPosition {
    ...
    private static final int Above = m4719constructorimpl(1);
    private static final int Below = m4719constructorimpl(2);
    private static final int Left = m4719constructorimpl(3);
    private static final int Right = m4719constructorimpl(4);
    private static final int Start = m4719constructorimpl(5);
    private static final int End = m4719constructorimpl(6);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TooltipAnchorPosition m4718boximpl(int i) {
        return new TooltipAnchorPosition(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m4719constructorimpl(int i) {
        return i;
    }
    ...
    public static String m4723toStringimpl(int i) {
        if (m4721equalsimpl0(i, Above)) {
            return "Above";
        }
        if (m4721equalsimpl0(i, Below)) {
            return "Below";
        }
        if (m4721equalsimpl0(i, Left)) {
            return "Left";
        }
        if (m4721equalsimpl0(i, Right)) {
            return "Right";
        }
        if (m4721equalsimpl0(i, Start)) {
            return DebugTraceUtil.EVENT_START;
        }
        return m4721equalsimpl0(i, End) ? "End" : "Invalid";
    }

    /* JADX INFO: compiled from: Tooltip.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u000e\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u0013\u0010\u0004\u001a\u00020\u0005¢\u0006\n\n\u0002\u0010\b\u001a\u0004\b\u0006\u0010\u0007R\u0013\u0010\t\u001a\u00020\u0005¢\u0006\n\n\u0002\u0010\b\u001a\u0004\b\n\u0010\u0007R\u0013\u0010\u000b\u001a\u00020\u0005¢\u0006\n\n\u0002\u0010\b\u001a\u0004\b\f\u0010\u0007R\u0013\u0010\r\u001a\u00020\u0005¢\u0006\n\n\u0002\u0010\b\u001a\u0004\b\u000e\u0010\u0007R\u0013\u0010\u000f\u001a\u00020\u0005¢\u0006\n\n\u0002\u0010\b\u001a\u0004\b\u0010\u0010\u0007R\u0013\u0010\u0011\u001a\u00020\u0005¢\u0006\n\n\u0002\u0010\b\u001a\u0004\b\u0012\u0010\u0007¨\u0006\u0013"}, d2 = {"Landroidx/compose/material3/TooltipAnchorPosition$Companion;", "", "<init>", "()V", "Above", "Landroidx/compose/material3/TooltipAnchorPosition;", "getAbove-lOKsHw4", "()I", "I", "Below", "getBelow-lOKsHw4", "Left", "getLeft-lOKsHw4", "Right", "getRight-lOKsHw4", DebugTraceUtil.EVENT_START, "getStart-lOKsHw4", "End", "getEnd-lOKsHw4", "material3"}, k = 1, mv = {2, 0, 0}, xi = 48)
