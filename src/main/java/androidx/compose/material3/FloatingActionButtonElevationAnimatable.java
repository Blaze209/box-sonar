...
final class FloatingActionButtonElevationAnimatable {
    ...
    @DebugMetadata(c = "androidx.compose.material3.FloatingActionButtonElevationAnimatable", f = "FloatingActionButton.kt", i = {0}, l = {1422}, m = "animateElevation", n = {TypedValues.TransitionType.S_TO}, s = {"L$0"}, v = 1)
    ...
    /* JADX INFO: compiled from: FloatingActionButton.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 48)
    @DebugMetadata(c = "androidx.compose.material3.FloatingActionButtonElevationAnimatable", f = "FloatingActionButton.kt", i = {}, l = {1408}, m = "snapElevation", n = {}, s = {}, v = 1)
    ...
    private FloatingActionButtonElevationAnimatable(float f, float f2, float f3, float f4) {
        ...
        this.animatable = new Animatable<>(Dp.m9685boximpl(this.defaultElevation), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
    }

    /* JADX INFO: renamed from: calculateTarget-u2uoSUM, reason: not valid java name */
    private final float m3379calculateTargetu2uoSUM(Interaction interaction) {
    ...
    public final Object m3380updateElevationlDy3nrA(float f, float f2, float f3, float f4, Continuation<? super Unit> continuation) {
        this.defaultElevation = f;
        this.pressedElevation = f2;
        this.hoveredElevation = f3;
        this.focusedElevation = f4;
    ...
    public final Object snapElevation(Continuation<? super Unit> continuation) {
        ...
        Object obj = c07201.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c07201.label;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                float fM3379calculateTargetu2uoSUM = m3379calculateTargetu2uoSUM(this.targetInteraction);
                if (!Dp.m9692equalsimpl0(this.animatable.getTargetValue().m9701unboximpl(), fM3379calculateTargetu2uoSUM)) {
                    Animatable<Dp, AnimationVector1D> animatable = this.animatable;
                    Dp dpM9685boximpl = Dp.m9685boximpl(fM3379calculateTargetu2uoSUM);
                    c07201.label = 1;
                    if (animatable.snapTo(dpM9685boximpl, c07201) == coroutine_suspended) {
    ...
    public final Object animateElevation(Interaction interaction, Continuation<? super Unit> continuation) {
        ...
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                float fM3379calculateTargetu2uoSUM = m3379calculateTargetu2uoSUM(interaction);
                ...
                if (!Dp.m9692equalsimpl0(this.animatable.getTargetValue().m9701unboximpl(), fM3379calculateTargetu2uoSUM)) {
                    ...
                    if (ElevationKt.m4981animateElevationrAjV9yQ(animatable, fM3379calculateTargetu2uoSUM, interaction2, interaction, anonymousClass1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
            } else {
