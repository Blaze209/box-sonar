...
public final class TypographyKt {
    ...
    public static final TextStyle getValue(TypographyKeyTokens typographyKeyTokens, Composer composer, int i) {
        ComposerKt.sourceInformationMarkerStart(composer, -1049072145, "C(<get-value>)556@30586L10:Typography.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1049072145, i, -1, "androidx.compose.material3.<get-value> (Typography.kt:556)");
        }
