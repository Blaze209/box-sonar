...
public final class SliderRange {
    ...
    public static final /* synthetic */ SliderRange m4250boximpl(long j) {
        return new SliderRange(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m4251constructorimpl(long j) {
        return j;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m4252equalsimpl(long j, Object obj) {
        return (obj instanceof SliderRange) && j == ((SliderRange) obj).m4258unboximpl();
    }
    ...
    public final /* synthetic */ long m4258unboximpl() {
    ...
    public static final float m4255getStartimpl(long j) {
        if (j == Unspecified) {
    ...
    public static final float m4254getEndInclusiveimpl(long j) {
        if (j == Unspecified) {
            throw new IllegalStateException("SliderRange is unspecified".toString());
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4259getUnspecifiedFYbKRX4$annotations() {
        }
        ...
        public final long m4260getUnspecifiedFYbKRX4() {
            return SliderRange.Unspecified;
        }
    }

    public String toString() {
        return m4257toStringimpl(this.packedValue);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m4257toStringimpl(long j) {
        if (SliderKt.m4242isSpecifiedIf1S1O4(j)) {
            return m4255getStartimpl(j) + ".." + m4254getEndInclusiveimpl(j);
        }
