...
public final class MotionSchemeKt {
    ...
    public static final <T> FiniteAnimationSpec<T> value(MotionSchemeKeyTokens motionSchemeKeyTokens, Composer composer, int i) {
        ComposerKt.sourceInformationMarkerStart(composer, -19828261, "C(value)298@11863L12:MotionScheme.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-19828261, i, -1, "androidx.compose.material3.value (MotionScheme.kt:298)");
        }
