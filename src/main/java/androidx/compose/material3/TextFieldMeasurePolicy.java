...
final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo344measure3p2s80s(final MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        final int i = measureScope.mo748roundToPx0680j_4(this.paddingValues.getTop());
        int i2 = measureScope.mo748roundToPx0680j_4(this.paddingValues.getBottom());
        ...
        int iMax = Math.max(0, LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo1));
        ...
        int iMax2 = Math.max(iMax, LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo0));
        ...
        int iMax3 = Math.max(iMax2, LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo2));
        ...
        int iMax4 = Math.max(iMax3, LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo3));
        ...
        if (!z) {
            objectRef.element = measurable12 != null ? measurable12.mo8265measureBRTryo0(ConstraintsKt.m9659offsetNN6EwU(j2, -widthOrZero4, -i2)) : 0;
        ...
        int heightOrZero = i + LayoutUtilKt.getHeightOrZero((Placeable) objectRef.element) + iMinIntrinsicHeight;
        long jM9659offsetNN6EwU = ConstraintsKt.m9659offsetNN6EwU(Constraints.m9630copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null), -widthOrZero4, ((-heightOrZero) - i2) - iMinIntrinsicHeight2);
        ...
        while (i9 < size7) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable14), "TextField")) {
                final Placeable placeableMo8265measureBRTryo4 = measurable14.mo8265measureBRTryo0(jM9659offsetNN6EwU);
                long jM9630copyZbe2FdA$default2 = Constraints.m9630copyZbe2FdA$default(jM9659offsetNN6EwU, 0, 0, 0, 0, 14, null);
                ...
                Placeable placeableMo8265measureBRTryo5 = measurable15 != null ? measurable15.mo8265measureBRTryo0(jM9630copyZbe2FdA$default2) : null;
                int iMax5 = Math.max(iMax4, Math.max(LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo4), LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo5)) + i11 + i2);
                long j3 = j2;
                boolean z2 = z;
                final Placeable placeable = placeableMo8265measureBRTryo3;
                Ref.ObjectRef objectRef2 = objectRef;
                final int iM4486calculateWidthyeHjK3Y = m4486calculateWidthyeHjK3Y(LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo1), LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo0), LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo2), LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo3), placeableMo8265measureBRTryo4.getWidth(), LayoutUtilKt.getWidthOrZero((Placeable) objectRef.element), LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo5), j);
                if (z2) {
                    objectRef2.element = measurable12 != null ? measurable12.mo8265measureBRTryo0(Constraints.m9630copyZbe2FdA$default(j3, 0, iM4486calculateWidthyeHjK3Y, 0, iMinIntrinsicHeight, 5, null)) : 0;
                }
                final Placeable placeableMo8265measureBRTryo6 = measurable13 != null ? measurable13.mo8265measureBRTryo0(Constraints.m9630copyZbe2FdA$default(ConstraintsKt.m9660offsetNN6EwU$default(j3, 0, -iMax5, 1, null), 0, iM4486calculateWidthyeHjK3Y, 0, 0, 9, null)) : null;
                int heightOrZero2 = LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo6);
                boolean z3 = z2;
                int iM4485calculateHeightmKXJcVc = m4485calculateHeightmKXJcVc(measureScope, placeableMo8265measureBRTryo4.getHeight(), LayoutUtilKt.getHeightOrZero((Placeable) objectRef2.element), LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo1), LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo0), LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo2), LayoutUtilKt.getHeightOrZero(placeable), LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo5), LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo6), j, z3, fInvoke);
                final int heightOrZero3 = (iM4485calculateHeightmKXJcVc - heightOrZero2) - (z3 ? LayoutUtilKt.getHeightOrZero((Placeable) objectRef2.element) : 0);
                ...
                while (i14 < size9) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable16), TextFieldImplKt.ContainerId)) {
                        final Placeable placeableMo8265measureBRTryo7 = measurable16.mo8265measureBRTryo0(ConstraintsKt.Constraints(iM4486calculateWidthyeHjK3Y != Integer.MAX_VALUE ? iM4486calculateWidthyeHjK3Y : 0, iM4486calculateWidthyeHjK3Y, heightOrZero3 != Integer.MAX_VALUE ? heightOrZero3 : 0, heightOrZero3));
                        final int i15 = iM4485calculateHeightmKXJcVc;
                        final boolean z4 = z3;
                        final Ref.ObjectRef objectRef3 = objectRef2;
                        final Placeable placeable2 = placeableMo8265measureBRTryo1;
                        final Placeable placeable3 = placeableMo8265measureBRTryo0;
                        final Placeable placeable4 = placeableMo8265measureBRTryo5;
                        final Placeable placeable5 = placeableMo8265measureBRTryo2;
                        return MeasureScope.layout$default(measureScope, iM4486calculateWidthyeHjK3Y, i15, null, new Function1() { // from class: androidx.compose.material3.TextFieldMeasurePolicy$$ExternalSyntheticLambda2
                            @Override // kotlin.jvm.functions.Function1
                            public final Object invoke(Object obj) {
                                return TextFieldMeasurePolicy.measure_3p2s80s$lambda$9(objectRef3, z4, this, heightOrZero3, i, measureScope, iM4486calculateWidthyeHjK3Y, i15, placeableMo8265measureBRTryo4, placeable4, placeable2, placeable3, placeable5, placeable, placeableMo8265measureBRTryo7, placeableMo8265measureBRTryo6, fInvoke, (Placeable.PlacementScope) obj);
                            }
                        }, 4, null);
                    }
                    i14++;
                    iM4485calculateHeightmKXJcVc = iM4485calculateHeightmKXJcVc;
                    z3 = z3;
            ...
            z = z;
            objectRef = objectRef;
            jM9659offsetNN6EwU = jM9659offsetNN6EwU;
        }
        ListUtilsKt.throwNoSuchElementException("Collection contains no element matching the predicate.");
        throw new KotlinNothingValueException();
    }
        ...
        if (objectRef.element != 0) {
            if (z) {
                ...
                if (textFieldMeasurePolicy.singleLine) {
                    ...
                    measureScope2 = measureScope;
                    iAlign = i2 + measureScope2.mo748roundToPx0680j_4(textFieldMeasurePolicy.minimizedLabelHalfHeight);
                }
                i5 = iAlign;
            }
    ...
    private final int m4486calculateWidthyeHjK3Y(int leadingWidth, int trailingWidth, int prefixWidth, int suffixWidth, int textFieldWidth, int labelWidth, int placeholderWidth, long constraints) {
        int i = prefixWidth + suffixWidth;
        return ConstraintsKt.m9657constrainWidthK40F9xA(constraints, leadingWidth + Math.max(textFieldWidth + i, Math.max(placeholderWidth + i, labelWidth)) + trailingWidth);
    }

    /* JADX INFO: renamed from: calculateHeight-mKXJcVc, reason: not valid java name */
    private final int m4485calculateHeightmKXJcVc(Density density, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, long j, boolean z, float f) {
        int iMo748roundToPx0680j_4 = density.mo748roundToPx0680j_4(Dp.m9687constructorimpl(this.paddingValues.getTop() + this.paddingValues.getBottom())) + ((i2 <= 0 || z) ? 0 : Math.max(density.mo748roundToPx0680j_4(Dp.m9687constructorimpl(this.minimizedLabelHalfHeight * 2)), MathHelpersKt.lerp(0, i2, MotionTokens.INSTANCE.getEasingEmphasizedAccelerateCubicBezier().transform(f)))) + ComparisonsKt.maxOf(i, i7, i5, i6, z ? 0 : MathHelpersKt.lerp(i2, 0, f));
        if (!z) {
            i2 = 0;
        }
        return ConstraintsKt.m9656constrainHeightK40F9xA(j, i2 + Math.max(i3, Math.max(i4, iMo748roundToPx0680j_4)) + i8);
    }
    ...
    private final void placeWithoutLabel(Placeable.PlacementScope placementScope, int i, int i2, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, Placeable placeable7, Placeable placeable8, float f) {
        Placeable.PlacementScope.m8331place70tqf50$default(placementScope, placeable7, IntOffset.INSTANCE.m9826getZeronOccac(), 0.0f, 2, null);
    ...
    private final int intrinsicWidth(List<? extends IntrinsicMeasurable> measurables, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> intrinsicMeasurer) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable7), "TextField")) {
                ...
                return m4486calculateWidthyeHjK3Y(iIntValue6, iIntValue3, iIntValue4, iIntValue5, iIntValue, iIntValue2, intrinsicMeasurable14 != null ? intrinsicMeasurer.invoke(intrinsicMeasurable14, Integer.valueOf(height)).intValue() : 0, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null));
            }
        }
        ListUtilsKt.throwNoSuchElementException("Collection contains no element matching the predicate.");
        throw new KotlinNothingValueException();
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        while (i9 < size6) {
            ...
            if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable13), "TextField")) {
                ...
                return m4485calculateHeightmKXJcVc(intrinsicMeasureScope, iIntValue6, iIntValue4, iIntValue, iIntValue2, i3, iIntValue3, iIntValue7, intrinsicMeasurable15 != null ? function2.invoke(intrinsicMeasurable15, Integer.valueOf(i2)).intValue() : 0, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.labelPosition instanceof TextFieldLabelPosition.Above, this.labelProgress.invoke());
            }
            i9++;
            list3 = list3;
        }
