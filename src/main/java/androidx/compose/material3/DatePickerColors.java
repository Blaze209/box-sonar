...
public final class DatePickerColors {
    ...
    public final State<Color> dayContentColor$material3(boolean z, boolean z2, boolean z3, boolean z4, Composer composer, int i) {
        long j;
        Composer composer2;
        State<Color> stateM437animateColorAsStateeuL9pac;
        ...
        if (z3) {
            ...
            stateM437animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m6804boximpl(j2), composer, 0);
            ...
            composer2 = composer;
            stateM437animateColorAsStateeuL9pac = SingleValueAnimationKt.m437animateColorAsStateeuL9pac(j2, MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultEffects, composer, 6), null, null, composer2, 0, 12);
        ...
        return stateM437animateColorAsStateeuL9pac;
    }
    ...
    public final State<Color> dayContainerColor$material3(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        if (z) {
            jM6849getTransparent0d7_KjU = z2 ? this.selectedDayContainerColor : this.disabledSelectedDayContainerColor;
        } else {
            jM6849getTransparent0d7_KjU = Color.INSTANCE.m6849getTransparent0d7_KjU();
        }
        long j = jM6849getTransparent0d7_KjU;
        if (z3) {
            composer.startReplaceGroup(-1319881536);
            ComposerKt.sourceInformation(composer, "1002@48304L7,999@48122L204");
            composer2 = composer;
            stateRememberUpdatedState = SingleValueAnimationKt.m437animateColorAsStateeuL9pac(j, MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultEffects, composer, 6), null, null, composer2, 0, 12);
            composer2.endReplaceGroup();
        } else {
            composer2 = composer;
            composer2.startReplaceGroup(-1319654864);
            ComposerKt.sourceInformation(composer2, "1005@48356L28");
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m6804boximpl(j), composer2, 0);
            composer2.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> yearContentColor$material3(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        State<Color> stateM437animateColorAsStateeuL9pac = SingleValueAnimationKt.m437animateColorAsStateeuL9pac(j, MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultEffects, composer, 6), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    public final State<Color> yearContainerColor$material3(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            jM6849getTransparent0d7_KjU = z2 ? this.selectedYearContainerColor : this.disabledSelectedYearContainerColor;
        } else {
            jM6849getTransparent0d7_KjU = Color.INSTANCE.m6849getTransparent0d7_KjU();
        }
        State<Color> stateM437animateColorAsStateeuL9pac = SingleValueAnimationKt.m437animateColorAsStateeuL9pac(jM6849getTransparent0d7_KjU, MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultEffects, composer, 6), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.containerColor, datePickerColors.containerColor) && Color.m6815equalsimpl0(this.titleContentColor, datePickerColors.titleContentColor) && Color.m6815equalsimpl0(this.headlineContentColor, datePickerColors.headlineContentColor) && Color.m6815equalsimpl0(this.weekdayContentColor, datePickerColors.weekdayContentColor) && Color.m6815equalsimpl0(this.subheadContentColor, datePickerColors.subheadContentColor) && Color.m6815equalsimpl0(this.yearContentColor, datePickerColors.yearContentColor) && Color.m6815equalsimpl0(this.disabledYearContentColor, datePickerColors.disabledYearContentColor) && Color.m6815equalsimpl0(this.currentYearContentColor, datePickerColors.currentYearContentColor) && Color.m6815equalsimpl0(this.selectedYearContentColor, datePickerColors.selectedYearContentColor) && Color.m6815equalsimpl0(this.disabledSelectedYearContentColor, datePickerColors.disabledSelectedYearContentColor) && Color.m6815equalsimpl0(this.selectedYearContainerColor, datePickerColors.selectedYearContainerColor) && Color.m6815equalsimpl0(this.disabledSelectedYearContainerColor, datePickerColors.disabledSelectedYearContainerColor) && Color.m6815equalsimpl0(this.dayContentColor, datePickerColors.dayContentColor) && Color.m6815equalsimpl0(this.disabledDayContentColor, datePickerColors.disabledDayContentColor) && Color.m6815equalsimpl0(this.selectedDayContentColor, datePickerColors.selectedDayContentColor) && Color.m6815equalsimpl0(this.disabledSelectedDayContentColor, datePickerColors.disabledSelectedDayContentColor) && Color.m6815equalsimpl0(this.selectedDayContainerColor, datePickerColors.selectedDayContainerColor) && Color.m6815equalsimpl0(this.disabledSelectedDayContainerColor, datePickerColors.disabledSelectedDayContainerColor) && Color.m6815equalsimpl0(this.todayContentColor, datePickerColors.todayContentColor) && Color.m6815equalsimpl0(this.todayDateBorderColor, datePickerColors.todayDateBorderColor) && Color.m6815equalsimpl0(this.dayInSelectionRangeContainerColor, datePickerColors.dayInSelectionRangeContainerColor) && Color.m6815equalsimpl0(this.dayInSelectionRangeContentColor, datePickerColors.dayInSelectionRangeContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((Color.m6821hashCodeimpl(this.containerColor) * 31) + Color.m6821hashCodeimpl(this.titleContentColor)) * 31) + Color.m6821hashCodeimpl(this.headlineContentColor)) * 31) + Color.m6821hashCodeimpl(this.weekdayContentColor)) * 31) + Color.m6821hashCodeimpl(this.subheadContentColor)) * 31) + Color.m6821hashCodeimpl(this.yearContentColor)) * 31) + Color.m6821hashCodeimpl(this.disabledYearContentColor)) * 31) + Color.m6821hashCodeimpl(this.currentYearContentColor)) * 31) + Color.m6821hashCodeimpl(this.selectedYearContentColor)) * 31) + Color.m6821hashCodeimpl(this.disabledSelectedYearContentColor)) * 31) + Color.m6821hashCodeimpl(this.selectedYearContainerColor)) * 31) + Color.m6821hashCodeimpl(this.disabledSelectedYearContainerColor)) * 31) + Color.m6821hashCodeimpl(this.dayContentColor)) * 31) + Color.m6821hashCodeimpl(this.disabledDayContentColor)) * 31) + Color.m6821hashCodeimpl(this.selectedDayContentColor)) * 31) + Color.m6821hashCodeimpl(this.disabledSelectedDayContentColor)) * 31) + Color.m6821hashCodeimpl(this.selectedDayContainerColor)) * 31) + Color.m6821hashCodeimpl(this.disabledSelectedDayContainerColor)) * 31) + Color.m6821hashCodeimpl(this.todayContentColor)) * 31) + Color.m6821hashCodeimpl(this.todayDateBorderColor)) * 31) + Color.m6821hashCodeimpl(this.dayInSelectionRangeContainerColor)) * 31) + Color.m6821hashCodeimpl(this.dayInSelectionRangeContentColor);
    }
}
