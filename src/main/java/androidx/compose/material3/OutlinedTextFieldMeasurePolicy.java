...
final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo344measure3p2s80s(final MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        long jM6647getZeroNHjbRc2;
        final float fInvoke = this.labelProgress.invoke();
        int i = measureScope.mo748roundToPx0680j_4(this.paddingValues.getBottom());
        ...
        Placeable placeableMo8265measureBRTryo1 = measurable8 != null ? measurable8.mo8265measureBRTryo0(jM9630copyZbe2FdA$default) : null;
        int widthOrZero = LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo1);
        int iMax2 = Math.max(0, LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo1));
        ...
        if (measurable9 != null) {
            j2 = jM9630copyZbe2FdA$default;
            placeableMo8265measureBRTryo0 = measurable9.mo8265measureBRTryo0(ConstraintsKt.m9660offsetNN6EwU$default(j2, -widthOrZero, 0, 2, null));
        } else {
            j2 = jM9630copyZbe2FdA$default;
            placeableMo8265measureBRTryo0 = null;
        }
        int widthOrZero2 = widthOrZero + LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo0);
        int iMax3 = Math.max(iMax2, LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo0));
        ...
        Placeable placeableMo8265measureBRTryo2 = measurable10 != null ? measurable10.mo8265measureBRTryo0(ConstraintsKt.m9660offsetNN6EwU$default(j2, -widthOrZero2, 0, 2, null)) : null;
        int widthOrZero3 = widthOrZero2 + LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo2);
        int iMax4 = Math.max(iMax3, LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo2));
        ...
        Placeable placeableMo8265measureBRTryo3 = measurable11 != null ? measurable11.mo8265measureBRTryo0(ConstraintsKt.m9660offsetNN6EwU$default(j2, -widthOrZero3, 0, 2, null)) : null;
        int widthOrZero4 = widthOrZero3 + LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo3);
        int iMax5 = Math.max(iMax4, LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo3));
        ...
        if (!z) {
            int i7 = measureScope.mo748roundToPx0680j_4(this.paddingValues.mo1163calculateLeftPaddingu2uoSUM(measureScope.getLayoutDirection())) + measureScope.mo748roundToPx0680j_4(this.paddingValues.mo1164calculateRightPaddingu2uoSUM(measureScope.getLayoutDirection()));
            objectRef.element = measurable12 != null ? measurable12.mo8265measureBRTryo0(ConstraintsKt.m9659offsetNN6EwU(j2, -MathHelpersKt.lerp(widthOrZero4 + i7, i7, fInvoke), -i)) : 0;
            Placeable placeable = (Placeable) objectRef.element;
            if (placeable == null) {
                jM6647getZeroNHjbRc2 = Size.INSTANCE.m6647getZeroNHjbRc();
            } else {
                jM6647getZeroNHjbRc2 = Size.m6629constructorimpl((((long) Float.floatToRawIntBits(placeable.getWidth())) << 32) | (((long) Float.floatToRawIntBits(placeable.getHeight())) & 4294967295L));
            }
            this.onLabelMeasured.invoke(Size.m6626boximpl(jM6647getZeroNHjbRc2));
            iMinIntrinsicHeight = 0;
        } else {
            iMinIntrinsicHeight = measurable12 != null ? measurable12.minIntrinsicHeight(Constraints.m9642getMinWidthimpl(j)) : 0;
        }
        ...
        int iMinIntrinsicHeight2 = measurable13 != null ? measurable13.minIntrinsicHeight(Constraints.m9642getMinWidthimpl(j)) : 0;
        if (z) {
            measureScope2 = measureScope;
            iMax = measureScope2.mo748roundToPx0680j_4(this.paddingValues.getTop());
        } else {
            measureScope2 = measureScope;
            iMax = Math.max(LayoutUtilKt.getHeightOrZero((Placeable) objectRef.element) / 2, measureScope2.mo748roundToPx0680j_4(this.paddingValues.getTop()));
        }
        int i9 = (((-i) - iMax) - iMinIntrinsicHeight) - iMinIntrinsicHeight2;
        int i10 = i;
        long jM9630copyZbe2FdA$default2 = Constraints.m9630copyZbe2FdA$default(ConstraintsKt.m9659offsetNN6EwU(j, -widthOrZero4, i9), 0, 0, 0, 0, 11, null);
        ...
        while (i11 < size7) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable14), "TextField")) {
                final Placeable placeableMo8265measureBRTryo4 = measurable14.mo8265measureBRTryo0(jM9630copyZbe2FdA$default2);
                long jM9630copyZbe2FdA$default3 = Constraints.m9630copyZbe2FdA$default(jM9630copyZbe2FdA$default2, 0, 0, 0, 0, 14, null);
                ...
                Placeable placeableMo8265measureBRTryo5 = measurable15 != null ? measurable15.mo8265measureBRTryo0(jM9630copyZbe2FdA$default3) : null;
                int iMax6 = Math.max(iMax5, Math.max(LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo4), LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo5)) + iMax + i13);
                MeasureScope measureScope3 = measureScope2;
                long j3 = j2;
                Ref.ObjectRef objectRef2 = objectRef;
                final int iM3964calculateWidthIzADHW4 = m3964calculateWidthIzADHW4(measureScope3, LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo1), LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo0), LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo2), LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo3), placeableMo8265measureBRTryo4.getWidth(), LayoutUtilKt.getWidthOrZero((Placeable) objectRef.element), LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo5), j, fInvoke);
                if (z2) {
                    objectRef2.element = measurable12 != null ? measurable12.mo8265measureBRTryo0(Constraints.m9630copyZbe2FdA$default(j3, 0, iM3964calculateWidthIzADHW4, 0, iMinIntrinsicHeight, 5, null)) : 0;
                    Placeable placeable2 = (Placeable) objectRef2.element;
                    if (placeable2 == null) {
                        jM6647getZeroNHjbRc = Size.INSTANCE.m6647getZeroNHjbRc();
                    } else {
                        jM6647getZeroNHjbRc = Size.m6629constructorimpl((((long) Float.floatToRawIntBits(placeable2.getWidth())) << 32) | (((long) Float.floatToRawIntBits(placeable2.getHeight())) & 4294967295L));
                    }
                    this.onLabelMeasured.invoke(Size.m6626boximpl(jM6647getZeroNHjbRc));
                }
                Placeable placeableMo8265measureBRTryo6 = measurable13 != null ? measurable13.mo8265measureBRTryo0(Constraints.m9630copyZbe2FdA$default(ConstraintsKt.m9660offsetNN6EwU$default(j3, 0, -iMax6, 1, null), 0, iM3964calculateWidthIzADHW4, 0, 0, 9, null)) : null;
                int heightOrZero = LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo6);
                boolean z3 = z2;
                final int iM3963calculateHeightmKXJcVc = m3963calculateHeightmKXJcVc(measureScope3, LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo1), LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo0), LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo2), LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo3), placeableMo8265measureBRTryo4.getHeight(), LayoutUtilKt.getHeightOrZero((Placeable) objectRef2.element), LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo5), LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo6), j, z3, fInvoke);
                int heightOrZero2 = (iM3963calculateHeightmKXJcVc - heightOrZero) - (z3 ? LayoutUtilKt.getHeightOrZero((Placeable) objectRef2.element) : 0);
                int size9 = list2.size();
                int i16 = 0;
                while (i16 < size9) {
                    Measurable measurable16 = list.get(i16);
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable16), TextFieldImplKt.ContainerId)) {
                        final Placeable placeableMo8265measureBRTryo7 = measurable16.mo8265measureBRTryo0(ConstraintsKt.Constraints(iM3964calculateWidthIzADHW4 != Integer.MAX_VALUE ? iM3964calculateWidthIzADHW4 : 0, iM3964calculateWidthIzADHW4, heightOrZero2 != Integer.MAX_VALUE ? heightOrZero2 : 0, heightOrZero2));
                        final Ref.ObjectRef objectRef3 = objectRef2;
                        final Placeable placeable3 = placeableMo8265measureBRTryo0;
                        final Placeable placeable4 = placeableMo8265measureBRTryo2;
                        final Placeable placeable5 = placeableMo8265measureBRTryo3;
                        final Placeable placeable6 = placeableMo8265measureBRTryo5;
                        final boolean z4 = z3;
                        final Placeable placeable7 = placeableMo8265measureBRTryo6;
                        final Placeable placeable8 = placeableMo8265measureBRTryo1;
                        return MeasureScope.layout$default(measureScope, iM3964calculateWidthIzADHW4, iM3963calculateHeightmKXJcVc, null, new Function1() { // from class: androidx.compose.material3.OutlinedTextFieldMeasurePolicy$$ExternalSyntheticLambda2
                            @Override // kotlin.jvm.functions.Function1
                            public final Object invoke(Object obj) {
                                return OutlinedTextFieldMeasurePolicy.measure_3p2s80s$lambda$11(this.f$0, iM3963calculateHeightmKXJcVc, iM3964calculateWidthIzADHW4, placeable8, placeable3, placeable4, placeable5, placeableMo8265measureBRTryo4, objectRef3, placeable6, placeableMo8265measureBRTryo7, placeable7, measureScope, z4, fInvoke, (Placeable.PlacementScope) obj);
                            }
                        }, 4, null);
                    }
                    i16++;
                    iM3963calculateHeightmKXJcVc = iM3963calculateHeightmKXJcVc;
                    z3 = z3;
            ...
            measureScope2 = measureScope;
            j2 = j2;
            jM9630copyZbe2FdA$default2 = jM9630copyZbe2FdA$default2;
        }
        ListUtilsKt.throwNoSuchElementException("Collection contains no element matching the predicate.");
        throw new KotlinNothingValueException();
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        int iIntValue5 = intrinsicMeasurable10 != null ? function2.invoke(intrinsicMeasurable10, Integer.valueOf(MathHelpersKt.lerp(iSubtractConstraintSafely, i, fInvoke))).intValue() : 0;
        int size4 = list2.size();
        int i6 = 0;
        while (true) {
            if (i6 >= size4) {
        ...
        while (i8 < size6) {
            ...
            if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable13), "TextField")) {
                int iIntValue6 = function2.invoke(intrinsicMeasurable13, Integer.valueOf(iSubtractConstraintSafely)).intValue();
                int size7 = list2.size();
                int i9 = 0;
                while (true) {
                    if (i9 >= size7) {
                ...
                int iIntValue7 = intrinsicMeasurable14 != null ? function2.invoke(intrinsicMeasurable14, Integer.valueOf(iSubtractConstraintSafely)).intValue() : 0;
                int size8 = list2.size();
                int i10 = 0;
                while (true) {
                    if (i10 >= size8) {
                ...
                return outlinedTextFieldMeasurePolicy.m3963calculateHeightmKXJcVc(intrinsicMeasureScope, iIntValue, iIntValue2, iIntValue3, iIntValue4, i2, iIntValue5, iIntValue7, intrinsicMeasurable15 != null ? function2.invoke(intrinsicMeasurable15, Integer.valueOf(i)).intValue() : 0, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), outlinedTextFieldMeasurePolicy.labelPosition instanceof TextFieldLabelPosition.Above, fInvoke);
            }
            i8++;
    ...
    private final int m3964calculateWidthIzADHW4(Density density, int i, int i2, int i3, int i4, int i5, int i6, int i7, long j, float f) {
        int i8 = i3 + i4;
        return ConstraintsKt.m9657constrainWidthK40F9xA(j, Math.max(i + Math.max(i5 + i8, Math.max(i7 + i8, MathHelpersKt.lerp(i6, 0, f))) + i2, MathKt.roundToInt((i6 + density.mo754toPx0680j_4(Dp.m9687constructorimpl(this.paddingValues.mo1163calculateLeftPaddingu2uoSUM(LayoutDirection.Ltr) + this.paddingValues.mo1164calculateRightPaddingu2uoSUM(LayoutDirection.Ltr)))) * f)));
    }

    /* JADX INFO: renamed from: calculateHeight-mKXJcVc, reason: not valid java name */
    private final int m3963calculateHeightmKXJcVc(Density density, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, long j, boolean z, float f) {
        int iMaxOf = ComparisonsKt.maxOf(i5, i7, i3, i4, z ? 0 : MathHelpersKt.lerp(i6, 0, f));
        float fMo754toPx0680j_4 = density.mo754toPx0680j_4(this.paddingValues.getTop());
        if (!z) {
            fMo754toPx0680j_4 = MathHelpersKt.lerp(fMo754toPx0680j_4, Math.max(fMo754toPx0680j_4, i6 / 2.0f), f);
        }
        float fMo754toPx0680j_5 = fMo754toPx0680j_4 + iMaxOf + density.mo754toPx0680j_4(this.paddingValues.getBottom());
        if (!z) {
            i6 = 0;
        }
        return ConstraintsKt.m9656constrainHeightK40F9xA(j, i6 + Math.max(i, Math.max(i2, MathKt.roundToInt(fMo754toPx0680j_5))) + i8);
    }
    ...
    private final void place(Placeable.PlacementScope placementScope, int i, int i2, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, Placeable placeable7, Placeable placeable8, Placeable placeable9, float f, LayoutDirection layoutDirection, boolean z, float f2, float f3) {
        ...
        if (placeable6 != null) {
            ...
            if (z) {
                ...
                Placeable.PlacementScope.place$default(placementScope, placeable6, MathKt.roundToInt(MathHelpersKt.lerp(TextFieldImplKt.getExpandedAlignment(this.labelPosition).align(placeable6.getWidth(), i2 - MathKt.roundToInt(width + width2), layoutDirection) + (layoutDirection == LayoutDirection.Ltr ? width : width2), TextFieldImplKt.getMinimizedAlignment(this.labelPosition).align(placeable6.getWidth(), i2 - MathKt.roundToInt(fCalculateStartPadding + fCalculateEndPadding), layoutDirection) + (layoutDirection == LayoutDirection.Ltr ? fCalculateStartPadding : fCalculateEndPadding), f2)), iLerp, 0.0f, 4, null);
            }
        }
        if (placeable3 != null) {
            i3 = heightOrZero2;
    ...
    private final int intrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable7), "TextField")) {
                ...
                return m3964calculateWidthIzADHW4(intrinsicMeasureScope, iIntValue4, iIntValue3, iIntValue5, iIntValue6, iIntValue, iIntValue2, intrinsicMeasurable14 != null ? function2.invoke(intrinsicMeasurable14, Integer.valueOf(i)).intValue() : 0, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.labelProgress.invoke());
            }
        }
        ListUtilsKt.throwNoSuchElementException("Collection contains no element matching the predicate.");
        throw new KotlinNothingValueException();
