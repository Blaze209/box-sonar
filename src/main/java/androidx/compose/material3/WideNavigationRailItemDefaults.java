...
public final class WideNavigationRailItemDefaults {
    ...
    public final int m4835iconPositionFors8pcRp0(boolean railExpanded) {
        NavigationItemIconPosition.Companion companion = NavigationItemIconPosition.INSTANCE;
        return railExpanded ? companion.m3894getStartxw1Ddg() : companion.m3895getTopxw1Ddg();
    }

    public final NavigationItemColors colors(Composer composer, int i) {
        ComposerKt.sourceInformationMarkerStart(composer, 911821421, "C(colors)1063@50720L11:WideNavigationRail.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(911821421, i, -1, "androidx.compose.material3.WideNavigationRailItemDefaults.colors (WideNavigationRail.kt:1063)");
        }
    ...
    public final NavigationItemColors m4834colors69fazGs(long j, long j2, long j3, long j4, long j5, long j6, long j7, Composer composer, int i, int i2) {
        long j8;
        ...
        if ((i2 & 32) != 0) {
            long j10 = value4;
            jM6813copywmQWz5c$default = Color.m6813copywmQWz5c$default(j10, 0.38f, 0.0f, 0.0f, 0.0f, 14, null);
            j8 = j10;
        } else {
            j8 = value4;
            jM6813copywmQWz5c$default = j6;
        }
        if ((i2 & 64) != 0) {
            long j11 = value5;
            jM6813copywmQWz5c$default2 = Color.m6813copywmQWz5c$default(j11, 0.38f, 0.0f, 0.0f, 0.0f, 14, null);
            j9 = j11;
        } else {
            j9 = value5;
            jM6813copywmQWz5c$default2 = j7;
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1759081702, i, -1, "androidx.compose.material3.WideNavigationRailItemDefaults.colors (WideNavigationRail.kt:1088)");
        }
        NavigationItemColors navigationItemColorsM3877copy4JmcsL4 = getDefaultWideNavigationRailItemColors(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m3877copy4JmcsL4(value, value2, value3, j8, j9, jM6813copywmQWz5c$default, jM6813copywmQWz5c$default2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return navigationItemColorsM3877copy4JmcsL4;
    }
