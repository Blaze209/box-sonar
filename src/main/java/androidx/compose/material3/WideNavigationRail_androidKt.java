...
public final class WideNavigationRail_androidKt {
    ...
    public static final Unit ModalWideNavigationRailDialog$lambda$5(Function0 function0, ModalWideNavigationRailProperties modalWideNavigationRailProperties, Function1 function1, Function0 function2, RailPredictiveBackState railPredictiveBackState, Function2 function3, int i, Composer composer, int i2) {
    ...
    public static final void ModalWideNavigationRailDialog(Function0<Unit> function0, final ModalWideNavigationRailProperties modalWideNavigationRailProperties, final Function1<? super Float, Unit> function1, final Function0<Unit> function2, final RailPredictiveBackState railPredictiveBackState, final Function2<? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if (!composerStartRestartGroup.shouldExecute((74899 & i2) != 74898, i2 & 1)) {
            ...
            final State stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(function3, composerStartRestartGroup, (i2 >> 15) & 14);
            Object[] objArr = new Object[0];
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 263516512, "CC(remember):WideNavigationRail.android.kt#9igjgp");
            Object objRememberedValue = composerStartRestartGroup.rememberedValue();
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function0() { // from class: androidx.compose.material3.WideNavigationRail_androidKt$$ExternalSyntheticLambda1
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 263520215, "CC(remember):WideNavigationRail.android.kt#9igjgp");
            ...
            if (zChanged || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                ...
                i4 = 1;
                modalWideNavigationRailDialogWrapper.setContent(compositionContextRememberCompositionContext, ComposableLambdaKt.composableLambdaInstance(-406777160, true, new Function2() { // from class: androidx.compose.material3.WideNavigationRail_androidKt$$ExternalSyntheticLambda2
                    @Override // kotlin.jvm.functions.Function2
                    public final Object invoke(Object obj2, Object obj3) {
                        return WideNavigationRail_androidKt.ModalWideNavigationRailDialog$lambda$2$0$0(stateRememberUpdatedState, (Composer) obj2, ((Integer) obj3).intValue());
                    }
                }));
            ...
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 263541548, "CC(remember):WideNavigationRail.android.kt#9igjgp");
            ...
            if (zChangedInstance || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue3 = new Function1() { // from class: androidx.compose.material3.WideNavigationRail_androidKt$$ExternalSyntheticLambda3
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj2) {
                        return WideNavigationRail_androidKt.ModalWideNavigationRailDialog$lambda$3$0(modalWideNavigationRailDialogWrapper2, (DisposableEffectScope) obj2);
                    }
                };
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 263546274, "CC(remember):WideNavigationRail.android.kt#9igjgp");
            ...
            if (i6 != 0 || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue4 = new Function0() { // from class: androidx.compose.material3.WideNavigationRail_androidKt$$ExternalSyntheticLambda4
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return WideNavigationRail_androidKt.ModalWideNavigationRailDialog$lambda$4$0(modalWideNavigationRailDialogWrapper2, function4, modalWideNavigationRailProperties, layoutDirection);
                    }
                };
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.WideNavigationRail_androidKt$$ExternalSyntheticLambda5
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj2, Object obj3) {
                    return WideNavigationRail_androidKt.ModalWideNavigationRailDialog$lambda$5(function4, modalWideNavigationRailProperties, function1, function2, railPredictiveBackState, function3, i, (Composer) obj2, ((Integer) obj3).intValue());
                }
            });
        }
    }
    ...
    public static final Unit ModalWideNavigationRailDialog$lambda$2$0$0(State state, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 3) != 2, i & 1)) {
            ...
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function1() { // from class: androidx.compose.material3.WideNavigationRail_androidKt$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return WideNavigationRail_androidKt.ModalWideNavigationRailDialog$lambda$2$0$0$0$0((SemanticsPropertyReceiver) obj);
                    }
                };
