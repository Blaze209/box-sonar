...
public final class ChipElevation {
    ...
    public final State<Dp> shadowElevation$material3(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ComposerKt.sourceInformationMarkerStart(composer, 1881877139, "C(shadowElevation)N(enabled,interactionSource)2735@131955L74:Chip.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1881877139, i, -1, "androidx.compose.material3.ChipElevation.shadowElevation (Chip.kt:2734)");
        }
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        float f;
        ComposerKt.sourceInformationMarkerStart(composer, -2071499570, "C(animateElevation)N(enabled,interactionSource)2743@132205L46,2744@132283L47,2745@132373L1473,2745@132339L1507,2797@134401L51,2799@134485L515,2799@134462L538:Chip.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2071499570, i, -1, "androidx.compose.material3.ChipElevation.animateElevation (Chip.kt:2742)");
        }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m9692equalsimpl0(this.elevation, chipElevation.elevation) && Dp.m9692equalsimpl0(this.pressedElevation, chipElevation.pressedElevation) && Dp.m9692equalsimpl0(this.focusedElevation, chipElevation.focusedElevation) && Dp.m9692equalsimpl0(this.hoveredElevation, chipElevation.hoveredElevation) && Dp.m9692equalsimpl0(this.disabledElevation, chipElevation.disabledElevation);
    }
