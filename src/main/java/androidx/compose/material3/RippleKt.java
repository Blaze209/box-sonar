...
public final class RippleKt {
    ...
    public static /* synthetic */ IndicationNodeFactory m4031rippleH2RKhps$default(boolean z, float f, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        if ((i & 2) != 0) {
        ...
        return m4030rippleH2RKhps(z, f, j);
    }

    /* JADX INFO: renamed from: ripple-H2RKhps, reason: not valid java name */
    public static final IndicationNodeFactory m4030rippleH2RKhps(boolean z, float f, long j) {
    ...
    public static /* synthetic */ IndicationNodeFactory m4033ripplewH6b6FI$default(ColorProducer colorProducer, boolean z, float f, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        if ((i & 4) != 0) {
        ...
        return m4032ripplewH6b6FI(colorProducer, z, f);
    }

    /* JADX INFO: renamed from: ripple-wH6b6FI, reason: not valid java name */
    public static final IndicationNodeFactory m4032ripplewH6b6FI(ColorProducer colorProducer, boolean z, float f) {
