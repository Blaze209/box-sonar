...
public final class NavigationDrawerItemDefaults {
    ...
    private static final PaddingValues ItemPadding = PaddingKt.m1213PaddingValuesYgX7TsA$default(Dp.m9687constructorimpl(12), 0.0f, 2, null);

    private NavigationDrawerItemDefaults() {
    }

    /* JADX INFO: renamed from: colors-oq7We08, reason: not valid java name */
    public final NavigationDrawerItemColors m3849colorsoq7We08(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, Composer composer, int i, int i2) {
        ...
        long jM6849getTransparent0d7_KjU = (i2 & 2) != 0 ? Color.INSTANCE.m6849getTransparent0d7_KjU() : j2;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1574983348, i, -1, "androidx.compose.material3.NavigationDrawerItemDefaults.colors (NavigationDrawer.kt:1230)");
        }
        DefaultDrawerItemsColor defaultDrawerItemsColor = new DefaultDrawerItemsColor(value2, value3, value4, value5, value, jM6849getTransparent0d7_KjU, j9, j10, null);
        if (ComposerKt.isTraceInProgress()) {
