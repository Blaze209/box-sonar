...
final class TopIconOrIconOnlyMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo344measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), HubsObservability.HUB_ASSET_ICON)) {
                float f = 2;
                Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(ConstraintsKt.m9659offsetNN6EwU(jM9630copyZbe2FdA$default, -measureScope.mo748roundToPx0680j_4(Dp.m9687constructorimpl(this.indicatorHorizontalPadding * f)), -measureScope.mo748roundToPx0680j_4(Dp.m9687constructorimpl(this.indicatorVerticalPadding * f))));
                int width = placeableMo8265measureBRTryo0.getWidth() + measureScope.mo748roundToPx0680j_4(Dp.m9687constructorimpl(this.indicatorHorizontalPadding * f));
                int height = placeableMo8265measureBRTryo0.getHeight() + measureScope.mo748roundToPx0680j_4(Dp.m9687constructorimpl(this.indicatorVerticalPadding * f));
                ...
                while (i2 < size2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "indicatorRipple")) {
                        Placeable placeableMo8265measureBRTryo1 = measurable2.mo8265measureBRTryo0(ConstraintsKt.m9655constrainN9IONVI(jM9630copyZbe2FdA$default, Constraints.INSTANCE.m9650fixedJhjzzOo(width, height)));
                        int size3 = list2.size();
                        int i3 = 0;
                        while (i3 < size3) {
                            Measurable measurable3 = list.get(i3);
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "indicator")) {
                                Placeable placeableMo8265measureBRTryo2 = measurable3.mo8265measureBRTryo0(ConstraintsKt.m9655constrainN9IONVI(jM9630copyZbe2FdA$default, Constraints.INSTANCE.m9650fixedJhjzzOo(iRoundToInt, height)));
                                if (!this.hasLabel) {
                                    return NavigationItemKt.m3912placeIconX9ElhV4(measureScope, placeableMo8265measureBRTryo0, placeableMo8265measureBRTryo1, placeableMo8265measureBRTryo2, j);
                                }
                                ...
                                while (i4 < size4) {
                                    ...
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), "label")) {
                                        return NavigationItemKt.m3914placeLabelAndTopIconqoqLrGI(measureScope, measurable4.mo8265measureBRTryo0(ConstraintsKt.m9660offsetNN6EwU$default(jM9630copyZbe2FdA$default, 0, -(placeableMo8265measureBRTryo2.getHeight() + measureScope.mo748roundToPx0680j_4(this.indicatorToLabelVerticalPadding)), 1, null)), placeableMo8265measureBRTryo0, placeableMo8265measureBRTryo1, placeableMo8265measureBRTryo2, j, this.indicatorToLabelVerticalPadding, this.indicatorVerticalPadding, this.topIconItemVerticalPadding);
                                    }
                                    i4++;
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable2), HubsObservability.HUB_ASSET_ICON)) {
                ...
                float f = 2;
                return iMaxIntrinsicHeight + iMaxIntrinsicHeight2 + intrinsicMeasureScope.mo748roundToPx0680j_4(Dp.m9687constructorimpl(Dp.m9687constructorimpl(Dp.m9687constructorimpl(this.topIconItemVerticalPadding * f) + Dp.m9687constructorimpl(this.indicatorVerticalPadding * f)) + this.indicatorToLabelVerticalPadding));
            }
        }
        ListUtilsKt.throwNoSuchElementException("Collection contains no element matching the predicate.");
        throw new KotlinNothingValueException();
