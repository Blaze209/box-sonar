...
public final class CustomButtonGroupItem implements ButtonGroupItem {
    ...
    public void ButtonGroupContent(Composer composer, final int i) {
        int i2;
        Composer composerStartRestartGroup = composer.startRestartGroup(-2102125731);
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(ButtonGroupContent)1281@55073L20:ButtonGroup.kt#uh7d8r");
        if ((i & 6) == 0) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            this.buttonGroupContent.invoke(composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.CustomButtonGroupItem$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return CustomButtonGroupItem.ButtonGroupContent$lambda$0(this.f$0, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public void MenuContent(final ButtonGroupMenuState buttonGroupMenuState, Composer composer, final int i) {
        int i2;
        Composer composerStartRestartGroup = composer.startRestartGroup(945127568);
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(MenuContent)N(state)1286@55185L18:ButtonGroup.kt#uh7d8r");
        if ((i & 6) == 0) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            this.menuContent.invoke(buttonGroupMenuState, composerStartRestartGroup, Integer.valueOf(i2 & 14));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.CustomButtonGroupItem$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return CustomButtonGroupItem.MenuContent$lambda$0(this.f$0, buttonGroupMenuState, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
