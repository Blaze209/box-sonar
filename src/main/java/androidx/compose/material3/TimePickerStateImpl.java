...
final class TimePickerStateImpl implements TimePickerState {
    ...
    public TimePickerStateImpl(int i, int i2, boolean z) {
        ...
        this.is24hour = z;
        this.selection = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TimePickerSelectionMode.m4583boximpl(TimePickerSelectionMode.INSTANCE.m4590getHouryecRtBI()), null, 2, null);
    ...
    public int mo2728getSelectionyecRtBI() {
        return ((TimePickerSelectionMode) this.selection.getValue()).m4589unboximpl();
    }

    @Override // androidx.compose.material3.TimePickerState
    /* JADX INFO: renamed from: setSelection-6_8s6DQ */
    public void mo2730setSelection6_8s6DQ(int i) {
        this.selection.setValue(TimePickerSelectionMode.m4583boximpl(i));
    }
