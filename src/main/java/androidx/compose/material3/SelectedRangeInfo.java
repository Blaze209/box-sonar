...
public final class SelectedRangeInfo {
    ...
    public static final class Companion {
        ...
        public final SelectedRangeInfo calculateRangeInfo(CalendarMonth month, CalendarDate startDate, CalendarDate endDate) {
            ...
            return new SelectedRangeInfo(IntOffset.m9809constructorimpl((((long) (daysFromStartOfWeekToFirstOfMonth % 7)) << 32) | (((long) (daysFromStartOfWeekToFirstOfMonth / 7)) & 4294967295L)), IntOffset.m9809constructorimpl((((long) (daysFromStartOfWeekToFirstOfMonth2 / 7)) & 4294967295L) | (((long) (daysFromStartOfWeekToFirstOfMonth2 % 7)) << 32)), z, z2, null);
        }
    }
}
