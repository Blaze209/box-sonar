...
public final class SwipeToDismissBoxDefaults {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function1() { // from class: androidx.compose.material3.SwipeToDismissBoxDefaults$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj) {
                    return Float.valueOf(SwipeToDismissBoxDefaults._get_positionalThreshold_$lambda$0$0$0(density, ((Float) obj).floatValue()));
                }
            };
    ...
    public static final float _get_positionalThreshold_$lambda$0$0$0(Density density, float f) {
        return density.mo754toPx0680j_4(Dp.m9687constructorimpl(56));
    }
}
