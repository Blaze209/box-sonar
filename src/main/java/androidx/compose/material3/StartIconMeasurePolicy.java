            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), HubsObservability.HUB_ASSET_ICON)) {
                ...
                while (i2 < size2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "label")) {
                        Placeable placeableMo8265measureBRTryo1 = measurable2.mo8265measureBRTryo0(ConstraintsKt.m9660offsetNN6EwU$default(jM9630copyZbe2FdA$default, -(placeableMo8265measureBRTryo0.getWidth() + measureScope.mo748roundToPx0680j_4(this.startIconToLabelHorizontalPadding)), 0, 2, null));
                        float f = 2;
                        int width = placeableMo8265measureBRTryo0.getWidth() + placeableMo8265measureBRTryo1.getWidth() + measureScope.mo748roundToPx0680j_4(Dp.m9687constructorimpl(this.startIconToLabelHorizontalPadding + Dp.m9687constructorimpl(this.indicatorHorizontalPadding * f)));
                        int iMax = Math.max(placeableMo8265measureBRTryo0.getHeight(), placeableMo8265measureBRTryo1.getHeight()) + measureScope.mo748roundToPx0680j_4(Dp.m9687constructorimpl(this.indicatorVerticalPadding * f));
                        int iRoundToInt = MathKt.roundToInt(width * fFloatValue);
                        int size3 = list2.size();
                        for (int i3 = 0; i3 < size3; i3++) {
                            Measurable measurable3 = list.get(i3);
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "indicatorRipple")) {
                                Placeable placeableMo8265measureBRTryo2 = measurable3.mo8265measureBRTryo0(ConstraintsKt.m9655constrainN9IONVI(jM9630copyZbe2FdA$default, Constraints.INSTANCE.m9650fixedJhjzzOo(width, iMax)));
                                int size4 = list2.size();
                                int i4 = 0;
                                while (i4 < size4) {
                                    Measurable measurable4 = list.get(i4);
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), "indicator")) {
                                        return NavigationItemKt.m3913placeLabelAndStartIconnru01g4(measureScope, placeableMo8265measureBRTryo1, placeableMo8265measureBRTryo0, placeableMo8265measureBRTryo2, measurable4.mo8265measureBRTryo0(ConstraintsKt.m9655constrainN9IONVI(jM9630copyZbe2FdA$default, Constraints.INSTANCE.m9650fixedJhjzzOo(iRoundToInt, iMax))), j, this.startIconToLabelHorizontalPadding);
                                    }
                                    i4++;
            ...
            if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable), HubsObservability.HUB_ASSET_ICON)) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    ...
                    if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable2), "label")) {
                        return iMaxIntrinsicWidth + intrinsicMeasurable2.maxIntrinsicWidth(i) + intrinsicMeasureScope.mo748roundToPx0680j_4(Dp.m9687constructorimpl(Dp.m9687constructorimpl(this.indicatorHorizontalPadding * 2) + this.startIconToLabelHorizontalPadding));
                    }
                }
                ListUtilsKt.throwNoSuchElementException("Collection contains no element matching the predicate.");
                throw new KotlinNothingValueException();
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable), HubsObservability.HUB_ASSET_ICON)) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    IntrinsicMeasurable intrinsicMeasurable2 = list.get(i3);
                    if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable2), "label")) {
                        return Math.max(iMaxIntrinsicHeight, intrinsicMeasurable2.maxIntrinsicHeight(i)) + intrinsicMeasureScope.mo748roundToPx0680j_4(Dp.m9687constructorimpl(this.indicatorVerticalPadding * 2));
                    }
                }
                ListUtilsKt.throwNoSuchElementException("Collection contains no element matching the predicate.");
                throw new KotlinNothingValueException();
