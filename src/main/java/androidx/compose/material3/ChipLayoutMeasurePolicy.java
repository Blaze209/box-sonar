...
final class ChipLayoutMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo344measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        final Placeable placeableMo8265measureBRTryo0 = measurable3 != null ? measurable3.mo8265measureBRTryo0(Constraints.m9630copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null)) : null;
        final int widthOrZero = LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo0);
        final int heightOrZero = LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo0);
        ...
        Placeable placeableMo8265measureBRTryo1 = measurable4 != null ? measurable4.mo8265measureBRTryo0(Constraints.m9630copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null)) : null;
        int widthOrZero2 = LayoutUtilKt.getWidthOrZero(placeableMo8265measureBRTryo1);
        final int heightOrZero2 = LayoutUtilKt.getHeightOrZero(placeableMo8265measureBRTryo1);
        int size3 = list2.size();
        for (int i3 = 0; i3 < size3; i3++) {
            Measurable measurable5 = list.get(i3);
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable5), "label")) {
                final Placeable placeableMo8265measureBRTryo2 = measurable5.mo8265measureBRTryo0(ConstraintsKt.m9660offsetNN6EwU$default(j, -(widthOrZero + widthOrZero2), 0, 2, null));
                int width = placeableMo8265measureBRTryo2.getWidth() + widthOrZero + widthOrZero2;
                final int iMax = Math.max(heightOrZero, Math.max(placeableMo8265measureBRTryo2.getHeight(), heightOrZero2));
                ...
                return MeasureScope.layout$default(measureScope, width, iMax, null, new Function1() { // from class: androidx.compose.material3.ChipLayoutMeasurePolicy$$ExternalSyntheticLambda0
                    ...
                    public final Object invoke(Object obj) {
                        return ChipLayoutMeasurePolicy.measure_3p2s80s$lambda$3(placeableMo8265measureBRTryo0, heightOrZero, iMax, placeableMo8265measureBRTryo2, widthOrZero, placeable, heightOrZero2, (Placeable.PlacementScope) obj);
                    }
                }, 4, null);
            }
        }
