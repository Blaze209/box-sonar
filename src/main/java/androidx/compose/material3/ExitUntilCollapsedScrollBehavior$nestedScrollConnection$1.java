...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo946onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        if (Float.intBitsToFloat(i2) < 0.0f || Float.intBitsToFloat(i) < 0.0f) {
            ...
            return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(0.0f)) << 32) | (((long) Float.floatToRawIntBits(heightOffset2)) & 4294967295L));
        }
        if (Float.intBitsToFloat(i2) > 0.0f) {
            ...
            return Offset.m6561constructorimpl((((long) Float.floatToRawIntBits(0.0f)) << 32) | (((long) Float.floatToRawIntBits(heightOffset4)) & 4294967295L));
        }
        return Offset.INSTANCE.m6585getZeroF1C5BW0();
    }
    ...
    public Object mo945onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        ...
        Object objMo945onPostFlingRZ2iAVY = exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$2.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$2.label;
        if (i == 0) {
            ...
            objMo945onPostFlingRZ2iAVY = super.mo945onPostFlingRZ2iAVY(j, j2, exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$2);
        ...
        objMo945onPostFlingRZ2iAVY = AppBarKt.settleAppBar(state, fM9926getYimpl, flingAnimationSpec, snapAnimationSpec, exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$2);
        if (objMo945onPostFlingRZ2iAVY != coroutine_suspended) {
            j3 = packedValue;
            return Velocity.m9916boximpl(Velocity.m9929plusAH228Gc(j3, ((Velocity) objMo945onPostFlingRZ2iAVY).getPackedValue()));
        }
