...
public final class ShortNavigationBarArrangement {
    ...
    private static final int EqualWeight = m4164constructorimpl(0);
    private static final int Centered = m4164constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ShortNavigationBarArrangement m4163boximpl(int i) {
        return new ShortNavigationBarArrangement(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m4164constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object other) {
        return m4165equalsimpl(this.value, other);
    }
    ...
    public static String m4168toStringimpl(int i) {
        if (m4166equalsimpl0(i, EqualWeight)) {
            return "EqualWeight";
        }
        return m4166equalsimpl0(i, Centered) ? "Centered" : "Unknown";
    }
}
