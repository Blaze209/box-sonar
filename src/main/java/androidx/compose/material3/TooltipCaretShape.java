...
final class TooltipCaretShape implements Shape {
    ...
    public Outline mo655createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        Outline outlineMo655createOutlinePq9zytI = this.tooltipShape.mo655createOutlinePq9zytI(size, layoutDirection, density);
        Outline outlineMo655createOutlinePq9zytI2 = this.caretShape.mo655createOutlinePq9zytI(size, layoutDirection, density);
        if (outlineMo655createOutlinePq9zytI instanceof Outline.Generic) {
            Path.m7100addPathUv8p0NA$default(this.tooltipPath, ((Outline.Generic) outlineMo655createOutlinePq9zytI).getPath(), 0L, 2, null);
        } else if (outlineMo655createOutlinePq9zytI instanceof Outline.Rounded) {
            Path.addRoundRect$default(this.tooltipPath, ((Outline.Rounded) outlineMo655createOutlinePq9zytI).getRoundRect(), null, 2, null);
        } else {
            if (!(outlineMo655createOutlinePq9zytI instanceof Outline.Rectangle)) {
                throw new NoWhenBranchMatchedException();
            }
            Path.addRect$default(this.tooltipPath, ((Outline.Rectangle) outlineMo655createOutlinePq9zytI).getRect(), null, 2, null);
        }
        if (outlineMo655createOutlinePq9zytI2 instanceof Outline.Generic) {
            Path.m7100addPathUv8p0NA$default(this.caretPath, ((Outline.Generic) outlineMo655createOutlinePq9zytI2).getPath(), 0L, 2, null);
        } else if (outlineMo655createOutlinePq9zytI2 instanceof Outline.Rounded) {
            Path.addRoundRect$default(this.caretPath, ((Outline.Rounded) outlineMo655createOutlinePq9zytI2).getRoundRect(), null, 2, null);
        } else {
            if (!(outlineMo655createOutlinePq9zytI2 instanceof Outline.Rectangle)) {
                throw new NoWhenBranchMatchedException();
            }
            Path.addRect$default(this.caretPath, ((Outline.Rectangle) outlineMo655createOutlinePq9zytI2).getRect(), null, 2, null);
        }
        this.caretPath.mo6705transform58bKbWc(this.transformationMatrix.getValue().m7083unboximpl());
        this.combinedPath.mo6703opN5in7k0(this.tooltipPath, this.caretPath, PathOperation.INSTANCE.m7125getUnionb3I0S0c());
