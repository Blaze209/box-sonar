...
public final class VerticalDragHandleDefaults {
    ...
    private static final DragHandleSizes sizes = new DragHandleSizes(DpKt.m9709DpSizeYgX7TsA(DragHandleTokens.INSTANCE.m5350getWidthD9Ej5fM(), DragHandleTokens.INSTANCE.m5346getHeightD9Ej5fM()), DpKt.m9709DpSizeYgX7TsA(DragHandleTokens.INSTANCE.m5349getPressedWidthD9Ej5fM(), DragHandleTokens.INSTANCE.m5348getPressedHeightD9Ej5fM()), DpKt.m9709DpSizeYgX7TsA(DragHandleTokens.INSTANCE.m5344getDraggedWidthD9Ej5fM(), DragHandleTokens.INSTANCE.m5343getDraggedHeightD9Ej5fM()), null);
    ...
    public final DragHandleColors m4796colorsRGew2ao(long j, long j2, long j3, Composer composer, int i, int i2) {
        ...
        DragHandleColors colors = getColors(MaterialTheme.INSTANCE.getColorScheme(composer, 6));
        if (jM6850getUnspecified0d7_KjU == 16) {
            jM6850getUnspecified0d7_KjU = colors.getColor();
        }
        long j4 = jM6850getUnspecified0d7_KjU;
        if (jM6850getUnspecified0d7_KjU2 == 16) {
            jM6850getUnspecified0d7_KjU2 = colors.getPressedColor();
        }
        long j5 = jM6850getUnspecified0d7_KjU2;
        if (jM6850getUnspecified0d7_KjU3 == 16) {
            jM6850getUnspecified0d7_KjU3 = colors.getDraggedColor();
        }
        DragHandleColors dragHandleColors = new DragHandleColors(j4, j5, jM6850getUnspecified0d7_KjU3, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public static /* synthetic */ DragHandleSizes m4795sizesL9TjZb0$default(VerticalDragHandleDefaults verticalDragHandleDefaults, long j, long j2, long j3, int i, Object obj) {
        if ((i & 1) != 0) {
            j = DpSize.INSTANCE.m9794getUnspecifiedMYxV2XQ();
        }
        long j4 = j;
        if ((i & 2) != 0) {
            j2 = DpSize.INSTANCE.m9794getUnspecifiedMYxV2XQ();
        }
        long j5 = j2;
        if ((i & 4) != 0) {
            j3 = DpSize.INSTANCE.m9794getUnspecifiedMYxV2XQ();
        }
        return verticalDragHandleDefaults.m4797sizesL9TjZb0(j4, j5, j3);
    }

    /* JADX INFO: renamed from: sizes-L9TjZb0, reason: not valid java name */
    public final DragHandleSizes m4797sizesL9TjZb0(long size, long pressedSize, long draggedSize) {
