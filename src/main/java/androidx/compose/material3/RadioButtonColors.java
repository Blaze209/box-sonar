...
public final class RadioButtonColors {
    ...
    public static /* synthetic */ RadioButtonColors m4012copyjRlVdoo$default(RadioButtonColors radioButtonColors, long j, long j2, long j3, long j4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return radioButtonColors.m4013copyjRlVdoo(j5, j6, j3, (i & 8) != 0 ? radioButtonColors.disabledUnselectedColor : j4);
    }

    /* JADX INFO: renamed from: copy-jRlVdoo, reason: not valid java name */
    public final RadioButtonColors m4013copyjRlVdoo(long selectedColor, long unselectedColor, long disabledSelectedColor, long disabledUnselectedColor) {
    ...
    public final State<Color> radioColor$material3(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            ...
            composer2 = composer;
            stateRememberUpdatedState = SingleValueAnimationKt.m437animateColorAsStateeuL9pac(j2, MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultEffects, composer, 6), null, null, composer2, 0, 12);
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m6815equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m6815equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m6815equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return (((((Color.m6821hashCodeimpl(this.selectedColor) * 31) + Color.m6821hashCodeimpl(this.unselectedColor)) * 31) + Color.m6821hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m6821hashCodeimpl(this.disabledUnselectedColor);
    }
}
