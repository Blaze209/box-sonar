...
public final class SearchBarColors {
    ...
    public static /* synthetic */ SearchBarColors m4040copyjxsXWHM$default(SearchBarColors searchBarColors, long j, long j2, TextFieldColors textFieldColors, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return searchBarColors.m4041copyjxsXWHM(j3, j4, textFieldColors);
    }

    /* JADX INFO: renamed from: copy-jxsXWHM, reason: not valid java name */
    public final SearchBarColors m4041copyjxsXWHM(long containerColor, long dividerColor, TextFieldColors inputFieldColors) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.containerColor, searchBarColors.containerColor) && Color.m6815equalsimpl0(this.dividerColor, searchBarColors.dividerColor) && Intrinsics.areEqual(this.inputFieldColors, searchBarColors.inputFieldColors);
    }

    public int hashCode() {
        return (((Color.m6821hashCodeimpl(this.containerColor) * 31) + Color.m6821hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
