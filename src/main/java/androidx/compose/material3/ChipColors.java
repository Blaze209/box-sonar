...
public final class ChipColors {
    ...
    public static /* synthetic */ ChipColors m2937copyFD3wquc$default(ChipColors chipColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, int i, Object obj) {
        long j9;
        long j10;
        ...
        return chipColors.m2939copyFD3wquc(j10, j12, j13, j14, j15, j16, j17, j9);
    }

    /* JADX INFO: renamed from: copy-FD3wquc, reason: not valid java name */
    public final ChipColors m2939copyFD3wquc(long containerColor, long labelColor, long leadingIconContentColor, long trailingIconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconContentColor, long disabledTrailingIconContentColor) {
    ...
    public final long m2938containerColorvNxB06k$material3(boolean enabled) {
    ...
    public final long m2948labelColorvNxB06k$material3(boolean enabled) {
    ...
    public final long m2949leadingIconContentColorvNxB06k$material3(boolean enabled) {
    ...
    public final long m2950trailingIconContentColorvNxB06k$material3(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.containerColor, chipColors.containerColor) && Color.m6815equalsimpl0(this.labelColor, chipColors.labelColor) && Color.m6815equalsimpl0(this.leadingIconContentColor, chipColors.leadingIconContentColor) && Color.m6815equalsimpl0(this.trailingIconContentColor, chipColors.trailingIconContentColor) && Color.m6815equalsimpl0(this.disabledContainerColor, chipColors.disabledContainerColor) && Color.m6815equalsimpl0(this.disabledLabelColor, chipColors.disabledLabelColor) && Color.m6815equalsimpl0(this.disabledLeadingIconContentColor, chipColors.disabledLeadingIconContentColor) && Color.m6815equalsimpl0(this.disabledTrailingIconContentColor, chipColors.disabledTrailingIconContentColor);
    }

    public int hashCode() {
        return (((((((((((((Color.m6821hashCodeimpl(this.containerColor) * 31) + Color.m6821hashCodeimpl(this.labelColor)) * 31) + Color.m6821hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m6821hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m6821hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m6821hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m6821hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m6821hashCodeimpl(this.disabledTrailingIconContentColor);
    }
}
