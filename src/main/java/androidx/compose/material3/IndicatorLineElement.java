...
public final /* data */ class IndicatorLineElement extends ModifierNodeElement<IndicatorLineNode> {
    ...
    public static /* synthetic */ IndicatorLineElement m3588copygv0btCI$default(IndicatorLineElement indicatorLineElement, boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, Shape shape, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return indicatorLineElement.m3591copygv0btCI(z, z2, interactionSource2, textFieldColors, shape2, f3, f4);
    }
    ...
    public final IndicatorLineElement m3591copygv0btCI(boolean enabled, boolean isError, InteractionSource interactionSource, TextFieldColors colors, Shape textFieldShape, float focusedIndicatorLineThickness, float unfocusedIndicatorLineThickness) {
    ...
    public int hashCode() {
        ...
        return ((((iHashCode2 + (shape != null ? shape.hashCode() : 0)) * 31) + Dp.m9693hashCodeimpl(this.focusedIndicatorLineThickness)) * 31) + Dp.m9693hashCodeimpl(this.unfocusedIndicatorLineThickness);
    }

    public String toString() {
        return "IndicatorLineElement(enabled=" + this.enabled + ", isError=" + this.isError + ", interactionSource=" + this.interactionSource + ", colors=" + this.colors + ", textFieldShape=" + this.textFieldShape + ", focusedIndicatorLineThickness=" + ((Object) Dp.m9698toStringimpl(this.focusedIndicatorLineThickness)) + ", unfocusedIndicatorLineThickness=" + ((Object) Dp.m9698toStringimpl(this.unfocusedIndicatorLineThickness)) + ')';
    }
    ...
    public final float m3592getFocusedIndicatorLineThicknessD9Ej5fM() {
        return this.focusedIndicatorLineThickness;
    }

    /* JADX INFO: renamed from: getUnfocusedIndicatorLineThickness-D9Ej5fM, reason: not valid java name */
    public final float m3593getUnfocusedIndicatorLineThicknessD9Ej5fM() {
        return this.unfocusedIndicatorLineThickness;
    }
    ...
    public void update(IndicatorLineNode node) {
        node.m3595updategv0btCI(this.enabled, this.isError, this.interactionSource, this.colors, this.textFieldShape, this.focusedIndicatorLineThickness, this.unfocusedIndicatorLineThickness);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("focusedIndicatorLineThickness", Dp.m9685boximpl(this.focusedIndicatorLineThickness));
        inspectorInfo.getProperties().set("unfocusedIndicatorLineThickness", Dp.m9685boximpl(this.unfocusedIndicatorLineThickness));
    }
}
