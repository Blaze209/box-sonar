...
public final class CardElevation {
    ...
    public final State<Dp> shadowElevation$material3(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (interactionSource == null) {
            ...
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m9685boximpl(this.defaultElevation), null, 2, null);
        ...
        composer.startReplaceGroup(138113847);
        composer.endReplaceGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m9692equalsimpl0(this.defaultElevation, cardElevation.defaultElevation) && Dp.m9692equalsimpl0(this.pressedElevation, cardElevation.pressedElevation) && Dp.m9692equalsimpl0(this.focusedElevation, cardElevation.focusedElevation) && Dp.m9692equalsimpl0(this.hoveredElevation, cardElevation.hoveredElevation) && Dp.m9692equalsimpl0(this.disabledElevation, cardElevation.disabledElevation);
    }
