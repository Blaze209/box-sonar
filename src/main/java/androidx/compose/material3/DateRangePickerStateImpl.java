...
final class DateRangePickerStateImpl extends BaseDatePickerStateImpl implements DateRangePickerState {
    ...
    private DateRangePickerStateImpl(Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates, Locale locale) {
        ...
        setSelection(l, l2);
        this._displayMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DisplayMode.m3269boximpl(i), null, 2, null);
    }
    ...
    public void mo3233setDisplayModevCnGnXg(int i) {
        ...
        this._displayMode.setValue(DisplayMode.m3269boximpl(i));
    }
    ...
    public static final class Companion {
        ...
        public static final List Saver$lambda$0(SaverScope saverScope, DateRangePickerStateImpl dateRangePickerStateImpl) {
            return CollectionsKt.listOf(dateRangePickerStateImpl.getSelectedStartDateMillis(), dateRangePickerStateImpl.getSelectedEndDateMillis(), Long.valueOf(dateRangePickerStateImpl.getDisplayedMonthMillis()), Integer.valueOf(dateRangePickerStateImpl.getYearRange().getFirst()), Integer.valueOf(dateRangePickerStateImpl.getYearRange().getLast()), Integer.valueOf(dateRangePickerStateImpl.mo3232getDisplayModejFl4v0()));
        }
        ...
        public static final DateRangePickerStateImpl Saver$lambda$1(SelectableDates selectableDates, Locale locale, List list) {
            ...
            return new DateRangePickerStateImpl(l, l2, l3, intRange, DisplayMode.m3270constructorimpl(((Integer) obj3).intValue()), selectableDates, locale, null);
        }
    }
}
