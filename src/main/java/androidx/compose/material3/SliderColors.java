...
public final class SliderColors {
    ...
    public static /* synthetic */ SliderColors m4180copyK518z4$default(SliderColors sliderColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, int i, Object obj) {
        long j11;
        long j12;
        ...
        return sliderColors.m4181copyK518z4(j20, j14, j15, j16, j17, j18, j19, j21, j12, j11);
    }

    /* JADX INFO: renamed from: copy--K518z4, reason: not valid java name */
    public final SliderColors m4181copyK518z4(long thumbColor, long activeTrackColor, long activeTickColor, long inactiveTrackColor, long inactiveTickColor, long disabledThumbColor, long disabledActiveTrackColor, long disabledActiveTickColor, long disabledInactiveTrackColor, long disabledInactiveTickColor) {
    ...
    public final long m4192thumbColorvNxB06k$material3(boolean enabled) {
    ...
    public final long m4194trackColorWaAFU9c$material3(boolean enabled, boolean active) {
        if (enabled) {
    ...
    public final long m4193tickColorWaAFU9c$material3(boolean enabled, boolean active) {
        if (enabled) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.thumbColor, sliderColors.thumbColor) && Color.m6815equalsimpl0(this.activeTrackColor, sliderColors.activeTrackColor) && Color.m6815equalsimpl0(this.activeTickColor, sliderColors.activeTickColor) && Color.m6815equalsimpl0(this.inactiveTrackColor, sliderColors.inactiveTrackColor) && Color.m6815equalsimpl0(this.inactiveTickColor, sliderColors.inactiveTickColor) && Color.m6815equalsimpl0(this.disabledThumbColor, sliderColors.disabledThumbColor) && Color.m6815equalsimpl0(this.disabledActiveTrackColor, sliderColors.disabledActiveTrackColor) && Color.m6815equalsimpl0(this.disabledActiveTickColor, sliderColors.disabledActiveTickColor) && Color.m6815equalsimpl0(this.disabledInactiveTrackColor, sliderColors.disabledInactiveTrackColor) && Color.m6815equalsimpl0(this.disabledInactiveTickColor, sliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m6821hashCodeimpl(this.thumbColor) * 31) + Color.m6821hashCodeimpl(this.activeTrackColor)) * 31) + Color.m6821hashCodeimpl(this.activeTickColor)) * 31) + Color.m6821hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m6821hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m6821hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m6821hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m6821hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m6821hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m6821hashCodeimpl(this.disabledInactiveTickColor);
    }
}
