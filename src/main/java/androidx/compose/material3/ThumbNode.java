...
final class ThumbNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo372measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        float thumbDiameter;
        boolean z = (measurable.maxIntrinsicHeight(Constraints.m9640getMaxWidthimpl(j)) == 0 || measurable.maxIntrinsicWidth(Constraints.m9639getMaxHeightimpl(j)) == 0) ? false : true;
        if (this.isPressed) {
            thumbDiameter = SwitchTokens.INSTANCE.m5833getPressedHandleWidthD9Ej5fM();
        } else if (z || this.checked) {
            thumbDiameter = SwitchKt.getThumbDiameter();
        } else {
            thumbDiameter = SwitchKt.getUncheckedThumbDiameter();
        }
        float f = measureScope.mo754toPx0680j_4(thumbDiameter);
        ...
        final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(Constraints.INSTANCE.m9650fixedJhjzzOo(iFloatValue, iFloatValue));
        final float f2 = measureScope.mo754toPx0680j_4(Dp.m9687constructorimpl(Dp.m9687constructorimpl(SwitchKt.SwitchHeight - measureScope.mo750toDpu2uoSUM(f)) / 2.0f));
        float f3 = measureScope.mo754toPx0680j_4(Dp.m9687constructorimpl(Dp.m9687constructorimpl(SwitchKt.SwitchWidth - SwitchKt.getThumbDiameter()) - SwitchKt.ThumbPadding));
        boolean z2 = this.isPressed;
        if (z2 && this.checked) {
            f2 = f3 - measureScope.mo754toPx0680j_4(SwitchTokens.INSTANCE.m5839getTrackOutlineWidthD9Ej5fM());
        } else if (z2 && !this.checked) {
            f2 = measureScope.mo754toPx0680j_4(SwitchTokens.INSTANCE.m5839getTrackOutlineWidthD9Ej5fM());
        ...
        return MeasureScope.layout$default(measureScope, iFloatValue, iFloatValue, null, new Function1() { // from class: androidx.compose.material3.ThumbNode$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return ThumbNode.measure_3p2s80s$lambda$0(placeableMo8265measureBRTryo0, this, f2, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
