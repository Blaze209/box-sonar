...
public final class TabIndicatorOffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo372measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (this.initialWidth != null) {
            ...
            if (!Dp.m9692equalsimpl0(width, animatable.getTargetValue().m9701unboximpl())) {
            ...
            this.initialWidth = Dp.m9685boximpl(width);
        }
        ...
        if (this.initialOffset != null) {
            ...
            if (!Dp.m9692equalsimpl0(left, animatable3.getTargetValue().m9701unboximpl())) {
            ...
            this.initialOffset = Dp.m9685boximpl(left);
        }
        if (measureScope.getLayoutDirection() == LayoutDirection.Ltr) {
            Animatable<Dp, AnimationVector1D> animatable5 = this.offsetAnimatable;
            if (animatable5 != null) {
                left = animatable5.getValue().m9701unboximpl();
            }
        } else {
            Animatable<Dp, AnimationVector1D> animatable6 = this.offsetAnimatable;
            if (animatable6 != null) {
                left = animatable6.getValue().m9701unboximpl();
            }
            left = Dp.m9687constructorimpl(-left);
        }
        Animatable<Dp, AnimationVector1D> animatable7 = this.widthAnimatable;
        if (animatable7 != null) {
            width = animatable7.getValue().m9701unboximpl();
        }
        final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(Constraints.m9630copyZbe2FdA$default(j, measureScope.mo748roundToPx0680j_4(width), measureScope.mo748roundToPx0680j_4(width), 0, 0, 12, null));
        final float f = left;
        return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo0.getWidth(), placeableMo8265measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.material3.TabIndicatorOffsetNode$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return TabIndicatorOffsetNode.measure_3p2s80s$lambda$3(placeableMo8265measureBRTryo0, measureScope, f, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit measure_3p2s80s$lambda$3(Placeable placeable, MeasureScope measureScope, float f, Placeable.PlacementScope placementScope) {
        Placeable.PlacementScope.place$default(placementScope, placeable, measureScope.mo748roundToPx0680j_4(f), 0, 0.0f, 4, null);
        return Unit.INSTANCE;
    }
}
