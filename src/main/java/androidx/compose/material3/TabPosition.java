...
public final class TabPosition {
    ...
    public final float m4369getRightD9Ej5fM() {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m9692equalsimpl0(this.left, tabPosition.left) && Dp.m9692equalsimpl0(this.width, tabPosition.width) && Dp.m9692equalsimpl0(this.contentWidth, tabPosition.contentWidth);
    }

    public int hashCode() {
        return (((Dp.m9693hashCodeimpl(this.left) * 31) + Dp.m9693hashCodeimpl(this.width)) * 31) + Dp.m9693hashCodeimpl(this.contentWidth);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m9698toStringimpl(this.left)) + ", right=" + ((Object) Dp.m9698toStringimpl(m4369getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m9698toStringimpl(this.width)) + ", contentWidth=" + ((Object) Dp.m9698toStringimpl(this.contentWidth)) + ')';
    }
}
