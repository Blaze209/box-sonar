...
public final class TimePickerSelectionMode {
    ...
    private static final int Hour = m4584constructorimpl(0);
    private static final int Minute = m4584constructorimpl(1);
    private final int value;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TimePickerSelectionMode m4583boximpl(int i) {
        return new TimePickerSelectionMode(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m4584constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m4585equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerSelectionMode) && i == ((TimePickerSelectionMode) obj).m4589unboximpl();
    }
    ...
    public boolean equals(Object other) {
        return m4585equalsimpl(this.value, other);
    }
    ...
    public static String m4588toStringimpl(int i) {
        if (m4586equalsimpl0(i, Hour)) {
            return "Hour";
        }
        return m4586equalsimpl0(i, Minute) ? "Minute" : "";
    }
}
