...
final class ModalBottomSheetDialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public ModalBottomSheetDialogLayout(Context context, Window window) {
        ...
        this.window = window;
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ModalBottomSheet_androidKt.INSTANCE.m3100getLambda$91331245$material3(), null, 2, null);
    }
    ...
    public void Content(Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(Content)308@13088L9:ModalBottomSheet.android.kt#uh7d8r");
        if ((i & 6) == 0) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(576708319, i2, -1, "androidx.compose.material3.ModalBottomSheetDialogLayout.Content (ModalBottomSheet.android.kt:307)");
            }
