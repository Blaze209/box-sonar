...
public final class RichTooltipColors {
    ...
    public static /* synthetic */ RichTooltipColors m4022copyjRlVdoo$default(RichTooltipColors richTooltipColors, long j, long j2, long j3, long j4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return richTooltipColors.m4023copyjRlVdoo(j5, j6, j3, (i & 8) != 0 ? richTooltipColors.actionContentColor : j4);
    }

    /* JADX INFO: renamed from: copy-jRlVdoo, reason: not valid java name */
    public final RichTooltipColors m4023copyjRlVdoo(long containerColor, long contentColor, long titleContentColor, long actionContentColor) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m6815equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m6815equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m6815equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
    }

    public int hashCode() {
        return (((((Color.m6821hashCodeimpl(this.containerColor) * 31) + Color.m6821hashCodeimpl(this.contentColor)) * 31) + Color.m6821hashCodeimpl(this.titleContentColor)) * 31) + Color.m6821hashCodeimpl(this.actionContentColor);
    }
}
