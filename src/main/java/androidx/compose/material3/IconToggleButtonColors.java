...
public final class IconToggleButtonColors {
    ...
    public static /* synthetic */ IconToggleButtonColors m3578copytNS2XkQ$default(IconToggleButtonColors iconToggleButtonColors, long j, long j2, long j3, long j4, long j5, long j6, int i, Object obj) {
        if ((i & 1) != 0) {
            j = iconToggleButtonColors.containerColor;
        }
        return iconToggleButtonColors.m3579copytNS2XkQ(j, (i & 2) != 0 ? iconToggleButtonColors.contentColor : j2, (i & 4) != 0 ? iconToggleButtonColors.disabledContainerColor : j3, (i & 8) != 0 ? iconToggleButtonColors.disabledContentColor : j4, (i & 16) != 0 ? iconToggleButtonColors.checkedContainerColor : j5, (i & 32) != 0 ? iconToggleButtonColors.checkedContentColor : j6);
    }

    /* JADX INFO: renamed from: copy-tNS2XkQ, reason: not valid java name */
    public final IconToggleButtonColors m3579copytNS2XkQ(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor) {
    ...
    public final State<Color> containerColor$material3(boolean z, boolean z2, Composer composer, int i) {
        long j;
        ComposerKt.sourceInformationMarkerStart(composer, 1175394478, "C(containerColor)N(enabled,checked)1433@65127L28:IconButton.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1175394478, i, -1, "androidx.compose.material3.IconToggleButtonColors.containerColor (IconButton.kt:1426)");
        }
        if (!z) {
    ...
    public final State<Color> contentColor$material3(boolean z, boolean z2, Composer composer, int i) {
        long j;
        ComposerKt.sourceInformationMarkerStart(composer, 1340854054, "C(contentColor)N(enabled,checked)1450@65697L28:IconButton.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1340854054, i, -1, "androidx.compose.material3.IconToggleButtonColors.contentColor (IconButton.kt:1443)");
        }
        if (!z) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.containerColor, iconToggleButtonColors.containerColor) && Color.m6815equalsimpl0(this.contentColor, iconToggleButtonColors.contentColor) && Color.m6815equalsimpl0(this.disabledContainerColor, iconToggleButtonColors.disabledContainerColor) && Color.m6815equalsimpl0(this.disabledContentColor, iconToggleButtonColors.disabledContentColor) && Color.m6815equalsimpl0(this.checkedContainerColor, iconToggleButtonColors.checkedContainerColor) && Color.m6815equalsimpl0(this.checkedContentColor, iconToggleButtonColors.checkedContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m6821hashCodeimpl(this.containerColor) * 31) + Color.m6821hashCodeimpl(this.contentColor)) * 31) + Color.m6821hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m6821hashCodeimpl(this.disabledContentColor)) * 31) + Color.m6821hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m6821hashCodeimpl(this.checkedContentColor);
    }
}
