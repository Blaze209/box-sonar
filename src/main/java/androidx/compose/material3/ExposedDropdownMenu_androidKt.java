...
public final class ExposedDropdownMenu_androidKt {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.ExposedDropdownMenu_androidKt$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return ExposedDropdownMenu_androidKt.OnPlatformWindowBoundsChange$lambda$0(function0, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final PopupProperties m3350popupPropertiesForAnchorTypeBTG8q0(String str, boolean z, Composer composer, int i) {
        ...
        int i2 = !popupPropertiesForAnchorType_BTG8_q0$lambda$0(stateRememberAccessibilityServiceState) ? 393248 : 393216;
        if ((ExposedDropdownMenuAnchorType.m3318equalsimpl0(str, ExposedDropdownMenuAnchorType.INSTANCE.m3322getPrimaryEditableoYjWRB4()) || (ExposedDropdownMenuAnchorType.m3318equalsimpl0(str, ExposedDropdownMenuAnchorType.INSTANCE.m3324getSecondaryEditableoYjWRB4()) && !popupPropertiesForAnchorType_BTG8_q0$lambda$0(stateRememberAccessibilityServiceState))) && !z) {
            i2 |= 8;
        }
    ...
    private static final void SoftKeyboardListener(final View view, final Density density, final Function0<Unit> function0, Composer composer, final int i) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i2 & Token.DOTQUERY) != 146, i2 & 1)) {
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -1045731228, "CC(remember):ExposedDropdownMenu.android.kt#9igjgp");
            ...
            if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function1() { // from class: androidx.compose.material3.ExposedDropdownMenu_androidKt$$ExternalSyntheticLambda1
                    ...
                    public final Object invoke(Object obj) {
                        return ExposedDropdownMenu_androidKt.SoftKeyboardListener$lambda$0$0(view, function0, (DisposableEffectScope) obj);
                    }
                };
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.ExposedDropdownMenu_androidKt$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return ExposedDropdownMenu_androidKt.SoftKeyboardListener$lambda$1(view, density, function0, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
