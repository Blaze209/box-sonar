...
public final class SingleRowTopAppBarOverrideScope {
    ...
    public /* synthetic */ SingleRowTopAppBarOverrideScope(Modifier modifier, Function2 function2, TextStyle textStyle, Function2 function3, TextStyle textStyle2, Alignment.Horizontal horizontal, Function2 function4, Function3 function5, float f, PaddingValues paddingValues, WindowInsets windowInsets, TopAppBarColors topAppBarColors, TopAppBarScrollBehavior topAppBarScrollBehavior, DefaultConstructorMarker defaultConstructorMarker) {
        this(modifier, function2, textStyle, function3, textStyle2, horizontal, function4, function5, f, paddingValues, windowInsets, topAppBarColors, topAppBarScrollBehavior);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private SingleRowTopAppBarOverrideScope(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> function3, TextStyle textStyle2, Alignment.Horizontal horizontal, Function2<? super Composer, ? super Integer, Unit> function4, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function5, float f, PaddingValues paddingValues, WindowInsets windowInsets, TopAppBarColors topAppBarColors, TopAppBarScrollBehavior topAppBarScrollBehavior) {
