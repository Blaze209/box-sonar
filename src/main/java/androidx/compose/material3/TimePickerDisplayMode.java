...
public final class TimePickerDisplayMode {
    ...
    private static final int Picker = m4529constructorimpl(0);
    private static final int Input = m4529constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TimePickerDisplayMode m4528boximpl(int i) {
    ...
    public boolean equals(Object other) {
        return m4530equalsimpl(this.value, other);
    }
    ...
    public static String m4533toStringimpl(int i) {
        if (m4531equalsimpl0(i, Picker)) {
            return "Picker";
        }
        return m4531equalsimpl0(i, Input) ? "Input" : "Unknown";
    }
}
