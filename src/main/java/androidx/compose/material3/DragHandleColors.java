...
public final class DragHandleColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.color, dragHandleColors.color) && Color.m6815equalsimpl0(this.pressedColor, dragHandleColors.pressedColor) && Color.m6815equalsimpl0(this.draggedColor, dragHandleColors.draggedColor);
    }

    public int hashCode() {
        return (((Color.m6821hashCodeimpl(this.color) * 31) + Color.m6821hashCodeimpl(this.pressedColor)) * 31) + Color.m6821hashCodeimpl(this.draggedColor);
    }
}
