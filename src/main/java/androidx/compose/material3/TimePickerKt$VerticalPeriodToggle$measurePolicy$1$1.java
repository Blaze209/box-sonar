    ...
    public final MeasureResult mo344measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "Spacer")) {
                final Placeable placeableMo8265measureBRTryo0 = measurable.mo8265measureBRTryo0(Constraints.m9630copyZbe2FdA$default(j, 0, 0, 0, measureScope.mo748roundToPx0680j_4(TimePickerTokens.INSTANCE.m5858getPeriodSelectorOutlineWidthD9Ej5fM()), 3, null));
                ...
                for (int i3 = 0; i3 < size3; i3++) {
                    arrayList3.add(((Measurable) arrayList2.get(i3)).mo8265measureBRTryo0(Constraints.m9630copyZbe2FdA$default(j, 0, 0, 0, Constraints.m9639getMaxHeightimpl(j) / 2, 3, null)));
                }
                final ArrayList arrayList4 = arrayList3;
                return MeasureScope.layout$default(measureScope, Constraints.m9640getMaxWidthimpl(j), Constraints.m9639getMaxHeightimpl(j), null, new Function1() { // from class: androidx.compose.material3.TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1.measure_3p2s80s$lambda$3(arrayList4, placeableMo8265measureBRTryo0, (Placeable.PlacementScope) obj);
                    }
                }, 4, null);
            }
        }
