...
public final class AnimatedShapeState {
    ...
    private long size = Size.INSTANCE.m6647getZeroNHjbRc();
    ...
    public final void m4904setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public static /* synthetic */ float m4900topStartTmRCtEA$default(AnimatedShapeState animatedShapeState, long j, Density density, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return animatedShapeState.m4906topStartTmRCtEA(j, density);
    }

    /* JADX INFO: renamed from: topStart-TmRCtEA, reason: not valid java name */
    public final float m4906topStartTmRCtEA(long size, Density density) {
        Animatable<Float, AnimationVector1D> animatableAnimatable$default = this.topStart;
        if (animatableAnimatable$default == null) {
            animatableAnimatable$default = AnimatableKt.Animatable$default(this.shape.getTopStart().mo1564toPxTmRCtEA(size, density), 0.0f, 2, null);
    ...
    public static /* synthetic */ float m4899topEndTmRCtEA$default(AnimatedShapeState animatedShapeState, long j, Density density, int i, Object obj) {
        if ((i & 1) != 0) {
            j = animatedShapeState.size;
        }
        if ((i & 2) != 0) {
        ...
        return animatedShapeState.m4905topEndTmRCtEA(j, density);
    }

    /* JADX INFO: renamed from: topEnd-TmRCtEA, reason: not valid java name */
    public final float m4905topEndTmRCtEA(long size, Density density) {
        Animatable<Float, AnimationVector1D> animatableAnimatable$default = this.topEnd;
        if (animatableAnimatable$default == null) {
            animatableAnimatable$default = AnimatableKt.Animatable$default(this.shape.getTopEnd().mo1564toPxTmRCtEA(size, density), 0.0f, 2, null);
    ...
    public static /* synthetic */ float m4898bottomStartTmRCtEA$default(AnimatedShapeState animatedShapeState, long j, Density density, int i, Object obj) {
        if ((i & 1) != 0) {
            j = animatedShapeState.size;
        }
        if ((i & 2) != 0) {
        ...
        return animatedShapeState.m4902bottomStartTmRCtEA(j, density);
    }

    /* JADX INFO: renamed from: bottomStart-TmRCtEA, reason: not valid java name */
    public final float m4902bottomStartTmRCtEA(long size, Density density) {
        Animatable<Float, AnimationVector1D> animatableAnimatable$default = this.bottomStart;
        if (animatableAnimatable$default == null) {
            animatableAnimatable$default = AnimatableKt.Animatable$default(this.shape.getBottomStart().mo1564toPxTmRCtEA(size, density), 0.0f, 2, null);
    ...
    public static /* synthetic */ float m4897bottomEndTmRCtEA$default(AnimatedShapeState animatedShapeState, long j, Density density, int i, Object obj) {
        if ((i & 1) != 0) {
            j = animatedShapeState.size;
        }
        if ((i & 2) != 0) {
        ...
        return animatedShapeState.m4901bottomEndTmRCtEA(j, density);
    }

    /* JADX INFO: renamed from: bottomEnd-TmRCtEA, reason: not valid java name */
    public final float m4901bottomEndTmRCtEA(long size, Density density) {
        Animatable<Float, AnimationVector1D> animatableAnimatable$default = this.bottomEnd;
        if (animatableAnimatable$default == null) {
            animatableAnimatable$default = AnimatableKt.Animatable$default(this.shape.getBottomEnd().mo1564toPxTmRCtEA(size, density), 0.0f, 2, null);
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        @DebugMetadata(c = "androidx.compose.material3.internal.AnimatedShapeState$animateToShape$2$1", f = "AnimatedShape.kt", i = {}, l = {82}, m = "invokeSuspend", n = {}, s = {}, v = 1)
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    if (animatable != null) {
                        this.label = 1;
                        obj = Animatable.animateTo$default(animatable, Boxing.boxFloat(this.$shape.getTopStart().mo1564toPxTmRCtEA(this.this$0.getSize(), this.this$0.getDensity())), this.this$0.getSpec(), null, null, this, 12, null);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C00642(AnimatedShapeState.this, this.$shape, null), 3, null);
        ...
        /* JADX INFO: compiled from: AnimatedShape.kt */
        @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 0, 0}, xi = 48)
        @DebugMetadata(c = "androidx.compose.material3.internal.AnimatedShapeState$animateToShape$2$2", f = "AnimatedShape.kt", i = {}, l = {83}, m = "invokeSuspend", n = {}, s = {}, v = 1)
        static final class C00642 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            final /* synthetic */ CornerBasedShape $shape;
            int label;
            final /* synthetic */ AnimatedShapeState this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00642(AnimatedShapeState animatedShapeState, CornerBasedShape cornerBasedShape, Continuation<? super C00642> continuation) {
                super(2, continuation);
                this.this$0 = animatedShapeState;
                this.$shape = cornerBasedShape;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C00642(this.this$0, this.$shape, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    if (animatable != null) {
                        this.label = 1;
                        obj = Animatable.animateTo$default(animatable, Boxing.boxFloat(this.$shape.getTopEnd().mo1564toPxTmRCtEA(this.this$0.getSize(), this.this$0.getDensity())), this.this$0.getSpec(), null, null, this, 12, null);
                        if (obj == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
        ...
        /* JADX INFO: compiled from: AnimatedShape.kt */
        @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 0, 0}, xi = 48)
        @DebugMetadata(c = "androidx.compose.material3.internal.AnimatedShapeState$animateToShape$2$3", f = "AnimatedShape.kt", i = {}, l = {84}, m = "invokeSuspend", n = {}, s = {}, v = 1)
        static final class AnonymousClass3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    if (animatable != null) {
                        this.label = 1;
                        obj = Animatable.animateTo$default(animatable, Boxing.boxFloat(this.$shape.getBottomStart().mo1564toPxTmRCtEA(this.this$0.getSize(), this.this$0.getDensity())), this.this$0.getSpec(), null, null, this, 12, null);
                        if (obj == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
        ...
        /* JADX INFO: compiled from: AnimatedShape.kt */
        @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 0, 0}, xi = 48)
        @DebugMetadata(c = "androidx.compose.material3.internal.AnimatedShapeState$animateToShape$2$4", f = "AnimatedShape.kt", i = {}, l = {85}, m = "invokeSuspend", n = {}, s = {}, v = 1)
        static final class AnonymousClass4 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    if (animatable != null) {
                        this.label = 1;
                        obj = Animatable.animateTo$default(animatable, Boxing.boxFloat(this.$shape.getBottomEnd().mo1564toPxTmRCtEA(this.this$0.getSize(), this.this$0.getDensity())), this.this$0.getSpec(), null, null, this, 12, null);
                        if (obj == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
