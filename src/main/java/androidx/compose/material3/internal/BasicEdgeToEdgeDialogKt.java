...
public final class BasicEdgeToEdgeDialogKt {
    ...
    public static final void PredictiveBackStateHandler(final PredictiveBackState predictiveBackState, boolean z, final Function0<Unit> function0, Composer composer, final int i, final int i2) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i3 & Token.DOTQUERY) != 146, i3 & 1)) {
            ...
            composerStartRestartGroup.startMovableGroup(1489276313, predictiveBackState);
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 1489280957, "CC(remember):BasicEdgeToEdgeDialog.kt#9igjgp");
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.internal.BasicEdgeToEdgeDialogKt$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return BasicEdgeToEdgeDialogKt.PredictiveBackStateHandler$lambda$2(predictiveBackState, z4, function0, i, i2, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
