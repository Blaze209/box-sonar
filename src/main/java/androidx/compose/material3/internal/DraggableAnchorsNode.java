...
final class DraggableAnchorsNode<T> extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo372measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (!measureScope.isLookingAhead() || !this.didLookahead) {
            Pair<? extends DraggableAnchors<T>, ? extends T> pairInvoke = this.anchors.invoke(IntSize.m9850boximpl(IntSize.m9853constructorimpl((((long) placeableMo8265measureBRTryo0.getHeight()) & 4294967295L) | (((long) placeableMo8265measureBRTryo0.getWidth()) << 32))), Constraints.m9627boximpl(j));
        ...
        return MeasureScope.layout$default(measureScope, placeableMo8265measureBRTryo0.getWidth(), placeableMo8265measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.material3.internal.DraggableAnchorsNode$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return DraggableAnchorsNode.measure_3p2s80s$lambda$0(measureScope, this, placeableMo8265measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit measure_3p2s80s$lambda$0(MeasureScope measureScope, DraggableAnchorsNode draggableAnchorsNode, final Placeable placeable, Placeable.PlacementScope placementScope) {
        ...
        final float f = draggableAnchorsNode.orientation == Orientation.Horizontal ? (draggableAnchorsNode.isReverseDirection() ? -1.0f : 1.0f) * fRequireOffset : 0.0f;
        ...
        placementScope.withMotionFrameOfReferencePlacement(new Function1() { // from class: androidx.compose.material3.internal.DraggableAnchorsNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return DraggableAnchorsNode.measure_3p2s80s$lambda$0$0(placeable, f, fRequireOffset, (Placeable.PlacementScope) obj);
            }
        });
