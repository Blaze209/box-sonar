...
public final class Strings_androidKt {
    ...
    public static final String m5086getString2EP1pXo(int i, Composer composer, int i2) {
    ...
    public static final String m5087getStringqBjtwXw(int i, Object[] objArr, Composer composer, int i2) {
        ...
        String strM5086getString2EP1pXo = m5086getString2EP1pXo(i, composer, i2 & 14);
        ProvidableCompositionLocal<Configuration> localConfiguration = AndroidCompositionLocals_androidKt.getLocalConfiguration();
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC(<get-current>):CompositionLocal.kt#9igjgp");
        ...
        String str = String.format(locale, strM5086getString2EP1pXo, Arrays.copyOf(objArrCopyOf, objArrCopyOf.length));
