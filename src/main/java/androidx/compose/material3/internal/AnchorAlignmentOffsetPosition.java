...
public final class AnchorAlignmentOffsetPosition {
    ...
    public static final /* data */ class Horizontal implements MenuPosition.Horizontal {
        ...
        public int mo4895position95KtPRI(IntRect anchorBounds, long windowSize, int menuWidth, LayoutDirection layoutDirection) {
    ...
    public static final /* data */ class Vertical implements MenuPosition.Vertical {
        ...
        public int mo4896positionJVtK1S4(IntRect anchorBounds, long windowSize, int menuHeight) {
