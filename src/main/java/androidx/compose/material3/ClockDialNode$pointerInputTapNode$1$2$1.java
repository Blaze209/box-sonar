...
final class ClockDialNode$pointerInputTapNode$1$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (TimePickerKt.m4568onTapuYHVD98(this.this$0.state, Float.intBitsToFloat((int) (this.$it.m6579unboximpl() >> 32)), Float.intBitsToFloat((int) (this.$it.m6579unboximpl() & 4294967295L)), this.this$0.getMaxDist(), this.this$0.autoSwitchToMinute, this.this$0.m2988getCenternOccac(), this.this$0.animationSpec, this) == coroutine_suspended) {
