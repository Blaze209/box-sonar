...
public final class DefaultWideNavigationRailOverride implements WideNavigationRailOverride {
    ...
    public void WideNavigationRail(final WideNavigationRailOverrideScope wideNavigationRailOverrideScope, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(WideNavigationRail)200@9586L346:WideNavigationRail.kt#uh7d8r");
        if ((i & 6) == 0) {
        ...
        if (composerStartRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1829525426, i2, -1, "androidx.compose.material3.DefaultWideNavigationRailOverride.WideNavigationRail (WideNavigationRail.kt:199)");
            }
