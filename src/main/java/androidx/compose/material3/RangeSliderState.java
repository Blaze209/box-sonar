...
public final class RangeSliderState {
    ...
    public final void onDrag$material3(boolean isStart, float offset) {
        ...
        long jM4020scaleToUserValue8bqG3aw = m4020scaleToUserValue8bqG3aw(isStart, getMinPx(), getMaxPx(), jSliderRange);
        if (SliderRange.m4253equalsimpl0(jM4020scaleToUserValue8bqG3aw, SliderKt.SliderRange(getActiveRangeStart(), getActiveRangeEnd()))) {
            return;
        }
        Function1<? super SliderRange, Unit> function1 = this.onValueChange;
        if (function1 == null) {
            setActiveRangeStart(SliderRange.m4255getStartimpl(jM4020scaleToUserValue8bqG3aw));
            setActiveRangeEnd(SliderRange.m4254getEndInclusiveimpl(jM4020scaleToUserValue8bqG3aw));
        } else if (function1 != null) {
            function1.invoke(SliderRange.m4250boximpl(jM4020scaleToUserValue8bqG3aw));
        }
    }
    ...
    private final long m4020scaleToUserValue8bqG3aw(boolean isStart, float minPx, float maxPx, long offset) {
        return SliderKt.m4244scale2geJ7wY(isStart, minPx, maxPx, offset, this.valueRange.getStart().floatValue(), this.valueRange.getEndInclusive().floatValue());
    }
    ...
    public final void updateMinMaxPx$material3() {
        float f = 2;
        float fMax = Math.max(getTotalWidth$material3() - (getEndThumbWidth$material3() / f), 0.0f);
        float fMin = Math.min(getStartThumbWidth$material3() / f, fMax);
