...
public final class InputIdentifier {
    ...
    private static final int SingleDateInput = m3603constructorimpl(0);
    private static final int StartDateInput = m3603constructorimpl(1);
    private static final int EndDateInput = m3603constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InputIdentifier m3602boximpl(int i) {
        return new InputIdentifier(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3603constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3604equalsimpl(int i, Object obj) {
        return (obj instanceof InputIdentifier) && i == ((InputIdentifier) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3605equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3606hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object other) {
        return m3604equalsimpl(this.value, other);
    }
    ...
    public static final class Companion {
        ...
        public final int m3610getSingleDateInputJ2x2o4M() {
            return InputIdentifier.SingleDateInput;
        }

        /* JADX INFO: renamed from: getStartDateInput-J2x2o4M, reason: not valid java name */
        public final int m3611getStartDateInputJ2x2o4M() {
            return InputIdentifier.StartDateInput;
        }

        /* JADX INFO: renamed from: getEndDateInput-J2x2o4M, reason: not valid java name */
        public final int m3609getEndDateInputJ2x2o4M() {
            return InputIdentifier.EndDateInput;
        }
    }

    public String toString() {
        return m3607toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3607toStringimpl(int i) {
        if (m3605equalsimpl0(i, SingleDateInput)) {
            return "SingleDateInput";
        }
        if (m3605equalsimpl0(i, StartDateInput)) {
            return "StartDateInput";
        }
        return m3605equalsimpl0(i, EndDateInput) ? "EndDateInput" : "Unknown";
    }
}
