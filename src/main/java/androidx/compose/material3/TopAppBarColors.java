...
public final class TopAppBarColors {
    ...
    public static /* synthetic */ TopAppBarColors m4757copytNS2XkQ$default(TopAppBarColors topAppBarColors, long j, long j2, long j3, long j4, long j5, long j6, int i, Object obj) {
        if ((i & 1) != 0) {
            j = topAppBarColors.containerColor;
        }
        return topAppBarColors.m4759copytNS2XkQ(j, (i & 2) != 0 ? topAppBarColors.scrolledContainerColor : j2, (i & 4) != 0 ? topAppBarColors.navigationIconContentColor : j3, (i & 8) != 0 ? topAppBarColors.titleContentColor : j4, (i & 16) != 0 ? topAppBarColors.actionIconContentColor : j5, (i & 32) != 0 ? topAppBarColors.subtitleContentColor : j6);
    }

    /* JADX INFO: renamed from: copy-tNS2XkQ, reason: not valid java name */
    public final TopAppBarColors m4759copytNS2XkQ(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, long subtitleContentColor) {
    ...
    public final long m4758containerColorvNxB06k$material3(float colorTransitionFraction) {
        return ColorKt.m6865lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6815equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m6815equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m6815equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m6815equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m6815equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor) && Color.m6815equalsimpl0(this.subtitleContentColor, topAppBarColors.subtitleContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m6821hashCodeimpl(this.containerColor) * 31) + Color.m6821hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m6821hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m6821hashCodeimpl(this.titleContentColor)) * 31) + Color.m6821hashCodeimpl(this.actionIconContentColor)) * 31) + Color.m6821hashCodeimpl(this.subtitleContentColor);
    }
}
