    ...
    void discoverAndInitialize() {
        try {
            try {
                ...
                discoverAndInitialize(MAMPackageManagement.getProviderInfo(this.mContext.getPackageManager(), new ComponentName(this.mContext.getPackageName(), InitializationProvider.class.getName()), 128).metaData);
                Trace.endSection();
