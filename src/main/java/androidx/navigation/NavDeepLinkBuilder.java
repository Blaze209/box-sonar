...
public final class NavDeepLinkBuilder {
    ...
    public final PendingIntent createPendingIntent() {
        ...
        int iM10957contentDeepHashCodeimpl = bundle != null ? SavedStateReader.m10957contentDeepHashCodeimpl(SavedStateReader.m10954constructorimpl(bundle)) : 0;
        for (DeepLinkDestination deepLinkDestination : this.destinations) {
            iM10957contentDeepHashCodeimpl = (iM10957contentDeepHashCodeimpl * 31) + deepLinkDestination.getDestinationId();
            Bundle arguments = deepLinkDestination.getArguments();
            Integer numValueOf = arguments != null ? Integer.valueOf(SavedStateReader.m10957contentDeepHashCodeimpl(SavedStateReader.m10954constructorimpl(arguments))) : null;
            if (numValueOf != null) {
                iM10957contentDeepHashCodeimpl = (iM10957contentDeepHashCodeimpl * 31) + numValueOf.intValue();
            }
        }
        PendingIntent pendingIntent = createTaskStackBuilder().getPendingIntent(iM10957contentDeepHashCodeimpl, 201326592);
