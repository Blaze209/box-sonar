...
public final class LongArrayNavType extends CollectionNavType<long[]> {
    ...
    public void put(Bundle bundle, String key, long[] value) {
        ...
        if (value != null) {
            SavedStateWriter.m11062putLongArrayimpl(bundleM11040constructorimpl, key, value);
        } else {
    ...
    public long[] get(Bundle bundle, String key) {
        ...
        return SavedStateReader.m10996getLongArrayimpl(bundleM10954constructorimpl, key);
    }
}
