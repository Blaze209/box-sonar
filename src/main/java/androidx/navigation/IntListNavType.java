...
public final class IntListNavType extends CollectionNavType<List<? extends Integer>> {
    ...
    public void put(Bundle bundle, String key, List<Integer> value) {
        ...
        if (value != null) {
            SavedStateWriter.m11058putIntArrayimpl(SavedStateWriter.m11040constructorimpl(bundle), key, CollectionsKt.toIntArray(value));
        }
    }
    ...
    public List<Integer> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m10986getIntArrayimpl(bundleM10954constructorimpl, key));
    }
}
