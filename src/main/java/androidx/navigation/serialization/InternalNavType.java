...
public final class InternalNavType {
    ...
    private static final NavType<Integer> IntNullableType = new NavType<Integer>() { // from class: androidx.navigation.serialization.InternalNavType$IntNullableType$1
        ...
        public void put(Bundle bundle, String key, Integer value) {
            ...
            if (value == null) {
                SavedStateWriter.m11063putNullimpl(SavedStateWriter.m11040constructorimpl(bundle), key);
            } else {
        ...
        public Integer get(Bundle bundle, String key) {
            ...
            if (!SavedStateReader.m10955containsimpl(bundleM10954constructorimpl, key) || SavedStateReader.m11033isNullimpl(bundleM10954constructorimpl, key)) {
                return null;
            }
            return Integer.valueOf(SavedStateReader.m10985getIntimpl(bundleM10954constructorimpl, key));
        }
    };
    private static final NavType<Boolean> BoolNullableType = new NavType<Boolean>() { // from class: androidx.navigation.serialization.InternalNavType$BoolNullableType$1
        ...
        public Boolean get(Bundle bundle, String key) {
            ...
            return Boolean.valueOf(SavedStateReader.m10963getBooleanimpl(bundleM10954constructorimpl, key));
        }
    };
    private static final NavType<Double> DoubleType = new NavType<Double>() { // from class: androidx.navigation.serialization.InternalNavType$DoubleType$1
        ...
        public void put(Bundle bundle, String key, double value) {
            Intrinsics.checkNotNullParameter(bundle, "bundle");
            Intrinsics.checkNotNullParameter(key, "key");
            SavedStateWriter.m11053putDoubleimpl(SavedStateWriter.m11040constructorimpl(bundle), key, value);
        }
        ...
        public Double get(Bundle bundle, String key) {
            Intrinsics.checkNotNullParameter(bundle, "bundle");
            Intrinsics.checkNotNullParameter(key, "key");
            return Double.valueOf(SavedStateReader.m10977getDoubleimpl(SavedStateReader.m10954constructorimpl(bundle), key));
        }
    };
    private static final NavType<Double> DoubleNullableType = new NavType<Double>() { // from class: androidx.navigation.serialization.InternalNavType$DoubleNullableType$1
        ...
        public Double get(Bundle bundle, String key) {
            ...
            return Double.valueOf(SavedStateReader.m10977getDoubleimpl(bundleM10954constructorimpl, key));
        }
    };
    private static final NavType<Float> FloatNullableType = new NavType<Float>() { // from class: androidx.navigation.serialization.InternalNavType$FloatNullableType$1
        ...
        public Float get(Bundle bundle, String key) {
            ...
            return Float.valueOf(SavedStateReader.m10981getFloatimpl(bundleM10954constructorimpl, key));
        }
    };
    private static final NavType<Long> LongNullableType = new NavType<Long>() { // from class: androidx.navigation.serialization.InternalNavType$LongNullableType$1
        ...
        public Long get(Bundle bundle, String key) {
            ...
            return Long.valueOf(SavedStateReader.m10995getLongimpl(bundleM10954constructorimpl, key));
        }
    };
    private static final NavType<String> StringNonNullableType = new NavType<String>() { // from class: androidx.navigation.serialization.InternalNavType$StringNonNullableType$1
        ...
        public void put(Bundle bundle, String key, String value) {
            ...
            Intrinsics.checkNotNullParameter(key, "key");
            Intrinsics.checkNotNullParameter(value, "value");
            SavedStateWriter.m11073putStringimpl(SavedStateWriter.m11040constructorimpl(bundle), key, value);
        }
        ...
        public String get(Bundle bundle, String key) {
            ...
            Intrinsics.checkNotNullParameter(key, "key");
            Bundle bundleM10954constructorimpl = SavedStateReader.m10954constructorimpl(bundle);
            return (!SavedStateReader.m10955containsimpl(bundleM10954constructorimpl, key) || SavedStateReader.m11033isNullimpl(bundleM10954constructorimpl, key)) ? AbstractJsonLexerKt.NULL : SavedStateReader.m11025getStringimpl(bundleM10954constructorimpl, key);
        }
    };
    private static final NavType<String[]> StringNullableArrayType = new CollectionNavType<String[]>() { // from class: androidx.navigation.serialization.InternalNavType$StringNullableArrayType$1
        ...
        public void put(Bundle bundle, String key, String[] value) {
            Intrinsics.checkNotNullParameter(bundle, "bundle");
            Intrinsics.checkNotNullParameter(key, "key");
            Bundle bundleM11040constructorimpl = SavedStateWriter.m11040constructorimpl(bundle);
            if (value == null) {
                SavedStateWriter.m11063putNullimpl(bundleM11040constructorimpl, key);
                return;
            }
            ...
            SavedStateWriter.m11074putStringArrayimpl(bundleM11040constructorimpl, key, (String[]) arrayList.toArray(new String[0]));
        }
        ...
        public String[] get(Bundle bundle, String key) {
            ...
            String[] strArrM11026getStringArrayimpl = SavedStateReader.m11026getStringArrayimpl(bundleM10954constructorimpl, key);
            ArrayList arrayList = new ArrayList(strArrM11026getStringArrayimpl.length);
            for (String str : strArrM11026getStringArrayimpl) {
    ...
    private static final NavType<List<String>> StringNullableListType = new CollectionNavType<List<? extends String>>() { // from class: androidx.navigation.serialization.InternalNavType$StringNullableListType$1
        ...
        public List<String> get(Bundle bundle, String key) {
            ...
            List list = ArraysKt.toList(SavedStateReader.m11026getStringArrayimpl(bundleM10954constructorimpl, key));
            ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(list, 10));
    ...
    private static final NavType<double[]> DoubleArrayType = new CollectionNavType<double[]>() { // from class: androidx.navigation.serialization.InternalNavType$DoubleArrayType$1
        ...
        public void put(Bundle bundle, String key, double[] value) {
            ...
            if (value == null) {
                ...
                SavedStateWriter.m11054putDoubleArrayimpl(bundleM11040constructorimpl, key, value);
            }
        }
        ...
        public double[] get(Bundle bundle, String key) {
            ...
            return SavedStateReader.m10978getDoubleArrayimpl(bundleM10954constructorimpl, key);
        }
    };
    private static final NavType<List<Double>> DoubleListType = new CollectionNavType<List<? extends Double>>() { // from class: androidx.navigation.serialization.InternalNavType$DoubleListType$1
        ...
        public void put(Bundle bundle, String key, List<Double> value) {
            ...
            if (value == null) {
                ...
                SavedStateWriter.m11054putDoubleArrayimpl(bundleM11040constructorimpl, key, CollectionsKt.toDoubleArray(value));
            }
        }
        ...
        public List<Double> get(Bundle bundle, String key) {
            ...
            return ArraysKt.toList(SavedStateReader.m10978getDoubleArrayimpl(bundleM10954constructorimpl, key));
        }
    };
