...
public class NavController {
    ...
    /* JADX INFO: compiled from: NavController.android.kt */
    @Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0005\b\u0090\u0004\u0018\u00002\u00020\u0001B\u0017\u0012\u000e\u0010\u0002\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00040\u0003¢\u0006\u0004\b\u0005\u0010\u0006J\u0010\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\fH\u0016J\u000e\u0010\r\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\fJ \u0010\u000e\u001a\u00020\f2\u0006\u0010\u000f\u001a\u00020\u00042\u000e\u0010\u0010\u001a\n\u0018\u00010\u0011j\u0004\u0018\u0001`\u0012H\u0016J\u0018\u0010\u0013\u001a\u00020\n2\u0006\u0010\u0014\u001a\u00020\f2\u0006\u0010\u0015\u001a\u00020\u0016H\u0016J\u0018\u0010\u0017\u001a\u00020\n2\u0006\u0010\u0014\u001a\u00020\f2\u0006\u0010\u0015\u001a\u00020\u0016H\u0016J\u0010\u0010\u0018\u001a\u00020\n2\u0006\u0010\u0019\u001a\u00020\fH\u0016J\u0010\u0010\u001a\u001a\u00020\n2\u0006\u0010\u0019\u001a\u00020\fH\u0016R\u0019\u0010\u0002\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00040\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b¨\u0006\u001b"}, d2 = {"Landroidx/navigation/NavController$NavControllerNavigatorState;", "Landroidx/navigation/NavigatorState;", "navigator", "Landroidx/navigation/Navigator;", "Landroidx/navigation/NavDestination;", "<init>", "(Landroidx/navigation/NavController;Landroidx/navigation/Navigator;)V", "getNavigator", "()Landroidx/navigation/Navigator;", "push", "", "backStackEntry", "Landroidx/navigation/NavBackStackEntry;", "addInternal", "createBackStackEntry", FirebaseAnalytics.Param.DESTINATION, "arguments", "Landroid/os/Bundle;", "Landroidx/savedstate/SavedState;", TokenRequest.TokenType.POP, "popUpTo", "saveState", "", "popWithTransition", "markTransitionComplete", "entry", "prepareForTransition", "navigation-runtime_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    ...
    private final boolean tryRelaunchUpToExplicitStack() {
        ...
        SavedStateWriter.m11064putParcelableimpl(bundleM11040constructorimpl, KEY_DEEP_LINK_INTENT, intent);
                    ...
                    if (activity.getIntent() != null) {
                        ...
                        if (activity2.getIntent().getData() != null) {
                            ...
                            if ((deepLinkMatchMatchDeepLinkComprehensive != null ? deepLinkMatchMatchDeepLinkComprehensive.getMatchingArgs() : null) != null && (bundleAddInDefaultArgs = deepLinkMatchMatchDeepLinkComprehensive.getDestination().addInDefaultArgs(deepLinkMatchMatchDeepLinkComprehensive.getMatchingArgs())) != null) {
                                SavedStateWriter.m11044putAllimpl(bundleM11040constructorimpl, bundleAddInDefaultArgs);
                            }
                        }
                    }
                }
    ...
    public boolean handleDeepLink(Intent intent) {
        ...
        if (bundle2 != null) {
            SavedStateWriter.m11044putAllimpl(SavedStateWriter.m11040constructorimpl(bundleBundleOf), bundle2);
        }
        if ((intArray == null || intArray.length == 0) && (deepLinkMatchMatchDeepLinkComprehensive = (topGraph$navigation_runtime_release = this.impl.getTopGraph$navigation_runtime_release()).matchDeepLinkComprehensive(NavControllerKt.NavDeepLinkRequest(intent), true, true, topGraph$navigation_runtime_release)) != null) {
            ...
            if (bundleAddInDefaultArgs != null) {
                SavedStateWriter.m11044putAllimpl(SavedStateWriter.m11040constructorimpl(bundleBundleOf), bundleAddInDefaultArgs);
            }
        ...
        SavedStateWriter.m11064putParcelableimpl(SavedStateWriter.m11040constructorimpl(bundleBundleOf), KEY_DEEP_LINK_INTENT, intent);
        ...
        for (int i = 0; i < length; i++) {
            ...
            Bundle bundleM11040constructorimpl = SavedStateWriter.m11040constructorimpl(bundleBundleOf2);
            SavedStateWriter.m11044putAllimpl(bundleM11040constructorimpl, bundleBundleOf);
    ...
    public final boolean handleDeepLink(NavDeepLinkRequest request) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            Bundle bundleBundleOf2 = BundleKt.bundleOf((Pair[]) Arrays.copyOf(pairArr2, pairArr2.length));
            SavedStateWriter.m11044putAllimpl(SavedStateWriter.m11040constructorimpl(bundleBundleOf2), bundleBundleOf);
            bundleArr[i] = bundleBundleOf2;
        }
    ...
    /* JADX WARN: Code duplicated, block: B:32:0x00c8 A[LOOP:0: B:30:0x00c2->B:32:0x00c8, LOOP_END] */
    ...
    public void navigate(int resId, Bundle args, NavOptions navOptions, Navigator.Extras navigatorExtras) {
        ...
        if (action != null) {
            ...
            if (defaultArguments != null) {
                ...
                SavedStateWriter.m11044putAllimpl(SavedStateWriter.m11040constructorimpl(bundleBundleOf), defaultArguments);
            }
            if (args != null) {
                ...
                SavedStateWriter.m11044putAllimpl(SavedStateWriter.m11040constructorimpl(bundleBundleOf), args);
            }
            if (destinationId == 0 || navOptions == null || (navOptions.getPopUpToId() == -1 && navOptions.getPopUpToRoute() == null && navOptions.getPopUpToRouteClass() == null)) {
                ...
                navigate(navDestinationFindDestination$default, bundleBundleOf, navOptions, navigatorExtras);
            }
    ...
    public final void writeIntent$navigation_runtime_release(NavDeepLinkRequest request, Bundle args) {
        ...
        SavedStateWriter.m11064putParcelableimpl(SavedStateWriter.m11040constructorimpl(args), KEY_DEEP_LINK_INTENT, intent);
    }
    ...
    public Bundle saveState() {
        ...
        if (this.deepLinkHandled) {
            if (bundleSaveState$navigation_runtime_release == null) {
                ...
                SavedStateWriter.m11040constructorimpl(bundleSaveState$navigation_runtime_release);
            }
            SavedStateWriter.m11046putBooleanimpl(SavedStateWriter.m11040constructorimpl(bundleSaveState$navigation_runtime_release), KEY_DEEP_LINK_HANDLED, this.deepLinkHandled);
        }
    ...
    public void restoreState(Bundle navState) {
        ...
        if (navState != null) {
            Boolean boolM10966getBooleanOrNullimpl = SavedStateReader.m10966getBooleanOrNullimpl(SavedStateReader.m10954constructorimpl(navState), KEY_DEEP_LINK_HANDLED);
            this.deepLinkHandled = boolM10966getBooleanOrNullimpl != null ? boolM10966getBooleanOrNullimpl.booleanValue() : false;
        }
    }
    ...
    public void setOnBackPressedDispatcher(OnBackPressedDispatcher dispatcher) {
        ...
        Lifecycle lifecycle = lifecycleOwner$navigation_runtime_release.getLifecycleRegistry();
