...
public final class StringArrayNavType extends CollectionNavType<String[]> {
    ...
    public void put(Bundle bundle, String key, String[] value) {
        ...
        if (value != null) {
            SavedStateWriter.m11074putStringArrayimpl(bundleM11040constructorimpl, key, value);
        } else {
    ...
    public String[] get(Bundle bundle, String key) {
        ...
        return SavedStateReader.m11026getStringArrayimpl(bundleM10954constructorimpl, key);
    }
