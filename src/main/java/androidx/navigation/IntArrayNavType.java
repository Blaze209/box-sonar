...
public final class IntArrayNavType extends CollectionNavType<int[]> {
    ...
    public void put(Bundle bundle, String key, int[] value) {
        ...
        if (value != null) {
            SavedStateWriter.m11058putIntArrayimpl(bundleM11040constructorimpl, key, value);
        } else {
    ...
    public int[] get(Bundle bundle, String key) {
        ...
        return SavedStateReader.m10986getIntArrayimpl(bundleM10954constructorimpl, key);
    }
}
