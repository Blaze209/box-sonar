...
public final class LongListNavType extends CollectionNavType<List<? extends Long>> {
    ...
    public void put(Bundle bundle, String key, List<Long> value) {
        ...
        if (value != null) {
            SavedStateWriter.m11062putLongArrayimpl(bundleM11040constructorimpl, key, CollectionsKt.toLongArray(value));
        } else {
    ...
    public List<Long> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m10996getLongArrayimpl(bundleM10954constructorimpl, key));
    }
}
