...
public final class NavDeepLink {
    ...
    private final void parseArgument(Bundle savedState, String name, String value, NavArgument argument) {
        if (argument != null) {
            ...
            SavedStateWriter.m11073putStringimpl(SavedStateWriter.m11040constructorimpl(savedState), name, value);
        }
    }
    ...
    public final Map<String, ParamQuery> parseQuery() {
        ...
        if (isParameterizedQuery()) {
            ...
            for (String str2 : uri.getQueryParameterNames()) {
                ...
                sb.append(MetadataReservedKeys.PREFIX);
                String string = sb.toString();
                Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
    ...
    private final boolean parseInputParams(List<String> inputParams, ParamQuery storedParam, Bundle savedState, Map<String, NavArgument> arguments) {
        ...
        for (String str2 : inputParams) {
            ...
            for (Object obj : arguments2) {
                ...
                try {
                    if (!SavedStateReader.m10955containsimpl(SavedStateReader.m10954constructorimpl(bundleBundleOf), str3)) {
        ...
        SavedStateWriter.m11044putAllimpl(SavedStateWriter.m11040constructorimpl(savedState), bundleBundleOf);
        return true;
    }

    private final boolean parseArgumentForRepeatedParam(Bundle savedState, String name, String value, NavArgument argument) {
        if (!SavedStateReader.m10955containsimpl(SavedStateReader.m10954constructorimpl(savedState), name)) {
            return true;
        }
        if (argument == null) {
            return false;
    ...
    public static final boolean getMatchingArguments$lambda$13(Bundle bundle, String argName) {
        ...
        return !SavedStateReader.m10955containsimpl(SavedStateReader.m10954constructorimpl(bundle), argName);
    }
}
