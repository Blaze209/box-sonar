...
public class NavGraphNavigator extends Navigator<NavGraph> {
    ...
    private final void navigate(NavBackStackEntry entry, NavOptions navOptions, Navigator.Extras navigatorExtras) {
        ...
        if (startDestinationRoute != null) {
            if (!Intrinsics.areEqual(startDestinationRoute, navDestinationFindNode.getRoute())) {
                ...
                if (matchingArgs != null && !SavedStateReader.m11032isEmptyimpl(SavedStateReader.m10954constructorimpl(matchingArgs))) {
                    ...
                    Bundle bundleM11040constructorimpl = SavedStateWriter.m11040constructorimpl(BundleOf);
                    SavedStateWriter.m11044putAllimpl(bundleM11040constructorimpl, matchingArgs);
    ...
    public static final boolean navigate$lambda$6(Ref.ObjectRef objectRef, String key) {
        ...
        return objectRef.element == 0 || !SavedStateReader.m10955containsimpl(SavedStateReader.m10954constructorimpl((Bundle) objectRef.element), key);
    }
}
