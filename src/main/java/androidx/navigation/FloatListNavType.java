...
public final class FloatListNavType extends CollectionNavType<List<? extends Float>> {
    ...
    public void put(Bundle bundle, String key, List<Float> value) {
        ...
        if (value != null) {
            SavedStateWriter.m11056putFloatArrayimpl(bundleM11040constructorimpl, key, CollectionsKt.toFloatArray(value));
        } else {
    ...
    public List<Float> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m10982getFloatArrayimpl(bundleM10954constructorimpl, key));
    }
}
