...
public final class FloatArrayNavType extends CollectionNavType<float[]> {
    ...
    public void put(Bundle bundle, String key, float[] value) {
        ...
        if (value != null) {
            SavedStateWriter.m11056putFloatArrayimpl(bundleM11040constructorimpl, key, value);
        } else {
    ...
    public float[] get(Bundle bundle, String key) {
        ...
        return SavedStateReader.m10982getFloatArrayimpl(bundleM10954constructorimpl, key);
    }
}
