...
public final class BoolArrayNavType extends CollectionNavType<boolean[]> {
    ...
    public void put(Bundle bundle, String key, boolean[] value) {
        ...
        if (value != null) {
            SavedStateWriter.m11047putBooleanArrayimpl(bundleM11040constructorimpl, key, value);
        } else {
    ...
    public boolean[] get(Bundle bundle, String key) {
        ...
        return SavedStateReader.m10964getBooleanArrayimpl(bundleM10954constructorimpl, key);
    }
}
