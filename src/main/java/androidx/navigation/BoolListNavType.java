...
public final class BoolListNavType extends CollectionNavType<List<? extends Boolean>> {
    ...
    public void put(Bundle bundle, String key, List<Boolean> value) {
        ...
        if (value != null) {
            SavedStateWriter.m11047putBooleanArrayimpl(bundleM11040constructorimpl, key, CollectionsKt.toBooleanArray(value));
        } else {
    ...
    public List<Boolean> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m10964getBooleanArrayimpl(bundleM10954constructorimpl, key));
    }
}
