...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo11084clone = transition.mo11084clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo11084clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo11084clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo11084clone);
    }
    ...
    public static TransitionSeekController createSeekController(Scene scene, Transition transition) {
        ...
        transitionSet.addTransition(transitionMo11084clone);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo11084clone = transition.mo11084clone();
        sceneChangeSetup(viewGroup, transitionMo11084clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo11084clone);
    }
