    ...
    public static final class Companion {
        ...
        public final MeasuredPolygon measurePolygon$graphics_shapes(Measurer measurer, RoundedPolygon polygon) {
            ...
            for (int i4 = 0; i4 < size4; i4++) {
                ...
                listCreateListBuilder.add(new ProgressableFeature(Utils.positiveModulo((mutableFloatList.get(iIntValue) + mutableFloatList.get(iIntValue + 1)) / 2, 1.0f), (Feature) ((Pair) arrayList2.get(i4)).getFirst()));
            }
