...
public final class ShapesKt {
    ...
    public static /* synthetic */ RoundedPolygon pillStar$default(RoundedPolygon.Companion companion, float f, float f2, int i, float f3, CornerRounding cornerRounding, CornerRounding cornerRounding2, List list, float f4, float f5, float f6, float f7, int i2, Object obj) {
        ...
        return pillStar(companion, f, f2, i, f3, cornerRounding, cornerRounding2, list, f4, f5, f6, (i2 & 1024) != 0 ? 0.0f : f7);
    }
    ...
    private static final float[] pillStarVerticesFromNumVerts(int i, float f, float f2, float f3, float f4, float f5, float f6, float f7) {
        ...
        long jM315constructorimpl2 = FloatFloatPair.m315constructorimpl(f12, f11);
        float f24 = -f12;
        long jM315constructorimpl3 = FloatFloatPair.m315constructorimpl(f24, f11);
        float f25 = -f11;
        long jM315constructorimpl4 = FloatFloatPair.m315constructorimpl(f24, f25);
        long jM315constructorimpl5 = FloatFloatPair.m315constructorimpl(f12, f25);
        float f26 = f11;
        int i3 = 0;
        float f27 = 0.0f;
        boolean z = false;
                ...
                if (f28 >= f29) {
                    ...
                    switch (i4) {
                        case 0:
                            f8 = f11;
                            f9 = f12;
                            jM315constructorimpl = FloatFloatPair.m315constructorimpl(f31, f30 * f8);
                            break;
                        case 1:
                            f8 = f11;
                            f9 = f12;
                            jM315constructorimpl = PointKt.m10271plusybeJwSQ(Utils.m10303radialToCartesianL6JJ3z0$default(f31, (f30 * Utils.getFloatPi()) / f10, 0L, 4, null), jM315constructorimpl2);
                            break;
                        case 2:
                            f8 = f11;
                            f9 = f12;
                            jM315constructorimpl = FloatFloatPair.m315constructorimpl(f9 - (f30 * fCoerceAtLeast2), f31);
                            break;
                        case 3:
                            f8 = f11;
                            f9 = f12;
                            jM315constructorimpl = PointKt.m10271plusybeJwSQ(Utils.m10303radialToCartesianL6JJ3z0$default(f31, (Utils.getFloatPi() / f10) + ((f30 * Utils.getFloatPi()) / f10), 0L, 4, null), jM315constructorimpl3);
                            break;
                        case 4:
                            f8 = f11;
                            f9 = f12;
                            jM315constructorimpl = FloatFloatPair.m315constructorimpl(-f31, f8 - (f30 * fCoerceAtLeast));
                            break;
                        case 5:
                            f8 = f11;
                            f9 = f12;
                            jM315constructorimpl = PointKt.m10271plusybeJwSQ(Utils.m10303radialToCartesianL6JJ3z0$default(f31, Utils.getFloatPi() + ((f30 * Utils.getFloatPi()) / f10), 0L, 4, null), jM315constructorimpl4);
                            break;
                        case 6:
                            f8 = f11;
                            f9 = f12;
                            jM315constructorimpl = FloatFloatPair.m315constructorimpl(f24 + (f30 * fCoerceAtLeast2), -f31);
                            break;
                        case 7:
                            f8 = f11;
                            f9 = f12;
                            jM315constructorimpl = PointKt.m10271plusybeJwSQ(Utils.m10303radialToCartesianL6JJ3z0$default(f31, (Utils.getFloatPi() * 1.5f) + ((f30 * Utils.getFloatPi()) / f10), 0L, 4, null), jM315constructorimpl5);
                            break;
                        default:
                            f8 = f11;
                            f9 = f12;
                            jM315constructorimpl = FloatFloatPair.m315constructorimpl(f31, f25 + (f30 * f8));
                            break;
                    }
                    int i7 = i5 + 1;
                    fArr2[i5] = PointKt.m10267getXDnnuFBc(jM315constructorimpl) + f6;
                    i5 += 2;
                    fArr2[i7] = PointKt.m10268getYDnnuFBc(jM315constructorimpl) + f7;
                    f23 += f22;
                    z = !z;
                    i3++;
                    f11 = f8;
    ...
    private static final float[] starVerticesFromNumVerts(int i, float f, float f2, float f3, float f4) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            float f5 = i;
            long jM10303radialToCartesianL6JJ3z0$default = Utils.m10303radialToCartesianL6JJ3z0$default(f, (Utils.getFloatPi() / f5) * 2 * i3, 0L, 4, null);
            fArr[i2] = PointKt.m10267getXDnnuFBc(jM10303radialToCartesianL6JJ3z0$default) + f3;
            fArr[i2 + 1] = PointKt.m10268getYDnnuFBc(jM10303radialToCartesianL6JJ3z0$default) + f4;
            long jM10303radialToCartesianL6JJ3z0$default2 = Utils.m10303radialToCartesianL6JJ3z0$default(f2, (Utils.getFloatPi() / f5) * ((i3 * 2) + 1), 0L, 4, null);
            int i4 = i2 + 3;
            fArr[i2 + 2] = PointKt.m10267getXDnnuFBc(jM10303radialToCartesianL6JJ3z0$default2) + f3;
            i2 += 4;
            fArr[i4] = PointKt.m10268getYDnnuFBc(jM10303radialToCartesianL6JJ3z0$default2) + f4;
        }
        return fArr;
    }
}
