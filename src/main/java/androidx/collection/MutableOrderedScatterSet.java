...
public final class MutableOrderedScatterSet<E> extends OrderedScatterSet<E> {
    ...
    /* JADX WARN: Code duplicated, block: B:16:0x005b A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:17:0x005d A[LOOP:0: B:5:0x001c->B:17:0x005d, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:24:0x0060 A[EDGE_INSN: B:24:0x0060->B:18:0x0060 BREAK  A[LOOP:0: B:5:0x001c->B:17:0x005d], SYNTHETIC] */
    ...
    public final void adjustStorage$collection() {
        if (this._capacity > 8 && Long.compareUnsigned(ULong.m14954constructorimpl(ULong.m14954constructorimpl(this._size) * 32), ULong.m14954constructorimpl(ULong.m14954constructorimpl(this._capacity) * 25)) <= 0) {
