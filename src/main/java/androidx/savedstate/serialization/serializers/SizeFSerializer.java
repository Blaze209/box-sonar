...
public final class SizeFSerializer implements KSerializer<SizeF> {
    ...
    public void serialize(Encoder encoder, SizeF value) {
        ...
        SavedStateWriter.m11071putSizeFimpl(SavedStateWriter.m11040constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public SizeF deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m11018getSizeFimpl(SavedStateReader.m10954constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
