...
public final class IBinderSerializer implements KSerializer<IBinder> {
    ...
    public void serialize(Encoder encoder, IBinder value) {
        ...
        SavedStateWriter.m11045putBinderimpl(SavedStateWriter.m11040constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public IBinder deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m10961getBinderimpl(SavedStateReader.m10954constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
