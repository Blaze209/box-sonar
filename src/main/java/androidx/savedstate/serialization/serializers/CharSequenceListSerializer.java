...
public final class CharSequenceListSerializer implements KSerializer<List<? extends CharSequence>> {
    ...
    public void serialize(Encoder encoder, List<? extends CharSequence> value) {
        ...
        SavedStateWriter.m11052putCharSequenceListimpl(SavedStateWriter.m11040constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public List<CharSequence> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m10974getCharSequenceListimpl(SavedStateReader.m10954constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
