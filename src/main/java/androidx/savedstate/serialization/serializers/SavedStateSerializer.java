...
public final class SavedStateSerializer implements KSerializer<Bundle> {
    ...
    public void serialize(Encoder encoder, Bundle value) {
        ...
        if (Intrinsics.areEqual(savedStateEncoder.getKey(), "")) {
            SavedStateWriter.m11044putAllimpl(SavedStateWriter.m11040constructorimpl(savedStateEncoder.getSavedState()), value);
        } else {
            SavedStateWriter.m11067putSavedStateimpl(SavedStateWriter.m11040constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
        }
    }
    ...
    public Bundle deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m11011getSavedStateimpl(SavedStateReader.m10954constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
