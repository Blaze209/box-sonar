...
public final class CharSequenceSerializer implements KSerializer<CharSequence> {
    ...
    public void serialize(Encoder encoder, CharSequence value) {
        ...
        SavedStateWriter.m11050putCharSequenceimpl(SavedStateWriter.m11040constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public CharSequence deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m10971getCharSequenceimpl(SavedStateReader.m10954constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
