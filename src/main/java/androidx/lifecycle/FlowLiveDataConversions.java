...
public final class FlowLiveDataConversions {
    ...
    static final class C08221<T> extends SuspendLambda implements Function2<LiveDataScope<T>, Continuation<? super Unit>, Object> {
        ...
        C08221(Flow<? extends T> flow, Continuation<? super C08221> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C08221 c08221 = new C08221(this.$this_asLiveData, continuation);
            c08221.L$0 = obj;
            return c08221;
        }
        ...
        public final Object invoke(LiveDataScope<T> liveDataScope, Continuation<? super Unit> continuation) {
            return ((C08221) create(liveDataScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> LiveData<T> asLiveData(Flow<? extends T> flow, CoroutineContext context, long j) {
        Intrinsics.checkNotNullParameter(flow, "<this>");
        Intrinsics.checkNotNullParameter(context, "context");
        RoomCallableTrackingLiveData roomCallableTrackingLiveData = (LiveData<T>) CoroutineLiveDataKt.liveData(context, j, new C08221(flow, null));
    ...
    static final class AnonymousClass1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
                ...
                if (r1 == 0) {
                    ...
                    Observer observer2 = new Observer() { // from class: androidx.lifecycle.FlowLiveDataConversions$asFlow$1$$ExternalSyntheticLambda0
                        ...
                        public final void onChanged(Object obj2) {
                            producerScope.mo11206trySendJP2dKIU(obj2);
                        }
                    };
                    this.L$0 = observer2;
                    this.label = 1;
                    Object objWithContext = BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C00851(this.$this_asFlow, observer2, null), this);
                    observer = observer2;
        ...
        static final class C00851 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00851(LiveData<T> liveData, Observer<T> observer, Continuation<? super C00851> continuation) {
                super(2, continuation);
                this.$this_asFlow = liveData;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C00851(this.$this_asFlow, this.$observer, continuation);
            }
