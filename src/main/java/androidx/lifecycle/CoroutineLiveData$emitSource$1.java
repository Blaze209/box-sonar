...
@DebugMetadata(c = "androidx.lifecycle.CoroutineLiveData", f = "CoroutineLiveData.kt", i = {0}, l = {221, BoxCommonConstants.REQUEST_DELETE_CURRENT_FOLDER}, m = "emitSource$lifecycle_livedata", n = {"source"}, s = {"L$0"}, v = 1)
