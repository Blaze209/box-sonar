...
public final class SimpleActor<T> {
    ...
    public SimpleActor(CoroutineScope scope, final Function1<? super Throwable, Unit> onComplete, final Function2<? super T, ? super Throwable, Unit> onUndeliveredElement, Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> consumeMessage) {
        ...
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
            ...
            public final void invoke2(Throwable th) {
                ...
                do {
                    Object objM16339getOrNullimpl = ChannelResult.m16339getOrNullimpl(((SimpleActor) this).messageQueue.mo11205tryReceivePtdJZtk());
                    if (objM16339getOrNullimpl == null) {
                        unit = null;
                    } else {
                        onUndeliveredElement.invoke((T) objM16339getOrNullimpl, th);
                        unit = Unit.INSTANCE;
                    }
                } while (unit != null);
            }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo11206trySendJP2dKIU(msg);
        ...
        if (!ChannelResult.m16344isSuccessimpl(obj)) {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Code duplicated, block: B:18:0x0059 A[PHI: r1 r6
