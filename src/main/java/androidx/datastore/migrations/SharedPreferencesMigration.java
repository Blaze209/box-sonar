...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    @DebugMetadata(c = "androidx.datastore.migrations.SharedPreferencesMigration", f = "SharedPreferencesMigration.kt", i = {0}, l = {Token.DOTQUERY}, m = "shouldMigrate", n = {"this"}, s = {"L$0"})
    static final class C08101 extends ContinuationImpl {
        ...
        C08101(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C08101> continuation) {
            super(continuation);
    ...
    public Object shouldMigrate(T t, Continuation<? super Boolean> continuation) {
        ...
        if (continuation instanceof C08101) {
            ...
            if ((c08101.label & Integer.MIN_VALUE) != 0) {
                ...
                c08101 = new C08101(this, continuation);
            }
        } else {
            c08101 = new C08101(this, continuation);
        }
        Object objInvoke = c08101.result;
        ...
        if (i == 0) {
            ...
            c08101.L$0 = this;
            c08101.label = 1;
            objInvoke = function2.invoke(t, c08101);
            ...
            this = (SharedPreferencesMigration) c08101.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
