...
final class SchemaUtil {
    ...
    static Object getMapDefaultEntry(Class<?> cls, String str) {
        try {
            java.lang.reflect.Field[] declaredFields = Class.forName(cls.getName() + MetadataReservedKeys.PREFIX + toCamelCase(str, true) + "DefaultEntryHolder").getDeclaredFields();
