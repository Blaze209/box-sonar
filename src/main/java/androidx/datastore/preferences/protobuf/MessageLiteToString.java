...
final class MessageLiteToString {
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            String strReplaceFirst = str.replaceFirst(PasskeyWebListener.GET_UNIQUE_KEY, "");
            ...
            if (((java.lang.reflect.Method) map2.get("set" + strReplaceFirst)) != null && (!strReplaceFirst.endsWith(BYTES_SUFFIX) || !map.containsKey(PasskeyWebListener.GET_UNIQUE_KEY + strReplaceFirst.substring(0, strReplaceFirst.length() - BYTES_SUFFIX.length())))) {
                String str4 = strReplaceFirst.substring(0, 1).toLowerCase() + strReplaceFirst.substring(1);
                java.lang.reflect.Method method4 = (java.lang.reflect.Method) map.get(PasskeyWebListener.GET_UNIQUE_KEY + strReplaceFirst);
