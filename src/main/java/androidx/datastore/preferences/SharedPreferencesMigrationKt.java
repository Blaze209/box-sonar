...
public final class SharedPreferencesMigrationKt {
    ...
    static final class C08111 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C08111(Set<String> set, Continuation<? super C08111> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C08111 c08111 = new C08111(this.$keysToMigrate, continuation);
            c08111.L$0 = obj;
            return c08111;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C08111) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
