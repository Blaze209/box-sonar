...
public final class SuspendToFutureAdapter {
    ...
    private static final class DeferredFuture<T> implements ListenableFuture<T>, Continuation<T> {
        ...
        public void resumeWith(Object result) {
            Throwable thM14783exceptionOrNullimpl = Result.m14783exceptionOrNullimpl(result);
            if (thM14783exceptionOrNullimpl == null) {
                this.delegateFuture.set(result);
            } else if (thM14783exceptionOrNullimpl instanceof CancellationException) {
                this.delegateFuture.cancel(false);
            } else {
                this.delegateFuture.setException(thM14783exceptionOrNullimpl);
            }
        }
    }
}
