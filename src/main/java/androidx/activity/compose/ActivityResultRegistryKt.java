...
public final class ActivityResultRegistryKt {
    public static final <I, O> ManagedActivityResultLauncher<I, O> rememberLauncherForActivityResult(ActivityResultContract<I, O> activityResultContract, Function1<? super O, Unit> function1, Composer composer, int i) {
        ...
        String str = (String) RememberSaveableKt.m6246rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<String>() { // from class: androidx.activity.compose.ActivityResultRegistryKt$rememberLauncherForActivityResult$key$1
        ...
        if (zChangedInstance || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
            ...
            objRememberedValue3 = (Function1) new ActivityResultRegistryKt$rememberLauncherForActivityResult$1$1(activityResultLauncherHolder, activityResultRegistry2, str, activityResultContract, stateRememberUpdatedState2);
