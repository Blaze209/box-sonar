...
public final class QueryInterceptorStatement implements SupportSQLiteStatement {
    ...
    static final class C08581 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C08581(List<? extends Object> list, Continuation<? super C08581> continuation) {
            super(2, continuation);
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorStatement.this.new C08581(this.$argsCopy, continuation);
        }
    ...
    public int executeUpdateDelete() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C08581(CollectionsKt.toList(this.bindArgsCache), null), 3, null);
    ...
    static final class C08571 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C08571(List<? extends Object> list, Continuation<? super C08571> continuation) {
            super(2, continuation);
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorStatement.this.new C08571(this.$argsCopy, continuation);
        }
    ...
    public long executeInsert() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C08571(CollectionsKt.toList(this.bindArgsCache), null), 3, null);
    ...
    static final class C08591 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C08591(List<? extends Object> list, Continuation<? super C08591> continuation) {
            super(2, continuation);
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorStatement.this.new C08591(this.$argsCopy, continuation);
        }
    ...
    public long simpleQueryForLong() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C08591(CollectionsKt.toList(this.bindArgsCache), null), 3, null);
    ...
    static final class C08601 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C08601(List<? extends Object> list, Continuation<? super C08601> continuation) {
            super(2, continuation);
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorStatement.this.new C08601(this.$argsCopy, continuation);
        }
    ...
    public String simpleQueryForString() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C08601(CollectionsKt.toList(this.bindArgsCache), null), 3, null);
