...
public final class QueryInterceptorDatabase implements SupportSQLiteDatabase {
    ...
    static final class C08491 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C08491(continuation);
        }
    ...
    public void beginTransactionNonExclusive() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C08491(null), 3, null);
    ...
    static final class C08501 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C08501(continuation);
        }
    ...
    public void beginTransactionWithListener(SQLiteTransactionListener transactionListener) {
        Intrinsics.checkNotNullParameter(transactionListener, "transactionListener");
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C08501(null), 3, null);
    ...
    static final class C08511 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C08511(continuation);
        }
    ...
    public void beginTransactionWithListenerNonExclusive(SQLiteTransactionListener transactionListener) {
        Intrinsics.checkNotNullParameter(transactionListener, "transactionListener");
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C08511(null), 3, null);
    ...
    static final class C08521 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C08521(continuation);
        }
    ...
    public void endTransaction() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C08521(null), 3, null);
    ...
    static final class C08561 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C08561(continuation);
        }
    ...
    public void setTransactionSuccessful() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C08561(null), 3, null);
    ...
    static final class C08541 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C08541(String str, Continuation<? super C08541> continuation) {
            super(2, continuation);
            this.$query = str;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C08541(this.$query, continuation);
        }
    ...
    public Cursor query(String query) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C08541(query, null), 3, null);
    ...
    static final class C08552 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ List<Object> $argsCopy;
        final /* synthetic */ String $query;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C08552(String str, List<? extends Object> list, Continuation<? super C08552> continuation) {
            super(2, continuation);
            this.$query = str;
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C08552(this.$query, this.$argsCopy, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C08552) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public Cursor query(String query, Object[] bindArgs) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C08552(query, ArraysKt.toList(bindArgs), null), 3, null);
    ...
    static final class AnonymousClass3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ResultKt.throwOnFailure(obj);
                QueryInterceptorDatabase.this.queryCallback.onQuery(this.$query.getSql(), this.$queryInterceptorProgram.getBindArgsCache$room_runtime());
    ...
    static final class C08531 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorDatabase.this.new C08531(this.$sql, continuation);
        }
    ...
    public void execSQL(String sql) {
        Intrinsics.checkNotNullParameter(sql, "sql");
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C08531(sql, null), 3, null);
