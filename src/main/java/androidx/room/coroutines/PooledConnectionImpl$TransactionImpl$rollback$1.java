...
@DebugMetadata(c = "androidx.room.coroutines.PooledConnectionImpl$TransactionImpl", f = "ConnectionPoolImpl.kt", i = {0, 0}, l = {568}, m = "rollback", n = {ReactNativeFeatureActivity.RESULT_EXTRA_KEY, "$this$withLock_u24default$iv"}, s = {"L$0", "L$2"})
