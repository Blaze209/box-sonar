...
public final class KClassUtil {
    ...
    public static final <T, C> T findAndInstantiateDatabaseImpl(Class<C> klass, String suffix) {
        ...
        String str = StringsKt.replace$default(canonicalName, '.', SessionDataKt.UNDERSCORE, false, 4, (Object) null) + suffix;
        try {
            ...
            throw new RuntimeException("Cannot find implementation for " + klass.getCanonicalName() + ". " + str + " does not exist. Is Room annotation processor correctly configured?", e);
