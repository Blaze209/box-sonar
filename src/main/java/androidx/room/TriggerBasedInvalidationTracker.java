...
public final class TriggerBasedInvalidationTracker {
    ...
    */
    ...
    public final java.lang.Object stopTrackingTable(androidx.room.PooledConnection r9, int r10, kotlin.coroutines.Continuation<? super kotlin.Unit> r11) {
        /*
            r8 = this;
            boolean r0 = r11 instanceof androidx.room.TriggerBasedInvalidationTracker.C08431
            if (r0 == 0) goto L14
            r0 = r11
            androidx.room.TriggerBasedInvalidationTracker$stopTrackingTable$1 r0 = (androidx.room.TriggerBasedInvalidationTracker.C08431) r0
            int r1 = r0.label
    ...
    /* JADX WARN: Code duplicated, block: B:7:0x0014  */
    public final Object refreshInvalidation$room_runtime(String[] strArr, Function0<Unit> function0, Function0<Unit> function1, Continuation<? super Boolean> continuation) {
        ...
        try {
            if (i == 0) {
                ...
                int[] iArrComponent2 = validateTableNames$room_runtime(strArr).component2();
                function0.invoke();
        ...
        if (i == 0) {
            ...
            if (closeBarrier2.block$room_runtime()) {
                try {
                    ...
                    c08411.L$0 = closeBarrier2;
                    c08411.label = 1;
                    Object objUseConnection = roomDatabase.useConnection(false, triggerBasedInvalidationTracker$notifyInvalidation$2$invalidatedTableIds$1, c08411);
            ...
            closeBarrier = (CloseBarrier) c08411.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (Throwable th2) {
                th = th2;
