...
class DocumentsContractApi19 {
    ...
    public static boolean exists(Context context, Uri uri) {
        ...
        try {
            cursorQuery = MAMContentResolverManagement.query(context.getContentResolver(), uri, new String[]{"document_id"}, null, null, null);
    ...
    private static String queryForString(Context context, Uri uri, String str, String str2) {
        Cursor cursorQuery = null;
        try {
            cursorQuery = MAMContentResolverManagement.query(context.getContentResolver(), uri, new String[]{str}, null, null, null);
    ...
    private static void closeQuietly(AutoCloseable autoCloseable) {
        if (autoCloseable != null) {
            try {
                n70$a$$ExternalSyntheticRecord0.m14051m((Object) autoCloseable);
