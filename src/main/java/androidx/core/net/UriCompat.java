...
public final class UriCompat {
    ...
    public static String toSafeString(Uri uri) {
        ...
        if (scheme != null) {
            if (scheme.equalsIgnoreCase("tel") || scheme.equalsIgnoreCase("sip") || scheme.equalsIgnoreCase(NativeAuthConstants.ChallengeChannel.SMS) || scheme.equalsIgnoreCase("smsto") || scheme.equalsIgnoreCase("mailto") || scheme.equalsIgnoreCase("nfc")) {
