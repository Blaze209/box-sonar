...
public class FileProvider extends MAMContentProvider {
    ...
    private static PathStrategy parsePathStrategy(Context context, String str, int i) throws XmlPullParserException, IOException {
        ...
        XmlResourceParser fileProviderPathsMetaData = getFileProviderPathsMetaData(context, str, MAMPackageManagement.resolveContentProvider(context.getPackageManager(), str, 128), i);
        while (true) {
    ...
    public void attachInfoMAM(Context context, ProviderInfo providerInfo) {
        ...
        String str = providerInfo.authority.split(AuthenticationConstants.Broker.CHALLENGE_REQUEST_CERT_AUTH_DELIMETER)[0];
