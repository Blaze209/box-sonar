...
public class ContextCompat {
    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            map.put(PrintManager.class, Analytics.Event.PRINT);
            ...
            map.put(DownloadManager.class, BoxAmplitudeAnalytics.JobEventPropertyBuilder.JOB_TYPE_DOWNLOAD_JOB);
            ...
            map.put(WifiManager.class, SemanticAttributes.NetHostConnectionTypeValues.WIFI);
