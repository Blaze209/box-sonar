...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    ...
    private Font getFontFromProvider(CancellationSignal cancellationSignal, FontsContractCompat.FontInfo fontInfo, ContentResolver contentResolver) {
        try {
            ParcelFileDescriptor parcelFileDescriptorOpenFileDescriptor = MAMContentResolverManagement.openFileDescriptor(contentResolver, fontInfo.getUri(), "r", cancellationSignal);
