...
public class TypefaceCompatUtil {
    ...
    public static File getTempFile(Context context) {
        ...
        String str = CACHE_FILE_PREFIX + Process.myPid() + CacheKeyValueDelegate.CACHE_VALUE_SEPARATOR + Process.myTid() + CacheKeyValueDelegate.CACHE_VALUE_SEPARATOR;
        for (int i = 0; i < 100; i++) {
    ...
    public static ByteBuffer mmap(Context context, CancellationSignal cancellationSignal, Uri uri) {
        try {
            ParcelFileDescriptor parcelFileDescriptorOpenFileDescriptor = MAMContentResolverManagement.openFileDescriptor(context.getContentResolver(), uri, "r", cancellationSignal);
