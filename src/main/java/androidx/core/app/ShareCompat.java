...
public final class ShareCompat {
    ...
    public static class IntentReader {
        ...
        public Drawable getCallingActivityIcon() {
            ...
            try {
                return MAMPackageManagement.getActivityIcon(this.mContext.getPackageManager(), this.mCallingActivity);
        ...
        public Drawable getCallingApplicationIcon() {
            ...
            try {
                return MAMPackageManagement.getApplicationIcon(this.mContext.getPackageManager(), this.mCallingPackage);
            } catch (PackageManager.NameNotFoundException e) {
        ...
        public CharSequence getCallingApplicationLabel() {
            ...
            try {
                return MAMPackageManagement.getApplicationLabel(packageManager, MAMPackageManagement.getApplicationInfo(packageManager, this.mCallingPackage, 0));
            } catch (PackageManager.NameNotFoundException e) {
