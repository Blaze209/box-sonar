...
public abstract class NotificationCompatSideChannelService extends MAMService {
    ...
    void checkPermission(int i, String str) {
        for (String str2 : MAMPackageManagement.getPackagesForUid(getPackageManager(), i)) {
            if (str2.equals(str)) {
                return;
            }
        }
