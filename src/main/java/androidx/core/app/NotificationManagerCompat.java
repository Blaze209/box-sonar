...
public final class NotificationManagerCompat {
    ...
    public void notify(String str, int i, Notification notification) {
        if (useSideChannelForNotification(notification)) {
            ...
            MAMNotificationManagement.notify(this.mNotificationManager, str, i, notification);
        }
    }
    ...
    private static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        private void updateListenerMap() {
            ...
            List<ResolveInfo> listQueryIntentServices = MAMPackageManagement.queryIntentServices(this.mContext.getPackageManager(), new Intent().setAction(NotificationManagerCompat.ACTION_BIND_SIDE_CHANNEL), 0);
