...
class FontProvider {
    ...
    static ProviderInfo getProvider(PackageManager packageManager, FontRequest fontRequest, Resources resources) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            if (providerInfo == null) {
                ...
                ProviderInfo providerInfoResolveContentProvider = MAMPackageManagement.resolveContentProvider(packageManager, providerAuthority, 0);
                ...
                List<byte[]> listConvertToByteArrayList = convertToByteArrayList(MAMPackageManagement.getPackageInfo(packageManager, providerInfoResolveContentProvider.packageName, 64).signatures);
    ...
    private static class ContentQueryWrapperApi16Impl implements ContentQueryWrapper {
        ...
        ContentQueryWrapperApi16Impl(Context context, Uri uri) {
            this.mClient = MAMContentResolverManagement.acquireUnstableContentProviderClient(context.getContentResolver(), uri);
        }
        ...
        public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2, CancellationSignal cancellationSignal) {
            ...
            try {
                return MAMContentProviderClientManagement.query(contentProviderClient, uri, strArr, str, strArr2, str2, cancellationSignal);
