...
public final class SparseArrayKt {
    ...
    public static final class C07941<T> implements Iterator<T>, KMappedMarker {
        ...
        C07941(SparseArray<T> sparseArray) {
