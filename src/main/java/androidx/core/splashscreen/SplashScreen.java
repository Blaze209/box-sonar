...
public final class SplashScreen {
    ...
    static class Impl {
        ...
        public static final boolean m10198splashScreenWaitPredicate$lambda0() {
            return false;
        }
        ...
        public Impl(Activity activity) {
            ...
            this.splashScreenWaitPredicate = new KeepOnScreenCondition() { // from class: androidx.core.splashscreen.SplashScreen$Impl$$ExternalSyntheticLambda0
                ...
                public final boolean shouldKeepOnScreen() {
                    return SplashScreen.Impl.m10198splashScreenWaitPredicate$lambda0();
                }
            };
        }
        ...
        public final void dispatchOnExitAnimation(final SplashScreenViewProvider splashScreenViewProvider) {
            ...
            splashScreenViewProvider.getView().postOnAnimation(new Runnable() { // from class: androidx.core.splashscreen.SplashScreen$Impl$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    SplashScreen.Impl.m10197dispatchOnExitAnimation$lambda3(splashScreenViewProvider, onExitAnimationListener);
                }
            });
        }
        ...
        public static final void m10197dispatchOnExitAnimation$lambda3(SplashScreenViewProvider splashScreenViewProvider, OnExitAnimationListener finalListener) {
            Intrinsics.checkNotNullParameter(splashScreenViewProvider, "$splashScreenViewProvider");
    ...
    static final class Impl31 extends Impl {
        ...
        public void setOnExitAnimationListener(final OnExitAnimationListener exitAnimationListener) {
            ...
            getActivity().getSplashScreen().setOnExitAnimationListener(new android.window.SplashScreen.OnExitAnimationListener() { // from class: androidx.core.splashscreen.SplashScreen$Impl31$$ExternalSyntheticLambda0
                ...
                public final void onSplashScreenExit(SplashScreenView splashScreenView) {
                    SplashScreen.Impl31.m10199setOnExitAnimationListener$lambda0(this.f$0, exitAnimationListener, splashScreenView);
                }
            });
        }
        ...
        public static final void m10199setOnExitAnimationListener$lambda0(Impl31 this$0, OnExitAnimationListener exitAnimationListener, SplashScreenView splashScreenView) {
        ...
        private final void applyAppSystemUiTheme() {
            ...
            if (theme.resolveAttribute(android.R.attr.windowDrawsSystemBarBackgrounds, typedValue, true)) {
                if (typedValue.data != 0) {
                    ...
                    MAMWindowManagement.clearFlags(window, Integer.MIN_VALUE);
                }
            }
