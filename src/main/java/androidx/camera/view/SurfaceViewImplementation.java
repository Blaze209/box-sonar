...
final class SurfaceViewImplementation extends PreviewViewImplementation {
    ...
    void onSurfaceRequested(final SurfaceRequest surfaceRequest, final PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
        ...
        this.mSurfaceView.post(new Runnable() { // from class: androidx.camera.view.SurfaceViewImplementation$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m307x6305943b(surfaceRequest, onSurfaceNotInUseListener);
            }
        });
    }
    ...
    /* synthetic */ void m307x6305943b(SurfaceRequest surfaceRequest, PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
    ...
    void initializePreview() {
        ...
        MAMSurfaceView mAMSurfaceView = new MAMSurfaceView(this.mParent.getContext());
        this.mSurfaceView = mAMSurfaceView;
        mAMSurfaceView.setLayoutParams(new FrameLayout.LayoutParams(this.mResolution.getWidth(), this.mResolution.getHeight()));
