...
public final class CameraX {
    ...
    private static CameraXConfig.Provider getConfigProvider(Context context) {
        ...
        try {
            ...
            ServiceInfo serviceInfo = MAMPackageManagement.getServiceInfo(applicationContext.getPackageManager(), new ComponentName(applicationContext, (Class<?>) MetadataHolderService.class), 640);
    ...
    /* synthetic */ void m136lambda$initAndRetryRecursively$2$androidxcameracoreCameraX(Context context, final Executor executor, final int i, final CallbackToFutureAdapter.Completer completer, final long j) {
            ...
            try {
                ...
                if (!retryConfigOnRetryDecisionRequested.shouldRetry() || i >= Integer.MAX_VALUE) {
                    ...
                    HandlerCompat.postDelayed(this.mSchedulerHandler, new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m135lambda$initAndRetryRecursively$1$androidxcameracoreCameraX(executor, j, i, applicationContext, completer);
                        }
