...
final class ExifAttribute {
    ...
    /* JADX WARN: Code duplicated, block: B:109:0x014f A[EXC_TOP_SPLITTER, SYNTHETIC] */
                ...
                try {
                    ...
                    switch (this.format) {
                        ...
                        case 6:
                            ...
                            str = (bArr.length == 1 && (b = bArr[0]) >= 0 && b <= 1) ? new String(new char[]{(char) (this.bytes[0] + CtapException.ERR_NOT_ALLOWED)}) : new String(this.bytes, ASCII);
                            break;
                        case 2:
                        case 7:
