...
public class ExifData {
    ...
    public static final class Builder {
        ...
        /* JADX WARN: Switch 'out' block B:99:0x02f8 for B:65:0x01a0 already processed. Defaulting to fallback option. */
            ...
            if (strReplaceAll != null && ExifData.sTagSetForCompatibility.contains(str3)) {
                if (str3.equals(ExifInterface.TAG_GPS_TIMESTAMP)) {
                    ...
                    try {
                        ...
                        Logger.w(ExifData.TAG, "Invalid value for " + str3 + " : " + strReplaceAll, e);
                        return;
                    }
                }
            }
                    ...
                    if (strReplaceAll == null) {
                        ...
                        switch (i3) {
                            case 1:
                                i = i6;
                                i2 = i5;
                                list.get(i7).put(str3, ExifAttribute.createByte(strReplaceAll));
                                continue;
                            case 2:
                            case 7:
                                i = i6;
                                i2 = i5;
                                list.get(i7).put(str3, ExifAttribute.createString(strReplaceAll));
                                continue;
                            case 3:
                                i = i6;
                                i2 = i5;
                                ...
                                for (int i8 = i; i8 < strArrSplit.length; i8++) {
                            ...
                            case 4:
                                ...
                                for (int i9 = i; i9 < strArrSplit2.length; i9++) {
                            ...
                            case 5:
                                ...
                                while (i10 < strArrSplit3.length) {
                                    ...
                                    int i11 = i10;
                                    longRationalArr[i11] = new LongRational((long) Double.parseDouble(strArrSplit4[i]), (long) Double.parseDouble(strArrSplit4[i2]));
                                    i10 = i11 + 1;
                                }
                            ...
                            case 9:
                                ...
                                for (int i12 = i; i12 < strArrSplit5.length; i12++) {
