...
public class QuirkSettingsLoader implements Function<Context, QuirkSettings> {
    ...
    public QuirkSettings apply(Context context) {
        try {
            Bundle bundle = MAMPackageManagement.getServiceInfo(context.getPackageManager(), new ComponentName(context, (Class<?>) MetadataHolderService.class), 640).metaData;
            if (bundle == null) {
    ...
    public static class MetadataHolderService extends MAMService {
