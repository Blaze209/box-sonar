...
final class Camera2CameraImpl implements CameraInternal {
    ...
    /* synthetic */ void m37xb3c15a2c(String str, SessionConfig sessionConfig, UseCaseConfig useCaseConfig, StreamSpec streamSpec, List list) {
    ...
    public void m25x3fc4c78d(Collection<UseCaseInfo> collection) {
        ArrayList arrayList = new ArrayList();
        boolean z = false;
        for (UseCaseInfo useCaseInfo : collection) {
            if (this.mUseCaseAttachState.isUseCaseAttached(useCaseInfo.getUseCaseId())) {
    ...
    /* synthetic */ void m38x83557197(boolean z) {
