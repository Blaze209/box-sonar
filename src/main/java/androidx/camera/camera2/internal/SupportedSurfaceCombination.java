    ...
    Pair<Map<UseCaseConfig<?>, StreamSpec>, Map<AttachedSurfaceInfo, StreamSpec>> getSuggestedStreamSpecifications(int i, List<AttachedSurfaceInfo> list, Map<UseCaseConfig<?>, List<Size>> map, boolean z, boolean z2) {
        ...
        while (true) {
            if (it3.hasNext()) {
                ...
                str2 = str4;
                map6 = map14;
                Pair<List<SurfaceConfig>, Integer> surfaceConfigListAndFpsCeiling2 = getSurfaceConfigListAndFpsCeiling(i, list, next, arrayList, useCasesPriorityOrder, i6, null, null);
                ...
                boolean z6 = targetFpsRange == null || i6 <= iIntValue || iIntValue >= ((Integer) targetFpsRange.getLower()).intValue();
                if (!z4 && checkSupported(featureSettingsCreateFeatureSettings, list8)) {
                    if (i7 == i8 || i7 < iIntValue) {
                        list6 = next;
                        i7 = iIntValue;
                    }
                    if (z6) {
        ...
        if (list4 != null) {
            Range<Integer> closestSupportedDeviceFrameRate = targetFpsRange != null ? getClosestSupportedDeviceFrameRate(targetFpsRange, i4) : null;
            ...
            if (list3 == null || i4 != i5 || list4.size() != list5.size()) {
                map7 = map8;
                break;
            }
            int i10 = 0;
