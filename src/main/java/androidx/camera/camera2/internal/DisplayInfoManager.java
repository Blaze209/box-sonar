...
public class DisplayInfoManager {
    ...
    private static final Size ABNORMAL_DISPLAY_SIZE_THRESHOLD = new Size(BoxRequestsFile.DownloadThumbnail.SIZE_320, PsExtractor.VIDEO_STREAM_MASK);
    private static final Size FALLBACK_DISPLAY_SIZE = new Size(640, WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND);
