...
public class GridLayout extends MAMViewGroup {
    ...
    public GridLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, R.styleable.GridLayout, attributeSet, typedArrayObtainStyledAttributes, i, 0);
        try {
    ...
    int getMargin1(View view, boolean z, boolean z2) {
        ...
        return i == Integer.MIN_VALUE ? getDefaultMargin(view) : i;
    }
    ...
    final class Axis {
        ...
        private String arcsToString(List<Arc> list) {
            ...
            for (Arc arc : list) {
                ...
                sb.append(i < i2 ? str + i2 + CacheKeyValueDelegate.CACHE_VALUE_SEPARATOR + str + i + SimpleComparison.GREATER_THAN_EQUAL_TO_OPERATION + i3 : str + i + CacheKeyValueDelegate.CACHE_VALUE_SEPARATOR + str + i2 + SimpleComparison.LESS_THAN_EQUAL_TO_OPERATION + (-i3));
            }
            return sb.toString();
        }
    ...
    private static Alignment createSwitchingAlignment(final Alignment alignment, final Alignment alignment2) {
        return new Alignment() { // from class: androidx.gridlayout.widget.GridLayout.5
            @Override // androidx.gridlayout.widget.GridLayout.Alignment
            int getGravityOffset(View view, int i) {
                return (view.getLayoutDirection() == 1 ? alignment2 : alignment).getGravityOffset(view, i);
            }

            @Override // androidx.gridlayout.widget.GridLayout.Alignment
            public int getAlignmentValue(View view, int i, int i2) {
                return (view.getLayoutDirection() == 1 ? alignment2 : alignment).getAlignmentValue(view, i, i2);
            }
