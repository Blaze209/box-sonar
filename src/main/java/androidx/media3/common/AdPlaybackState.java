...
public final class AdPlaybackState {
    ...
    public static final class SkipInfo {
        ...
        public SkipInfo(long j, long j2, String str) {
            Preconditions.checkArgument((j == -9223372036854775807L && j2 == -9223372036854775807L && str == null) ? false : true);
            this.skipOffsetUs = j == -9223372036854775807L ? 0L : j;
    ...
    private boolean isPositionBeforeAdGroup(long j, long j2, int i) {
        ...
        if (j3 == Long.MIN_VALUE) {
            return j2 == -9223372036854775807L || adGroup.isLivePostrollPlaceholder() || j < j2;
        }
        return j < j3;
    }
