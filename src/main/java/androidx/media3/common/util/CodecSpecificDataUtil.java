...
public final class CodecSpecificDataUtil {
    ...
    public static byte[] getOpusInitializationData(Format format) {
        ...
        if (string.equals("AOPUSHDR")) {
            ...
            Preconditions.checkArgument(((long) 16) + littleEndianLong <= ((long) bArr.length));
            length = (int) littleEndianLong;
            i = 16;
        } else {
            Preconditions.checkArgument(string.equals("OpusHead"));
        }
    ...
    public static Pair<Integer, Integer> getVideoResolutionFromMpeg4VideoConfig(byte[] bArr) {
        ...
        while (true) {
            ...
            if (parsableByteArray.readUnsignedInt24() == 1 && (bArr[i3] & CtapException.ERR_VENDOR_FIRST) == 32) {
                z = true;
                break;
            }
    ...
    public static Pair<Integer, Integer> getCodecProfileAndLevel(Format format) {
        ...
        switch (str.hashCode()) {
            case 2986313:
                if (!str.equals(CODEC_ID_AC4)) {
                    b = -1;
                }
                break;
            case 3001066:
                b = !str.equals(CODEC_ID_APV1) ? (byte) -1 : (byte) 1;
                break;
            case 3004662:
                b = !str.equals(CODEC_ID_AV01) ? (byte) -1 : (byte) 2;
                break;
            case 3006243:
                b = !str.equals(CODEC_ID_AVC1) ? (byte) -1 : (byte) 3;
                break;
            case 3006244:
                b = !str.equals(CODEC_ID_AVC2) ? (byte) -1 : (byte) 4;
                break;
            case 3199032:
                b = !str.equals(CODEC_ID_HEV1) ? (byte) -1 : (byte) 5;
                break;
            case 3214780:
                b = !str.equals(CODEC_ID_HVC1) ? (byte) -1 : (byte) 6;
                break;
            case 3224753:
                b = !str.equals(CODEC_ID_IAMF) ? (byte) -1 : (byte) 7;
                break;
            case 3356560:
                b = !str.equals(CODEC_ID_MP4A) ? (byte) -1 : (byte) 8;
                break;
            case 3475740:
                b = !str.equals(CODEC_ID_H263) ? (byte) -1 : (byte) 9;
                break;
            case 3624515:
                b = !str.equals(CODEC_ID_VP09) ? (byte) -1 : (byte) 10;
                break;
            case 3631854:
                b = !str.equals(CODEC_ID_VVC1) ? (byte) -1 : (byte) 11;
                break;
            case 3632040:
                b = !str.equals(CODEC_ID_VVI1) ? (byte) -1 : Ascii.FF;
                break;
            default:
                b = -1;
                break;
    ...
    private static Pair<Integer, Integer> getVvcProfileAndLevel(String str, String[] strArr, ColorInfo colorInfo) {
        ...
        try {
            ...
            return new Pair<>(Integer.valueOf(i), numVvcCodecStringToProfileLevel);
    ...
    private static Integer dolbyVisionStringToLevel(String str) {
        ...
        switch (str.hashCode()) {
            ...
            case 1545:
                ...
                break;
            case 1567:
                if (str.equals(GrpcStatusUtil.GRPC_STATUS_ABORTED)) {
                    b = 9;
                }
                break;
            case 1568:
                if (str.equals(GrpcStatusUtil.GRPC_STATUS_OUT_OF_RANGE)) {
                    b = 10;
                }
                break;
            case 1569:
                if (str.equals(GrpcStatusUtil.GRPC_STATUS_UNIMPLEMENTED)) {
                    b = 11;
                }
                break;
            case 1570:
