...
public final class NetworkTypeObserver {
    ...
    private NetworkTypeObserver(final Context context) {
        ...
        executor.execute(new Runnable() { // from class: androidx.media3.common.util.NetworkTypeObserver$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m10341lambda$new$0$androidxmedia3commonutilNetworkTypeObserver(context);
            }
        });
    }
    ...
    public void m10341lambda$new$0$androidxmedia3commonutilNetworkTypeObserver(Context context) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    final class Receiver extends MAMBroadcastReceiver {
        private Receiver() {
        }
        ...
        /* synthetic */ void m10343x90e623c9(Context context) {
        ...
        public void onMAMReceive(final Context context, Intent intent) {
            NetworkTypeObserver.this.backgroundExecutor.execute(new Runnable() { // from class: androidx.media3.common.util.NetworkTypeObserver$Receiver$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m10343x90e623c9(context);
                }
            });
        }
    }
    ...
    final class ListenerHolder {
        ...
        /* synthetic */ void m10342x7c19281b() {
