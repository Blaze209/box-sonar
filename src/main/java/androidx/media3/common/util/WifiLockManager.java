...
public final class WifiLockManager {
    ...
    /* synthetic */ void m10348xfd5ac0b8(boolean z, boolean z2) {
    ...
    /* synthetic */ void m10349x97fb8339(AtomicBoolean atomicBoolean) {
    ...
    /* synthetic */ void m10350x329c45ba(AtomicBoolean atomicBoolean, boolean z, boolean z2) {
    ...
    static final class WifiLockManagerInternal {
        ...
        public void updateWifiLock(boolean z, boolean z2) {
            if (z && this.wifiLock == null) {
                ...
                WifiManager wifiManager = (WifiManager) this.applicationContext.getApplicationContext().getSystemService(SemanticAttributes.NetHostConnectionTypeValues.WIFI);
                if (wifiManager == null) {
        ...
        public void forceReleaseWifiLock(final AtomicBoolean atomicBoolean) {
            if (atomicBoolean.get()) {
                new Thread(new Runnable() { // from class: androidx.media3.common.util.WifiLockManager$WifiLockManagerInternal$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m10351xd91cfc11(atomicBoolean);
                    }
        ...
        public synchronized void m10351xd91cfc11(AtomicBoolean atomicBoolean) {
