...
public final class MediaFormatUtil {
    ...
    private static String getCodecString(MediaFormat mediaFormat) {
        if (Objects.equals(mediaFormat.getString("mime"), MimeTypes.VIDEO_H263) && mediaFormat.containsKey("profile") && mediaFormat.containsKey(FirebaseAnalytics.Param.LEVEL)) {
        ...
        if (Objects.equals(mediaFormat.getString("mime"), MimeTypes.VIDEO_DOLBY_VISION) && mediaFormat.containsKey("profile") && mediaFormat.containsKey(FirebaseAnalytics.Param.LEVEL)) {
            return CodecSpecificDataUtil.buildDolbyVisionCodecString(CodecSpecificDataUtil.dolbyVisionConstantToProfileNumber(mediaFormat.getInteger("profile")), CodecSpecificDataUtil.dolbyVisionConstantToLevelNumber(mediaFormat.getInteger(FirebaseAnalytics.Param.LEVEL)));
        }
