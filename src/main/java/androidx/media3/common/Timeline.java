...
public abstract class Timeline {
    ...
    public static final class Window {
        ...
        public static Window fromBundle(Bundle bundle, int i) {
            ...
            if (bundle2 != null) {
                mediaItemFromBundle = MediaItem.fromBundle(bundle2, i);
            } else {
                mediaItemFromBundle = MediaItem.EMPTY;
            }
            ...
            window.set(FAKE_WINDOW_UID, mediaItem, null, j, j2, j3, z, z2, liveConfigurationFromBundle, j4, j5, i2, i3, j6);
    ...
    public static final class Period {
        ...
        public static Period fromBundle(Bundle bundle, int i) {
            ...
            if (bundle2 != null) {
                adPlaybackStateFromBundle = AdPlaybackState.fromBundle(bundle2, i);
            } else {
                adPlaybackStateFromBundle = AdPlaybackState.NONE;
            }
            Period period = new Period();
            period.set(null, null, i2, j, j2, adPlaybackStateFromBundle, z);
            return period;
        }
    }
    ...
    public static Timeline fromBundle(Bundle bundle, final int i) {
        ImmutableList immutableListFromBundleListRetriever = fromBundleListRetriever(new Function() { // from class: androidx.media3.common.Timeline$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return Timeline.Window.fromBundle((Bundle) obj, i);
            }
        ...
        ImmutableList immutableListFromBundleListRetriever2 = fromBundleListRetriever(new Function() { // from class: androidx.media3.common.Timeline$$ExternalSyntheticLambda1
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return Timeline.Period.fromBundle((Bundle) obj, i);
            }
