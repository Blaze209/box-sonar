    ...
    public static int inferFileTypeFromMimeType(String str) {
        ...
        switch (strNormalizeMimeType.hashCode()) {
            ...
            case 187090232:
                ...
                break;
            case 187091926:
                b = !strNormalizeMimeType.equals(MimeTypes.AUDIO_OGG) ? (byte) -1 : (byte) 22;
                break;
            case 187099443:
                b = !strNormalizeMimeType.equals(MimeTypes.AUDIO_WAV) ? (byte) -1 : (byte) 23;
                break;
            case 1331848029:
                b = !strNormalizeMimeType.equals(MimeTypes.VIDEO_MP4) ? (byte) -1 : Ascii.CAN;
                break;
            case 1503095341:
                b = !strNormalizeMimeType.equals(MimeTypes.AUDIO_AMR_NB) ? (byte) -1 : (byte) 25;
                break;
            case 1504578661:
