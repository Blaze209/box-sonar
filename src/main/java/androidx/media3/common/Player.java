...
public interface Player {
    ...
    public static final class PositionInfo {
        ...
        public static PositionInfo fromBundle(Bundle bundle, int i) {
            ...
            return new PositionInfo(null, iMax, bundle2 == null ? null : MediaItem.fromBundle(bundle2, i), null, Math.max(0, bundle.getInt(FIELD_PERIOD_INDEX, 0)), bundle.getLong(FIELD_POSITION_MS, 0L), bundle.getLong(FIELD_CONTENT_POSITION_MS, 0L), bundle.getInt(FIELD_AD_GROUP_INDEX, -1), bundle.getInt(FIELD_AD_INDEX_IN_AD_GROUP, -1));
        }
    }
