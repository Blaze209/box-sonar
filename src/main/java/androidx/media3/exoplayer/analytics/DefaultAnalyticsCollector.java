...
public class DefaultAnalyticsCollector implements AnalyticsCollector {
    ...
    public void setPlayer(final Player player, Looper looper) {
        ...
        this.listeners = this.listeners.copy(looper, this.clock, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.exoplayer.analytics.DefaultAnalyticsCollector$$ExternalSyntheticLambda16
            ...
            public final void invoke(Object obj, FlagSet flagSet) {
                this.f$0.m10487xb1acc65(player, (AnalyticsListener) obj, flagSet);
            }
        });
    }
    ...
    /* synthetic */ void m10487xb1acc65(Player player, AnalyticsListener analyticsListener, FlagSet flagSet) {
    ...
    public final void onUpstreamDiscarded(int i, MediaSource.MediaPeriodId mediaPeriodId, final MediaLoadData mediaLoadData) {
        final AnalyticsListener.EventTime eventTimeGenerateMediaPeriodEventTime = generateMediaPeriodEventTime(i, mediaPeriodId);
        sendEvent(eventTimeGenerateMediaPeriodEventTime, 1005, new ListenerSet.Event() { // from class: androidx.media3.exoplayer.analytics.DefaultAnalyticsCollector$$ExternalSyntheticLambda60
            @Override // androidx.media3.common.util.ListenerSet.Event
            public final void invoke(Object obj) {
    ...
    public void onDrmKeysLoaded(int i, MediaSource.MediaPeriodId mediaPeriodId, final KeyRequestInfo keyRequestInfo) {
        final AnalyticsListener.EventTime eventTimeGenerateMediaPeriodEventTime = generateMediaPeriodEventTime(i, mediaPeriodId);
        sendEvent(eventTimeGenerateMediaPeriodEventTime, 1023, new ListenerSet.Event() { // from class: androidx.media3.exoplayer.analytics.DefaultAnalyticsCollector$$ExternalSyntheticLambda23
            @Override // androidx.media3.common.util.ListenerSet.Event
            public final void invoke(Object obj) {
