...
public abstract class DownloadService extends MAMService {
    ...
    public int onMAMStartCommand(Intent intent, int i, int i2) {
        ...
        if (this.startedInForeground && (foregroundNotificationUpdater = this.foregroundNotificationUpdater) != null) {
    ...
    final class ForegroundNotificationUpdater {
        ...
        public void update() {
            ...
            if (!this.notificationDisplayed) {
                ...
                MAMNotificationManagement.notify((NotificationManager) DownloadService.this.getSystemService("notification"), this.notificationId, foregroundNotification);
            }
    ...
    static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(final DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new Runnable() { // from class: androidx.media3.exoplayer.offline.DownloadService$DownloadManagerHelper$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m10541xee6ee963(downloadService);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m10541xee6ee963(DownloadService downloadService) {
