...
public final class PlaybackVideoGraphWrapper implements VideoGraph.Listener {
    ...
    private PlaybackVideoGraphWrapper(Builder builder) {
        ...
        this.clock = clock;
        this.earlyThresholdToDropInputUs = builder.lateThresholdToDropInputUs != -9223372036854775807L ? -builder.lateThresholdToDropInputUs : -9223372036854775807L;
    ...
    public boolean registerInput(Format format, int i) throws VideoSink.VideoSinkException {
        ...
        if (i == 0) {
            ...
            try {
                ...
                } else if (!GlUtil.isColorTransferSupported(adjustedInputColorInfo.colorTransfer)) {
                ...
                try {
                    ...
                    if (pair != null) {
                        ...
                        playbackVideoGraphWrapper.maybeSetOutputSurfaceInfo(surface, size.getWidth(), size.getHeight());
                    }
    ...
    /* synthetic */ void m10602x92e2e5d9() {
        this.pendingFlushCount--;
    }
    ...
    final class InputVideoSink implements VideoSink, Listener {
        ...
        public boolean handleInputFrame(long j, VideoSink.VideoFrameHandler videoFrameHandler) {
            ...
            if (jPredictEarlyUs == -9223372036854775807L || PlaybackVideoGraphWrapper.this.earlyThresholdToDropInputUs == -9223372036854775807L || jPredictEarlyUs >= PlaybackVideoGraphWrapper.this.earlyThresholdToDropInputUs || (i = this.consecutiveDroppedFrames) >= 2) {
        ...
        public boolean handleInputBitmap(Bitmap bitmap, TimestampIterator timestampIterator) {
            ...
            Preconditions.checkState(lastTimestampUs != -9223372036854775807L);
        ...
        public void onError(final VideoFrameProcessingException videoFrameProcessingException) {
            ...
            this.listenerExecutor.execute(new Runnable() { // from class: androidx.media3.exoplayer.video.PlaybackVideoGraphWrapper$InputVideoSink$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m10603x167f068a(listener, videoFrameProcessingException);
                }
            });
        }
        ...
        /* synthetic */ void m10603x167f068a(VideoSink.Listener listener, VideoFrameProcessingException videoFrameProcessingException) {
