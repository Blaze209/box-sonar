...
public final class SphericalGLSurfaceView extends MAMGLSurfaceView {
    ...
    /* synthetic */ void m10617x99583d2c() {
    ...
    public void onSurfaceTextureAvailable(final SurfaceTexture surfaceTexture) {
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.video.spherical.SphericalGLSurfaceView$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m10618x24c550f4(surfaceTexture);
            }
        });
    }
    ...
    /* synthetic */ void m10618x24c550f4(SurfaceTexture surfaceTexture) {
