...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    /* synthetic */ void m10556x97cae34d() {
        if (this.released) {
            return;
        }
    ...
    public void prepare(MediaPeriod.Callback callback, long j) throws Throwable {
        this.callback = callback;
        if (this.singleTrackFormat != null) {
            track(this.singleTrackId, 3).format(this.singleTrackFormat);
            m10558x33ac0ff2(new IndexSeekMap(new long[]{0}, new long[]{0}, -9223372036854775807L));
            endTracks();
    ...
    private boolean haveSampleQueuesReachedEndTimeUs() {
        ...
        for (int i = 0; i < this.sampleQueues.length; i++) {
            if (this.trackState.trackEnabledStates[i] && (this.trackState.trackIsAudioVideoFlags[i] || !this.haveAudioVideoTracks)) {
                zHasQueuedTimestampsUpToReadEndTimeUs &= this.sampleQueues[i].hasQueuedTimestampsUpToReadEndTimeUs();
            }
        }
    ...
    public void seekMap(final SeekMap seekMap) {
        this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() throws Throwable {
                this.f$0.m10558x33ac0ff2(seekMap);
            }
        });
    }
    ...
    /* synthetic */ void m10557xa2bd730d() {
    ...
    public void m10558x33ac0ff2(SeekMap seekMap) throws Throwable {
    ...
    public void maybeFinishPrepare() throws Throwable {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            Format formatBuild = (Format) Preconditions.checkNotNull(this.sampleQueues[i4].getUpstreamFormat());
            ...
            if (icyHeaders != null) {
                if (zIsAudio || this.sampleQueueTrackIds[i4].isIcyTrack) {
            ...
            if (i4 != i2) {
                formatCopyWithCryptoType = formatCopyWithCryptoType.buildUpon().setPrimaryTrackGroupId(Integer.toString(i2)).build();
            }
            trackGroupArr[i4] = new TrackGroup(Integer.toString(i4), formatCopyWithCryptoType);
    ...
    final class ExtractingLoadable implements Loader.Loadable, IcyDataSource.Listener {
        ...
        /* JADX WARN: Bottom block not found for handler: all -> 0x0136 */
        @Override // androidx.media3.exoplayer.upstream.Loader.Loadable
        /*
        ...
        */
        ...
        private DataSpec buildDataSpec(long j, String str) {
            ...
            if (str != null && !str.startsWith("W/")) {
                mapBuildKeepingLast = ImmutableMap.builder().putAll(mapBuildKeepingLast).put("If-Range", str).buildKeepingLast();
            }
