...
public final class ConcatenatingMediaSource2 extends CompositeMediaSource<Integer> {
    ...
    public static final class Builder {
        ...
        public Builder add(MediaSource mediaSource, long j) {
            ...
            Preconditions.checkState(((mediaSource instanceof ProgressiveMediaSource) && j == -9223372036854775807L) ? false : true, "Progressive media source must define an initial placeholder duration.");
    ...
    public void m10545x28f9175(Integer num, MediaSource mediaSource, Timeline timeline) {
        scheduleTimelineUpdate();
    }
        ...
        while (i < size) {
            ...
            while (i2 < timeline.getWindowCount()) {
                ...
                while (i3 <= window2.lastPeriodIndex) {
                    ...
                    if (i3 != window2.firstPeriodIndex || ((mediaSourceHolder.index == 0 && i2 == 0) || j7 == -9223372036854775807L)) {
                        j = j7;
                        j2 = 0;
                    } else {
