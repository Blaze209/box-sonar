...
public final class DefaultPreloadManager extends BasePreloadManager<Integer, PreloadStatus> {
    ...
    public static final class PreloadStatus {
        public static final PreloadStatus PRELOAD_STATUS_NOT_PRELOADED = new PreloadStatus(Integer.MIN_VALUE, -9223372036854775807L, 0);
        public static final PreloadStatus PRELOAD_STATUS_SOURCE_PREPARED = new PreloadStatus(0, -9223372036854775807L, 0);
        public static final PreloadStatus PRELOAD_STATUS_TRACKS_SELECTED = new PreloadStatus(1, -9223372036854775807L, 0);
        ...
        private PreloadStatus(int i, long j, long j2) {
            ...
            Preconditions.checkArgument(j2 == -9223372036854775807L || j2 >= 0);
            this.stage = i;
        ...
        public static PreloadStatus specifiedRangeCached(long j) {
            return new PreloadStatus(-1, -9223372036854775807L, j);
        }
    ...
    /* synthetic */ void m10572xa55db43d() {
    ...
    final class PreloadMediaSourceControl implements PreloadMediaSource.PreloadControl {
        ...
        static /* synthetic */ boolean lambda$onContinueLoadingRequested$2(long j, PreloadStatus preloadStatus) {
            return preloadStatus.stage == 2 && preloadStatus.durationMs != -9223372036854775807L && preloadStatus.durationMs > Util.usToMs(j);
        }
