...
public class SampleQueue implements TrackOutput {
    ...
    public final synchronized void setReadEndTimeUs(long j) throws Throwable {
        Throwable th;
        SampleQueue sampleQueue;
        long j2;
        int iFindSampleAfter;
        try {
            try {
                ...
                if (j == Long.MIN_VALUE) {
                    ...
                    if (j <= this.largestQueuedTimestampUs) {
                        sampleQueue = this;
                        j2 = j;
                        iFindSampleAfter = sampleQueue.findSampleAfter(this.relativeFirstIndex, this.length, j2, false);
                    } else {
                        sampleQueue = this;
                        j2 = j;
                        iFindSampleAfter = -1;
                    ...
                    if (iFindSampleAfter != -1) {
                        i = sampleQueue.absoluteFirstIndex + iFindSampleAfter;
                    }
        ...
        try {
            try {
                ...
                if (j3 != Long.MIN_VALUE) {
                    try {
                        jMin = Math.min(this.largestQueuedTimestampUs, j3);
                    } catch (Throwable th2) {
                        th = th2;
                        throw th;
                    }
                ...
                if (hasNextSample() && j >= this.timesUs[relativeIndex] && (j <= jMin || z)) {
    ...
    private synchronized int peekSampleMetadata(FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, boolean z, boolean z2, SampleExtrasHolder sampleExtrasHolder) {
        ...
        if (!z2 && !this.isLastSampleQueued && !z3) {
            Format format2 = this.upstreamFormat;
            if (format2 == null || (!z && format2 == this.downstreamFormat)) {
                return -3;
            }
            onFormatResult((Format) Preconditions.checkNotNull(format2), formatHolder);
            return -5;
        }
