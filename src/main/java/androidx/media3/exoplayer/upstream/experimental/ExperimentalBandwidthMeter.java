...
public final class ExperimentalBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    private static int[] getInitialBitrateCountryGroupAssignment(String str) {
        ...
        switch (str.hashCode()) {
            ...
            case 2150:
                if (str.equals("CI")) {
                    b = CtapException.ERR_NOT_BUSY;
                }
                break;
            case 2152:
                if (str.equals("CK")) {
                    b = CtapException.ERR_NO_OPERATION_PENDING;
                }
                break;
            case 2153:
                if (str.equals("CL")) {
                    b = CtapException.ERR_UNSUPPORTED_OPTION;
                }
                break;
            case 2154:
                if (str.equals("CM")) {
                    b = CtapException.ERR_INVALID_OPTION;
                }
                break;
            case 2155:
                if (str.equals("CN")) {
                    b = CtapException.ERR_KEEPALIVE_CANCEL;
                }
                break;
            case 2156:
                if (str.equals("CO")) {
                    b = CtapException.ERR_NO_CREDENTIALS;
                }
                break;
            case 2159:
                if (str.equals("CR")) {
                    b = CtapException.ERR_USER_ACTION_TIMEOUT;
                }
                break;
            case 2162:
                if (str.equals("CU")) {
                    b = CtapException.ERR_NOT_ALLOWED;
                }
                break;
            case 2163:
                if (str.equals("CV")) {
                    b = CtapException.ERR_PIN_INVALID;
                }
                break;
            case 2164:
                if (str.equals("CW")) {
                    b = CtapException.ERR_PIN_BLOCKED;
                }
                break;
            case 2165:
                if (str.equals("CX")) {
                    b = CtapException.ERR_PIN_AUTH_INVALID;
                }
                break;
            case 2166:
                if (str.equals("CY")) {
                    b = CtapException.ERR_PIN_AUTH_BLOCKED;
                }
                break;
            case 2167:
                if (str.equals("CZ")) {
                    b = CtapException.ERR_PIN_NOT_SET;
                }
                break;
            case 2177:
                if (str.equals("DE")) {
                    b = CtapException.ERR_PIN_REQUIRED;
                }
                break;
            case 2182:
                if (str.equals("DJ")) {
                    b = CtapException.ERR_PIN_POLICY_VIOLATION;
                }
                break;
            case 2183:
                if (str.equals("DK")) {
                    b = CtapException.ERR_PIN_TOKEN_EXPIRED;
                }
                break;
            case 2185:
                if (str.equals("DM")) {
                    b = CtapException.ERR_REQUEST_TOO_LARGE;
                }
                break;
            case 2187:
                if (str.equals("DO")) {
                    b = CtapException.ERR_ACTION_TIMEOUT;
                }
                break;
            case 2198:
                if (str.equals("DZ")) {
                    b = CtapException.ERR_UP_REQUIRED;
                }
                break;
            case 2206:
                if (str.equals("EC")) {
                    b = CtapException.ERR_UV_BLOCKED;
                }
                break;
            case 2208:
                if (str.equals("EE")) {
            ...
            case 2210:
                if (str.equals("EG")) {
                    b = CtapException.ERR_INVALID_SUBCOMMAND;
                }
                break;
            case 2221:
                if (str.equals("ER")) {
            ...
            case 2641:
                if (str.equals("SD")) {
                    b = ByteSourceJsonBootstrapper.UTF8_BOM_2;
                }
                break;
            case 2642:
                if (str.equals("SE")) {
            ...
            case 2725:
                if (str.equals("UZ")) {
                    b = CtapException.ERR_SPEC_LAST;
                }
                break;
            case 2731:
                if (str.equals("VA")) {
                    b = CtapException.ERR_EXTENSION_FIRST;
                }
                break;
            case 2733:
                if (str.equals("VC")) {
        ...
        switch (b) {
            ...
            case 36:
            case BoxCommonConstants.REQUEST_INVITE_COLLABORATORS /* 219 */:
            ...
            case BoxCommonConstants.REQUEST_DELETE_CURRENT_FOLDER /* 222 */:
                return new int[]{2, 1, 1, 2, 1, 2};
            case 223:
                return new int[]{1, 2, 3, 4, 3, 2};
            case 227:
                return new int[]{2, 2, 1, 1, 2, 4};
            case BoxSearchFragment.REQUEST_FILTER_SEARCH_RESULTS /* 228 */:
