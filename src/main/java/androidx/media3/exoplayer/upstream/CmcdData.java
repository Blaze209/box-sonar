    ...
    public static final class Factory {
        ...
        public CmcdData createCmcdData() {
            ...
            if (zIsMediaObjectType) {
                Preconditions.checkState(this.bufferedDurationUs != -9223372036854775807L, "Buffered duration must be set");
                Preconditions.checkState(this.chunkDurationUs != -9223372036854775807L, "Chunk duration must be set");
            }
        ...
        private void validateCustomDataListFormat(List<String> list) {
            ...
            while (it.hasNext()) {
                Preconditions.checkState(CUSTOM_KEY_NAME_PATTERN.matcher(Util.split(it.next(), SimpleComparison.EQUAL_TO_OPERATION)[0]).matches());
            }
        }
    }
    ...
    private static final class CmcdObject {
        ...
        public static final class Builder {
            ...
            public Builder setObjectDurationMs(long j) {
                Preconditions.checkArgument(j >= 0 || j == -9223372036854775807L);
