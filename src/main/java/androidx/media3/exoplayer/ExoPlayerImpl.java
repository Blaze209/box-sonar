...
final class ExoPlayerImpl extends BasePlayer implements ExoPlayer {
    ...
    public ExoPlayerImpl(ExoPlayer.Builder builder, Player player) {
        ...
        try {
            ...
            this.listeners = new ListenerSet<>(looper, clock2, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda18
                @Override // androidx.media3.common.util.ListenerSet.IterationFinishedEvent
                public final void invoke(Object obj, FlagSet flagSet) {
                    this.f$0.m10447lambda$new$0$androidxmedia3exoplayerExoPlayerImpl((Player.Listener) obj, flagSet);
                }
            });
            ...
            this.playbackInfoUpdateHandler = clock2.createHandler(looper, null);
            ExoPlayerImplInternal.PlaybackInfoUpdateListener playbackInfoUpdateListener = new ExoPlayerImplInternal.PlaybackInfoUpdateListener() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda19
                ...
                public final void onPlaybackInfoUpdate(ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
                    this.f$0.m10449lambda$new$2$androidxmedia3exoplayerExoPlayerImpl(playbackInfoUpdate);
                }
            };
            ...
            BackgroundThreadStateHandler<Integer> backgroundThreadStateHandler = new BackgroundThreadStateHandler<>(0, playbackLooper, looper, clock2, new BackgroundThreadStateHandler.StateChangeListener() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda20
            ...
            backgroundThreadStateHandler.runInBackground(new Runnable() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda21
                ...
                public final void run() {
                    this.f$0.m10450lambda$new$3$androidxmedia3exoplayerExoPlayerImpl();
                }
            });
            ...
            if (builder.suppressPlaybackOnUnsuitableOutput) {
                ...
                }, this.applicationContext, looper, playbackLooper, clock3);
                clock3 = clock3;
            } else {
            ...
            if (builder.deviceVolumeControlEnabled) {
                Clock clock4 = clock3;
                clock = clock4;
                this.streamVolumeManager = new StreamVolumeManager(builder.context, this.componentListener, this.audioAttributes.getVolumeControlStream(), playbackLooper, looper, clock4);
            } else {
                clock = clock3;
            ...
            WakeLockManager wakeLockManager = new WakeLockManager(builder.context, r16, clock);
    ...
    /* synthetic */ void m10447lambda$new$0$androidxmedia3exoplayerExoPlayerImpl(Player.Listener listener, FlagSet flagSet) {
    ...
    /* synthetic */ void m10449lambda$new$2$androidxmedia3exoplayerExoPlayerImpl(final ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
        this.playbackInfoUpdateHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m10448lambda$new$1$androidxmedia3exoplayerExoPlayerImpl(playbackInfoUpdate);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$3$androidx-media3-exoplayer-ExoPlayerImpl, reason: not valid java name */
    /* synthetic */ void m10450lambda$new$3$androidxmedia3exoplayerExoPlayerImpl() {
    ...
    public void setAudioSessionId(final int i) {
        ...
        this.audioSessionIdState.updateStateAsync(new Function() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda8
            ...
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return this.f$0.m10451x12b41e76(i, (Integer) obj);
            }
        });
    }
    ...
    /* synthetic */ Integer m10451x12b41e76(int i, Integer num) {
        if (i == 0) {
    ...
    public void m10448lambda$new$1$androidxmedia3exoplayerExoPlayerImpl(ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
        int i;
        long j;
        ...
        if (this.pendingOperationAcks == 0) {
            ...
            if (this.pendingDiscontinuity) {
                boolean z2 = playbackInfoUpdate.playbackInfo.timeline.isEmpty() && this.playbackInfo.timeline.isEmpty();
                boolean zEquals = playbackInfoUpdate.playbackInfo.periodId.equals(this.playbackInfo.periodId);
                boolean z3 = playbackInfoUpdate.playbackInfo.discontinuityStartPositionUs == this.playbackInfo.positionUs;
                if (z2 || (zEquals && z3)) {
                    z = false;
                }
                if (z) {
    ...
    private void updateAvailableCommands() {
        ...
        this.listeners.queueEvent(13, new ListenerSet.Event() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda28
            @Override // androidx.media3.common.util.ListenerSet.Event
            public final void invoke(Object obj) {
                this.f$0.m10453xe2cbb286((Player.Listener) obj);
            }
        });
    }
    ...
    /* synthetic */ void m10453xe2cbb286(Player.Listener listener) {
        ...
        if (playbackInfoMaskTimelineAndPosition.playbackState == 1) {
            ...
            if (!timelineCreateMaskingTimeline.isEmpty()) {
                if (firstWindowIndex == -1) {
                    i2 = playbackInfoMaskTimelineAndPosition.playbackState;
                } else if (firstWindowIndex < timelineCreateMaskingTimeline.getWindowCount()) {
                    i2 = 2;
                }
            }
        }
        PlaybackInfo playbackInfoMaskPlaybackState = maskPlaybackState(playbackInfoMaskTimelineAndPosition, i2);
        this.internalPlayer.setMediaSources(mediaSourceHolders, firstWindowIndex, Util.msToUs(j2), this.shuffleOrder);
    ...
    final class ComponentListener implements VideoRendererEventListener, AudioRendererEventListener, TextOutput, MetadataOutput, SurfaceHolder.Callback, TextureView.SurfaceTextureListener, SphericalGLSurfaceView.VideoSurfaceListener, AudioBecomingNoisyManager.Listener, StreamVolumeManager.Listener, ExoPlayer.AudioOffloadListener, StuckPlayerDetector.Callback {
        ...
        public void onMetadata(final Metadata metadata) {
            ...
            if (!mediaMetadataBuildUpdatedMediaMetadata.equals(ExoPlayerImpl.this.mediaMetadata)) {
                ...
                ExoPlayerImpl.this.listeners.queueEvent(14, new ListenerSet.Event() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$ComponentListener$$ExternalSyntheticLambda3
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
                        this.f$0.m10454x2c83eab9((Player.Listener) obj);
                    }
                });
            }
        ...
        /* synthetic */ void m10454x2c83eab9(Player.Listener listener) {
