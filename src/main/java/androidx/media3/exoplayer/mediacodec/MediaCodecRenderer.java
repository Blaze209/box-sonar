...
public abstract class MediaCodecRenderer extends BaseRenderer {
    private static final byte[] ADAPTATION_WORKAROUND_BUFFER = {0, 0, 1, 103, 66, -64, 11, -38, CtapException.ERR_NO_OPERATIONS, -112, 0, 0, 1, 104, -50, Ascii.SI, 19, 32, 0, 0, 1, 101, -120, -124, Ascii.CR, -50, 113, Ascii.CAN, -96, 0, CtapException.ERR_USER_ACTION_TIMEOUT, ByteSourceJsonBootstrapper.UTF8_BOM_3, Ascii.FS, CtapException.ERR_PIN_INVALID, -61, CtapException.ERR_OPERATION_DENIED, 93, 120};
    ...
    */
        ...
        try {
            mediaCodecAdapter.useInputBuffer(new Runnable() { // from class: androidx.media3.exoplayer.mediacodec.MediaCodecRenderer$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m10533xf3821a9d(formatHolder);
                }
            });
    ...
    /* synthetic */ void m10533xf3821a9d(FormatHolder formatHolder) {
    ...
    protected DecoderReuseEvaluation onInputFormatChanged(FormatHolder formatHolder) throws ExoPlaybackException {
        ...
        boolean z = true;
        this.waitingForFirstSampleInFormat = true;
        Format formatBuild = (Format) Preconditions.checkNotNull(formatHolder.format);
        ...
        if ((Objects.equals(formatBuild.sampleMimeType, MimeTypes.VIDEO_AV1) || Objects.equals(formatBuild.sampleMimeType, MimeTypes.VIDEO_VP9) || (Objects.equals(formatBuild.sampleMimeType, MimeTypes.VIDEO_DOLBY_VISION) && Objects.equals(MediaCodecUtil.getAlternativeCodecMimeType(formatBuild), MimeTypes.VIDEO_AV1))) && !formatBuild.initializationData.isEmpty()) {
        ...
        Format format2 = (Format) Preconditions.checkNotNull(this.codecInputFormat);
    ...
    private boolean drainOutputBuffer(long j, long j2) throws ExoPlaybackException {
        ...
        this.isLastOutputBuffer = this.outputStreamInfo.lastBufferTimeUs != -9223372036854775807L && this.outputStreamInfo.lastBufferTimeUs <= this.outputBufferInfo.presentationTimeUs;
