...
public class DefaultTrackSelector extends MappingTrackSelector implements RendererCapabilities.Listener {
    ...
    protected final Pair<RendererConfiguration[], ExoTrackSelection[]> selectTracks(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, MediaSource.MediaPeriodId mediaPeriodId, Timeline timeline) throws ExoPlaybackException {
        ...
        for (int i = 0; i < rendererCount; i++) {
            rendererConfigurationArr[i] = (parameters.getRendererDisabled(i) || parameters.disabledTrackTypes.contains(Integer.valueOf(mappedTrackInfo.getRendererType(i))) || (mappedTrackInfo.getRendererType(i) != -2 && exoTrackSelectionArrCreateTrackSelections[i] == null)) ? null : RendererConfiguration.DEFAULT;
        }
    ...
    protected void selectAllTracks(ExoTrackSelection.Definition[] definitionArr, MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, Parameters parameters) throws ExoPlaybackException {
        String str;
        Pair<ExoTrackSelection.Definition, Integer> pairSelectTextTrack;
        int rendererCount = mappedTrackInfo.getRendererCount();
        Pair<ExoTrackSelection.Definition, Integer> pairFindDefinitionForType = findDefinitionForType(definitionArr, 1);
        if (pairFindDefinitionForType == null && (pairFindDefinitionForType = selectAudioTrack(mappedTrackInfo, iArr, iArr2, parameters)) != null) {
            definitionArr[((Integer) pairFindDefinitionForType.second).intValue()] = (ExoTrackSelection.Definition) pairFindDefinitionForType.first;
        }
        String str2 = pairFindDefinitionForType == null ? null : ((ExoTrackSelection.Definition) pairFindDefinitionForType.first).group.getFormat(((ExoTrackSelection.Definition) pairFindDefinitionForType.first).tracks[0]).language;
        Pair<ExoTrackSelection.Definition, Integer> pairFindDefinitionForType2 = findDefinitionForType(definitionArr, 2);
        Pair<ExoTrackSelection.Definition, Integer> pairFindDefinitionForType3 = findDefinitionForType(definitionArr, 4);
        ...
        if (findDefinitionForType(definitionArr, 3) == null && (pairSelectTextTrack = selectTextTrack(mappedTrackInfo, iArr, parameters, str)) != null) {
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda8
            ...
            public final List create(int i2, TrackGroup trackGroup, int[] iArr3) {
                return this.f$0.m10595x86684b84(parameters, z, iArr2, i2, trackGroup, iArr3);
            }
    ...
    /* synthetic */ List m10595x86684b84(final Parameters parameters, boolean z, int[] iArr, int i, TrackGroup trackGroup, int[] iArr2) {
        return AudioTrackInfo.createForTrackGroup(i, trackGroup, parameters, iArr2, z, new Predicate() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda5
            ...
            public final boolean apply(Object obj) {
                return this.f$0.m10594x92d8c743(parameters, (Format) obj);
            }
        }, iArr[i]);
    }
    ...
    public boolean m10594x92d8c743(Format format, Parameters parameters) {
        SpatializerWrapper spatializerWrapper;
    ...
    protected void selectMetadataTracks(ExoTrackSelection.Definition[] definitionArr, MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, Parameters parameters) throws ExoPlaybackException {
        ...
        for (int i4 = 0; i4 < mappedTrackInfo.getRendererCount(); i4++) {
            if (mappedTrackInfo.getRendererType(i4) == 5) {
                ExoTrackSelection.Definition definitionSelectOtherTrack = selectOtherTrack(5, trackGroupArray, iArr3, parameters);
                definitionArr[i4] = definitionSelectOtherTrack;
                if (definitionSelectOtherTrack == null) {
                    return;
                } else {
                    Arrays.fill(iArr3[trackGroupArray.indexOf(definitionSelectOtherTrack.group)], RendererCapabilities.create(0));
                }
            }
        }
    }
    ...
    private static ImmutableSet<String> getSelectedPrimaryTrackGroupIds(ExoTrackSelection.Definition[] definitionArr, Parameters parameters) {
        ...
        for (int i = 0; i < definitionArr.length; i++) {
            ...
            if (definition != null && !parameters.getRendererDisabled(i) && !parameters.disabledTrackTypes.contains(Integer.valueOf(definition.group.type))) {
                builder.add(definition.group.id);
                for (int i2 = 0; i2 < definition.tracks.length; i2++) {
                    ...
                    if (format.primaryTrackGroupId != null) {
                        builder.add(format.primaryTrackGroupId);
                    }
                }
            }
        }
    ...
    protected static int getFormatLanguageScore(Format format, String str, boolean z) {
        ...
        return Util.splitAtFirst(strNormalizeUndeterminedLanguageToNull2, CacheKeyValueDelegate.CACHE_VALUE_SEPARATOR)[0].equals(Util.splitAtFirst(strNormalizeUndeterminedLanguageToNull, CacheKeyValueDelegate.CACHE_VALUE_SEPARATOR)[0]) ? 2 : 0;
    }
    ...
    static final class VideoTrackInfo extends TrackInfo<VideoTrackInfo> {
        ...
        public VideoTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3, String str, int i4, boolean z) {
            ...
            for (int i8 = 0; i8 < parameters.preferredVideoMimeTypes.size(); i8++) {
