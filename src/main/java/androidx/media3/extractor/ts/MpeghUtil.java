...
final class MpeghUtil {
    ...
    private static double getResamplingRatio(int i) throws ParserException {
        switch (i) {
            ...
            case 32000:
            case 58800:
            case RecorderService.AUDIO_BIT_RATE /* 64000 */:
                return 1.5d;
            case RecorderService.AUDIO_SAMPLING_RATE /* 44100 */:
    ...
    private static int getSamplingFrequency(int i) throws ParserException {
        switch (i) {
            ...
            case 1:
                return 88200;
            case 2:
                return RecorderService.AUDIO_BIT_RATE;
            case 3:
                return OpusUtil.SAMPLE_RATE;
            case 4:
                return RecorderService.AUDIO_SAMPLING_RATE;
            case 5:
                return 32000;
            case 6:
                return 24000;
