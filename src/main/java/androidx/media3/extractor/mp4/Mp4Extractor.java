...
public final class Mp4Extractor implements Extractor {
    ...
    private void processMoovAtom(Mp4Box.ContainerBox containerBox) throws ParserException {
        ...
        Metadata metadata4 = new Metadata(BoxParser.parseMvhd(((Mp4Box.LeafBox) Preconditions.checkNotNull(containerBox.getLeafBoxOfType(Mp4Box.TYPE_mvhd))).data));
        List<TrackSampleTable> traks = BoxParser.parseTraks(containerBox, gaplessInfoHolder2, -9223372036854775807L, null, (this.flags & 1) != 0, z3, new Function() { // from class: androidx.media3.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda2
        ...
        while (i5 < traks.size()) {
            ...
            if (trackSampleTable.sampleCount == 0) {
                ...
                metadataArr[i3] = metadata4;
                metadataArr[3] = metadata3;
                MetadataUtil.setFormatMetadata(i9, metadata, builderBuildUpon, metadata5, metadataArr);
    ...
    private static long findBestThumbnailPresentationTimeUs(TrackSampleTable trackSampleTable, long j) {
        ...
        return trackSampleTable.timestampsUs[i];
    }
    ...
    private static final class Mp4SeekMap implements TrackAwareSeekMap {
        ...
        public SeekMap.SeekPoints getSeekPoints(long j, int i) {
            ...
            if (i2 != -1) {
                ...
                int synchronizationSampleIndex = Mp4Extractor.getSynchronizationSampleIndex(trackSampleTable, j4);
            ...
            if (i == -1) {
                ...
                while (true) {
                    ...
                    if (i3 != this.firstVideoTrackIndex) {
                        ...
                        jMaybeAdjustSeekOffset = Mp4Extractor.maybeAdjustSeekOffset(trackSampleTable2, j4, jMaybeAdjustSeekOffset);
                        if (j2 != -9223372036854775807L) {
                            jMaybeAdjustSeekOffset2 = Mp4Extractor.maybeAdjustSeekOffset(trackSampleTable2, j2, jMaybeAdjustSeekOffset2);
                        }
                    }
                    i3++;
                }
