...
public final class DvbParser implements SubtitleParser {
    ...
    private static final byte[] defaultMap4To8 = {0, 17, CtapException.ERR_INVALID_CREDENTIAL, CtapException.ERR_PIN_AUTH_INVALID, 68, 85, 102, 119, -120, -103, -86, ByteSourceJsonBootstrapper.UTF8_BOM_2, -52, -35, -18, -1};
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray parsableBitArray, int i) {
        ...
        while (i5 > 0) {
            ...
            double d = bits3;
            double d2 = bits4 + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT;
            double d3 = bits + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT;
