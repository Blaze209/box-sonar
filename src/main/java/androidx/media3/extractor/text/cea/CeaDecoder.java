...
abstract class CeaDecoder implements SubtitleDecoder {
    ...
    public void queueInputBuffer(SubtitleInputBuffer subtitleInputBuffer) throws SubtitleDecoderException {
        ...
        if (!ceaInputBuffer.isEndOfStream() && ceaInputBuffer.timeUs != Long.MIN_VALUE && this.outputStartTimeUs != -9223372036854775807L && ceaInputBuffer.timeUs < this.outputStartTimeUs) {
