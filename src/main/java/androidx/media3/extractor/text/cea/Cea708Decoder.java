...
public final class Cea708Decoder extends CeaDecoder {
    ...
    private void handleG3Character(int i) {
        if (i == 160) {
            ...
            this.currentCueInfoBuilder.append(SessionDataKt.UNDERSCORE);
        }
    }
    ...
    private static final class CueInfoBuilder {
        ...
        public Cea708CueInfo build() {
            ...
            return new Cea708CueInfo(spannableStringBuilder, alignment, f4, 0, i4, f3, i, -3.4028235E38f, this.windowFillColor != COLOR_SOLID_BLACK, this.windowFillColor, this.priority);
        }
