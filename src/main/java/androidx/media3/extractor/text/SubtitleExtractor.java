...
public class SubtitleExtractor implements Extractor {
        ...
        try {
            ...
            this.subtitleParser.parse(this.subtitleData, 0, this.bytesRead, outputOptionsAllCues, new Consumer() { // from class: androidx.media3.extractor.text.SubtitleExtractor$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    this.f$0.m10621xdbba10ad((CuesWithTiming) obj);
                }
            });
    ...
    /* synthetic */ void m10621xdbba10ad(CuesWithTiming cuesWithTiming) {
        ...
        if (this.seekTimeUs == -9223372036854775807L || cuesWithTiming.endTimeUs >= this.seekTimeUs) {
