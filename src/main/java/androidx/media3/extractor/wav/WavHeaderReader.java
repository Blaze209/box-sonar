...
final class WavHeaderReader {
    ...
    private static final byte[] WAVEEXT_SUBFORMAT = {0, 0, 0, 0, Ascii.DLE, 0, -128, 0, 0, -86, 0, CtapException.ERR_PIN_TOKEN_EXPIRED, -101, 113};
    private static final byte[] AMBISONIC_SUBFORMAT = {0, 0, CtapException.ERR_PROCESSING, 7, -45, 17, -122, 68, -56, -63, -54, 0, 0, 0};
