...
final class HeicMotionPhotoExtractor implements Extractor {
    ...
    private boolean readAtomHeader(ExtractorInput extractorInput) throws IOException {
        ...
        if (this.atomType == 1836086884) {
            ...
            MotionPhotoMetadata motionPhotoMetadata = new MotionPhotoMetadata(0L, position - ((long) this.atomHeaderBytesRead), -9223372036854775807L, this.mp4StartPosition, this.atomSize - ((long) this.atomHeaderBytesRead));
