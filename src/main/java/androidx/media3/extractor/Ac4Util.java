...
public final class Ac4Util {
    ...
    private static final int[] SAMPLE_COUNT = {2002, 2000, 1920, 1601, 1600, 1001, 1000, 960, HubAssetRemoteDataSource.HUB_BANNER_SCALED_SIZE, HubAssetRemoteDataSource.HUB_BANNER_SCALED_SIZE, WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND, 400, 400, 2048};
    ...
    public static Format parseAc4AnnexEFormat(ParsableByteArray parsableByteArray, String str, String str2, DrmInitData drmInitData) throws ParserException {
        ...
        int i5 = parsableBitArray.readBit() ? OpusUtil.SAMPLE_RATE : RecorderService.AUDIO_SAMPLING_RATE;
        ...
        while (true) {
            if (i6 < bits7) {
                ...
                if (bit || z || bits != 6) {
                    ...
                    if (!bit && !z) {
                        ...
                        if (bits == 0 || bits == 1 || bits == 2) {
                            ...
                            for (int i15 = 0; i15 < bits12 + 2; i15++) {
                                parseDsiSubstreamGroup(parsableBitArray, ac4Presentation);
                            }
                        }
                    } else if (bits2 == 0) {
                ...
                parsableBitArray.byteAlign();
                if (bits5 == 1) {
                    int iBitsLeft3 = ((iBitsLeft - parsableBitArray.bitsLeft()) / 8) - i3;
                    if (bits3 < iBitsLeft3) {
            ...
            if (ac4Presentation.isChannelCoded) {
                ...
                int i18 = ac4Presentation.numOfUmxObjects + 1;
            ...
            return new Format.Builder().setId(str).setSampleMimeType(MimeTypes.AUDIO_AC4).setChannelCount(adjustedChannelCount).setSampleRate(i5).setDrmInitData(drmInitData).setLanguage(str2).setCodecs(createCodecsString(bits6, ac4Presentation.version, ac4Presentation.level)).build();
        }
    }
    ...
    public static SyncFrameInfo parseAc4SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        boolean bit = parsableBitArray.readBit();
        int i7 = RecorderService.AUDIO_SAMPLING_RATE;
        if (bit) {
            i7 = 48000;
        }
