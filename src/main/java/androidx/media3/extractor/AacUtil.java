...
public final class AacUtil {
    ...
    private static final int[] AUDIO_SPECIFIC_CONFIG_SAMPLING_RATE_TABLE = {96000, 88200, RecorderService.AUDIO_BIT_RATE, OpusUtil.SAMPLE_RATE, RecorderService.AUDIO_SAMPLING_RATE, 32000, 24000, 22050, AAC_HE_V1_MAX_RATE_BYTES_PER_SECOND, 12000, 11025, 8000, 7350};
