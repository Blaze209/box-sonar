...
public interface HttpDataSource extends DataSource {
    ...
    static /* synthetic */ boolean lambda$static$0(String str) {
        ...
        return (TextUtils.isEmpty(lowerCase) || (lowerCase.contains("text") && !lowerCase.contains(MimeTypes.TEXT_VTT)) || lowerCase.contains(TextRecognitionConverter.Tags.HTML) || lowerCase.contains("xml")) ? false : true;
    }
