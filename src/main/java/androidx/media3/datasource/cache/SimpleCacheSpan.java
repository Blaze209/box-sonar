...
final class SimpleCacheSpan extends CacheSpan {
    ...
    public static SimpleCacheSpan createCacheEntry(File file, long j, long j2, CachedContentIndex cachedContentIndex) {
        ...
        return new SimpleCacheSpan(keyForId, Long.parseLong((String) Preconditions.checkNotNull(matcher.group(2))), j3, j2 == -9223372036854775807L ? Long.parseLong((String) Preconditions.checkNotNull(matcher.group(3))) : j2, file2);
    }
