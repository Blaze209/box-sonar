...
public final class PlaybackStateCompat implements Parcelable {
    ...
    PlaybackStateCompat(Parcel parcel) {
        ...
        this.customActions = listCreateTypedArrayList == null ? ImmutableList.of() : listCreateTypedArrayList;
    ...
    public static final class CustomAction implements Parcelable {
        ...
        CustomAction(Parcel parcel) {
            this.action = (String) Preconditions.checkNotNull(parcel.readString());
            this.name = (CharSequence) Preconditions.checkNotNull((CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(parcel));
