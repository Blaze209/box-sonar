...
class MediaBrowserImplBase extends MediaControllerImplBase implements MediaBrowser.MediaBrowserImpl {
    ...
    MediaBrowserImplBase(Context context, MediaBrowser mediaBrowser, SessionToken sessionToken, Bundle bundle, Looper looper, boolean z) {
        super(context, mediaBrowser, sessionToken, bundle, looper, z);
        ...
        if (isConnected()) {
            getInstance().notifyBrowserListener(new Consumer() { // from class: androidx.media3.session.MediaBrowserImplBase$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    this.f$0.m10638x7271beb5(str, i, libraryParams, (MediaBrowser.Listener) obj);
                }
            });
        }
    }
    ...
    /* synthetic */ void m10638x7271beb5(String str, int i, MediaLibraryService.LibraryParams libraryParams, MediaBrowser.Listener listener) {
    ...
    public void notifyChildrenChanged(final String str, final int i, final MediaLibraryService.LibraryParams libraryParams) {
        if (isConnected()) {
            getInstance().notifyBrowserListener(new Consumer() { // from class: androidx.media3.session.MediaBrowserImplBase$$ExternalSyntheticLambda1
                @Override // androidx.media3.common.util.Consumer
                public final void accept(Object obj) {
                    this.f$0.m10637x606d39ee(str, i, libraryParams, (MediaBrowser.Listener) obj);
                }
            });
        }
    }
    ...
    /* synthetic */ void m10637x606d39ee(String str, int i, MediaLibraryService.LibraryParams libraryParams, MediaBrowser.Listener listener) {
