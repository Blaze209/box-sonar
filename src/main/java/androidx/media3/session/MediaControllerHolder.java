...
class MediaControllerHolder<T extends MediaController> extends AbstractFuture<T> implements MediaController.ConnectionCallback {
    ...
    /* synthetic */ void m10645xf63780e5(Runnable runnable) {
