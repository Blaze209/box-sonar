...
class PlayerInfo {
    ...
    public static class Builder {
        ...
        public PlayerInfo build() {
            Preconditions.checkState(this.timeline.isEmpty() || this.sessionPositionInfo.positionInfo.mediaItemIndex < this.timeline.getWindowCount());
    ...
    public PlayerInfo copyWithAudioSessionId(int i) {
        return new Builder(this).setAudioSessionId(i).build();
    }
    ...
    public PlayerInfo copyWithUnmuteVolume(float f) {
        return new Builder(this).setUnmuteVolume(f).build();
    }
    ...
    public Bundle toBundleForRemoteProcess(int i) {
        ...
        if (!this.timeline.equals(Timeline.EMPTY)) {
            bundle.putBundle(FIELD_TIMELINE, this.timeline.toBundle(i));
        }
        ...
        if (!this.playlistMetadata.equals(MediaMetadata.EMPTY)) {
            bundle.putBundle(FIELD_PLAYLIST_METADATA, this.playlistMetadata.toBundle(i));
        }
        float f = this.volume;
        if (f != 1.0f) {
            bundle.putFloat(FIELD_VOLUME, f);
        }
        float f2 = this.unmuteVolume;
        if (f2 != 1.0f) {
            bundle.putFloat(FIELD_UNMUTE_VOLUME, f2);
        }
        int i6 = this.audioSessionId;
        if (i6 != 0) {
            bundle.putInt(FIELD_AUDIO_SESSION_ID, i6);
        }
    ...
    public static PlayerInfo fromBundle(Bundle bundle, int i) {
        ...
        if (bundle3 == null) {
            ...
            sessionPositionInfoFromBundle = SessionPositionInfo.fromBundle(bundle3, i);
        }
        ...
        if (bundle4 == null) {
            ...
            positionInfoFromBundle = Player.PositionInfo.fromBundle(bundle4, i);
        }
        ...
        if (bundle5 == null) {
            ...
            positionInfoFromBundle2 = Player.PositionInfo.fromBundle(bundle5, i);
        }
        ...
        if (bundle7 == null) {
            timelineFromBundle = Timeline.EMPTY;
        } else {
            timelineFromBundle = Timeline.fromBundle(bundle7, i);
        }
        Timeline timeline = timelineFromBundle;
        ...
        if (bundle9 == null) {
            ...
            mediaMetadataFromBundle = MediaMetadata.fromBundle(bundle9, i);
        }
        MediaMetadata mediaMetadata = mediaMetadataFromBundle;
        float f = bundle.getFloat(FIELD_VOLUME, 1.0f);
        float f2 = bundle.getFloat(FIELD_UNMUTE_VOLUME, 1.0f);
        int i6 = bundle.getInt(FIELD_AUDIO_SESSION_ID, 0);
        ...
        if (bundle13 == null) {
            ...
            mediaMetadataFromBundle2 = MediaMetadata.fromBundle(bundle13, i);
        }
        ...
        if (bundle15 == null) {
            trackSelectionParametersFromBundle = TrackSelectionParameters.DEFAULT;
        } else {
            trackSelectionParametersFromBundle = TrackSelectionParameters.fromBundle(bundle15);
        }
        return new PlayerInfo(playbackExceptionFromBundle, i2, sessionPositionInfo, positionInfo, positionInfo2, i3, playbackParameters, i4, z, videoSizeFromBundle, timeline, i5, mediaMetadata, f, f2, audioAttributes, i6, cueGroupFromBundle, deviceInfoFromBundle, i7, z2, z3, i8, i9, i10, z4, z5, mediaMetadata2, j, j2, j3, tracksFromBundle, trackSelectionParametersFromBundle);
    }
