...
public final class MediaConstants {
    ...
    public static final String CUSTOM_COMMAND_DOWNLOAD = "android.support.v4.media.action.DOWNLOAD";
    ...
    public static final String EXTRAS_KEY_DOWNLOAD_PROGRESS = "android.media.browse.extra.DOWNLOAD_PROGRESS";
    ...
    static final String SESSION_COMMAND_MEDIA3_CHANGE_REQUEST = "androidx.media3.session.SESSION_COMMAND_MEDIA3_PLAY_REQUEST";
