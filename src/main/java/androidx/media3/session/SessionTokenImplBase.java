...
final class SessionTokenImplBase implements SessionToken.SessionTokenImpl {
    ...
    private final android.media.session.MediaSession.Token platformToken;
    ...
    public SessionTokenImplBase(ComponentName componentName, int i, int i2) {
        this(i, i2, 1000000, 0, ((ComponentName) Preconditions.checkNotNull(componentName)).getPackageName(), componentName.getClassName(), componentName, null, Bundle.EMPTY, null);
    }

    public SessionTokenImplBase(int i, int i2, int i3, int i4, String str, IMediaSession iMediaSession, Bundle bundle, android.media.session.MediaSession.Token token) {
        this(i, i2, i3, i4, (String) Preconditions.checkNotNull(str), "", null, iMediaSession.asBinder(), (Bundle) Preconditions.checkNotNull(bundle), token);
    }

    private SessionTokenImplBase(int i, int i2, int i3, int i4, String str, String str2, ComponentName componentName, IBinder iBinder, Bundle bundle, android.media.session.MediaSession.Token token) {
        this.uid = i;
        this.type = i2;
    ...
    public static SessionTokenImplBase fromBundle(Bundle bundle, android.media.session.MediaSession.Token token) {
        ...
        android.media.session.MediaSession.Token token2 = (android.media.session.MediaSession.Token) bundle.getParcelable(FIELD_PLATFORM_TOKEN);
        android.media.session.MediaSession.Token token3 = token2 != null ? token2 : token;
        if (bundleConvertToNullIfInvalid == null) {
            bundleConvertToNullIfInvalid = Bundle.EMPTY;
        }
        return new SessionTokenImplBase(i, i2, i3, i4, string, string2, componentName, binder, bundleConvertToNullIfInvalid, token3);
    }
}
