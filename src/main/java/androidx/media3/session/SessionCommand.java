...
public final class SessionCommand {
    ...
    public SessionCommand(int i) {
        Preconditions.checkArgument(i != 0, "commandCode shouldn't be COMMAND_CODE_CUSTOM");
        this.commandCode = i;
        this.customAction = "";
    ...
    public SessionCommand(String str, Bundle bundle) {
        this.commandCode = 0;
        this.customAction = (String) Preconditions.checkNotNull(str);
        this.customExtras = new Bundle((Bundle) Preconditions.checkNotNull(bundle));
    }
    ...
    public static SessionCommand fromBundle(Bundle bundle) {
        ...
        String str = (String) Preconditions.checkNotNull(bundle.getString(FIELD_CUSTOM_ACTION));
        ...
        return new SessionCommand(str, bundleConvertToNullIfInvalid);
    }
}
