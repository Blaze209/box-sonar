...
public final class TrackSelectionDialogBuilder {
    ...
    private Dialog buildForPlatform() {
        MAMAlertDialogBuilder mAMAlertDialogBuilder = new MAMAlertDialogBuilder(this.context, this.themeResId);
        View viewInflate = LayoutInflater.from(mAMAlertDialogBuilder.getContext()).inflate(R.layout.exo_track_selection_dialog, (ViewGroup) null);
        return mAMAlertDialogBuilder.setTitle(this.title).setView(viewInflate).setPositiveButton(android.R.string.ok, setUpDialogView(viewInflate)).setNegativeButton(android.R.string.cancel, (DialogInterface.OnClickListener) null).create();
    }
    ...
    private Dialog buildForAndroidX() {
        try {
            ...
            return (Dialog) cls.getMethod(PasskeyWebListener.CREATE_UNIQUE_KEY, new Class[0]).invoke(objNewInstance, new Object[0]);
    ...
    private DialogInterface.OnClickListener setUpDialogView(View view) {
        ...
        return new DialogInterface.OnClickListener() { // from class: androidx.media3.ui.TrackSelectionDialogBuilder$$ExternalSyntheticLambda0
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.m10880xc121951d(trackSelectionView, dialogInterface, i);
            }
        };
    }
    ...
    /* synthetic */ void m10880xc121951d(TrackSelectionView trackSelectionView, DialogInterface dialogInterface, int i) {
