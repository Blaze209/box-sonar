        ...
        try {
            ...
            while (entry != null) {
                ...
                while (i2 < 3 && !z) {
                    ...
                    Log.i(TAG, "Extraction " + (z ? TelemetryEventStrings.Value.SUCCEEDED : TelemetryEventStrings.Value.FAILED) + " '" + extractedDex.getAbsolutePath() + "': length " + extractedDex.length() + " - crc: " + extractedDex.crc);
                    if (!z) {
                        extractedDex.delete();
