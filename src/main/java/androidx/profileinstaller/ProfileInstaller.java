...
public class ProfileInstaller {
    ...
    static void writeSkipFile(Context context, Executor executor, DiagnosticsCallback diagnosticsCallback) {
        try {
            noteProfileWrittenFor(MAMPackageManagement.getPackageInfo(context.getPackageManager(), context.getApplicationContext().getPackageName(), 0), context.getFilesDir());
