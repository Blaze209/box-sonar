...
public abstract class TrustedWebActivityService extends MAMService {
    ...
    private final ITrustedWebActivityService.Stub mBinder = new ITrustedWebActivityService.Stub() { // from class: androidx.browser.trusted.TrustedWebActivityService.1
        ...
        private void checkCaller() {
            if (TrustedWebActivityService.this.mVerifiedUid == -1) {
                String[] packagesForUid = MAMPackageManagement.getPackagesForUid(TrustedWebActivityService.this.getPackageManager(), getCallingUid());
    ...
    public boolean onNotifyNotificationWithChannel(String str, int i, Notification notification, String str2) {
        ...
        MAMNotificationManagement.notify(this.mNotificationManager, str, i, notificationCopyNotificationOntoChannel);
        return true;
    }
    ...
    public int onGetSmallIconId() {
        try {
            ServiceInfo serviceInfo = MAMPackageManagement.getServiceInfo(getPackageManager(), new ComponentName(this, getClass()), 128);
