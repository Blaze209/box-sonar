...
public class BrowserActionsIntent {
    ...
    public static final class Builder {
        ...
        public BrowserActionsIntent build() {
            ...
            this.mIntent.putExtra(BrowserActionsIntent.EXTRA_APP_ID, MAMPendingIntent.getActivity(this.mContext, 0, new Intent(), 67108864));
    ...
    static void launchIntent(Context context, Intent intent, List<ResolveInfo> list) {
        ...
        if (list.size() == 1) {
            ...
            ResolveInfo resolveInfoResolveActivity = MAMPackageManagement.resolveActivity(context.getPackageManager(), new Intent("android.intent.action.VIEW", Uri.parse(TEST_URL)), 65536);
    ...
    public static List<ResolveInfo> getBrowserActionsIntentHandlers(Context context) {
        return MAMPackageManagement.queryIntentActivities(context.getPackageManager(), new Intent(ACTION_BROWSER_ACTIONS_OPEN, Uri.parse(TEST_URL)), 131072);
    }
