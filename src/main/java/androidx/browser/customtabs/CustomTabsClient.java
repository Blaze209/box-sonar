...
public class CustomTabsClient {
    ...
    public static String getPackageName(Context context, List<String> list, boolean z) {
        ...
        if (!z && (resolveInfoResolveActivity = MAMPackageManagement.resolveActivity(packageManager, intent, 0)) != null) {
    ...
    private static PendingIntent createSessionId(Context context, int i) {
        return MAMPendingIntent.getActivity(context, i, new Intent(), 67108864);
    }
