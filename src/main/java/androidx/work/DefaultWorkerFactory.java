...
public final class DefaultWorkerFactory extends WorkerFactory {
    ...
    public Void m11129createWorker(Context appContext, String workerClassName, WorkerParameters workerParameters) {
    ...
    public /* bridge */ /* synthetic */ ListenableWorker createWorker(Context context, String str, WorkerParameters workerParameters) {
        return (ListenableWorker) m11129createWorker(context, str, workerParameters);
    }
