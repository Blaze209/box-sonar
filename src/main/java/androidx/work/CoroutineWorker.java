...
public abstract class CoroutineWorker extends ListenableWorker {
    ...
    public final ListenableFuture<ListenableWorker.Result> startWork() {
        ...
        return ListenableFutureKt.launchFuture$default(workerContext.plus(JobKt__JobKt.Job$default((Job) null, 1, (Object) null)), null, new C08641(null), 2, null);
    }
    ...
    static final class C08641 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ListenableWorker.Result>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return CoroutineWorker.this.new C08641(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ListenableWorker.Result> continuation) {
            return ((C08641) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    private static final class DeprecatedDispatcher extends CoroutineDispatcher {
        ...
        public void mo16386dispatch(CoroutineContext context, Runnable block) {
            ...
            dispatcher.mo16386dispatch(context, block);
        }
