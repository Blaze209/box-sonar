...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m14948boximpl(ULong.m14954constructorimpl(getMostSignificantBits())), ULong.m14948boximpl(ULong.m14954constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m16298toUByteArrayTcUX1vc() {
        return UByteArray.m14851constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m14954constructorimpl(j), ULong.m14954constructorimpl(other.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m14954constructorimpl(this.leastSignificantBits), ULong.m14954constructorimpl(other.leastSignificantBits));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m16300fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m16299fromUByteArrayGBYM_sE(byte[] ubyteArray) {
