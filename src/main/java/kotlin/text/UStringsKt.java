...
public final class UStringsKt {
    ...
    public static final String m16141toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m16143toStringolVBNx4(short s, int i) {
    ...
    public static final String m16142toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m16140toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m14875constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m14792boximpl(UByte.m14798constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m14875constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m15055boximpl(UShort.m15061constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM14875constructorimpl = UInt.m14875constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM14875constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM14875constructorimpl2 = UInt.m14875constructorimpl(i3 * iM14875constructorimpl);
            int iM14875constructorimpl3 = UInt.m14875constructorimpl(UInt.m14875constructorimpl(iDigitOf) + iM14875constructorimpl2);
            if (Integer.compareUnsigned(iM14875constructorimpl3, iM14875constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM14875constructorimpl3;
        }
        return UInt.m14869boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM14954constructorimpl = ULong.m14954constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM14954constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM14954constructorimpl2 = ULong.m14954constructorimpl(j * jM14954constructorimpl);
            long jM14954constructorimpl3 = ULong.m14954constructorimpl(ULong.m14954constructorimpl(((long) UInt.m14875constructorimpl(iDigitOf)) & 4294967295L) + jM14954constructorimpl2);
            if (Long.compareUnsigned(jM14954constructorimpl3, jM14954constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM14954constructorimpl3;
        }
        return ULong.m14948boximpl(j);
    }
}
