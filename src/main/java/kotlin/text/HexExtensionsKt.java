...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        if (0 > j || j > SieveCacheKt.NodeLinkMask) {
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m15000toStringimpl(ULong.m14954constructorimpl(j))));
        }
        return (int) j;
    }
