...
public class UComparisonsKt___UComparisonsKt {
    ...
    public static final int m15974maxOfJ1ME1BU(int i, int i2) {
        return Integer.compareUnsigned(i, i2) >= 0 ? i : i2;
    }

    /* JADX INFO: renamed from: maxOf-eb3DHEI, reason: not valid java name */
    public static final long m15982maxOfeb3DHEI(long j, long j2) {
        return Long.compareUnsigned(j, j2) >= 0 ? j : j2;
    }

    /* JADX INFO: renamed from: maxOf-Kr8caGY, reason: not valid java name */
    public static final byte m15975maxOfKr8caGY(byte b, byte b2) {
        return Intrinsics.compare(b & 255, b2 & 255) >= 0 ? b : b2;
    }

    /* JADX INFO: renamed from: maxOf-5PvTz6A, reason: not valid java name */
    public static final short m15973maxOf5PvTz6A(short s, short s2) {
        return Intrinsics.compare(s & UShort.MAX_VALUE, 65535 & s2) >= 0 ? s : s2;
    }

    /* JADX INFO: renamed from: maxOf-WZ9TVnA, reason: not valid java name */
    private static final int m15979maxOfWZ9TVnA(int i, int i2, int i3) {
        return UComparisonsKt.m15974maxOfJ1ME1BU(i, UComparisonsKt.m15974maxOfJ1ME1BU(i2, i3));
    }

    /* JADX INFO: renamed from: maxOf-sambcqE, reason: not valid java name */
    private static final long m15983maxOfsambcqE(long j, long j2, long j3) {
        return UComparisonsKt.m15982maxOfeb3DHEI(j, UComparisonsKt.m15982maxOfeb3DHEI(j2, j3));
    }

    /* JADX INFO: renamed from: maxOf-b33U2AM, reason: not valid java name */
    private static final byte m15981maxOfb33U2AM(byte b, byte b2, byte b3) {
        return UComparisonsKt.m15975maxOfKr8caGY(b, UComparisonsKt.m15975maxOfKr8caGY(b2, b3));
    }

    /* JADX INFO: renamed from: maxOf-VKSA0NQ, reason: not valid java name */
    private static final short m15978maxOfVKSA0NQ(short s, short s2, short s3) {
        return UComparisonsKt.m15973maxOf5PvTz6A(s, UComparisonsKt.m15973maxOf5PvTz6A(s2, s3));
    }

    /* JADX INFO: renamed from: maxOf-Md2H83M, reason: not valid java name */
    public static final int m15976maxOfMd2H83M(int i, int... iArr) {
        ...
        for (int i2 = 0; i2 < iM14936getSizeimpl; i2++) {
            i = UComparisonsKt.m15974maxOfJ1ME1BU(i, UIntArray.m14935getpVg5ArA(iArr, i2));
        }
        return i;
    }

    /* JADX INFO: renamed from: maxOf-R03FKyM, reason: not valid java name */
    public static final long m15977maxOfR03FKyM(long j, long... jArr) {
        ...
        for (int i = 0; i < iM15015getSizeimpl; i++) {
            j = UComparisonsKt.m15982maxOfeb3DHEI(j, ULongArray.m15014getsVKNKU(jArr, i));
        }
        return j;
    }

    /* JADX INFO: renamed from: maxOf-Wr6uiD8, reason: not valid java name */
    public static final byte m15980maxOfWr6uiD8(byte b, byte... bArr) {
        ...
        for (int i = 0; i < iM14857getSizeimpl; i++) {
            b = UComparisonsKt.m15975maxOfKr8caGY(b, UByteArray.m14856getw2LRezQ(bArr, i));
        }
        return b;
    }

    /* JADX INFO: renamed from: maxOf-t1qELG4, reason: not valid java name */
    public static final short m15984maxOft1qELG4(short s, short... sArr) {
        ...
        for (int i = 0; i < iM15120getSizeimpl; i++) {
            s = UComparisonsKt.m15973maxOf5PvTz6A(s, UShortArray.m15119getMh2AYeg(sArr, i));
        }
        return s;
    }

    /* JADX INFO: renamed from: minOf-J1ME1BU, reason: not valid java name */
    public static final int m15986minOfJ1ME1BU(int i, int i2) {
        return Integer.compareUnsigned(i, i2) <= 0 ? i : i2;
    }

    /* JADX INFO: renamed from: minOf-eb3DHEI, reason: not valid java name */
    public static final long m15994minOfeb3DHEI(long j, long j2) {
        return Long.compareUnsigned(j, j2) <= 0 ? j : j2;
    }

    /* JADX INFO: renamed from: minOf-Kr8caGY, reason: not valid java name */
    public static final byte m15987minOfKr8caGY(byte b, byte b2) {
        return Intrinsics.compare(b & 255, b2 & 255) <= 0 ? b : b2;
    }

    /* JADX INFO: renamed from: minOf-5PvTz6A, reason: not valid java name */
    public static final short m15985minOf5PvTz6A(short s, short s2) {
        return Intrinsics.compare(s & UShort.MAX_VALUE, 65535 & s2) <= 0 ? s : s2;
    }

    /* JADX INFO: renamed from: minOf-WZ9TVnA, reason: not valid java name */
    private static final int m15991minOfWZ9TVnA(int i, int i2, int i3) {
        return UComparisonsKt.m15986minOfJ1ME1BU(i, UComparisonsKt.m15986minOfJ1ME1BU(i2, i3));
    }

    /* JADX INFO: renamed from: minOf-sambcqE, reason: not valid java name */
    private static final long m15995minOfsambcqE(long j, long j2, long j3) {
        return UComparisonsKt.m15994minOfeb3DHEI(j, UComparisonsKt.m15994minOfeb3DHEI(j2, j3));
    }

    /* JADX INFO: renamed from: minOf-b33U2AM, reason: not valid java name */
    private static final byte m15993minOfb33U2AM(byte b, byte b2, byte b3) {
        return UComparisonsKt.m15987minOfKr8caGY(b, UComparisonsKt.m15987minOfKr8caGY(b2, b3));
    }

    /* JADX INFO: renamed from: minOf-VKSA0NQ, reason: not valid java name */
    private static final short m15990minOfVKSA0NQ(short s, short s2, short s3) {
        return UComparisonsKt.m15985minOf5PvTz6A(s, UComparisonsKt.m15985minOf5PvTz6A(s2, s3));
    }

    /* JADX INFO: renamed from: minOf-Md2H83M, reason: not valid java name */
    public static final int m15988minOfMd2H83M(int i, int... iArr) {
        Intrinsics.checkNotNullParameter(iArr, "$v$c$kotlin-UIntArray$-other$0");
        int iM14936getSizeimpl = UIntArray.m14936getSizeimpl(iArr);
        for (int i2 = 0; i2 < iM14936getSizeimpl; i2++) {
            i = UComparisonsKt.m15986minOfJ1ME1BU(i, UIntArray.m14935getpVg5ArA(iArr, i2));
        }
        return i;
    }

    /* JADX INFO: renamed from: minOf-R03FKyM, reason: not valid java name */
    public static final long m15989minOfR03FKyM(long j, long... jArr) {
        Intrinsics.checkNotNullParameter(jArr, "$v$c$kotlin-ULongArray$-other$0");
        int iM15015getSizeimpl = ULongArray.m15015getSizeimpl(jArr);
        for (int i = 0; i < iM15015getSizeimpl; i++) {
            j = UComparisonsKt.m15994minOfeb3DHEI(j, ULongArray.m15014getsVKNKU(jArr, i));
        }
        return j;
    }

    /* JADX INFO: renamed from: minOf-Wr6uiD8, reason: not valid java name */
    public static final byte m15992minOfWr6uiD8(byte b, byte... bArr) {
        Intrinsics.checkNotNullParameter(bArr, "$v$c$kotlin-UByteArray$-other$0");
        int iM14857getSizeimpl = UByteArray.m14857getSizeimpl(bArr);
        for (int i = 0; i < iM14857getSizeimpl; i++) {
            b = UComparisonsKt.m15987minOfKr8caGY(b, UByteArray.m14856getw2LRezQ(bArr, i));
        }
        return b;
    }

    /* JADX INFO: renamed from: minOf-t1qELG4, reason: not valid java name */
    public static final short m15996minOft1qELG4(short s, short... sArr) {
        Intrinsics.checkNotNullParameter(sArr, "$v$c$kotlin-UShortArray$-other$0");
        int iM15120getSizeimpl = UShortArray.m15120getSizeimpl(sArr);
        for (int i = 0; i < iM15120getSizeimpl; i++) {
            s = UComparisonsKt.m15985minOf5PvTz6A(s, UShortArray.m15119getMh2AYeg(sArr, i));
        }
        return s;
    }
}
