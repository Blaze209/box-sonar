    ...
    public static final boolean isAccessible(KCallable<?> kCallable) {
        ...
        if (kCallable instanceof KFunction) {
            ...
            if (javaMethod3 != null ? javaMethod3.isAccessible() : true) {
                ...
                Member memberMo16068getMember = (kCallableImplAsKCallableImpl == null || (defaultCaller = kCallableImplAsKCallableImpl.getDefaultCaller()) == null) ? null : defaultCaller.mo16068getMember();
                AccessibleObject accessibleObject = memberMo16068getMember instanceof AccessibleObject ? (AccessibleObject) memberMo16068getMember : null;
