...
public final class TypeOfImplKt {
    ...
    public static final KType createPlatformKType(KType lowerBound, KType upperBound) {
        ...
        return new KTypeImpl(KotlinTypeFactory.flexibleType((SimpleType) type, (SimpleType) type2), null, 2, 0 == true ? 1 : 0);
    }
    ...
    public static final KType createMutableCollectionKType(KType type) {
        ...
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = type2.getConstructor().mo16080getDeclarationDescriptor();
        ...
        return new KTypeImpl(KotlinTypeFactory.simpleType$default(simpleType, (TypeAttributes) null, typeConstructor, (List) null, false, 26, (Object) null), function0, 2, objArr == true ? 1 : 0);
    }
    ...
    public static final KType createNothingType(KType type) {
        ...
        Intrinsics.checkNotNullExpressionValue(typeConstructor, "getTypeConstructor(...)");
        return new KTypeImpl(KotlinTypeFactory.simpleType$default((SimpleType) type2, (TypeAttributes) null, typeConstructor, (List) null, false, 26, (Object) null), null, 2, 0 == true ? 1 : 0);
    }
}
