...
public final class ChainedMemberScope implements MemberScope {
    ...
    public ClassifierDescriptor mo16082getContributedClassifier(Name name, LookupLocation location) {
        ...
        for (MemberScope memberScope : this.scopes) {
            ClassifierDescriptor classifierDescriptorMo16082getContributedClassifier = memberScope.mo16082getContributedClassifier(name, location);
            if (classifierDescriptorMo16082getContributedClassifier != null) {
                if (!(classifierDescriptorMo16082getContributedClassifier instanceof ClassifierDescriptorWithTypeParameters) || !((MemberDescriptor) classifierDescriptorMo16082getContributedClassifier).isExpect()) {
                    return classifierDescriptorMo16082getContributedClassifier;
                }
                if (classifierDescriptor == null) {
                    classifierDescriptor = classifierDescriptorMo16082getContributedClassifier;
                }
            }
        }
    ...
    public void mo16086recordLookup(Name name, LookupLocation location) {
        ...
        Intrinsics.checkNotNullParameter(location, "location");
        for (MemberScope memberScope : this.scopes) {
            memberScope.mo16086recordLookup(name, location);
        }
    }
