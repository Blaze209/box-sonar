    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo16081getSupertypes = capturedTypeConstructorImpl.mo16081getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo16081getSupertypes, 10));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo16081getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo16081getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo16081getSupertypes2, 10));
            Iterator<T> it2 = collectionMo16081getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo16081getSupertypes3 = intersectionTypeConstructor.mo16081getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo16081getSupertypes3, 10));
        Iterator<T> it3 = collectionMo16081getSupertypes3.iterator();
        while (it3.hasNext()) {
