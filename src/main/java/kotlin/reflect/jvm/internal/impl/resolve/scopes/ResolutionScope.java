...
public interface ResolutionScope {
    ...
    ClassifierDescriptor mo16082getContributedClassifier(Name name, LookupLocation lookupLocation);
    ...
    void mo16086recordLookup(Name name, LookupLocation lookupLocation);
