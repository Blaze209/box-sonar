...
public final class TypeUtilsKt {
    ...
    private static final void extractTypeParametersFromUpperBounds(KotlinType kotlinType, KotlinType kotlinType2, Set<TypeParameterDescriptor> set, Set<? extends TypeParameterDescriptor> set2) {
        ...
        if (classifierDescriptorMo16080getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            if (!Intrinsics.areEqual(kotlinType.getConstructor(), kotlinType2.getConstructor())) {
                set.add(classifierDescriptorMo16080getDeclarationDescriptor);
                return;
            }
            for (KotlinType kotlinType3 : ((TypeParameterDescriptor) classifierDescriptorMo16080getDeclarationDescriptor).getUpperBounds()) {
                Intrinsics.checkNotNull(kotlinType3);
                extractTypeParametersFromUpperBounds(kotlinType3, kotlinType2, set, set2);
            }
            return;
        }
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor2 = kotlinType.getConstructor().mo16080getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = classifierDescriptorMo16080getDeclarationDescriptor2 instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) classifierDescriptorMo16080getDeclarationDescriptor2 : null;
        ...
        for (TypeProjection typeProjection : kotlinType.getArguments()) {
            ...
            if ((typeParameterDescriptor == null || set2 == null || !set2.contains(typeParameterDescriptor)) && !typeProjection.isStarProjection() && !CollectionsKt.contains(set, typeProjection.getType().getConstructor().mo16080getDeclarationDescriptor()) && !Intrinsics.areEqual(typeProjection.getType().getConstructor(), kotlinType2.getConstructor())) {
    ...
    private static final boolean containsSelfTypeParameter(KotlinType kotlinType, TypeConstructor typeConstructor, Set<? extends TypeParameterDescriptor> set) {
        ...
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = kotlinType.getConstructor().mo16080getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = classifierDescriptorMo16080getDeclarationDescriptor instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) classifierDescriptorMo16080getDeclarationDescriptor : null;
        List<TypeParameterDescriptor> declaredTypeParameters = classifierDescriptorWithTypeParameters != null ? classifierDescriptorWithTypeParameters.getDeclaredTypeParameters() : null;
    ...
    public static final boolean containsTypeAliasParameters$lambda$0(UnwrappedType it) {
        ...
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = it.getConstructor().mo16080getDeclarationDescriptor();
        if (classifierDescriptorMo16080getDeclarationDescriptor != null) {
            return isTypeAliasParameter(classifierDescriptorMo16080getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean requiresTypeAliasExpansion$lambda$0(UnwrappedType it) {
        ...
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = it.getConstructor().mo16080getDeclarationDescriptor();
        if (classifierDescriptorMo16080getDeclarationDescriptor != null) {
            return (classifierDescriptorMo16080getDeclarationDescriptor instanceof TypeAliasDescriptor) || (classifierDescriptorMo16080getDeclarationDescriptor instanceof TypeParameterDescriptor);
        }
        return false;
    }
    ...
    public static final KotlinType getRepresentativeUpperBound(TypeParameterDescriptor typeParameterDescriptor) {
        ...
        while (true) {
            ...
            Object next = it.next();
            ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = ((KotlinType) next).getConstructor().mo16080getDeclarationDescriptor();
    ...
    public static final boolean shouldBeUpdated(KotlinType kotlinType) {
        return kotlinType == null || contains(kotlinType, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.types.typeUtil.TypeUtilsKt$$Lambda$5
            @Override // kotlin.jvm.functions.Function1
            public Object invoke(Object obj) {
                return Boolean.valueOf(TypeUtilsKt.shouldBeUpdated$lambda$0((UnwrappedType) obj));
            }
        });
    }
    ...
    public static final KotlinType replaceArgumentsWithStarProjections(KotlinType kotlinType) {
        ...
        if (unwrappedTypeUnwrap instanceof FlexibleType) {
            ...
            if (!lowerBound.getConstructor().getParameters().isEmpty() && lowerBound.getConstructor().mo16080getDeclarationDescriptor() != null) {
            ...
            if (!upperBound.getConstructor().getParameters().isEmpty() && upperBound.getConstructor().mo16080getDeclarationDescriptor() != null) {
            ...
            if (!simpleTypeReplace$default.getConstructor().getParameters().isEmpty() && simpleTypeReplace$default.getConstructor().mo16080getDeclarationDescriptor() != null) {
