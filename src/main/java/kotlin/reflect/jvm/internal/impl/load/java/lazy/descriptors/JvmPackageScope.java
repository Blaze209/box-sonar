...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo16082getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo16082getContributedClassifier = this.javaScope.mo16082getContributedClassifier(name, location);
        if (classDescriptorMo16082getContributedClassifier != null) {
            return classDescriptorMo16082getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor contributedClassifier = memberScope.mo16082getContributedClassifier(name, location);
