...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    private class Entry implements Comparable<SmallSortedMap<K, V>.Entry>, Map.Entry<K, V> {
        ...
        public String toString() {
            ...
            return new StringBuilder(strValueOf.length() + 1 + strValueOf2.length()).append(strValueOf).append(SimpleComparison.EQUAL_TO_OPERATION).append(strValueOf2).toString();
        }
