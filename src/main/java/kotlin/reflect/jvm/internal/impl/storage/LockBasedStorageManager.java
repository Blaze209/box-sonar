...
public class LockBasedStorageManager implements StorageManager {
    ...
    public String toString() {
        return getClass().getSimpleName() + CommentEntityDomainMapper.MENTIONS_SYMBOL + Integer.toHexString(hashCode()) + " (" + this.debugText + ")";
    }
