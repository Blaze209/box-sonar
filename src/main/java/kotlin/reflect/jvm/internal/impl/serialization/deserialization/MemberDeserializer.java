...
public final class MemberDeserializer {
    ...
    public final PropertyDescriptor loadProperty(final ProtoBuf.Property proto, boolean z) {
        ...
        deserializedPropertyDescriptor.setType(kotlinTypeType2, ownTypeParameters, dispatchReceiverParameter, receiverParameterDescriptorCreateExtensionReceiverParameterForCallable, memberDeserializer.contextReceivers(listContextReceiverTypes, contextParameterList, property, AnnotatedCallableKind.PROPERTY_GETTER));
        ...
        if (Flags.HAS_SETTER.get(i).booleanValue()) {
            ...
            Annotations annotations4 = getAnnotations(property, accessorFlags, AnnotatedCallableKind.PROPERTY_SETTER);
            if (zBooleanValue10) {
                PropertySetterDescriptorImpl propertySetterDescriptorImpl = new PropertySetterDescriptorImpl(deserializedPropertyDescriptor, annotations4, ProtoEnumFlags.INSTANCE.modality(Flags.MODALITY.get(accessorFlags)), ProtoEnumFlagsUtilsKt.descriptorVisibility(ProtoEnumFlags.INSTANCE, Flags.VISIBILITY.get(accessorFlags)), !zBooleanValue10, zBooleanValue11, zBooleanValue12, deserializedPropertyDescriptor.getKind(), null, SourceElement.NO_SOURCE);
                ...
                propertySetterDescriptorImplCreateDefaultSetter = DescriptorFactory.createDefaultSetter(deserializedPropertyDescriptor, annotations4, Annotations.Companion.getEMPTY());
    ...
    public static final NullableLazyValue loadProperty$lambda$3(final MemberDeserializer memberDeserializer, final ProtoBuf.Property property, final DeserializedPropertyDescriptor deserializedPropertyDescriptor) {
        return memberDeserializer.c.getStorageManager().createNullableLazyValue(new Function0(memberDeserializer, property, deserializedPropertyDescriptor) { // from class: kotlin.reflect.jvm.internal.impl.serialization.deserialization.MemberDeserializer$$Lambda$8
            private final MemberDeserializer arg$0;
            private final ProtoBuf.Property arg$1;
            private final DeserializedPropertyDescriptor arg$2;
    ...
    public final SimpleFunctionDescriptor loadFunction(ProtoBuf.Function proto) {
        ...
        List<ProtoBuf.ValueParameter> contextParameterList = proto.getContextParameterList();
        Intrinsics.checkNotNullExpressionValue(contextParameterList, "getContextParameterList(...)");
        List<ReceiverParameterDescriptor> listContextReceivers = memberDeserializer.contextReceivers(listContextReceiverTypes, contextParameterList, function, AnnotatedCallableKind.FUNCTION);
        List<TypeParameterDescriptor> ownTypeParameters = deserializationContextChildContext$default.getTypeDeserializer().getOwnTypeParameters();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final List getPropertyFieldAnnotations$lambda$0(MemberDeserializer memberDeserializer, boolean z, ProtoBuf.Property property) {
        List list;
        ProtoContainer protoContainerAsProtoContainer = memberDeserializer.asProtoContainer(memberDeserializer.c.getContainingDeclaration());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final List valueParameters$lambda$0$0(MemberDeserializer memberDeserializer, ProtoContainer protoContainer, MessageLite messageLite, AnnotatedCallableKind annotatedCallableKind, int i, ProtoBuf.ValueParameter valueParameter) {
    ...
    private final List<ReceiverParameterDescriptor> contextReceivers(List<ProtoBuf.Type> list, List<ProtoBuf.ValueParameter> list2, final MessageLite messageLite, final AnnotatedCallableKind annotatedCallableKind) {
        ...
        for (Object obj : list) {
            ...
            final ProtoBuf.ValueParameter valueParameter = (ProtoBuf.ValueParameter) CollectionsKt.getOrNull(list2, i);
            int flags = (valueParameter == null || !valueParameter.hasFlags()) ? 0 : valueParameter.getFlags();
            if (protoContainerAsProtoContainer != null && Flags.HAS_ANNOTATIONS.get(flags).booleanValue()) {
                empty = new NonEmptyDeserializedAnnotations(this.c.getStorageManager(), new Function0(this, protoContainerAsProtoContainer, messageLite, annotatedCallableKind, i, valueParameter) { // from class: kotlin.reflect.jvm.internal.impl.serialization.deserialization.MemberDeserializer$$Lambda$6
                    private final MemberDeserializer arg$0;
                    private final ProtoContainer arg$1;
                    private final MessageLite arg$2;
                    private final AnnotatedCallableKind arg$3;
            ...
            ReceiverParameterDescriptor receiverParameterDescriptorCreateContextReceiverParameterForCallable = DescriptorFactory.createContextReceiverParameterForCallable(callableDescriptor, this.c.getTypeDeserializer().type(type), null, empty, i);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final List contextReceivers$lambda$0$0(MemberDeserializer memberDeserializer, ProtoContainer protoContainer, MessageLite messageLite, AnnotatedCallableKind annotatedCallableKind, int i, ProtoBuf.ValueParameter valueParameter) {
        return CollectionsKt.toList(memberDeserializer.c.getComponents().getAnnotationAndConstantLoader().loadContextParameterAnnotations(protoContainer, messageLite, annotatedCallableKind, i, valueParameter));
    }
}
