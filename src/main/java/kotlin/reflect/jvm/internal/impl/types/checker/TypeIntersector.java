    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> collectionMo16081getSupertypes = simpleType.getConstructor().mo16081getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo16081getSupertypes, "getSupertypes(...)");
                Collection<KotlinType> collection = collectionMo16081getSupertypes;
