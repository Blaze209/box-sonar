...
public final class DescriptorEquivalenceForOverrides {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean areCallableDescriptorsEquivalent$lambda$1(boolean z, final CallableDescriptor callableDescriptor, final CallableDescriptor callableDescriptor2, TypeConstructor c1, TypeConstructor c2) {
        Intrinsics.checkNotNullParameter(c1, "c1");
        Intrinsics.checkNotNullParameter(c2, "c2");
        if (Intrinsics.areEqual(c1, c2)) {
            return true;
        }
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = c1.mo16080getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor2 = c2.mo16080getDeclarationDescriptor();
        if ((classifierDescriptorMo16080getDeclarationDescriptor instanceof TypeParameterDescriptor) && (classifierDescriptorMo16080getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) classifierDescriptorMo16080getDeclarationDescriptor, (TypeParameterDescriptor) classifierDescriptorMo16080getDeclarationDescriptor2, z, new Function2(callableDescriptor, callableDescriptor2) { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$$Lambda$3
