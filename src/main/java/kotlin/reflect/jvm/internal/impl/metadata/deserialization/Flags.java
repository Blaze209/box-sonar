...
public class Flags {
    ...
    public static final BooleanFlagField HAS_MUST_USE_RETURN_VALUE_CTOR;
    public static final BooleanFlagField HAS_MUST_USE_RETURN_VALUE_FUNCTION;
    public static final BooleanFlagField HAS_MUST_USE_RETURN_VALUE_PROPERTY;
    ...
    static {
        ...
        HAS_MUST_USE_RETURN_VALUE_CTOR = FlagField.booleanAfter(booleanFlagFieldBooleanAfter8);
        ...
        HAS_MUST_USE_RETURN_VALUE_FUNCTION = FlagField.booleanAfter(booleanFlagFieldBooleanAfter16);
        ...
        HAS_MUST_USE_RETURN_VALUE_PROPERTY = FlagField.booleanAfter(booleanFlagFieldBooleanAfter25);
    ...
    public static class BooleanFlagField extends FlagField<Boolean> {
        private static /* synthetic */ void $$$reportNull$$$0(int i) {
            throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "kotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField", PasskeyWebListener.GET_UNIQUE_KEY));
        }
        ...
        public Boolean get(int i) {
            Boolean boolValueOf = Boolean.valueOf(((1 << this.offset) & i) != 0);
            if (boolValueOf == null) {
                $$$reportNull$$$0(0);
            }
            return boolValueOf;
