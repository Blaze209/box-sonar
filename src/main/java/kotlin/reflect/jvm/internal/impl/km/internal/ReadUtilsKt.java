...
/* JADX INFO: compiled from: ReadUtils.kt */
...
public final class ReadUtilsKt {
    ...
    public static final KmAnnotationArgument readAnnotationArgument(ProtoBuf.Annotation.Argument.Value value, NameResolver strings) {
        ...
        if (Flags.IS_UNSIGNED.get(value.getFlags()).booleanValue()) {
            ...
            if (i == 1) {
                return new KmAnnotationArgument.UByteValue(UByte.m14798constructorimpl((byte) value.getIntValue()), null);
            }
            if (i == 2) {
                return new KmAnnotationArgument.UShortValue(UShort.m15061constructorimpl((short) value.getIntValue()), null);
            }
            if (i == 3) {
                return new KmAnnotationArgument.UIntValue(UInt.m14875constructorimpl((int) value.getIntValue()), null);
            }
            if (i == 4) {
                return new KmAnnotationArgument.ULongValue(ULong.m14954constructorimpl(value.getIntValue()), null);
            }
