...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    public AbstractTypeAliasDescriptor(StorageManager storageManager, DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public TypeAliasDescriptor mo16080getDeclarationDescriptor() {
                return this.this$0;
            }
            ...
            public Collection<KotlinType> mo16081getSupertypes() {
                Collection<KotlinType> collectionMo16081getSupertypes = mo16080getDeclarationDescriptor().getUnderlyingType().getConstructor().mo16081getSupertypes();
            ...
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo16080getDeclarationDescriptor());
            }

            public String toString() {
                return "[typealias " + mo16080getDeclarationDescriptor().getName().asString() + AbstractJsonLexerKt.END_LIST;
            }
    ...
    public static final Boolean isInner$lambda$0(AbstractTypeAliasDescriptor abstractTypeAliasDescriptor, UnwrappedType unwrappedType) {
        ...
        if (KotlinTypeKt.isError(unwrappedType)) {
            ...
            ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = unwrappedType.getConstructor().mo16080getDeclarationDescriptor();
            if (!(classifierDescriptorMo16080getDeclarationDescriptor instanceof TypeParameterDescriptor) || Intrinsics.areEqual(((TypeParameterDescriptor) classifierDescriptorMo16080getDeclarationDescriptor).getContainingDeclaration(), abstractTypeAliasDescriptor)) {
                z = false;
            } else {
                z = true;
            }
