...
public final class DescriptorUtilsKt {
    ...
    public static final ClassDescriptor resolveTopLevelClass(ModuleDescriptor moduleDescriptor, FqName topLevelClassFqName, LookupLocation location) {
        ...
        ClassifierDescriptor contributedClassifier = moduleDescriptor.getPackage(topLevelClassFqName.parent()).getMemberScope().mo16082getContributedClassifier(topLevelClassFqName.shortName(), location);
    ...
    public static final ClassDescriptor getSuperClassNotAny(ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : classDescriptor.getDefaultType().getConstructor().mo16081getSupertypes()) {
            if (!KotlinBuiltIns.isAnyOrNullableAny(kotlinType)) {
                ...
                if (DescriptorUtils.isClassOrEnumClass(classifierDescriptorMo16080getDeclarationDescriptor)) {
                    ...
                    return (ClassDescriptor) classifierDescriptorMo16080getDeclarationDescriptor;
                }
            }
        }
        return null;
    ...
    public static final Sequence<CallableMemberDescriptor> overriddenTreeAsSequence(CallableMemberDescriptor callableMemberDescriptor, final boolean z) {
        ...
        return SequencesKt.plus(sequenceSequenceOf, SequencesKt.flatMap(CollectionsKt.asSequence(overriddenDescriptors), new Function1(z) { // from class: kotlin.reflect.jvm.internal.impl.resolve.descriptorUtil.DescriptorUtilsKt$$Lambda$3
            ...
            @Override // kotlin.jvm.functions.Function1
            public Object invoke(Object obj) {
                return DescriptorUtilsKt.overriddenTreeAsSequence$lambda$0$0(this.arg$0, (CallableMemberDescriptor) obj);
            }
        }));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Sequence overriddenTreeAsSequence$lambda$0$0(boolean z, CallableMemberDescriptor callableMemberDescriptor) {
    ...
    public static final ClassDescriptor getAnnotationClass(AnnotationDescriptor annotationDescriptor) {
        ...
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = annotationDescriptor.getType().getConstructor().mo16080getDeclarationDescriptor();
