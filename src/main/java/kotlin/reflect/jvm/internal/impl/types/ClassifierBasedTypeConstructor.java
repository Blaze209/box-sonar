...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo16080getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = mo16080getDeclarationDescriptor();
        if (hasMeaningfulFqName(classifierDescriptorMo16080getDeclarationDescriptor)) {
            iIdentityHashCode = DescriptorUtils.getFqName(classifierDescriptorMo16080getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = mo16080getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor2 = typeConstructor.mo16080getDeclarationDescriptor();
        if (classifierDescriptorMo16080getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo16080getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo16080getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo16080getDeclarationDescriptor2);
        }
        return false;
    }
