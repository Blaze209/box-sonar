    ...
    public static final <H> Collection<H> selectMostSpecificInEachOverridableGroup(Collection<? extends H> collection, Function1<? super H, ? extends CallableDescriptor> descriptorByHandle) {
        ...
        while (true) {
            ...
            if (!linkedList2.isEmpty()) {
                ...
                Collection<R> collectionExtractMembersOverridableInBothWays = OverridingUtil.extractMembersOverridableInBothWays(objFirst, linkedList2, descriptorByHandle, new Function1(smartSetCreate2) { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtilsKt$$Lambda$1
                ...
                if (collectionExtractMembersOverridableInBothWays.size() == 1 && smartSetCreate2.isEmpty()) {
                    ...
                    for (R r : collectionExtractMembersOverridableInBothWays) {
                        Intrinsics.checkNotNull(r);
                        if (!OverridingUtil.isMoreSpecific(callableDescriptorInvoke, descriptorByHandle.invoke(r))) {
                            smartSet.add(r);
                        }
                    }
                    if (!smartSet.isEmpty()) {
