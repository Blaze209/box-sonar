...
public final class NewCapturedTypeConstructor implements CapturedTypeConstructor {
    ...
    public List<UnwrappedType> mo16081getSupertypes() {
    ...
    public static final List refine$lambda$0$0(NewCapturedTypeConstructor newCapturedTypeConstructor, KotlinTypeRefiner kotlinTypeRefiner) {
        List<UnwrappedType> listMo16081getSupertypes = newCapturedTypeConstructor.mo16081getSupertypes();
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(listMo16081getSupertypes, 10));
        Iterator<T> it = listMo16081getSupertypes.iterator();
        while (it.hasNext()) {
