...
public final class OperatorNameConventions {
    ...
    static {
        ...
        Name nameIdentifier10 = Name.identifier(PasskeyWebListener.GET_UNIQUE_KEY);
        ...
        Name nameIdentifier12 = Name.identifier(ES6Iterator.NEXT_METHOD);
        ...
        TOKENS_BY_OPERATOR_NAME = MapsKt.mapOf(TuplesKt.to(nameIdentifier22, "++"), TuplesKt.to(nameIdentifier23, "--"), TuplesKt.to(nameIdentifier28, Marker.ANY_NON_NULL_MARKER), TuplesKt.to(nameIdentifier27, CacheKeyValueDelegate.CACHE_VALUE_SEPARATOR), TuplesKt.to(nameIdentifier26, "!"), TuplesKt.to(nameIdentifier29, "*"), TuplesKt.to(nameIdentifier24, Marker.ANY_NON_NULL_MARKER), TuplesKt.to(nameIdentifier25, CacheKeyValueDelegate.CACHE_VALUE_SEPARATOR), TuplesKt.to(nameIdentifier30, "/"), TuplesKt.to(nameIdentifier31, "%"), TuplesKt.to(nameIdentifier32, ".."), TuplesKt.to(nameIdentifier33, "..<"));
    }
}
