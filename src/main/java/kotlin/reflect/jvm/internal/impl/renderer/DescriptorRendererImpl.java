...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    public String renderFlexibleType(String lowerRendered, String upperRendered, final KotlinBuiltIns builtIns) {
        ...
        String strRenderFlexibleMutabilityOrArrayElementVarianceType = RenderingUtilsKt.renderFlexibleMutabilityOrArrayElementVarianceType(lowerRendered, upperRendered, new Function0(this, builtIns) { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$$Lambda$1
            private final DescriptorRendererImpl arg$0;
        ...
        return strRenderFlexibleMutabilityOrArrayElementVarianceType == null ? "(" + lowerRendered + ".." + upperRendered + ')' : strRenderFlexibleMutabilityOrArrayElementVarianceType;
    }
    ...
    public static final String renderFlexibleType$lambda$0(DescriptorRendererImpl descriptorRendererImpl, KotlinBuiltIns kotlinBuiltIns) {
        ...
        return StringsKt.substringBefore$default(classifierNamePolicy.renderClassifier(collection, descriptorRendererImpl), "Collection", (String) null, 2, (Object) null);
    }
    ...
    /* JADX INFO: compiled from: DescriptorRendererImpl.kt */
    static final /* synthetic */ class AnonymousClass3 extends FunctionReferenceImpl implements Function1<String, String> {
        ...
        public final String invoke(String p0) {
            ...
            return ((DescriptorRendererImpl) this.receiver).escape(p0);
        }
    }
    ...
    public static final String renderFlexibleType$lambda$1(DescriptorRendererImpl descriptorRendererImpl, KotlinBuiltIns kotlinBuiltIns) {
        ...
        return StringsKt.substringBefore$default(classifierNamePolicy.renderClassifier(array, descriptorRendererImpl), "Array", (String) null, 2, (Object) null);
    }
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = typeConstructor.mo16080getDeclarationDescriptor();
        if ((classifierDescriptorMo16080getDeclarationDescriptor instanceof TypeParameterDescriptor) || (classifierDescriptorMo16080getDeclarationDescriptor instanceof ClassDescriptor) || (classifierDescriptorMo16080getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            return renderClassifierName(classifierDescriptorMo16080getDeclarationDescriptor);
        }
        ...
        throw new IllegalStateException(("Unexpected classifier: " + classifierDescriptorMo16080getDeclarationDescriptor.getClass()).toString());
    }
    ...
    private final void appendTypeProjections(StringBuilder sb, List<? extends TypeProjection> list) {
        CollectionsKt.joinTo(list, sb, (112 & 2) != 0 ? ", " : ", ", (112 & 4) != 0 ? "" : null, (112 & 8) != 0 ? "" : null, (112 & 16) != 0 ? -1 : 0, (112 & 32) != 0 ? "..." : null, (112 & 64) != 0 ? null : new Function1(this) { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$$Lambda$4
            private final DescriptorRendererImpl arg$0;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final CharSequence appendTypeProjections$lambda$0(DescriptorRendererImpl descriptorRendererImpl, TypeProjection it) {
        Intrinsics.checkNotNullParameter(it, "it");
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo16080getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor classConstructorDescriptorMo16070getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (classConstructorDescriptorMo16070getUnsubstitutedPrimaryConstructor = annotationClass.mo16070getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = classConstructorDescriptorMo16070getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    private final String renderConstant(ConstantValue<?> constantValue) {
        ...
        if (!(constantValue instanceof ArrayValue)) {
            if (constantValue instanceof AnnotationValue) {
                return StringsKt.removePrefix(DescriptorRenderer.renderAnnotation$default(this, ((AnnotationValue) constantValue).getValue(), null, 2, null), (CharSequence) CommentEntityDomainMapper.MENTIONS_SYMBOL);
            }
    ...
    private final void renderMemberModifiers(MemberDescriptor memberDescriptor, StringBuilder sb) {
        renderModifier(sb, memberDescriptor.isExternal(), BoxAnalyticsParams.REFERRER_EXTERNAL);
    ...
    public final void renderFunction(FunctionDescriptor functionDescriptor, StringBuilder sb) {
        ...
        if (getStartFromName()) {
            ...
            if (getStartFromDeclarationKeyword()) {
                ...
                descriptorRendererImpl = this;
                sb2 = sb;
                renderAnnotations$default(descriptorRendererImpl, sb2, functionDescriptor, null, 2, null);
                ...
                if (descriptorRendererImpl.getIncludeAdditionalModifiers()) {
                    descriptorRendererImpl.renderMemberModifiers(functionDescriptor, sb2);
                }
                descriptorRendererImpl.renderOverride(functionDescriptor2, sb2);
                if (descriptorRendererImpl.getIncludeAdditionalModifiers()) {
                    descriptorRendererImpl.renderAdditionalModifiers(functionDescriptor, sb2);
                } else {
                    descriptorRendererImpl.renderSuspendModifier(functionDescriptor, sb2);
                }
            ...
            sb2.append(descriptorRendererImpl.renderKeyword("fun")).append(" ");
            List<TypeParameterDescriptor> typeParameters = functionDescriptor.getTypeParameters();
            Intrinsics.checkNotNullExpressionValue(typeParameters, "getTypeParameters(...)");
            descriptorRendererImpl.renderTypeParameters(typeParameters, sb2, true);
            descriptorRendererImpl.renderReceiver(functionDescriptor, sb2);
        }
        descriptorRendererImpl.renderName(functionDescriptor, sb2, true);
        List<ValueParameterDescriptor> valueParameters = functionDescriptor.getValueParameters();
        Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
        descriptorRendererImpl.renderValueParameters(valueParameters, functionDescriptor.hasSynthesizedParameterNames(), sb2);
        descriptorRendererImpl.renderReceiverAfterName(functionDescriptor, sb2);
        ...
        if (!descriptorRendererImpl.getWithoutReturnType() && (descriptorRendererImpl.getUnitReturnType() || returnType == null || !KotlinBuiltIns.isUnit(returnType))) {
            sb2.append(": ").append(returnType == null ? "[NULL]" : descriptorRendererImpl.renderType(returnType));
        }
    ...
    public final void renderConstructor(ConstructorDescriptor constructorDescriptor, StringBuilder sb) {
        ...
        if (getRenderConstructorDelegation() && !constructorDescriptor.isPrimary() && (containingDeclaration instanceof ClassDescriptor) && (classConstructorDescriptorMo16070getUnsubstitutedPrimaryConstructor = ((ClassDescriptor) containingDeclaration).mo16070getUnsubstitutedPrimaryConstructor()) != null) {
            List<ValueParameterDescriptor> valueParameters2 = classConstructorDescriptorMo16070getUnsubstitutedPrimaryConstructor.getValueParameters();
            ...
            if (!arrayList2.isEmpty()) {
                ...
                sb.append(CollectionsKt.joinToString$default(arrayList2, ", ", "(", ")", 0, null, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$$Lambda$5
                    @Override // kotlin.jvm.functions.Function1
    ...
    private final void renderWhereSuffix(List<? extends TypeParameterDescriptor> list, StringBuilder sb) {
        ...
        for (TypeParameterDescriptor typeParameterDescriptor : list) {
            ...
            for (KotlinType kotlinType : CollectionsKt.drop(upperBounds, 1)) {
                ...
                Intrinsics.checkNotNull(kotlinType);
                arrayList2.add(sbAppend.append(renderType(kotlinType)).toString());
            }
        }
    ...
    public final void renderProperty(PropertyDescriptor propertyDescriptor, StringBuilder sb) {
        ...
        if (getStartFromName()) {
            ...
            descriptorRendererImpl = this;
            sb2 = sb;
            renderValVarPrefix$default(descriptorRendererImpl, propertyDescriptor, sb2, false, 4, null);
            List<TypeParameterDescriptor> typeParameters = propertyDescriptor.getTypeParameters();
            Intrinsics.checkNotNullExpressionValue(typeParameters, "getTypeParameters(...)");
            descriptorRendererImpl.renderTypeParameters(typeParameters, sb2, true);
            descriptorRendererImpl.renderReceiver(propertyDescriptor, sb2);
        }
        descriptorRendererImpl.renderName(propertyDescriptor, sb2, true);
        StringBuilder sbAppend = sb2.append(": ");
        KotlinType type = propertyDescriptor.getType();
        Intrinsics.checkNotNullExpressionValue(type, "getType(...)");
        sbAppend.append(descriptorRendererImpl.renderType(type));
        descriptorRendererImpl.renderReceiverAfterName(propertyDescriptor, sb2);
        descriptorRendererImpl.renderInitializer(propertyDescriptor, sb2);
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> constantValueMo16072getCompileTimeInitializer;
        String strRenderConstant;
        if (!getIncludePropertyConstant() || (constantValueMo16072getCompileTimeInitializer = variableDescriptor.mo16072getCompileTimeInitializer()) == null || (strRenderConstant = renderConstant(constantValueMo16072getCompileTimeInitializer)) == null) {
            return;
        }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (classConstructorDescriptorMo16070getUnsubstitutedPrimaryConstructor = classDescriptor.mo16070getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, classConstructorDescriptorMo16070getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = classConstructorDescriptorMo16070getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "getVisibility(...)");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = classConstructorDescriptorMo16070getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
            renderValueParameters(valueParameters, classConstructorDescriptorMo16070getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Collection<KotlinType> collectionMo16081getSupertypes = classDescriptor.getTypeConstructor().mo16081getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo16081getSupertypes, "getSupertypes(...)");
        if (collectionMo16081getSupertypes.isEmpty()) {
            return;
        }
        if (collectionMo16081getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(collectionMo16081getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(collectionMo16081getSupertypes, sb, (112 & 2) != 0 ? ", " : ", ", (112 & 4) != 0 ? "" : null, (112 & 8) != 0 ? "" : null, (112 & 16) != 0 ? -1 : 0, (112 & 32) != 0 ? "..." : null, (112 & 64) != 0 ? null : new Function1(this) { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$$Lambda$6
            private final DescriptorRendererImpl arg$0;
