...
public final class SignatureEnhancement {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final KotlinType enhanceSignature$lambda$4$0(ValueParameterDescriptor valueParameterDescriptor, CallableMemberDescriptor it) {
        Intrinsics.checkNotNullParameter(it, "it");
    ...
    public static final Boolean containsFunctionN$lambda$0(UnwrappedType unwrappedType) {
        ...
        if (Intrinsics.areEqual(classifierDescriptorMo16080getDeclarationDescriptor.getName(), JavaToKotlinClassMap.INSTANCE.getFUNCTION_N_FQ_NAME().shortName()) && Intrinsics.areEqual(DescriptorUtilsKt.fqNameOrNull(classifierDescriptorMo16080getDeclarationDescriptor), JavaToKotlinClassMap.INSTANCE.getFUNCTION_N_FQ_NAME())) {
            z = true;
        }
