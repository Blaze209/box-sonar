...
public final class KmAnnotation {
    ...
    public String toString() {
        return CommentEntityDomainMapper.MENTIONS_SYMBOL + this.className + '(' + CollectionsKt.joinToString$default(MapsKt.toList(this.arguments), null, null, null, 0, null, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.km.KmAnnotation$$Lambda$0
