...
public class TypeSubstitutor implements TypeSubstitutorMarker {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i) {
        ...
        switch (i) {
            ...
            case 6:
            default:
                objArr[2] = PasskeyWebListener.CREATE_UNIQUE_KEY;
                break;
            case 7:
                objArr[2] = "<init>";
                break;
    ...
    private TypeProjection unsafeSubstitute(TypeProjection typeProjection, TypeParameterDescriptor typeParameterDescriptor, int i) throws SubstitutionException {
        ...
        if (!typeProjection.isStarProjection()) {
            ...
            if (!DynamicTypesKt.isDynamic(type) && !(type.unwrap() instanceof RawType)) {
                TypeProjection typeProjectionMo16085get = this.substitution.mo16085get(type);
                TypeProjection typeProjectionProjectedTypeForConflictedTypeWithUnsafeVariance = typeProjectionMo16085get != null ? projectedTypeForConflictedTypeWithUnsafeVariance(type, typeProjectionMo16085get, typeParameterDescriptor, typeProjection) : null;
    ...
    private TypeProjection substituteCompoundType(TypeProjection typeProjection, int i) throws SubstitutionException {
        KotlinType type = typeProjection.getType();
        Variance projectionKind = typeProjection.getProjectionKind();
        if (type.getConstructor().mo16080getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return typeProjection;
        }
