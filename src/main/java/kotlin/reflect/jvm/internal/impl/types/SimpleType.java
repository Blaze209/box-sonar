...
public abstract class SimpleType extends UnwrappedType implements SimpleTypeMarker, TypeArgumentListMarker {
    ...
    public String toString() {
        ...
        if (!getArguments().isEmpty()) {
            CollectionsKt.joinTo(getArguments(), sb, (112 & 2) != 0 ? ", " : ", ", (112 & 4) != 0 ? "" : SimpleComparison.LESS_THAN_OPERATION, (112 & 8) != 0 ? "" : SimpleComparison.GREATER_THAN_OPERATION, (112 & 16) != 0 ? -1 : 0, (112 & 32) != 0 ? "..." : null, (112 & 64) != 0 ? null : null);
        }
        if (isMarkedNullable()) {
