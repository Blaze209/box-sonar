...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo16080getDeclarationDescriptor != null) {
            return isInlineClass(classifierDescriptorMo16080getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = kotlinType.getConstructor().mo16080getDeclarationDescriptor();
        if (classifierDescriptorMo16080getDeclarationDescriptor != null) {
            return isValueClass(classifierDescriptorMo16080getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = kotlinType.getConstructor().mo16080getDeclarationDescriptor();
        return (classifierDescriptorMo16080getDeclarationDescriptor == null || !isMultiFieldValueClass(classifierDescriptorMo16080getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
