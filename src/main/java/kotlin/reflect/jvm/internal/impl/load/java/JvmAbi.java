...
public final class JvmAbi {
    ...
    public static final boolean isGetterName(String name) {
        ...
        return StringsKt.startsWith$default(name, PasskeyWebListener.GET_UNIQUE_KEY, false, 2, (Object) null) || StringsKt.startsWith$default(name, "is", false, 2, (Object) null);
    }
    ...
    public static final String getterName(String propertyName) {
        ...
        return startsWithIsPrefix(propertyName) ? propertyName : PasskeyWebListener.GET_UNIQUE_KEY + CapitalizeDecapitalizeKt.capitalizeAsciiOnly(propertyName);
    }
