...
public final class KTypeParameterImpl implements KTypeParameter, KClassifierImpl {
    ...
    public KTypeParameterImpl(final KTypeParameterOwnerImpl kTypeParameterOwnerImpl, TypeParameterDescriptor descriptor) {
        ...
        this.upperBounds = ReflectProperties.lazySoft(new Function0(this) { // from class: kotlin.reflect.jvm.internal.KTypeParameterImpl$$Lambda$0
            ...
            public Object invoke() {
                return KTypeParameterImpl.upperBounds_delegate$lambda$0(this.arg$0);
            }
        });
        this.container = ReflectProperties.lazySoft(new Function0(kTypeParameterOwnerImpl, this) { // from class: kotlin.reflect.jvm.internal.KTypeParameterImpl$$Lambda$1
            private final KTypeParameterOwnerImpl arg$0;
            private final KTypeParameterImpl arg$1;

            {
                this.arg$0 = kTypeParameterOwnerImpl;
                this.arg$1 = this;
            }

            @Override // kotlin.jvm.functions.Function0
            public Object invoke() {
                return KTypeParameterImpl.container_delegate$lambda$0(this.arg$0, this.arg$1);
            }
        });
    }
    ...
    public static final List upperBounds_delegate$lambda$0(KTypeParameterImpl kTypeParameterImpl) {
    ...
    private final KTypeParameterOwnerImpl getContainer() {
        T value = this.container.getValue(this, $$delegatedProperties[1]);
        Intrinsics.checkNotNullExpressionValue(value, "getValue(...)");
        return (KTypeParameterOwnerImpl) value;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final KTypeParameterOwnerImpl container_delegate$lambda$0(KTypeParameterOwnerImpl kTypeParameterOwnerImpl, KTypeParameterImpl kTypeParameterImpl) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(getContainer(), kTypeParameterImpl.getContainer()) && Intrinsics.areEqual(getName(), kTypeParameterImpl.getName());
    }
