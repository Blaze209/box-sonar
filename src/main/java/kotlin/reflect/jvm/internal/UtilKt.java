...
public final class UtilKt {
    ...
    public static final List<Annotation> unwrapRepeatableAnnotations(List<? extends Annotation> list) throws IllegalAccessException, InvocationTargetException {
        List listListOf;
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof KClassValue) {
            ...
            ClassifierDescriptor classifierDescriptorMo16080getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo16080getDeclarationDescriptor();
