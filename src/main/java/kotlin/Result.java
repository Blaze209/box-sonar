...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m14779boximpl(Object obj) {
        return new Result(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m14780constructorimpl(Object obj) {
        return obj;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m14781equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).getValue());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m14782equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m14785hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object other) {
        return m14781equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m14785hashCodeimpl(this.value);
    }
    ...
    public static final boolean m14787isSuccessimpl(Object obj) {
        return !(obj instanceof Failure);
    }

    /* JADX INFO: renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m14786isFailureimpl(Object obj) {
        return obj instanceof Failure;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getOrNull-impl, reason: not valid java name */
    private static final T m14784getOrNullimpl(Object obj) {
        if (m14786isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static final Throwable m14783exceptionOrNullimpl(Object obj) {
    ...
    public String toString() {
        return m14788toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m14788toStringimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m14780constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m14780constructorimpl(ResultKt.createFailure(exception));
        }
    }
