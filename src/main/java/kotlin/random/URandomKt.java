...
public final class URandomKt {
    public static final int nextUInt(Random random) {
        ...
        return UInt.m14875constructorimpl(random.nextInt());
    }

    /* JADX INFO: renamed from: nextUInt-qCasIEU, reason: not valid java name */
    public static final int m16017nextUIntqCasIEU(Random nextUInt, int i) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
        return m16016nextUInta8DCA5k(nextUInt, 0, i);
    }

    /* JADX INFO: renamed from: nextUInt-a8DCA5k, reason: not valid java name */
    public static final int m16016nextUInta8DCA5k(Random nextUInt, int i, int i2) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
        m16011checkUIntRangeBoundsJ1ME1BU(i, i2);
        return UInt.m14875constructorimpl(nextUInt.nextInt(i ^ Integer.MIN_VALUE, i2 ^ Integer.MIN_VALUE) ^ Integer.MIN_VALUE);
    }
    ...
    public static final int nextUInt(Random random, UIntRange range) {
        ...
        if (Integer.compareUnsigned(range.getLast(), -1) < 0) {
            return m16016nextUInta8DCA5k(random, range.getFirst(), UInt.m14875constructorimpl(range.getLast() + 1));
        }
        return Integer.compareUnsigned(range.getFirst(), 0) > 0 ? UInt.m14875constructorimpl(m16016nextUInta8DCA5k(random, UInt.m14875constructorimpl(range.getFirst() - 1), range.getLast()) + 1) : nextUInt(random);
    }

    public static final long nextULong(Random random) {
        Intrinsics.checkNotNullParameter(random, "<this>");
        return ULong.m14954constructorimpl(random.nextLong());
    }

    /* JADX INFO: renamed from: nextULong-V1Xi4fY, reason: not valid java name */
    public static final long m16018nextULongV1Xi4fY(Random nextULong, long j) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
        return m16019nextULongjmpaWc(nextULong, 0L, j);
    }

    /* JADX INFO: renamed from: nextULong-jmpaW-c, reason: not valid java name */
    public static final long m16019nextULongjmpaWc(Random nextULong, long j, long j2) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
        m16012checkULongRangeBoundseb3DHEI(j, j2);
        return ULong.m14954constructorimpl(nextULong.nextLong(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) ^ Long.MIN_VALUE);
    }
    ...
    public static final long nextULong(Random random, ULongRange range) {
        ...
        if (Long.compareUnsigned(range.getLast(), -1L) < 0) {
            return m16019nextULongjmpaWc(random, range.getFirst(), ULong.m14954constructorimpl(range.getLast() + ULong.m14954constructorimpl(((long) 1) & 4294967295L)));
        }
        if (Long.compareUnsigned(range.getFirst(), 0L) <= 0) {
            return nextULong(random);
        }
        long j = ((long) 1) & 4294967295L;
        return ULong.m14954constructorimpl(m16019nextULongjmpaWc(random, ULong.m14954constructorimpl(range.getFirst() - ULong.m14954constructorimpl(j)), range.getLast()) + ULong.m14954constructorimpl(j));
    }

    @IgnorableReturnValue
    /* JADX INFO: renamed from: nextUBytes-EVgfTAA, reason: not valid java name */
    public static final byte[] m16013nextUBytesEVgfTAA(Random nextUBytes, byte[] bArr) {
    ...
    public static final byte[] nextUBytes(Random random, int i) {
        Intrinsics.checkNotNullParameter(random, "<this>");
        return UByteArray.m14851constructorimpl(random.nextBytes(i));
    }

    /* JADX INFO: renamed from: nextUBytes-Wvrt4B4$default, reason: not valid java name */
    public static /* synthetic */ byte[] m16015nextUBytesWvrt4B4$default(Random random, byte[] bArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m16014nextUBytesWvrt4B4(random, bArr, i, i2);
    }

    @IgnorableReturnValue
    /* JADX INFO: renamed from: nextUBytes-Wvrt4B4, reason: not valid java name */
    public static final byte[] m16014nextUBytesWvrt4B4(Random nextUBytes, byte[] bArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(nextUBytes, "$this$nextUBytes");
        Intrinsics.checkNotNullParameter(bArr, "$v$c$kotlin-UByteArray$-array$0");
    ...
    public static final void m16011checkUIntRangeBoundsJ1ME1BU(int i, int i2) {
        if (Integer.compareUnsigned(i2, i) <= 0) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(UInt.m14869boximpl(i), UInt.m14869boximpl(i2)).toString());
        }
    }

    /* JADX INFO: renamed from: checkULongRangeBounds-eb3DHEI, reason: not valid java name */
    public static final void m16012checkULongRangeBoundseb3DHEI(long j, long j2) {
        if (Long.compareUnsigned(j2, j) <= 0) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(ULong.m14948boximpl(j), ULong.m14948boximpl(j2)).toString());
        }
    }
}
