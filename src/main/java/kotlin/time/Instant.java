...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final Instant m16259minusLRDsOJo(long duration) {
        return m16261plusLRDsOJo(Duration.m16200unaryMinusUwyO8pc(duration));
    }

    /* JADX INFO: renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m16260minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m16185plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public final Instant m16261plusLRDsOJo(long duration) {
        long jM16170getInWholeSecondsimpl = Duration.m16170getInWholeSecondsimpl(duration);
        int iM16172getNanosecondsComponentimpl = Duration.m16172getNanosecondsComponentimpl(duration);
        if (jM16170getInWholeSecondsimpl == 0 && iM16172getNanosecondsComponentimpl == 0) {
            return this;
        }
        long j = this.epochSeconds;
        long j2 = j + jM16170getInWholeSecondsimpl;
        if ((j ^ j2) >= 0 || (jM16170getInWholeSecondsimpl ^ j) < 0) {
            return INSTANCE.fromEpochSeconds(j2, this.nanosecondsOfSecond + iM16172getNanosecondsComponentimpl);
        }
        return Duration.m16183isPositiveimpl(duration) ? MAX : MIN;
    }
}
