...
final class InstantPeriodicTask implements Callable<Void>, Disposable {
    ...
    void setFirst(Future<?> f) {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.first, future, f));
    }
    ...
    void setRest(Future<?> f) {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.rest, future, f));
    }
}
