        ...
        */
        public void onNext(T r8) {
            ...
            L2d:
                ...
                io.reactivex.rxjava3.functions.Supplier<U extends java.util.Collection<? super T>> r8 = r7.bufferSupplier     // Catch: java.lang.Throwable -> L62
                java.lang.Object r8 = r8.get()     // Catch: java.lang.Throwable -> L62
                java.lang.String r0 = "The buffer supplied is null"
                java.lang.Object r8 = java.util.Objects.requireNonNull(r8, r0)     // Catch: java.lang.Throwable -> L62
                ...
                r4 = r2
                r1 = r7
                io.reactivex.rxjava3.disposables.Disposable r7 = r0.schedulePeriodically(r1, r2, r4, r6)
                r1.timer = r7
            L5a:
                return
            L5b:
            ...
            L62:
                ...
                io.reactivex.rxjava3.core.Observer<? super V> r8 = r1.downstream
                r8.onError(r7)
                r1.dispose()
                return
            L71:
