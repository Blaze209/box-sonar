...
public final class FlowableOnBackpressureReduceWith<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    static final class BackpressureReduceWithSubscriber<T, R> extends AbstractBackpressureThrottlingSubscriber<T, R> {
        ...
        public void onNext(T t) {
            ...
            try {
                if (andSet != null) {
                    this.current.lazySet((R) Objects.requireNonNull(this.reducer.apply(andSet, (Object) t), "The reducer returned a null value"));
                } else {
                    this.current.lazySet((R) Objects.requireNonNull(this.reducer.apply((R) Objects.requireNonNull(this.supplier.get(), "The supplier returned a null value"), (Object) t), "The reducer returned a null value"));
                }
                drain();
            } catch (Throwable th) {
