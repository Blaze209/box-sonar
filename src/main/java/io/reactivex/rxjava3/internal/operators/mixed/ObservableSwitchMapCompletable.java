...
public final class ObservableSwitchMapCompletable<T> extends Completable {
    ...
    static final class SwitchMapCompletableObserver<T> implements Observer<T>, Disposable {
        ...
        void innerError(SwitchMapInnerObserver sender, Throwable error) {
            if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.inner, sender, null)) {
        ...
        void innerComplete(SwitchMapInnerObserver sender) {
            if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.inner, sender, null) && this.done) {
                this.errors.tryTerminateConsumer(this.downstream);
            }
        }
