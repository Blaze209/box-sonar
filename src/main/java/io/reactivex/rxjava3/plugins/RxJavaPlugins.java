...
public final class RxJavaPlugins {
    ...
    public static <T> Subscriber<? super T>[] onSubscribe(ParallelFlowable<T> source, Subscriber<? super T>[] subscribers) {
    ...
    public static void setOnParallelSubscribe(BiFunction<? super ParallelFlowable, ? super Subscriber[], ? extends Subscriber[]> handler) {
        if (lockdown) {
            throw new IllegalStateException("Plugins can't be changed anymore");
        }
    ...
    public static Scheduler createExecutorScheduler(Executor executor, boolean interruptibleWorker, boolean fair) {
