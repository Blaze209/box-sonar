...
public final class BehaviorSubject<T> extends Subject<T> {
    ...
    public void onError(Throwable t) {
        ...
        if (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.terminalEvent, null, t)) {
    ...
    boolean add(BehaviorDisposable<T> rs) {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.observers, behaviorDisposableArr, behaviorDisposableArr2));
        return true;
    }
