...
class TracingCallFactory implements Call.Factory {
    ...
    static {
        try {
            timeoutMethod = Call.class.getMethod(ResetPasswordSubmitNewPasswordCommand.POLL_COMPLETION_TIMEOUT_ERROR_CODE, new Class[0]);
    ...
    public Call newCall(Request request) {
        ...
        contextsByRequest.set(requestBuild, contextCurrent);
        return new TracingCall(this.okHttpClient.newCall(requestBuild), contextCurrent);
    }
    ...
    static class TracingCall implements Call {
        ...
        public Call clone() throws CloneNotSupportedException {
            ...
            try {
                return new TracingCall((Call) TracingCallFactory.cloneMethod.invoke(this.delegate, new Object[0]), Context.current());
        ...
        public Response execute() throws IOException {
            Scope scopeMakeCurrent = this.callingContext.makeCurrent();
            try {
                Response responseExecute = this.delegate.execute();
