...
public final class RpcServerMetrics implements OperationListener {
    ...
    public static /* synthetic */ RpcServerMetrics $r8$lambda$4icwCfwhvv4_QPNq4J6R32OsrXQ(Meter meter) {
    ...
    public static OperationMetrics get() {
        return new OperationMetrics() { // from class: io.opentelemetry.instrumentation.api.instrumenter.rpc.RpcServerMetrics$$ExternalSyntheticLambda0
            ...
            public final OperationListener create(Meter meter) {
                return RpcServerMetrics.$r8$lambda$4icwCfwhvv4_QPNq4J6R32OsrXQ(meter);
            }
        };
    }
    ...
    public void onEnd(Context context, Attributes attributes, long j) {
        ...
        if (state == null) {
            ...
            this.serverDurationHistogram.record((j - state.startTimeNanos()) / NANOS_PER_MS, MetricsView.applyServerView(state.startAttributes(), attributes), context);
        }
    }
