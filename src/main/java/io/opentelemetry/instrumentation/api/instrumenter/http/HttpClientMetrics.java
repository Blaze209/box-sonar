...
public final class HttpClientMetrics implements OperationListener {
    ...
    /* JADX INFO: renamed from: $r8$lambda$c7g3Ly--ckSVVHtTe4QbsIFt5cM, reason: not valid java name */
    public static /* synthetic */ HttpClientMetrics m14748$r8$lambda$c7g3LyckSVVHtTe4QbsIFt5cM(Meter meter) {
    ...
    public static OperationMetrics get() {
        return new OperationMetrics() { // from class: io.opentelemetry.instrumentation.api.instrumenter.http.HttpClientMetrics$$ExternalSyntheticLambda0
            ...
            public final OperationListener create(Meter meter) {
                return HttpClientMetrics.m14748$r8$lambda$c7g3LyckSVVHtTe4QbsIFt5cM(meter);
            }
        };
    }
    ...
    public void onEnd(Context context, Attributes attributes, long j) {
        ...
        Attributes attributesApplyClientDurationAndSizeView = TemporaryMetricsView.applyClientDurationAndSizeView(state.startAttributes(), attributes);
        this.duration.record((j - state.startTimeNanos()) / NANOS_PER_MS, attributesApplyClientDurationAndSizeView, context);
        Long l = (Long) getAttribute(SemanticAttributes.HTTP_REQUEST_CONTENT_LENGTH, attributes, state.startAttributes());
        if (l != null) {
            this.requestSize.record(l.longValue(), attributesApplyClientDurationAndSizeView);
        }
        Long l2 = (Long) getAttribute(SemanticAttributes.HTTP_RESPONSE_CONTENT_LENGTH, attributes, state.startAttributes());
        if (l2 != null) {
            this.responseSize.record(l2.longValue(), attributesApplyClientDurationAndSizeView);
        }
    }
