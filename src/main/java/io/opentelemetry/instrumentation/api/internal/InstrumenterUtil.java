...
public final class InstrumenterUtil {
    ...
    static {
        ...
        try {
            declaredMethod = Instrumenter.class.getDeclaredMethod("startAndEnd", Context.class, Object.class, Object.class, Throwable.class, Instant.class, Instant.class);
            declaredMethod.setAccessible(true);
        } catch (NoSuchMethodException e) {
            logger.log(Level.WARNING, "Could not get Instrumenter#startAndEnd() method with reflection", (Throwable) e);
        }
        startAndEndMethod = declaredMethod;
    }
