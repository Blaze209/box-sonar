...
final class AutoSqlSanitizer {
    ...
    static SqlStatementInfo sanitize(String str, SqlDialect sqlDialect) {
    ...
    public String readTableName() {
        ...
        if (strYytext != null) {
            return ((strYytext.startsWith("\"") && strYytext.endsWith("\"")) || (strYytext.startsWith("`") && strYytext.endsWith("`"))) ? strYytext.substring(1, strYytext.length() - 1) : strYytext;
        }
        return strYytext;
    }
    ...
    private boolean zzRefill() throws IOException {
        ...
        int i7 = length - i6;
        int i8 = this.zzReader.read(cArr4, i6, i7);
        if (i8 == 0) {
        ...
        int i9 = this.zzEndRead + i8;
        this.zzEndRead = i9;
        if (Character.isHighSurrogate(this.zzBuffer[i9 - 1])) {
            if (i8 == i7) {
                this.zzEndRead--;
                this.zzFinalHighSurrogate = 1;
            } else {
                int i10 = this.zzReader.read();
                if (i10 == -1) {
                    return true;
                }
                char[] cArr5 = this.zzBuffer;
                int i11 = this.zzEndRead;
                this.zzEndRead = i11 + 1;
                cArr5[i11] = (char) i10;
            }
        }
        return false;
    ...
    private int yylex() throws IOException {
        ...
        while (true) {
            ...
            while (true) {
                if (iCharCount < i) {
                    iCodePointAt = Character.codePointAt(cArr, iCharCount, i);
                    ...
                    if (!this.zzAtEOF) {
                        ...
                        if (zZzRefill) {
                            ...
                            int iCodePointAt2 = Character.codePointAt(cArr2, i4, i5);
            ...
            switch (i3) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    if (this.dialect == SqlDialect.COUCHBASE) {
                        this.builder.append('?');
                    } else {
                        if (!this.insideComment && !this.extractionDone) {
                            this.extractionDone = this.operation.handleIdentifier();
