...
final class AutoValue_ImmutableMetricData extends ImmutableMetricData {
    ...
    public int hashCode() {
        return this.data.hashCode() ^ ((((((((((((this.resource.hashCode() ^ 1000003) * 1000003) ^ this.instrumentationScopeInfo.hashCode()) * 1000003) ^ this.name.hashCode()) * 1000003) ^ this.description.hashCode()) * 1000003) ^ this.unit.hashCode()) * 1000003) ^ this.type.hashCode()) * 1000003);
    }
}
