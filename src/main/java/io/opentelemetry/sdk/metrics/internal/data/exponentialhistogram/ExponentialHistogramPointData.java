...
public interface ExponentialHistogramPointData extends PointData {
    ...
    static ExponentialHistogramPointData create(int i, double d, long j, @Nullable Double d2, @Nullable Double d3, ExponentialHistogramBuckets exponentialHistogramBuckets, ExponentialHistogramBuckets exponentialHistogramBuckets2, long j2, long j3, Attributes attributes, List<DoubleExemplarData> list) {
