...
final class AutoValue_ImmutableHistogramPointData extends ImmutableHistogramPointData {
    ...
    public int hashCode() {
        ...
        return this.getExemplars.hashCode() ^ ((((((((((((((iHashCode ^ ((int) (j3 ^ (j3 >>> 32)))) * 1000003) ^ (this.hasMin ? 1231 : 1237)) * 1000003) ^ ((int) ((Double.doubleToLongBits(this.getMin) >>> 32) ^ Double.doubleToLongBits(this.getMin)))) * 1000003) ^ (this.hasMax ? 1231 : 1237)) * 1000003) ^ ((int) ((Double.doubleToLongBits(this.getMax) >>> 32) ^ Double.doubleToLongBits(this.getMax)))) * 1000003) ^ this.getBoundaries.hashCode()) * 1000003) ^ this.getCounts.hashCode()) * 1000003);
    }
}
