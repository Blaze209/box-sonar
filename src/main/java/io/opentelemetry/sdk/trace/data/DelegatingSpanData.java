...
public abstract class DelegatingSpanData implements SpanData {
    ...
    public int hashCode() {
        return getTotalAttributeCount() ^ ((((((((((((((((((((((((((((((getSpanContext().hashCode() ^ 1000003) * 1000003) ^ getParentSpanContext().hashCode()) * 1000003) ^ getResource().hashCode()) * 1000003) ^ getInstrumentationScopeInfo().hashCode()) * 1000003) ^ getName().hashCode()) * 1000003) ^ getKind().hashCode()) * 1000003) ^ ((int) ((getStartEpochNanos() >>> 32) ^ getStartEpochNanos()))) * 1000003) ^ getAttributes().hashCode()) * 1000003) ^ getEvents().hashCode()) * 1000003) ^ getLinks().hashCode()) * 1000003) ^ getStatus().hashCode()) * 1000003) ^ ((int) ((getEndEpochNanos() >>> 32) ^ getEndEpochNanos()))) * 1000003) ^ (hasEnded() ? 1231 : 1237)) * 1000003) ^ getTotalRecordedEvents()) * 1000003) ^ getTotalRecordedLinks()) * 1000003);
    }
