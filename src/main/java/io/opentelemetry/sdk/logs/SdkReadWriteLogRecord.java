...
class SdkReadWriteLogRecord implements ReadWriteLogRecord {
    ...
    static SdkReadWriteLogRecord create(LogLimits logLimits, Resource resource, InstrumentationScopeInfo instrumentationScopeInfo, long j, SpanContext spanContext, Severity severity, @Nullable String str, Body body, @Nullable AttributesMap attributesMap) {
    ...
    public LogRecordData toLogRecordData() {
        ...
        synchronized (this.lock) {
            ...
            AttributesMap attributesMap = this.attributes;
            sdkLogRecordDataCreate = SdkLogRecordData.create(resource, instrumentationScopeInfo, j, spanContext, severity, str, body, immutableAttributes, attributesMap == null ? 0 : attributesMap.getTotalAddedValues());
        }
