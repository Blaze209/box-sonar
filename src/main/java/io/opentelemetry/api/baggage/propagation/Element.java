...
class Element {
    ...
    static {
        char[] cArr = {'(', ')', Typography.less, Typography.greater, CommentBarInputBoxKt.MENTION_SYMBOL, AbstractJsonLexerKt.COMMA, ';', AbstractJsonLexerKt.COLON, '\\', '\"', '/', AbstractJsonLexerKt.BEGIN_LIST, AbstractJsonLexerKt.END_LIST, '?', '=', AbstractJsonLexerKt.BEGIN_OBJ, AbstractJsonLexerKt.END_OBJ};
        for (int i = 0; i < 17; i++) {
