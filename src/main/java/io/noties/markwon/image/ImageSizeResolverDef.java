...
public class ImageSizeResolverDef extends ImageSizeResolver {
    ...
    protected Rect resolveImageSize(ImageSize imageSize, Rect rect, int i, float f) {
        ...
        if (dimension != null) {
            ...
            return new Rect(0, 0, iResolveAbsolute, (dimension2 == null || UNIT_PERCENT.equals(dimension2.unit)) ? (int) ((iResolveAbsolute / f2) + 0.5f) : resolveAbsolute(dimension2, iHeight, f));
        }
