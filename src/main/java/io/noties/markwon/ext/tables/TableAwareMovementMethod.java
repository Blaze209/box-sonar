...
public class TableAwareMovementMethod implements MovementMethod {
    ...
    public static boolean handleTableRowTouchEvent(TextView textView, Spannable spannable, MotionEvent motionEvent) {
        ...
        if (tableRowSpanArr.length != 0 && (layoutFindLayoutForHorizontalOffset = (tableRowSpan = tableRowSpanArr[0]).findLayoutForHorizontalOffset(scrollX)) != null) {
            int offsetForHorizontal2 = layoutFindLayoutForHorizontalOffset.getOffsetForHorizontal(layoutFindLayoutForHorizontalOffset.getLineForVertical(scrollY - layout.getLineTop(lineForVertical)), scrollX % tableRowSpan.cellWidth());
