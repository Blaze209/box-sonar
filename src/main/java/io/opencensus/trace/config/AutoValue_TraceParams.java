...
final class AutoValue_TraceParams extends TraceParams {
    ...
    public int hashCode() {
        return this.maxNumberOfLinks ^ ((((((((this.sampler.hashCode() ^ 1000003) * 1000003) ^ this.maxNumberOfAttributes) * 1000003) ^ this.maxNumberOfAnnotations) * 1000003) ^ this.maxNumberOfMessageEvents) * 1000003);
    }
