...
final class AutoValue_Distribution extends Distribution {
    ...
    public int hashCode() {
        long j = this.count;
        int iDoubleToLongBits = ((int) (((long) (((int) (((long) (((int) (((long) 1000003) ^ (j ^ (j >>> 32)))) * 1000003)) ^ ((Double.doubleToLongBits(this.sum) >>> 32) ^ Double.doubleToLongBits(this.sum)))) * 1000003)) ^ ((Double.doubleToLongBits(this.sumOfSquaredDeviations) >>> 32) ^ Double.doubleToLongBits(this.sumOfSquaredDeviations)))) * 1000003;
        Distribution.BucketOptions bucketOptions = this.bucketOptions;
        return this.buckets.hashCode() ^ ((iDoubleToLongBits ^ (bucketOptions == null ? 0 : bucketOptions.hashCode())) * 1000003);
    }
}
