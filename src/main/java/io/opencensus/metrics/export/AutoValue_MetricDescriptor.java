...
final class AutoValue_MetricDescriptor extends MetricDescriptor {
    ...
    public int hashCode() {
        return this.labelKeys.hashCode() ^ ((((((((this.name.hashCode() ^ 1000003) * 1000003) ^ this.description.hashCode()) * 1000003) ^ this.unit.hashCode()) * 1000003) ^ this.type.hashCode()) * 1000003);
    }
}
