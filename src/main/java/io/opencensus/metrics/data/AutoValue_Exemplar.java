...
final class AutoValue_Exemplar extends Exemplar {
    ...
    public int hashCode() {
        return this.attachments.hashCode() ^ (((((int) (((long) 1000003) ^ ((Double.doubleToLongBits(this.value) >>> 32) ^ Double.doubleToLongBits(this.value)))) * 1000003) ^ this.timestamp.hashCode()) * 1000003);
    }
}
