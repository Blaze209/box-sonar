...
final class AutoValue_ViewData extends ViewData {
    ...
    public int hashCode() {
        return this.end.hashCode() ^ ((((((((this.view.hashCode() ^ 1000003) * 1000003) ^ this.aggregationMap.hashCode()) * 1000003) ^ this.windowData.hashCode()) * 1000003) ^ this.start.hashCode()) * 1000003);
    }
}
