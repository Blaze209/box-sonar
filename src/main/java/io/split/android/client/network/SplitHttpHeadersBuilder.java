...
public class SplitHttpHeadersBuilder {
    ...
    public SplitHttpHeadersBuilder setApiToken(String apiToken) {
        this.mHeaders.put("Authorization", "Bearer " + apiToken);
        return this;
    }

    public SplitHttpHeadersBuilder setAblyApiToken(String apiToken) {
        this.mHeaders.put(ABLY_CLIENT_KEY, apiToken.substring(apiToken.length() - 4));
        return this;
    }

    public SplitHttpHeadersBuilder setHostname(String hostname) {
        if (hostname != null) {
            this.mHeaders.put(CLIENT_MACHINE_NAME_HEADER, hostname);
        }
        return this;
    }
    ...
    public SplitHttpHeadersBuilder setHostIp(String hostIp) {
        if (hostIp != null) {
            this.mHeaders.put(CLIENT_MACHINE_IP_HEADER, hostIp);
        }
        return this;
    }
    ...
    public SplitHttpHeadersBuilder setClientVersion(String clientVersion) {
        ...
        this.mHeaders.put(CLIENT_VERSION, clientVersion);
        return this;
    }
