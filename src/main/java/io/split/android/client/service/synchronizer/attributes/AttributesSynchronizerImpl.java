...
public class AttributesSynchronizerImpl implements AttributesSynchronizer {
    ...
    AttributesSynchronizerImpl(SplitTaskExecutor taskExecutor, SplitEventsManager splitEventsManager, AttributeTaskFactory attributeTaskFactory, PersistentAttributesStorage persistentAttributesStorage) {
