...
public class LocalhostSplitClientContainerImpl extends BaseSplitClientContainer {
    ...
    public LocalhostSplitClientContainerImpl(LocalhostSplitFactory splitFactory, SplitClientConfig config, SplitsStorage splitsStorage, SplitParser splitParser, AttributesManagerFactory attributesManagerFactory, AttributesMerger attributesMerger, TelemetryStorageProducer telemetryStorageProducer, EventsManagerCoordinator eventsManagerCoordinator, SplitTaskExecutor taskExecutor, FlagSetsFilter flagSetsFilter) {
        ...
        this.mSplitTaskExecutor = taskExecutor;
    ...
    protected void createNewClient(Key key) {
        SplitEventsManager splitEventsManager = new SplitEventsManager(this.mSplitTaskExecutor, this.mConfig.blockUntilReady());
        ...
        LocalhostSplitClient localhostSplitClient = new LocalhostSplitClient(this.mSplitFactory, this, this.mConfig, key, this.mSplitStorage, splitEventsManager, this.mSplitParser, this.mAttributesManagerFactory.getManager(key.matchingKey(), new AttributesStorageImpl()), this.mAttributesMerger, this.mTelemetryStorageProducer, this.mFlagSetsFilter);
