...
public class ContainsAllOfSetMatcher implements Matcher {
    ...
    public boolean match(Object matchValue, String bucketingKey, Map<String, Object> attributes, Evaluator evaluator) {
        if (matchValue == null || !(matchValue instanceof Collection) || this._compareTo.isEmpty()) {
            return false;
        }
        return Transformers.toSetOfStrings((Collection) matchValue).containsAll(this._compareTo);
    }

    public String toString() {
        return "contains all of " + this._compareTo;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ContainsAllOfSetMatcher) {
            return this._compareTo.equals(((ContainsAllOfSetMatcher) obj)._compareTo);
        }
        return false;
    }
}
