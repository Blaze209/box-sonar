...
public class EqualToMatcher implements Matcher {
    ...
    public EqualToMatcher(long compareTo, DataType dataType) {
        ...
        if (dataType == DataType.DATETIME) {
            this._normalizedCompareTo = Transformers.asDate(Long.valueOf(compareTo)).longValue();
        } else {
    ...
    public boolean match(Object matchValue, String bucketingKey, Map<String, Object> attributes, Evaluator evaluator) {
        ...
        if (this._dataType == DataType.DATETIME) {
            lAsLong = Transformers.asDate(matchValue);
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof EqualToMatcher) && this._compareTo == ((EqualToMatcher) obj)._compareTo;
    }
}
