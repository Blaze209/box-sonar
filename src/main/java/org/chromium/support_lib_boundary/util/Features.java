...
public class Features {
    ...
    public static final String COMMITTED_NAVIGATION_GET_PAGE_NON_NULL = "COMMITTED_NAVIGATION_GET_PAGE_NON_NULL";
    ...
    public static final String PREFETCH_WITH_CALLBACK_RESULT_V1 = "PREFETCH_WITH_CALLBACK_RESULT_V1";
