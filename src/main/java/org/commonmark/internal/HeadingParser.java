...
public class HeadingParser extends AbstractBlockParser {
    ...
    public static HeadingParser getAtxHeading(CharSequence charSequence, int i) {
        int iSkip = Parsing.skip(ColorSerializer.PREFIX, charSequence, i, charSequence.length()) - i;
        if (iSkip == 0 || iSkip > 6) {
            return null;
        }
        int i2 = i + iSkip;
        ...
        int iSkipBackwards = Parsing.skipBackwards(ColorSerializer.PREFIX, charSequence, iSkipSpaceTabBackwards, i2);
