...
public class Md5Crypt {
    ...
    public static String md5Crypt(byte[] bArr, String str, String str2) {
        ...
        if (str == null) {
            ...
            Matcher matcher = Pattern.compile("^" + str2.replace(MetadataReservedKeys.PREFIX, "\\$") + "([\\.\\/a-zA-Z0-9]{1,8}).*").matcher(str);
            if (!matcher.find()) {
        ...
        StringBuilder sb = new StringBuilder(str2 + strGroup + MetadataReservedKeys.PREFIX);
