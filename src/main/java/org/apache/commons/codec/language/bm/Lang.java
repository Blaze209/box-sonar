                    ...
                    if (scanner.hasNextLine()) {
                        ...
                        if (z) {
                            ...
                            if (strTrim.length() != 0) {
                                ...
                                arrayList.add(new LangRule(Pattern.compile(strArrSplit[0]), new HashSet(Arrays.asList(strArrSplit[1].split("\\+"))), strArrSplit[2].equals(TelemetryEventStrings.Value.TRUE)));
                            }
                        }
                    } else {
                        scanner.close();
