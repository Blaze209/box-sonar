...
public class WriterOutputStream extends OutputStream {
    ...
    public WriterOutputStream(Writer writer, Charset charset, int i, boolean z) {
        this(writer, charset.newDecoder().onMalformedInput(CodingErrorAction.REPLACE).onUnmappableCharacter(CodingErrorAction.REPLACE).replaceWith(MsalUtils.QUERY_STRING_SYMBOL), i, z);
    }
