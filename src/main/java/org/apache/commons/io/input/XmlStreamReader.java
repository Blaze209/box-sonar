...
public class XmlStreamReader extends Reader {
    ...
    private static final ByteOrderMark[] XML_GUESS_BYTES = {new ByteOrderMark("UTF-8", 60, 63, 120, 109), new ByteOrderMark("UTF-16BE", 0, 60, 0, 63), new ByteOrderMark("UTF-16LE", 60, 0, 63, 0), new ByteOrderMark(UTF_32BE, 0, 0, 0, 60, 0, 0, 0, 63, 0, 0, 0, 120, 0, 0, 0, 109), new ByteOrderMark(UTF_32LE, 60, 0, 0, 0, 63, 0, 0, 0, 120, 0, 0, 0, 109, 0, 0, 0), new ByteOrderMark(EBCDIC, 76, 111, Token.LAST_TOKEN, Token.XMLATTR)};
    ...
    private String doLenientDetection(String str, XmlStreamReaderException xmlStreamReaderException) throws IOException {
        ...
        if (str == null || !str.startsWith("text/html")) {
            ...
            try {
                xmlStreamReader = this;
                try {
                    return xmlStreamReader.calculateHttpEncoding("text/xml" + str.substring("text/html".length()), xmlStreamReaderException.getBomEncoding(), xmlStreamReaderException.getXmlGuessEncoding(), xmlStreamReaderException.getXmlEncoding(), true);
                } catch (XmlStreamReaderException e) {
                    e = e;
    ...
    static String getContentTypeMime(String str) {
        ...
        int iIndexOf = str.indexOf(AuthenticationConstants.Broker.CHALLENGE_REQUEST_CERT_AUTH_DELIMETER);
        if (iIndexOf >= 0) {
    ...
    static String getContentTypeEncoding(String str) {
        int iIndexOf;
        if (str != null && (iIndexOf = str.indexOf(AuthenticationConstants.Broker.CHALLENGE_REQUEST_CERT_AUTH_DELIMETER)) > -1) {
