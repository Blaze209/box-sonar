...
public class ArchUtils {
    ...
    private static void init_X86_64Bit() {
        addProcessors(new Processor(Processor.Arch.BIT_64, Processor.Type.X86), MinElf.ISA.X86_64, ResourceAttributes.HostArchValues.AMD64, "em64t", "universal");
    }
    ...
    private static void init_IA64_64Bit() {
        addProcessors(new Processor(Processor.Arch.BIT_64, Processor.Type.IA_64), ResourceAttributes.HostArchValues.IA64, "ia64w");
    }
    ...
    private static void init_PPC_64Bit() {
        addProcessors(new Processor(Processor.Arch.BIT_64, Processor.Type.PPC), ResourceAttributes.HostArchValues.PPC64, "power64", "powerpc64", "power_pc64", "power_rs64");
    }
