...
public class SystemUtils {
    ...
    static {
        ...
        IS_JAVA_1_3 = getJavaVersionMatches(BuildConfig.FLAGS_SPEC);
        ...
        IS_JAVA_10 = getJavaVersionMatches(GrpcStatusUtil.GRPC_STATUS_ABORTED);
        IS_JAVA_11 = getJavaVersionMatches(GrpcStatusUtil.GRPC_STATUS_OUT_OF_RANGE);
        IS_JAVA_12 = getJavaVersionMatches(GrpcStatusUtil.GRPC_STATUS_UNIMPLEMENTED);
        IS_JAVA_13 = getJavaVersionMatches("13");
        IS_JAVA_14 = getJavaVersionMatches(GrpcStatusUtil.GRPC_STATUS_UNAVAILABLE);
        IS_JAVA_15 = getJavaVersionMatches(GrpcStatusUtil.GRPC_STATUS_DATA_LOSS);
