...
public class ReflectionToStringBuilder extends ToStringBuilder {
    ...
    protected void appendFieldsIn(Class<?> cls) {
        ...
        Arrays.sort(declaredFields, Comparator.comparing(new Function() { // from class: org.apache.commons.lang3.builder.ReflectionToStringBuilder$$ExternalSyntheticLambda0
