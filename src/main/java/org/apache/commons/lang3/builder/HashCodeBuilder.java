...
public class HashCodeBuilder implements Builder<Integer> {
    ...
    private static void reflectionAppend(Object obj, Class<?> cls, HashCodeBuilder hashCodeBuilder, boolean z, String[] strArr) {
        ...
        try {
            ...
            Arrays.sort(declaredFields, Comparator.comparing(new Function() { // from class: org.apache.commons.lang3.builder.HashCodeBuilder$$ExternalSyntheticLambda0
            ...
            for (Field field : declaredFields) {
                if (!ArrayUtils.contains(strArr, field.getName()) && !field.getName().contains(MetadataReservedKeys.PREFIX) && ((z || !Modifier.isTransient(field.getModifiers())) && !Modifier.isStatic(field.getModifiers()) && !field.isAnnotationPresent(HashCodeExclude.class))) {
                    try {
