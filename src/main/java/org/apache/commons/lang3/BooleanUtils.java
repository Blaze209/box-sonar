...
public class BooleanUtils {
    ...
    public static Boolean toBooleanObject(String str) {
        Boolean bool;
        if (str == TelemetryEventStrings.Value.TRUE) {
            return Boolean.TRUE;
        }
        if (str == null) {
            return null;
    ...
    public static String toStringTrueFalse(Boolean bool) {
        return toString(bool, TelemetryEventStrings.Value.TRUE, "false", null);
    }
    ...
    public static String toStringTrueFalse(boolean z) {
        return toString(z, TelemetryEventStrings.Value.TRUE, "false");
    }
