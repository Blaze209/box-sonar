...
class GmtTimeZone extends TimeZone {
    ...
    GmtTimeZone(boolean z, int i, int i2) {
        ...
        this.offset = z ? -i3 : i3;
        this.zoneId = twoDigits(twoDigits(new StringBuilder(9).append(TimeZones.GMT_ID).append(z ? Soundex.SILENT_MARKER : '+'), i).append(AbstractJsonLexerKt.COLON), i2).toString();
    }
