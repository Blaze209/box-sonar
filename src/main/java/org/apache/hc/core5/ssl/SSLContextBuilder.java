...
public class SSLContextBuilder {
    ...
    public SSLContextBuilder setTrustStoreProvider(String str) throws NoSuchProviderException {
        this.tsProvider = requireNonNullProvider(str);
        return this;
    }
    ...
    public SSLContextBuilder setKeyStoreProvider(String str) throws NoSuchProviderException {
        this.ksProvider = requireNonNullProvider(str);
        return this;
    }
    ...
    public SSLContextBuilder loadTrustMaterial(KeyStore keyStore, TrustStrategy trustStrategy) throws NoSuchAlgorithmException, KeyStoreException {
        ...
        Provider provider = this.tsProvider;
        TrustManagerFactory trustManagerFactory = provider == null ? TrustManagerFactory.getInstance(defaultAlgorithm) : TrustManagerFactory.getInstance(defaultAlgorithm, provider);
    ...
    public SSLContextBuilder loadTrustMaterial(Path path) throws NoSuchAlgorithmException, IOException, KeyStoreException, CertificateException {
        return loadTrustMaterial(path, (char[]) null);
    }

    public SSLContextBuilder loadTrustMaterial(Path path, char[] cArr) throws NoSuchAlgorithmException, IOException, KeyStoreException, CertificateException {
        return loadTrustMaterial(path, cArr, null, new OpenOption[0]);
    }

    public SSLContextBuilder loadTrustMaterial(Path path, char[] cArr, TrustStrategy trustStrategy, OpenOption... openOptionArr) throws NoSuchAlgorithmException, IOException, KeyStoreException, CertificateException {
        Args.notNull(path, "Truststore file");
        return loadTrustMaterial(loadKeyStore(path, cArr, openOptionArr), trustStrategy);
    }
    ...
    public SSLContextBuilder loadTrustMaterial(File file, char[] cArr, TrustStrategy trustStrategy) throws NoSuchAlgorithmException, IOException, KeyStoreException, CertificateException {
        ...
        return loadTrustMaterial(file.toPath(), cArr, trustStrategy, new OpenOption[0]);
    }
    ...
    public SSLContextBuilder loadTrustMaterial(URL url, char[] cArr, TrustStrategy trustStrategy) throws NoSuchAlgorithmException, IOException, KeyStoreException, CertificateException {
        ...
        return loadTrustMaterial(loadKeyStore(url, cArr), trustStrategy);
    }
    ...
    public SSLContextBuilder loadKeyMaterial(KeyStore keyStore, char[] cArr, PrivateKeyStrategy privateKeyStrategy) throws NoSuchAlgorithmException, UnrecoverableKeyException, KeyStoreException {
        ...
        Provider provider = this.ksProvider;
        KeyManagerFactory keyManagerFactory = provider == null ? KeyManagerFactory.getInstance(defaultAlgorithm) : KeyManagerFactory.getInstance(defaultAlgorithm, provider);
    ...
    public SSLContextBuilder loadKeyMaterial(Path path, char[] cArr, char[] cArr2, OpenOption... openOptionArr) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, KeyStoreException, CertificateException {
        return loadKeyMaterial(path, cArr, cArr2, null, openOptionArr);
    }

    public SSLContextBuilder loadKeyMaterial(Path path, char[] cArr, char[] cArr2, PrivateKeyStrategy privateKeyStrategy, OpenOption... openOptionArr) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, KeyStoreException, CertificateException {
        Args.notNull(path, "Keystore file");
        return loadKeyMaterial(loadKeyStore(path, cArr, openOptionArr), cArr2, privateKeyStrategy);
    }
    ...
    public SSLContextBuilder loadKeyMaterial(File file, char[] cArr, char[] cArr2, PrivateKeyStrategy privateKeyStrategy) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, KeyStoreException, CertificateException {
        ...
        return loadKeyMaterial(file.toPath(), cArr, cArr2, privateKeyStrategy, new OpenOption[0]);
    }
    ...
    public SSLContextBuilder loadKeyMaterial(URL url, char[] cArr, char[] cArr2, PrivateKeyStrategy privateKeyStrategy) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, KeyStoreException, CertificateException {
        ...
        return loadKeyMaterial(loadKeyStore(url, cArr), cArr2, privateKeyStrategy);
    }
    ...
    private KeyStore loadKeyStore(Path path, char[] cArr, OpenOption... openOptionArr) throws NoSuchAlgorithmException, IOException, KeyStoreException, CertificateException {
        KeyStore keyStore = KeyStore.getInstance(this.keyStoreType);
        InputStream inputStreamNewInputStream = Files.newInputStream(path, openOptionArr);
        try {
            keyStore.load(inputStreamNewInputStream, cArr);
    ...
    private KeyStore loadKeyStore(URL url, char[] cArr) throws NoSuchAlgorithmException, IOException, KeyStoreException, CertificateException {
        KeyStore keyStore = KeyStore.getInstance(this.keyStoreType);
    ...
    static class KeyManagerDelegate extends X509ExtendedKeyManager {
        ...
        public Map<String, PrivateKeyDetails> getClientAliasMap(String[] strArr, Principal[] principalArr) {
            ...
            for (String str : strArr) {
                putPrivateKeyDetails(map, str, this.keyManager.getClientAliases(str, principalArr));
            }
            return map;
        }
        ...
        public Map<String, PrivateKeyDetails> getServerAliasMap(String str, Principal[] principalArr) {
            HashMap map = new HashMap();
            putPrivateKeyDetails(map, str, this.keyManager.getServerAliases(str, principalArr));
            return map;
        }

        private void putPrivateKeyDetails(Map<String, PrivateKeyDetails> map, String str, String[] strArr) {
            if (strArr != null) {
    ...
    private Provider requireNonNullProvider(String str) throws NoSuchProviderException {
