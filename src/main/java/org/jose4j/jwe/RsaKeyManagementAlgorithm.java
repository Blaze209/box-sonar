...
public class RsaKeyManagementAlgorithm extends WrappingKeyManagementAlgorithm implements KeyManagementAlgorithm {
    ...
    public static class RsaOaep256 extends RsaKeyManagementAlgorithm implements KeyManagementAlgorithm {
        public RsaOaep256() {
            ...
            setAlgorithmParameterSpec(new OAEPParameterSpec("SHA-256", IDevicePopManager.MGF_1, MGF1ParameterSpec.SHA256, PSource.PSpecified.DEFAULT));
        }
        ...
        public boolean isAvailable() {
            ...
            try {
                rsaOaep256 = this;
                try {
                    return rsaOaep256.manageForEncrypt(JsonWebKey.Factory.newJwk("{\"kty\":\"RSA\",\"n\":\"sXchDaQebHnPiGvyDOAT4saGEUetSyo9MKLOoWFsueri23bOdgWp4Dy1WlUzewbgBHod5pcM9H95GQRV3JDXboIRROSBigeC5yjU1hGzHHyXss8UDprecbAYxknTcQkhslANGRUZmdTOQ5qTRsLAt6BTYuyvVRdhS8exSZEy_c4gs_7svlJJQ4H9_NxsiIoLwAEk7-Q3UXERGYw_75IDrGA84-lA_-Ct4eTlXHBIY2EaV7t7LjJaynVJCpkv4LKjTTAumiGUIuQhrNhZLuF_RJLqHpM2kgWFLU7-VTdL1VbC2tejvcI2BlMkEpk1BzBZI0KQB0GaDWFLN-aEAw3vRw\",\"e\":\"AQAB\"}").getKey(), new ContentEncryptionKeyDescriptor(16, "AES"), null, null, new ProviderContext()) != null;
                } catch (JoseException e) {
                    e = e;
                    rsaOaep256.log.debug(rsaOaep256.getAlgorithmIdentifier() + " is not available due to " + ExceptionHelp.toStringWithCauses(e));
                    return false;
                }
