        ...
        if (i11 != 0) {
            if (i11 == 1) {
                ...
                if (this.encodeTable == STANDARD_ENCODE_TABLE) {
                    int i14 = context.pos;
                    context.pos = i14 + 1;
                    bArrEnsureBufferSize2[i14] = 61;
                    int i15 = context.pos;
                    context.pos = i15 + 1;
                    bArrEnsureBufferSize2[i15] = 61;
                }
            } else if (i11 == 2) {
                int i16 = context.pos;
                context.pos = i16 + 1;
