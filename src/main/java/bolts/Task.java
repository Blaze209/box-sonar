...
public class Task<TResult> {
    ...
    public <TContinuationResult> Task<TContinuationResult> continueWith(Continuation<TResult, TContinuationResult> continuation, Executor executor, CancellationToken cancellationToken) {
            ...
            if (zIsCompleted) {
                ...
                this.continuations.add(new Continuation<TResult, Void>() { // from class: bolts.Task.10
                    ...
                    public Void then(Task<TResult> task2) {
                        Task.completeImmediately(taskCompletionSource, continuation2, task2, executor2, cancellationToken2);
                        return null;
                    }
                });
            }
        ...
        if (zIsCompleted) {
            completeImmediately(taskCompletionSource, continuation2, task, executor2, cancellationToken2);
        }
        return taskCompletionSource.getTask();
    }
    ...
    public <TContinuationResult> Task<TContinuationResult> continueWithTask(Continuation<TResult, Task<TContinuationResult>> continuation, Executor executor, CancellationToken cancellationToken) {
        ...
        synchronized (this.lock) {
            ...
            if (zIsCompleted) {
                ...
                this.continuations.add(new Continuation<TResult, Void>() { // from class: bolts.Task.11
                    @Override // bolts.Continuation
                    public Void then(Task<TResult> task2) {
                        Task.completeAfterTask(taskCompletionSource, continuation2, task2, executor2, cancellationToken2);
                        return null;
                    }
                });
            }
        ...
        if (zIsCompleted) {
            completeAfterTask(taskCompletionSource, continuation2, task, executor2, cancellationToken2);
        }
        return taskCompletionSource.getTask();
    }
